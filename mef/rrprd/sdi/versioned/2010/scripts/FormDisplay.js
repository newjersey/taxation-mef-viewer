...
//=========================================================
      ...
      // feature list
       var height = "dialogHeight:132px;";
       var width = "dialogWidth:271px;";
       ...
       if( docIdList.length == 1 )
       {
        ...
        //displayFormByDocId( docIdList[0] );
        return;
       }
       var features = height + width + scroll + status + help;
       //var docNameList = getDisplayNameByDocId(docIdList);
  ...
  // for testing only
  //
  /*  function getDisplayNameByDocId(docIdList)
      {
       // this is a mock-up
       var nid = docIdList.length;
       var name = new Array(nid);
       for( i = 0; i < nid; i++ )
       {
        name[i] = "Linked File: " + docIdList[i];
       }
       name[1]="InvalidDocId"; // simulate error condition.
       return name;
      }
      
    function displayFormByDocId(docId)
      {
       alert(docId);  
      }
  */
