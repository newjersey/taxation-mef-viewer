          ...
          <span class="IRS8865_DotSpacing">....</span>
				...
				<div class="pageEnd" style="width:187mm;padding-top:1mm;border-top:1px solid black;">
					...
					<div style="float:right;">
					  ...
					  Form <span class="styBoldText" style="font-size:8pt;">8865</span> (2021)
					</div>
				</div>
				...
				<div style="width:187mm;padding-top:.5mm;border-bottom:1px solid black;">
					<div style="float:left;">Form 8865 (2021)<span style="width:148mm;"/>
					</div>
				...
				<div class="IRS8865_LineContainer">
					...
					<div class="IRS8865_LineDescLong" style="height:15mm;width:146mm;border-right-width:0px;">
						...
						<xsl:call-template name="SetFormLinkInline">
							<xsl:with-param name="TargetNode" select="$FormData/PropTrnsfrRegs17073Or17076Ind"/>
						</xsl:call-template>
						<span style="width:2mm;"/>
						<span style="width:0.75mm;"/><span style="float:right;"><span class="IRS8865_DotSpacing">..........................................</span>
						<img src="{$ImagePath}/8865_Bullet_Sm.gif" alt="Small Right Arrow" border="0"/></span>
					...
					<div class="IRS8865_LineDescLong" style="padding-top:8mm;width:12mm;border-right-width:0px;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" alt="Property Transfer Regs 1.707-3 Or 1.707-6 Yes">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/PropTrnsfrRegs17073Or17076Ind"/>
									<xsl:with-param name="BackupName">IRS8865PropTrnsfrRegs17033Or17076YesInd</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						<span style="font-weight:bold;">
					...
					<div class="IRS8865_LineDescLong" style="width:12mm;border-right-width:0px; padding-top:8mm;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" alt="Property Transfer Regs 1.707-3 Or 1.707-6 No">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/PropTrnsfrRegs17073Or17076Ind"/>
									<xsl:with-param name="BackupName">IRS8865PropTrnsfrRegs17033Or17076NoInd</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						<span style="font-weight:bold;">
				...
				<div class="IRS8865_LineContainer">
					...
					<div class="IRS8865_LineDescLong" style="padding-top:8mm;width:12mm;border-right-width:0px;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" alt="Property Liability Incurred By Transfer To Partnership Yes">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/PropLiabIncurdTrnsfrPrtshpInd"/>
									<xsl:with-param name="BackupName">IRS8865PropLiabIncurdTrnsfrPrtshpYesInd</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						<span style="font-weight:bold;">
					...
					<div class="IRS8865_LineDescLong" style="width:12mm;border-right-width:0px; padding-top:8mm;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" alt="Property Liability Incurred By Transfer To Partnership No">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/PropLiabIncurdTrnsfrPrtshpInd"/>
									<xsl:with-param name="BackupName">IRS8865PropLiabIncurdTrnsfrPrtshpNoInd</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						<span style="font-weight:bold;">
