				  ...
				  <div class="styLNDesc" style="clear:none; width:26mm;">
				    <span>
					  ...
					  <input type="checkbox" alt="Compensation Claimed Not Treat As Intangible Development Amount Indicator Yes" class="styCkbox">
						<xsl:call-template name="PopulateYesCheckbox">
						  <xsl:with-param name="TargetNode" select="CompClmNotTrtdAsIntngblDevAmt"/>
						  <xsl:with-param name="BackupName">CompClmNotTrtdAsIntngblDevAmtYes</xsl:with-param>
						</xsl:call-template>
					  </input>
					</span>
					<label>
					  <xsl:call-template name="PopulateLabelYes">
						<xsl:with-param name="TargetNode" select="CompClmNotTrtdAsIntngblDevAmt"/>
						<xsl:with-param name="BackupName">CompClmNotTrtdAsIntngblDevAmtYesLabel</xsl:with-param>
					  </xsl:call-template>
					  Yes
					</label>
					<span style="width:4mm;"/>
					<span>
					  ...
					  <input type="checkbox" alt="Compensation Claimed Not Treat As Intangible Development Amount Indicator No" class="styCkbox">
						<xsl:call-template name="PopulateNoCheckbox">
						  <xsl:with-param name="TargetNode" select="CompClmNotTrtdAsIntngblDevAmt"/>
						  <xsl:with-param name="BackupName">CompClmNotTrtdAsIntngblDevAmtNo</xsl:with-param>
						</xsl:call-template>
					  </input>
					</span>
					<label>
					  <xsl:call-template name="PopulateLabelNo">
						<xsl:with-param name="TargetNode" select="CompClmNotTrtdAsIntngblDevAmt"/>
						<xsl:with-param name="BackupName">CompClmNotTrtdAsIntngblDevAmtNoLabel</xsl:with-param>
					  </xsl:call-template>
					  No
					</label>
				  </div>
