						...
						<div style="float:left;width:87mm;border-right:1px solid black;">
							...
							<div style="width:100%;border-bottom:1px solid black;">
								...
								<div style="width:60%;height:12.4mm;padding-left:1px;">
									<span style="font-family:Arial;display:inline;">U.S. TIN of foreign person <br />subject to withholding (see instructions)</span> <br /><br />
									<span style="width:100%;text-align:center;">
										<xsl:choose>
							...
							<div style="width:100%;height:10.3mm;padding-left:2px;border-right:0px solid black;border-bottom:1px solid black;">
						...
						<div style="float:left;width:99.7mm;">
							...
							<div style="width:36.2mm;border-right:1px solid black;float:left;">
								...
								<div style="width:100%;height:15.5mm;border-bottom:1px solid black;">
									...
									<span style="font-family:Arial;display:inline;">Gain recognized by foreign coorporation </span>
									<br /><br /><br />
							...
							<div style="width:100%;border:none;">
								<div style="width:72mm;float:left;border-right:1px solid black;">
									...
									<div style="width:50.5%;height:25.5mm;border-right:1px solid black;border-bottom:1px solid black;word-break:break-all;">
										...
										<input type="checkbox" class="styCkboxNM" style="margin-top:1px;margin-left:17px;">
									...
									<div style="width:48.2%;height:25mm;border-right:0px solid black;border-bottom:0px solid black;word-break:break-all;">
										<span style="font-weight:bold;width:5mm;height:9mm;float:left;padding-left:.5mm;">6</span>
										<span style="font-family:Arial;display:inline;">Person subject to<br></br>withholding:</span> <br /><br></br>
										...
										<input type="checkbox" class="styCkboxNM" style="margin-top:1px;margin-left:11px;">
											<xsl:call-template name="PopulateCheckbox">
												<xsl:with-param name="TargetNode" select="$FormData/ForeignPersonSubjectToWthldGrp/IndividualInd"/>
												<xsl:with-param name="BackupName">IRS8288A/IndividualInd</xsl:with-param>
											</xsl:call-template>
									...
									<!-- Box 7 -->
									<div style="width:50.5%;height:10mm;border-right:1px solid black;border-bottom:0px solid black;">
										<span style="font-weight:bold;width:5mm;height:0mm;float:left;padding-left:1.5mm;">7</span>
									<span style="font-family:Arial;width:40mm;padding-left:5mm;">Country code of person <br/> subject to withholding: </span><br />
									<span style="width:100%;text-align:center;">
										<xsl:call-template name="PopulateText">
