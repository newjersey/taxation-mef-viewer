...
<!--						<div class="styForm8865ScheduleOFN" style="width:28mm;height:17.25mm;float:left;">  -->
						<div class="styForm8865ScheduleOFN" style="width:28mm;height:18mm;float:left;">				
							<span class="styForm8865ScheduleOFST" style="margin-left:0mm;padding-bottom:0px;">SCHEDULE O </span>
							<span class="styFBT" style="font:size:9pt;padding-top:0px;">(Form 8865)</span>
							<!--  Form Link -->
							<xsl:call-template name="SetFormLinkInline">
								<xsl:with-param name="TargetNode" select="$Form8865ScheduleOData"/>
							</xsl:call-template><br/>
              <span style="font-size:6.5pt;font-family:'Arial';">(Rev. December 2020)</span><br/>
							<span class="styAgency">Department of the Treasury</span>
							<br/>
							<span class="styAgency">Internal Revenue Service</span>
						</div>
						<div class="styFTBox" style="width:126mm;height:18mm;">
 ...
 <!--         Attach to Form 8865. See Instructions for Form 8865. -->
			   Go to <i>www.irs.gov/Form8865</i> for instructions and the latest information.
						...
						<div class="styTYBox" style="width:32mm;height:18mm;">
							<div class="styOMB" style="height:4mm;border-bottom-width:0px;">
							  OMB No. 1545-1668
							</div>
					...
					<div class="styTableContainer" style="height:auto;display:block;" id="TPctn">
						...
						<table class="styDynamicTable" cellspacing="0" cellpadding="0" style="height:auto;display:block;">
								<tr>
									...
									<td class="styForm8865ScheduleOTablesCells" style="width:20mm;height: 4mm; background-color:lightgrey"> </td>
									<td class="styForm8865ScheduleOTablesCells" style="width:28mm;height: 4mm; background-color:lightgrey"> </td>
									<td class="styForm8865ScheduleOTablesCells" style="width:27mm;text-align: right; padding-left: 1.5mm">
										<xsl:call-template name="PopulateAmount" >
									...
									<td class="styForm8865ScheduleOTablesCells" style="width:20mm;height: 4mm; background-color:lightgrey"> </td>
									<td class="styForm8865ScheduleOTablesCells" style="width:20mm;height: 4mm; background-color:lightgrey"> </td>
									<td class="styForm8865ScheduleOTablesCells" style="width:27mm;text-align: right; padding-left: 1.5mm;border-right:0;">
										<xsl:call-template name="PopulateAmount">
								...
								<tr>
									<td style="width:5mm;height:4mm;vertical-align:center;">3</td>
									<td style="width:160mm;height:4mm;vertical-align:center;" colspan="8">
						...
						<tbody>
							<xsl:for-each select="$Form8865ScheduleOData/SupplementalInformationTxt">
								<xsl:if test="($Print != $Separated) or (count($Form8865ScheduleOData/SupplementalInformationTxt) &lt;=4)">
									<tr style="height:4mm; width: 180mm; font-size: 7pt">
							...
							<xsl:if test="count($Form8865ScheduleOData/SupplementalInformationTxt) &lt; 1 or ((count($Form8865ScheduleOData/SupplementalInformationTxt) &gt;4) and ($Print =    $Separated))">
								<tr style="font-size: 7pt">
									<td style="border-bottom:1px solid black; padding-left:2mm; height:4mm; width:185mm; font-size: 7pt">
						...
						<span>
							...
							<div class="styLNDesc" style="width:15mm;height:4.5mm;text-align:right;padding-top:3mm;">
								<span>
									...
									<input type="checkbox" class="styCkbox" name="Checkbox" alt="subject to gain recognition yes">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8865ScheduleOData/TransferRptOnSubjectToGainInd"/>
										</xsl:call-template>
									</input>
							...
							<div class="styLNDesc" style="width:15mm;height:4.5mm;text-align:right;padding-top:3mm;">
								<span>
									...
									<input type="checkbox" class="styCkbox" name="Checkbox" alt="subject to gain recognition no">
										<xsl:call-template name="PopulateNoCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8865ScheduleOData/TransferRptOnSubjectToGainInd"/>
										</xsl:call-template>
									</input>
      ...
      <span style="width:20px;"/>
						<span class="styBoldText">Schedule O (Form 8865) 12-2020</span>
					</div>
					<br/>
					<div class="pageEnd"/>
	...
	<xsl:template name="p1Template5">
		...
		<xsl:if test="$index &lt;= $max">
			<tr>
				...
				<xsl:if test="$index = 1">
					<td class="styForm8865ScheduleOTablesCells" scope="row" style="width:20mm;text-align:left" colspan="2">
						<xsl:attribute name="rowspan"><xsl:value-of select="$max"/></xsl:attribute>        
					  Other<br/>property  
					</td>
				</xsl:if>
				...
				<td class="styForm8865ScheduleOTablesCells" style="width:28mm;">
					<xsl:call-template name="PopulateText">
						<xsl:with-param name="TargetNode" select="$Form8865ScheduleOData/OtherPropertyTransfersGrp[$index]/PropertyDesc"/>
					</xsl:call-template>
				</td>
				<td class="styForm8865ScheduleOTablesCells" style="width:27mm;">
					<xsl:call-template name="PopulateAmount">
						<xsl:with-param name="TargetNode" select="$Form8865ScheduleOData/OtherPropertyTransfersGrp[$index]/FairMarketValueOnDtOfTrnsfrAmt"/>
					</xsl:call-template>
				</td>
				...
				<td class="styForm8865ScheduleOTablesCells" style="width:20mm;text-align:left">
					<xsl:call-template name="PopulateText">
				...
				<td class="styForm8865ScheduleOTablesCells" style="width:27mm;border-right:0;">
					<xsl:call-template name="PopulateAmount">
						<xsl:with-param name="TargetNode" select="$Form8865ScheduleOData/OtherPropertyTransfersGrp[$index]/GainRecognizedOnTransferAmt"/>
					</xsl:call-template>
				</td>
