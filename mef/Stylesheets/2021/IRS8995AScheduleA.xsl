			...
			<body class="styBodyClass">
				<form id="Form8995AScheduleA">
					...
					<div class="sty8995ASALineDiv" style="border-top:1px solid black;padding-top:0.5mm;padding-bottom:0.5mm;font-style:italic;">
						...
						income is more than $164,900 but not $214,900 ($164,925 and $214,925 if married filing separately; $329,800 and $429,800 if married filing jointly). If your taxable income isn’t more than $164,900
							...
							<xsl:if test="$pos = 1">
								...
								<div class="sty8995ASALineDiv">
									...
									<div class="sty8995ASADesc" style="height:13mm;width:43mm;">
										Threshold. Enter $164,900 ($164,925 if married filing separately; $329,800 if married filing jointly)
										<span class="sty8995ASchADotLn">......</span>
									</div>
									...
									<div class="sty8995ASAAmtBox" style="height:13mm;background-color:lightgrey;">&nbsp;</div>
									<div class="sty8995ASAAmtBox" style="height:13mm;background-color:lightgrey;">&nbsp;</div>
									<div class="sty8995ASAAmtBox" style="height:13mm;background-color:lightgrey;">&nbsp;</div>
								</div>
								<!-- Line 7 -->
					...
					<div class="styStdDiv pageEnd" style="border-top:2px solid black;">
						...
						<span style="float:right;font-weight:bold;">Schedule A (Form 8995-A) 2021</span>
					</div>
