...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:variable name="FormUpperRightNumber">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">430121</xsl:when>
			<xsl:otherwise>430121</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="FormUpperRightNumber2">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">430221</xsl:when>
			<xsl:otherwise>430221</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="FormUpperRightNumber3">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">430321</xsl:when>
			<xsl:otherwise>430321</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="CityStateZipText">
		<xsl:choose>
			...
			<xsl:otherwise>Ciudad o pueblo, estado o provincia , pais y código postal &lt;i&gt;(ZIP)&lt;/i&gt; o c&amp;#243;digo postal extranjero&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="Line1Text">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">Number of agricultural employees employed in the pay period that includes March 12, 2021</xsl:when>
			<xsl:otherwise>Número de empleados agrícolas durante el período de nómina que incluye el 12 de marzo de 2021</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="Line2Text">
		<xsl:choose>
			...
			<xsl:otherwise>&lt;span style="float:left"&gt;Salarios sujetos a la contribuci&amp;#243;n al Seguro Social&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="Line3aText">
		<xsl:choose>
			...
			<xsl:otherwise>Contribuci&amp;#243;n al Seguro Social por los salarios de licencia por enfermedad calificados (multiplique la l&amp;#237;nea &lt;b&gt;2a&lt;/b&gt;&lt;span style="float:left"&gt; por el 6.2% (0.062))&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line3bText">
		<xsl:choose>
			...
			<xsl:otherwise>Contribuci&amp;#243;n al Seguro Social por los salarios de licencia familiar calificados (multiplique la l&amp;#237;nea &lt;b&gt;2b&lt;/b&gt; por el 6.2%&lt;span style="float:left"&gt; (0.062))&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line4Text">
		<xsl:choose>
			...
			<xsl:otherwise>&lt;span style="float:left;"&gt;Salarios sujetos a la contribuci&amp;#243;n al Medicare&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="Line6Text">
		<xsl:choose>
			...
			<xsl:otherwise>&lt;span style="float:left"&gt;Salarios sujetos a la retenci&amp;#243;n de la Contribuci&amp;#243;n Adicional al &lt;i&gt;Medicare&lt;/i&gt;&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="Line9Text">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;Total taxes before adjustments. Add lines 3, 3a, 3b, 5, 7, and 8&lt;/span&gt;</xsl:when>
			<xsl:otherwise>&lt;span style="float:left"&gt;Total de contribuciones antes de los ajustes. Sume las l&amp;#237;neas &lt;b&gt;3&lt;/b&gt;, &lt;b&gt;3a&lt;/b&gt;, &lt;b&gt;3b&lt;/b&gt;, &lt;b&gt;5&lt;/b&gt; y &lt;b&gt;7&lt;/b&gt;&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="Line12bText">
		<xsl:choose>
			...
			<xsl:otherwise>Porci&amp;#243;n no reembolsable del cr&amp;#233;dito por los salarios de licencia de enfermedad y familiar calificados&lt;span style="float:left"&gt;de la Hoja de Trabajo 1&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line12cText">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left;padding-right:1mm"&gt;Nonrefundable portion of employee retention credit&lt;/span&gt;</xsl:when>
			<xsl:otherwise>&lt;span style="float:left"&gt;Porci&amp;#243;n no reembolsable del cr&amp;#233;dito de retenci&amp;#243;n de empleados de la Hoja de Trabajo 1&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line12dText">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left;padding-right:1mm"&gt;Nonrefundable portion of credit for qualified sick and family leave wages for leave taken after March 31, 2021&lt;/span&gt;</xsl:when>
			<xsl:otherwise>Total de cr&amp;#233;ditos no reembolsables. Sume las l&amp;#237;neas &lt;b&gt;12a&lt;/b&gt;, &lt;b&gt;12b&lt;/b&gt; y &lt;b&gt;12c&lt;/b&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line12eText">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left;padding-right:1mm"&gt;Nonrefundable portion of COBRA premium assistance credit&lt;/span&gt;</xsl:when>
			<xsl:otherwise>&lt;span style="float:left"&gt;&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line12fText">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left;padding-right:1mm"&gt;Number of individuals provided COBRA premium assistance&lt;/span&gt;</xsl:when>
			<xsl:otherwise>&lt;span style="float:left"&gt;&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line12gText">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left;padding-right:1mm"&gt;Total nonrefundable credits. Add lines 12a, 12b, 12c, 12d, and 12e&lt;/span&gt;</xsl:when>
			<xsl:otherwise></xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line13Text">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;Total taxes after adjustments and nonrefundable credits. Subtract line 12g from line 11&lt;/span&gt;</xsl:when>
			<xsl:otherwise>Total de las contribuciones despu&amp;#233;s de considerar los ajustes y cr&amp;#233;ditos. Reste la l&amp;#237;nea &lt;b&gt;12d&lt;/b&gt; de la l&amp;#237;nea &lt;b&gt;11&lt;/b&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line14aText">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;Total deposits for 2021, including overpayment applied from a prior year and Form 943-X&lt;/span&gt;</xsl:when>
			<xsl:otherwise>Total de dep&amp;#243;sitos hechos en 2021, incluyendo todo exceso pagado y aplicado de un a&amp;#241;o anterior&lt;br/&gt;&lt;span style="float:left"&gt;y cantidad pagada en exceso aplicada del Formulario 943-X (PR)&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line14bText">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;Reserved for future use&lt;/span&gt;</xsl:when>
			<xsl:otherwise>&lt;span style="float:left"&gt;Cantidad diferida de la parte del patrono de la contribuci&amp;#243;n al Seguro Social&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line14cText">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;Reserved for future use&lt;/span&gt;</xsl:when>
			<xsl:otherwise>Porci&amp;#243;n reembolsable del cr&amp;#233;dito por los salarios de licencia de enfermedad y familiar calificados&lt;span style="float:left"&gt;de la Hoja de Trabajo 1&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line14dText">
		<xsl:choose>
			...
			<xsl:otherwise>&lt;span style="float:left"&gt;Porci&amp;#243;n reembolsable del cr&amp;#233;dito de retenci&amp;#243;n de empleados de la Hoja de Trabajo 1&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line14eText">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;Refundable portion of employee retention credit&lt;/span&gt;</xsl:when>
			<xsl:otherwise>Total de cr&amp;#233;ditos, cantidades diferidas y cr&amp;#233;ditos reembolsables. Sume las l&amp;#237;neas &lt;b&gt;14a,&lt;/b&gt; &lt;b&gt;14b,&lt;/b&gt; &lt;b&gt;14c&lt;/b&gt; y &lt;b&gt;14d&lt;/b&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line14fText">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;Refundable portion of credit for qualified sick and family leave wages for leave taken after March 31, 2021&lt;/span&gt;</xsl:when>
			<xsl:otherwise>Total de anticipos recibidos por la radicaci&amp;#243;n del (de los) Formulario(s) 7200(SP) para el a&amp;#241;o</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line14gText">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;Refundable portion of COBRA premium assistance credit&lt;/span&gt;</xsl:when>
			<xsl:otherwise>Total de cr&amp;#233;ditos, cantidades diferidas y cr&amp;#233;ditos reembolsables menos anticipos. Reste la l&amp;#237;nea &lt;b&gt;14f&lt;/b&gt; de&lt;span style="float:left"&gt;la l&amp;#237;nea &lt;b&gt;14e&lt;/b&gt;&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line14hText">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;Total deposits and refundable credits. Add lines 14d, 14e, 14f, and 14g&lt;/span&gt;</xsl:when>
			<xsl:otherwise>Total deposits and refundable credits. Add lines 14d, 14e, 14f, and 14g&lt;/b&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line14iText">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;Total advances received from filing Form(s) 7200 for the year&lt;/span&gt;</xsl:when>
			<xsl:otherwise>&lt;span style="float:left"&gt;Total advances received from filing Form(s) 7200 for the year&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line14jText">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;Total deposits and refundable credits less advances. Subtract line 14i from line 14h&lt;/span&gt;</xsl:when>
			<xsl:otherwise>Total deposits and refundable credits less advances. Subtract line 14i from line 14h&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line15Text">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;&lt;b&gt;Balance due.&lt;/b&gt; If line 13 is more than line 14j, enter the difference and see the instructions&lt;/span&gt;</xsl:when>
			<xsl:otherwise>&lt;b&gt;Saldo adeudado.&lt;/b&gt; Si la l&amp;#237;nea &lt;b&gt;13&lt;/b&gt; es mayor que la l&amp;#237;nea &lt;b&gt;14g&lt;/b&gt;, anote la diferencia y vea las instrucciones</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="AllFilersText">
		<xsl:choose>
			...
			<xsl:otherwise>&lt;b&gt;Todos los contribuyentes:&lt;/b&gt; Si la l&amp;#237;nea &lt;b&gt;13&lt;/b&gt; es menos de $2,500, &lt;b&gt;no complete&lt;/b&gt; la l&amp;#237;nea &lt;b&gt;17 &lt;/b&gt;ni el Formulario 943A-PR.</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="Line18Text">
		<xsl:choose>
			...
			<xsl:otherwise>&lt;span style="float:left"&gt;Gastos calificados del plan de salud asignados a los salarios de licencia por enfermedad calificados&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line19Text">
		<xsl:choose>
			...
			<xsl:otherwise>&lt;span style="float:left"&gt;Gastos calificados del plan de salud asignados a los salarios de licencia familiar calificados&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line20Text">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;Qualified wages for the employee retention credit&lt;/span&gt;</xsl:when>
			<xsl:otherwise>&lt;span style="float:left"&gt;Salarios calificados para el cr&amp;#233;dito de retenci&amp;#243;n de empleados&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line21Text">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;Qualified health plan expenses for the employee retention credit&lt;/span&gt;</xsl:when>
			<xsl:otherwise>&lt;span style="float:left"&gt;Gastos calificados del plan de salud asignados a los salarios declarados en la l&amp;#237;nea &lt;b&gt;20&lt;/b&gt;&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="Line22Text">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;Qualified sick leave wages for leave taken after March 31, 2021&lt;/span&gt;</xsl:when>
			<xsl:otherwise>&lt;span style="float:left"&gt;Cr&amp;#233;dito de la l&amp;#237;nea &lt;b&gt;11&lt;/b&gt; del Formulario 5884-C para el a&amp;#241;o&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line23Text">
		<xsl:choose>
			...
			<xsl:otherwise>&lt;span style="float:left"&gt;Qualified health plan expenses allocable to qualified sick leave wages reported on line 22&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<!--<xsl:variable name="Line24Text">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;Amounts under certain collectively bargained agreements allocable to qualified sick leave wages reported on line 22&lt;/span&gt;</xsl:when>
			<xsl:otherwise></xsl:otherwise>
		</xsl:choose>
	</xsl:variable>-->
	<xsl:variable name="Line25Text">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;Qualified family leave wages for leave taken after March 31, 2021&lt;/span&gt;</xsl:when>
			<xsl:otherwise>&lt;span style="float:left"&gt;Qualified family leave wages for leave taken after March 31, 2021&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line26Text">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;Qualified health plan expenses allocable to qualified family leave wages reported on line 25&lt;/span&gt;</xsl:when>
			<xsl:otherwise>&lt;span style="float:left"&gt;Qualified health plan expenses allocable to qualified family leave wages reported on line 25&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<!--<xsl:variable name="Line27Text">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;Amounts under certain collectively bargained agreements allocable to qualified family leave wages reported on line 25&lt;/span&gt;</xsl:when>
			<xsl:otherwise></xsl:otherwise>
		</xsl:choose>
	</xsl:variable>-->
	<xsl:variable name="Line28Text">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">If you're eligible for the employee retention credit in the third quarter solely because your business is a recovery &lt;span style="float:left"&gt;startup business, enter the total of any amounts included on lines 12c and 14e for
the third quarter&lt;/span&gt;</xsl:when>
			<xsl:otherwise>If you're eligible for the employee retention credit in the third quarter solely because your business is a recovery &lt;span style="float:left"&gt;startup business, enter the total of any amounts included on lines 12c and 14e for
the third quarter&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line29Text">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">If you're eligible for the employee retention credit in the fourth quarter solely because your business is a &lt;span style="float:left"&gt;recovery startup business, enter the total of any amounts included on lines 12c and 14e for
the fourth quarter &lt;/span&gt;</xsl:when>
			<xsl:otherwise>If you're eligible for the employee retention credit in the fourth quarter solely because your business is a &lt;span style="float:left"&gt;recovery startup business, enter the total of any amounts included on lines 12c and 14e for
the fourth quarter &lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
		...
		<html lang="{$HtmlLang}">
			...
			<body class="styBodyClass">
				<form name="Form943">
					...
					<xsl:if test="$Language='SPANISH'">
						<div class="styBB" style="width:187mm;float:none;clear:both;">
							<div class="styLNDesc" style="width:187mm;height:4.4mm">
								<span style="float:left;">Si no tien que radicar esta planilla en el futuro, marque esta casilla</span>
					...
					<div class="styFNBox" style="border-right:0px solid black;width:30mm;padding-left:1mm;padding-top:0mm;font-size:5.6px">
							<span class="styBoldText">
					...
					<div class="styBB" style="width:187mm;border-bottom-width:0px;float:none;clear:both;">
						...
						<xsl:choose>
							<xsl:when test="$Language = 'ENGLISH'">
								<div class="styLNRightNumBox">
									<xsl:value-of disable-output-escaping="yes" select="$SpanishBreak"/>12a
								</div>
								<div class="styLNAmountBox" style="width:30mm;">
									<xsl:value-of disable-output-escaping="yes" select="$SpanishBreak"/>
									<span style="font-size:6pt;">
					...
					<!-- END LINE 12c -->
					<!-- BEGIN LINES 12d, 12e, 12f and 12g ENGLISH -->
					<xsl:if test="$Language= 'ENGLISH'">
						<!-- BEGIN LINE 12d -->
						<div class="styBB" style="width:187mm;border-bottom-width:0px;float:none;clear:both;">
					...
					<!-- END LINES 12d, 12e, 12f and 12g ENGLISH -->
					<!-- BEGIN LINE 12d SPANISH -->
					<xsl:if test="$Language='SPANISH'">
						<div class="styBB" style="width:187mm;border-bottom-width:0px;float:none;clear:both;">
							<div class="styLNLeftNumBox" style="text-align:center;padding-left:2mm">d</div>
							<div class="styLNDesc" style="width:140.8mm;">
					...
					<div class="styBB" style="width:187mm;border-bottom-width:1px;float:none;clear:both;">
						...
						<div class="styLNAmountBox" style="font-size:6pt;width:30mm;border-bottom-width:0px;">
							<xsl:call-template name="PopulateAmount">
							...
							<xsl:choose>
								<xsl:when test="$Language = 'ENGLISH'">
									<div class="styLNDesc" style="width:130mm;padding-left:28mm;font-weight:bold;">
										You must complete both pages of Form 943 and sign it.
									</div>
								</xsl:when>
								<xsl:otherwise> 
									<div class="styLNDesc" style="width:130mm;padding-left:8mm;">
										<img src="{$ImagePath}/1040PR_Bullet_Sm.gif" alt="Bullet Image"/>
										<b> TIENE</b> que completar las tres páginas del Formulario 943-PR y luego <b>FIRMARLO</b>.
									</div>
								</xsl:otherwise>
							</xsl:choose>
						</span>
					...
					<div class="styBB" style="width:187mm;border-bottom-width:0px;float:none;clear:both;">
						...
						<xsl:choose>
							<xsl:when test="$Language = 'ENGLISH'">
								<div class="styLNRightNumBox">
									<xsl:value-of disable-output-escaping="yes" select="$SpanishBreak"/>14a
								</div>
								<div class="styLNAmountBox" style="width:30mm;">
									<xsl:value-of disable-output-escaping="yes" select="$SpanishBreak"/>
									<span style="font-size:6pt;">
					...
					<div class="styBB" style="width:187mm;border-bottom-width:0px;float:none;clear:both;">
						...
						<xsl:choose>
							...
							<xsl:otherwise>
								<div class="styLNRightNumBox">14d</div>
								<div class="styLNAmountBox" style="font-size:6pt;width:30mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/RfdblCrQlfySLFMLWagesAmt"/>
									</xsl:call-template>
					...
					<xsl:if test="$Language='SPANISH'">
						<div class="styBB" style="width:187mm;border-bottom-width:0px;float:none;clear:both;">
							...
							<div class="styLNRightNumBox">14f</div>
							<div class="styLNAmountBox" style="font-size:6pt;width:30mm;">
								<xsl:call-template name="PopulateAmount">
					...
					<!-- END LINE 14f SPANISH -->
					<!-- BEGIN LINE 14g SPANISH -->
					<xsl:if test="$Language='SPANISH'">
						<div class="styBB" style="width:187mm;border-bottom-width:0px;float:none;clear:both;">
							<div class="styLNLeftNumBox" style="text-align:center;padding-left:2mm">g</div>
							<div class="styLNDesc" style="width:140.8mm;">
					...
					<!-- END LINE 14g SPANISH -->
					<!-- BEGIN LINES 14f and 14g ENGLISH -->
					<xsl:if test="$Language='ENGLISH'">
						<!-- BEGIN LINE 14f -->
						<div class="styBB" style="width:187mm;border-bottom-width:0px;float:none;clear:both;">
							<div class="styLNLeftNumBox" style="text-align:center;padding-left:2mm">f</div>
						...
						<!-- END LINES 14f and 14g ENGLISH -->	
						<!-- BEGIN LINES 14h, 14i and 14j ENGLISH (Spanish version done in ENG also) -->
						<!-- BEGIN LINE 14h -->
						<div class="styBB" style="width:187mm;border-bottom-width:0px;float:none;clear:both;">
					...
					<xsl:if test="$Language='SPANISH'">
						<div class="styBB" style="width:187mm;padding-bottom:.5mm;float:none;clear:both;border-bottom-width:0px">
							<div class="styLNLeftNumBox">16</div>
							<div class="styLNDesc" style="width:141mm;float:left;">
								<span style="float:left;">
									<b>Cantidad pagada en exceso.</b> Si la línea <b>14g</b> es mayor que la línea <b>13</b>, anote la diferencia</span>
								<!--Dotted Line-->
								<img style="float:right;padding-right:3.0mm;padding-top:.5mm;" src="{$ImagePath}/1040PR_Bullet_Sm.gif" alt="Bullet Image"/>
								<span class="styDotLn" style="float:right;">.....</span>
							</div>
					...
					<xsl:if test="$Language='ENGLISH'">
						<div class="styBB" style="width:187mm;float:none;clear:both;">
							...
							<div class="styLNDesc" style="width:140.8mm;float:left;">
								<b>Overpayment.</b> If line 14j is more than line 13, enter the difference
								<span style="float:right">								
									<span class="styDotLn">............</span> 
									<img style="padding-right:1.5mm;padding-top:.5mm;" src="{$ImagePath}/1040PR_Bullet_Sm.gif" alt="Bullet Image"/>
								</span>
							</div>
							...
							<div style="width:187mm;float:left;padding-left:2mm;">
								<span style="padding-left:6mm">Check one:</span>
								<span>
									<xsl:call-template name="PopulateSpan">
										<xsl:with-param name="TargetNode" select="$FormData/OverpaymentGrp/ApplyOverpaymentNextReturnInd"/>
									</xsl:call-template>
						...
						<xsl:if test="$Language='ENGLISH'">
							<div class="styGenericDiv" style="width:187mm;float:left;">
								...
								<div style="float:left;font-size:6.5pt;">
									...
									<span style="padding-left:2mm;padding-right:2mm;">										
										<span class="styDotLn">....................</span>
										<img style="float:right;padding-right:1.5mm;padding-top:.5mm;" src="{$ImagePath}/1040PR_Bullet_Sm.gif" alt="Bullet Image"/>
									</span>
					...
					<xsl:choose>
						...
						<xsl:otherwise>
							<div class="styBB" style="width:187mm;border-bottom-width:0px;float:none;clear:both;">
								...
								<div class="styLNRightNumBox" style="border-bottom-width:1px;">22</div>
								<div class="styLNAmountBox" style="font-size:6pt;width:30mm;border-bottom-width:1px">
									<xsl:call-template name="PopulateAmount">
					...
					<!-- END LINE 22 -->
					<!-- BEGIN LINES 23-29 ENGLISH ONLY -->
					<!--<xsl:if test="$Language='ENGLISH'">-->
						<!-- BEGIN LINE 23 -->
						<div class="styBB" style="width:187mm;border-bottom-width:0px;float:none;clear:both;">
						...
						<div class="styBB" style="width:187mm;border-bottom-width:0px;float:none;clear:both;">
							...
							<div class="styLNDesc" style="width:140.8mm;height:6mm;">
								Amounts under certain collectively bargained agreements allocable to qualified sick leave wages reported 
								<span style="float:left;">on line 22</span>
								<span class="styDotLn" style="float:right;">...............................</span>
							</div>
						...
						<div class="styBB" style="width:187mm;border-bottom-width:0px;float:none;clear:both;">
							...
							<div class="styLNDesc" style="width:140.8mm;height:6mm;">
								Amounts under certain collectively bargained agreements allocable to qualified family leave wages reported 
								<span style="float:left;">on line 25</span>
								<span class="styDotLn" style="float:right;">...............................</span>
							</div>
							<div class="styLNRightNumBox" style="height:6mm;padding-top:2.5mm">27</div>
							<div class="styLNAmountBox" style="font-size:6pt;width:30mm;height:6mm;padding-top:2.5mm">
								<xsl:call-template name="PopulateAmount">
						...
						<div class="styBB" style="width:187mm;border-bottom-width:0px;float:none;clear:both;">
							...
							<div class="styLNDesc" style="width:140.8mm;height:7mm;">
								<xsl:value-of disable-output-escaping="yes" select="$Line28Text"/>
								<span class="styDotLn" style="float:right;">...</span>
							</div>
							<div class="styLNRightNumBox" style="height:7mm;padding-top:3.5mm">28</div>
							...
							<!--<div class="styLNRightNumBox" style="border-bottom-width:1px;height:7mm;padding-top:3.5mm">
								<xsl:value-of disable-output-escaping="yes" select="$SpanishBreak"/>28
							</div>
							<div class="styLNAmountBox" style="width:30mm;border-bottom-width:1px;height:7mm;padding-top:3.5mm">
								<xsl:value-of disable-output-escaping="yes" select="$SpanishBreak"/>
								<span style="font-size:6pt;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/EligEmplRtntnCrRcvryStUp3rdAmt"/>
						...
						<div class="styBB" style="width:187mm;border-bottom-width:1px;float:none;clear:both;">
							...
							<div class="styLNRightNumBox" style="height:7mm;padding-top:4mm;border-bottom-width:0px;">29</div>
							<div class="styLNAmountBox" style="font-size:6pt;width:30mm;height:7mm;padding-top:4mm;border-bottom-width:0px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/EligEmplRtntnCrRcvryStUp4thAmt"/>
								</xsl:call-template>
							</div>
							<!--<div class="styLNRightNumBox" style="border-bottom-width:0px;height:7mm;padding-top:4mm">
								<xsl:value-of disable-output-escaping="yes" select="$SpanishBreak"/>29
							</div>
							<div class="styLNAmountBox" style="width:30mm;border-bottom-width:0px;height:7mm;padding-top:4mm">
								<xsl:value-of disable-output-escaping="yes" select="$SpanishBreak"/>
								<span style="font-size:6pt;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/EligEmplRtntnCrRcvryStUp4thAmt"/>
