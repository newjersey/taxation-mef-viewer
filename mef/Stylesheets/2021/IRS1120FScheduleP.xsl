		  ...
		  <div class="styGenericDiv" style="width:187mm;">
			...
			<div class="styGenericDiv" style="width:187mm;clear:all;height:auto;">
			  ...
			  <div class="styGenericDiv" style="width:187mm;clear:all;height:auto;">
				...
				<div style="width:187mm;">
					...
					<tbody>
						...
						<xsl:for-each select="$FormData/ForeignPartnerInformationGrp">
						  ...
						  <!--Table Header-->
							<tr>
							  ...
							  <td colspan="5" class="styTableCellHeader" style="border:none;font-weight:bold;font-size:8pt;">Schedules K-3</td>
							</tr>
							<tr>
							...
							<!--Line 1-->
							<tr>
							  <td class="sty1120FSchPTableK1CellNumSD" style="padding-left:1.5mm;padding-bottom:5.0mm;">1</td>
							...
							<!--Line 2-->
							<tr>
							  <td class="sty1120FSchPTableK1CellNumSD" style="padding-left:1.5mm;padding-bottom:5.1mm">2</td>
							...
							<!--Line 3-->
							<tr>
							  <td class="sty1120FSchPTableK1CellNumSD" style="padding-left:1.5mm;padding-bottom:5.6mm">3</td>
							  <td class="sty1120FSchPTableK1Desc" scope="row">
						        <b>Gross ECI - Partner determination.</b> Enter all applicable amounts from Schedule K-3, Part X, Section 1, column (b) (see instructions). 
								<span class="sty1120FSchPDotLn" style="float:right;">...</span>
							  </td>
							  <xsl:call-template name="CreateTable">
								<xsl:with-param name="Start" select="position()"/>
							...
							<!--Line 5-->
							<tr>
							  <td class="sty1120FSchPTableK1CellNumSD" style="border-bottom-width:0px; padding-left:1.5mm;padding-bottom:10.5mm">5</td>
							...
							<!--Line 6-->
							<tr>
							  <td class="sty1120FSchPTableK1CellNumSD" style="padding-left:1.5mm;padding-bottom:10mm">6</td>
							  <td class="sty1120FSchPTableK1Desc" style="border-bottom-width:0px" scope="row">
							...
							<tr>
							  ...
							  <td class="sty1120FSchPTableK1Desc" scope="row">
						        ...
						        <br/>(<b>Note: </b> Include the line 7 total on <span style="float:left;">Schedule I, line 22.) </span>
								<span class="sty1120FSchPDotLn" style="float:right;">................</span>
							  </td>
							  <xsl:call-template name="CreateTablePaddingTop">
								<xsl:with-param name="Start" select="position()"/>
							...
							<!--Line 8-->
							<tr>
							  <td valign="top" class="sty1120FSchPTableK1CellNumSD" style=";padding-top:1mm;border-bottom-width:2px;">8</td>
					  ...
					  <xsl:if test="($Print = $Separated and count($FormData/ForeignPartnerInformationGrp) &gt; 4) or count($FormData/ForeignPartnerInformationGrp) = 0">
						<!--Table Header-->
						  ...
						  <!--Line 6-->
						  <tr>
							<td class="sty1120FSchPTableK1CellNumSD" style="border-bottom-width:0px; padding-left:1.5mm;padding-bottom:10mm">6</td>
							<td class="sty1120FSchPTableK1Desc" style="border-bottom-width:0px" scope="row">
                              <b>Total deductions and losses deductible against gross ECI - Partner determination</b>.  Enter all applicable amounts from Schedule K-3, Part X, Section 2, column (b) (see instructions).
					          <span class="sty1120FSchPDotLn" style="float:right;">...............</span>
							</td>
						  ...
						  <tr>
							<td class="sty1120FSchPTableK1CellNumSD" style=";padding-bottom:8.0mm;">7</td>
							<td class="sty1120FSchPTableK1Desc" scope="row">
					          Interest expense directly allocable under 
					          <br/>Regulations section 1.882-5(a)(1)(ii)(B). (<b>Note:</b> Include the
				              line 7 total on  Schedule I, line 22.)  
					          <span class="sty1120FSchPDotLn" style="float:right;">....................</span>
							</td>
							<xsl:call-template name="CreateTablePaddingTop">
							  <xsl:with-param name="Start" select="1"/>
						  ...
						  <!--Line 8-->
						  <tr>
							<td class="sty1120FSchPTableK1CellNumSD" style=";padding-bottom:17.0mm;border-bottom-width:2px;">8</td>
							<td class="sty1120FSchPTableK1Desc" style="border-bottom-width:2px" scope="row">
					          Interest expense on U.S.-booked liabilities as described under Regulations section 1.882-5(d)(2)(vii).  Enter the amount from Schedule K-3, Part X, Section 2, line 7, column (b).  Include the line 8 total on Schedule I, line 9, column (b). 
					          <span class="sty1120FSchPDotLn" style="float:right;">.....</span>
							</td>
				  ...
				  <div style="width:187mm;padding-top:1mm">
					...
					<span style="font-weight:bold;float:right;">Schedule P (Form 1120-F) 2021</span>
				  </div>
				  ...
				  <!-- Begin Page 2 -->
				  <div style="width:187mm">
				    <span style="font-weigh:normal;float:left;">Schedule P (Form 1120-F) 2021</span>
					...
					<!-- Begin Part III Table -->
						  ...
						  <xsl:if test="$Print != $Separated or ($Print = $Separated and count($FormData/ForeignPartnerInformationGrp) &lt; 5)">
							...
							<xsl:for-each select="$FormData/ForeignPartnerInformationGrp">
							  <xsl:if test="position() mod 4 = 1">
								...
								<!--Line 9-->
								<tr>
								  <td class="sty1120FSchPTableK1CellNumSD" style="padding-top:2.5mm;">9</td>
								  <td class="sty1120FSchPTableK1Desc" scope="row">
								...
								<!--Line 10a-->
								<tr>
								  <td valign="top" class="sty1120FSchPTableK1CellNumSD" style="padding-top:2mm;padding-left:0.9mm">10a</td>
								  <td class="sty1120FSchPTableK1Desc" scope="row" style="padding-left:0.3mm;">
								...
								<!--Line 10b-->
								<tr>
								  <td valign="top" class="sty1120FSchPTableK1CellNumSD" style="padding-left:3.7mm;padding-top:1mm;">b</td>
								  <td class="sty1120FSchPTableK1Desc" scope="row" style="padding-left:0.3mm;">
								...
								<tr>
								  <td valign="top" class="sty1120FSchPTableK1CellNumSD" style="padding-top:2.5mm;">
									<span style="width:2.7mm;padding-left:2.9mm"/>c
								  </td>
								  <td class="sty1120FSchPTableK1Desc" scope="row" style="padding-left:0.3mm;">
								  ...
								  <!--Line 10d-->
								  <tr>
									<td valign="top" class="sty1120FSchPTableK1CellNumSD" style="padding-top:2.7mm;">
									  <span style="padding-left:2.6mm;">d </span> </td>
									<td class="sty1120FSchPTableK1Desc" scope="row" style="padding-left:0.3mm;">
								  ...
								  <!--Line 11-->
								  <tr>
									<td valign="top" class="sty1120FSchPTableK1CellNumSD" style="padding-top:3.5mm;">11</td>
									<td class="sty1120FSchPTableK1Desc" scope="row">
			                          Partner&#8217;s liabilities under Regulations section 1.884-1(d)(3)(vi).
						              <span style="width:2mm"/>(<b>Note: </b>Enter the portion of the 
				                      line 11 total on Schedule I, line 8, column (b) that represents U.S. booked liabilities under
								  ...
								  <!--Line 12-->
								  <tr>
									<td valign="top" class="sty1120FSchPTableK1CellNumSD" style="padding-top:2mm">12</td>
									<td class="sty1120FSchPTableK1Desc" scope="row">
									  <b>Partner&#8217;s outside basis under Regulations section 
	                                  1.884-1(d)(3)(vi). </b>  Add lines 10d and 11 
	                                  <span class="sty1120FSchPDotLn" style="float:right;">...........................</span>
									</td>
									<xsl:call-template name="CreateTablePaddingTop">
									  <xsl:with-param name="Start" select="position()"/>
								  ...
								  <!--Line 13-->
								  <tr>
									<td valign="top" class="sty1120FSchPTableK1CellNumSD" style="padding-top:2.8mm">13</td>
									<td class="sty1120FSchPTableK1Desc" scope="row">
						              Partner&#8217;s outside basis allocable to ECI under Regulations section 1.884-1(d)(3)(i) and 1.882-5.
						              (<b>Note: </b> The line 13 total should generally be entered on Schedule I, line 5, column (b).  
								  ...
								  <!--Line 14-->
								  <tr>
									<td valign="top" class="sty1120FSchPTableK1CellNumSD" style="padding-left:0.8mm;border-bottom-width:2px;padding-top:4.2mm;">14</td>
									<td class="sty1120FSchPTableK1Desc" style="border-bottom-width:2px" scope="row">
									...
									<td class="sty1120FSchPTableCellAmountShaded" style="border-bottom-width:2px">
								  <span style="width:1px"/>
									</td>
								  </tr>
								</xsl:if>
							...
							<tr>
							  <td class="sty1120FSchPTableK1CellNumSD" style="padding-left:4.4mm;padding-top:2.5mm;">9</td>
							  <td class="sty1120FSchPTableK1Desc" scope="row">
							...
							<!--Line 10a-->
							<tr>
							  <td valign="top" class="sty1120FSchPTableK1CellNumSD" style="padding-left:0.9mm;padding-top:1mm">10a</td>
							  <td class="sty1120FSchPTableK1Desc" scope="row" style="padding-left:0.3mm;">
					            Partner&#8217;s liabilities included in outside 
					            basis under section 752 that give rise
					            to directly allocable interest expense 
							...
							<!--Line 10b-->
							<tr>
							  <td valign="top" class="sty1120FSchPTableK1CellNumSD" style="padding-left:3.9mm;padding-top:1mm;">b</td>
							  <td class="sty1120FSchPTableK1Desc" scope="row" style="padding-left:0.3mm;">
						        All other liabilities included in partner&#8217;s outside basis under section 752
						        <span class="sty1120FSchPDotLn" style="float:right;">......</span>
							  </td>
							...
							<!--Line 10c-->
							<tr>
							  <td valign="top" class="sty1120FSchPTableK1CellNumSD" style="padding-left:2.8mm;padding-top:3.7mm;">c</td>
							  <td class="sty1120FSchPTableK1Desc" scope="row" style="padding-left:0.3mm;">
					            Add lines 10a and 10b 
					            <span class="sty1120FSchPDotLn" style="float:right;">.............</span>
							  </td>
							...
							<!--Line 10d-->
						    <tr>
							  <td valign="top" class="sty1120FSchPTableK1CellNumSD" style="padding-left:3.0mm;padding-top:2.75mm;">d</td>
							  <td class="sty1120FSchPTableK1Desc" scope="row" style="padding-left:2.6mm;">
					            Subtract line 10c from line 9 
					            <span class="sty1120FSchPDotLn" style="float:right;">........</span>
							  </td>
							  <xsl:call-template name="CreateTable">
							...
							<!--Line 11-->
							<tr>
							  <td valign="top" class="sty1120FSchPTableK1CellNumSD" style="padding-left:2.8mm;padding-top:3.5mm">11</td>
							  <td class="sty1120FSchPTableK1Desc" scope="row">
					            Partner&#8217;s liabilities under Regulations  section 1.884-1(d)(3)(vi). 
							...
							<!--Line 12-->
							<tr>
							  <td valign="top" class="sty1120FSchPTableK1CellNumSD" style="padding-left:2.8mm;padding-top:1mm">12</td>
							  <td class="sty1120FSchPTableK1Desc" scope="row">
							...
							<tr>
							  ...
							  <!--Line 14-->
							  <tr>
								<td valign="top" class="sty1120FSchPTableK1CellNumSD" style="padding-left:0.8mm;border-bottom-width:2px;padding-top:5.2mm;">14</td>
								<td class="sty1120FSchPTableK1Desc" style="width:100mm;border-bottom-width:2px" scope="row">
                                  Check either the "income" box or the "asset" box to indicate the allocation method used on line 13  (see instructions)  
			                      <span class="sty1120FSchPDotLn" style="float:right;">..........</span>
								</td>
								<xsl:call-template name="CreateTable14">
					  ...
					  <div style="width:187mm;padding-top:0.5mm;">
						...
						<div style="float:right;">
						  ...
						  <span class="styBoldText">Schedule P (Form 1120-F) 2021</span>
						</div>
					  </div>
					  <div class="pageEnd"/>
					  <!-- end page break and footer  -->
							  ...
							  <tbody>
								...
								<tr class="styDepTblRow1">
								  ...
								  <td class="sty1120FSchPTableK1Desc" style="width:60mm;">
						            Total gross income. Enter the amount from Schedule K-3, Part X, Section 1, line 21, column (a).
						           <span class="sty1120FSchPDotLn" style="float:right;">...................</span>
								  </td>
								...
								<tr class="styDepTblRow1">
								  <td class="sty1120FSchPTableK1CellNumSD" style="border-bottom-width:1px; padding-left:1.5mm;padding-bottom:10.5mm">5</td>
								  ...
								  <td class="styDepTblRow3LC" style="padding-top:14mm;">
									<span style="font-size:5.5pt">
									  <xsl:choose>
										<xsl:when test="position() = 1 ">
										  <xsl:call-template name="PopulateAmount">
								...
								<tr class="styDepTblRow1">
								  <td valign="top" class="sty1120FSchPTableK1CellNumSD" style="border-bottom-width:1px">
									<span style="padding-left:3mm; padding-top:2.5mm">8</span>
								  </td>
								  <td class="sty1120FSchPTableK1Desc" style="width:60mm;border-bottom-width:1px">
						  ...
						  <xsl:if test="position() mod 4 = 1">
							...
							<table class="styDepTbl" cellpadding="0" cellspacing="0" style="width:187mm;font-size:7pt">
							  <tbody>
								...
								<tr class="styDepTblHdr">
								  <td colspan="2" class="styTableCellHeader" style="border:none;"/>
								  <td colspan="5" class="styTableCellHeader" style="font-weight:bold;font-size:8pt;">Schedules K-3</td>
								</tr>
								<tr class="styDepTblHdr">
								  <td colspan="2" class="sty1120FSchPTableK1CellHeaderSpacer">
									<span style="width:1px"/>
								...
								<!--Part III, L10a Separated Print-->
								<tr class="styDepTblRow2">
								  <td valign="top" class="sty1120FSchPTableK1CellNumSD" style="padding-top:3mm;padding-left:0.9mm">10a</td>
								  <td class="sty1120FSchPTableK1Desc" style="width:60mm;">
		                            Partner&#8217;s liabilities included in outside
								...
								<!--Part III, L10b Separated Print-->
								<tr class="styDepTblRow1">
								  <td valign="top" class="sty1120FSchPTableK1CellNumSD" style="padding-top:1mm;">
									<span style="padding-left:3.9mm;padding-top:2.mm;">b</span>
								  </td>
								  <td class="sty1120FSchPTableK1Desc" style="width:60mm;">
								...
								<!--Part III, L10c Separated Print-->
								<tr class="styDepTblRow2">
								  <td valign="top" class="sty1120FSchPTableK1CellNumSD" style="padding-top:4mm;">
									<span style="padding-left:2.7mm"/>c
								  </td>
								  <td class="sty1120FSchPTableK1Desc" style="width:60mm;">
									<span style="float:left;padding-left:0.3mm">Add lines 10a and 10b</span>
									<span class="sty1120FSchPDotLn" style="float:right;">..............</span>
								  </td>
								...
								<!--Part III, L10d Separated Print-->
								<tr class="styDepTblRow1">
								  <td valign="top" class="sty1120FSchPTableK1CellNumSD" style="padding-top:2.75mm;">
									<span style="padding-left:2.6mm;"/>d
								  </td>
								  <td class="sty1120FSchPTableK1Desc" style="width:60mm;">
									<span style="float:left;padding-left:0.3mm">Subtract line 10c from line 9</span>
									<span class="sty1120FSchPDotLn" style="float:right;">.........</span>
								  </td>
								  <xsl:call-template name="CreateTableDepRow1">
									<xsl:with-param name="Start" select="position()"/>
								...
								<!--Part III, L12 Separated Print-->
								<tr class="styDepTblRow1">
								  <td valign="top" class="sty1120FSchPTableK1CellNumSD" style="padding-top:1mm">12</td>
								  <td class="sty1120FSchPTableK1Desc" style="width:60mm;">
									<b>Partner&#8217;s outside basis under <br/>Regulations section 1.884-1(d)</b>
									<b>(3)(vi).</b> Add lines 10d and 11
									<span class="sty1120FSchPDotLn" style="float:right;">...............</span>
								  </td>
								...
								<!--Part III, L13 Separated Print-->
								<tr class="styDepTblRow2">
								  <td valign="top" class="sty1120FSchPTableK1CellNumSD" style="padding-top:3mm">13</td>
								  <td class="sty1120FSchPTableK1Desc" style="width:60mm;">
						            Partner&#8217;s outside basis allocable to ECI under Regulations section 1.884-1(d)(3)(i) and 1.882-5.
						            (<b>Note: </b>The line 13 total should generally be entered on Schedule I, line 5, column (b).  
								...
								<!--Part III, L14 Separated Print-->
								<tr class="styDepTblRow1">
								  <td valign="top" class="sty1120FSchPTableK1CellNumSD" style="padding-left:0.8mm;border-bottom-width:2px;padding-top:4.2mm;">14</td>
								  <td class="sty1120FSchPTableK1Desc"  style="width:60mm;border-bottom-width:1px">
                                    Check either the "income" box or the "asset" box to indicate the allocation method used on line 20  (see instructions)  
									<span class="sty1120FSchPDotLn" style="float:right;">.......</span>
								   </td>
	          ...
	          <xsl:template name="CreateTable14">
		        ...
		        <xsl:param name="TargetNode"/>
		        <xsl:if test="$Start &lt; $Stop">
			      <td class="sty1120FSchPTableK1Cell" style="border-bottom-width:2px; text-align:left; padding-left:1mm; padding-top:7mm;">
