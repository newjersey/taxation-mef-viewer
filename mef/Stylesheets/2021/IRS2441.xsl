	...
	<xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
				...
				<form name="Form2441">
							...
							<span class="styAgency">Internal Revenue Service (99)</span>
									...
									<div class="styFTBox" style="width:120mm;height:20mm;">
										...
										<div class="styFBT" style="height:5mm;margin-top:3mm;width:90mm;">
											<img src="{$ImagePath}/2441_Bullet.gif" alt="Bullet"/> Attach to Form 1040, 1040-SR, or 1040-NR.<br/>
											<img src="{$ImagePath}/2441_Bullet.gif" alt="Bullet"/>Go to <a href="http://www.irs.gov/Form2441">www.irs.gov/Form2441</a> for instructions and the latest information.
											</div>
									</div>
									<!-- Begin Form Tax Year -->
									<div class="styTYBox" style="width:31mm; height:20mm;border-left-width:2px;">
										...
										<div class="styTaxYear" style="font-size:21pt;border-top:1px solid black;width:26mm;">20<span class="styTYColor" style="font-size:21pt:">21</span>
										</div>
					...
					<div class="styBB" style="width:187mm;font-size:7pt;border-bottom-width:2px;height:9mm;">
						<div class="styFNBox" style="width:187mm; height:7mm;border-right-width: 0px;">
							...
							</xsl:call-template><b>A</b> You can't claim a credit for child and dependent care expenses if your filing status is married filing separately unless you meet the requirements listed in the instructions under “Married Persons Filing Separately.” If you meet these requirements, check this box.
					...
					<div class="styBB" style="width:187mm;font-size:7pt;border-bottom-width:2px;height:9mm;">
						<div class="styFNBox" style="width:187mm; height:7mm;border-right-width: 0px;">
							<xsl:call-template name="PopulateLabel">
								<xsl:with-param name="TargetNode" select="$Form2441Data/EligibilityRequirementMetInd"/>
								<xsl:with-param name="BackupName">Eligbility requirement met indicator</xsl:with-param>
							</xsl:call-template><b>B</b> For 2021, your credit for child and dependent care expenses is refundable if you, or your spouse if married filing jointly, had a principal place of abode in the United States for more than half of 2021. If you meet these requirements, check this box.
       ...
       Care provider's <br/>
										...
										<th class="styTableCellHeader" scope="col" colspan="1" style="width:30mm;font-weight:normal;height:9mm;  border-color:black;vertical-align:top;">
											<span style="font-weight:bold;">(d)</span> Check here if the care provider is your household employee.<br/>(see instructions)
     </th>
										 <th class="styTableCellHeader" scope="col" colspan="1" style="width:30mm;font-weight:normal;height:9mm;  border-color:black;vertical-align:top;">
											...
											<tr style="vertical-align:top">
												...
												<td class="styTableCell" style="width:30mm;  border-color:black;text-align:left;vertical-align:top;">
													<span>
														...
														<input type="checkbox" alt="HouseholdEmployeeInd" class="styCkbox">
															<xsl:call-template name="PopulateCheckbox">
																<xsl:with-param name="TargetNode" select="HouseholdEmployeeInd"/>
																<xsl:with-param name="BackupName">Form2441HouseholdEmployeeInd</xsl:with-param>
															</xsl:call-template>
														</input>
														<label>
														</label>
...
Did you receive<br/>
							...
							<img src="{$ImagePath}/2441_Bullet_Md.gif" alt="MediumBullet" align="bottom" style="padding-top:1.6mm;"/> Complete Part III on page 2 next.  
						</div>
						<div class="styPartDesc" style="font-weight:Normal;width:187mm;padding-top:2mm;font-size:8pt;height:13mm;padding-left:0mm;">
							<b>Caution.</b> If the care was provided in your home, you may owe employment taxes. For details, see the Instructions for Schedule H (Form 1040). If you incurred care expenses in 2021 but didn't pay them until 2022, or if you prepaid in 2021 for care to be provided in 2022, don't include these expenses on column (c) of line 2 for 2021. See instructions.</div>
						<!-- BEGIN PART II TITLE -->
									...
									<tr>
										...
										<th class="styTableCellHeader" scope="col" colspan="1" style="width:50mm;font-weight:normal;  height:6mm;border-color:black;">
											<span style="">
												...
												<span class="styBoldText">Qualified expenses</span> you<br/> incurred and paid in 2021 for the person listed in column (a)</span>
										</th>
									</tr>
								</thead>
								<tfoot/>
						...
						<div style="width:187mm;">
							...
							<span class="styBoldText">Don't</span> enter more than $8,000 if you had one qualifying<br/>
						        person or $16,000 if you had two or more persons. If you completed Part III, enter the amount from line 31 
								<!--Dotted Line -->
						...
						<div style="width:187mm;">
						    ...
						    <div class="styLNDesc" style="width:123mm;height:4mm;">Enter on line 8 the decimal amount shown below that applies to the amount on line 7.<br/>
						    &#8226;<span style="width:120mm;padding-left:2mm;height:2mm;">If line 7 is $125,000 or less, enter .50 on line 8.</span>
						    &#8226;<span style="width:120mm;padding-left:2mm;height:2mm;"> If line 7 is over $125,000 and no more than $438,000, see the instructions for line 8</span>
						    <span style="width:120mm;padding-left:3.5mm;height:2mm;"> for the amount to enter.</span><br/>
						    &#8226;<span style="width:120mm;padding-left:2mm;height:2mm;"> If line 7 is over $438,000, you can’t claim this credit; don’t complete lines 8 and 9a. However,</span>
						    <span style="width:120mm;padding-left:3.5mm;height:2mm;"> you may be able to claim a credit on line 9b.</span><br/>
						   </div>
						...
						<div style="width:187mm;">
							<div class="styLNLeftNumBox" style="height:6.5mm;width:49px;"/>
							
							<div style="width:72mm;height:10mm;float:right;">
								<div class="styLNAmountBoxNBB" style="height:100%;border-left-width:0px;width:16mm;float:left;"/>

								<div style="height:11mm;width:56mm;float:right">
									<div class="styLNRightNumBoxNBB" style="height:100%;border-right-width:0px;border-bottom-width:1px;padding-top:7.5mm">  8                  
		                            </div>
									<div class="styLNAmountBox" style="height:100%;border-left-width:1px;width:47.5mm;padding-top:7.5mm;">
								...
								<!--<div style="height:15mm;float:right;width:56mm;">
									<div class="styLNRightNumBoxNBB" style="height:12mm;border-right-width:0px;background-color:lightgrey"/>
									<div class="styIRS2441RightSpaceBox" style="height:12mm;border-left-width:1px;"/>
								</div>-->
							</div>
						</div>		
						...
						<!--Line 9a -->
						<div style="width:187mm;">
							<div class="styLNLeftNumBox" style="height:4mm;padding-top:2.5mm;"><span style="width:1.5mm"/>9a
                            </div>
						...
						<!--Line 9b-->
						<div style="width:187mm;">
							<div class="styLNLeftNumBox" style="height:5mm;"><span style="width:1.5mm"/>9b
                            </div>
							<div class="styLNDesc" style="width:123mm;height:5mm;">If you paid 2020 expenses in 2021, complete Worksheet A in the instructions. Enter the amount from line 13 of the worksheet here. Otherwise, go to line 10
                             <!--CPYECreditAmt-->
									<xsl:call-template name="SetFormLinkInline">
					...
					<div style="width:187mm;clear:all;">
						<div class="styLNLeftNumBox" style="height:5mm;padding-top:1mm;">10
                   </div>
						<div class="styLNDesc" style="width:123mm;height:5mm;padding-top:1mm;font-size:7pt;">
						Add lines 9a and 9b and enter the result. If you checked the box on line B above, this is your <b>refundable credit for child and dependent care expenses;</b> enter the amount from this line on Schedule 3 (Form 1040), line 13g, and don’t complete line 11. If you didn’t check the box on line B above, go to line 11 
								<!--Dotted Line -->
								<span class="styDotLn" style="float:right;padding-right:1mm;">......................</span>
						</div>
						...
						<div class="styIRS2441RightSpaceBox" style="width:131mm;height:6mm;border-left-width:0px;border-top-width:0px;"/>
						<div class="styLNRightNumBox" style="height:8mm;border-right-width:0px;padding-top:4.5mm;">10                    
                            </div>
						<div class="styLNAmountBox" style="float:right;height:8mm;border-left-width:1px;width:48mm;padding-top:4.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form2441Data/RfdblCrForChildAndDepdCareAmt"/>
							</xsl:call-template>
						</div>
					</div>
						...
						<div style="width:187mm;height:15mm;">
							<div class="styLNLeftNumBox" style="height:15mm;padding-top:1.5mm;">11
					        </div>
							<div class="styLNDesc" style="width:123mm;height:15mm;padding-top:1.5mm;">
								<span class="styBoldText">Nonrefundable credit for child and dependent care expenses.</span> If you didn't check the box on line B above, your credit is nonrefundable and limited by the amount of your tax; see the instructions to figure the portion of line 10 that you can claim and enter that amount here and on Schedule 3 (Form 1040), line 2.
								<!--Dotted Line -->
								<span class="styDotLn" style="float:right;padding-right:1mm;">....................</span>
							</div>
			                <div class="styLNRightNumBox" style="height:15mm;border-right-width:0px;border-bottom-width:0px;padding-top:11mm;">11                     
                            </div>
						    <div class="styLNAmountBox" style="height:15mm;border-left-width:1px;border-bottom-width:0px;width:48mm;padding-top:11mm;">
								<xsl:call-template name="PopulateAmount">
					...
					<div class="stySmallText" style="width:36mm;text-align:right;">Form <span class="styBoldText">2441</span> (2021)
                   </div>
					</div>
					<!--End Footer-->
					<!-- Page Header -->
					<div style="width:187mm;padding-top:0.5mm;">
						<div style="float:left;">Form 2441 (2021)<span style="width:148mm;"/>
						</div>
					...
					<div style="width:187mm;clear:all;">
						...
						you received in 2021. Amounts you<br/> received as an employee should be shown in box 10 of your Form(s) W-2. 
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:123mm;height:5mm;padding-top:1mm;">Enter the amount, if any, you carried over from 2020 and used in 2021. See instructions
								<!--Dotted Line -->
								<span class="styDotLn" style="float:right;padding-right:1mm;">..</span>
						</div>
                        <div class="styLNRightNumBox" style="height:5mm;border-right-width:0px;padding-top:2mm;">13                    
                        </div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:123mm;height:7mm;padding-top:1mm;">If you forfeited or carried over to 2022 any of the amounts reported on line 12 or 13, enter the amount. See instructions
							<!--Dotted Line -->
							<span class="styDotLn" style="float:right;padding-right:1mm;">......................</span>
						</div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:91mm;height:4mm;">
							<span style="width:8mm"/>in 2021 for the care of the <span class="styBoldText">qualifying person(s)</span>
							<!--Dotted Line -->
							<span class="styDotLn" style="float:right;padding-right:1mm;">.....</span>
						</div>
  ...
  If married filing separately, see<br/>
		...
		<div class="styLNDesc" style="width:83mm;padding-top:0mm;height:13mm;">Enter $10,500 ($5,250 if married filing separately <b>and</b> <br/>you were required to enter your spouse&#8221;s earned <br/>income on line 19). If you entered an amount on line 13, add it to the $10,500 or $5,250 amount you enter on line 21. However, don't enter more than the maximum amount allowed under your dependent care plan. See Intstructions
							<!--Dotted Line -->
							<!--<span class="styDotLn" style="float:right;padding-right:1mm;">...</span>-->
						</div>
						...
						<div class="styLNRightNumBox" style="height:10.5mm;border-right-width:0px;padding-top:7mm;">21                  
                            </div>
						<div class="styLNAmountBox" style="height:10.5mm;border-left-width:1px;width:32mm;padding-top:7mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form2441Data/SpecifiedAmt"/>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBoxNBB" style="height:11mm;border-right-width:0px;background-color:lightgrey;"/>
						<div class="styIRS2441RightSpaceBox" style="height:11mm;width:48mm;border-right-width:0px;"/>
					</div>
					<!--line 22-->
					<div style="width:187mm;">
					...
					<div style="width:187mm;height:10mm;">
						...
						<div class="styLNAmountBox" style="height:10.5mm;border-left-width:1px;width:48mm;padding-top:7mm;border-bottom-width:2px;">
							<xsl:call-template name="PopulateAmount">
					...
					<div style="width:187mm;">
						...
						You can't take the credit. <br/><b>Exception.</b> If you paid 2020 expenses in 2021, see the instructions for line 9b
							<!--Dotted Line -->
							<span class="styDotLn" style="float:right;padding-right:1mm;">.....</span>
						</div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:123mm;height:5mm;padding-top:1mm;font-size:7pt;">Complete line 2 on page 1 of this form. <b> Don't </b>include in column (c) any benefits shown on line 28 above. Then, add the amounts in column (c) and enter the total here
  							<!--Dotted Line -->
							<span class="styDotLn" style="float:right;padding-right:1mm;">......</span>
						</div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:123mm;height:5mm;padding-top:1mm;font-size:7pt;border-bottom-width:0px;">Enter the <b>smaller </b>of line 29 or 30. Also, enter this amount on line 3 page 1 of this form and complete lines 4 through 11
  							<!--Dotted Line -->
							<span class="styDotLn" style="float:right;padding-right:1mm;">....................</span>
						</div>
					...
					<div class="pageEnd" style="width:187mm; border-top:0.5mm solid black;">
						<div style="float:right;">
							<span style="width:80px;"/>  
                             Form <span class="styBoldText">2441</span> (2021)
                    </div>
					</div>
					<!--END Page Footer-->
      ...
      <br/> First<span style="width:40mm"/>Last
									...
									<th class="styDepTblCell" scope="col" colspan="1" style="width:49mm;font-weight:normal;vertical-align:top;">
										<span style="font-weight:bold;"></span>  <span style="height:3mm;padding-bottom:5mm">(c) Qualified expenses you<br/> incurred and paid in 2019 for the person listed in column (a)  	</span>
                                </th>
								</tr>
							</thead>
							<tfoot/>
