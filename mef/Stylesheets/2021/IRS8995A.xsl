			...
			<body class="styBodyClass">
				<form id="Form8995A">
					...
					<xsl:for-each select="$FormData/QBIDeductionInformationGrp">
						<xsl:if test="position() mod 3 = 1">
							...
							<div class="styStdIBDiv">
								...
								<div class="sty8995ADesc" style="height:13.5mm;">
									Multiply line 2 by 20% (0.20). If your taxable income is $164,900 or less 
									($164,925 if married filing separately; $329,800 if married filing jointly), skip lines 4 through 12 and enter the amount from line 3 on line 13
									<span class="sty8995ADotLn">.......</span>
								</div>
								<div class="styLNRightNumBox" style="height:13.5mm;"><br/><br /><br />3</div>
								<div class="sty8995AAmtBox" style="height:13.5mm;"><br /><br /><br />
									<xsl:call-template name="PopulateAmount">
								...
								<div class="sty8995AAmtBox" style="min-height:13.5mm;"><br /><br /><br />
									<xsl:call-template name="PopulateAmount">
					...
					<div class="styStdDiv pageEnd" style="border-top:2px solid black;">
						...
						<span style="float:right;">Form <span style="font-weight:bold;font-size:larger;">8995-A</span> (2021)</span>
					</div>
					<div class="styStdDiv">
						Form 8995-A (2021)
					...
					<div class="styStdDiv" style="border-top:1px solid black;padding-top:0.5mm;padding-bottom:0.5mm;font-style:italic;font-family:Arial;">
						Complete Part III only if your taxable income is more than $164,900 but not $214,900 ($164,925 and $214,925 if married filing separately; $329,800 and $429,800 if married filing jointly) and line 10 is less than line 3. Otherwise, skip Part III.
					</div>
					<xsl:for-each select="$FormData/QBIDeductionInformationGrp">
						<xsl:if test="position() mod 3 = 1">
							<xsl:variable name="pos" select="position()"/>
