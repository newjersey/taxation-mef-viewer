				...
				<form id="Form1040SR" style="font-size:10pt;font-family:Arial;">
					...
					<div style="width:187mm;height:6mm;">
						<div class="styIRS1040SRHeaderCell" style="height:6mm;width:187mm;
							...
							border-width:0px 0px 1px 0px;">At any time during 2021, did you receive,
							sell, exchange, or otherwise dispose of any financial
							interest in any virtual currency?
							<span style="font-size:7.5pt;padding-left:6.5mm">
							...
							<span style="display:inline;font-family:Arial;">
								...
								<label>
									<xsl:call-template name="PopulateLabel">
										<xsl:with-param name="TargetNode" select="$FormData/Primary65OrOlderInd"/>
										<xsl:with-param name="BackupName">IRS1040Primary65OrOlderInd</xsl:with-param>
									</xsl:call-template>Were born before January 2, 1957</label>
								...
								<label>
									<xsl:call-template name="PopulateLabel">
										<xsl:with-param name="TargetNode" select="$FormData/Spouse65OrOlderInd"/>
										<xsl:with-param name="BackupName">IRS1040Spouse65OrOlderInd</xsl:with-param>
									</xsl:call-template>Was born before January 2, 1957</label>
					...
					<!--<div class="styStdDiv" style="overflow:visible;">-->
						<div class="styGenericDiv" style="width:20mm;padding-top:4mm;height:69mm;
						...
						<div class="sty1040SRLN">
							...
							<div class="sty1040SRDesc">Other income from Schedule 1, line 10
								<span class="sty1040SRDotLn">..............</span></div>
					...
					select="$FormData/ExcldSect933PuertoRicoIncmAmt/@excldSect933PuertoRicoIncmCd"/>
						...
						<div class="styStdDiv pageEnd" style="border-top:1px solid black;">
							...
							<span style="float:right;font-size:7pt;">Form <strong style="font-size:10pt;">
								1040-SR</strong> (2021)</span>
						</div>
						<!-- Page 2 -->
						<div class="styStdDiv" style="border-bottom:1px solid black;font-size:7pt;
							font-family:Verdana;">Form 1040-SR (2021)
							<div style="float:right;">Page <strong>2</strong></div>
						</div>
						<div class="styGenericDiv" style="width:20mm;padding-top:4mm;height:140mm;
							font-family:Arial;font-size:8pt;">
							<div style="width:100%;border:1px solid black;border-radius:8px;
						...
						<div class="sty1040SRLN">
							<div class="sty1040SRLeftNumBoxSD" style="border-top:1px solid black;
								...
								margin-right:2px;padding-top:1mm;padding-left:1mm">12a</div>
							<div class="sty1040SRDesc" style="padding-top:1.5mm;width:87mm;">
								<strong>Standard deduction or itemized deductions </strong> (from <br/>Schedule A)
								<span class="sty1040SRDotLn" style="">...............</span> 
							</div>
							<div class="sty1040SRRightNumBox" style="height:9mm;padding-top:4.5mm">12a</div>
							<div class="sty1040SRAmountBox" style="height:9mm;padding-top:4.5mm">
								<span style="float:left;">
									<xsl:call-template name="LinkToLeftoverDataTableInline">
						 ...
						 select="$FormData/TotalItemizedOrStandardDedAmt/@modifiedStandardDeductionInd"/>
							...
							<div class="sty1040SRRightNumBoxNBB" style="background-color:lightgrey;height:9mm">
							 &nbsp;</div>
						...
						<div class="sty1040SRLN">	
							...
							<div class="sty1040SRDesc" style="width:87mm;">
								<span style="padding-top:0mm;">Charitable contributions if you take the standard <br/>
								 deduction (see instructions) 
									<span style="width:4.1mm"/>
									<span class="sty1040SRDotLn">.........</span>
								</span>	
							</div>
							<div class="sty1040SRRightNumBox" style="text-align:center;height:9.5mm;
							 padding-top:5mm">12b
							</div>
							<div class="sty1040SRAmountBox" style="padding-top:2mm;height:9.5mm;padding-top:5mm">
									<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
										select="$FormData/CharitableContributionAmt"/>
								</xsl:call-template>
							</div>
							<div class="sty1040SRRightNumBoxNBB" style="background-color:lightgrey;height:9.5mm">
								&nbsp;</div>
							<div class="sty1040SRAmountBoxNBB" style="height:9.5mm">&nbsp;</div>
						</div>
						<div class="sty1040SRLN">
							...
							<div class="sty1040SRRightNumBox">12c</div>
							<div class="sty1040SRAmountBox">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
						...
						<div class="sty1040SRLN">
							...
							<div class="sty1040SRDesc" style="">
								Nonrefundable child tax credit or credit for other dependents from Schedule <br/>8812
								<span class="sty1040SRDotLn">..........................</span>
							</div>
							<div class="sty1040SRRightNumBox" style="height:9mm;padding-top:4.5mm">19</div>
							<div class="sty1040SRAmountBox" style="height:9mm;padding-top:4.5mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/NrfdblCTCODCOrNrfdblODCAmt"/>
								</xsl:call-template>
							</div>
						</div>
						<!-- Line 20 -->
						...
						<div class="styGenericDiv" style="width:20mm;padding-top:1mm;height:79mm;">
							<div style="width:100%;border:1px solid black;border-radius:8px;padding-top:2mm;
								padding-left:1mm;font-family:Arial;font-size:7pt;padding-bottom:2mm">
								<span style="width:1.9mm;height:5mm;float:left;"></span>
								<span style="float:left;width:16.5mm;">If you have <br/>a qualifying <br/>
						...
						<div class="sty1040SRLN">
							<div class="sty1040SRLeftNumBoxSD" style="border-top:1px solid black;
							border-bottom:1px solid black;border-left:2px solid white;margin-left:-2px;
							margin-right:2px;padding-left:1mm;padding-top:1mm">27a</div>
							...
							<div class="sty1040SRDesc" style="width:87mm;padding-top:1.7mm;height:17.5mm;">
								...
								<span style="float:right;">
									...
									<input type="checkbox" class="styCkbox" style=""
										...
										<xsl:call-template name="PopulateCheckbox">
											<xsl:with-param name="TargetNode" 
												select="$FormData/UndSpcfdAgeStsfyRqrEICInd"/>
											<xsl:with-param name="BackupName">IRS1040UndSpcfdAgeStsfyRqrEICInd</xsl:with-param>
										</xsl:call-template>
									</input>
								</span>
							</div>	
						...
						<div class="sty1040SRLN">	
							<div class="sty1040SRLeftNumBoxSD"	style="padding-left:4.8mm;">b</div>
							<div class="sty1040SRDesc" style="width:51mm;">
								<span style="padding-top:0mm;">Nontaxable combat pay election</span>	
							</div>
							<div class="sty1040SRRightNumBox" style="text-align:center;">27b</div>
							<div class="sty1040SRAmountBox" style="padding-top:2mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
						...
						<div class="sty1040SRLN">	
							<div class="sty1040SRLeftNumBoxSD"	style="padding-left:4.8mm;">c</div>
							<div class="sty1040SRDesc" style="width:51mm;">
								<span style="padding-top:0mm;">Prior year (2019) earned income</span>	
							</div>
							<div class="sty1040SRRightNumBox" style="text-align:center;">27c</div>
							<div class="sty1040SRAmountBox" style="padding-top:2mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
						...
						<div class="sty1040SRLN">
							...
							<div class="sty1040SRDesc" style="">
								Add lines 27a and 28 through 31. These are your <strong>total other payments
					...
					<div class="sty1040SRLN">
						...
						<div class="sty1040SRDesc" style="width:87mm;">
							Amount of line 34 you want<strong> applied to your 2022 <br/>
					...
					<div style="display:block;width:187mm;border-top:1px solid black;">
						...
						<div class="sty1040SRLN">
							...
							<div class="sty1040SRDesc" style="">
								<strong>Amount you owe. </strong>Subtract line 33 from line 24. For details on how to pay, see instructions  
								<span style="float:right">
									<span class="sty1040SRDotLn" style="float:none;margin-right:-2px;">
										...................</span>
									<img src="{$ImagePath}/1040_Bullet.gif" alt="Right arrow"/>
							...
							<div class="sty1040SRRightNumBox" style="height:8.5mm;padding-top:4mm">37</div>
							<div class="sty1040SRAmountBox" style="height:8.5mm;padding-top:4mm;">
								<xsl:call-template name="PopulateAmount">
					...
					<div class="styStdIBDiv">
						...
						<div style="width:187mm;border-top:1px solid black;font-size:10pt;">
							...
							<div style="width:64mm;padding-top:1mm;float:left;text-align:center;
								border-right:0px solid black;padding-bottom:0.5mm">
								$26,450 <br/><br /> 27,800 <br/><br /> 28,150 <br/><br /> 30,500 
							</div>
						</div>
						<div style="width:187mm;border-top:1px solid black;font-size:10pt;">
						...
						<div style="width:187mm;border-top:1px solid black;font-size:10pt;">
							...
							<div style="width:64mm;padding-top:1mm;float:left;text-align:center;">
								$13,900 <br/><br /> 15,250 <br/><br /> 16,600 <br/><br /> 17,950
							</div>
						</div>
					</div>
