		...
		<table id="INOLDTbl" class="styDepTbl" style="font-size:7pt; width:256mm">
			<thead class="styTableThead">
				<tr class="styDepTblHdr">           
					<th class="styDepTblCell" scope="col" style="width:34mm;">Type of Deduction</th>
					<th class="styDepTblCell" scope="col" style="width:32mm;">U.S. source income</th>
					<th class="styDepTblCell" scope="col" style="width:32mm;">Foreign Source - Foreign branch category income</th>
					<th class="styDepTblCell" scope="col" style="width:32mm;">Foreign Source - Passive category income</th>
					<th class="styDepTblCell" scope="col" style="width:32mm;">Foreign Source - General category income</th>
					<th class="styDepTblCell" scope="col" style="width:32mm;">Foreign Source - Other category income</th>
					<th class="styDepTblCell" scope="col" style="width:30mm;">Sourced by partner/shareholder</th>
					<th class="styDepTblCell" scope="col" style="width:32mm;">Total deductions</th>
				</tr>
			</thead>
			<tbody>
