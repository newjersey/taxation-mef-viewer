			...
			<body class="styBodyClass" style="width:187mm">
				<form name="IRS5471">
					...
					<div class="styBB" style="width:187mm;">
						<div class="styFNBox" style="width:28.25mm; height: 23mm; border-bottom-width:1pt; border-right-width:1pt;">
							<div>
								...
								<div class="styAgency">(Rev. December 2019)</div>
								...
								<div class="styTYBox" style="height:23mm; width:31mm; border-bottom-width:1pt; border-left-width:1pt;">
									...
									<div style="height:6mm; text-align:left; padding-left:3mm;">
										...
										<div style="width:23mm;">Sequence No.<b>121</b></div>
									</div>
								</div>
							</div>
							<!--   END FORM HEADER   -->
					...
					<div style="width:187mm;">
						...
						<div style="width:78mm; height:15mm; padding-left:1mm; border-top-width:1px; border-bottom-width:0px; text-align:left;">
						...
						<tr>
							<td scope="col" class="styTableCell " rowspan="3" style="border-color:black;height: 2mm;font-weight:normal;border-bottom-width: 1px;width:107mm" valign="top">
								<span style="width:107mm;text-align:left;">
									...
									<span style="width: 3mm"/> (if any) in the United States<br/></span>
					...
					<div style="width:187mm; border-color: black; border-style: solid; border-right-width: 0px;
					 border-left-width: 0px; border-top-width: 1px; border-bottom-width: 0px;">
						...
						<div style="float:right">
							...
							Form <span class="styBoldText" style="font-size: 8pt">5471</span> (Rev. 12-2019)
						</div>
					</div>
					<!--<div class="pageEnd"/>-->
					<!--END FOOTER-->
					...
					<div class="styGenericDiv" style="width:187mm">
						<div style="float: left; clear: none">Form 5471 (Rev. 12-2019)</div>
						<div style="float:right">
				...
				<!--   BEGIN SCHEDULE G   -->
					...
					<div class="styGenericDiv" style="width:187mm;">
						...
						<span class="styLNDesc" style="width:162mm; height:11mm;">
							...
							<br/><span style="float:left">(FDDEI) (see instructions)</span>
					...
					<div class="styGenericDiv" style="width:187mm;">
						...
						<div class="styGenericDiv" style="width:187mm">
							<span class="styLNDesc" style="width:162mm; margin-left:8mm;">
								<span style="float:left;">required to report a section 367(d) annual income inclusion for the taxable year?</span>
								<span class="styDotLn" style="float:right;padding-right:1mm;">..............</span>
							</span>
							<span >
								<xsl:call-template name="PopulateSpan">
					...
					<div class="styGenericDiv" style="width:187mm;">
						<span class="styLNDesc" style="margin-left:8mm; ">
							...
							<span style="width:1mm"/>
							<span class="sty1120FItemUnderlineSM" style="width:20mm;">
								
							</span>
						</span>
					</div>
					<!--   END LINE 19 of Schedule G  -->
					<!--   BEGIN OLD LINE 20 of Schedule G  -->
<!--					<div class="styGenericDiv" style="width:187mm">
						<span class="styLNLeftNumBox">20</span>
						<span class="styLNDesc" style="width:177mm">
							Is the foreign corporation a member of a CFC group in which a CFC group election under Regulations section 1.163(j)-7(b)(5)
						</span>
					</div>
					<div class="styGenericDiv" style="width: 187mm">
						<span class="styLNDesc" style="width: 162mm; margin-left:8mm">
							<span style="float:left">
								is in effect (see instructions)? 		
							</span>
							<span class="styDotLn" style="float:right;padding-right:1mm;">...............................</span>
						</span>
						<span>
							<xsl:call-template name="PopulateSpan">
								<xsl:with-param name="TargetNode" select="$IRS5471GData/CFCGroupElectionInd"/>
							</xsl:call-template>
							<input type="checkbox" alt="CFC Group Election Indicator Yes" class="styCkbox" style="width:3mm; height:3mm;">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/CFCGroupElectionInd"/>
									<xsl:with-param name="BackupName">IRS5471CFCGroupElectionIndYes</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						<span class="styNBSP" style="width: 10px"/>
						<span>
							...
							<input type="checkbox" alt="CFC Group Election Indicator No" class="styCkbox" style="width:3mm; height:3mm;">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS5471GData/CFCGroupElectionInd"/>
									<xsl:with-param name="BackupName">IRS5471CFCGroupElectionIndNo</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
					</div>
					<label>
						<xsl:call-template name="PopulateLabelYes">
							<xsl:with-param name="TargetNode" select="$IRS5471GData/CFCGroupElectionInd"/>
							<xsl:with-param name="BackupName">IRS5471CFCGroupElectionIndYesLabel</xsl:with-param>
						</xsl:call-template>
					</label>
					<label>
						<xsl:call-template name="PopulateLabelNo">
							<xsl:with-param name="TargetNode" select="$IRS5471GData/ReportableTransactionPrtcptInd"/>
							<xsl:with-param name="BackupName">IRS5471CFCGroupElectionIndNoLabel</xsl:with-param>
						</xsl:call-template>
					</label>-->
					<!--   END OLD LINE 20 of Schedule G -->
					<!--   BEGIN LINE 20 of Schedule G  -->
					<div class="styGenericDiv" style="width:187mm;">
						<span class="styLNLeftNumBox">20</span>
						<span class="styLNDesc" style="width:162mm;">
							<span style="float:left">
					...
					<!--   END LINE 20 of Schedule G  -->
					<!--   BEGIN LINE 21 of Schedule G  -->
					<div class="styGenericDiv" style="width:187mm">
					...
					<xsl:if test="(not($IRS5471IData)) or (($Print = $Separated) and count($IRS5471IData) &gt; 1)">
						...
						<div style="width:187mm;height:6mm;">
							<div style="float:left;">
								...
								<div class="styLNDesc" style="padding-top:.5mm;padding-bottom:.5mm;">
									<span style="float:left;">Section 964(e)(4) Subpart F dividend income from the sale of stock of a lower-tier foreign corporation (see<br/></span>
						...
						<div style="width:187mm;">
							<div style="float:left;">
								...
								<div class="styLNDesc" style="padding-top:.5mm;padding-bottom:.5mm;">
									<span style="float:left;">See instructions for reporting amounts on line 1, 2 and 4 on your income tax return </span>
									<span class="styDotLn" style="float:right; padding-right:2mm;">.......</span>   
								</div>
							</div>
							<div style="float:right;">
						...
						<xsl:for-each select="$IRS5471IData">
							...
							<div class="styBB" style="width:187mm; float:none; clear:both;">
								...
								<div style="width:187mm;">
									...
									<div class="styLNRightNumBox" style="border-top-width:1;">1d </div>
									<div class="styLNAmountBox" style="width:33mm; border-top-width:1;">
										<xsl:call-template name="PopulateAmount">
