				...
				<form name="Form1120ScheduleB">
					...
					<div class="styBB" style="width:187mm;">
						<div class="styNameBox" style="width:120mm;height:9mm;font-size:7pt;font-weight:normal;">
						  ...
						  <br/>
							<xsl:choose>
								<xsl:when test="$Form1120ScheduleB/FilerBusinessName/BusinessNameLine1Txt !=''">
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:158mm;height:4mm;">
							Does any amount reported on Schedule M-3 (Form 1120), Part II, lines 9 or 10, column (d), reflect allocations to this
						</div>
					...
					<div style="width:187mm;">
						<div class="styLNLeftNumBox" style="height:4mm;"/>
						<div class="styLNDesc" style="width:158mm;height:4mm;">
						  sections 1.263A-1(e)(3)(ii)(F), (G), and (H), as mixed-service costs, as defined in Regulations section 1.263A-
						</div>
						<div class="styShadingCell" style="height:4mm;width:10mm;"/>
						<div class="styShadingCell" style="height:4mm;width:10mm;"/>
					</div>
					...
					<div style="width:187mm;">
						...
						<div class="stySmallText" style="width:51mm;text-align:right;">
							<span class="styBoldText">Schedule B (Form 1120) (Rev. 12-2018)</span>
						</div>
					</div>
