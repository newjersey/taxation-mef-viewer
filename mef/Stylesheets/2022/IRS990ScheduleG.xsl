...
<!-- 10/14/2021 - Changes made for defect 68045 - Jeremy Nichols -->
      ...
      <body class="styBodyClass">
        <form name="Form990ScheduleG">
          ...
          <div class="styTBB" style="width:187mm;display:block;">
            <div class="styFNBox" style="height:23mm;width:33mm;padding-top:1mm;">
              <div style="height:13.5mm;">
                <span class="styFormNumber" style="font-size:9pt;">SCHEDULE G<span style="width:5mm;"/>
                  <span style="text-align:left;padding-left:0mm;padding-top:1mm;"/> (Form 990)
                </span>
            ...
            <div class="styFTBox" style="height:23mm;width:122mm;">
              ...
              <div class="styFBT" style="margin-top:0mm;font-weight:bold;">
				...
				<br/>
                <span style="width:122mm;font-size:5.5pt;font-weight:bold;">
					<img src="{$ImagePath}/990SchG_Bullet_Line.gif" alt="right arrow"/>Go to <i>www.irs.gov/Form990</i> for instructions and the latest information. 
				</span>
              </div>
            </div>
          ...
          <div class="styBB" style="width:187mm;padding-top:1mm;padding-bottom:1mm;">
            ...
            <div class="styPartDesc"> <b>Fundraising Activities.</b>  
              <span class="styNormalText"><span style="width:0.5mm;"/>Complete if the organization answered "Yes" on Form 990, Part IV, line 17.</span>
            </div>
        ...
        <div class="styNBB" style="width:187mm;float:left;clear:none;">
          ...
          <div style="width:178mm; font-size:7pt;padding-top:1mm;display:inline;">
            If "Yes," list the 10 highest paid individuals or entities (fundraisers) pursuant to agreements under which the fundraiser is <br/>
          ...
          <div style="display:block;">
            <div class="styBB" style="width:187mm; padding-bottom:.5mm;">  
              <div style="float:left;">Schedule G (Form 990) 2022</div>
            ...
            <table class="styTable" style="font-size: 7pt;height:auto;width:187mm;display:inline;" cellspacing="0" cellpadding="0">
				<tr>
					<td class="styIRS990ScheduleGVTImageBox" style="height:69.5mm;width:6mm;padding-top:0mm;border-bottom-width:1px;">
						<br/>
						<br/>
						<br/>
						<br/>
					...
					<td>
						<table class="styTable" style="font-size: 7pt;height:auto;width:181mm;display:inline;" cellspacing="0" cellpadding="0">
							<tr>
							  <th colspan="2" style="height:50mm;width:53mm;float:left;clear:none;display:inline;">
								<span style="width: 53mm;display:inline;"/>
							  </th>
							  <th class="styLNAmountBox" scope="col" style="width:32mm;height:50mm;vertical-align:top;padding-top:.5mm;text-align:center;display:inline;">
								<b>(a)</b>
							  ...
							  <th class="styLNAmountBox" scope="col" style="height:50mm;width:32mm;vertical-align:top;padding-top:.5mm;text-align:center;display:inline;">
								<b>(b)</b>
							  ...
							  <th class="styLNAmountBox" scope="col" style="height:50mm;width:32mm;vertical-align:top;padding-top:0.5mm;text-align:center;display:inline;">
								<b>(c)</b>
							  ...
							  <th class="styLNAmountBox" scope="col" style="height:50mm;width:31mm; border-right-width: 0px;vertical-align:top;text-align:center;padding-top:0.75mm;display:inline;">
								<b>(d)</b>
								<span class="styNormalText" style="display:inline;"> Total events<br/>(add col. <b>(a) </b>through col. <b>(c)</b>)</span>
							  </th>
							</tr>
								  ...
								  <tbody>
									<tr>
									  <td style="width:5mm;text-align:center;">
										...
										<span style="float:left;clear:none;display:inline;">
										  <input type="checkbox" class="styCkbox" name="Checkbox" id="CheckVolunteerLaborOtherGamingYes" alt="CheckVolunteerLaborOtherGamingYes">
											<xsl:call-template name="PopulateYesCheckbox">
											  <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/GamingInformationGrp/VolunteerLaborOtherGamingInd"/>
											  <xsl:with-param name="BackupName">CheckVolunteerLaborOtherGamingYes</xsl:with-param>
											</xsl:call-template>
										  </input>
										</span>  
									  </td> 
									  <td style="width:25mm;text-align:left;padding-left:1mm;">         
										<label id="CheckVolunteerLaborOtherGamingYes">
										  <xsl:call-template name="PopulateLabelYes">
											<xsl:with-param name="TargetNode" select="$Form990ScheduleGData/GamingInformationGrp/VolunteerLaborOtherGamingInd"/>
											<xsl:with-param name="BackupName">CheckVolunteerLaborOtherGamingYes</xsl:with-param>
										  </xsl:call-template>
									...
									<tr>
									  <td style="width:5mm;text-align:center;">
										...
										<span style="float:left;clear:none;display:inline;">
										  <input type="checkbox" class="styCkbox" name="Checkbox" id="CheckVolunteerLaborOtherGamingNo" alt="CheckVolunteerLaborOtherGamingNo">
											<xsl:call-template name="PopulateNoCheckbox">
											  <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/GamingInformationGrp/VolunteerLaborOtherGamingInd"/>
											  <xsl:with-param name="BackupName">CheckVolunteerLaborOtherGamingNo</xsl:with-param>
											</xsl:call-template>
										  </input>
										</span>
									  </td> 
									  <td style="width:27mm;text-align:left;padding-left:1mm;">  
										<label id="CheckVolunteerLaborOtherGamingNo">
										  <xsl:call-template name="PopulateLabelNo">
											<xsl:with-param name="TargetNode" select="$Form990ScheduleGData/GamingInformationGrp/VolunteerLaborOtherGamingInd"/>
											<xsl:with-param name="BackupName">CheckVolunteerLaborOtherGamingNo</xsl:with-param>
										  </xsl:call-template>
 ...
 <xsl:if test="string-length($Form990ScheduleGData/ExplanationIfYesTxt) &lt;1">
   <div class="IRS990ScheduleG_LineContainer">
    ...
    <div class="pageEnd" style="width:187mm;">
      ...
      <span style="font-weight:bold;font-size:6pt;">Schedule G (Form 990) 2022</span>
    </div>
 
     <!-- PAGE 3 HEADER  -->
          <div style="display:block;">
 <div class="styBB" style="width:187mm; padding-bottom:.5mm;border-bottom-width:1.75px;">  
    <div style="float:left;font-size;6pt;">Schedule G (Form 990) 2022</div>
        ...
        Address  <img src="{$ImagePath}/990SchG_Bullet_Line.gif" alt="right arrow"/>  </div>
          <div class="styFixedUnderline" style="width:162mm;padding-left:2mm;border-bottom-style:dashed;border-bottom-width:1px;border-right-width:0px;">
				...
				<xsl:if test="$Form990ScheduleGData/PersonsWithBooksUSAddress != ''">
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/PersonsWithBooksUSAddress/AddressLine1Txt"/>
                  </xsl:call-template> <span style="0.5mm;"/>
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/PersonsWithBooksUSAddress/AddressLine2Txt"/>
                  </xsl:call-template> <span style="0.5mm;"/>
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/PersonsWithBooksUSAddress/CityNm"/>
                  </xsl:call-template>, <span style="0.5mm;"/>
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/PersonsWithBooksUSAddress/StateAbbreviationCd"/>
                  </xsl:call-template> <span style="0.5mm;"><span style="width:0.5mm;"/></span>
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/PersonsWithBooksUSAddress/ZIPCd"/>
                  </xsl:call-template>
                </xsl:if>
                <xsl:if test="$Form990ScheduleGData/PersonsWithBooksForeignAddress != ''">
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/PersonsWithBooksForeignAddress/AddressLine1Txt"/>
                  </xsl:call-template> <span style="0.5mm;"/>
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/PersonsWithBooksForeignAddress/AddressLine2Txt"/>
                  </xsl:call-template> <span style="0.5mm;"/>
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/PersonsWithBooksForeignAddress/CityNm"/>
                  </xsl:call-template>, <span style="0.5mm;"/>
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/PersonsWithBooksForeignAddress/ProvinceOrStateNm"/>
                  </xsl:call-template> <span style="0.5mm;"><span style="width:0.5mm;"/></span>
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/PersonsWithBooksForeignAddress/ForeignPostalCd"/>
                  </xsl:call-template> <span style="0.5mm;"><span style="width:0.5mm;"/></span>
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/PersonsWithBooksForeignAddress/CountryCd"/>
                  </xsl:call-template>
                </xsl:if>
...
<!-- LINE  15c  -->
 ...
 <!--<xsl:if test="string-length($Form990ScheduleGData/NameOfThirdPartyPerson) &lt;1">
  ...
  <!-- Line 15c  Address  -->
    <div style="width:187mm">
     <div class="IRS990ScheduleG_LineContainer" style="height:12mm;"> 
       <div class="styLNDesc" style="width:25mm;height:12mm;padding-left:8mm;padding-right:2.5mm;">
        Address  <img src="{$ImagePath}/990SchG_Bullet_Line.gif" alt="right arrow"/>  </div>
          <div class="styFixedUnderline" style="width:162mm;padding-left:2mm;border-bottom-style:dashed;border-bottom-width:1px;border-right-width:0px;">

			 <xsl:if test="$Form990ScheduleGData/ThirdPartyUSAddress != ''">
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/ThirdPartyUSAddress/AddressLine1Txt"/>
                  </xsl:call-template> <span style="0.5mm;"/>
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/ThirdPartyUSAddress/AddressLine2Txt"/>
                  </xsl:call-template> <span style="0.5mm;"/>
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/ThirdPartyUSAddress/CityNm"/>
                  </xsl:call-template>, <span style="0.5mm;"/>
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/ThirdPartyUSAddress/StateAbbreviationCd"/>
                  </xsl:call-template> <span style="0.5mm;"><span style="width:0.5mm;"/></span>
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/ThirdPartyUSAddress/ZIPCd"/>
                  </xsl:call-template>
                </xsl:if>
                <xsl:if test="$Form990ScheduleGData/ThirdPartyForeignAddress != ''">
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/ThirdPartyForeignAddress/AddressLine1Txt"/>
                  </xsl:call-template> <span style="0.5mm;"/>
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/ThirdPartyForeignAddress/AddressLine2Txt"/>
                  </xsl:call-template> <span style="0.5mm;"/>
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/ThirdPartyForeignAddress/CityNm"/>
                  </xsl:call-template>, <span style="0.5mm;"/>
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/ThirdPartyForeignAddress/ProvinceOrStateNm"/>
                  </xsl:call-template> <span style="0.5mm;"><span style="width:0.5mm;"/></span>
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/ThirdPartyForeignAddress/ForeignPostalCd"/>
                  </xsl:call-template> <span style="0.5mm;"><span style="width:0.5mm;"/></span>
                  <xsl:call-template name="PopulateText">
                    <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/ThirdPartyForeignAddress/CountryCd"/>
                  </xsl:call-template>
                </xsl:if>
    </div> 
 </div>
     ...
     <div class="IRS990ScheduleG_LineContainer" style="height:auto;"> 
       <div class="styLNDesc" style="width:24mm;height:auto;padding-left:8mm;padding-right:2mm;padding-top:1mm;">
        ...
        <xsl:choose>
                ...
                <xsl:choose>
                  <xsl:when test="$Form990ScheduleGData/GamingManagerBusinessName/BusinessNameLine1Txt != ''">
                    <xsl:call-template name="PopulateText">
                      <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/GamingManagerBusinessName/BusinessNameLine1Txt"/>
                    </xsl:call-template>
                  </xsl:when>
                </xsl:choose>
                <xsl:choose>
                  <xsl:when test="$Form990ScheduleGData/GamingManagerBusinessName/BusinessNameLine2Txt != ''">
                    <br/>
                    <xsl:call-template name="PopulateText">
                      <xsl:with-param name="TargetNode" select="$Form990ScheduleGData/GamingManagerBusinessName/BusinessNameLine2Txt"/>
                    </xsl:call-template>
                  </xsl:when>
                </xsl:choose>
