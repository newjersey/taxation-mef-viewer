...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:param name="FormData" select="$RtnDoc/IRS1065ScheduleK3" />
	<xsl:template match="/">
				...
				<form id="Form1065ScheduleK2" style="width:256mm;">
					...
					<div class="styStdDiv">
						<div class="styFNBox" style="width:30mm;height:21mm;">
							<span class="styFN" style="font-size:9pt;">SCHEDULE K-3<br />(Form 1065)</span> 
							<br />
					...
					<div class="styStdDiv" style="overflow:visible;border-top:2px solid black;">
						<div class="styGenericDiv" style="width:94mm;border-right:2px solid black;">
							...
							<div class="" style="width:100%;border-top:1px solid black;">
								...
								<div class="styLNDesc" style="width:87mm;">Partnership's employer identification number (EIN)</div>
								<div class="styLNDesc" style="width:100%;height:8mm;padding-right:0.5mm;">
					...
					<div class="styStdDiv" style="">
						<div class="styLNLeftLtrBox" style="width:6mm;">&nbsp;</div>
						<div class="styLNLeftNumBox" style="width:6mm;padding-left:0mm;">10</div>
						<div class="styLNDesc" style="width:151mm;">
					...
					<div class="styStdDiv" style="">
						<div class="styLNLeftLtrBox" style="width:6mm;">&nbsp;</div>
						<div class="styLNLeftNumBox" style="width:6mm;padding-left:0mm;">11</div>
						<div class="styLNDesc" style="width:151mm;">
					...
					<div class="styStdDiv" style="">
						<div class="styLNLeftLtrBox" style="width:6mm;">&nbsp;</div>
						<div class="styLNLeftNumBox" style="width:6mm;padding-left:0mm;">12</div>
						<div class="styLNDesc" style="width:151mm;">
						...
						<div class="styLNRightNumBox" style="height:4.5mm;background-color:lightgrey;">
							<!--<input type="checkbox" class="styCkboxNM" style="" alt="Part 12 Yes">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/PartXIIAttachedInd"/>
									<xsl:with-param name="BackupName">F1065SK2PartXIIAttachedInd</xsl:with-param>
								</xsl:call-template>
							</input>--> &nbsp;
						</div>
						<div class="styLNRightNumBox" style="height:4.5mm;border-right-width:1px;background-color:lightgrey;">
							<!--<input type="checkbox" class="styCkboxNM" style="" alt="Part 12 No">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/PartXIIAttachedInd"/>
									<xsl:with-param name="BackupName">F1065SK2PartXIIAttachedInd</xsl:with-param>
								</xsl:call-template>
					...
					<div class="styStdDiv" style="">
						<div class="styLNLeftLtrBox" style="width:6mm;">&nbsp;</div>
						<div class="styLNLeftNumBox" style="width:6mm;padding-left:0mm;">13</div>
						<div class="styLNDesc" style="width:151mm;">
							Does Part XIII apply? If "Yes," complete and attach Part XIII
							<span class="sty1065K2DotLn">..................</span>
						</div>
						<div class="styLNRightNumBoxNBB" style="height:4.5mm;">13</div>
						<div class="styLNRightNumBoxNBB" style="height:4.5mm;">
							<input type="checkbox" class="styCkboxNM" style="" alt="Part 13 Yes">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/PartXIIIAttachedInd"/>
									<xsl:with-param name="BackupName">F1065SK2PartXIIIAttachedInd</xsl:with-param>
								</xsl:call-template>
							</input>
						</div>
						<div class="styLNRightNumBoxNBB" style="height:4.5mm;border-right-width:1px;">
							<input type="checkbox" class="styCkboxNM" style="" alt="Part 13 No">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/PartXIIIAttachedInd"/>
									<xsl:with-param name="BackupName">F1065SK2PartXIIIAttachedInd</xsl:with-param>
								</xsl:call-template>
					...
					<div class="styStdDiv pageEnd" style="border-top:2px solid black;font-weight:bold;font-family:Arial;">
						...
						<span style="margin-left:3mm;font-weight:normal;">www.irs.gov/Form1065</span>
						<span style="margin-left:8mm;font-weight:normal;">Cat. No. 74715S</span>
						<span style="float:right;">Schedule K-3 (Form 1065) 2022</span>
					</div>
					<!-- Page 2 -->
					...
					<!-- Filer information section -->
					<xsl:call-template name="SchK3PageEntity"/>
					<!--Part 1 -->
					...
					<div class="styStdDivLS">
						...
						<div class="styGenericDiv" style="width:64mm;">
							...
							<br />
							<input type="checkbox" class="styCkboxNM" style="margin-right:2mm;" alt="Form 8865 information Ind">
								<xsl:call-template name="PopulateCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/Form8865AttachmentInd"/>
									<xsl:with-param name="BackupName">F1065SKForm8865AttachmentInd</xsl:with-param>
								</xsl:call-template>
							</input>
							...
							13. Other international items <br /> <span style="width:5mm;"/>(attach description and statement)
							<xsl:call-template name="SetFormLinkInline">
								<xsl:with-param name="TargetNode" select="$FormData/OtherInternationalItemsInd"/>
							</xsl:call-template>
						</div>
					...
					<xsl:variable name="sep2-1" select="(count($FormData/SchK2K3FrgnTaxCreditGroIncmGrp/SalesGrossIncomeGrp) &gt; 3)"/>
					<xsl:variable name="sep2-2" select="(count($FormData/SchK2K3FrgnTaxCreditGroIncmGrp/GrossIncmPerfOfSrvcGrp) &gt; 3)"/>
					<xsl:variable name="sep2-3" select="(count($FormData/SchK2K3FrgnTaxCreditGroIncmGrp/GroRntlRealEstateIncmGrp) &gt; 3)"/>
					<xsl:variable name="sep2-4" select="(count($FormData/SchK2K3FrgnTaxCreditGroIncmGrp/OthGrossRentalIncomeGrp) &gt; 3)"/>
					<xsl:variable name="sep2-6" select="(count($FormData/SchK2K3FrgnTaxCreditGroIncmGrp/SchK2K3InterestIncomeGrp) &gt; 3)"/>
					<xsl:variable name="sep2-7" select="(count($FormData/SchK2K3FrgnTaxCreditGroIncmGrp/SchK2K3OrdinaryDividendsGrp) &gt; 3)"/>
					...
					<xsl:variable name="sep2-8" select="(count($FormData/SchK2K3FrgnTaxCreditGroIncmGrp/QualifiedDividendsGrp) &gt; 3)"/>
					<xsl:variable name="sep2-10" select="(count($FormData/SchK2K3FrgnTaxCreditGroIncmGrp/RoyaltiesLicenseFeesGrp) &gt; 3)"/>
					<xsl:variable name="sep2-11" select="(count($FormData/SchK2K3FrgnTaxCreditGroIncmGrp/NetShortTermCapGainGrp) &gt; 3)"/>
					<xsl:variable name="sep2-12" select="(count($FormData/SchK2K3FrgnTaxCreditGroIncmGrp/NetLongTermCapGainGrp) &gt; 3)"/>
					<xsl:variable name="sep2-13" select="(count($FormData/SchK2K3FrgnTaxCreditGroIncmGrp/CollectiblesGainGrp) &gt; 3)"/>
					<xsl:variable name="sep2-14" select="(count($FormData/SchK2K3FrgnTaxCreditGroIncmGrp/SchK2K3UnrcptrSect1250GainGrp) &gt; 3)"/>
					<xsl:variable name="sep2-15" select="(count($FormData/SchK2K3FrgnTaxCreditGroIncmGrp/SchK2K3NetSection1231GainGrp) &gt; 3)"/>
					...
					<xsl:variable name="sep2-19" select="(count($FormData/SchK2K3FrgnTaxCreditGroIncmGrp/Section951aInclusionsGrp) &gt; 3)"/>
					<xsl:variable name="sep2-20" select="(count($FormData/SchK2K3FrgnTaxCreditGroIncmGrp/SchK2K3OtherIncomeGrp) &gt; 3)"/>
					<xsl:variable name="sep2-24" select="(count($FormData/SchK2K3FrgnTaxCreditGroIncmGrp/TotGrossIncomeByCountryGrp) &gt; 3)"/>
									...
									<xsl:for-each select="$FormData/SchK2K3ForeignTaxesGrp/FrgnTaxRedeterminationsGrp">
										<tr style="vertical-align:bottom;">
											...
											<td class="styTableCellTextInherit" style="">
												...
												<br />
												Contested tax
												<input type="checkbox" class="styCkboxNM" style="margin-right:2mm;" alt="Contested tax Ind">
												<xsl:call-template name="PopulateCheckbox">
													<xsl:with-param name="TargetNode" select="ContestedTaxInd"/>
													<xsl:with-param name="BackupName">F1065SKContestedTaxInd</xsl:with-param>
												</xsl:call-template>
												</input>
											</td>
											<xsl:call-template name="LineForeignTaxSingleP1">
								...
								<xsl:if test="$sep3-4-3 or ($count343 &lt; 1)">
									<tr>
										...
										<td class="styTableCellTextInherit" style="">
											...
											<br />
											Date tax paid &#9658;  
											<span style="width:58.5mm;border-bottom:1px dashed black;">&nbsp;</span>
											<br />
											Contested tax
								...
								<xsl:if test="$sep3-4-3 or ($count343 &lt; 2)">
									<tr>
										...
										<td class="styTableCellTextInherit" style="">
											...
											Date tax paid &#9658; <span style="width:58.5mm;border-bottom:1px dashed black;">&nbsp;</span> <br />
											Contested tax <input type="checkbox" class="styCkboxNM" style="margin-right:2mm;"/>
										</td>
										<td class="styTableCellAmtInherit" style="">&nbsp;</td>
										<td class="styTableCellAmtInherit" style="">&nbsp;</td>
										<td class="styTableCellAmtInherit" style="">&nbsp;</td>
							...
							<thead class="styTableThead">
								...
								<tr>
									...
									<th class="styTableCellHeader" scope="col" style="width:25mm;font-weight:normal;">
										<strong>(j)</strong> Election by partnership <br /> (see instructions)
									</th>
									<th class="styTableCellHeader" scope="col" style="width:25mm;font-weight:normal;">
					...
					<xsl:for-each select="$FormData/SchK2K3PrtshpFrgnCorpIncmGrp">
						...
						<xsl:call-template name="S960Page1-1">
							<xsl:with-param name="K3-1065" select="true()"/>
						</xsl:call-template>
						<div class="styStdDivLS pageEnd" style="border-top:1px solid black;font-weight:bold;">
							<span style="float:right;">Schedule K-3 (Form 1065) 2022</span>
						</div>
						<xsl:if test="position() != last()">
							...
							<div class="styStdDivLS">
								Schedule K-3 (Form 1065) 2022
								<span style="float:right;">Page <span style="font-weight:bold;font-size:8pt;">16</span> (excerpt)</span>
							</div>
							<xsl:call-template name="S960Page2-1">
								<xsl:with-param name="K3-1065" select="true()"/>
							</xsl:call-template>
							<div class="styStdDivLS pageEnd" style="border-top:1px solid black;font-weight:bold;">
								<span style="float:right;">Schedule K-3 (Form 1065) 2022</span>
					...
					<div class="styStdDivLS">
						Schedule K-3 (Form 1065) 2022
						<span style="float:right;">
							Page <span style="font-weight:bold;font-size:8pt;">16</span> 
						</span>
					</div>
					<!-- Filer information section -->
					<xsl:call-template name="SchK3PageEntity"/>
					<div class="styStdDivLS" style="border-top:1px solid black;border-bottom:1px solid black;">
						...
						<div class="styPartDesc" style="padding-left:3mm;width:230mm;">
							Partner's Interest in Foreign Corporations Income (Section 960) <span style="font-style:italic;font-weight:normal;">(continued)</span>
						</div>
					</div>
					...
					<div class="styStdDivLS" style="border-top:1px solid black;border-bottom:1px solid black;">
						<div class="styPartName" style="width:15mm;">Part IX</div>
						<div class="styPartDesc" style="padding-left:3mm;width:230mm;">
							Partner's Information for Base Erosion and Anti-Abuse Tax (Section 59A) <span style="font-weight:normal;font-style:italic;">(continued)</span>
						</div>
					</div>
					<!-- Part 9, Section 2 -->
					<div class="styStdDivLS" style="font-size:8pt;font-weight:bold;border-top:1px solid black;border-bottom:1px solid black;">
							...
							<tbody>
								...
								<tr>
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/OrdinaryBusinessIncomeGrossGrp"/>
									</xsl:call-template>
								</tr>
								<!-- Part 10, Line 2 -->
								<tr>
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/GrossRentalRealEstateIncomeGrp"/>
									</xsl:call-template>
								</tr>
								<!-- Part 10, Line 3 -->
								<tr>
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/OtherGrossRentalIncomeGrp"/>
									</xsl:call-template>
								</tr>
								<!-- Part 10, Line 4 -->
								<tr>
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/GuaranteedPaymentsForSrvcGrp"/>
									</xsl:call-template>
								</tr>
								<!-- Part 10, Line 5 -->
								<tr>
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/GuaranteedPymtForUseOfCapGrp"/>
									</xsl:call-template>
								</tr>
								<!-- Part 10, Line 6 -->
								<tr>
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/PrtshpDetermInterestIncomeGrp"/>
									</xsl:call-template>
								</tr>
								<!-- Part 10, Line 7 -->
								<tr>
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/DividendsGrp"/>
									</xsl:call-template>
								</tr>
								<!-- Part 10, Line 8 -->
								<tr>
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/DividendEquivalentsGrp"/>
									</xsl:call-template>
								</tr>
								<!-- Part 10, Line 9 -->
								<tr>
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/RoyaltiesAndLicenseFeesGrp"/>
									</xsl:call-template>
								</tr>
								<!-- Part 10, Line 10 -->
								<tr>
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/SchK2K3NetShortTermCapGainGrp"/>
									</xsl:call-template>
								</tr>
								<!-- Part 10, Line 11 -->
								<tr>
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/SchK2K3NetLongTermCapGainGrp"/>
									</xsl:call-template>
								</tr>
								<!-- Part 10, Line 12 -->
								<tr>
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/SchK2K3Collectible28PctGainGrp"/>
									</xsl:call-template>
								</tr>
								<!-- Part 10, Line 13 -->
								<tr>
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/GroIncmUnrcptrSect1250GainGrp"/>
									</xsl:call-template>
								</tr>
								<!-- Part 10, Line 14 -->
								<tr>
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/NetSection1231GainGrp"/>
									</xsl:call-template>
								</tr>
								<!-- Part 10, Line 15 -->
								<tr>
								...
								<tr style="vertical-align:bottom;">
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/OtherIncomeLossGrp"/>
									</xsl:call-template>
								</tr>
								<!-- Part 10, Line 21 -->
								<tr style="vertical-align:bottom;border-top:2px solid black;">
									...
									<td class="styTableCellTextInherit">
										...
										<xsl:call-template name="SetFormLinkInline">
											<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/GrossIncomeTotalGrp"/>
										</xsl:call-template>
										<span class="sty1065K2DotLn" style="margin-right:-5px;">......&#9658;</span>
									</td>
									<xsl:call-template name="LinePartnerDetermination">
					...
					<div class="styStdDivLS" style="border-top:1px solid black;border-bottom:1px solid black;">
						<div class="styPartName" style="width:15mm;">Part X</div>
						<div class="styPartDesc" style="padding-left:3mm;width:230mm;">
							Foreign Partner's Character and Source of Income and Deductions <span style="font-weight:normal;font-style:italic;">(continued)</span>
						</div>
					</div>
					<!-- Part 10, Section 2 -->
					<div class="styStdDivLS" style="font-size:8pt;font-weight:bold;border-top:1px solid black;border-bottom:1px solid black;">
						...
						<table class="styTable" style="border-collapse:collapse;font-size:7pt;">
							...
							<tbody>
								...
								<tr style="vertical-align:bottom;">
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/ExpnssRltdOrdnryBusIncmGroGrp"/>
									</xsl:call-template>
								</tr>
								...
								<tr>
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/PrtrshpDetermREExpensesGrp"/>
									</xsl:call-template>
								</tr>
								...
								<tr>
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/ExpnssFromRentalRealEstateGrp"/>
									</xsl:call-template>
								</tr>
								...
								<tr>
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/ExpnssFromOtherRentalActyGrp"/>
									</xsl:call-template>
								</tr>
								...
								<tr>
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/RoyaltyAndLicensingExpensesGrp"/>
									</xsl:call-template>
								</tr>
								...
								<tr>
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/PrtshpDetermSection179DedGrp"/>
									</xsl:call-template>
								</tr>
								...
								<tr style="vertical-align:bottom;">
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/IntExpnsUSBookedLiabilitiesGrp"/>
									</xsl:call-template>
								</tr>
								...
								<tr style="vertical-align:bottom;">
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/IntExpnsDrtAllcblUnderRegsGrp"/>
									</xsl:call-template>
								</tr>
								...
								<tr>
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/SchK2K3OtherInterestExpenseGrp"/>
									</xsl:call-template>
								</tr>
								...
								<tr>
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/Sect59e2ExpendituresGrp"/>
									</xsl:call-template>
								</tr>
								...
								<tr>
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/SchK2K3NetShortTermCapLossGrp"/>
									</xsl:call-template>
								</tr>
								...
								<tr>
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/SchK2K3NetLongTermCapLossGrp"/>
									</xsl:call-template>
								</tr>
								...
								<tr>
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/SchK2K3CollectiblesLossGrp"/>
									</xsl:call-template>
								</tr>
								...
								<tr>
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/SchK2K3NetSection1231LossGrp"/>
									</xsl:call-template>
								</tr>
								...
								<xsl:for-each select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/SchK2K3OtherLossesGrp">
									<tr style="vertical-align:bottom;">
								...
								<xsl:if test="count($FormData/SchK3FrgnPrtnrSrceIncmDedGrp/SchK2K3OtherLossesGrp) &lt; 1">
									<tr style="vertical-align:bottom;">
										<td class="sty1065K2RowNumCell" style="border-width:0px;">&nbsp;</td>
								...
								<xsl:if test="count($FormData/SchK3FrgnPrtnrSrceIncmDedGrp/SchK2K3OtherLossesGrp) &lt; 2">
									<tr style="vertical-align:bottom;">
										<td class="sty1065K2RowNumCell" style="border-width:0px;">&nbsp;</td>
										<td class="styTableCellTextInherit" style="">&nbsp;</td>
										<xsl:call-template name="LinePartnerDetermination">
								...
								<tr>
									...
									<td class="styTableCellAmtInherit" style="">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/CharitableContributionsGrp/TotalAmt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellAmtInherit" style="background-color:lightgrey;">&nbsp;</td>
									<td class="styTableCellAmtInherit" style="">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/CharitableContributionsGrp/ECIUSSourceAmt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellAmtInherit" style="background-color:lightgrey;">&nbsp;</td>
									<td class="styTableCellAmtInherit" style="background-color:lightgrey;">&nbsp;</td>
								...
								<tr style="vertical-align:bottom;">
									...
									<td class="styTableCellTextInherit" style="">
										Other &#9658; 
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/OtherDeductionLineGrp[1]/OtherDeductionTypeDesc"/>
										</xsl:call-template>
									</td>
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/OtherDeductionLineGrp[1]"/>
									</xsl:call-template>
								</tr>
								...
								<tr style="vertical-align:bottom;">
									...
									<td class="styTableCellTextInherit" style="">
										Other &#9658; 
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/OtherDeductionLineGrp[2]/OtherDeductionTypeDesc"/>
										</xsl:call-template>
									</td>
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/OtherDeductionLineGrp[2]"/>
									</xsl:call-template>
								</tr>
								<xsl:for-each select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/OtherDeductionLineGrp[position() &gt; 2]">
									<tr style="vertical-align:bottom;">
								...
								<tr>
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/TotDeductionsLossesNetIncmGrp"/>
									</xsl:call-template>
								</tr>
								<!-- Part 10, Line 25-->
								<tr style="vertical-align:bottom;border-top:2px solid black;">
									...
									<td class="styTableCellAmtInherit" style="">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/TotalNetIncomeLossAmt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellAmtInherit" style="background-color:lightgrey;">&nbsp;</td>
									<td class="styTableCellAmtInherit" style="background-color:lightgrey;">&nbsp;</td>
					...
					<div class="styGenericDiv" style="width:129.7mm;border-right:1px solid black;">
						...
						<div class="styStdDiv" style="width:126mm;">
							...
							<div class="styLNAmountBox" style="border-left:none;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/GrossECIAmt"/>
								</xsl:call-template>
							</div>
						</div>
						<div class="styStdDiv" style="width:126mm;">
							...
							<div class="styLNAmountBox" style="border-left:none;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/WorldwideGrossIncomeAmt"/>
								</xsl:call-template>
							</div>
						</div>
						...
						<div class="styStdDiv" style="width:126mm;">
							...
							<div class="styLNAmountBox" style="border-left:none;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/AverageUSAssetsAmt"/>
								</xsl:call-template>
							</div>
						</div>
						<div class="styStdDiv" style="width:126mm;">
							...
							<div class="styLNAmountBox" style="border-left:none;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/WorldwideAssetsAmt"/>
								</xsl:call-template>
							</div>
						</div>
						...
						<div class="styStdDiv" style="width:126mm;">
							...
							<div class="styLNAmountBox" style="border-left:none;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/USBookedLiabilitiesAmt"/>
								</xsl:call-template>
							</div>
						</div>
						<div class="styStdDiv" style="width:126mm;">
							...
							<div class="styLNAmountBox" style="border-left:none;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/DirectlyAllocPrtshpIndbtAmt"/>
								</xsl:call-template>
							</div>
						</div>
						...
						<div class="styStdDiv" style="width:126mm;">
							...
							<div class="styLNAmountBox" style="width:41mm;border-left:none;">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/PersonnelWithinUSCnt"/>
								</xsl:call-template>
							</div>
						</div>
						<div class="styStdDiv" style="width:126mm;">
							...
							<div class="styLNAmountBox" style="width:41mm;border-left:none;">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/WorldwidePersonnelCnt"/>
								</xsl:call-template>
							</div>
						</div>
						...
						<div class="sty1065K2Halftable" style="" id="SICSales">
							...
							<table class="styTable" style="border-collapse:collapse;font-size:7pt;">
								...
								<tbody>
									<xsl:for-each select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/SchK2K3GrossRcptsBySICCodeGrp">
										<tr>
									...
									<xsl:if test="count($FormData/SchK3FrgnPrtnrSrceIncmDedGrp/SchK2K3GrossRcptsBySICCodeGrp) &lt; 1">
										<tr>
									...
									<xsl:if test="count($FormData/SchK3FrgnPrtnrSrceIncmDedGrp/SchK2K3GrossRcptsBySICCodeGrp) &lt; 2">
										<tr>
					...
					<div class="styGenericDiv" style="width:126mm;">
						...
						<div class="sty1065K2Halftable" style="" id="OtherKey1">
							...
							<table class="styTable" style="border-collapse:collapse;font-size:7pt;">
								...
								<tbody>
									<xsl:for-each select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/OtherAllocAndApprtnKey1Grp">
										<tr>
									...
									<xsl:if test="count($FormData/SchK3FrgnPrtnrSrceIncmDedGrp/OtherAllocAndApprtnKey1Grp) &lt; 1">
										<tr>
											<td class="styTableCellTextInherit" style="font-weight:bold;border:none;padding-left:4mm;">a</td>
											<td class="styTableCellCtrInherit" style="">&nbsp;</td>
											<td class="styTableCellAmtInherit" style="border-right-width:0px;">&nbsp;</td>
									...
									<xsl:if test="count($FormData/SchK3FrgnPrtnrSrceIncmDedGrp/OtherAllocAndApprtnKey1Grp) &lt; 2">
										<tr>
											<td class="styTableCellTextInherit" style="font-weight:bold;border:none;padding-left:4mm;">b</td>
											<td class="styTableCellCtrInherit" style="">&nbsp;</td>
											<td class="styTableCellAmtInherit" style="border-right-width:0px;">&nbsp;</td>
						...
						<div class="sty1065K2Halftable" style="" id="OtherKey2">
							...
							<table class="styTable" style="border-collapse:collapse;font-size:7pt;">
								...
								<tbody>
									<xsl:for-each select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/OtherAllocAndApprtnKey2Grp">
										<tr>
											<td class="styTableCellAmtInherit" style="font-weight:bold;border:none;padding-right:2.2mm;">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="AlphaRowId"/>
									...
									<xsl:if test="count($FormData/SchK3FrgnPrtnrSrceIncmDedGrp/OtherAllocAndApprtnKey2Grp) &lt; 1">
										<tr>
											<td class="styTableCellTextInherit" style="font-weight:bold;border:none;padding-left:4mm;">a</td>
											<td class="styTableCellCtrInherit" style="">&nbsp;</td>
											<td class="styTableCellAmtInherit" style="border-right-width:0px;">&nbsp;</td>
									...
									<xsl:if test="count($FormData/SchK3FrgnPrtnrSrceIncmDedGrp/OtherAllocAndApprtnKey2Grp) &lt; 2">
										<tr>
											<td class="styTableCellTextInherit" style="font-weight:bold;border:none;padding-left:4mm;">b</td>
											<td class="styTableCellCtrInherit" style="">&nbsp;</td>
											<td class="styTableCellAmtInherit" style="border-right-width:0px;">&nbsp;</td>
					...
					<div class="styStdDivLS">
						Schedule K-3 (Form 1065) 2022
						<span style="float:right;">Page <span style="font-weight:bold;font-size:8pt;">20</span></span>
					</div>
					<!-- Filer information section -->
					<xsl:call-template name="SchK3PageEntity"/>
					<div class="styStdDivLS" style="border-top:1px solid black;border-bottom:1px solid black;">
					...
					<div class="styStdDivLS">
						...
						<div class="styLNDesc" style="width:240mm;height:auto;">
							Box is checked if the partnership is a publicly traded partnership as defined in section 7704(b) and the partnership is a covered partnership 
							as defined in Regulations section 1.871-15(m)(1) or directly or indirectly holds an interest in a lower-tier partnerhip 
					...
					<div class="styStdDivLS">
						...
						<div class="styLNAmountBox" style="border-left:none;text-align:right;width:48mm;">
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="$FormData/UnitsHeldByPartnerCnt"/>
							</xsl:call-template>
						</div>
					</div>
					<div class="styStdDivLS">
					...
					<div class="styStdDivLS" style="border-top:1px solid black;border-bottom:1px solid black;margin-bottom:2mm;">
					...
					<!-- Part 13 -->
					<xsl:for-each select="$FormData/SchK3SharePrtshpIntTrnsfrGrp">
						<xsl:call-template name="K3DistributiveShare"/>
					</xsl:for-each>
					<xsl:if test="count($FormData/SchK3SharePrtshpIntTrnsfrGrp) &lt; 1">
						<xsl:call-template name="K3DistributiveShare"/>
					</xsl:if>
					<div class="styStdDivLS pageEnd" style="border-top:1px solid black;font-weight:bold;">
						<span style="float:right;">Schedule K-3 (Form 1065) 2022</span>
...
<!-- Additonal Data Title Bar and Button -->
								...
								<xsl:for-each select="$FormData/SchK2K3ForeignTaxesGrp/FrgnTaxRedeterminationsGrp">
									<tr style="vertical-align:bottom;border-color:black;">
										...
										<td class="styTableCellTextInherit" style="">
											...
											<xsl:call-template name="PopulateCheckbox">
												<xsl:with-param name="TargetNode" select="ContestedTaxInd"/>
												<xsl:with-param name="BackupName">F1065SK2ContestedTaxInd</xsl:with-param>
											</xsl:call-template>
											</input>
										</td>
										<xsl:call-template name="LineForeignTaxSingleP1">
	...
	<xsl:template name="S960Page1-1">
		<xsl:param name="K3-1065" select="false()"/>
		<xsl:param name="K2-1120S" select="false()"/>
		<xsl:param name="K3-1120S" select="false()"/>
		<xsl:variable name="Entity">
			<xsl:choose>
				<xsl:when test="$K2-1120S">S Corporation's</xsl:when>
				<xsl:when test="$K3-1120S">Shareholder's</xsl:when>
		...
		<!-- Filer information section -->
		<xsl:choose>
			<xsl:when test="$K2-1120S"><xsl:call-template name="SchK2PageEntity1120S"/></xsl:when>
			<xsl:when test="$K3-1120S"><xsl:call-template name="SchK3PageEntity1120S"/></xsl:when>
		...
		<div class="styStdDivLS" style="border-top:1px solid black;border-bottom:1px solid black;">
			<div class="styPartName" style="width:15mm;">
				<xsl:choose>
					<xsl:when test="$K2-1120S or $K3-1120S">Part VII</xsl:when>
					<xsl:otherwise>Part VIII</xsl:otherwise>
				</xsl:choose>
			</div>
			<div class="styPartDesc" style="padding-left:3mm;width:230mm;">
				<xsl:choose>
					<xsl:when test="$K3-1120S">Shareholder's Share of S Corporation's Interest in Foreign Corporation Income (Section 960)</xsl:when>
					<xsl:otherwise><xsl:value-of select="$Entity"/> Interest in Foreign Corporation Income (Section 960)</xsl:otherwise>
				</xsl:choose>
			</div>
		</div>
		<div class="styStdDivLS">
			...
			<div class="styLNDesc" style="width:85mm;">
				<xsl:if test="not($K3-1065) and not($K3-1120S)">Enter </xsl:if>EIN or reference ID number of controlled foreign corporation :
			</div>
			...
			<div class="styLNLeftNumBoxSD" style="margin-left:4mm;">B</div>
			<div class="styLNDesc" style="width:80mm;">
				<xsl:choose>
					<xsl:when test="$K3-1065 or $K3-1120S">
						Separate category. See instructions
						<span class="sty1065K2DotLn">........</span>
					</xsl:when>
					<xsl:otherwise>
						Separate category (enter code &mdash; see instructions) : <span class="sty1065K2DotLn">..</span>
					</xsl:otherwise>
				</xsl:choose>
			</div>
			<div class="styLNAmountBox" style="border-left:none;text-align:center;">
		...
		<div class="styStdDivLS">
			...
			<div class="styLNDesc" style="width:216mm;">
				If PAS was entered on line B, <xsl:if test="not($K3-1065 or $K3-1120S)">enter the </xsl:if> applicable grouping 
				under Regulations section 1.904-4(c). See instructions
				<span class="sty1065K2DotLn"><xsl:if test="$K3-1065 or $K3-1120S">...</xsl:if>..................</span>
			</div>
			<div class="styLNAmountBox" style="border-left:none;text-align:center;">
				<xsl:call-template name="PopulateText">
			...
			<table class="styTable" style="border-collapse:collapse;font-size:7pt;">
				<thead class="styTableThead">
					<tr style="border-top:1px solid black;">
						...
						<th class="styTableCellHeader" scope="col" style="width:132mm;font-weight:normal;font-style:italic;text-align:left;padding-left:6px;">
							<xsl:choose>
								<xsl:when test="$K3-1065 or $K3-1120S">Amounts are in functional currency unless otherwise noted. <br /> See instructions.</xsl:when>
						...
						<th class="styTableCellHeader" scope="col" style="width:32mm;font-weight:normal;">
							<strong>(iii) </strong> Reserved for future use
						</th>
				...
				<tbody>
					...
					<tr style="vertical-align:top;">
						...
						<td class="styTableCellTextInherit" style="">
							Dividends, interest, rents, royalties, and annuities (total)
							<span class="sty1065K2DotLn">..............</span>
						</td>
					...
					<xsl:call-template name="UnitLineIntFCIncome-1">
						<xsl:with-param name="TargetNode" select="K2K3DivIntRntsRyltsAnntsGrp"/>
						<xsl:with-param name="K2-1120S" select="$K2-1120S"/>
					</xsl:call-template>
					<!-- Line 1b total -->
					<tr style="vertical-align:top;">
					...
					<tr>
						...
						<xsl:call-template name="TotCellsIntFCIncome">
							<xsl:with-param name="TargetNode" select="K2K3SubpartFOtherGrp"/>
						</xsl:call-template>
					</tr>
					<xsl:call-template name="UnitLineIntFCIncome-1">
						<xsl:with-param name="TargetNode" select="K2K3OtherGrp"/>
						<xsl:with-param name="K2-1120S" select="$K2-1120S"/>
					</xsl:call-template>
					<!-- Line 1g total -->
					<tr>
					...
					<!-- Line 1m total -->
					<tr>
						<td class="styTableCellCtrInherit" style="font-weight:bold;border:none;text-align:right;padding-right:3px;">m</td>
						<td class="styTableCellTextInherit" style="">
							Section 901(j) (total)
							<span class="sty1065K2DotLn">.........................</span>
						</td>
	...
	<xsl:template name="UnitLineIntFCIncome-1">
	...
	<xsl:if test="(count($TargetNode) &lt; 1)">
		<tr>
			<td class="styTableCellAmtInherit" style="font-weight:bold;border:none;">&nbsp;</td>
			<td class="styTableCellTextInherit" style="font-color:red;">
				<xsl:choose>
					<xsl:when test="$K2-1120S">
	...
	<xsl:if test="(count($TargetNode) &lt; 2)">
		<tr>
			<td class="styTableCellAmtInherit" style="font-weight:bold;border:none;">&nbsp;</td>
			<td class="styTableCellTextInherit" style="">
				<xsl:choose>
