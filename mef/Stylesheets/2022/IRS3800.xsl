			...
			<body class="styBodyClass">
               ...
               Form<span class="styFormNumber"> 3800</span>
                ...
                OMB No. 1545-0895
							...
							<div class="styTaxYear" style="height:9mm;padding-top:0;">20<span class="styTYColor">22</span>
							</div>
         ...
         <xsl:call-template name="PartIIITemplate"/>        
					...
					<div class="styBB" style="width:187mm;">
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139mm;">
								<span style="float:left;">Enter the applicable passive activity credits allowed for 2022.  See instructions </span>
								<!--Dotted Line-->
								<div class="styDotLn" style="float:right;">.........</div>
							</div>
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139mm;">
								Carryforward of general business credit to 2022. Enter the amount from line 2 of Part III with box C 
					...
					<div style="width:187mm;">
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139mm;">
								...
								Carryback of general business credit from 2023. Enter the amount from line 2 of Part III with box D 
		       ...
		       Regular tax before credits:
					...
					<span class="styDotLn" style="float:right;">..................</span>
					 ...
					 lines 1a and 1b, plus any Form 8978 amount included on line 1d; or the amount from the applicable line of your return
					<span class="styDotLn" style="float:right;">.................</span>
									</li>
								</ul>
							</div>
             ...
             Tentative minimum tax: 
                ...
                <!--Pen and ink image -->
						...
						<div style="width:187mm;clear:both;" class="styGenericDiv">
							...
							<div style="float:right;" class="styGenericDiv">Form <span class="styBoldText">3800</span> (2022)</div>
						</div>
					</div>
<div class="styStdDiv pageEnd"/>
					<!-- Page 2 Header -->
					<div style="width:187mm;clear:both;padding-bottom:.5mm;" class="styBB">
						<div style="width:90mm;" class="styGenericDiv">Form 3800 (2022)</div>
              ...
              Passive activity credit from line 3 of all Parts III with box B checked 
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139mm;">
								<span style="float:left;">Enter the applicable passive activity credit allowed for 2022. See instructions</span>
								<div class="styDotLn" style="float:right;">.........</div>
							</div>
              ...
              <!--<span style="float:left;">line 6 of all Parts III with box F check</span>-->
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139mm;">
              Carryforward of business credit to 2022. Enter the amount from line 5 of Part III with box C checked 
                ...
                <!-- Push Pin image -->
					...
					<div style="width:187mm;">
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139mm;">
              Carryback of business credit from 2023. Enter the amount from line 5 of Part III with box D checked 
...
Enter the appropriate amount
				...
				<div style="width:187mm;">
					<div style="float:left;clear:none:">
						...
						<div class="styLNDesc" style="height:4mm;width:107mm;">
							<span style="float:left">Advanced Manufacturing Production (Form 7207)
								<!-- Push Pin image -->
								<span style="float:none;">
									<xsl:call-template name="SetFormLinkInline">
										<xsl:with-param name="TargetNode" select="BusinessCreditsGrp/CYAdvncManufacturingProdCrGrp/AdvncManufacturingProdCrAmt"/>
									</xsl:call-template>
								</span>
							</span>
							<!--Dotted Line -->
					...
					<div style="float:right;clear:none;">
						...
						<div class="styLNAmountBoxNBB" style="border-top-width:1px;text-align:center;height:4.5mm;">
							<xsl:if test="BusinessCreditsGrp/CYIncreasingResearchCrGrp/PassThroughEntityEIN !=''">
								<xsl:call-template name="PopulateEIN">
									<xsl:with-param name="TargetNode" select="BusinessCreditsGrp/CYAdvncManufacturingProdCrGrp/PassThroughEntityEIN"/>
								</xsl:call-template>
							</xsl:if>
							<xsl:if test="BusinessCreditsGrp/CYIncreasingResearchCrGrp/MissingEINReasonCd !=''">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="BusinessCreditsGrp/CYAdvncManufacturingProdCrGrp/MissingEINReasonCd"/>
								</xsl:call-template>
							</xsl:if>
						</div>
				...
				<div style="width:187mm;">
					<div style="float:left;clear:none:">
						...
						<div class="styLNDesc" style="height:4mm;width:107mm;">
							<span style="float:left">  Low-income housing (carryforward only) (see instructions)
                 <!-- Push Pin image -->
								<span style="float:none;">
									<xsl:call-template name="SetFormLinkInline">
...
<!--								<xsl:call-template name="SetFormLinkInline">
				...
				<div style="width:187mm;">
					<div style="float:left;clear:none:">
						...
						<div class="styLNDesc" style="height:4mm;width:107mm;">
							<span style="float:left">Enhanced oil recovery credit (Form 8830)
							<!-- Push Pin image -->
							<xsl:call-template name="SetFormLinkInline">
               ...
               General credits from an electing large partnership (carryforward only) 
				...
				<div style="width:187mm;">
					<div style="float:left;clear:none:">
						...
						<div class="styLNDesc" style="height:4mm;width:107mm;">
							<span style="float:left">Other. Oil and gas production from marginal wells (Forms 8904) and certain other credits (see instructions)
								<xsl:call-template name="SetFormLinkInline">
          ...
          <!-- Push Pin image -->
				...
				<div style="width:187mm;">
					<div style="float:left;clear:none:">
						<div class="styLNLeftNumBox" style="height:4mm;padding-left:4mm;">d</div>
						<div class="styLNDesc" style="height:4mm;width:107mm;">
							<span style="float:left"> Low-income housing (Form 8586) 
                   	<!-- Push Pin image -->
								<xsl:call-template name="SetFormLinkInline">
...
Enter the appropriate amount
				...
				<div style="width:187mm;">
					<div style="float:left;clear:none:">
						<div class="styLNLeftNumBox" style="height:4mm;padding-left:4mm;">b</div>
						<div class="styLNDesc" style="height:4mm;width:107mm;">
							<span style="float:left">Advanced Manufacturing Production (Form 7207)</span>
							<!--Dotted Line -->
							<div class="styDotLn" style="float:right;">..........</div>
						</div>
					</div>
             ...
             instructions for limitation)
				...
				<div style="width:187mm;">
					<div style="float:left;clear:none:">
						<div class="styLNLeftNumBox" style="height:4mm;padding-left:4mm;">t</div>
						<div class="styLNDesc" style="height:4mm;width:107mm;">
							<span style="float:left">Enhanced oil recovery credit (Form 8830)</span>
							<!--Dotted Line -->
							<div class="styDotLn" style="float:right;">...........</div>
						</div>
					</div>
				...
				<div style="width:187mm;">
					<div style="float:left;clear:none:">
						...
						<div class="styLNDesc" style="height:4mm;width:107mm;">
							<span style="float:left">Other. Oil and gas production from marginal wells (Form 8904) and certain other credits (see instructions)
							<!--Dotted Line -->
							<div class="styDotLn" style="float:right;">.................</div>
							</span>
						</div>
				...
				<div style="width:187mm;">
					<div style="float:left;clear:none:">
						<div class="styLNLeftNumBox" style="height:4mm;padding-left:4mm;">e</div>
						<div class="styLNDesc" style="height:4mm;width:107mm;padding-top:1mm;"> 
              <span style="float:left">Renewable electricity production (Form 8835)</span>
							<!--Dotted Line -->
							<div class="styDotLn" style="float:right;">..........</div>
						</div>
					</div>
