        ...
        <style type="text/css">
          ...
          <xsl:for-each select="/AppData/PrintDocuments/Document">
            <xsl:choose>
              ...
              <xsl:when test="@documentName='IRS1040Schedule1'">
                <xsl:call-template name="IRS1040Schedule1Style"/>
              </xsl:when>
              <xsl:when test="@documentName='IRS1040Schedule2'">
                <xsl:call-template name="IRS1040Schedule2Style"/>
              </xsl:when>
              <xsl:when test="@documentName='IRS1040Schedule3'">
              ...
              <xsl:when test="@documentName='IRS1040ScheduleLEP'">
              ...
              <xsl:when test="@documentName='IRS1040SR'">
              ...
              <xsl:when test="@documentName='IRS1065ScheduleB2'">
              ...
              <xsl:when test="@documentName='IRS461'">
              ...
              <xsl:when test="@documentName='IRS5227'">
              ...
              <xsl:when test="@documentName='IRS5471ScheduleE'">
                <xsl:call-template name="IRS5471ScheduleEStyle"/>
              </xsl:when>
              <xsl:when test="@documentName='IRS5471ScheduleG1'">
                <xsl:call-template name="IRS5471ScheduleG1Style"/>
              </xsl:when>
              <xsl:when test="@documentName='IRS5471ScheduleH'">
                <xsl:call-template name="IRS5471ScheduleHStyle"/>
              </xsl:when>
              <xsl:when test="@documentName='IRS5471ScheduleI1'">
              ...
              <xsl:when test="@documentName='IRS8038CPScheduleA'">
                <xsl:call-template name="IRS8038CPScheduleAStyle"/>
              </xsl:when>
              <xsl:when test="@documentName='IRS8038CP'">
              ...
              <xsl:when test="@documentName='IRS8838P'">
              ...
              <xsl:when test="@documentName='IRS8865ScheduleG'">
                <xsl:call-template name="IRS8865ScheduleGStyle"/>
              </xsl:when>
              <xsl:when test="@documentName='IRS8865ScheduleH'">
              ...
              <xsl:when test="@documentName='IRS8865ScheduleK2'">
                <xsl:call-template name="IRS8865ScheduleK2Style"/>
              </xsl:when>
              <xsl:when test="@documentName='IRS8865ScheduleK3'">
              ...
              <xsl:when test="@documentName='IRS8915F'">
              ...
              <xsl:when test="@documentName='IRS8975ScheduleA'">
                <xsl:call-template name="IRS8975ScheduleAStyle"/>
              </xsl:when>
              <xsl:when test="@documentName='IRS8975'">
                <xsl:call-template name="IRS8975Style"/>
              </xsl:when>
              <xsl:when test="@documentName='IRS8978ScheduleA'">
                <xsl:call-template name="IRS8978ScheduleAStyle"/>
              </xsl:when>
              <xsl:when test="@documentName='IRS8978'">
                <xsl:call-template name="IRS8978Style"/>
              </xsl:when>
              <xsl:when test="@documentName='IRS8990'">
              ...
              <xsl:when test="@documentName='IRS8992'">
                <xsl:call-template name="IRS8992Style"/>
              </xsl:when>
              <xsl:when test="@documentName='IRS8993'">
              ...
              <xsl:when test="@documentName='IRS8996'">
                <xsl:call-template name="IRS8996Style"/>
              </xsl:when>
              <xsl:when test="@documentName='IRS8997'">
                <xsl:call-template name="IRS8997Style"/>
              </xsl:when>
              <xsl:when test="@documentName='IRS9000'">
              ...
              <xsl:when test="@documentName='IRS943ScheduleR'">
              ...
              <xsl:when test="@documentName='IRS965A'">
                <xsl:call-template name="IRS965AStyle"/>
              </xsl:when>
              <xsl:when test="@documentName='IRS965B'">
                <xsl:call-template name="IRS965BStyle"/>
              </xsl:when>
              <xsl:when test="@documentName='IRS965ScheduleF'">
                <xsl:call-template name="IRS965ScheduleFStyle"/>
              </xsl:when>
              <xsl:when test="@documentName='IRS965ScheduleH'">
                <xsl:call-template name="IRS965ScheduleHStyle"/>
              </xsl:when>
              <xsl:when test="@documentName='IRS965'">
