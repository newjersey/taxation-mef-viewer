    ...
    <table id="ILSTbl" class="styDepTbl" style="text-align:center;">
      <thead class="styTableThead">
        <tr class="styDepTblHdr"> 
 			<th class="styDepTblCell" scope="col" style="width:80mm;">Schedule Or Form Number</th>
			<th class="styDepTblCell" scope="col" style="width:80mm;">Section Or Election Text</th> 
			<th class="styDepTblCell" scope="col" style="width:80mm;">Explanation of the changes</th>      
        </tr>
      </thead>
       <tbody>    
