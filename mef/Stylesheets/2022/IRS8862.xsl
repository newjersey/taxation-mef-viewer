			...
			<body class="styBodyClass" style="width:187mm;">
				<form name="IRS8862" style="font-family:arial;">
					...
					<div class="styBB" style="width:187mm;height:20.5mm;">
						...
						<div class="styIRS8862LineItem">
							<div class="styIRS8862CleanDiv" style="width:200mm;">
								...
								<div class="styIRS8862CleanDiv" style="width:100%;height:auto;">
									<div class="styIRS8862LNDesc" style="height:100%;width:187mm;padding-left:0mm;">
					...
					<div class="styBB" style="width:187mm;height:32mm;">
						<!-- (1) ////////////////////////////////////////////////////-->
						<div class="styIRS8862LineItem" style="width:187mm;height:6mm;padding-top:1mm;">
							...
							<div class="styIRS8862CleanDiv" style="width:144mm;height:4mm;padding:0px 0px 0px 0px;">
								<div class="styIRS8862LNDesc" style="width:auto;height:4mm;padding:0px 0px 0px 0px;">
									<div class="styIRS8862LNDesc" style="width:auto;height:4mm;">
										Enter the tax year for which you are filing this form (for example, 2022)
									</div>
						...
						<!-- (2) ////////////////////////////////////////////////////-->
						<div class="styIRS8862LineItem" style="width:187mm;height:26mm;padding-top:1mm;">
							<div>							
								<div class="styIRS8862LNLeftNumBox" style="padding-right:3mm; height:8mm;">2</div>
							...
							<div class="styIRS8862LineItem" style="width:187mm; height:16mm; ">
									...
									<div class="styIRS8862LineItem" style="width:90mm;height:5mm;font-weight:bold;font-align:center;padding-left:10mm;padding-bottom:7mm;border-bottom-width: 0px;">
										<!--<label>
											<xsl:call-template name="PopulateLabel">
											...
											<span style="width:80mm;padding-left:5mm;">Child Tax Credit (nonrefundable or refundable)/Additional </span>
											<span style="width:80mm;padding-left:10.5mm;">Child Tax Credit/Credit for Other Dependents</span>
										</label>-->
										<span style="width:80mm;padding-left:5mm;">Child Tax Credit (nonrefundable or refundable)/Additional </span>
											<span style="width:80mm;padding-left:10.5mm;">Child Tax Credit/Credit for Other Dependents</span>
										<div class="styIRS8862LineItem" style="width:60mm;font-weight:lighter;padding-left:25mm;border-bottom-width: 0px;">
											<font color="gray">(Complete Part III)</font>
											<span style="padding-left:11mm; padding-top:2mm;">
												<xsl:call-template name="PopulateSpan">
													<xsl:with-param name="TargetNode" select="$Form8862Data/CTCACTCODCClaimedInd"/>
												</xsl:call-template>
									...
									<div class="styIRS8862LineItem" style="width:55mm;height:5mm;font-weight:bold;padding-left:9mm;border-bottom-width: 0px;">
										<!--<label>
											<xsl:call-template name="PopulateLabel">
...
-						<div style="float:left; width:80mm;">
						...
						<div style="float:right;padding-top:1mm;">
							<span style="width:50px;"/>  
								Form 
							<span class="styBoldText" style="font-size:8pt;">8862</span> (Rev. 12-2022)
						</div>
					</div>
					<br/>
					...
					<div class="styTBB" style="width:187mm;padding-top:2mm;">
						<div style="float:left;">
							Form 8862 (Rev. 12-2022)<span style="width:148mm;"/>
						</div>
					...
					<div class="styIRS8862LineItem" style="width:187;height:12mm;padding-top:.5mm;padding-bottom:5mm;">
						...
						<div class="styIRS8862LNDesc" style="width:175mm;height:12mm;">
							Enter the name(s) of each child for whom you are claiming the child tax credit/refundable child tax credit/additional child tax credit (CTC/RCTC/ACTC). If you are claiming the
							CTC/RCTC/ACTC for more than four qualifying children, attach a statement also answering questions 12 and 14–17 for those children.
						</div>
					</div>
					<div class="styIRS8862LineItem" style="width:93.5mm;float:left;">
...
<xsl:with-param name="AltName">Live With Child 4 Over Half Year</xsl:with-param>								
					...
					<xsl:choose>
						<xsl:when test="count($Form8862Data/CTCACTCChildInformationGrp) &lt; 5">
							<div class="styIRS8862LineItem" style="width:187;height:10mm;padding-top:3.5mm;padding-bottom:2mm;">
								...
								<div class="styIRS8862LNDesc" style="width:175mm;height:10mm;">
										For each child listed in response to question 12, did the child meet the requirements to be a qualifying child for the CTC/RCTC/ACTC?
									</div>
							</div>
							<!-- (Line 15 Child 1) ////////////////////////////////////////////////////-->
							<div class="styIRS8862LineItem" style="width:187mm;padding-left:9mm;padding-top:1.5mm;font-size:8.5pt;">
...
<xsl:with-param name="AltName">Dependent 1 Ind</xsl:with-param>								
								</xsl:call-template>
								<span style="width:7mm;"/>
								<b style="font-size:8pt;">Child 2</b>
								<span style="width:2mm;"/>
...
<xsl:with-param name="AltName">Dependent 2 Ind</xsl:with-param>								
								</xsl:call-template>
								<span style="width:7mm;"/>
								<b style="font-size:8pt;">Child 3</b>
								<span style="width:2mm;"/>
...
<xsl:with-param name="AltName">Dependent 3 Ind</xsl:with-param>								
								</xsl:call-template>
								<span style="width:7mm;"/>
								<b style="font-size:8pt;">Child 4</b>
								<span style="width:2mm;"/>
...
<xsl:with-param name="AltName">Dependent 4 Ind</xsl:with-param>								
								</xsl:call-template>
							</div>
...
<xsl:with-param name="AltName">Dependent 4 Ind</xsl:with-param>								
					...
					<!-- (17) ////////////////////////////////////////////////////-->
							...
							<div class="styIRS8862LineItem" style="width:187;height:12.5mm;padding-top:3.5mm;padding-bottom:2mm;">
								...
								<div class="styIRS8862LNDesc" style="width:175mm;height:10mm;">
										For each person claimed as a qualifying child or other dependent for the CTC/RCTC/ACTC/ODC, is that person a
...
<xsl:with-param name="AltName">US Citizen Or National 4 Ind</xsl:with-param>								
					...
					<div class="styIRS8862LNDesc" style="width:181mm;height:7mm;padding-left:9.5mm;padding-top:3mm;">
						<b>Caution:</b> If the answer is “No” for questions 14, 15, 16, or 17, you cannot claim the CTC/RCTC/ACTC/ODC for that child or other dependent.
							</div>
					<div class="styIRS8862LNDesc" style="width:181mm;height:18mm;padding-left:9.5mm;padding-top:3mm;">
                                    ...
                                    CTC/RCTC/ACTC or the ODC based on having a qualifying child. If you are a noncustodial parent who is entitled to treat the child as a qualifying child, you do not need
                                    to complete Part V.
							</div>
					<br/>
					...
					<div class="styBB" style="width:187mm;">
						<div class="styIRS8862LineItem" style="height:8mm;">
							<div class="styIRS8862LNDesc" style="width:187mm;padding-left:0mm;">
								To determine which person can treat the child as a qualifying child for the EIC, and CTC/RCTC/ACTC, see 
					...
					<div class="pageEnd" style="width:187mm;padding-top:5mm;border-top-width:1px;">
						<div style="float:right;">
							<span style="width:40px;"/>  
							  Form <span class="styBoldText" style="font-size:8pt;">8862</span> (Rev. 12-2022)
                        </div>
					</div>
					<!-- <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< -->
