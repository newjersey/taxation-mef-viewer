        ...
        <span style="width: 18mm;border-bottom:1px solid black;">
          ...
          <span style="width: 18mm;border-bottom:1px solid black;">
			...
			<div class="styTYBox" style="width:30mm;height:18mm;">
			  ...
			  <div class="styTY" style="height:11mm;">20<span class="styTYColor">22</span></div>
			</div>
		  </div>
		  <!--Return Header End -->
		  ...
		  <div style="width:187mm;float:left;clear:left;height:28mm;">
			...
			<div class="styBoldText" style="height:9mm;width:3mm;float:left;clear:none;padding-top:2mm;">3</div>
				<div class="styGenericDiv" style="height:9mm;width:25mm;padding-top:2mm;">
					Schedule M-3 (Form 1120-PC) attached 
                    <xsl:call-template name="SetFormLinkInline">
				...
				<div class="styGenericDiv" style="height:9mm;padding-top:2mm;">
				  <label>
					<xsl:call-template name="PopulateLabel">
					  <xsl:with-param name="TargetNode" select="$Form1120PCData/ScheduleM3Form1120PCInd"/>
					  <xsl:with-param name="BackupName">IRS1120ScheduleM3RequiredLabel</xsl:with-param>
					</xsl:call-template>
				  </label>
			...
			<span class="styBoldText" style="padding-right:2mm">C </span>
			  Date incorporated
			  <br/>
			  <br/>
			...
			<div class="styEINDateAssets" style="width:48mm;height:8.75mm;border-bottom-width:0px;">
			  ...
			  <br/>
			  <span style="padding-left:4mm">has been made under section(s):</span>
			  <br/>			
		  ...
		  <!-- E 1 Final return-->
			...
			<input type="checkbox" alt="Indicates this is a Name Change" class="styCkbox">
			  ...
			  <xsl:attribute name="id">
				<xsl:value-of select="concat($finalReturnID, '[2]')"/>
			  </xsl:attribute>
			</input>
			<label>
			  <xsl:call-template name="PopulateLabel">
		...
		<div class="styBB" style="width:187mm;border-bottom:2px solid black;">
		  ...
		  <div class="styGenericDiv" style="width:181mm;">
			...
			<div class="styGenericDiv" style="width:181mm;">
			  ...
			  <div class="styLNDesc" style="width:133mm;height:4.3mm;">
				<span style="float:left">  <b>Total tax.</b> Add lines 9 through 12
                  <!-- Form to Form Link (Push Pin)-->
				  <xsl:call-template name="SetFormLinkInline">
			...
			<div style="width:181mm;">
			  <div style="float:left;clear:none">
				...
				<div class="styLNDesc" style="width:53.5mm;height:4.3mm;">2021 overpayment credited to 2022
					<!--Dotted Line-->
					<div class="styDotLn" style="float:right;padding-right:1mm;">.</div> 
      	        </div>      	       
...
-->
				...
				<div class="styLNAmountBox" style="height:4.3mm;border-right-width:1px;padding-top14mm;background-color:lightgrey;">
<!--
				  <xsl:call-template name="PopulateAmount">
					<xsl:with-param name="TargetNode" select="$Form1120PCData/PriorYearEstimatedTaxPymtAmt"/>
				  </xsl:call-template>
-->
			...
			<div style="width:181mm;">
			  <div style="float:left; clear:none;">
				...
				<div class="styLNDesc" style="width:53.5mm;height:4.3mm;"> 2022 estimated tax payments (see instructions)
					<!--Dotted Line-->
					<div class="styDotLn" style="float:right;padding-right:1mm;">........</div> 
				</div>
			...
			<div style="width:181mm;">
			  <div style="float:left;clear:none;">
				...
				<div class="styLNDesc" style="width:53.5mm;height:4.3mm;">Less 2022 refund applied for on Form 4466
				  <!-- Form to Form Link (Push Pin) -->
				  <xsl:call-template name="SetFormLinkInline">
...
-->
			...
			<div class="styGenericDiv" style="width:186mm;">
			  ...
			  <div class="styLNDesc" style="width:138mm;height:4.3mm;">
				<span style="float:left"> <b>Amount owed.</b> If line 15k is smaller than the total of lines 13 and 16, enter amount owed
				</span>
				<!--Dotted Line-->
				<div class="styDotLn" style="float:right;padding-right:1mm;">.....</div>
			  </div>
			...
			<div class="styGenericDiv" style="width:186mm;">
			  ...
			  <div class="styLNDesc" style="width:138mm;height:4.3mm;">
			    <span style="float:left"> <b>Overpayment.</b> If line 15k is larger than the total of lines 13 and 16, enter amount overpaid
				</span>
				<!--Dotted Line-->
				<div class="styDotLn" style="float:right;padding-right:1mm;">....</div>
			  </div>
		  ...
		  <div class="styBB" style="width:187mm;font-size:6pt;">
			...
			<div style="float:right;">
              ...
              Form <span class="styBoldText" style="font-size:8pt;">1120-PC</span> (2022)
            </div>
		  </div>
		  ...
		  <!-- Page 2 Header -->
			...
			<div style="float:left;">Form 1120-PC (2022)<span style="width:146mm;"/>
		  </div>
...
-->
        ...
        <!-- Form to Form Link (Push Pin)-->
		  ...
		  <div class="styGenericDiv" style="width:181mm;">
			<div style="width:141mm;float:left;clear:none;">
			  ...
			  <div class="styLNDesc" style="width:133mm;height:4.5mm;">
				<span style="float:left"><b>Total deductions.</b> Add lines 15 through 31
                  <!-- Form to Form Link (Push Pin)-->
				  <xsl:call-template name="SetFormLinkInline">
		  ...
		  <div class="styGenericDiv" style="width:181mm;">
			<div style="width:141mm;float:left;clear:none;">
			  ...
			  <div class="styLNDesc" style="width:133mm;height:4.5mm;">
				<span style="float:left"><b>Total.</b> Add lines 34a and 34b</span>
				<!--Dotted Line-->
				<div class="styDotLn" style="float:right;padding-right:1mm;">.......................</div>
			  </div>
			</div>
		  ...
		  <div class="styGenericDiv" style="width:181mm;">
			<div style="width:141mm;float:left;clear:none;">
			  <div class="styLNLeftNumBox" style="height:4.5mm;padding-left: 4.25mm">c</div>
			  <div class="styLNDesc" style="width:133mm;height:4.5mm;">
				<span style="float:left"> <b>Total.</b> Add lines 36a and 36b</span>
				<!--Dotted Line-->
				<div class="styDotLn" style="float:right;padding-right:1mm;">.......................</div>
			  </div>
			</div>
	  ...
	  <div class="styBB" style="width:187mm;">
		...
		<div class="styBB" style="width:187mm;">
		  ...
		  <div class="styGenericDiv" style="width:181mm;">
			<div style="width:141mm;float:left;clear:none;">
			  <div class="styLNLeftNumBox" style="height:4.5mm;">16</div>
			  <div class="styLNDesc" style="width:133mm;height:4.5mm;">
				<span style="float:left"><b>Total.</b> Add lines 9 through 15</span>
				<!--Dotted Line-->
				<div class="styDotLn" style="float:right;padding-right:1mm;">.......................</div>
			  </div>
			</div>
		...
		<div class="styBB" style="width:187mm;">
		  <div class="styPartDesc" style="width:164mm;padding-left:0mm;height:auto;font-weight:normal;padding-left:20mm;">
				<b>Part II - Invested Assets Book Values</b><br/>
		...
		<div style="width:187mm;">
		  <div style="float:left;clear:none:">
			<div class="styLNLeftNumBox" style="height:4.5mm;">31</div>
			<div class="styLNDesc" style="height:4.5mm;width:99mm;">
			  <span style="float:left"><b>Total.</b> Add lines 22 through 30</span>
			  <!--Dotted Line-->
			  <div class="styDotLn" style="float:right;padding-right:1mm;">..............</div>
			</div>
		  </div>
	...
	<div class="styBB" style="width:187mm;height:auto;">
	  ...
	  <div class="styPartDesc" style="font-weight: normal;;height:7mm;width:187mm;padding-left:26mm;">
       <b>Note:</b> Include capital assets sold or exchanged to meet abnormal insurance losses and to pay dividends and similar distributions to
policyholders.
      </div>
	</div>
	...
	<div class="styGenericDiv" style="width:187mm;">
	  ...
	  <div style="float:left;width:78mm;height:13mm;border-right:1px solid black;background-color:lightgrey;clear:none;"></div>
  ...
  <div class="styBB" style="width:187mm;height:auto;border-bottom-width:1px;float:left;clear:left;">
	...
	<div class="styLblNameAddr" style="width:93.5mm;height:auto;border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px;border-right-width: 0px;">
		...
		<div class="styLNDesc" style="width:73mm;height:4.5mm;">
		  ...
		  <span style="width:40mm;background-color:none;">
			...
			<span style="width:70mm;border-bottom:1px solid black;background-color:none;">
			  <xsl:call-template name="PopulateText">
				<xsl:with-param name="TargetNode" select="$Form1120PCScheduleI/ParentCorporationName/BusinessNameLine1Txt"/>
			  </xsl:call-template>
			</span>
			<span style="width:70mm;border-bottom:1px solid black;background-color:none;">
			  <xsl:call-template name="PopulateText">
				<xsl:with-param name="TargetNode" select="$Form1120PCScheduleI/ParentCorporationName/BusinessNameLine2Txt"/>
			  </xsl:call-template>
			  <xsl:call-template name="LinkToLeftoverDataTableInline">
	  ...
	  <div class="styGenericDiv" style="width:93.5mm;height:30mm;">
		<div class="styLNLeftNumBoxSD" style="height:4.5mm;padding-left: 2.25mm"></div>
		<div class="styLNDesc" style="width:73mm;height:4.5mm;">
		  <span style="float:left;">If “Yes,” enter:<br/>  <b>a</b> Percentage owned and  
		  <span/> 
		 <!-- <img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="Small right pointing arrow"/>-->
		...
		<div class="styGenericDiv" style="width:93.5mm;">
          <div class="styLNLeftNumBoxSD" style="height:9mm;padding-left: 4.25mm"></div>
		  <div class="styLNDesc" style="width:73mm;height:9mm;"></div>
		  <div class="styShadingCell" style="width:6mm;height:9mm;"/>
		  <div class="styShadingCellRB" style="width:6mm;height:9mm;border-left-width:0px;"/>
		</div>
	  </div>
	  <!-- Right Hand Side-->
	  <div class="styLblNameAddr" style="width:93mm;height:27mm;border-top-width:0px;border-bottom-width:0px;border-left-width:0px;border-right-width:0px;">
		...
		<div class="styGenericDiv" style="width:93mm;">
		  ...
		  <div class="styLNDesc" style="width:72.5mm;height:4.5mm;">
			<span style="float:left">
			  ...
			  the <br/>statement required by Regulations section<br/> 1.1502-21(b)(3) must be attached 
			  <xsl:call-template name="SetFormLinkInline">
				<xsl:with-param name="TargetNode" select="$Form1120PCScheduleI/NOLForegoCarrybackInd"/>
			  </xsl:call-template>
			  or the election<br/> won't be valid.
		...
		<!-- Schedule I, Line 13a -->
		<div class="styGenericDiv" style="width:93mm;">
		  <div class="styLNLeftNumBoxSD" style="height:8.5mm;font-size:6pt;padding-left: 4.25mm"></div>
		  <div class="styLNDesc" style="width:72.5mm;height:8.5mm;">
			<div style="width:40mm;clear:none;">
				...
				<span style="width:5mm;"/>MLR numerator					
					<!--Dotted Line -->
					<span class="styDotLn" style="float:right;padding-right:7mm;">..
					<!--<img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="Small right pointing arrow"/>--></span>					
			...
			<div style="width:32.5mm;float:right;clear:none;">
			  <span style="padding-top:2mm;">
				...
				<span style="width:27.5mm;padding-bottom:.5mm;border-style: solid; border-color: black;border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px;text-align:right;">
				  <xsl:call-template name="PopulateAmount">
					<xsl:with-param name="TargetNode" select="$Form1120PCScheduleI/ClinicalServicesReimbAmt"/>
				  </xsl:call-template>
				</span>
			  </span>			
			 </div>
		  ...
		  <div class="styLNDesc" style="width:72.5mm;height:8.5mm;">
			<div style="width:40mm;float:left;clear:none;">
				...
				<span style="width:5mm;"/>MLR denominator					
					<!--Dotted Line -->
					<span class="styDotLn" style="float:right;padding-right:8mm;">.
					<!--<img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="Small right pointing arrow"/>--></span>
				<span style="width:10mm"/>
			</div>
			<div style="width:32.5mm;float:right;clear:none;">
			  <span style="padding-top:2mm;">
				...
				<span style="width:27.5mm;padding-bottom:.5mm;border-style: solid; border-color: black;border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px;text-align:right;">
				  <xsl:call-template name="PopulateAmount">
					<xsl:with-param name="TargetNode" select="$Form1120PCScheduleI/TotalPremiumRevenueAmt"/>
				  </xsl:call-template>
				</span>
			  </span>			
			 </div>
			...
			<div style="width:32.5mm;float:right;clear:none;">
			  <!--<span style="padding-top:2mm;">-->
				...
				<span style="width:27.5mm;padding-bottom:.5mm;border-style: solid; border-color: black;border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 0px">
				  <xsl:call-template name="PopulateText">
					<xsl:with-param name="TargetNode" select="$Form1120PCScheduleI/MedicalLossRt"/>
				  </xsl:call-template>
				<!--</span>-->
			  </span>			
			 </div>
		...
		<!-- Schedule I, Line 14-->
		  <div class="styGenericDiv" style="width:93mm;">
			...
			<div class="styLNDesc" style="width:72.5mm;height:26mm;">
				...
				<span style="float:left;"><b>(a)</b> Does the corporation satisfy the diversification 
			...
			<div class="styIRS1120PCLNYesNoBox" style="border-right-width:0px;height:4.5mm;">
			  <span style="font-weight:normal;">
				<xsl:call-template name="PopulateYesBoxText">
				  <xsl:with-param name="TargetNode" select="$Form1120PCScheduleI/DvrsfctnRqrSect831b2BiIInd"/>
				</xsl:call-template>
			  </span>
			</div>
			<div class="styIRS1120PCLNYesNoBoxRB" style="height:4.5mm;">
		  ...
		  <div class="styGenericDiv" style="width:93mm;">
			<div class="styLNLeftNumBox" style="height:4.5mm;padding-left: 2.25mm;"></div>
		  ...
		  <!-- Shading Cell-->
			...
			<div class="styIRS1120PCLNYesNoBox" style="border-right-width:0px;height:4.25mm;">
			  <span style="font-weight:normal;">
				<xsl:call-template name="PopulateYesBoxText">
				  <xsl:with-param name="TargetNode" select="$Form1120PCScheduleI/DvrsfctnRqrSect831b2BiIIInd"/>
				</xsl:call-template>
			  </span>
			</div>
		...
		<!-- Schedule I, Line 15-->
		  <div class="styGenericDiv" style="width:93mm;">
			...
			<div class="styLNDesc" style="width:72.5mm;height:16mm;padding-top:3.5mm;">
				...
				<xsl:call-template name="SetFormLinkInline">
					<xsl:with-param name="TargetNode" select="$Form1120PCScheduleI/GrossReceiptsLast3YearsInd"/>
				</xsl:call-template>
				   <!--Dotted Line -->
				  <span class="styDotLn" style="float:right;padding-right:1mm;">...</span>
			</div>
		...
		<div class="styGenericDiv" style="width:93mm;">
		  ...
		  <div class="styShadingCellRB" style="width:6mm;height:5.5mm;border-left-width:0px;"/>		  
			<div class="styIRS1120PCLNYesNoBox" style="border-right-width:0px;height:4.5mm;">
			  <span style="font-weight:normal;">
				<xsl:call-template name="PopulateYesBoxText">
				  <xsl:with-param name="TargetNode" select="$Form1120PCScheduleI/NondedIntRoyaltyUndSect267AInd"/>
				</xsl:call-template>
			  </span>
			</div>
			<div class="styIRS1120PCLNYesNoBoxRB" style="height:4.5mm;">
		...
		<div class="styGenericDiv" style="width:93mm;">
		  ...
		  <div class="styLNDesc" style="width:72.5mm;height:6mm;">			
			...
			<span class="styIRS1120PCBBText" style="float:right;width:30.5mm;height:4.5mm;text-align:right;padding-top:1mm; ">
				<xsl:call-template name="PopulateAmount">
				  <xsl:with-param name="TargetNode" select="$Form1120PCScheduleI/NondedIntRoyaltyUndSect267AAmt"/>
				</xsl:call-template>
			</span>		 
		   </div>
		  <div class="styShadingCell" style="width:6mm;height:8mm;"/>
	    ...
	    <!-- Schedule I, Line 17-->
		  <div class="styGenericDiv" style="width:93mm;">
			<div class="styLNLeftNumBox" style="height:4.5mm;padding-left: 2.25mm;padding-top:4.5mm;">17</div>
			<div class="styLNDesc" style="width:72.5mm;height:13.5mm;padding-top:4.5mm;">
			...
			<div class="styIRS1120PCLNYesNoBox" style="border-right-width:0px;height:4.5mm;">
			  <span style="font-weight:normal;">
				<xsl:call-template name="PopulateYesBoxText">
				  <xsl:with-param name="TargetNode" select="$Form1120PCScheduleI/Section163jElectionInd"/>
				</xsl:call-template>
			  </span>
			</div>
			<div class="styIRS1120PCLNYesNoBoxRB" style="height:4.5mm;">
		  ...
		  <div class="styGenericDiv" style="width:93mm;">
			...
			<div class="styLNDesc" style="width:72.5mm;height:12mm;">
...
<br/> (see instructions)?
				<xsl:call-template name="SetFormLinkInline">
					<xsl:with-param name="TargetNode" select="$Form1120PCScheduleI/Form8990RequiredInd"/>
				</xsl:call-template> 
			<!--Dotted Line -->
			<span class="styDotLn" style="float:right;padding-right:1mm;">..........</span>
			</div>
  ...
  <div style="width:187mm;">
	...
	<div class="styGenericDiv" style="width:50mm;height:4.5mm;text-align:center;font-weight:bold;border-top-width:0px;"></div>
	...
	<div style="width:187mm;">
	  ...
	  <div style="width:187mm;">
		...
		<div class="styBB" style="width:187mm;border-bottom:2px solid black;">
		  <div class="styLNLeftNumBox" style="height:4.5mm;">15</div>
		  <div class="styLNDesc" style="width:50mm;height:4.5mm;">
			<span style="float:left"><b>Total assets</b></span>
			<!--Dotted Line-->
			<div class="styDotLn" style="float:right;padding-right:1mm;">........</div>
		  </div>
		...
		<div style="float:right;">Page <span style="font-weight:bold;font-size:8pt;">9</span></div>
	  </div>
	  <!-- END Page 9 Header -->
		...
		<div class="styBB" style="width:187mm;height:auto;border-bottom-width:1px;float:none;clear:both;">
		  <div class="styLblNameAddr" style="width:93.5mm;height:auto;border-top-width: 0px;border-bottom-width: 0px; border-left-width: 0px;border-right-width: 1px;float:left;clear:left;">
			...
			<div class="styGenericDiv" style="width:93.5mm;">
			  ...
			  <div class="styLNAmountBox" style="height:8mm;padding-top:4mm;width:32mm;border-bottom-width:0px;padding-right:.5mm;">				
			  </div>
			</div>
		  ...
		  <div class="styGenericDiv" style="width:93mm;">
			...
			<div class="styLNAmountBox" style="height:5mm;width:32mm;border-bottom-width:1px;">
			  <xsl:call-template name="PopulateAmount">
				<xsl:with-param name="TargetNode" select="$Form1120PCScheduleM1/TotalDeductionsNotChargedAmt"/>
			  </xsl:call-template>
			</div>
		  ...
		  <!-- Sch M-1 : Line 10 * 11/12/2015 Exception: amount is not bottom align due to tex-->
		  <div class="styGenericDiv" style="width:93mm;">
	...
	<table class="styDepTbl" style="font-size:6pt;" cellspacing="0">
	  <thead class="styTableThead" style="border-color: black; font-size: 7pt;">
		<tr class="styDepTblHdr">
		  <th class="styDepTblCell" style="width:42mm;" rowspan="2" colspan="2" scope="col">(a) <span class="styNormalText">Description of capital <br/>asset</span></th>
		  <th class="styDepTblCell" style="width:15mm;" rowspan="2" scope="col">(b) <span class="styNormalText">Date<br/>acquired</span></th>
		  <th class="styDepTblCell" style="width: 26mm;" scope="col">(c) <span class="styNormalText">Gross<br/>sales price</span></th>
		  <th class="styDepTblCell" style="width: 26mm;" scope="col">(d) <span class="styNormalText">Cost or <br/>other basis</span></th>
		  <th class="styDepTblCell" style="width: 26mm;" scope="col">(e) <span class="styNormalText">Expense<br/>of sale</span></th>
		  <th class="styDepTblCell" style="width: 26mm;" scope="col">(f) <span class="styNormalText">Depreciation allowed <br/>(or allowable)</span></th>
