...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:include href="IRS8865ScheduleK2Style.xsl" />
	<xsl:include href="ScheduleK2K3Common.xsl" />
	<xsl:output method="html" indent="yes" />
	<xsl:strip-space elements="*" />
	<xsl:param name="FormData" select="$RtnDoc/IRS8865ScheduleK2" />
	<xsl:template match="/">
		...
		<html lang="EN-US">
			<head>
				...
				<style type="text/css">
					<xsl:if test="not($Print) or $Print=''">
						<xsl:call-template name="IRS8865ScheduleK2Style" />
			...
			<body class="styBodyClass">
				<form id="Form8865ScheduleK2" style="width:256mm;">
					<xsl:call-template name="DocumentHeaderLandscape" />
					<!-- Page 1 -->
					<!-- Header -->
					<div class="styStdDivLS">
						<div class="styFNBox" style="width:35mm;height:18mm;">
							<span class="styFN" style="font-size:9pt;">SCHEDULE K-2<br />(Form 8865)</span> 
					...
					<div class="styStdDivLS" style="border-top:1px solid black;border-bottom:1px solid black;">
						<div class="styNameBox" style="width:159.2mm;height:8.5mm;">
						...
						<div class="styEINBox" style="width:36mm;height:8.5mm;padding-left:1mm;font-weight:normal;">
							<strong>Employer identification number (EIN) (if any)</strong> <br />
							<xsl:call-template name="PopulateEIN">
								<xsl:with-param name="TargetNode" select="$FormData/PartnershipEIN"/>
							</xsl:call-template>
						</div>
						<div class="styEINBox" style="width:60mm;height:8.5mm;padding-left:1mm;font-weight:normal;word-break:break-all;border-left:1px solid black;">
							<strong>Reference ID Number (see instructions)</strong> <br />
							<xsl:choose>
						...
						<div class="styLNRightNumBoxNBB" style="height:4.5mm;">
							<input type="checkbox" class="styCkboxNM" style="" alt="Part 8 Yes">
								<xsl:call-template name="PopulateYesCheckbox">
									...
									<xsl:with-param name="BackupName">F8865SK2PartVIIIAttachedInd</xsl:with-param>
								</xsl:call-template>
							</input>
						</div>
					...
					<div class="styStdDivLS pageEnd" style="border-top:2px solid black;font-weight:bold;">
						...
						<span style="margin-left:40mm;font-weight:normal;">Cat. No. 73346D</span>
						<span style="float:right;">Schedule K-2 (Form 8865) 2022</span>
					</div>
					<!-- Page 2 -->
					<div class="styStdDivLS">
						Schedule K-2 (Form 8865) 2022
						<span style="float:right;">Page <span style="font-weight:bold;font-size:8pt;">2</span></span>
					</div>
					<!-- Filer information section -->
					<xsl:call-template name="SchK2PageEntity8865"/>
					<div class="styStdDivLS" style="border-top:1px solid black;border-bottom:1px solid black;">
						<div class="styPartName" style="width:15mm;">Part II</div>
						<div class="styPartDesc" style="padding-left:3mm;width:230mm;">
							...
							<thead class="styTableThead">
								...
								<tr>
									...
									<th class="styTableCellHeader" scope="col" style="width:25mm;font-weight:normal;">
										<strong>(j)</strong> Check if foreign corporation has documented its eligiblity to be treated as a qualifying insurance corporation <br /> under section <br /> 1297(f)(2).
									</th>
									<th class="styTableCellHeader" scope="col" style="width:25mm;font-weight:normal;">
										<strong>(k)</strong> Check if PFIC has indicated its shares are "marketable stock" within the meaning of section 1296(e).
									</th>
									<th class="styTableCellHeader" scope="col" style="width:25mm;font-weight:normal;">
										<strong>(l)</strong> Check if PFIC is also a controlled foreign corporation (CFC) within the meaning of section 957.
									</th>
									<th class="styTableCellHeader" scope="col" style="width:25mm;font-weight:normal;border-right-width:0px;">
										<strong>(m)</strong> Check if PFIC meets the income test or asset test of section 1297(a) for the tax year.
									</th>
								</tr>
							</thead>
							<tbody>
...
<!-- Additonal Data Title Bar and Button -->
	...
	<xsl:template name="SchK2PageEntity8865">
		<div class="styStdDivLS" style="border-top:1px solid black;border-bottom:1px solid black;">
			<div class="styNameBox" style="width:169.2mm;height:8.5mm;">
				Name of partnership <br />
				<xsl:call-template name="PopulateText">
					<xsl:with-param name="TargetNode" select="$FormData/PartnershipName/BusinessNameLine1Txt"/>
				</xsl:call-template><br />
			...
			<div class="styEINBox" style="width:26mm;height:8.5mm;padding-left:1mm;font-weight:normal;">
