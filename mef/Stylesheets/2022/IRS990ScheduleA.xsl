			...
			<body class="styBodyClass">
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_FormYearBlock" style="height:22.5mm;">
						...
						<div style="width:30mm; background-color: black; color: white; font-size: 7.5pt;font-weight: bold;
						text-align:center;">Open to Public<br/>Inspection</div>
					</div>
				</div>
   ...
   The organization is not a private foundation because it is: (For lines 1 through 12, check only one box.)
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" alt="IRS990SchAChurchInd">
       ...
       <span style="font-weight:bold;">
         section 170(b)(1)(A)(i).
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" alt="IRS990SchASchoolInd">
							<xsl:call-template name="PopulateCheckbox">
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" alt="IRS990SchAHospitalInd">
							<xsl:call-template name="PopulateCheckbox">
      ...
      <span style="font-weight:bold;">
         section 170(b)(1)(A)(iii).
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" alt="IRS990SchAMedicalResearchOrganizationInd">
							<xsl:call-template name="PopulateCheckbox">
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" alt="IRS990SchACollegeOrganizationInd">
							<xsl:call-template name="PopulateCheckbox">
      ...
      An organization operated for the benefit of a college or university owned or operated by a governmental unit described in<b> section 170(b)(1)(A)(iv).</b> (Complete Part II.)
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" alt="IRS990SchAGovernmentalUnitInd">
							<xsl:call-template name="PopulateCheckbox">
       ...
       <span style="font-weight:bold;"> section 170(b)(1)(A)(v).</span>
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" alt="IRS990SchAPublicOrganization170Ind">
							<xsl:call-template name="PopulateCheckbox">
						...
						<label>
							<xsl:call-template name="PopulateLabel">
								...
								<xsl:with-param name="BackupName">IRS990SchAPublicOrganization170Ind</xsl:with-param>
								  ...
								  from the general public described in <b>section 170(b)(1)(A)(vi).</b> (Complete Part II.)
						</label>
					</div>
				</div>
				<!-- line 8 -->
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" alt="IRS990SchACommunityTrustInd">
							<xsl:call-template name="PopulateCheckbox">
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" alt="IRS990SchAAgriculturalResearchOrgInd">
							<xsl:call-template name="PopulateCheckbox">
				...
				<xsl:choose>
					...
					<xsl:otherwise>
					<div style="width:171mm; height:auto; float:right; border-bottom: 1px solid;">
						<xsl:call-template name="PopulateAdditionalDataTableMessage">
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" alt="IRS990SchAPubliclySupportedOrg509a2Ind">
							<xsl:call-template name="PopulateCheckbox">
						...
						<label>
							<xsl:call-template name="PopulateLabel">
								...
								<xsl:with-param name="BackupName">IRS990SchAPubliclySupportedOrg509a2Ind</xsl:with-param>
								  ...
								  An organization that normally receives: (1) more than 33<span style="font-size:5pt;">
								  1/3</span>% of its support from contributions, membership fees, and gross  receipts from activities 
								  related to its exempt functions—subject to certain exceptions, and (2) no more than 33
								  <span style="font-size:5pt;">1/3</span>% of its support from gross investment income and unrelated 
								  business taxable income (less section 511 tax) from businesses  acquired by the organization after 
								  June 30, 1975.  See <span style="font-weight:bold;"> section 509(a)(2).</span> (Complete Part III.)
						</label>
					</div>
				</div>
				<!-- line 10 -->
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" alt="IRS990SchATestPublicSafetyInd">
							<xsl:call-template name="PopulateCheckbox">
					...
					<div class="IRS990ScheduleA_LineDescIV">
						<label>
							<xsl:call-template name="PopulateLabel">
							  ...
							  <span style="font-weight:bold;">section 509(a)(4).</span>
						</label>
					</div>
				</div>
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" alt="IRS990SchASupportingOrganization509a3Ind">
							<xsl:call-template name="PopulateCheckbox">
					...
					<div class="IRS990ScheduleA_LineDescIV">
						<label>
							<xsl:call-template name="PopulateLabel">
							  ...
							  An organization organized and operated exclusively for the benefit of, to perform the functions of, or 
							  to carry out the purposes of one or more publicly supported organizations described in <b>section 
							  509(a)(1)</b> or <b>section 509(a)(2).</b> See <span style="font-weight:bold;">section 509(a)(3).
							  </span> Check the box on lines 12a through 12d that describes the type of supporting organization and 
							  complete lines 12e, 12f, and 12g.
						</label>
					</div>
				</div>
				<!-- line 12 ends-->
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" alt="IRS990SchASupportingOrgType1Ind">
							<xsl:call-template name="PopulateCheckbox">
...
<b>You must complete Part IV, Sections A and B.</b>
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" alt="IRS990SchASupportingOrgType2Ind">
							<xsl:call-template name="PopulateCheckbox">
...
must complete Part IV, Sections A and C.</b>
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" alt="IRS990SchASupportingOrgType3FuncIntInd">
							<xsl:call-template name="PopulateCheckbox">
...
Part IV, Sections A, D, and E.</b>
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" alt="IRS990SchASupportingOrgType3NonFuncInd">
							<xsl:call-template name="PopulateCheckbox">
...
instructions). <b>You must complete Part IV, Sections A and D, and Part V.</b>
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" alt="IRS990SchAIRSWrittenDeterminationInd">
							<xsl:call-template name="PopulateCheckbox">
...
-->
						...
						<!-- Column i -->
						<tr>
							<th class="IRS990ScheduleA_GenericCell" style="width:60mm;vertical-align:top;text-align:center;font-weight:normal" scope="col" rowspan="2">
								<b>(i)</b> Name of supported organization</th>
							<!-- Column ii -->
							<th class="IRS990ScheduleA_GenericCell" style="vertical-align:top;text-align:center;width:20mm;padding-bottom:17mm;border-right-width:1px;font-weight:normal" scope="col" rowspan="2">
								<b>(ii)</b> EIN</th>
							<!-- Column iii -->
							<th class="IRS990ScheduleA_GenericCell" style="vertical-align:top;text-align:center;width:32mm;border-right-width:1px;font-weight:normal" scope="col" rowspan="2">
								<b>(iii)</b> Type of organization (described on lines 1- 10 above (see instructions)) </th>
							<!-- Column iv -->
							<th class="IRS990ScheduleA_GenericCell" style="vertical-align:top;text-align:center;width:32mm;padding-bottom:1mm;border-right-width:1px;font-weight:normal" scope="col" colspan="2">
								<b>(iv)</b> Is the organization listed in your governing document?</th>
							<!-- Column v -->
							...
							<!-- Column v -->
							<th class="IRS990ScheduleA_GenericCell" style="vertical-align:top;text-align:center;width:32mm;padding-bottom:15mm;border-right-width:1px;font-weight:normal" scope="col" rowspan="2" colspan="1">
								<b>(v)</b> Amount of monetary support (see instructions)</th>
							<th class="IRS990ScheduleA_GenericCell" style="vertical-align:top;text-align:center;width:32mm;padding-bottom:15mm;border-right-width:0px;font-weight:normal" scope="col" rowspan="2" colspan="1">
								<b>(vi)</b> Amount of other support (see instructions)</th>
						</tr>
						<tr>
                ...
                <xsl:call-template name="PopulateText">
						...
						<tr>
							...
							<td class="IRS990ScheduleA_MoneyCell" style="border-right-width:1px;background-color:lightgrey;width:25mm;font-size:6pt;Verdana;">
    ...
    <xsl:with-param name="containerID" select="'p1Ln11TbCtnr'"/>
				...
				<div style="width:187mm; border-style: solid; border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width: 1px; border-bottom-width: 0px">
					<div class="styBoldText" style="font-weight:7pt;width:90;float: left; clear: none;"> For Paperwork Reduction Act Notice, see the Instructions for <br/>Form 990 or 990-EZ.  </div>
					<div style="width:40mm;float:left;font-size:7pt;padding-left:10mm">
					  Cat. No. 11285F
					</div>
					<div style="width:57mm;text-align:right;float:right;font-size:7pt;font-weight:bold;">Schedule A (Form 990) 2022</div>
				</div>
				<div class="pageEnd"/>
				<p style="page-break-before: always"/>
				<!-- Page Header -->
				<div class="styBB" style="width:187mm; padding-bottom:.5mm;">
					<div style="float:left;">Schedule A (Form 990) 2022</div>
				...
				<div class="styBB" style="width:187mm;">
					...
					<div class="styPartDesc" style="width:171mm;height:auto;">Support Schedule for Organizations Described in 
						Sections 170(b)(1)(A)(iv) and 170(b)(1)(A)(vi)<br/>
				...
				<span class="styPartDesc" style="width:171mm;font-weight:bold;text-align:left;height:auto;">Section A.  
					Public Support
				</span>
				...
				<div class="IRS990ScheduleA_TableContainer" style="border-bottom-width:0px;">
					<table cellspacing="0" cellpadding="0" style="font-size:7pt;">
						<tr>
							<th class="IRS990ScheduleA_GenericCell" style="width:60mm;font-weight:bold;border-bottom-width:0px;
								height:auto;" scope="col" colspan="2">
								<span style="float: left; clear:both"> Calendar year 
									<span class="styBoldText">(or fiscal year beginning in) 
										<img src="{$ImagePath}/990SchA_Bullet_Line.gif" alt="right arrow"/>
									</span>
								</span>
							</th>
							<th class="IRS990ScheduleA_GenericCell" style="width:25mm;text_align:center;vertical-align:center;" 
								scope="col">(a) <span class="styNormalText"> 2018</span>
							</th>
							<th class="IRS990ScheduleA_GenericCell" style="width:25mm;text_align:center;vertical-align:center;" 
								scope="col">(b) <span class="styNormalText"> 2019</span>
							</th>
							<th class="IRS990ScheduleA_GenericCell" style="width:25mm;text_align:center;vertical-align:center;" 
								scope="col">(c) <span class="styNormalText"> 2020</span>
							</th>
							<th class="IRS990ScheduleA_GenericCell" style="width:25mm;text_align:center;vertical-align:center;" 
								scope="col">(d) <span class="styNormalText"> 2021</span>
							</th>
							<th class="IRS990ScheduleA_GenericCell" style="width:25mm;text_align:center;vertical-align:center;" 
								scope="col">(e) <span class="styNormalText"> 2022</span>
							</th>
							<th class="IRS990ScheduleA_GenericCell" style="width:25mm;border-right-width:0px;text_align:center;
							vertical-align:center;" scope="col">(f) <span class="styNormalText"> Total</span>
							</th>
						</tr>
						<tr>
							<td class="IRS990ScheduleA_IndexCell" style="width:4mm;border-bottom-width:0px;" valign="top">1</td>
							<td class="IRS990ScheduleA_GenericCell" style="width:56mm;border-bottom-width:0px;">Gifts, grants, contributions, and membership fees received. (Do not include any "unusual grant.") <span class="IRS990ScheduleA_DotSpacing">..</span>
							</td>
						...
						<tr>
							...
							<td class="IRS990ScheduleA_GenericCell" style="width:56mm;border-bottom-width:0px;">Tax revenues levied for the organization's benefit and either paid to or expended on its behalf<span class="IRS990ScheduleA_DotSpacing">....</span>
							</td>
							<td class="IRS990ScheduleA_MoneyCell" style="width:25mm;font-size:6pt;Verdana;">
								<xsl:call-template name="PopulateAmount">
						...
						<tr>
							...
							<td class="IRS990ScheduleA_GenericCell" style="width:56mm;border-bottom-width:0px;">The value of services or facilities furnished by a governmental unit to the organization without charge.<span class="IRS990ScheduleA_DotSpacing">.</span>
							</td>
							<td class="IRS990ScheduleA_MoneyCell" style="width:25mm;font-size:6pt;Verdana;">
								<xsl:call-template name="PopulateAmount">
						...
						<tr>
							...
							<td class="IRS990ScheduleA_GenericCell" style="width:56mm;border-bottom-width:0px;">
								<b>Total.</b> Add lines 1 through 3<span class="IRS990ScheduleA_DotSpacing"/>
							</td>
							<td class="IRS990ScheduleA_MoneyCell" style="width:25mm;font-size:6pt;Verdana;">
								<xsl:call-template name="PopulateAmount">
						...
						<tr>
							...
							<td class="IRS990ScheduleA_GenericCell" style="width:56mm;border-bottom-width:0px;">The portion of total 
						...
						<tr>
							...
							<td class="IRS990ScheduleA_GenericCell" style="width:56mm;">
								<b>Public support.</b> Subtract line 5 from line 4.<span class="IRS990ScheduleA_DotSpacing"/>
							</td>
							<td class="IRS990ScheduleA_MoneyCell" style="border-right-width:1px;background-color:lightgrey;width:25mm;font-size:6pt;Verdana;">
								<span style="width:1px;"/>
							</td>
				...
				<div class="IRS990ScheduleA_TableContainer" style="border-bottom-width:0px;">
					<table cellspacing="0" cellpadding="0" style="font-size:7pt;">
						...
						<tr>
							...
							<td class="IRS990ScheduleA_GenericCell" style="width:56mm;border-bottom-width:0px;">Amounts from line 4<span class="IRS990ScheduleA_DotSpacing">..</span>
							</td>
							<td class="IRS990ScheduleA_MoneyCell" style="width:25mm;font-size:6pt;Verdana;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/TotalCalendarYear170Grp/CurrentTaxYearMinus4YearsAmt"/>
						...
						<tr>
							...
							<td class="IRS990ScheduleA_GenericCell" style="width:56mm;border-bottom-width:0px;">Gross income from interest, dividends, payments received on securities loans, rents, royalties and income from similar sources<span class="IRS990ScheduleA_DotSpacing">...</span>
							</td>
							<td class="IRS990ScheduleA_MoneyCell" style="width:25mm;font-size:6pt;Verdana;">
								<xsl:call-template name="PopulateAmount">
						...
						<tr>
							...
							<td class="IRS990ScheduleA_GenericCell" style="width:56mm;border-bottom-width:0px;">Net income from unrelated business activities, whether or not the business is regularly carried on<span class="IRS990ScheduleA_DotSpacing">..</span>
							</td>
							<td class="IRS990ScheduleA_MoneyCell" style="width:25mm;font-size:6pt;Verdana;">
								<xsl:call-template name="PopulateAmount">
						...
						<tr>
							...
							<td class="IRS990ScheduleA_GenericCell" style="width:56mm;border-bottom-width:0px;">Other income. Do not include gain or loss from the sale of capital assets (Explain in Part VI.)<span class="IRS990ScheduleA_DotSpacing">..</span>
							</td>
							<td class="IRS990ScheduleA_MoneyCell" style="width:25mm;font-size:6pt;Verdana;">
								<xsl:call-template name="PopulateAmount">
						...
						<tr>
							...
							<td class="IRS990ScheduleA_GenericCell" style="width:56mm;border-bottom-width:0px;">
								<b>Total support.</b> Add lines 7 through 10<span class="IRS990ScheduleA_DotSpacing"/>
							</td>
							<td class="IRS990ScheduleA_MoneyCell" style="border-right-width:1px;background-color:lightgrey;width:25mm;font-size:6pt;Verdana;">
								<span style="width:1px;"/>
							</td>
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineDescIV" style="width:178mm;">
						...
						<span style="letter-spacing:2mm; font-weight:bold; font-size:7pt; margin-left:2mm;">
							........................................</span>
						<img src="{$ImagePath}/990SchA_Bullet_Line.gif" alt="right arrow"/>
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" alt="IRS990SchAFirst5Years170Ind">
							<xsl:call-template name="PopulateCheckbox">
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineDescIVB" style="height:auto;">
						<span style="font-weight:bold;">
						    33 <span style="font-size:5pt;">1/3</span>% support test—2022.
						</span>
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineDescIVB" style="width:178mm;height:auto;">
						...
						<span class="IRS990ScheduleA_DotSpacing">.....................................................  </span>
						<img src="{$ImagePath}/990SchA_Bullet_Line.gif" alt="right arrow"/>
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" alt="IRS990SchAPrivateFoundation170Ind">
							<xsl:call-template name="PopulateCheckbox">
				...
				<div class="pageEnd" style="width:187mm;border-top-width:1px;">
					<div style="float:right;">
						...
						<span class="styBoldText"> Schedule A (Form 990) 2022</span>
					</div>
				</div>
				<!-- END Footer -->
				<p style="page-break-before: always"/>
				...
				<div class="IRS990ScheduleA_TableContainer" style="border-bottom-width:0px;">
					<table cellspacing="0" cellpadding="0" style="font-size:7pt;">
						<tr>
							<th class="IRS990ScheduleA_GenericCell" style="width:60mm;font-weight:bold;border-bottom-width:0px;" 
								scope="col" colspan="2">
								<span style="float: left; clear: both"> Calendar year <span class="styBoldText">(or fiscal year beginning in) <img src="{$ImagePath}/990SchA_Bullet_Line.gif" alt="right arrow"/>
									</span>
								</span>
							</th>
							<th class="IRS990ScheduleA_GenericCell" style="width:25mm;text_align:center;vertical-align:center;" 
						...
						<tr>
							<!-- Line 1 -->
							<td class="IRS990ScheduleA_IndexCell" style="width:4mm;border-bottom-width:0px;" valign="top">1</td>
							<td class="IRS990ScheduleA_GenericCell" style="width:56mm;border-bottom-width:0px;">Gifts, grants, contributions, and membership fees received. (Do not include any "unusual grants.") <span class="IRS990ScheduleA_DotSpacing">.</span>
							</td>
							<td class="IRS990ScheduleA_MoneyCell" style="width:25mm;font-size:6pt;Verdana;">
								<xsl:call-template name="PopulateAmount">
						...
						<tr>
							<!-- Line 2 -->
							<td class="IRS990ScheduleA_IndexCell" style="width:4mm;border-bottom-width:0px;" valign="top">2</td>
							<td class="IRS990ScheduleA_GenericCell" style="width:56mm;border-bottom-width:0px;">Gross receipts from admissions, merchandise sold or services performed, or facilities furnished in any activity that is related to the organization's tax-exempt purpose<span class="IRS990ScheduleA_DotSpacing"/>
							</td>
							<td class="IRS990ScheduleA_MoneyCell" style="width:25mm;font-size:6pt;Verdana;">
								<xsl:call-template name="PopulateAmount">
						...
						<tr>
							<!-- Line 3 -->
							<td class="IRS990ScheduleA_IndexCell" style="width:4mm;border-bottom-width:0px;" valign="top">3</td>
							<td class="IRS990ScheduleA_GenericCell" style="width:56mm;border-bottom-width:0px;">Gross receipts from activities that are not an unrelated trade or business under section 513 <span class="IRS990ScheduleA_DotSpacing">.....</span>
							</td>
							<td class="IRS990ScheduleA_MoneyCell" style="width:25mm;font-size:6pt;Verdana;">
								<xsl:call-template name="PopulateAmount">
						...
						<tr>
							<td class="IRS990ScheduleA_IndexCell" style="width:4mm;border-bottom-width:0px;" valign="top">5</td>
							<td class="IRS990ScheduleA_GenericCell" style="width:56mm;border-bottom-width:0px;">The value of services or facilities furnished by a governmental unit to the organization without charge<span class="IRS990ScheduleA_DotSpacing"/>
							</td>
							<td class="IRS990ScheduleA_MoneyCell" style="width:25mm;font-size:6pt;Verdana;">
								<xsl:call-template name="PopulateAmount">
						...
						<tr>
							...
							<td class="IRS990ScheduleA_GenericCell" style="width:56mm;border-bottom-width:0px;">
								<b>Total.</b> Add lines 1 through 5<span class="IRS990ScheduleA_DotSpacing"/>
							</td>
							<td class="IRS990ScheduleA_MoneyCell" style="width:25mm;font-size:6pt;Verdana;">
								<xsl:call-template name="PopulateAmount">
						...
						<tr>
							...
							<td class="IRS990ScheduleA_GenericCell" style="width:56mm;border-bottom-width:0px;">Amounts included on lines 1, 2, and 3 received from disqualified persons<span class="IRS990ScheduleA_DotSpacing"/>
							</td>
							<td class="IRS990ScheduleA_MoneyCell" style="width:25mm;font-size:6pt;Verdana;">
								<xsl:call-template name="PopulateAmount">
						...
						<tr>
							...
							<td class="IRS990ScheduleA_GenericCell" style="width:56mm;border-bottom-width:0px;">Amounts included on lines 2 and 3 received from other than disqualified persons that exceed the greater of $5,000 or 1% of the amount on line 13 for the year<span class="IRS990ScheduleA_DotSpacing">.</span>
							</td>
							<td class="IRS990ScheduleA_MoneyCell" style="width:25mm;font-size:6pt;Verdana;">
								<xsl:call-template name="PopulateAmount">
						...
						<tr>
							...
							<td class="IRS990ScheduleA_GenericCell" style="width:56mm;border-bottom-width:0px;">Add lines 7a and 7b<span class="IRS990ScheduleA_DotSpacing">..</span>
							</td>
							<td class="IRS990ScheduleA_MoneyCell" style="width:25mm;font-size:6pt;Verdana;">
								<xsl:call-template name="PopulateAmount">
				...
				<div class="IRS990ScheduleA_TableContainer" style="border-bottom-width:0px;">
					<table cellspacing="0" cellpadding="0" style="font-size:7pt;">
						...
						<tr>
							...
							<td class="IRS990ScheduleA_GenericCell" style="width:56mm;border-bottom-width:0px;">Amounts from line 6<span class="IRS990ScheduleA_DotSpacing">...</span>
							</td>
							<td class="IRS990ScheduleA_MoneyCell" style="width:25mm;font-size:6pt;Verdana;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/Total509Grp/CurrentTaxYearMinus4YearsAmt"/>
						...
						<tr>
							...
							<td class="IRS990ScheduleA_GenericCell" style="width:56mm;border-bottom-width:0px;">Unrelated business taxable income (less section 511 taxes) from businesses acquired after June 30, 1975<span class="IRS990ScheduleA_DotSpacing">.</span>
							</td>
							<td class="IRS990ScheduleA_MoneyCell" style="width:25mm;font-size:6pt;Verdana;">
								<xsl:call-template name="PopulateAmount">
						...
						<tr>
							...
							<td class="IRS990ScheduleA_GenericCell" style="width:56mm;border-bottom-width:0px;">Add lines 10a and 10b<span class="IRS990ScheduleA_DotSpacing">.</span>
							</td>
							<td class="IRS990ScheduleA_MoneyCell" style="width:25mm;font-size:6pt;Verdana;">
								<xsl:call-template name="PopulateAmount">
						...
						<tr>
							...
							<td class="IRS990ScheduleA_GenericCell" style="width:56mm;border-bottom-width:0px;">Net income from 
							unrelated business activities not included on line 10b, whether or not the business is regularly carried 
							on<span class="IRS990ScheduleA_DotSpacing">.</span>
							</td>
							<td class="IRS990ScheduleA_MoneyCell" style="width:25mm;font-size:6pt;Verdana;">
								<xsl:call-template name="PopulateAmount">
          ...
          <span style="width:5mm" /> -->
            ...
            <xsl:with-param name="TargetNode" select="$FormData/OtherIncome"/>
						...
						<tr>
							...
							<td class="IRS990ScheduleA_GenericCell" style="width:56mm;border-bottom-width:0px;">
								<b>Total support.</b> (Add lines 9, 10c, 11, and 12.)<span class="IRS990ScheduleA_DotSpacing">..</span>
							</td>
							<td class="IRS990ScheduleA_MoneyCell" style="width:25mm;font-size:6pt;Verdana;">
								<xsl:call-template name="PopulateAmount">
					...
					<div class="IRS990ScheduleA_LineDescIVA">
						<label>
							<xsl:call-template name="PopulateLabel">
							  ...
							  Investment income percentage for <b>2022</b> (line 10c, column (f) divided by line 13, column (f))
							   <span class="IRS990ScheduleA_DotSpacing">......  </span>
						</label>
					</div>
					...
					<div class="IRS990ScheduleA_LineDescIVA">
						<label>
							<xsl:call-template name="PopulateLabel">
							  ...
							  Investment income percentage from <b>2021</b> Schedule A, Part III, line 17
							   <span class="IRS990ScheduleA_DotSpacing">.............  </span>
						</label>
					</div>
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineDescIVAL" style="height:auto;">
						<span style="font-weight:bold;">33 <span style="font-size:5pt;">1/3</span>% support tests—2021.
						</span>
				...
				<div class="styBB" style="width:187mm;float:none;">
					...
					<span style="padding-left:16mm;height:auto"/> (Complete only if you checked a box on line 12 of Part I. If you checked box 12a, of Part I, complete 
					Sections A and B.  If you checked <span style="padding-left:17mm;height:auto"/>box 12b, of Part I, complete Sections A and C. If you checked box 12c, of 	
					Part I, complete Sections A, D, and E. If you checked box<span style="padding-left:17mm;height:auto"/>12d, of Part I, complete Sections A and D, and 
					complete Part V.)
          </div>
    ...
    Section A. All Supporting Organizations 
       ...
       Are all of the organization’s supported organizations listed by name in the organization’s governing documents?<br/>
						<i> If "No," describe in<b> Part VI</b> how the supported organizations are designated. If designated by class or purpose,<br/>describe the designation. If historic and continuing relationship, explain.</i>
					</div>
				...
				<div style="width: 187mm">
					...
					<div class="styLNDesc" style="width: 155mm;height:4.5mm;">
					   Did the organization have a supported organization described in section 501(c)(4), (5), or (6)?
						<i> If "Yes," answer lines 3b and 3c below.</i>
					</div>
              ...
              <i>If "Yes," explain in <b>Part VI</b> what controls the organization put in place to ensure such use</i>.
				...
				<div style="width: 187mm">
					...
					Was any supported organization not organized in the United States ("foreign supported organization")?
					  <i>If “Yes” and if you checked box 12a or 12b in Part I, answer lines 4b and 4c below.</i>
					</div>
					<div class="styLNRightNumBox" style="height:4.5mm;background-color: lightgrey;">
						<span style="width: 1px"/>
					</div>
...
supervised by or in connection with its supported organizations.</i>
				...
				<div style="width: 187mm">
					<div class="styLNLeftNumBox" style="padding-left:3mm; padding-top:2mm;">c</div>
					<div class="styLNDesc" style="width: 155mm;height:7.5mm;padding-top:2mm;">
...
the foreign supported organization was used exclusively for section 170(c)(2)(B) purposes.</i>
				...
				<div style="width: 187mm">
					...
					<div class="styLNDesc" style="width: 155mm;height:10.5mm;">
						...
						<i>If “Yes,” answer lines 5b and 5c below (if applicable). Also, provide detail in <b>Part VI,</b> including (i) the names and EIN numbers 
...
organization’s supported organizations?
        <i>If “Yes,” provide detail in <b>Part VI.</b>
						</i>
					</div>
					<div class="styLNRightNumBox" style="height:10.5mm;background-color: lightgrey;">
						<span style="width: 1px"/>
				...
				<div style="width: 187mm">
					...
					<div class="styLNDesc" style="width: 155mm;height:7.5mm;">
						...
						with regard to a	 substantial contributor? <i>If “Yes,” complete Part I of Schedule L (Form 990) .</i>
					</div>
					<div class="styLNRightNumBox" style="height:7.5mm;background-color: lightgrey;">
						<span style="width: 1px"/>
					</div>
				...
				<div style="width: 187mm">
					...
					509(a)(1) or (2))? <i>If “Yes,” provide detail in<b> Part VI.</b></i>
					</div>
					<div class="styLNRightNumBox" style="height:7.5mm;background-color: lightgrey;">
						<span style="width: 1px"/>
					</div>
				...
				<div style="width: 187mm">
					...
					<div class="styLNDesc" style="width: 155mm;height:4.5mm;">
						...
						the supporting organization had an interest?	<i>If “Yes,” provide detail in<b> Part VI.</b></i>
					</div>
					<div class="styLNRightNumBox" style="height:4.5mm;background-color: lightgrey;">
						<span style="width: 1px"/>
					</div>
...
whether the organization had excess business holdings).</i>
				...
				<div class="styBB" style="width:187mm;float:none;">
					<div class="styPartName" style="float:left;height:auto">Part IV</div>
					<div class="styPartDesc" style="float:left;width:172mm;">Supporting Organizations  <span class="styNormalText">  (continued)</span>
					</div>
				</div>
				<div style="width: 187mm">
					<div class="styLNLeftNumBox"/>
				...
				<div style="width: 187mm">
					...
					<div class="styLNDesc" style="width: 155mm;height:4.5mm;">
					   Has the organization accepted a gift or contribution from any of the following persons?<br/>
						<div class="styLNLeftNumBox" style="padding-left:0mm"/>
					</div>
					<div class="styLNRightNumBox" style="height:4.5mm;background-color: lightgrey;">
						<span style="width: 1px"/>
					</div>
				...
				<div style="width: 187mm">
					<div class="styLNLeftNumBox" style="padding-left:3mm;">a
					</div>
				...
				<div style="width: 187mm">
					<div class="styLNLeftNumBox" style="padding-left:3mm;">b</div>
					<div class="styLNDesc" style="width: 155mm;height:4.5;">A family member of a person described on 11a above?</div>
				...
				<div style="width: 187mm">
					...
					<div class="styLNDesc" style="width: 155mm;height:4.5;">
						A 35% controlled entity of a person described on line 11a or 11b above?
						 <i>If “Yes” to 11a, 11b, or 11c, provide detail in <b>Part VI</b>.</i>
					</div>
					<div class="styLNRightNumBox" style="height:6mm;">11c</div>
				...
				<div style="width: 187mm">
					...
					<div class="styLNDesc" style="width: 155mm;height:17mm;">
						...
						<i>If “No,” describe in <b>Part VI</b> how the supported organization(s) effectively operated, supervised, or controlled the 
						...
						applied to such powers during the tax year.</i>
					</div>
...
supporting organization was vested in the same persons that controlled or managed the supported organization(s).
				...
				<div style="width: 187mm">
					<div class="styLNLeftNumBox">1</div>
					<div class="styLNDesc" style="width: 155mm;height:9mm;">
				...
				<div class="styLNDesc" style="width: 175mm">Check the box next to the method that the organization used to satisfy the Integral Part Test during the year<b> 
					(see instructions)</b>:
				</div>
				<!-- line 1 -->
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" alt="ActivitiesTestInd">
							<xsl:call-template name="PopulateCheckbox">
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" alt="ParentSupportedOrgInd">
							<xsl:call-template name="PopulateCheckbox">
				...
				<div class="IRS990ScheduleA_LineContainer">
					...
					<div class="IRS990ScheduleA_LineIndex">
						<input class="IRS990ScheduleA_Checkbox" type="checkbox" alt="GovernmentalEntityInd">
							<xsl:call-template name="PopulateCheckbox">
				...
				<!-- Line 2 -->
				<div style="width: 187mm">
					<div class="styLNLeftNumBox" style="padding-left:1mm;padding-top:2.5mm;">2</div>
					<div class="styLNDesc" style="width: 155mm;padding-top:2.5mm;">
						Activities Test.<b> Answer lines 2a and 2b below.</b>
					</div>
				</div>
				<div style="width: 187mm">
					<div class="styLNLeftNumBox"/>
				...
				<div style="width:187mm;float:none;">
					...
					<div class="styLNDesc" style="width: 155mm;height:4.5mm;">
						Parent of Supported Organizations.<b> Answer lines 3a and 3b below.</b>
					</div>
					<div class="styLNRightNumBox" style="height:4.5mm;background-color: lightgrey;">
					</div>
					<div class="styLNRightNumBox" style="height:4.5mm;background-color: lightgrey"/>
				...
				<div class="styBB" style="width:187mm;float:none;">
					...
					<tr>
						<div class="IRS990ScheduleA_LineContainer">
							<div class="IRS990ScheduleA_LineIndex" style="padding-left:3mm;">1</div>
							<div class="IRS990ScheduleA_LineIndex">
								<input class="IRS990ScheduleA_Checkbox" type="checkbox" alt="IRS990SchATrustIntegralPartTestInd">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" select="$FormData/TrustIntegralPartTestInd"/>
							...
							<div class="IRS990ScheduleA_LineDescIV">
								<label>
									<xsl:call-template name="PopulateLabel">
										...
										Check here if the organization satisfied the Integral Part Test as a qualifying trust on Nov.
										20, 1970 <i>(explain in <b>Part VI</b>)</i>. <b>See instructions.</b> All other Type III non-functionally integrated supporting 
...
held for production of income (see instructions)
            ...
            <!--Dotted Line-->
					...
					<tr>
						...
						<td class="styLNDesc" style="width:107mm;height:4.5mm;border-style: solid; border-color: black; border-top-width: 0px;border-bottom-width: 1px;border-left:0px;border-right:0px;" colspan="3">
							<b>Adjusted Net Income</b> (subtract lines 5, 6 and 7 from
line 4)
            <!--Dotted Line-->
							<span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm"/>
						</td>
				...
				<table class="styTable" style="font-size:7pt;width:187mm;" cellspacing="0">
					<!-- Begin Part V -->
					<tr>
						<td class="styLNLeftNumBox" style="height:4.5mm;padding-left:3mm;border-top-width: 1px"/>
						<td class="styLNDesc" style="width:107mm;height:4.5mm;" colspan="3">
                ...
                (B) Current Year<br/>(optional)
                  <span style="width:1px;"/>
					...
					<tr>
						<!-- Line 1 -->
						<td class="styLNLeftNumBox" style="height:7.5mm;padding-left:3mm;border-style: solid; border-color: black; border-top-width: 1px;
							border-bottom-width: 1px;border-left:0px;border-right:0px;">1
						</td>
						<td class="styLNDesc" style="width:107mm;height:7.5mm;border-style: solid; border-color: black; border-top-width: 1px;
							border-bottom-width: 1px;border-left:0px;border-right:0px;" colspan="3">
					...
					<tr>
						<!-- Line 1a -->
						<td class="styLNLeftNumBox" style="height:4.5mm;padding-left:5mm;border-style: solid; border-color: black; border-top-width: 0px;
							border-bottom-width: 1px;border-left:0px;border-right:0px;">a
						</td>
						<td class="styLNDesc" style="width:107mm;height:4.5mm;border-style: solid; border-color: black; border-top-width: 0px;
							border-bottom-width: 1px;border-left:0px;border-right:0px;" colspan="3">Average monthly value of securities
							<span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm"/>
						</td>
					...
					<tr>
						<!-- Line 1b -->
						<td class="styLNLeftNumBox" style="height:4.5mm;padding-left:5mm;border-style: solid; border-color: black; border-top-width: 0px;
							border-bottom-width: 1px;border-left:0px;border-right:0px;">b
						</td>
						<td class="styLNDesc" style="width:107mm;height:4.5mm;border-style: solid; border-color: black; border-top-width: 0px;
							border-bottom-width: 1px;border-left:0px;border-right:0px;" colspan="3">Average monthly cash balances                            
							<span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm"/>
						</td>
					...
					<tr>
						<!-- Line 1c -->
						<td class="styLNLeftNumBox" style="height:4.5mm;padding-left:5mm;border-style: solid; border-color: black; border-top-width: 0px;
							border-bottom-width: 1px;border-left:0px;border-right:0px;">c
						</td>
						<td class="styLNDesc" style="width:107mm;height:4.5mm;border-style: solid; border-color: black; border-top-width: 0px;
							border-bottom-width: 1px;border-left:0px;border-right:0px;" colspan="3">Fair market value of other non-exempt-use assets
							<span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm"/>
						</td>
					...
					<tr>
						<!-- Line 1d -->
						<td class="styLNLeftNumBox" style="height:4.5mm;padding-left:5mm;border-style: solid; border-color: black; border-top-width: 0px;
							border-bottom-width: 1px;border-left:0px;border-right:0px;">d
						</td>
						<td class="styLNDesc" style="width:107mm;height:4.5mm;border-style: solid; border-color: black; border-top-width: 0px;
							border-bottom-width: 1px;border-left:0px;border-right:0px;" colspan="3">
							<b>Total</b> (add lines 1a, 1b, and 1c)            
							<span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm"/>
						</td>
					...
					<tr>
						...
						<td class="styLNDesc" style="width:107mm;height:auto;border-style: solid; border-color: black; border-top-width: 0px;border-bottom-width: 1px;
							border-left:0px;border-right:0px;" colspan="3">
							<b>Discount </b>claimed for blockage or other factors<br/>
							(<i>explain in detail in <b>Part VI</b></i>):
							<span style="width: 0mm"/>
							<span class="styIRS990AUnderlinedText" style="text-align: right; width: 32mm; font-size: 6pt">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/MinimumAssetAmountGrp/DiscountClaimedAmt"/>
								</xsl:call-template>
							</span>
						</td>
						<td class="styLNRightNumBox" style="height:7.5mm;border-top-width: 0px;border-left-width: 1px;background-color:lightgrey;"/>
						<td class="styLNAmountBox" style="height:7.5mm;font-family:'Arial'; background-color:lightgrey;">
							<span style="width:1px;"/>
						</td>
						<td class="styLNAmountBox" style="height:7.5mm;font-family:'Arial'; background-color:lightgrey;">
					...
					<tr>
						<!-- Line 2 -->
						<td class="styLNLeftNumBox" style="height:4.5mm;padding-left:3mm;border-style: solid; border-color: black; border-top-width: 0px;
							border-bottom-width: 1px;border-left:0px;border-right:0px;">2
						</td>
						<td class="styLNDesc" style="width:107mm;height:4.5mm;border-style: solid; border-color: black; border-top-width: 0px;border-bottom-width: 1px;
							border-left:0px;border-right:0px;" colspan="3">Acquisition indebtedness applicable to non-exempt use assets
							<span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm"/>
						</td>
						<td class="styLNRightNumBox" style="height:4.5mm;">2</td>
						<td class="styLNAmountBox" style="height:4.5mm;font-family:'Arial';">
					...
					<tr>
						<!-- Line 3 -->
						<td class="styLNLeftNumBox" style="height:4.5mm;padding-left:3mm;border-style: solid; border-color: black; border-top-width: 0px;
							border-bottom-width: 1px;border-left:0px;border-right:0px;">3
						</td>
						<td class="styLNDesc" style="width:107mm;height:4.5mm;border-style: solid; border-color: black; border-top-width: 0px;
							border-bottom-width: 1px;border-left:0px;border-right:0px;" colspan="3">Subtract line 2 from line 1d
							<span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm"/>
						</td>
						<td class="styLNRightNumBox" style="height:4.5mm;">3</td>
						<td class="styLNAmountBox" style="height:4.5mm;font-family:'Arial';">
					...
					<tr>
						<!-- Line 5 -->
						<td class="styLNLeftNumBox" style="height:auto;padding-left:3mm;border-style: solid; border-color: black; border-top-width: 0px;
							border-bottom-width: 1px;border-left:0px;border-right:0px;">5
						</td>
						<td class="styLNDesc" style="width:107mm;height:4.5mm;border-style: solid; border-color: black; border-top-width: 0px;
							border-bottom-width: 1px;border-left:0px;border-right:0px;" colspan="3">
					...
					<tr>
						<td class="styLNLeftNumBox" style="height:4.5mm;padding-left:3mm;border-style: solid; border-color: black; border-top-width: 0px;
							border-bottom-width: 1px;border-left:0px;border-right:0px;">6
						</td>
						<td class="styLNDesc" style="width:107mm;height:4.5mm;border-style: solid; border-color: black; border-top-width: 0px;
							border-bottom-width: 1px;border-left:0px;border-right:0px;" colspan="3">
            ...
            <!--Dotted Line-->
					...
					<tr>
						<td class="styLNLeftNumBox" style="height:4.5mm;padding-left:3mm;border-style: solid; border-color: black; border-top-width: 0px;border-bottom-width: 1px;border-left:0px;border-right:0px;">8</td>
						<td class="styLNDesc" style="width:107mm;height:4.5mm;border-style: solid; border-color: black; border-top-width: 0px;border-bottom-width: 1px;border-left:0px;border-right:0px;" colspan="3">
							<b>Minimum Asset Amount </b> (add line 7 to line 6)
            <!--Dotted Line-->
							<span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm"/>
						</td>
						<td class="styLNRightNumBox" style="height:4.5mm;">8</td>
				...
				<table class="styTable" style="font-size:7pt;width:187mm;" cellspacing="0">
					...
					<tr>
						<td class="styLNLeftNumBox" style="height:4.5mm;padding-left:0mm;border-top-width: 1px"/>
						<td class="styLNDesc" style="width:107mm;height:4.5mm;" colspan="3">
							<span class="styBoldText" style="font-size:8pt;font-weight:bold;">Section C - Distributable Amount</span>
						</td>
...
line 8, Column A)
            ...
            <!--Dotted Line-->
					...
					<tr>
						<td class="styLNLeftNumBox" style="height:7.5mm;padding-left:3mm;padding-bottom:3mm;border-style: solid; border-color: black; border-top-width: 0px;
							border-bottom-width: 1px;border-left:0px;border-right:0px;">6</td>
						<td class="styLNDesc" style="width:107mm;height:7.5mm;border-style: solid; border-color: black; border-top-width: 0px;border-bottom-width: 1px;
							border-left:0px;border-right:0px;" colspan="3">
							<b>Distributable Amount.</b> Subtract line 5 from line 4, unless subject to emergency temporary reduction (see instructions)
							<span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm"/>
						</td>
				...
				<tr>
					<div class="IRS990ScheduleA_LineContainer">
						...
						<div class="IRS990ScheduleA_LineIndex">
							<input class="IRS990ScheduleA_Checkbox" type="checkbox" alt="FirstYearType3NonFuncInd">
								<xsl:call-template name="PopulateCheckbox">
              ...
              <xsl:with-param name="containerID" select="'DISctn'"/>
				...
				<div class="styTableContainer" style="border-top-width: 0px; width: 187mm;height:auto" id="DISctn">
					<table class="styTable" style="font-size: 7pt; border-color:black" cellspacing="0">
						<div class="styPartName" style="float:left;height:auto">Part V</div>
						<span class="styPartDesc" style="width:123mm; text-align:left;">Type III Non-Functionally Integrated 509(a)(3) Supporting Organizations</span>
							<span style="font-size: 7pt;">(continued)</span>
						<tr>
							<th scope="col" class="styTableCellHeader" colspan="2" style="font-size: 8pt; width: 150mm; border-bottom-width: 1px; border-left-width: 0px; 
								border-top-width: 1px;text-align:left;">
						...
						<tr>
							<!-- Line 1 -->
							<td class="styTableCell" style="padding-top:2mm;height:5.5mm;text-align:left; border-style: solid; border-color: black; border-left-width: 0px; 
									border-right-width: 1px; border-top-width: 1px; border-bottom-width: 1px; width: 100mm;" colspan="1">
								<span class="styBoldText" style="padding-left:1.5mm">1</span>
								<span style="width: 2mm"/>
									 Amounts paid to supported organizations to accomplish exempt purposes
							</td>
							<td class="styTableCell" style="padding-top:2mm;height:5.5mm;text-align:left; border-style: solid; border-color: black; border-left-width: 0px; 
									border-right-width: 1px; border-top-width: 1px; border-bottom-width: 1px; width: 4mm;" colspan="1">
								<span class="styBoldText" style="padding-left:1.5mm">1</span>
							</td>		
							<td class="styTableCellSmall" style="width: 37mm;border-style: solid; border-color: black; border-left-width: 0px; border-right-width: 0px; 
						...
						<tr>
							<!-- Line 2 -->
							<td class="styTableCell" style="padding-top:2mm;height:5.5mm;text-align:left; border-bottom-width: 1px; border-left-width: 0px; border-left-width: 0px;
								 border-top-width: 0px; width: 100mm" colspan="1">
								<span class="styBoldText" style="padding-left:1.5mm">2</span>
								<span style="width: 2mm"/>
									Amounts paid to perform activity that directly furthers exempt purposes of supported organizations, in <br/>
								<span style="width: 6mm"/>excess of income from activity
							</td>
							<td class="styTableCell" style="padding-top:2mm;height:5.5mm;text-align:left; border-style: solid; border-color: black; border-left-width: 0px; 
									border-right-width: 1px; border-top-width: 0px; border-bottom-width: 1px; width: 4mm;" colspan="1">
								<span class="styBoldText" style="padding-left:1.5mm">2</span>
							</td>		
							<td class="styTableCellSmall" style="width: 37mm;border-style: solid; border-color: black; border-left-width: 0px; border-right-width: 0px; 
						...
						<tr>
							...
							<td class="styTableCell" style="padding-top:2mm;height:5.5mm;text-align:left; border-bottom-width: 1px; border-left-width: 0px; border-left-width: 0px; 
								...
								<span style="width: 2mm"/>
									 Qualified set-aside amounts (<i>prior IRS approval required - provide details in <b>Part VI</b></i>)
							</td>
							<td class="styTableCell" style="padding-top:2mm;height:5.5mm;text-align:left; border-style: solid; border-color: black; border-left-width: 0px; 
									border-right-width: 1px; border-top-width: 0px; border-bottom-width: 1px; width: 4mm;" colspan="1">
								<span class="styBoldText" style="padding-left:1.5mm">5</span>
						...
						<tr>
							...
							<td class="styTableCell" style="padding-top:2mm;height:5.5mm;text-align:left; border-bottom-width: 1px; border-left-width: 0px; border-left-width: 0px; 
								...
								<span style="width: 2mm"/>
									 Other distributions (<i>describe in <b>Part VI</b></i>). See instructions
							</td>
							<td class="styTableCell" style="padding-top:2mm;height:5.5mm;text-align:left; border-style: solid; border-color: black; border-left-width: 0px; 
									border-right-width: 1px; border-top-width: 0px; border-bottom-width: 1px; width: 4mm;" colspan="1">
								<span class="styBoldText" style="padding-left:1.5mm">6</span>
						...
						<tr>
							...
							<td class="styTableCell" style="padding-top:2mm;height:5.5mm;text-align:left; border-bottom-width: 1px; border-left-width: 0px; border-left-width: 0px; 
								...
								<span style="width: 2mm"/>
								<b>Total annual distributions.</b>  Add lines 1 through 6.
							</td>
							<td class="styTableCell" style="padding-top:2mm;height:5.5mm;text-align:left; border-style: solid; border-color: black; border-left-width: 0px; 
									border-right-width: 1px; border-top-width: 0px; border-bottom-width: 1px; width: 4mm;" colspan="1">
								<span class="styBoldText" style="padding-left:1.5mm">7</span>
						...
						<tr>
							...
							<td class="styTableCell" style="padding-top:2mm;height:5.5mm;text-align:left; border-bottom-width: 1px; border-left-width: 0px; border-left-width: 0px; 
								...
								<span style="width: 2mm"/>
									Distributions to attentive supported organizations to which the organization is responsive (<i>provide <br/>
									<span style="width: 6mm"/>details in <b>Part VI</b></i>). See instructions
							</td>
							<td class="styTableCell" style="padding-top:2mm;height:5.5mm;text-align:left; border-style: solid; border-color: black; border-left-width: 0px; 
									border-right-width: 1px; border-top-width: 0px; border-bottom-width: 1px; width: 4mm;" colspan="1">
								<span class="styBoldText" style="padding-left:1.5mm">8</span>
						...
						<tr>
							<!-- Line 9 -->
							<td class="styTableCell" style="padding-top:2mm;height:5.5mm;text-align:left; border-bottom-width: 1px;
							...
							<td class="styTableCell" style="padding-top:2mm;height:5.5mm;text-align:left; border-style: solid; 
							  border-color: black; border-left-width: 0px; 
									border-right-width: 1px; border-top-width: 0px; border-bottom-width: 1px; width: 4mm;" colspan="1">
								<span class="styBoldText" style="padding-left:1.5mm">9</span>
							</td>
							<td class="styTableCellSmall" style="width: 37mm;border-style: solid; border-color: black; 
						...
						<tr>
							...
							<td class="styTableCell" style="padding-top:2mm;height:5.5mm;text-align:left; border-style: solid; border-color: black; border-left-width: 0px; 
									border-right-width: 1px; border-top-width: 0px; border-bottom-width: 1px; width: 4mm;" colspan="1">
								<span class="styBoldText" style="padding-left:1.5mm">10</span>
							</td>
							<td class="styTableCellSmall" style="width: 39mm;border-style: solid; border-color: black; border-left-width: 0px; border-right-width: 0px; 
					...
					<table class="styTable" style="font-size: 7pt; border-color:black;width:187mm;" cellspacing="0">
						<tr>
							<th scope="col" class="styTableCellHeader" colspan="2" style="font-size: 8pt;width: 76mm; border-bottom-width: 1px; border-left-width: 0px; 
								border-top-width: 1px">
								<span class="styTableCellPad"/>Section E - Distribution Allocations <span style="font-weight: normal;">(see instructions)</span>
							</th>
							<th scope="col" class="styTableCellHeader" style="width: 37mm;border-top-width: 1px">
								<b> (i)</b>
								<br/>
								<span class="styNormalText">
									<b>Excess Distributions</b>
								</span>
							</th>
							<th scope="col" class="styTableCellHeader" style="width: 37mm;border-top-width: 1px">
								<b>(ii)</b>
						...
						<tr>
							<td class="styTableCell" style="text-align:left; border-bottom-width: 1px; border-left-width: 0px; 
							  border-top-width: 0px; width: 76mm" colspan="2">
								<span class="styBoldText" style="padding-left: 1.5mm">1</span>
							...
							<td class="styTableCellSmall" style="width: 37mm; border-right-width:0px;padding-top:3mm;">
								<span class="styTableCellPad "/>
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/DistributionAllocationsGrp/
						...
						<tr>
							<td class="styTableCell" style="text-align:left; border-bottom-width: 1px; border-left-width: 0px; 
							  border-top-width: 0px; width: 76mm" colspan="2">
								<span class="styBoldText" style="padding-left: 1.5mm">2</span>
								<span style="width: 1mm"/>
									 Underdistributions, if any, for years prior to 2022 <span style="padding-left: 7mm"/>
									 <span style="width:5mm;">
								</span>(reasonable cause required-- <i>explain in <span style="font-weight: bold;">Part VI</span></i>).
								 <br/>
							...
							<td class="styTableCellSmall" style="width: 37mm;  border-bottom-width: 1px;padding-top:4mm;">
								...
								<xsl:call-template name="PopulateAmount">
									...
									select="$FormData/DistributionAllocationsGrp/UnderdistributionsAmt"/>
								</xsl:call-template>
							</td>
						...
						<tr>
							<td class="styTableCell" style="text-align:left; border-bottom-width: 1px; border-left-width: 0px; 
							  border-top-width: 0px; width: 76mm" colspan="2">
								...
								<span class="styIRS990AUnderlinedText" style="text-align: center; width: 20mm; font-size: 7pt">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/DistributionAllocationsGrp/
						...
						<tr>
							<td class="styTableCell" style="text-align:left; border-bottom-width: 1px; border-left-width: 0px; 
							  border-top-width: 0px; width: 76mm" colspan="2">
								...
								<span class="styIRS990AUnderlinedText" style="text-align: center; width: 20mm; font-size: 6pt">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/DistributionAllocationsGrp/
						...
						<tr>
							<td class="styTableCell" style="text-align:left; border-bottom-width: 1px; border-left-width: 0px; 
							  border-top-width: 0px; width: 76mm" colspan="2">
								...
								<span style="width: 1.5mm"/>
								<b>Total</b> of lines 3a through e
							</td>
       ...
       Applied to underdistributions of prior years
						...
						<tr>
							<td class="styTableCell" style="text-align:left; border-bottom-width: 1px; border-left-width: 0px; 
							  border-top-width: 0px; width: 76mm" colspan="2">
								...
								<span style="width: 1.5mm;"/>
									Carryover from 2017 not applied (see <br/>
								<span style="width: 6mm;"/>instructions)
							</td>
							<td class="styTableCellSmall" style="width: 37mm; border-bottom-width: 1px; ">
								<span class="styTableCellPad"/>
								<!-- IBM wrote up saying take out shading and that it should populate this field, then reversed their
								 opinion per PDF -->
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/DistributionAllocationsGrp/
						...
						<tr>
							<td class="styTableCell" style="text-align:left; border-bottom-width: 1px; border-left-width: 0px; 
							  border-top-width: 0px; width: 76mm" colspan="2">
								...
								<span style="width: 1mm;"/> Remainder. Subtract lines 3g, 3h, and 3i from line 3f.
							</td>
							<td class="styTableCellSmall" style="width: 37mm; border-bottom-width: 1px">
								<span class="styTableCellPad"/>
								<xsl:call-template name="PopulateAmount">
						...
						<tr>
							<td class="styTableCell" style="text-align:left; border-bottom-width: 0px; border-left-width: 0px; 
							  border-top-width: 0px; width: 76mm" colspan="2">
								...
								<span style="width: 1mm"/>Distributions for 2022 from Section D, line 7:</td>
						...
						<tr>
							<td class="styTableCell" style="text-align:left; border-bottom-width: 1px; border-left-width: 0px; 
							  border-top-width: 0px; width: 76mm" colspan="2">
								...
								<span style="width: 0mm"/>$ <span class="styIRS990AUnderlinedText" style="text-align: right; width: 32mm;
								 font-size: 7pt">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/DistributionAllocationsGrp/
						...
						<tr>
							<td class="styTableCell" style="text-align:left; border-bottom-width: 1px; border-left-width: 0px; 
							  border-top-width: 0px; width: 76mm" colspan="2">
								...
								<span style="width: 1mm"/>
									Remaining underdistributions for years prior to<br/>
								<span style="width: 5mm"/> 2022, if any. Subtract lines 3g and 4a from line 2.<br/>
								<span style="width: 6mm"/>If the amount is greater than zero, <i>explain in 
								<span style="font-weight: bold;">Part VI</span></i>. <br/>
								<span style="width: 6mm"/>See instructions.
							</td>
							<td class="styTableCellSmall" style="width: 37mm; font-size: 6pt;background-color:lightgrey;">
							</td>
						...
						<tr>
							<td class="styTableCell" style="text-align:left; border-bottom-width: 1px; border-left-width: 0px; 
							  border-top-width: 0px; width: 76mm" colspan="2">
								...
								<span style="width: 1mm"/>
									Remaining underdistributions for 2022. Subtract <br/>
								<span style="width: 6mm"/>lines 3h and 4b from line 1. If the amount is greater <br/>
								<span style="width: 5mm"/> than zero, <i>explain in <span style="font-weight: bold;">Part VI</span></i>. 
								  See instructions.
							</td>
							<td class="styTableCellSmall" style="width: 37mm; font-size: 6pt;background-color:lightgrey;">
							</td>
						...
						<tr>
							<td class="styTableCell" style="text-align:left; border-bottom-width: 1px; border-left-width: 0px; 
							  border-top-width: 0px; width: 76mm" colspan="2">
								...
								<span style="width: 1mm"/>
								<b> Excess distributions carryover to 2023.</b> Add lines <br/>
								<span style="width: 5mm"/>3j and 4c.
							</td>
				...
				<div style="width:187mm">
					<div style="float:right">
						<span class="styBoldText" style="font-size: 7pt">Schedule A (Form 990)</span> (2022)
					</div>
				</div>
				<div class="pageEnd"/>
				<!--END FOOTER-->
    ...
    Page <span class="styBoldText" style="font-size: 8pt">7</span>
				...
				<div class="styBB" style="width:187mm;float:none;border-top-width:1px">
					...
					<span style="font-size:7pt;padding-left:2mm;width: 170mm;">
  ...
  Provide the explanations required by Part II, line 10; Part II, line 17a or 17b; Part III, line 12; Part IV, Section A, lines 1, 2, 3b, 3c, 4b, 4c, 5a, 6, 9a, 9b, 9c, 11a, 11b, and 11c; Part IV, Section B, lines 1 and 2; Part IV, Section C, line 1; Part IV, Section D, lines 2 and 3; Part IV, Section E, lines 1c, 2a, 2b, 3a and 3b; Part V, line 1; Part V, Section B, line 1e; Part V Section D, lines 5, 6, and 8; and Part V, Section E, lines 2, 5, and 6. Also complete this part for any additional information. (See instructions).</span>
    ...
    <xsl:call-template name="PopulateAdditionalRows">
      <xsl:with-param name="RowCounter" select="1" ></xsl:with-param>
							...
							<xsl:for-each select="$FormData/HospitalNameAndAddressGrp">
								<tr>
									...
									<td class="styDepTblCell" style="text-align:left;font-size:7pt;">
										...
										<xsl:choose>
											<xsl:when test="StateAbbreviationCd">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="StateAbbreviationCd"/>
												</xsl:call-template>
											</xsl:when>
				...
				<!--\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\-->
				<!-- Additonal Data Table for separated data from Part I, Line 4 -->
				<xsl:if test="($Print = $Separated) and (count($FormData/AgriculturalNameAndAddressGrp) &gt; 2) ">
					<span class="styRepeatingDataTitle">
						<br/>Form 990, Schedule A, Part I, Line 9 - An agricultural research organization described in <span style="font-weight:bold;">170(b)(1)(A)(ix) </span> operated in conjunction with a land-grant college or university or a non-land grant college of agriculture.
      </span>
					<table class="styDepTbl" style="font-size:7pt">
						<thead class="styTableHead">
							<tr class="styDepTblHdr">
								<th scope="col" class="styDepTblCell">College or University Name, City, and State</th>
							</tr>
						</thead>
						<tbody>
							<xsl:for-each select="$FormData/AgriculturalNameAndAddressGrp">
				...
				<xsl:if test="($Print = $Separated) and (count($FormData/SupportedOrgInformationGrp) &gt; 2) ">
					...
					<table class="styDepTbl" style="font-size:7pt">
						<thead class="styTableHead">
							<tr>
								<th class="IRS990ScheduleA_GenericCell" style="width:60mm;vertical-align:top;text-align:center;" scope="col" rowspan="2">
									<b>(i)</b>
									<span class="styNormalText">Name of supported organization</span>
								</th>
								<!-- Column ii -->
								<th class="IRS990ScheduleA_GenericCell" style="vertical-align:top;text-align:center;width:20mm;padding-bottom:17mm;border-right-width:1px" scope="col" rowspan="2">
									<b>(ii)</b>
									<span class="styNormalText"> EIN</span>
								</th>
								<!-- Column iii -->
								<th class="IRS990ScheduleA_GenericCell" style="vertical-align:top;text-align:center;width:32mm;border-right-width:1px;" scope="col" rowspan="2">
									<b>(iii)</b>
									<span class="styNormalText">  Type of organization (described on lines 1- 9 above (see instructions))</span>
								</th>
								<!-- Column iv -->
								<th class="IRS990ScheduleA_GenericCell" style="vertical-align:top;text-align:center;width:32mm;padding-bottom:1mm;border-right-width:1px;" scope="col" colspan="2">
									<b>(iv)</b>
									<span class="styNormalText">  Is the organization listed in your governing document? </span>
								</th>
								<!-- Column v -->
								<!--     <th class="IRS990ScheduleA_GenericCell" style="vertical-align:top;text-align:center;width:24mm;padding-bottom:4mm;border-right-width:1px;" scope="col" colspan="2"><b>(v)</b><span class="styNormalText"> Did you notify the organization in col. <b>(i)</b> of your support? </span></th>-->
								<!-- Column vi -->
								<!--	<th class="IRS990ScheduleA_GenericCell" style="vertical-align:top;text-align:center;width:24mm;padding-bottom:5mm;border-right-width:1px;" scope="col" colspan="2"><b>(vi)</b><span class="styNormalText">  Is the organization in col. <b>(i)</b> organized in the U.S.? </span></th>-->
								<!-- Column v -->
								<th class="IRS990ScheduleA_GenericCell" style="vertical-align:top;text-align:center;width:32mm;padding-bottom:15mm;border-right-width:1px;" scope="col" rowspan="2" colspan="1">
									<b>(v)</b>
									<span class="styNormalText">  Amount of monetary support (see instructions)</span>
								</th>
								<th class="IRS990ScheduleA_GenericCell" style="vertical-align:top;text-align:center;width:32mm;padding-bottom:15mm;border-right-width:0px;" scope="col" rowspan="2" colspan="1">
									<b>(vi)</b>
									<span class="styNormalText">  Amount of other support (see instructions)</span>
								</th>
							</tr>
							<tr>
								<th scope="col" class="IRS990ScheduleA_GenericCell" style="width:9mm;border-right-width:1px;padding-left:5mm;">Yes</th>
						...
						<thead class="styTableHead">
							<tr class="styDepTblHdr">
								...
								<th scope="col" class="styDepTblCell" style="width:70mm;text_align:center;">
									...
									<br/>Name of noncharitable exempt organization
            </th>
								<th scope="col" class="styDepTblCell" style="width:70mm;text_align:center;">
									<span style="font-weight:bold">(d)</span>
									<br/>Description of transfers, transactions, and sharing arrangement
            </th>
							</tr>
						</thead>
						<tbody>
					...
					<table class="styDepTbl" style="font-size:7pt">
						<thead class="styTableHead">
							<tr class="styDepTblHdr">
								...
								<th scope="col" class="styDepTblCell" style="width:70mm;text_align:center;">
									<span style="font-weight:bold;">(c)</span>
									<br/>Description of relationship
            </th>
							</tr>
						</thead>
						<tbody>
	...
	<xsl:template name="Part7Line51dFillerRows">
		...
		<xsl:if test="$CurrentRowCount &lt; $NumOfTotRows">
			<tr>
				<td class="IRS990ScheduleA_GenericCell" style="vertical-align:top;">
					<span style="width:1px;"/>
				</td>
				<td class="IRS990ScheduleA_MoneyFieldMid" style="vertical-align:top;">
					<span style="width:1px;"/>
				</td>
				<td class="IRS990ScheduleA_GenericCell" style="vertical-align:top;">
					<span style="width:1px;"/>
