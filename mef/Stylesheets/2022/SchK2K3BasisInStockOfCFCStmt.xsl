...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:param name="DependencyData" select="$RtnDoc/SchK2K3BasisInStockOfCFCStmt" />
		...
		<table id="INOLDTbl" class="styDepTbl" style="font-size:7pt;">
			<thead class="styTableThead">
				<tr class="styDepTblHdr">           
					<th class="styDepTblCell" scope="col" style="width:40mm;">Name of foreign corporation</th>
					<th class="styDepTblCell" scope="col" style="width:20mm;">EIN or other identifying number</th>
					<th class="styDepTblCell" scope="col" style="width:32mm;">Percentage of voting </th>
					<th class="styDepTblCell" scope="col" style="width:32mm;">Value of stock owned in such foreign corporation</th>
					
				</tr>
			</thead>
			<tbody>
				<xsl:for-each select="$DependencyData/BasisInStockGrp">
					<tr>
						...
						<td class="styDepTblCell" style="text-align:right;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="OwnedStockValueAmt"/>
							</xsl:call-template>
						</td>
