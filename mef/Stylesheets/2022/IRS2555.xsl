  ...
  <xsl:template match="/">
      ...
      <body class="styBodyClass">
        <form name="Form2555">
          ...
          <div class="styTBB" style="width:187mm;height:19mm;">
            ...
            <div class="styFTBox" style="width:127mm;height:18mm;">
              ...
              <div class="styFBT" style="height:4mm;margin-top:1.5mm">
                <img src="{$ImagePath}/2555_Bullet.gif" width="9" height="9" alt="Bullet"/> Attach to Form 1040 or 1040-SR.<br></br>
          ...
          <div class="styBB" style="width:187mm;font-size:8pt;text-align:center;font-weight:bold;border-top:1px solid black;
            margin-top:1mm;padding:1mm 0mm;">
          ...
          <!-- BEGIN PART II TITLE -->
          <div class="styBB" style="width:187mm;padding-top:2mm;padding-bottom: 6.5mm;">
            <div class="styPartName" style="font-family:sans-serif;">Part II</div>
            <div class="styPartDesc">Taxpayers Qualifying Under Bona Fide Residence Test<br></br> <span style="font-weight:normal;">
            <b>Note.</b> Only U.S. citizens and resident aliens who are citizens or nationals of U.S. treaty countries can use this test.<br> See</br> instructions.
            </span>
            </div>
          </div>
          <!-- END PART II TITLE -->
	...
	<!-- Right Table -->
        ...
        <!--<div style="width:187mm;padding-top:0mm;border-top:1px solid black"></div>-->
          ...
          <div class="styBB" style="width:187mm;padding-top:2mm;padding-bottom: 3.5mm;">
            <div class="styPartName" style="font-family:sans-serif;">Part III</div>
            <div class="styPartDesc">Taxpayers Qualifying Under Physical Presence Test<br></br><span style="font-weight:normal;">
            <b>Note.</b> U.S. citizens and all resident aliens can use this test. See instructions.
            </span>
            </div>
          </div>
          <!-- END PART III TITLE -->
          ...
          <div style="width:187mm;height:15mm">
            ...
            <div style="float:left;position:relative;">
              ...
              <div class="styLNDesc" style="font-size:7pt;width:81mm;height:3mm;padding-right:4mm;padding-left:5mm">
                ...
                If you completed Part VI, enter the number from line
            ...
            <div style="float:left;">
              <div style="height:15mm;width:8mm;font-weight:bold;text-align:center;border-bottom:1px solid black;
                border-left:1px solid black;padding-top:8mm;">38</div>
            </div>
            <div style="float:left;">
              <div class="styLNAmountBox" style="height:15mm;width:42mm;border-bottom:1px solid black;padding-top:8mm">
                <xsl:call-template name="PopulateText">
            ...
            <div style="float:left;">
              <div style="height:15mm;width:8mm;border-left:1px solid black;background-color:lightgrey;"/>
            </div>
            <div style="float:left;">
              <div class="styLNAmountBox" style="height:15mm;width:42mm;border-bottom:none;"/>
            </div>
          </div>
          <!-- Line 39 -->
          ...
          <div style="width:187mm;height:8mm;">
            ...
            <div style="float:left;width:5mm;font-weight:bold;"/>
            <div class="styLNDesc" style="width:131mm;padding-left:5mm">
              Deductions allowed in figuring your adjusted gross income (Form 1040 or 1040-SR, line 11) that are allocable
          ...
          <!-- Line 50 -->
          <div class="styBB" style="width:187mm;height:16mm;padding-top:0mm">
            <div style="float:left;width:5mm;font-weight:bold;text-align:right;padding-top:.5mm">50</div>
            <div style="float:left;width:5mm;font-weight:bold;"/>
            <div class="styLNDesc" style="width:131mm;padding-left:5mm">
              <b>Housing deduction.</b> Add lines 48 and 49. Enter the total here and on Schedule 1 (Form 1040), line 24j. Complete the Foreign Earned       Income Tax Worksheet in the Instructions for Forms 1040 and 1040-SR if you enter an amount on this line
              <span style="letter-spacing:3mm;font-weight:bold;">................</span>
              <img src="{$ImagePath}/2555_Bullet.gif" width="9" height="9" alt="Bullet" style="margin:0mm 1mm;"/>
            </div>
            <div style="float:left;">
              <div style="height:16mm;width:8mm;text-align:center;font-weight:bold;border-left:1px solid black;
                padding-top:12mm">50</div>
            </div>
            <div style="float:left;">
              <div class="styLNAmountBox" style="height:16mm;width:42mm;border-bottom:none;padding-top:12mm">
                <xsl:call-template name="PopulateAmount">
