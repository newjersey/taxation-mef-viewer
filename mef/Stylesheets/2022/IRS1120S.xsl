...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
			...
			<body class="styBodyClass">
				<form name="Form1120&#8211;S">
					...
					<div class="styBB" style="width:187mm;">
						For calendar year 2022<span style="width: 1mm"/>or tax year beginning
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styGenericDiv" style="width:182mm; ">
							...
							<input type="checkbox" alt="Election Termination " class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
									<xsl:with-param name="TargetNode" select="$Form1120SData/ElectionTerminationInd"/>
									<xsl:with-param name="BackupName">ElectionTerminationIndicator</xsl:with-param>
								</xsl:call-template>
							</input>
							<label style="font-size:6pt; padding-right:2mm;">
								<xsl:call-template name="PopulateLabel">
									<xsl:with-param name="TargetNode" select="$Form1120SData/ElectionTerminationInd"/>
									<xsl:with-param name="BackupName">ElectionTerminationLabel</xsl:with-param>
								</xsl:call-template>
					...
					<div class="styBB" style="width:187mm;height:auto">
						...
						<div style="width:181mm;float:right;">
							...
							<div class="styLNDesc" style="width:133mm;height:4mm;">
									<span style="float:left">Depreciation from Form 4562 not claimed on Form 1125&#8211;A or elsewhere on return (attach Form 4562)
									<xsl:call-template name="SetFormLinkInline">
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;">
						...
						<div style="float:right;">
							...
							Form <span class="styBoldText" style="font-size:8pt;">1120&#8211;S</span> (2022)
						</div>
					</div>
					<!-- END Page Break and Footer-->
					<!--Begin Page 2 -->
					...
					<div class="styBB" style="width:187mm; padding-top:.5mm; float:none; clear:both;">
						<div style="float:left;">Form 1120&#8211;S (2022)<span style="width:148mm;"/>
						</div>
					...
					<div style="width:187mm;">
						...
						<div class="styIRS1120SBBText" style="word-wrap: break-word;width:46mm;min-height:4.5mm;height:auto;font-size:6pt;">
							<xsl:call-template name="PopulateText">
						...
						<span style="float:right;">
							<div class="styShadingCell" style="width:10mm;min-height:12mm;"/>
							<div class="styShadingCell" style="width:10mm;min-height:12mm;"/>
						</span>
					</div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:159mm;height:4mm">
							<div style="font-weight:6pt;">
								If &#8220;Yes,&#8221; complete and attach <b>	Form 8990,</b> Limitation on Business Interest Expense Under Section 163(j)
							...
							<div style="float:left;clear:none;">
								...
								<div class="styLNDesc" style="width:124.7mm;height:4mm">
									...
									<span class="styIRS1120SBBText" style="width:35.75mm;height:4mm;">
										...
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$Form1120SScheduleK/Section59e2ExpenditureAmt/@sect59e2ExpenditureDesc"/>
										</xsl:call-template>
									</span>
					...
					<div class="styBB" style="width:187mm; ">
						<span class="styIRS1120SVTImageBox" style="width:10mm;height:27mm;padding-top:0mm;padding-left: 2.1mm;">
						<img src="{$ImagePath}/1120SSchK_Transactions2.gif" alt="Schedule K, Foreign Transactions Section" valign="center"/>
					</span>
						...
						<div class="styGenericDiv" style="width:177mm;">
							...
							<div class="styLNLeftNumBox" style="padding-left:1mm;padding-top:10mm;">14</div>
								<div class="styLNDesc" style="width:123.7mm;padding-top:10mm;">
									<span style="float:left;">Attach Schedule K-2 (Form 1120-S), Shareholders’ Pro Rata Share Items—International, and check this box to indicate you are reporting items of international tax relevance 
		<xsl:call-template name="SetFormLinkInline">
	...
	<img src="{$ImagePath}/1120S_Bullet_Md.gif" alt="Right Pointing Arrow"/>&#160;
							...
							<div style="float:right;clear:none">
								<div class="styLNRightNumBoxNBB" style="width:12.3mm;height:27.5mm;background-color:lightgrey;"/>
								<div class="styLNAmountBoxNBB" style="height:27.5mm;background-color:lightgrey;">
								</div>
							</div>
						</div>
					</div>	
					...
					<div style="width:187mm;">
						...
						<div class="styShadingCell" style="height:4.5mm;border-bottom-width:1px"/>
						<div class="styLNAmountBox" style="height:4.5mm; padding-top:1mm;">
							<xsl:call-template name="PopulateAmount">
					...
					<div style="width:187mm;">
						...
						<div class="styShadingCell" style="height:7mm;border-bottom-width:1px"/>
					...
					<div style="width:187mm;height:4.5mm">
						...
						<div class="styShadingCell" style="height:4.5mm;border-bottom-width:2px"/>
						<div class="styLNAmountBox" style="width:4mm; height:4.5mm;;border-bottom-width:2px">
							<xsl:call-template name="SetFormLinkInline">
								<xsl:with-param name="TargetNode" select="$Form1120SScheduleL/OtherAssetsBOYAmt"/>
							</xsl:call-template>
						</div>
						<div class="styIRS1120SLNAmountBoxNLB" style="width:28mm; height:4.5mm; padding-top:1mm;;border-bottom-width:2px">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form1120SScheduleL/OtherAssetsBOYAmt"/>
							</xsl:call-template>
						</div>
					...
					<div style="width:187mm;">
						...
						<div class="styShadingCell" style="border-bottom-width:0px; height:4.5mm;border-bottom-width:2px"/>
						<div class="styLNAmountBox" style="height:4.5mm; padding-top:1mm;border-bottom-width:2px">
							<xsl:call-template name="PopulateAmount">
					...
					<div style="width:187mm;;border-bottom-width:2px">
						<div class="styLNLeftNumBox" style="height:4.5mm; padding-top:1mm;;border-bottom-width:2px"/>
						<div class="styGenericDiv" style="width:50mm; height:4.5mm; text-align:center; padding-top:1mm;;border-bottom-width:2px">
					...
					<div style="width:187mm;">
						...
						<div class="styShadingCell" style="height:4.5mm;;border-bottom-width:1px"/>
						<div class="styLNAmountBox" style="height:4.5mm; padding-top:1mm;border-bottom-width:1px">
							<xsl:call-template name="PopulateAmount">
					...
					<div class="styBB" style="width:187mm; float:none; clear:both;;border-bottom-width:2px">
