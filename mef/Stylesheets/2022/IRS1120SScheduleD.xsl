			...
			<body class="styBodyClass">
				...
				<div class="styBB" style="width: 187mm">
					...
					<div class="styFNBox" style="height: 18mm;width:28mm;">
						...
						<div class="styAgency" style="height:4mm;">
					...
					<!-- Form Title Box -->
					<div class="styFTBox" style="height: 18mm;width:131mm;">
						<!-- Form Title -->
              ...
              <br/>
							<img src="{$ImagePath}/1120SSchD_Bullet.gif" alt="Right arrow"/> Go to <a style="text-decoration:none;color:black;"
 href="http://www.irs.gov/form1120s"><i>www.irs.gov/Form1120S</i> </a> for instructions and the latest information.
              <br/>
    </span>
					</div>
					<!-- Tax Year Box -->
					<div class="styTYBox" style="height: 18mm;width:28mm;">
						...
						<!-- Tax Year -->
						<div class="styTY" style="text-align: center; padding-top: 2.8mm">20<span class="styTYColor">22</span>
						</div>
					</div>
				</div>
				<!-- Name and Address -->
				<div class="styBB" style="width:187mm;border-bottom-width:1px;">
					<div class="styNameBox" style="width:137mm;height:9mm;font-size:7pt;">Name<br/>
					...
					<div class="styEINBox" style="width:50mm;height:9mm;padding-left:2mm;font-weight:bold;font-size:7pt;">Employer identification number <br/>
						<br/>
				...
				<!--  *************************************************************************************************************  -->
					<div style="width:187mm;clear:none;padding-bottom:.0mm;padding-top:0mm">
						<div class="styIRS1120FDivTreatyDataRG" style="width:187mm; height:9mm; text-align:left;">
							...
							<span style="padding-left:30mm;">
									<!-- begin check box for Yes -->
									<input type="checkbox" alt="Corp Fiscally Transparent Yes Indicator " class="styCkbox">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/DisposeInvestmentQOFInd"/>
											<xsl:with-param name="BackupName">CorpFiscallyTransparentYesIndicator</xsl:with-param>
										</xsl:call-template>
									</input>
									<label>
										<xsl:call-template name="PopulateLabelYes">
											<xsl:with-param name="TargetNode" select="$FormData/DisposeInvestmentQOFInd"/>
											<xsl:with-param name="BackupName">CorpFiscallyTransparentYesLabel</xsl:with-param>
										</xsl:call-template>
								...
								<span style="padding-left:5mm;">
									...
									<input type="checkbox" alt="Corp Fiscally Transparent No Indicator" class="styCkbox">
										<xsl:call-template name="PopulateNoCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/DisposeInvestmentQOFInd"/>
											<xsl:with-param name="BackupName">CorpFiscallyTransparentNoIndicator</xsl:with-param>
										</xsl:call-template>
									</input>
									<label>
									<xsl:call-template name="PopulateLabelNo">
											<xsl:with-param name="TargetNode" select="$FormData/DisposeInvestmentQOFInd"/>
											<xsl:with-param name="BackupName">CorpFiscallyTransparentNoLabel</xsl:with-param>
										</xsl:call-template>
										<span style="padding-left:2mm">
											<b>No</b>
										</span>
				...
				<div class="styGenericDiv" style="width:187mm;clear:all;height:auto;">
					...
					<div class="styBB" style="width:187mm;border-top-width:2px;">
						...
						<div class="styPartDesc" style="padding-left:3mm;width:160mm;border-top-width:1px;"> 
              ...
              This form may be easier to complete if you round off the cents to whole dollars.</th>
					...
					<div class="IRS1120SScheduleD_LineContainer">
						...
						<div class="styLNDesc" style="width:139mm;">Tax on short&#8211;term capital gain included on line 23 below
                         <span class="styDotLn" style="float:right;">................</span>
						</div>
               ...
               This form may be easier to complete if you round off the cents to whole dollars.</th>
					...
					<div style="width:187mm;">
						<div style="float:left;">
							<span class="styBoldText" style="width:115mm">For Paperwork Reduction Act  Notice, see the Instructions for Form 1120S.</span>Cat. No. 11516V
                        </div>
						<div style="float:right;">
							<span style="width:9px;"/><b>Schedule D (Form 1120S) 2022</b>
                         </div>
					</div>
				...
				<div class="styGenericDiv" style="width:187mm;clear:all;height:auto;">
					...
					<div class="styBB" style="width:187mm;padding-top:.5mm;">
						<div style="float:left;">Schedule D (Form 1120S) 2022<span style="width:132mm;"/>
						</div>
					...
					<div class="styBB" style="width:187mm;border-top-width:1px;">
						...
						<div class="styPartDesc" style="padding-left:3mm;width:150mm;border-top-width:1px;">Build&#8211;in Gains Tax
                                       <span class="styNormalText">(See instructions
                                       <span class="styBoldText">before</span>completing this part.)</span>
						</div>
					</div>
					<!-- line 16 -->
					<div class="IRS1120SScheduleD_LineContainer">
					...
					<div class="IRS1120SScheduleD_LineContainer">
						...
						<div class="styLNDesc" style="width:139mm;">
							<span style="float:left;">Enter 21% (0.21) of line 20</span>
							<span class="styDotLn" style="float:right;">.........................</span>
						</div>
					...
					<div class="IRS1120SScheduleD_LineContainer">
						...
						<div class="styLNDesc" style="width:139mm;">Section 1374(b)(3) business credit and minimum tax credit carryforwards from C corporation years
                              <span class="styDotLn" style="float:right;">...</span>
						</div>
					...
					<div class="pageEnd" style="width:187mm;clear:all;float:none;">
						<div style="float:right;">
							...
							<b>Schedule D (Form 1120S) 2022</b>
                        </div>
					</div>
				<p style="page-break-before: always"/>
				<div class="styGenericDiv" style="width:187mm;clear:all;height:auto;">
...
<!-- 8/4/2016 CJ: If the content is empty, the parentesis will not display-->	
<xsl:template name="NegativeNumber">
