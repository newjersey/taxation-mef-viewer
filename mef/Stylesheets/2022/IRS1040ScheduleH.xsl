				...
				<form name="IRS1040ScheduleH">
								...
								<span style="text-align:center;font-weight:bold;">
									<div style="width:100%;height:5mm;">
										<div style="width:100mm;height:5mm;">
											<img src="{$ImagePath}/1040ScheduleH_Bullet_Sm.gif" alt="SmallRightArrow"/> 
                 ...
                 <span style="width:3px;"/>
					...
					<div class="styTBB" style="width:187mm;height:69mm;">
						<div style="width:187mm;height:auto;padding-top:4mm;">Calendar year taxpayers having no household employees in 2022 don't have to complete this form for 2022.</div>
						<!-- Spacer -->
						...
						<div class="styIRS1040ScheduleHLineItem" style="height:20mm;">
							...
							<div class="styIRS1040ScheduleHLNDesc" style="width:175mm;height:auto;">
								<!-- Description -->
                                Did you pay <span class="styBoldText">any one</span> household employee cash wages of $2,400 or more in 2022? (If any household employee was your<br/>
...
`
						...
						<div class="styIRS1040ScheduleHLineItem"  style="height:16mm;padding-top:1mm;">
							...
							<div class="styIRS1040ScheduleHLNDesc" style="width:175mm;height:auto;">
								<!-- Description -->
                                Did you withhold federal income tax during 2022 for any household employee?
						...
						<div class="styIRS1040ScheduleHLineItem"  style="height:16mm;padding-top:1mm;">
							...
							<div class="styIRS1040ScheduleHLNDesc" style="width:175mm;height:auto;">
								<!-- Description -->
                               Did you pay <span class="styBoldText">total</span> cash wages of $1,000 or more in <span class="styBoldText">any</span> calendar 
                               <span class="styBoldText">quarter</span> of 2021 or 2022 to <span class="styBoldText">all</span> household employees?<br/>
                               (<span class="styBoldText">Don't</span> count cash wages paid in 2021 or 2022 to your spouse, your child under age 21, or your parent.)
					...
					<div style="width:187mm;" class="styTBB">
						...
						<!-- (1b) ////////////////////////////////////////////////////////////-->
						<!--<div class="styIRS1040ScheduleHLineItem">
							<div class="styLNAmountBox" style="height:2.5mm;border-bottom-width:0px;float:right;"/>
							<div class="styLNRightNumBox" style="height:2.5mm;border-bottom-width:0px;float:right;background-color:lightgrey;"/>
						</div>-->
						<div class="styIRS1040ScheduleHLineItem" style="height:7.5mm">
							<div class="styIRS1040ScheduleHLNLeftNumBox">b</div>
							<div class="styIRS1040ScheduleHLNDesc" style="width:98mm;">
							...
							<!-- Box with content -->
                             <div class="styLNRightNumBox" style="height:100%; padding-top:3.5mm;">1b</div>
							<div class="styLNAmountBox" style="height:100%;width:33mm;padding-right:3.5px; padding-top:3mm">
								<xsl:call-template name="PopulateAmount">
							...
							<!-- Grey Box -->
							<span>							
								<div class="styLNAmountBox" style="height:7.5mm;border-bottom-width:0px;float:right;"/>
								<div class="styLNRightNumBox" style="height:7.5mm;border-bottom-width:0px;float:right;background-color:lightgrey;"/>
							</span>
						</div>
						<!-- (2a) ////////////////////////////////////////////////////////////-->
						<div class="styIRS1040ScheduleHLineItem">
						...
						<div class="styIRS1040ScheduleHLineItem" style="height:8mm;">
                           ...
                           Employer share of social security tax on qualified sick and family leave wages paid in 2022 for leave taken after March 31, 2020, and before
                           April 1, 2021. Multiply line 1b by 6.2% (0.062)                                <!--Dotted Line-->
						...
						<div class="styIRS1040ScheduleHLineItem" style="height:8mm;">
							...
							<div class="styIRS1040ScheduleHLNDesc" style="width:139mm;">
							 ...
							 <!--Dotted Line-->
                            <span class="styDotLn" style="padding-right:1mm; display:inline; float:right">......................</span></div>
							<div class="styLNRightNumBox" style="height:8mm; padding-top:4mm;">8c</div>
							<!-- Box with content -->
							<div class="styLNAmountBox" style="height:8mm;padding-right:3px; padding-top:4mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form1040ScheduleHData/NrfdblCrQlfySLFMLWagesAftrAmt"/>
								</xsl:call-template>
							</div>
						</div>
						...
						<div class="styIRS1040ScheduleHLineItem" style="height:8mm;">
							...
							<div class="styIRS1040ScheduleHLNDesc" style="width:139mm;">
								Total social security, Medicare, and federal income taxes after nonrefundable credits. Add lines 8b and 8c and then subtract that total from line 8a
								<span class="styDotLn" style="padding-left:2mm; display:inline; float:right">....................</span>
						...
						<div class="styIRS1040ScheduleHLineItem" style="height:8mm;">
							...
							<div class="styLNRightNumBox" style="height:8mm; padding-top:4mm;">8f</div>
							<!-- Box with content -->
							<div class="styLNAmountBox" style="height:8mm;padding-right:3px; padding-top:4mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form1040ScheduleHData/RfdblCrQlfySLFMLWagesAftrAmt"/>
								</xsl:call-template>
							</div>
						</div>
						<!-- (8g) ////////////////////////////////////////////////////////////-->
						...
						<div class="styIRS1040ScheduleHLineItem" style="height:auto;">
							...
							<div class="styIRS1040ScheduleHLNDesc" style="width:139mm; ">
							 ...
							 <!--Dotted Line-->
                            <span class="styDotLn" style="display:inline; float:right; padding-left:2mm">............</span></div>
						...
						<div class="styIRS1040ScheduleHLineItem" style="height:auto;">
							<div class="styIRS1040ScheduleHLNLeftNumBox">j</div>
							<div class="styIRS1040ScheduleHLNDesc" style="width:139mm;">
								Qualified health plan expenses allocable to qualified family leave wages reported on line 8i
							
							 <!--Dotted Line-->
                            <span class="styDotLn" style="display:inline; float:right; padding-left:2mm">...</span></div>
							<div class="styLNRightNumBox" style="height:4.5mm;">8j</div>
							<!-- Box with content -->
							<div class="styLNAmountBox" style="height:4.5mm;padding-right:3px;">
								<xsl:call-template name="PopulateAmount">
...
<!-- (8k) ////////////////////////////////////////////////////////////-->
						...
						<div class="styIRS1040ScheduleHLineItem" style="height:auto;">
							<div class="styIRS1040ScheduleHLNLeftNumBox">k</div>
							<div class="styIRS1040ScheduleHLNDesc" style="width:139mm; ">
								Qualified sick leave wages for leave taken after March 31, 2021, and before October 1, 2021
							
							 <!--Dotted Line-->
                            <span class="styDotLn" style="display:inline; float:right; padding-left:2mm">...</span></div>
							<div class="styLNRightNumBox" style="height:4.5mm;">8k</div>
							<!-- Box with content -->
							<div class="styLNAmountBox" style="height:4.5mm;padding-right:3px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form1040ScheduleHData/QlfySLWgsAftrAmt"/>
								</xsl:call-template>
							</div>
						</div>
						<!-- (8l) ////////////////////////////////////////////////////////////-->
						...
						<div class="styIRS1040ScheduleHLineItem" style="height:auto;">
							<div class="styIRS1040ScheduleHLNLeftNumBox">l</div>
							<div class="styIRS1040ScheduleHLNDesc" style="width:139mm;">
								Qualified health plan expenses allocable to qualified sick leave wages reported on line 8k
							
							 <!--Dotted Line-->
                            <span class="styDotLn" style="display:inline; float:right; padding-left:2mm">...</span></div>
							<div class="styLNRightNumBox" style="height:4.5mm;">8l</div>
							<!-- Box with content -->
							<div class="styLNAmountBox" style="height:4.5mm;padding-right:3px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form1040ScheduleHData/QHPExpnssQlfySLWgsAftrAmt"/>
								</xsl:call-template>
							</div>
						</div>
						<!-- (8m) ////////////////////////////////////////////////////////////-->
						...
						<div class="styIRS1040ScheduleHLineItem" style="height:auto;">
							<div class="styIRS1040ScheduleHLNLeftNumBox">m</div>
							<div class="styIRS1040ScheduleHLNDesc" style="width:139mm;">
								Qualified family leave wages for leave taken after March 31, 2021, and before October 1, 2021
							
							 <!--Dotted Line-->
                            <span class="styDotLn" style="display:inline; float:right; padding-left:2mm">...</span></div>
							<div class="styLNRightNumBox" style="height:4.5mm;">8m</div>
							<!-- Box with content -->
							<div class="styLNAmountBox" style="height:4.5mm;padding-right:3px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form1040ScheduleHData/QlfyFMLWgsAftrAmt"/>
								</xsl:call-template>
							</div>
						</div>
						<!-- (8n) ////////////////////////////////////////////////////////////-->
						...
						<div class="styIRS1040ScheduleHLineItem" style="height:auto;">
							<div class="styIRS1040ScheduleHLNLeftNumBox">n</div>
							<div class="styIRS1040ScheduleHLNDesc" style="width:139mm;">
								Qualified health plan expenses allocable to qualified family leave wages reported on line 8m
							
							 <!--Dotted Line-->
                            <span class="styDotLn" style="display:inline; float:right; padding-left:2mm">...</span></div>
							<div class="styLNRightNumBox" style="height:4.5mm;">8n</div>
							<!-- Box with content -->
							<div class="styLNAmountBox" style="height:4.5mm;padding-right:3px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form1040ScheduleHData/QHPExpnssQlfyFMLWgsAftrAmt"/>
								</xsl:call-template>
							</div>
						</div>
								...
								<div class="styIRS1040ScheduleHLNDesc" style="width:170mm;padding-left:0px;float:none;">
									...
									<div class="styIRS1040ScheduleHLNDesc" style="width:165mm;padding-left:0px;float:none;height:8mm;">
										...
										<label style="height:4mm;">
											...
											<span style="width:2mm;"/>
											<span class="styBoldText">No. Stop.</span> Include the amount from line 8d above on Schedule 2 (Form 1040), line 9. Include the amounts, if any, from <br/>
											<span style="padding-left:7mm;">line 8e on Schedule 3 (Form 1040), line 13b, and line 8f on Schedule 3 (Form 1040), line 13h. 
											If you're not required to file Form 1040, see the line 9 instructions.</span>
                                        </label>
									</div>
									<!-- Yes -->
									<div class="styIRS1040ScheduleHLNDesc" style="width:165mm;padding-left:0px;float:none;height:4mm;">
					...
					<div  style="width:187mm;padding-top:1mm;clear:both;font-size:6.5pt;page-break-after:always;display:block;">
					    ...
					    <div style="float:right;">
								<span class="styBoldText">Schedule H (Form 1040) 2022</span>
					    </div>
					</div>
					</div>	
					...
					<div class="styTBB" style="width:187mm;padding-top:.5mm;">
						<div style="float:left;">Schedule H (Form 1040) 2022</div>
						<div style="float:right;">
						...
						<div style="width:187mm;" class="styNBB">
							...
							<div class="styIRS1040ScheduleHLineItem" style="height:auto;">
								...
								<div class="styIRS1040ScheduleHLNDesc" style="width:153.5mm;height:5mm;">
								  Did you pay all state unemployment contributions for 2022 by April 18, 2023? Fiscal year filers, see instructions
								</div>
								<div class="styIRS1040ScheduleHLNDesc" style="width:25mm;float:right;padding:0px 0px 0px 0px;">
								<!-- Number Box -->
...
<!--							--><!-- Amount Box --><!--
					...
					<div style="width:187mm;" class="styBB">
						...
						<div class="styIRS1040ScheduleHLineItem">
							...
							<!-- Description -->
							<div class="styIRS1040ScheduleHLNDesc" style="width:137mm;">
                                <span style="float:left;">Enter the amount from line 8d. If you checked the " <b>Yes</b>" box on line C of page 1, enter -0-</span>
                                <!--Dotted Line-->
								<span class="styDotLn" style="float:right;padding-right:1mm;">...</span>
							</div>
							<!-- Amount Box -->
								...
								<div class="styIRS1040ScheduleHLNDesc" style="width:170mm;padding-left:0px;float:none;">
									...
									<div class="styIRS1040ScheduleHLNDesc" style="width:165mm;padding-left:0px;float:none;">
										...
										<label style="height:7mm;padding-bottom:2mm;">
											...
											<span style="width:2mm;"/>
											<span class="styBoldText" style="">Yes. Stop.</span> Include the amount from line 26 above on Schedule 2 (Form 1040), line 9. 
											Include the amounts, if any, from <br/><span style="padding-left:7mm"/>line 8e, on Schedule 3 (Form 1040), line 13b, 
											and line 8f on Schedule 3 (Form 1040), line 13h. <span class="styBoldText">Don't</span> complete Part IV below.
                                        </label>
									</div>
									<!-- No -->
              ...
              Declaration of preparer (other than taxpayer) is based on all information of which preparer has any knowledge.<br/>
							...
							<div class="styIRS1040ScheduleHLNDesc" style="padding:0px 0px 0px 0px;width:100%;height:auto;">
								<div class="styIRS1040ScheduleHLNDesc" style="padding:0px 0px 0px 2mm;width:3%">
									<img src="{$ImagePath}/1040ScheduleH_Bullet_Lg.gif" alt="LargeRightArrow"/>
								</div>
					...
					<xsl:choose>
								    <xsl:when test="$Form1040ScheduleHData/HouseholdEmployerNm != '' ">
                       <div class="styTBB" style="width:187mm;font-size:6pt;height:auto;border-top:1px solid black;">
							...
							<div style="width:164mm;float:left;clear:none;border-width:0px 0px 0px 1px; border-color:black;border-style:solid;">
								<div style="width:164mm;float:left;clear:none;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;">
									...
									<!--	******NOTE: UWR 228037 REQUESTED PAID PREPARERER SECTION TO BE BLANK TY2022*****-->
<!--										<xsl:call-template name="PopulateText">
					...
					<!-- Page Break and Footer-->
						<div   style="width:187mm;">
							...
							<div class="stySmallText" style="width:51mm;text-align:right;">
								<span class="styBoldText" style="font-weight:bold;">Schedule H (Form 1040) 2022</span>
							</div>
						</div>
					</div>
					</div>
							...
							<tbody>
								...
								<xsl:for-each select="$Form1040ScheduleHData/UnemplFundMultiStateGroup/UnemploymentStateTaxGroup">
									<tr style="border-color:black;">
										...
										<xsl:when test="position() mod 2 = 1">styDepTblRow1</xsl:when><xsl:otherwise>styDepTblRow2</xsl:otherwise></xsl:choose></xsl:attribute>
										<!-- (a) //////////////////////////////////// -->
										...
										<td class="styIRS1040ScheduleHTableCell" style="width:20%;font-size: 6pt; text-align:center;padding:0px 0px 0px 0px;height:auto;">
											<div class="styIRS1040ScheduleHLineItem" style="padding:0px 0px 0px 0px;width:100%;height:3mm;">
												...
												<div class="styIRS1040ScheduleHLineItem" 
							style="padding:0px 0px 0px 0px;float:left;width:49%;text-align:center;border-width:0px 0px 0px 1px;border-style:solid;border-color:black;height:3mm;">
													<xsl:call-template name="PopulateMonthDayYear">
														<xsl:with-param name="TargetNode" select="UnemplStateExprncRateToDt"/>
													</xsl:call-template>
												</div>
