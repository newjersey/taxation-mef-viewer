...
<!-- Last Modified by Sergey Smirnov on 12/20/2022 -->
				...
				<form id="Form1040NR">
					...
					<div class="styStdDiv">
						...
						<div class="styTYBox" style="width:17mm;border-right-width:1px;height:42px;
							padding-top:4px;">
							<span class="styTaxYear" style="font-size:21pt;">20<span class="styTYColor">22
							</span></span>
						</div>
					...
					<div class="styStdDiv" style="border-top:1px solid black;border-bottom:1px solid black;">
						...
						<div style="width:167mm;min-height:15mm;padding-top:1.0mm;
							...
							<span style="display:inline;font-family:Arial;font-size:10pt">
								...
								<span style="width:3mm;"/>
								<input type="checkbox" class="styCkboxNM" style="margin-right:1mm;"
									alt="Individual Return Filing Status Cd Qualifying surviving spouse (QSS)">
									<xsl:call-template name="PopulateEnumeratedCheckbox">
										<xsl:with-param name="TargetNode" 
										select="$FormData/IndividualReturnFilingStatusCd"/>
								...
								<label>
									<!--<xsl:call-template name="PopulateLabel">
										...
										<xsl:with-param name="BackupName">
										IRS1040NRIndividualReturnFilingStatusCd[5]</xsl:with-param>
									</xsl:call-template>-->Estate</label>
								<span style="width:3mm;"/>
								<input type="checkbox" class="styCkboxNM" style="margin-right:1mm;"
									alt="Trust Ind">
									<!--<xsl:call-template name="PopulateEnumeratedCheckbox">
					...
					<div class="styStdDiv">
					    <div style="width:20mm; height:8mm;padding-top:0.5mm;padding-left:1mm;float:left; border-right:1px solid black;border-bottom:1px solid black; ">
							<strong>Digital<br/>Assets</strong>
						</div>
						<div class="styIRS1040NRHeaderCell" style="width:167mm;height:8mm;border-right-width:0mm; float:left;">
						At any time during 2022, did you: (a) receive (as a reward, award, or payment for property or services); or (b) sell, exchange, gift, <br/>or otherwise dispose of a digital asset (or a financial interest in a digital asset)? (See instructions). 
							<span style="font-family:Arial Narrow;font-size:8pt;padding-top:2px">
								<input type="checkbox" class="styCkboxNM" 
									style="margin-left:5mm;margin-top:0mm" alt="Virtual Cur Acquired Dur TY Ind Yes">
					...
					<!-- Dependents area -->
					<div class="sty1040NRDepdContainer" style="display:block; overflow:visible">
							...
							<thead class="styTableThead">
								<tr>
									<th class="styTableCellHeader" rowspan="2"	scope="col" 
										style="min-width:55.4mm;width:55.4mm;text-align:left;padding-left:1mm;
										padding-top:0mm;">
										<br/>
									...
									<th class="styTableCellHeader" rowspan="2"
										scope="col" style="min-width:20mm;width:26.2mm;border-right-width:1px;
										vertical-align:top;">
									...
									<th class="styTableCellHeader" rowspan="2"	scope="col" style="min-width:20mm;width:21.6mm;border-right-width:1px;vertical-align:top;">
										<span style="font-weight:normal;">
											<b>(3)</b><span style="width:.5mm"/>Relationship to you
										</span>
									</th>
									<th class="styTableCellHeader" colspan="2" scope="colgroup" style="width:49.6mm;border-right-width:0px;border-bottom-width:0px;vertical-align:top;text-align:left;">
										<span style="font-weight:normal">
											<span style="width:1mm"/><b>(4)</b>
											<span style="width:1mm"/>Check the box if qualifies for (see inst.):
										</span>
									</th>
								</tr>
								<tr>
									...
									<xsl:for-each select="$FormData/DependentDetail">
										<tr>
											<td class="styTableCellTextInherit">
												<span style="width:27mm;text-align:left;float:left;clear:none;">
													<xsl:call-template name="PopulateText">
...
EligibleForChildTaxCreditInd</xsl:with-param>
											...
											<td class="styTableCellCtrInherit" style="border-right-width:0px;text-align:center">
...
EligibleForODCInd</xsl:with-param>
					...
					<div class="styStdDiv" style="border-top:1px solid black;overflow:visible;border-top:1px solid black">
						<div class="styGenericDiv" style="width:20mm;padding-top:.5mm;height:134mm;">
						...
						<div class="sty1040NRLN">
							...
							<div class="sty1040NRDesc" style="width:122.7mm;">
						...
						<div class="sty1040NRLN">
							...
							<div class="sty1040NRDesc" style="width:86.7mm;padding-top:0.7mm;">
						...
						<!-- Line 1j -->
						<div class="sty1040NRLN">
							<div class="styLNLeftNumBoxSD" style="padding-left:1mm;margin-left:5px;margin-right:-4px;">j</div>
							<div class="sty1040NRDesc" style="width:122.7mm;">
								Reserved for future use
								<span class="sty1040NRDotLn">......................</span>
							</div>
						...
						<!-- Line 1k -->
						<div class="sty1040NRLN">
							<div class="styLNLeftNumBoxSD" style="padding-left:1mm;margin-left:5px;margin-right:-4px;">k</div>
							<div class="sty1040NRDesc" style="width:86.7mm;padding-top:0.7mm;">
						...
						<div class="sty1040NRLN">
							...
							<div class="sty1040NRDesc">Add lines 1z, 2b, 3b, 4b, 5b, 7, and 8. This is your
						...
						<div class="sty1040NRLN">	
							...
							<div class="sty1040NRAmountBox" style="height:4mm;background-color:lightgrey;padding-top:.5mm">
								<!--<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode"
						...
						<div class="sty1040NRLN">	
							...
							<div class="sty1040NRDesc" style="height:4mm;">
								<span style="padding-top:0mm;">Enter the amount from line 10a. These are your 
									<strong>total adjustments to income</strong> 
									<span class="sty1040NRDotLn" style="padding-left:10px;">....</span>
								</span>	
							</div>
						...
						<div class="sty1040NRLN">
							...
							<div class="sty1040NRDesc" style="padding-top:0.7mm;height:7.5">
					...
					<div class="styStdDiv pageEnd" style="border-top:1px solid black;">
						...
						<span style="float:right;font-size:6.5pt;">Form <strong>1040-NR</strong> (2022)
						</span>
					</div>
					<!-- Page 2 -->
					...
					<div class="styStdDiv" style="border-bottom:0px solid black;overflow:visible;">
							<div class="styGenericDiv" style="width:20mm;padding-top:1mm;padding-bottom:1mm;">
								...
								<span style="padding-left:0mm;font-weight:bold;font-size:10pt;padding-bottom:42mm;">Credits</span>	
							</div>
						<!-- Line 16 -->
						<div class="sty1040NRLN">
			...
			select="$FormData/Form8814Ind/@childInterestAndDividendTaxAmt"/>
						...
						<div class="sty1040NRLN">
							...
							<div class="sty1040NRAmountBox">
								<span style="float:left;">
									<xsl:call-template name="SetFormLinkInline">
										<xsl:with-param name="TargetNode"
											select="$FormDataSch8812/CTCODCAmt"/>
									</xsl:call-template>
								</span>
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
						...
						<div class="styStdDiv" style="border-top:1px solid black;overflow:visible;border-bottom:1px solid black">
							<div class="styGenericDiv" style="width:20mm;padding-top:0mm;padding-bottom:1mm;">
								<span style="padding-left:.5mm;font-weight:bold;font-size:9.5pt;padding-bottom:59mm;">Payments</span>
							</div>
					<!--</div>-->
						<!-- Line 25 -->
						<div class="sty1040NRLN">
						...
						<div class="sty1040NRLN">
							...
							<div class="sty1040NRRightNumBox" style="height:4.5mm;padding-top:1.3mm">28</div>
							<div class="sty1040NRAmountBox" style="height:4.5mm;padding-top:1.3mm">
								<span style="float:left;">
									<xsl:call-template name="SetFormLinkInline">
										<xsl:with-param name="TargetNode" 
							...
							<div class="sty1040NRRightNumBoxNBB" style="background-color:lightgrey;height:4.5mm">
								&nbsp;</div>
							<div class="sty1040NRAmountBoxNBB" style="height:4.5mm">&nbsp;</div>
						</div>
						<!-- Line 29 -->
						<div class="sty1040NRLN">
					...
					<!-- Refund -->
				<div class="styStdDiv" style="border-top:0px solid black;overflow:visible;">	
					<div class="styGenericDiv" style="width:20mm;height:30mm;">
					...
					<div class="sty1040NRLN">
						...
						<div class="sty1040NRDesc" style="width:87mm;">
							<span style="display:inline;font-family:Arial;">Amount of line 34 you want
								<strong>applied to your 2023 estimated tax </strong></span>
							<span class="sty1040NRDotLn" style="padding-right:0px;
								margin-right:8px;">..
							</span>
						</div>
					...
					<div class="" style="width:187mm;font-size:7pt;float:none;clear:both;
						...
						<div style="width:20mm;padding-top:4mm;float:left;clear:none;border-right:1px solid black;height:24.3mm;">
			...
			select="$RtnHdrData/PaidPreparerInformationGrp/PreparerFirmName/BusinessNameLine2Txt"/>
				...
				<div class="styStdDiv pageEnd" style="border-top:2px solid black;">
					...
					<span style="float:right;font-size:6.5pt;">Form <strong>1040-NR</strong> (2022)</span>
				</div>
