		...
		<html>
			...
			<!--!		<div style="float:right;clear:none;width:40mm;">
					...
					<div class="styBB" style="width:187mm;height:auto;border-top-width:2px;padding-top:0;padding-bottom:0;">
						<div class="styPartName" style="height:3.9mm">Part II</div>
						<div class="styPartDesc" style="float:left;width:167mm;">
		    Credit for Business/Investment Use Part of Refueling Property
					...
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
							<div class="styLNLeftNumBox" style="padding-left:2.5mm;">4b</div>
							<div class="styLNDesc" style="width:139mm;">
					<!--		<div class="styLNLeftNumBoxSD">4b</div> --> 
								Enter any amount included on line 4a attributable to property placed in service after 2022 as part of a       				<span style="float:left;">project subject to project requirements that were not met (see instructions) </span>
								<!--Dotted Line-->
							<div class="styDotLn" style="float:right;padding-right:3mm;">..........</div>
							</div>
						</div>
						<div style="float:right;clear:none;width:40mm;">
					    	  <div class="styLNRightNumBox" style="height:4.1mm;background:gray;border-bottom-width:0"/>
			   				<div class="styLNAmountBox" style="height:4.1mm;border-bottom-width:0"/>
			   				 <div class="styLNRightNumBox" style="height:4.1mm;">4b</div>
							<div class="styLNAmountBox" style="height:4.1mm;">
									<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form8911/NetBusUseAftrYrProjNotMetAmt"/>
								</xsl:call-template>							
					...
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
							<div class="styLNLeftNumBoxSD">4c</div>
							<div class="styLNDesc" style="width:137mm;">
								<span style="float:left;">Subtract line 4b from line 4a </span>
								<!--Dotted Line-->
								<div class="styDotLn" style="float:right;padding-right:1mm;">........................</div>
							</div>
						</div>
						<div style="float:right;clear:none;">
							...
							<div class="styLNAmountBox">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form8911/TotNetBusinessUsePartAmt"/>
								</xsl:call-template>
							</div>
						</div>
					</div>
					...
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="width:137mm;">
								<span style="float:left;">Multiply line 4b by 6% (0.06) </span>
								<!--Dotted Line-->
								<div class="styDotLn" style="float:right;padding-right:1mm;">........................</div>
							</div>
						</div>
						<div style="float:right;clear:none;">
							...
							<div class="styLNAmountBox">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form8911/TotNetBusUsePartCrRateAdjAmt"/>
								</xsl:call-template>
							</div>
						</div>
					</div>
					...
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
							<div class="styLNLeftNumBoxSD">5b</div>
							<div class="styLNDesc" style="width:137mm;">
								<span style="float:left;">Multiply line 4c by 30% (0.30) </span>
								<!--Dotted Line-->
								<div class="styDotLn" style="float:right;padding-right:1mm;">........................</div>
							</div>
						</div>
					...
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
							<div class="styLNLeftNumBoxSD">5c</div>
							<div class="styLNDesc" style="width:137mm;">
								<span style="float:left;">Add lines 5a and 5b </span>
								<!--Dotted Line-->
								<div class="styDotLn" style="float:right;padding-right:1mm;">...........................</div>
							</div>
						</div>
						<div style="float:right;clear:none;">
							...
							<div class="styLNAmountBox">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form8911/TotBusinessUsePartAmt"/>
								</xsl:call-template>
							</div>
						</div>
					</div>
					...
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="width:137mm;">
								<span style="float:left;">Enter the <span class="styBoldText">smaller</span> of line 5c or line 6 </span>
								<!--Dotted Line-->
								<div class="styDotLn" style="float:right;padding-right:1mm;">......................</div>
							</div>
						</div>
					...
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="width:139mm;">
								<span style="float:left;">Alternative fuel vehicle refueling property credit from partnerships and S corporations</span>
                                          <br/>								
                                <span style="font-size: 6.5pt;">(see instructions)</span>
								<!--Dotted Line-->
								<div class="styDotLn" style="float:right;padding-right:3mm;">............................</div>
							</div>
						</div>
						<div style="float:right;clear:none;width:40mm;">
					    	<div class="styLNRightNumBox" style="height:4.1mm;background:gray;border-bottom-width:0"/>
			   				<div class="styLNAmountBox" style="height:4.1mm;border-bottom-width:0"/>
			   				<div class="styLNRightNumBox" style="height:4.1mm;">8</div>
							<div class="styLNAmountBox" style="height:4.1mm;">
								<xsl:call-template name="PopulateAmount">
					...
					<div style="width:187mm;">
						...
						<div style="float:right;clear:none;width:40mm;">
							<div class="styLNRightNumBox" style="height:4.1mm;background:gray;border-bottom-width:0"/>
			   				<div class="styLNAmountBox" style="height:4.1mm;border-bottom-width:0"/>
			   				<div class="styLNRightNumBox" style="height:4.1mm;">9</div>
							<div class="styLNAmountBox" style="height:4.1mm;">
								<xsl:call-template name="PopulateAmount">
                ...
                Subtract line 2 from line 1. If zero, stop here; <span class="styBoldText">do not</span> file this form unless you 
                  are claiming a credit on line 9 
                <!--Dotted Line-->
								<!--<div class="styDotLn" style="float:right;padding-right:1mm;">...............................</div>-->
							</div>
						</div>
					...
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="width:137mm;">
								<span style="float:left;">Multiply line 10 by 30% (0.30) </span>
								<!--Dotted Line-->
								<div class="styDotLn" style="float:right;padding-right:1mm;">........................</div>
							</div>
						</div>
		      ...
		      Regular tax before credits:
					...
					<div style="width:187mm;">
						...
						Individuals. Enter the sum of the amounts from Form 1040, 1040-SR, or 1040-NR, 
											...
											<span style="padding-left:2mm">line 16, and Schedule 2 (Form 1040), line 2.</span>
											<br/>
					...
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
							<div class="styLNLeftNumBox">
								<span style="width:6px;padding-left:2mm"/>
		        a
		    </div>
			 ...
			 <span style="float:left;">credit on line 9 </span>
			   ...
			   of line 13 or line 18 here and on Schedule 3 (Form 1040), line 6j; or the appropriate line of your return. If line 18 is smaller than line 13, see instructions 			
                <!--Dotted Line-->
								<div class="styDotLn" style="float:right;padding-right:1mm;">....</div>
							</div>
						</div>
						<div style="float:right;clear:none;width:40mm;">
							<div class="styLNRightNumBox" style="height:5mm;background:gray;border-bottom-width:0"/>
							<div class="styLNAmountBox" style="height:5mm;border-bottom-width:0"/>
							<div class="styLNRightNumBox" style="height:5mm;border-bottom-width:0;">19</div>
							<div class="styLNAmountBox" style="height:5mm;border-bottom-width:0;">
								<xsl:call-template name="PopulateAmount">
					...
					<div class="pageEnd" style="width:187mm;">
						...
						<div style="float:right;clear:none;">
							<span style="width:50mm;text-align:right;"> Form <b>8911</b> (Rev. 12-2022)</span>
						</div>
					</div>
