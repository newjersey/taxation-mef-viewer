...
<!-- 10/24/2022 - Changes made for UWR 861256 - Jeremy Nichols -->
		...
		<html>
          ...
          Employer identification number<br/>
						...
						<table class="styTable" style="border-bottom:0;" cellspacing="0">
							<thead class="styTableThead">
								<tr>
									...
									<th class="styIRS1118TableCellHeaderSmall" style="width:32mm;height:9mm;" scope="col" rowspan="2">14. <span class="styNormalText" style="display:inline;">Apportioned Share of Deductions (enter amount from applicable line of Schedule H, Part I, column (b); Part II, column (f); and Part III, column (g))</span>
									</th>
					...
					<div style="width:256mm;padding-top:0.5mm;border-top:1px solid black;">
						...
						<div style="float:right">
						  ...
						  Form <b style="font-size:8pt;">1118</b> (Rev. 12-2022)
						</div>
					</div>
					<div class="pageEnd"/>
					<!--END FOOTER-->
					...
					<div style="display:block;">
						<div class="styBB" style="width:256mm">
							<div style="float: left; clear: none">Form 1118 (Rev. 12-2022)</div>
							<div style="float:right">
							...
							<table class="styLandscapeTable" summary="Part I—Dividends and Deemed Inclusions From Post-1986 Undistributed Earnings" cellspacing="0" style="width:259mm;">
								<thead class="styTableThead">
									<tr>
										...
										<th class="styIRS1118TableCellHeaderSmall" style="width:80mm;height:5mm;" scope="col">1c. <span class="styNormalText" style="display:inline;">Tested Unit Reference ID (if applicable)</span>
										</th>
									</tr>
								</thead>
								<tfoot/>
							...
							<table class="styLandscapeTable" summary="Part I—Dividends and Deemed Inclusions From Post-1986 Undistributed Earnings" cellspacing="0" style="width:259mm;">
								<thead class="styTableThead">
									<tr>
										...
										<th class="styIRS1118TableCellHeaderSmall" style="width:40mm;" rowspan="2" scope="col">7. <span class="styNormalText" style="display:inline;">Total Eligible Current Year Taxes in Subpart F Income Group (in U.S. dollars)</span>
										</th>
						...
						<div style="width:256mm;border-top:1pt solid black;">
							<div style="float:right;clear:none;">
								<div style="width:100mm;">
								 ...
								 Form <b style="font-size:8pt;">1118</b> (Rev. 12-2022)</div>
							</div>
						</div>
						<div class="pageEnd"/>
						<!--END FOOTER-->
          ...
          Page <span class="styBoldText" style="font-size: 8pt">8</span>
					...
					<div style="width:256mm;">
						...
						<div style="float:right;clear:none;">
							<div style="width:128mm;">
								<span style="width:90mm;"/>      Form <b style="font-size:8pt;">1118</b> (Rev. 12-2022)</div>
						</div>
					</div>
					<div class="pageEnd"/>
					<!--END FOOTER-->
					...
					<div style="display:block;">
						...
						<div class="styBB" style="width:256mm;text-align:left;display:block;">
							<div class="styIRS1118TitleDesc" style="text-align:left;padding-left:0;">Part II—Deductions Allocated and Apportioned Based on Assets
          <!-- The xsl:choose code block below enables this stylesheet to display data from more than one schema version -->
						...
						<div style="height:auto;width:260mm;">
							<table class="styTable" style="height:auto;width:256mm;" cellspacing="0">
								<thead class="styTableThead">
									<tr>
										<td colspan="2" rowspan="2" scope="col" style="height:28mm;width:46mm;">
											<span style="width:1px;"/>
										</td>
										<td colspan="2" scope="col" style="height:22mm;width:56mm;text-align:left;float:none;border-bottom:1px solid black;border-left:1px solid black;">
											<span style="width:16px"/>
                ...
                Check method used:<br/>
										...
										<td colspan="2" scope="col" style="height:28mm;width:56mm;text-align:center;float:none;border-bottom:1px solid black;border-left:1px solid black;">
											<span class="styBoldText">(b)</span>
											Interest Deductions
										</td>
										<td rowspan="2" scope="col" style="height:28mm;width:28mm;text-align:center;padding-top:1mm;Padding-left:1mm;border-left:1px solid black;border-bottom:0px solid black;">
											<span class="styBoldText">(c)</span>
											Stewardship Deductions
										</td>
										<td rowspan="2" scope="col" style="height:28mm;width:28mm;text-align:center;padding-top:1mm;Padding-left:1mm;border-left:1px solid black;border-bottom:0px solid black;">
											<span class="styBoldText">(d)</span>
											CertainIndustrial/Investor Damages <br/>(see instructions)
										</td>
										<td rowspan="2" scope="col" style="height:28mm;width:28mm;text-align:center;border-left:1px solid black;">
											<span class="styBoldText">(e)</span> 
												Other <br/>Deductions<br/>
												(attach schedule)<br/>
												(see instructions)
												<xsl:call-template name="SetFormLinkInline">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ApprtnOtherDeductionsGrp/OthDedNotAllcblTotalsAmt"/>
											</xsl:call-template>
										</td>
										<td rowspan="2" scope="col" style="height:28mm;width:30mm;text-align:center;padding-top:1mm;Padding-left:1mm;border-left:1px solid black;border-bottom:0px solid black;">
									...
									<tr>
										<td scope="col" style="height:7mm;width:25mm;text-align:center;border-left:1px solid black;">
								...
								<tbody>
									<tr>
										<td class="styLNLeftLtrBoxBB" style="height:8mm;padding-top:4.5mm;padding-left:1mm;border-top:1px solid black;border-bottom:0px solid black;">
											<span class="styBoldText">1<span style="width:2px"/>a</span>
										</td>
										<td class="styIRS1118LNDescDed" style="height:8mm;padding-top:4mm;border-top:1px solid black;">
												Totals (see instructions)
												<span style="width:10px;"/>.
												<span style="width:10px;"/>.
												<span style="width:10px;"/>.
										...
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;border-top:1px solid black;">
											<xsl:call-template name="PopulateAmount">
										...
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;border-top:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/StewardshipDeductionsGrp/OthDedNotAllcblTotalsAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;border-top:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/CrtnIndustrialInvstDamagesGrp/OthDedNotAllcblTotalsAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;border-top:1px solid black;">
									...
									<tr>
										...
										<td class="styIRS1118LNDescDed" style="height:10mm;padding-top:4mm;">
										...
										<td class="styIRS1118LNAmountBoxSmall" style="height:10mm;border-bottom-width:1px;background-color:lightgrey;">
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:10mm;border-bottom-width:1px;background-color:lightgrey;">
											<span style="width:1px;"/>
									...
									<tr>
										...
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;border-bottom-width:1px;">
											<span style="width:1px;"/>
										</td>
									</tr>
									<tr>
										...
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;border-bottom-width:0px;border-bottom-width:1px;background-color:lightgrey;">
											<span style="width:1px;"/>
										</td>
									</tr>
									<tr>
										...
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/StewardshipDeductionsGrp/TotalApportionedAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/CrtnIndustrialInvstDamagesGrp/TotalApportionedAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;border-top-width:0px;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ApprtnOtherDeductionsGrp/TotalApportionedAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;border-bottom-width:1px;background-color:lightgrey;">
									...
									<tr>
										...
										<td class="styIRS1118LNDescDed" style="border-bottom-width:0px;'">Apportionment among statutory groupings and residual grouping (see instructions):</td>
									...
									<tr>
										...
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/StewardshipDeductionsGrp/ApportionmentStatutoryGrp/Section951AIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/CrtnIndustrialInvstDamagesGrp/ApportionmentStatutoryGrp/Section951AIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ApprtnOtherDeductionsGrp/ApportionmentStatutoryGrp/Section951AIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
									...
									<tr>
										...
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/StewardshipDeductionsGrp/ApportionmentStatutoryGrp/Section951AIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/CrtnIndustrialInvstDamagesGrp/ApportionmentStatutoryGrp/Section951AIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ApprtnOtherDeductionsGrp/ApportionmentStatutoryGrp/Section951AIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
									...
									<tr>
										...
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/StewardshipDeductionsGrp/ApportionmentStatutoryGrp/Section951AIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/CrtnIndustrialInvstDamagesGrp/ApportionmentStatutoryGrp/Section951AIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ApprtnOtherDeductionsGrp/ApportionmentStatutoryGrp/Section951AIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
									...
									<tr>
										...
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/StewardshipDeductionsGrp/ApportionmentStatutoryGrp/ForeignBranchIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/CrtnIndustrialInvstDamagesGrp/ApportionmentStatutoryGrp/ForeignBranchIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ApprtnOtherDeductionsGrp/ApportionmentStatutoryGrp/ForeignBranchIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
									...
									<tr>
										...
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/StewardshipDeductionsGrp/ApportionmentStatutoryGrp/ForeignBranchIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/CrtnIndustrialInvstDamagesGrp/ApportionmentStatutoryGrp/ForeignBranchIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ApprtnOtherDeductionsGrp/ApportionmentStatutoryGrp/ForeignBranchIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
									...
									<tr>
										...
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/StewardshipDeductionsGrp/ApportionmentStatutoryGrp/ForeignBranchIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/CrtnIndustrialInvstDamagesGrp/ApportionmentStatutoryGrp/ForeignBranchIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ApprtnOtherDeductionsGrp/ApportionmentStatutoryGrp/ForeignBranchIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
									...
									<tr>
										...
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/StewardshipDeductionsGrp/ApportionmentStatutoryGrp/PassiveCategoryIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/CrtnIndustrialInvstDamagesGrp/ApportionmentStatutoryGrp/PassiveCategoryIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ApprtnOtherDeductionsGrp/ApportionmentStatutoryGrp/PassiveCategoryIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
									...
									<tr>
										...
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/StewardshipDeductionsGrp/ApportionmentStatutoryGrp/PassiveCategoryIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/CrtnIndustrialInvstDamagesGrp/ApportionmentStatutoryGrp/PassiveCategoryIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ApprtnOtherDeductionsGrp/ApportionmentStatutoryGrp/PassiveCategoryIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
									...
									<tr>
										...
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/StewardshipDeductionsGrp/ApportionmentStatutoryGrp/PassiveCategoryIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/CrtnIndustrialInvstDamagesGrp/ApportionmentStatutoryGrp/PassiveCategoryIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ApprtnOtherDeductionsGrp/ApportionmentStatutoryGrp/PassiveCategoryIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
									...
									<tr>
										...
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/StewardshipDeductionsGrp/ApportionmentStatutoryGrp/GeneralCategoryIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/CrtnIndustrialInvstDamagesGrp/ApportionmentStatutoryGrp/GeneralCategoryIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ApprtnOtherDeductionsGrp/ApportionmentStatutoryGrp/GeneralCategoryIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
									...
									<tr>
										...
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/StewardshipDeductionsGrp/ApportionmentStatutoryGrp/GeneralCategoryIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/CrtnIndustrialInvstDamagesGrp/ApportionmentStatutoryGrp/GeneralCategoryIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ApprtnOtherDeductionsGrp/ApportionmentStatutoryGrp/GeneralCategoryIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
									...
									<tr>
										...
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/StewardshipDeductionsGrp/ApportionmentStatutoryGrp/GeneralCategoryIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/CrtnIndustrialInvstDamagesGrp/ApportionmentStatutoryGrp/GeneralCategoryIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ApprtnOtherDeductionsGrp/ApportionmentStatutoryGrp/GeneralCategoryIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
									...
									<tr>
										<td style="width:8mm;height:8mm;font-size:6pt;font-weight:bold;text-align:center;vertical-align:bottom;padding-bottom:1mm;border-bottom:0px solid black;">
												e				
											</td>
										<td class="styIRS1118LNDescRD" style="height:8mm;vertical-align:center;border-bottom:0px solid black;">Enter Code
											<span style="width:20mm;text-align:center;border-bottom:1px solid black;">
												<xsl:for-each select="$Form1118ScheduleH/AverageValueAssetsGrp/AvgAstNonFinclCorporationsGrp/ApportionmentStatutoryGrp/Section901jIncomeCatGrp">
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode" select="Section901jIncomeCd"/>
													</xsl:call-template>
													<span style="width:1mm;"/>
													<xsl:call-template name="PopulateText">
												...
												<xsl:for-each select="$Form1118ScheduleH/AverageValueAssetsGrp/AvgAstFinancialCorporationsGrp/ApportionmentStatutoryGrp/Section901jIncomeCatGrp">
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode" select="Section901jIncomeCd"/>
													</xsl:call-template>
													<span style="width:1mm;"/>
												...
												<xsl:for-each select="$Form1118ScheduleH/ApportionmentInterestDedGrp/IntDedNonFinclCorporationsGrp/ApportionmentStatutoryGrp/Section901jIncomeCatGrp">
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode" select="Section901jIncomeCd"/>
													</xsl:call-template>
													<span style="width:1mm;"/>
												...
												<xsl:for-each select="$Form1118ScheduleH/ApprtnOtherDeductionsGrp/ApportionmentStatutoryGrp/Section901jIncomeCatGrp">
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode" select="Section901jIncomeCd"/>
													</xsl:call-template>
													<span style="width:1mm;"/>
												...
												<xsl:for-each select="$Form1118ScheduleH/StewardshipDeductionsGrp/ApportionmentStatutoryGrp/Section901jIncomeCatGrp">
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode" select="Section901jIncomeCd"/>
													</xsl:call-template>
													<span style="width:1mm;"/>
												...
												<xsl:for-each select="$Form1118ScheduleH/CrtnIndustrialInvstDamagesGrp/ApportionmentStatutoryGrp/Section901jIncomeCatGrp">
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode" select="Section901jIncomeCd"/>
													</xsl:call-template>
													<span style="width:1mm;"/>
									...
									<tr>
										...
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:for-each select="$Form1118ScheduleH/AverageValueAssetsGrp/AvgAstNonFinclCorporationsGrp/ApportionmentStatutoryGrp/Section901jIncomeCatGrp">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="Section901jIncomeGrp/Section245ADividendAmt"/>
												</xsl:call-template><br/>
											</xsl:for-each>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
										...
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:for-each select="$Form1118ScheduleH/ApportionmentInterestDedGrp/IntDedFinancialCorporationsGrp/ApportionmentStatutoryGrp/Section901jIncomeCatGrp">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="Section901jIncomeGrp/Section245ADividendAmt"/>
												</xsl:call-template><br/>
											</xsl:for-each>
									...
									<tr>
										...
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:for-each select="$Form1118ScheduleH/AverageValueAssetsGrp/AvgAstNonFinclCorporationsGrp/ApportionmentStatutoryGrp/Section901jIncomeCatGrp">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="Section901jIncomeGrp/OtherCategoryIncomeAmt"/>
												</xsl:call-template><br/>
											</xsl:for-each>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
									...
									<tr>
										...
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:for-each select="$Form1118ScheduleH/AverageValueAssetsGrp/AvgAstNonFinclCorporationsGrp/ApportionmentStatutoryGrp/Section901jIncomeCatGrp">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="Section901jIncomeGrp/TotalCategoryIncomeAmt"/>
												</xsl:call-template><br/>
											</xsl:for-each>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
									...
									<tr>
										...
										<td class="styIRS1118LNDescRD" style="height:8mm;vertical-align:center;border-bottom:0px solid black;">
											U.S. source
										</td>
										<td class="styShadingCellSmall" style="height:8mm;width:25mm;padding-top:4mm;float:none;border-left-width:1px;border-right-width:0px;border-bottom-width:1px;">
											<span style="width:1px;"/>
									...
									<tr>
										...
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/AverageValueAssetsGrp/AvgAstNonFinclCorporationsGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/AverageValueAssetsGrp/AvgAstFinancialCorporationsGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ApportionmentInterestDedGrp/IntDedNonFinclCorporationsGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ApportionmentInterestDedGrp/IntDedFinancialCorporationsGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/StewardshipDeductionsGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/CrtnIndustrialInvstDamagesGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ApprtnOtherDeductionsGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
									...
									<tr>
										...
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/AverageValueAssetsGrp/AvgAstNonFinclCorporationsGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/AverageValueAssetsGrp/AvgAstFinancialCorporationsGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ApportionmentInterestDedGrp/IntDedNonFinclCorporationsGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ApportionmentInterestDedGrp/IntDedFinancialCorporationsGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/StewardshipDeductionsGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/CrtnIndustrialInvstDamagesGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ApprtnOtherDeductionsGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
									...
									<tr>
										...
										<td class="styIRS1118LNDescDed" style="height:8mm;padding-top:4mm;">(3) Total line f
												...
												<span style="width:10px;"/>.
												<span style="width:10px;"/>.</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:28mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/AverageValueAssetsGrp/AvgAstNonFinclCorporationsGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:28mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/AverageValueAssetsGrp/AvgAstFinancialCorporationsGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:28mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ApportionmentInterestDedGrp/IntDedNonFinclCorporationsGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:28mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ApportionmentInterestDedGrp/IntDedFinancialCorporationsGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:28mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/StewardshipDeductionsGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:28mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/CrtnIndustrialInvstDamagesGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:28mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ApprtnOtherDeductionsGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td class="styIRS1118LNAmountBoxSmall" style="height:8mm;width:30mm;">
									...
									<tr>
										...
										<td class="styIRS1118LNDescDed" style="height:7mm;vertical-align:top;padding-top:1mm;" colspan="8">
											Part II Expenses Allocated and Apportioned to Section 245A Dividend.  
											Enter the sum of amounts in column (f) of lines 3a(1), 3b(1), 3c(1),
											3d(1), 3e(1), and 3f(1). Include this line 4 result as a negative amount on Schedule B, Part II, line 8b
					...
					<div style="display:block;">
						...
						<div class="styBB" style="width:256mm;text-align:left;display:block;">
							<div class="styIRS1118TitleDesc" style="text-align:left;padding-left:0;">Part III—Other Deductions
							</div>
						</div>
						<div style="height:auto;">
							<table class="styLandscapeTable" style="height:auto;width:256mm;font-size:6pt;" cellspacing="0">
								<thead class="styTableThead">
									<tr>
										<td colspan="2" scope="col" style="width:78mm;border-bottom:1px solid black;;">
											<span style="width:77mm;"/>
										</td>
										<td scope="col" style="width:25mm;text-align:center;border-bottom:1px solid black;border-left:1px solid black;">
											<span class="styBoldText">(a)</span>Officers’<br/>
											Compensation<br/>
											Expense
										</td>
										<td scope="col" style="width:25mm;text-align:center;border-bottom:1px solid black;border-left:1px solid black;">
											<span class="styBoldText">(b)</span>Amortization<br/>
											Deductions
											
										</td>
										<td scope="col" style="width:25mm;text-align:center;border-bottom:1px solid black;border-left:1px solid black;">
											<span class="styBoldText">(c)</span>Depletion<br/>
											Deductions
											
										</td>
										<td scope="col" style="width:25mm;text-align:center;border-bottom:1px solid black;border-left:1px solid black;">
											<span class="styBoldText">(d)</span>Product Liability<br/>
											Damages<br/>
											(see instructions)
											
										</td>
										<td scope="col" style="width:25mm;text-align:center;border-bottom:1px solid black;border-left:1px solid black;">
											<span class="styBoldText">(e)</span>Other<br/>
											Deductions
											
										</td>
										<td scope="col" style="width:25mm;text-align:center;border-bottom:1px solid black;border-left:1px solid black;">
											<span class="styBoldText">(f)</span>Total Deductions<br/>
											Allocated and<br/>
											Apportioned to<br/>
											Section 245A<br/>
											Dividend<br/>
										...
										<td scope="col" style="width:28mm;text-align:center;border-bottom:1px solid black;border-left:1px solid black;">
											<span class="styBoldText">(g)</span>Totals<br/>
											(add the amounts<br/>
											from columns (a)<br/>
											through (e)).<br/><br/>
											
											<span class="styBoldText">Additional note:</span><br/>
											With respect to each<br/>
											applicable statutory<br/>
											grouping, include the<br/>
											amount in column (g)<br/>
											of line 2a(2), 2b(2),<br/>
											2c(2), 2d(2), or 2e(2)<br/>
											below in column 14<br/>
								...
								<tbody>
									<tr>
										<td scope="col" style="width:10mm;text-align:center;vertical-align:top;">
											<span class="styBoldText">1</span>
										</td>
										<td scope="col" style="border-bottom:1px solid black;">
										...
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OfficerCompensationExpenseGrp/TotalApportionedAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/AmortizationDeductionsGrp/TotalApportionedAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/DepletionDeductionsGrp/TotalApportionedAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLiabilityDamagesGrp/TotalApportionedAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OtherCertainApprtnDedGrp/TotalApportionedAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;background-color:lightgrey;">
									...
									<tr>
										...
										<td scope="col" style="border-bottom:0px solid black;">
											Apportionment among statutory groupings<br/>
											and residual grouping (see instructions):
										</td>
										<td scope="col" style="text-align:right;border-bottom:0px solid black;border-left:1px solid black;background-color:lightgrey;">
									...
									<tr>
										<td scope="col" style="width:10mm;text-align:right;vertical-align:top;padding-right:2mm;">
											<span class="styBoldText">a</span>
										</td>
										<td scope="col" style="border-bottom:0px solid black;">
											Enter Code
											<span style="width:30mm;text-align:center;border-bottom:1px solid black;">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OfficerCompensationExpenseGrp/ApportionmentStatutoryGrp/Section951AIncomeCd"/>
												</xsl:call-template>
											</span>
										</td>
										<td scope="col" style="text-align:right;border-bottom:0px solid black;border-left:1px solid black;background-color:lightgrey;">
									...
									<tr>
										...
										<td scope="col" style="border-bottom:0px solid black;">
											<span class="styBoldText">(1)</span> Section 245A dividend
											<span style="width:10px;"/>.
											<span style="width:10px;"/>.
											<span style="width:10px;"/>.
											<span style="width:10px;"/>.
										...
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OfficerCompensationExpenseGrp/ApportionmentStatutoryGrp/Section951AIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/AmortizationDeductionsGrp/ApportionmentStatutoryGrp/Section951AIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/DepletionDeductionsGrp/ApportionmentStatutoryGrp/Section951AIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLiabilityDamagesGrp/ApportionmentStatutoryGrp/Section951AIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OtherCertainApprtnDedGrp/ApportionmentStatutoryGrp/Section951AIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/TotDedAllocApprtn245ADivGrp/ApportionmentStatutoryGrp/Section951AIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;background-color:lightgrey;">
									...
									<tr>
										...
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OfficerCompensationExpenseGrp/ApportionmentStatutoryGrp/Section951AIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/AmortizationDeductionsGrp/ApportionmentStatutoryGrp/Section951AIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/DepletionDeductionsGrp/ApportionmentStatutoryGrp/Section951AIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLiabilityDamagesGrp/ApportionmentStatutoryGrp/Section951AIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OtherCertainApprtnDedGrp/ApportionmentStatutoryGrp/Section951AIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;background-color:lightgrey;">
										...
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/TotalCertainDedAllocApprtnGrp/ApportionmentStatutoryGrp/Section951AIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
									</tr>
									<tr>
										...
										<td scope="col" style="border-bottom:1px solid black;">
											<span class="styBoldText">(3)</span> Total line a
											<span style="width:7px;"/>.
											<span style="width:10px;"/>.
											<span style="width:10px;"/>.
											<span style="width:10px;"/>.
										...
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OfficerCompensationExpenseGrp/ApportionmentStatutoryGrp/Section951AIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/AmortizationDeductionsGrp/ApportionmentStatutoryGrp/Section951AIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/DepletionDeductionsGrp/ApportionmentStatutoryGrp/Section951AIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLiabilityDamagesGrp/ApportionmentStatutoryGrp/Section951AIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OtherCertainApprtnDedGrp/ApportionmentStatutoryGrp/Section951AIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;background-color:lightgrey;">
									...
									<tr>
										...
										<td scope="col" style="border-bottom:0px solid black;">
											...
											<span style="width:30mm;text-align:center;border-bottom:1px solid black;">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OfficerCompensationExpenseGrp/ApportionmentStatutoryGrp/ForeignBranchIncomeCd"/>
												</xsl:call-template>
											</span>
										</td>
										<td scope="col" style="text-align:right;border-bottom:0px solid black;border-left:1px solid black;background-color:lightgrey;">
									...
									<tr>
										...
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OfficerCompensationExpenseGrp/ApportionmentStatutoryGrp/ForeignBranchIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/AmortizationDeductionsGrp/ApportionmentStatutoryGrp/ForeignBranchIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/DepletionDeductionsGrp/ApportionmentStatutoryGrp/ForeignBranchIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLiabilityDamagesGrp/ApportionmentStatutoryGrp/ForeignBranchIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OtherCertainApprtnDedGrp/ApportionmentStatutoryGrp/ForeignBranchIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/TotDedAllocApprtn245ADivGrp/ApportionmentStatutoryGrp/ForeignBranchIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;background-color:lightgrey;">
									...
									<tr>
										...
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OfficerCompensationExpenseGrp/ApportionmentStatutoryGrp/ForeignBranchIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/AmortizationDeductionsGrp/ApportionmentStatutoryGrp/ForeignBranchIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/DepletionDeductionsGrp/ApportionmentStatutoryGrp/ForeignBranchIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLiabilityDamagesGrp/ApportionmentStatutoryGrp/ForeignBranchIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OtherCertainApprtnDedGrp/ApportionmentStatutoryGrp/ForeignBranchIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;background-color:lightgrey;">
										...
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/TotalCertainDedAllocApprtnGrp/ApportionmentStatutoryGrp/ForeignBranchIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
									</tr>
									<tr>
										...
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OfficerCompensationExpenseGrp/ApportionmentStatutoryGrp/ForeignBranchIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/AmortizationDeductionsGrp/ApportionmentStatutoryGrp/ForeignBranchIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/DepletionDeductionsGrp/ApportionmentStatutoryGrp/ForeignBranchIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLiabilityDamagesGrp/ApportionmentStatutoryGrp/ForeignBranchIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OtherCertainApprtnDedGrp/ApportionmentStatutoryGrp/ForeignBranchIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;background-color:lightgrey;">
									...
									<tr>
										...
										<td scope="col" style="border-bottom:0px solid black;">
											...
											<span style="width:30mm;text-align:center;border-bottom:1px solid black;">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OfficerCompensationExpenseGrp/ApportionmentStatutoryGrp/PassiveCategoryIncomeCd"/>
												</xsl:call-template>
											</span>
										</td>
										<td scope="col" style="text-align:right;border-bottom:0px solid black;border-left:1px solid black;background-color:lightgrey;">
									...
									<tr>
										...
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OfficerCompensationExpenseGrp/ApportionmentStatutoryGrp/PassiveCategoryIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/AmortizationDeductionsGrp/ApportionmentStatutoryGrp/PassiveCategoryIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/DepletionDeductionsGrp/ApportionmentStatutoryGrp/PassiveCategoryIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLiabilityDamagesGrp/ApportionmentStatutoryGrp/PassiveCategoryIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OtherCertainApprtnDedGrp/ApportionmentStatutoryGrp/PassiveCategoryIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/TotDedAllocApprtn245ADivGrp/ApportionmentStatutoryGrp/PassiveCategoryIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;background-color:lightgrey;">
									...
									<tr>
										...
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OfficerCompensationExpenseGrp/ApportionmentStatutoryGrp/PassiveCategoryIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/AmortizationDeductionsGrp/ApportionmentStatutoryGrp/PassiveCategoryIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/DepletionDeductionsGrp/ApportionmentStatutoryGrp/PassiveCategoryIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLiabilityDamagesGrp/ApportionmentStatutoryGrp/PassiveCategoryIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OtherCertainApprtnDedGrp/ApportionmentStatutoryGrp/PassiveCategoryIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;background-color:lightgrey;">
										...
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/TotalCertainDedAllocApprtnGrp/ApportionmentStatutoryGrp/PassiveCategoryIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
									</tr>
									<tr>
										...
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OfficerCompensationExpenseGrp/ApportionmentStatutoryGrp/PassiveCategoryIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/AmortizationDeductionsGrp/ApportionmentStatutoryGrp/PassiveCategoryIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/DepletionDeductionsGrp/ApportionmentStatutoryGrp/PassiveCategoryIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLiabilityDamagesGrp/ApportionmentStatutoryGrp/PassiveCategoryIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OtherCertainApprtnDedGrp/ApportionmentStatutoryGrp/PassiveCategoryIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;background-color:lightgrey;">
									...
									<tr>
										...
										<td scope="col" style="border-bottom:0px solid black;">
											...
											<span style="width:30mm;text-align:center;border-bottom:1px solid black;">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OfficerCompensationExpenseGrp/ApportionmentStatutoryGrp/GeneralCategoryIncomeCd"/>
												</xsl:call-template>
											</span>
										</td>
										<td scope="col" style="text-align:right;border-bottom:0px solid black;border-left:1px solid black;background-color:lightgrey;">
									...
									<tr>
										...
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OfficerCompensationExpenseGrp/ApportionmentStatutoryGrp/GeneralCategoryIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/AmortizationDeductionsGrp/ApportionmentStatutoryGrp/GeneralCategoryIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/DepletionDeductionsGrp/ApportionmentStatutoryGrp/GeneralCategoryIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLiabilityDamagesGrp/ApportionmentStatutoryGrp/GeneralCategoryIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OtherCertainApprtnDedGrp/ApportionmentStatutoryGrp/GeneralCategoryIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/TotDedAllocApprtn245ADivGrp/ApportionmentStatutoryGrp/GeneralCategoryIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;background-color:lightgrey;">
									...
									<tr>
										...
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OfficerCompensationExpenseGrp/ApportionmentStatutoryGrp/GeneralCategoryIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/AmortizationDeductionsGrp/ApportionmentStatutoryGrp/GeneralCategoryIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/DepletionDeductionsGrp/ApportionmentStatutoryGrp/GeneralCategoryIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLiabilityDamagesGrp/ApportionmentStatutoryGrp/GeneralCategoryIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OtherCertainApprtnDedGrp/ApportionmentStatutoryGrp/GeneralCategoryIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;background-color:lightgrey;">
										...
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/TotalCertainDedAllocApprtnGrp/ApportionmentStatutoryGrp/GeneralCategoryIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
									</tr>
									<tr>
										...
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OfficerCompensationExpenseGrp/ApportionmentStatutoryGrp/GeneralCategoryIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/AmortizationDeductionsGrp/ApportionmentStatutoryGrp/GeneralCategoryIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/DepletionDeductionsGrp/ApportionmentStatutoryGrp/GeneralCategoryIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLiabilityDamagesGrp/ApportionmentStatutoryGrp/GeneralCategoryIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OtherCertainApprtnDedGrp/ApportionmentStatutoryGrp/GeneralCategoryIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;background-color:lightgrey;">
									...
									<tr>
										...
										<td scope="col" style="border-bottom:0px solid black;">
											Enter Code
											<span style="width:30mm;text-align:center;border-bottom:1px solid black;">
												<xsl:for-each select="$Form1118ScheduleH/OfficerCompensationExpenseGrp/ApportionmentStatutoryGrp/Section901jIncomeCatGrp">
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode" select="Section901jIncomeCd"/>
													</xsl:call-template>
													<span style="width:1mm;"/>
												...
												<xsl:for-each select="$Form1118ScheduleH/AmortizationDeductionsGrp/ApportionmentStatutoryGrp/Section901jIncomeCatGrp">
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode" select="Section901jIncomeCd"/>
													</xsl:call-template>
													<span style="width:1mm;"/>
												...
												<xsl:for-each select="$Form1118ScheduleH/DepletionDeductionsGrp/ApportionmentStatutoryGrp/Section901jIncomeCatGrp">
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode" select="Section901jIncomeCd"/>
													</xsl:call-template>
													<span style="width:1mm;"/>
												...
												<xsl:for-each select="$Form1118ScheduleH/ProductLiabilityDamagesGrp/ApportionmentStatutoryGrp/Section901jIncomeCatGrp">
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode" select="Section901jIncomeCd"/>
													</xsl:call-template>
													<span style="width:1mm;"/>
												...
												<xsl:for-each select="$Form1118ScheduleH/OtherCertainApprtnDedGrp/ApportionmentStatutoryGrp/Section901jIncomeCatGrp">
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode" select="Section901jIncomeCd"/>
													</xsl:call-template>
													<span style="width:1mm;"/>
									...
									<tr>
										...
										<td scope="col" style="vertical-align:bottom;border-bottom:0px solid black;">
											<span class="styBoldText">(1)</span> Section 245A dividend
											<span style="width:10px;"/>.
											<span style="width:10px;"/>.
											<span style="width:10px;"/>.
										...
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:for-each select="$Form1118ScheduleH/TotDedAllocApprtn245ADivGrp/ApportionmentStatutoryGrp/Section901jIncomeCatGrp">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="Section901jIncomeGrp/Section245ADividendAmt"/>
												</xsl:call-template><br/>
											</xsl:for-each>
									...
									<tr>
										...
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:for-each select="$Form1118ScheduleH/TotalCertainDedAllocApprtnGrp/ApportionmentStatutoryGrp/Section901jIncomeCatGrp">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="Section901jIncomeGrp/OtherCategoryIncomeAmt"/>
												</xsl:call-template><br/>
											</xsl:for-each>
									...
									<tr>
										...
										<td scope="col" style="vertical-align:bottom;border-bottom:1px solid black;">
											<span class="styBoldText">(3)</span> Total line a
											<span style="width:7px;"/>.
											<span style="width:10px;"/>.
											<span style="width:10px;"/>.
									...
									<tr>
										...
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OfficerCompensationExpenseGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/AmortizationDeductionsGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/DepletionDeductionsGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLiabilityDamagesGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OtherCertainApprtnDedGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/TotDedAllocApprtn245ADivGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/Section245ADividendAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;background-color:lightgrey;">
									...
									<tr>
										...
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OfficerCompensationExpenseGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/AmortizationDeductionsGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/DepletionDeductionsGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLiabilityDamagesGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OtherCertainApprtnDedGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/OtherCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;background-color:lightgrey;">
									...
									<tr>
										<td scope="col" style="width:10mm;text-align:center;vertical-align:top;border-bottom:1px solid black;">
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="border-bottom:1px solid black;">
											<span class="styBoldText">(3)</span> Total line a
										...
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OfficerCompensationExpenseGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/AmortizationDeductionsGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/DepletionDeductionsGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/ProductLiabilityDamagesGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/OtherCertainApprtnDedGrp/ApportionmentStatutoryGrp/USSourceIncomeGrp/TotalCategoryIncomeAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;background-color:lightgrey;">
									...
									<tr>
										...
										<td colspan="6" scope="col" style="width:193mm;border-bottom:1px solid black;">
											<span style="width:183mm; border-right:1px solid black;">
												Expenses Allocated and Apportioned to Section 245A Dividends. Add the amounts in column (f) and include this line 3 result as a<br/>
										...
										<td scope="col" style="text-align:right;vertical-align:bottom;border-bottom:1px solid black;border-left:1px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1118ScheduleH/CrtnDedExpnssApprtn245ADivAmt"/>
											</xsl:call-template>
											<span style="width:1px;"/>
										</td>
										<td scope="col" style="text-align:right;border-bottom:1px solid black;border-left:1px solid black;background-color:lightgrey;">
									...
									<tr>
										<td colspan="9" scope="col" style="border-bottom:2px solid black;">
											<span class="styBoldText">Important: </span><span style="width:1mm;"/><i>See <span class="styBoldText">Computer-Generated Schedule H</span> in the instructions.</i>
										</td>
									</tr>
								</tbody>
							</table>
