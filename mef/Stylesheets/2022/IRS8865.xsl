...
<!-- 01/13/2021 - Changes made for defect 66369 - Jeremy Nichols -->
<!-- 01/14/2021 - Changes made for defect 65051 - Jeremy Nichols -->
<!-- 04/23/2021 - Changes made for UWR 243365 - Jeremy Nichols -->
<!-- 07/19/2021 - Changes made for defect 67471 - Jeremy Nichols -->
...
<!-- 08/31/2022 - Changes made for UWR 861509 - Jeremy Nichols -->
					...
					<table cellspacing="0" cellpadding="0" style="font-size:7pt;">
						<tr>
							...
							<td class="IRS8865_LineGTab" style="width:87mm;border-top-width:1px;border-bottom-width:1px;">
								...
								<input type="checkbox" class="IRS8865_Checkbox" alt="File Form 1042">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" select="$FormData/FileForm1042Ind"/>
										<xsl:with-param name="BackupName">IRS8865FileForm1042Ind</xsl:with-param>
									</xsl:call-template>
								</input>
								<label>
									<xsl:call-template name="PopulateLabel">
								...
								<input type="checkbox" class="IRS8865_Checkbox" alt="File Form 8804">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" select="$FormData/FileForm8804Ind"/>
										<xsl:with-param name="BackupName">IRS8865FileForm8804Ind</xsl:with-param>
									</xsl:call-template>
								</input>
								<label>
									<xsl:call-template name="PopulateLabel">
								...
								<span style="width:12px;"/>
								<input type="checkbox" class="IRS8865_Checkbox" alt="File Form 1065">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" select="$FormData/FileForm1065Ind"/>
										<xsl:with-param name="BackupName">IRS8865FileForm1065Ind</xsl:with-param>
									</xsl:call-template>
								</input>
								<label>
									<xsl:call-template name="PopulateLabel">
				...
				<div class="IRS8865_LineContainer">
					...
					<div class="IRS8865_LineDescLong" style="height:6mm;width:12mm;padding-top:2mm;border-right-width:0px;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" alt="Non Deduction Interest Royalty Under Section 267A Yes">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/NondedIntRoyaltyUndSect267AInd"/>
									<xsl:with-param name="BackupName">IRS8865NondedIntRoyaltyUndSect267AYesInd</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						<span style="font-weight:bold;">
					...
					<div class="IRS8865_LineDescLong" style="height:6mm;width:12mm;padding-top:2mm;border-right-width:0px;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" alt="Non Deduction Under Section 267A No">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/NondedIntRoyaltyUndSect267AInd"/>
									<xsl:with-param name="BackupName">IRS8865NondedIntRoyaltyUndSect267ANoInd</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						<span style="font-weight:bold;">
				...
				<div class="IRS8865_LineContainer">
					...
					<div class="IRS8865_LineDescLong" style="width:12mm;border-right-width:0px;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" alt="Section 721c Partnership Yes">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/Section721cPartnershipInd"/>
									<xsl:with-param name="BackupName">IRS8865Section721cPartnershipYesInd</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						<span style="font-weight:bold;">
					...
					<div class="IRS8865_LineDescLong" style="width:12mm;border-right-width:0px;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" alt="Section 721c Partnership No">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/Section721cPartnershipInd"/>
									<xsl:with-param name="BackupName">IRS8865Section721cPartnershipNoInd</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						<span style="font-weight:bold;">
          ...
          <span class="IRS8865_DotSpacing">.......................</span>
					...
					<div class="IRS8865_LineDescLong" style="width:12mm;border-right-width:0px;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" alt="Special Allocation Made By Foreign Partnership Yes">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/SpclAllocnMadeByFrgnPrtshpInd"/>
									<xsl:with-param name="BackupName">IRS8865SpclAllocnMadeByFrgnPrtshpYesInd</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						<span style="font-weight:bold;">
					...
					<div class="IRS8865_LineDescLong" style="width:12mm;border-right-width:0px;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" alt="Special Allocation Made By Foreign Partnership No">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/SpclAllocnMadeByFrgnPrtshpInd"/>
									<xsl:with-param name="BackupName">IRS8865SpclAllocnMadeByFrgnPrtshpNoInd</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						<span style="font-weight:bold;">
          ...
          <span class="IRS8865_DotSpacing">....</span>
				...
				<div class="IRS8865_LineContainer">
					...
					<div class="IRS8865_LineDescLong" style="padding-top:6.5mm;width:12mm;border-right-width:0px;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" alt="Foreign Partnership Interest Under Separate Unit Yes">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/FrgnPrtshpInterestSepUnitInd"/>
									<xsl:with-param name="BackupName">IRS8865FrgnPrtshpInterestSepUnitYesInd</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						<span style="font-weight:bold;">
					...
					<div class="IRS8865_LineDescLong" style="width:12mm;border-right-width:0px; padding-top:6.5mm;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" alt="Foreign Partnership Interest Under Separate Unit No">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/FrgnPrtshpInterestSepUnitInd"/>
									<xsl:with-param name="BackupName">IRS8865FrgnPrtshpInterestSepUnitInd</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						<span style="font-weight:bold;">
				...
				<div class="IRS8865_LineContainer">
					...
					<div class="IRS8865_LineDescLong" style="padding-top:3.5mm;width:12mm;border-right-width:0px;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" alt="Dual Consolidated Loss Yes">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/SepCombSepDualCnsldtLossInd"/>
									<xsl:with-param name="BackupName">IRS8865SepCombSepDualCnsldtLossYesInd</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						<span style="font-weight:bold;">
					...
					<div class="IRS8865_LineDescLong" style="width:12mm;border-right-width:0px; padding-top:3.5mm;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" alt="Dual Consolidated Loss No">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/SepCombSepDualCnsldtLossInd"/>
									<xsl:with-param name="BackupName">IRS8865SepCombSepDualCnsldtLossNoInd</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						<span style="font-weight:bold;">
				...
				<div class="IRS8865_LineContainer">
					...
					<div class="IRS8865_LineDescLong" style="width:12mm;border-right-width:0px;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" alt="Total Receipts Or Assets Less Than Limit Yes">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/TotalRcptsAssetsLessThanLmtInd"/>
									<xsl:with-param name="BackupName">IRS8865TotalRcptsAssetsLessThanLmtYesInd</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						<span style="font-weight:bold;">
					...
					<div class="IRS8865_LineDescLong" style="width:12mm;border-right-width:0px;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" alt="Total Receipts Or Assets Less Than Limit No">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/TotalRcptsAssetsLessThanLmtInd"/>
									<xsl:with-param name="BackupName">IRS8865TotalRcptsAssetsLessThanLmtNoInd</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						<span style="font-weight:bold;">
				...
				<div class="pageEnd" style="width:187mm;padding-top:1mm;border-top:1px solid black;">
					...
					<div style="float:right;">
					  ...
					  Form <span class="styBoldText" style="font-size:8pt;">8865</span> (2022)
					</div>
				</div>
				...
				<div style="width:187mm;padding-top:.5mm;border-bottom:1px solid black;">
					<div style="float:left;">Form 8865 (2022)<span style="width:148mm;"/>
					</div>
				...
				<div class="IRS8865_LineContainer">
					...
					<div class="IRS8865_LineDescLong" style="height:10mm;width:146mm;border-right-width:0px;">
						Is the filer of this Form 8865 claiming a foreign-derived intangible income (FDII) deduction (under section 250) with respect to any transaction with the foreign partnership? <br/>If "Yes," complete lines 12b, 12c, and 12d. See instructions.
						<span style="width:1px;"/>
						<span style="width:0.2mm;"/><span class="IRS8865_DotSpacing">.......................</span>
						<img src="{$ImagePath}/8865_Bullet_Sm.gif" alt="Small Right Arrow" border="0"/>
					</div>
					<div class="IRS8865_LineDescLong" style="padding-top:5mm;width:12mm;border-right-width:0px;">
						<span>
							<xsl:call-template name="PopulateSpan">
								<xsl:with-param name="TargetNode" select="$FormData/FDIIBenefitsClaimInd"/>
							</xsl:call-template>
							<input type="checkbox" class="IRS8865_Checkbox" alt="FDII Benefits Claim Yes">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/FDIIBenefitsClaimInd"/>
									<xsl:with-param name="BackupName">IRS8865FDIIBenefitsClaimYesInd</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						<span style="font-weight:bold;">
					...
					<div class="IRS8865_LineDescLong" style="width:12mm;border-right-width:0px; padding-top:5mm;">
						<span>
							<xsl:call-template name="PopulateSpan">
								<xsl:with-param name="TargetNode" select="$FormData/FDIIBenefitsClaimInd"/>
							</xsl:call-template>
							<input type="checkbox" class="IRS8865_Checkbox" alt="FDII Benefits Claim No">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/FDIIBenefitsClaimInd"/>
									<xsl:with-param name="BackupName">IRS8865FDIIBenefitsClaimNoInd</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						<span style="font-weight:bold;">
				...
				<div class="IRS8865_LineContainer">
					...
					<div class="IRS8865_LineDescLong" style="height:7mm;width:146mm;border-right-width:0px;">
						Enter the amount of gross receipts derived from all sales of general property to the foreign partnership that the filer included in its
						computation of foreign-derived deduction eligible income (FDDEI).<span style="width:2mm;"/>
						<span class="IRS8865_DotSpacing">..............</span>
						<img src="{$ImagePath}/8865_Bullet_Sm.gif" alt="Small Right Arrow" border="0"/>
					</div>
				...
				<div class="IRS8865_LineContainer">
					...
					<div class="IRS8865_LineDescLong" style="height:7mm;width:146mm;border-right-width:0px;">
						Enter the amount of gross receipts derived from all sales of intangible property to the foreign
				...
				<div class="IRS8865_LineContainer">
					...
					<div class="IRS8865_LineDescLong" style="height:8mm;width:146mm;border-right-width:0px;">
						Enter the amount of gross receipts derived from all services provided to the foreign partnership
				...
				<div class="IRS8865_LineContainer">
					...
					<div class="IRS8865_LineDescLong" style="padding-top:2mm;width:12mm;border-right-width:0px;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" alt="Transfers Subject To Disclosure Requirements Yes">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/TransfersSubjectToDisclRqrInd"/>
									<xsl:with-param name="BackupName">IRS8865TransfersSubjectToDisclRqrYesInd</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						<span style="font-weight:bold;">
					...
					<div class="IRS8865_LineDescLong" style="width:12mm;border-right-width:0px; padding-top:2mm;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" alt="Transfers Subject To Disclosure Requirements No">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/TransfersSubjectToDisclRqrInd"/>
									<xsl:with-param name="BackupName">IRS8865TransfersSubjectToDisclRqrNoInd</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						<span style="font-weight:bold;">
								...
								<div class="styLNDesc" style="height:8mm;width:18mm;border-right:1px solid black;padding-top:.5mm;padding-bottom:0mm;padding-left:1mm;">
									<label>
										<xsl:call-template name="PopulateLabel">
											...
											<xsl:with-param name="BackupName">IRS8865PreparerPersonGrpSelfEmployedInd</xsl:with-param>
										</xsl:call-template>
										Check 
										<input class="styCkbox" type="checkbox" style="width:4mm;" alt="Self Employed">
											<xsl:call-template name="PopulateCheckbox">
												<xsl:with-param name="TargetNode" select="$RtnHdrData/PreparerPersonGrp/SelfEmployedInd"/>
												<xsl:with-param name="BackupName">IRS8865PreparerPersonGrpSelfEmployedInd</xsl:with-param>
											</xsl:call-template>
					...
					<div class="styBB" style="height:17mm;">
						...
						<div class="IRS8865_LineDescLong" style="font-size:8pt;padding-left:4px;border-right-width:0px;border-top-width:1px;width:167mm;">
							...
							<span style="width:92.5mm;padding-left:10px;padding-top:5px;font-size:7pt;">
								...
								<input type="checkbox" class="IRS8865_Checkbox" alt="Owns Direct Interest">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" select="$FormData/IRS8865ScheduleA/OwnsDirectInterestInd"/>
										<xsl:with-param name="BackupName">IRS8865ScheduleAOwnsDirectInterestInd</xsl:with-param>
									</xsl:call-template>
									<label>
										<xsl:call-template name="PopulateLabel">
											<xsl:with-param name="TargetNode" select="$FormData/IRS8865ScheduleA/OwnsDirectInterestInd"/>
							...
							<span style="width:59mm;padding-left:10px;padding-top:5px;font-size:7pt;">
								...
								<input type="checkbox" class="IRS8865_Checkbox" alt="Owns Constructive Interest">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" select="$FormData/IRS8865ScheduleA/OwnsConstructiveInterestInd"/>
										<xsl:with-param name="BackupName">IRS8865ScheduleAOwnsConstructiveInterestInd</xsl:with-param>
									</xsl:call-template>
									<label>
										<xsl:call-template name="PopulateLabel">
											<xsl:with-param name="TargetNode" select="$FormData/IRS8865ScheduleA/OwnsConstructiveInterestInd"/>
										...
										<span>
											<input type="checkbox" name="RelatedToUSTransferor" alt="Related To US Transferor">
												<xsl:call-template name="PopulateCheckbox">
													...
													<xsl:with-param name="BackupName">IRS8865RelatedUSTransferor<xsl:value-of select="position()"/></xsl:with-param>
												</xsl:call-template>
											</input>
										</span>
										<span style="font-weight:bold;">
				...
				<div class="IRS8865_LineContainer">
					...
					<div class="IRS8865_LineDescLong" style="width:12mm;border-right-width:0px;">
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" alt="Have Other Foreign Direct Partner Yes">
								<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/IRS8865ScheduleA1/HaveOtherForeignDirectPrtnrInd"/>
									<xsl:with-param name="BackupName">IRS8865ScheduleA1HaveOtherForeignDirectPrtnrYesInd</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						<span style="font-weight:bold;">
					...
					<div class="IRS8865_LineDescLong" style="width:12mm;border-right-width:0px;">
						...
						<span>
							...
							<input type="checkbox" class="IRS8865_Checkbox" alt="Have Other Foreign Direct Partner No">
								<xsl:call-template name="PopulateNoCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/IRS8865ScheduleA1/HaveOtherForeignDirectPrtnrInd"/>
									<xsl:with-param name="BackupName">IRS8865ScheduleA1HaveOtherForeignDirectPrtnrNoInd</xsl:with-param>
								</xsl:call-template>
							</input>
						</span>
						<span style="font-weight:bold;">
             ...
             Type <img src="{$ImagePath}/8865_Bullet_Sm.gif" alt="MidSizeBullet"/>
				...
				<!-- superimposed image -->
					<span style="z-index:1;position:absolute;padding-top:10mm;vertical-align: top;" >
						<img src="{$ImagePath}/8865_International.gif" alt="image displaying the word International Transactions" border="0" height="110mm" width="42mm"/>
  					</span>
				<!-- Schedule K line 16 -->	
								
				<div class="IRS8865_LineContainer">
					<div class="IRS8865_LabelSpaceWide" style="height:50mm;padding-top:20mm;border-bottom:1px solid black;"/>

					<div class="IRS8865_LineIndex" style="height:50mm;padding-top:20mm;padding-right:9px;border-bottom:1px solid black;">
					
					16</div>
					<div class="IRS8865_LineDescLongSchK" style="height:50mm;padding-top:20mm;width:134mm;border-right-width:1px;border-bottom:1px solid black;">
						...
						<span class="IRS8865_DotSpacing"> ............</span>
						<xsl:call-template name="SetFormLinkInline">
							<xsl:with-param name="TargetNode" select="$FormData/IRS8865ScheduleK/IntntlTaxRelevanceRptgInd"/>
						</xsl:call-template>
						<input type="checkbox" >
							<xsl:call-template name="PopulateCheckbox">
								<xsl:with-param name="TargetNode" select="$FormData/IRS8865ScheduleK/IntntlTaxRelevanceRptgInd"/>
            ...
            (Not required if Item H11, page 1, is answered "Yes.")
               ...
               (itemize):
                ...
                <xsl:call-template name="SetFormLinkInline">
							...
							<div class="IRS8865_MoneyFieldFull" style="height:13mm;border-bottom:0"/>
						</div>
                ...
                <span style="border-bottom:1px solid black; width:14.5mm"/>
							...
							<div class="IRS8865_MoneyFieldFull" style="padding-top:mm; border-top:0 solid black; border-bottom:0; height:7mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/IRS8865ScheduleM1/TotalExpensesNotDeductedAmt"/>
								</xsl:call-template>
							</div>
                ...
                <span class="IRS8865_DotSpacing">........</span>
					...
					<div style="float:left; width:93mm">
						<!-- Schedule M-1 line 6 -->
						<div class="IRS8865_M12LineContainer">
							<div class="IRS8865_LineIndex" style="padding-top:2mm;">6</div>
							<div class="IRS8865_LineDescLongSchM1" style="height:11.5mm;padding-top:2mm;">
               ...
               <xsl:call-template name="SetFormLinkInline">
                ...
                <span style="border-bottom:1px solid black; width:20.5mm"/>
							...
							<div class="IRS8865_MoneyFieldFull" style="height:7mm; padding-top:3mm; border-right:0; border-bottom:0;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/IRS8865ScheduleM1/TotIncmRecordedNotIncludedAmt"/>
								</xsl:call-template>
							</div>
						...
						<div style="float:left; width:93.5mm">
							<div class="IRS8865_M12LineContainer">
								<div class="IRS8865_LineIndex" style="padding-top:1mm;">7</div>
								<div class="IRS8865_LineDescLongSchM1" style="height:12mm;padding-top:1mm;">
...
income this tax year (itemize):
                 <xsl:call-template name="SetFormLinkInline">
								...
								<div class="IRS8865_MoneyFieldFull" style="border-right:0;border-top:1px solid black;border-bottom:0px solid black;"/>
							</div>
						</div>
						<!-- Schedule M-1 line 7a -->
						<div class="IRS8865_M12LineContainer">
							<div class="IRS8865_LineIndex" style="padding-right:2mm">a</div>
							<div class="IRS8865_LineDescLongSchM1" style="height:16mm">
								Depreciation $
								<span style="border-bottom:1px solid black; width:31.8mm; text-align:right;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/IRS8865ScheduleM1/DepreciationDeductionAmt"/>
									</xsl:call-template>
								</span>
								<br/>
							    <span style="border-bottom:1px solid black; height:3.5mm; width:51mm"/>
								<span style="border-bottom:1px solid black; height:3.5mm; width:51mm"/>
								<span style="border-bottom:1px solid black; height:3.5mm; width:51mm"/>
							</div>
								<!-- Schedule M-1 line 7 total -->
								<div class="IRS8865_MoneyFieldFull" style="border-top:0px solid black; padding-top:12mm;border-right:0;border-bottom:0;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/IRS8865ScheduleM1/TotalDeductionsNotChargedAmt"/>
									</xsl:call-template>
								</div>
          ...
          <span class="IRS8865_DotSpacing">.......</span>
							...
							<div class="IRS8865_MoneyFieldFull" style="height:6.5mm; padding-top:3.5mm; border-right:0;border-bottom:0;">
								<xsl:call-template name="PopulateAmount">
              ...
              <xsl:call-template name="SetFormLinkInline">
                ...
                <span class="IRS8865_DotSpacing">........</span>
						...
						<div class="IRS8865_TableContainer2" id="partM2Line7TPctn" style="">
							...
							<div class="IRS8865_MoneyFieldFull" style="height:16.25mm;padding-top:12.5mm;border-right:0; border-bottom:0;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/IRS8865ScheduleM2/TotalOtherDecreasesAmt"/>
								</xsl:call-template>
							</div>
