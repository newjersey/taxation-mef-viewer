...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:param name="DependencyData" select="$RtnDoc/SchK2K3OtherIntntlItemsStmt" />
		...
		<table id="INOLDTbl" class="styDepTbl" style="font-size:7pt;">
			<thead class="styTableThead">
				<tr class="styDepTblHdr">           
					<th class="styDepTblCell" scope="col" style="width:40mm;">Other International Item</th>
					<th class="styDepTblCell" scope="col" style="width:50mm;">Other International Item Amount</th>
					<th class="styDepTblCell" scope="col" style="width:80mm;">Other International Explanation</th>
				</tr>
			</thead>
			<tbody>
				<xsl:for-each select="$DependencyData/OtherInternationalItemsGrp">
					<tr>
						...
						<td class="styDepTblCell" style="text-align:left;">
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="OtherItemTypeDesc"/>
							</xsl:call-template>
						</td>
