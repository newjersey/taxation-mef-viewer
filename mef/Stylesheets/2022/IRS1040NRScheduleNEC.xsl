...
<!-- Last Modified by Ashleigh Smith on 03/02/2023 -->
				...
				<form id="Form1040NRScheduleNEC">
							...
							<div class="styTBB" style="height:20mm;
								...
								<div class="styFNBox" style="width:51mm;height:20mm;
									...
									<div style="height:6mm;padding-top:.1mm;">
										...
										<span class="styAgency" style="width:51mm;">Internal Revenue Service
					...
					<!-- Sch NEC Line 1 -->
						...
						<div class="styStdDivLS">
							...
							<div class="styLNAmountBox" style="height:7mm;border-bottom:none;background-color:lightgrey;"/>
							<div class="styLNAmountBox" style="height:7mm;border-bottom:none;background-color:white;"/>
							<div class="styLNAmountBox" style="height:7mm;border-bottom:none;background-color:white;"/>
							<div class="styLNAmountBox" style="height:7mm;border-bottom:none;background-color:lightgrey;"/>
						</div>
						<!-- Sch NEC Line 10a -->
						<div class="styStdDivLS">
							...
							<div class="styLNAmountBox" style="border-bottom:none;background-color:lightgrey;"/>
							<div class="styLNAmountBox" style="border-bottom:none;background-color:white;"/>
							<div class="styLNAmountBox" style="border-bottom:none;background-color:white;"/>
							<div class="styLNAmountBox" style="border-bottom:none;background-color:lightgrey;"/>
						</div>
						...
						<div class="styStdDivLS">
							...
							<div class="styLNAmountBox" style="background-color:white;">
								<xsl:call-template name="PopulateAmount">
						...
						<div class="styStdDivLS">
							...
							<div class="styLNRightNumBoxNBB"/>
							<div class="styLNAmountBoxNBB" style="background-color:white;"/>
										...
										<thead class="styTableThead">
											<tr>
												...
												<th class="styTableCellHeader" scope="col" style="width:20mm;font-weight:normal;">
													<strong>(b)</strong> Date <br/> acquired <br/> mm/dd/yyyy
											</th>
												<th class="styTableCellHeader" scope="col" style="width:20mm;font-weight:normal;">
													<strong>(c)</strong> Date <br/> sold <br/> mm/dd/yyyy
											</th>
