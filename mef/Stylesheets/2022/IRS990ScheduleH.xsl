...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
        ...
        <form name="IRS990ScheduleH">
          ...
          <div style="width:187mm">
            ...
            <div class="styLNDesc" style="width:155mm;height:4mm;padding-top:0mm;font-size:7pt;">
              <span class="styNormalText">
                If "Yes," indicate which of the following was the FPG family income limit for eligibility for free care: <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;"/>
              </span>
            </div>
          ...
          <div style="width:187mm;">
            ...
            <span style="font-weight:bold;font-size:6.25pt;">Schedule H (Form 990) 2022</span>
          </div><div class="pageEnd" />
          
          <!-- PAGE2HEADER  -->
          <div style="display:block;">
          <div class="styBB" style="width:187mm; padding-bottom:.5mm;display:block;">
            <div style="float:left;">Schedule H (Form 990) 2022</div>
          ...
          <div class="styBB" style="width:187mm;height:4mm;border-top-width:1px;vertical-align:bottom;">
            ...
            <table class="styTable" cellspacing="0" name="TYTable" id="TYTable" style="height:auto;display:block;">
              <thead class="styTableThead">
                <tr style="height:5mm;">
                  <th class="styTableCellHeader" style="height:16mm;width:50mm;padding-top:1mm;border-color:black;font-weight:normal;text-align:center;vertical-align:top;" scope="col">
                      ...
                      <xsl:for-each select="$Form990ScheduleHData/ManagementCoAndJntVenturesGrp">
                        <tr>
                          <td class="styTableCell" style="height:16mm;width:50mm;vertical-align:top;text-align:left;border-color:black;float:left;clear:none;">
                            ...
                            <span style="padding-left:1mm;display:inline;">
          ...
          <div style="width:187mm;padding-top:0mm;border-top:1px solid black;">
            ...
            <div style="float:right;">
              ...
              <span class="styBoldText" style="font-weight:bold;font-size:6.25pt;">Schedule H (Form 990) 2022</span>
            </div>
          </div>
          <div class="pageEnd" />
          ...
          <!-- BEGIN Part V Table -->
		<div class="styTableContainer" id="PartVctn" style="width:187mm;display:block;">
            <xsl:call-template name="SetInitialState"/>
            <!-- end -->
            
            <table border="0" cellspacing="0" cellpadding="0" style="height:auto;width:187mm;font-size:7pt;display:block;">
                <tr>
                  <th class="styTableCellHeader" colspan="2" scope="col" style="height:44mm;text-align:left;vertical-align:top;padding-top:2mm;width:74mm;border-bottom-width:1px; border-style:solid;border-color:black;border-right-width:0px;font-size:8pt;padding-bottom:1mm;display:inline;float:left;clear:none;">
                    ...
                    <span style="width:68mm;height:6mm;font-weight:normal;">(list in order of size from largest to smallest—see instructions)</span>
                    <span style="width:68mm;height:6mm;padding-top:2mm;font-weight:normal;">How many hospital facilities did the organization operate during the tax year?</span>
                    ...
                    <span style="width:68mm;padding-top:2mm;font-weight:normal;">Name, address, primary website address, and state license number (and if a group return, the name and EIN of the subordinate hospital organization that operates the hospital facility)</span>
                  </th>
                  ...
                  <th class="styTableCellHeader" style="height:44mm;width:34mm;font-weight:normal;border-bottom-width:1px; border-style:solid;border-color:black; border-right-width:1px;padding-top:37.5mm;padding-left:1mm;font-size:7pt;float:left;clear:none;" scope="col">
					Other (describe)
                  </th>
                  <th class="styTableCellHeader" style="height:44mm;width:23mm;font-weight:normal;border-bottom-width:1px; border-style:solid;border-color:black; border-right-width:0px;padding-top:34.5mm;padding-left:1mm;font-size:7pt;float:left;clear:none;" scope="col">
                ...
                <xsl:for-each select="$Form990ScheduleHData/HospitalFacilitiesGrp">
                  ...
                  <xsl:if test="($Print != $Separated)">
                    <tr>
                      ...
                      <td class="styTableCellText" style="height:57mm;width:62mm;padding-bottom:2mm;padding-left:1mm;border-bottom-width:1px;border-right-width:0px;border-color:black;float:left;clear:none;display:inline;">
                ...
                <xsl:if test="count($Form990ScheduleHData/HospitalFacilitiesGrp) &lt; 1 or ($Print = $Separated)">
                  <tr>
                    ...
                    <td class="styTableCellText" style="height:8mm;width:62mm;border-bottom-width:1px;border-right-width:0px;border-color:black;float:left;clear:none;float:left;clear:none;display:inline;">
          ...
          <div style="width:187mm;float:none;clear:both;padding-top:.5mm;" >
            ...
            <div style="width:58mm;font-size:6pt;text-align:right;padding-top:1mm;float:right;font-weight:bold;">Schedule H (Form 990) 2022</div>
          </div>
          <div class="pageEnd" />
          ...
          <xsl:if test="count($Form990ScheduleHData/HospitalFcltyPoliciesPrctcGrp) &lt; 1">
            ...
            <div style="width: 187mm;border-top-width:1px;">
              <div class="styLNDesc" style="width:187mm;height:4mm;padding-top:0mm;padding-bottom:0mm;font-size:8pt;font-weight:bold;border-style:solid;border-color:black;border-top-width:1px;border-left-width:0px;border-right-width:0px;border-bottom-width:0px;">
              ...
              <div class="styLNDesc" style="width: 187mm;padding-top:0mm;font-size:8pt;font-weight:bold;border-top:1px solid black;">Section  B. Facility Policies and Practices</div><br/>
			...
			<table border="0" cellspacing="0" cellpadding="0" style="width:171mm;font-size:7pt;">			
             ...
             <table border="0" cellspacing="0" cellpadding="0" style="width:187mm;font-size:7pt;">
              <tbody>
                ...
                <tr>
                  <td class="IRS990ScheduleH_LineIndexMid" colspan="2" style="width:165mm;height:4mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:0px;border-right-width:0px;border-top-width:1px;text-align:left;font-size:7pt;font-weight:bold;">
                    Community Health Needs Assessment 
                  </td>
                  <td class="styShadingCell" style="width:6mm;height:4mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:1px;border-right-width:0px;border-top-width:1px;font-size:7pt;font-weight:bold;">
                    <span style="width:5mm;"/>
                  </td>
                ...
                <tr>
                  ...
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:6mm;height:7.5mm;padding-top:4mm;border-bottom-width:0px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-size:7pt;font-weight:bold;text-align:center;vertical-align:bottom;vertical-align:bottom;">
                    1
                  </td>
                ...
                <tr>
                  ...
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:6mm;height:7.5mm;padding-top:4mm;border-bottom-width:0px;border-left-width:1px;border-right-width:0px;border-top-width:1px;font-size:7pt;font-weight:bold;text-align:center;vertical-align:bottom;vertical-align:bottom;">
                    2
                  </td>
                ...
                <tr>
                  ...
                  <td class="styShadingCell" style="width:6mm;height:4mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-size:7pt;font-weight:bold;">
                    <span style="width:5mm;"/>
                  </td>
                ...
                <tr>
                  ...
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:159mm;height:6mm;padding-top:.75mm;border-bottom-width:0px;border-left-width:0px;border-right-width:0px;border-top-width:0px;text-align:left;font-size:7pt;font-weight:normal;">
                  ...
                  <td class="styShadingCell" style="width:6mm;height:6mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-size:7pt;font-weight:bold;">
                    <span style="width:5mm;"/>
                  </td>
                ...
                <tr>
                  ...
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:159mm;height:4mm;padding-top:.5mm;border-bottom-width:0px;border-left-width:0px;border-right-width:0px;border-top-width:0px;text-align:left;font-size:7pt;font-weight:normal;">
                    <table cellspacing="0" cellpadding="0" style="font-size:7pt;">
						<tr>
							<td style="text-align:left;vertical-align:top;">
								<input type="checkbox" class="IRS990ScheduleH_Checkbox" style="height:3mm;width:3mm;">
                ...
                <tr>
                  ...
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:159mm;height:4mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:0px;border-right-width:0px;border-top-width:0px;text-align:left;font-size:7pt;font-weight:normal;">
                    <input type="checkbox" class="IRS990ScheduleH_Checkbox" style="height:3mm;width:3mm;">
                      <xsl:call-template name="PopulateCheckbox">
                        <xsl:with-param name="TargetNode" select="PriorCHNAImpactInd"/>
						<xsl:with-param name="BackupName">Form990ScheduleHPriorCHNAImpactInd</xsl:with-param>
                      </xsl:call-template>
                    </input>
					<label>
					  <xsl:call-template name="PopulateLabel">
                ...
                <tr>
                  ...
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:159mm;height:13mm;padding-top:0.25mm;border-bottom-width:0px;border-left-width:0px;border-right-width:0px;border-top-width:0px;text-align:left;font-size:7pt;font-weight:normal;">
                  ...
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:6mm;height:13mm;padding-top:9.5mm;border-bottom-width:1px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-size:7pt;font-weight:bold;text-align:center;vertical-align:bottom;vertical-align:bottom;">
                    5
                  </td>
                ...
                <tr>
                  ...
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:159mm;height:7mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:0px;border-right-width:0px;border-top-width:0px;text-align:left;font-size:7pt;font-weight:normal;">
                  ...
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:6mm;height:7mm;padding-top:3mm;border-bottom-width:1px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-size:7pt;font-weight:bold;text-align:center;vertical-align:bottom;vertical-align:bottom;">
                    6a
                  </td>
                ...
                <tr>
                  ...
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:6mm;height:4mm;padding-top:.25mm;border-bottom-width:1px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-size:7pt;font-weight:bold;text-align:center;vertical-align:bottom;vertical-align:bottom;">
                    7
                  </td>
                ...
                <tr>
                  ...
                  <td class="styShadingCell" style="width:6mm;height:6.5mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-size:7pt;font-weight:bold;">
                    <span style="width:5mm;"/>
                  </td>
                ...
                <tr>
                  ...
                  <td class="styShadingCell" style="width:6mm;height:7mm;padding-top:3mm;border-bottom-width:0px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-size:7pt;font-weight:bold;">
                    <span style="width:5mm;"/>
                  </td>
                ...
                <tr>
                  ...
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:6mm;height:7mm;padding-left:0mm;padding-top:3mm;border-bottom-width:1px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-size:7pt;font-weight:bold;text-align:center;vertical-align:bottom;vertical-align:bottom;">
                    12a
                  </td>
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:8mm;height:7mm;padding-top:3mm;border-bottom-width:1px;border-left-width:1px;border-right-width:0px;border-top-width:0px;text-align:center;vertical-align:bottom;font-size:7pt;font-weight:normal;">
                    <span>
                ...
                <tr>
                  ...
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:159mm;height:7.5mm;padding-top:.25mm;border-bottom-width:1px;border-left-width:0px;border-right-width:0px;border-top-width:0px;text-align:left;font-size:7pt;font-weight:normal;">
                  ...
                  <td class="styShadingCell" style="width:6mm;height:7.5mm;padding-top:.25mm;border-bottom-width:1px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-size:7pt;font-weight:bold;">
                    <span style="width:5mm;"/>
                  </td>
            ...
            <div style="width:187mm;float:none;clear:both;padding-top:.5mm;">
              ...
              <div style="width:58mm;font-size:6pt;text-align:right;float:right;font-weight:bold;">Schedule H (Form 990) 2022</div>
            </div>
            <div class="pageEnd" />
            ...
            <table border="0" cellspacing="0" cellpadding="0" style="height:auto;width:187mm;font-size:7pt;">
              <tbody>
                ...
                <tr>
                  <td class="IRS990ScheduleH_LineIndexMid" colspan="5" style="width:187mm;height:7.8mm;border-bottom-width:0px;border-left-width:0px;border-right-width:0px;border-top-width:0px;text-align:left;padding-left:1mm;font-size:7pt;font-weight:bold;">
                    <table border="0" cellspacing="0" cellpadding="0" style="height:auto;width:187mm;font-size:7pt;">
						<tr >
							<td style="height:4mm;width:85mm;">
								<span style="width:1mm;"/>
							</td>
							<td style="height:4mm;width:101mm;">
								<span style="width:101mm;font-weight:normal;">
								  <xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="HospitalFacilityName/BusinessNameLine1Txt"/>
								  </xsl:call-template>
								</span>
						...
						<tr>
							...
							<td style="height:4mm;width:101mm;">
								<span class="styIRS990ScheduleHUnderlinedText" style="width:101mm;font-weight:normal;">
									<xsl:call-template name="PopulateText">
									  <xsl:with-param name="TargetNode" select="HospitalFacilityName/BusinessNameLine2Txt"/>
									</xsl:call-template>
								  </span>
                ...
                <tr>
                  <td class="IRS990ScheduleH_LineIndexMid" colspan="2" style="width:165mm;height:4mm;padding-bottom:.25mm;border-bottom-width:0;border-left-width:0px;border-right-width:0px;border-top-width:0px;text-align:left;padding-left:1mm;font-size:7pt;font-weight:bold;">
                    <span style="width:160mm;" />
                  </td>
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:6mm;height:4mm;padding-top:.25mm;border-bottom-width:1px;border-left-width:0px;border-right-width:0px;border-top-width:0px;font-size:7pt;font-weight:bold;">
                    <span style="width:5mm;"/>
                  </td>
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:8mm;height:4mm;padding-top:.25mm;border-bottom-width:1px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-size:7pt;font-weight:bold;text-align:bottom;">
                    Yes
                  </td>
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:8mm;height:4mm;padding-top:.25mm;border-bottom-width:1px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-size:7pt;font-weight:bold;text-align:bottom;">
                    No
                ...
                <tr>
                  ...
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:6mm;height:4mm;padding-top:.25mm;border-bottom-width:1px;border-left-width:1px;border-right-width:0px;border-top-width:0px;text-align:center;vertical-align:bottom;font-size:7pt;font-weight:bold;">
                    13
                  </td>
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:8mm;height:4mm;padding-top:.25mm;border-bottom-width:1px;border-left-width:1px;border-right-width:0px;border-top-width:0px;text-align:center;vertical-align:bottom;font-size:7pt;font-weight:normal;">
                    <span>
                ...
                <tr>
                  ...
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:159mm;height:7mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:0px;border-right-width:0px;border-top-width:0px;text-align:left;font-weight:normal;">
					...
					<label>
                      ...
                      <span class="styIRS990ScheduleHUnderlinedText" style="width:36mm;">
						...
						<span style="width:6mm;"/>and FPG family income limit for eligibility for discounted care of 
						<span class="styIRS990ScheduleHUnderlinedText" style="width:36mm;">
						  <xsl:call-template name="PopulateText">
                  ...
                  <td class="styShadingCell" style="width:6mm;height:7mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-size:7pt;font-weight:bold;">
                    <span style="width:5mm;"/>
                  </td>
                ...
                <tr>
                  ...
                  <td class="styShadingCell" style="width:6mm;height:4.5mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-size:7pt;font-weight:bold;">
                    <span style="width:5mm;"/>
                  </td>
                ...
                <tr>
                  ...
                  <td class="styShadingCell" style="width:6mm;height:7mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-weight:bold;">
                    <span style="width:5mm;"/>
                  </td>
                  <td class="styShadingCell" style="width:8mm;height:7mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-weight:bold;">
                    <span style="width:5mm;"/>
                ...
                <tr>
                  ...
                  <td class="styShadingCell" style="width:6mm;height:4mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-weight:bold;">
                    <span style="width:5mm;"/>
                  </td>
                  <td class="styShadingCell" style="width:8mm;height:4mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-weight:bold;">
                    <span style="width:5mm;"/>
                ...
                <tr>
                  ...
                  <td class="styShadingCell" style="width:6mm;height:5mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-weight:bold;">
                    <span style="width:5mm;"/>
                  </td>
                ...
                <tr>
                  ...
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:159mm;height:4mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:0px;border-right-width:0px;border-top-width:0px;text-align:left;font-weight:normal;">
                    Was widely publicized within the community served by the hospital facility?<span style="width:2mm;"/>
                    <span class="styDotLn" style="float:none">........</span>
                  </td>
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:6mm;height:4mm;padding-top:.25mm;border-bottom-width:1px;border-left-width:1px;border-right-width:0px;border-top-width:0px;text-align:center;vertical-align:bottom;font-size:7pt;font-weight:bold;">
                    16
                ...
                <tr>
                  ...
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:159mm;height:6mm;padding-top:1mm;border-bottom-width:0px;border-left-width:0px;border-right-width:0px;border-top-width:0px;text-align:left;font-weight:normal;">
                    <span style="width:5mm;"/>
                  ...
                  <td class="styShadingCell" style="width:6mm;height:6mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-weight:bold;">
                    <span style="width:5mm;"/>
                  </td>
                ...
                <tr>
                  ...
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:159mm;height:5.5mm;padding-top:1mm;border-bottom-width:0px;border-left-width:0px;border-right-width:0px;border-top-width:0px;text-align:left;font-weight:normal;">
                    <span style="width:5mm;"/>
                    <span class="styIRS990ScheduleHUnderlinedText" style="width:150mm;">
						  <xsl:call-template name="PopulateText">
                  ...
                  <td class="styShadingCell" style="width:6mm;height:5.5mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-weight:bold;">
                    <span style="width:5mm;"/>
                  </td>
                ...
                <tr>
                  ...
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:159mm;height:7.5mm;border-bottom-width:0px;border-left-width:0px;border-right-width:0px;border-top-width:0px;text-align:left;font-weight:normal;">
                    <input type="checkbox" class="IRS990ScheduleH_Checkbox" style="height:3mm;width:3mm;">
                      <xsl:call-template name="PopulateCheckbox">
                  ...
                  <td class="styShadingCell" style="width:6mm;height:7.5mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-weight:bold;">
                    <span style="width:5mm;"/>
                  </td>
                ...
                <tr>
                  ...
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:159mm;height:7mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:0px;border-right-width:0px;border-top-width:0px;text-align:left;font-weight:normal;">
					...
					<label>
                      ...
                      <br/><span style="width:6mm;"/>hospital facility and by mail)
					</label>
                  </td>
                  <td class="styShadingCell" style="width:6mm;height:7mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-weight:bold;">
                    <span style="width:5mm;"/>
                ...
                <tr>
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:6mm;height:10mm;padding-top:1mm;border-bottom-width:0px;border-left-width:0px;border-right-width:0px;border-top-width:0px;text-align:right;font-weight:bold;">
                    g
                  </td>
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:159mm;height:10mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:0px;border-right-width:0px;border-top-width:0px;text-align:left;font-weight:normal;">
                    <input type="checkbox" class="IRS990ScheduleH_Checkbox" style="height:3mm;width:3mm;">
                      <xsl:call-template name="PopulateCheckbox">
                        <xsl:with-param name="TargetNode" select="NotifiedFAPCopyBillDisplayInd"/>
						<xsl:with-param name="BackupName">Form990ScheduleHNotifiedFAPCopyBillDisplayInd</xsl:with-param>
                      </xsl:call-template>
                    </input>
					<label>
					  <xsl:call-template name="PopulateLabel">
                      ...
                      <br/><span style="width:6mm;"/>receiving a conspicuous written notice about the FAP on their billing statements, and via conspicuous public displays or 
                      <br/><span style="width:6mm;"/>other measures reasonably calculated to attract patients' attention
					</label>
                  </td>
                  <td class="styShadingCell" style="width:6mm;height:10mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-weight:bold;">
                    <span style="width:5mm;"/>
                  </td>
                  <td class="styShadingCell" style="width:8mm;height:10mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-weight:bold;">
                    <span style="width:5mm;"/>
                  </td>
                  <td class="styShadingCell" style="width:8mm;height:10mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-weight:bold;">
                    <span style="width:5mm;"/>
                ...
                <tr>
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:6mm;height:7mm;padding-top:1mm;border-bottom-width:0px;border-left-width:0px;border-right-width:0px;border-top-width:0px;text-align:right;font-weight:bold;">
                    i
                  </td>
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:159mm;height:7mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:0px;border-right-width:0px;border-top-width:0px;text-align:left;font-weight:normal;">
                    <input type="checkbox" class="IRS990ScheduleH_Checkbox" style="height:3mm;width:3mm;">
                      <xsl:call-template name="PopulateCheckbox">
                        <xsl:with-param name="TargetNode" select="FAPTranslatedInd"/>
						<xsl:with-param name="BackupName">Form990ScheduleHFAPTranslatedInd</xsl:with-param>
                      </xsl:call-template>
                    </input>
					<label>
					  <xsl:call-template name="PopulateLabel">
                      ...
                      <br/><span style="width:6mm;"/>spoken by LEP populations
					</label>
                  </td>
                  <td class="styShadingCell" style="width:6mm;height:7mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-weight:bold;">
                    <span style="width:5mm;"/>
            ...
            <table border="0" cellspacing="0" cellpadding="0" style="height:auto;width:187mm;font-size:7pt;">
              <tbody>
                ...
                <tr>
                  <td class="IRS990ScheduleH_LineIndexMid" colspan="5" style="width:187mm;height:7.8mm;border-bottom-width:0px;border-left-width:0px;border-right-width:0px;border-top-width:0px;text-align:left;padding-left:1mm;font-size:7pt;font-weight:bold;">
                    <table border="0" cellspacing="0" cellpadding="0" style="height:auto;width:187mm;font-size:7pt;">
						...
						<tr>
							<td style="height:5mm;width:85mm;">
								<span style="font-weight:bold;">Name of hospital facility or letter of facility reporting group</span>
							</td>
							<td style="height:5mm;width:101mm;">
								<span class="styIRS990ScheduleHUnderlinedText" style="width:101mm;font-weight:normal;">
									<xsl:call-template name="PopulateText">
									  <xsl:with-param name="TargetNode" select="HospitalFacilityName/BusinessNameLine2Txt"/>
									</xsl:call-template>
                ...
                <tr>
                  <td class="IRS990ScheduleH_LineIndexMid" colspan="2" style="width:165mm;height:4mm;padding-bottom:.25mm;border-bottom-width:0px;border-left-width:0px;border-right-width:0px;border-top-width:0px;text-align:left;padding-left:1mm;font-size:7pt;font-weight:bold;">
                    <span style="width:160mm;"/>
                  </td>
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:6mm;height:4mm;padding-top:.25mm;border-bottom-width:1px;border-left-width:0px;border-right-width:0px;border-top-width:0px;font-size:7pt;font-weight:bold;">
                    <span style="width:5mm;"/>
                  </td>
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:8mm;height:4mm;padding-top:.5mm;border-bottom-width:1px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-size:7pt;font-weight:bold;text-align:bottom;">
                    Yes
                  </td>
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:8mm;height:4mm;padding-top:.5mm;border-bottom-width:1px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-size:7pt;font-weight:bold;text-align:bottom;">
                    No
                ...
                <tr>
                  ...
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:159mm;height:10mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:0px;border-right-width:0px;border-top-width:0px;text-align:left;font-weight:normal;">
                    ...
                    assistance policy (FAP) that explained all of the actions the hospital facility or other authorized party may take upon nonpayment?<span style="width:2mm;"/>
                    <span class="styDotLn" style="float:none">..................................</span>
                  </td>
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:6mm;height:10mm;padding-top:6.5mm;border-bottom-width:1px;border-left-width:1px;border-right-width:0px;border-top-width:0px;text-align:center;vertical-align:bottom;font-size:7pt;font-weight:bold;">
                    17
                  </td>
                ...
                <tr>
                  ...
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:159mm;height:7mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:0px;border-right-width:0px;border-top-width:0px;text-align:left;font-weight:normal;">
					...
					<label>
                      ...
                      <br/><span style="width:6mm;"/>bill for care covered under the hospital facility's FAP
					</label>
                  </td>
                  <td class="styShadingCell" style="width:6mm;height:7mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-weight:bold;">
                    <span style="width:5mm;"/>
                ...
                <tr>
                  ...
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:159mm;height:7mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:0px;border-right-width:0px;border-top-width:0px;text-align:left;font-weight:normal;">
                    ...
                    the facility’s FAP?<span style="width:3mm;"/>
                    <span class="styDotLn" style="float:none">............</span>
                  </td>
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:6mm;height:7mm;padding-top:3mm;border-bottom-width:1px;border-left-width:1px;border-right-width:0px;border-top-width:0px;text-align:center;vertical-align:bottom;font-size:7pt;font-weight:bold;">
                    19
                  </td>
                ...
                <tr>
                  ...
                  <td class="styShadingCell" style="width:6mm;height:6.5mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-weight:bold;">
                    <span style="width:5mm;"/>
                  </td>
                  <td class="styShadingCell" style="width:8mm;height:6.5mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-size:7pt;font-weight:bold;">
                    <span style="width:5mm;"/>
                ...
                <tr>
                  ...
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:159mm;height:7mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:0px;border-right-width:0px;border-top-width:0px;text-align:left;font-weight:normal;">
                    <input type="checkbox" class="IRS990ScheduleH_Checkbox" style="height:3mm;width:3mm;">
                      <xsl:call-template name="PopulateCheckbox">
                        <xsl:with-param name="TargetNode" select="ProvidedWrittenNoticeInd"/>
						<xsl:with-param name="BackupName">Form990ScheduleHProvidedWrittenNoticeInd</xsl:with-param>
                      </xsl:call-template>
                    </input>
					<label>
					  <xsl:call-template name="PopulateLabel">
                      ...
                      <br/><span style="width:6mm;"/>FAP at least 30 days before initiating those ECAs (if not, describe in Section C)
					</label>
                  </td>
                  <td class="styShadingCell" style="width:6mm;height:7mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-weight:bold;">
                    <span style="width:5mm;"/>
                ...
                <tr>
                  ...
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:159mm;height:4mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:0px;border-right-width:0px;border-top-width:0px;text-align:left;font-weight:normal;">
                    <input type="checkbox" class="IRS990ScheduleH_Checkbox" style="height:3mm;width:3mm;">
                      <xsl:call-template name="PopulateCheckbox">
                        <xsl:with-param name="TargetNode" select="MadeEffortOrallyNotifyInd"/>
						<xsl:with-param name="BackupName">Form990ScheduleHMadeEffortOrallyNotifyInd</xsl:with-param>
                      </xsl:call-template>
                    </input>
					<label>
					  <xsl:call-template name="PopulateLabel">
                      ...
                      Made a reasonable effort to orally notify individuals about the FAP and FAP application process (if not, describe in <br/>
						<span style="width:6mm;"/>Section C)
					</label>
                  </td>
                  <td class="styShadingCell" style="width:6mm;height:4mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-weight:bold;">
                    <span style="width:5mm;"/>
                ...
                <tr>
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:6mm;height:4mm;padding-top:1mm;border-bottom-width:0px;border-left-width:0px;border-right-width:0px;border-top-width:0px;text-align:right;vertical-align:top;font-weight:bold;">
                    c
                  </td>
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:159mm;height:4mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:0px;border-right-width:0px;border-top-width:0px;text-align:left;font-weight:normal;">
                    <input type="checkbox" class="IRS990ScheduleH_Checkbox" style="height:3mm;width:3mm;">
                      <xsl:call-template name="PopulateCheckbox">
                        <xsl:with-param name="TargetNode" select="ProcessedFAPApplicationInd"/>
						<xsl:with-param name="BackupName">Form990ScheduleHProcessedFAPApplicationInd</xsl:with-param>
                      </xsl:call-template>
                    </input>
					<label>
					  <xsl:call-template name="PopulateLabel">
                ...
                <tr>
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:6mm;height:4mm;padding-top:1.5mm;border-bottom-width:0px;border-left-width:0px;border-right-width:0px;border-top-width:0px;text-align:right;vertical-align:top;font-weight:bold;">
                    d
                  </td>
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:159mm;height:4mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:0px;border-right-width:0px;border-top-width:0px;text-align:left;font-weight:normal;">
                    <table cellspacing="0" cellpadding="0" style="font-size:7pt;">
						<tr>
							<td style="text-align:left;vertical-align:top;">
								<input type="checkbox" class="IRS990ScheduleH_Checkbox" style="height:3mm;width:3mm;">
								  <xsl:call-template name="PopulateCheckbox">
									<xsl:with-param name="TargetNode" select="MadePresumptiveEligDetermInd"/>
									<xsl:with-param name="BackupName">Form990ScheduleHMadePresumptiveEligDetermInd</xsl:with-param>
								  </xsl:call-template>
								</input>							
							</td>
							<td style="padding-left:0.5mm;padding-top:1mm;">
              ...
              <tbody>
                    ...
                    <table cellspacing="0" cellpadding="0" style="font-size:7pt;">
						<tr>
							<td style="text-align:left;vertical-align:top;"> 
								<input type="checkbox" class="IRS990ScheduleH_Checkbox" style="height:3mm;width:3mm;">
								  <xsl:call-template name="PopulateCheckbox">
									<xsl:with-param name="TargetNode" select="LookBackMedicareInd"/>
									<xsl:with-param name="BackupName">Form990ScheduleHLookBackMedicareInd</xsl:with-param>
								  </xsl:call-template>
								</input>					
							</td>
                    ...
                    <table cellspacing="0" cellpadding="0" style="font-size:7pt;">
						<tr>
							<td style="text-align:left;vertical-align:top;"> 
								<input type="checkbox" class="IRS990ScheduleH_Checkbox" style="height:3mm;width:3mm;">
								  <xsl:call-template name="PopulateCheckbox">
									<xsl:with-param name="TargetNode" select="LookBackMedicarePrivateInd"/>
									<xsl:with-param name="BackupName">Form990ScheduleHLookBackMedicarePrivateInd</xsl:with-param>
								  </xsl:call-template>
								</input>				
							</td>
							<td style="padding-left:0.5mm;padding-top:1mm;">
                ...
                <tr>
                  ...
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:159mm;height:10mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:0px;border-right-width:0px;border-top-width:0px;text-align:left;font-weight:normal;">
                    <input type="checkbox" class="IRS990ScheduleH_Checkbox" style="height:3mm;width:3mm;">
                      <xsl:call-template name="PopulateCheckbox">
                        <xsl:with-param name="TargetNode" select="LookBackMedicaidMedcrPrvtInd"/>
						<xsl:with-param name="BackupName">Form990ScheduleHLookBackMedicaidMedcrPrvtInd</xsl:with-param>
                      </xsl:call-template>
                    </input>
					<label>
					  <xsl:call-template name="PopulateLabel">
					  ...
					  <br/><span style="width:6mm;"/>Medicare fee-for-service and all private health insurers that pay claims to the hospital facility during a prior 12-month 
					  <br/><span style="width:6mm;"/>period
					</label>
                  </td>
                  <td class="styShadingCell" style="width:6mm;height:10mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:1px;border-right-width:0px;border-top-width:0px;font-weight:bold;">
                    <span style="width:5mm;"/>
                ...
                <tr>
                  ...
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:159mm;height:5mm;padding-top:.25mm;border-bottom-width:0px;border-left-width:0px;border-right-width:0px;border-top-width:0px;text-align:left;font-weight:normal;">
                    <input type="checkbox" class="IRS990ScheduleH_Checkbox" style="height:3mm;width:3mm;">
                      <xsl:call-template name="PopulateCheckbox">
                        <xsl:with-param name="TargetNode" select="ProspectiveMedicareMedicaidInd"/>
						<xsl:with-param name="BackupName">Form990ScheduleHProspectiveMedicareMedicaidInd</xsl:with-param>
                      </xsl:call-template>
                    </input>
					<label>
					  <xsl:call-template name="PopulateLabel">
                ...
                <tr>
                  ...
                  <td class="IRS990ScheduleH_LineIndexMid" style="width:6mm;height:4mm;padding-top:.25mm;border-bottom-width:1px;border-left-width:0px;border-right-width:0px;border-top-width:0px;text-align:center;vertical-align:bottom;font-size:7pt;font-weight:bold;">
                    <span style="width:5mm;"/>
                  </td>
          ...
          <table border="0" cellspacing="0" cellpadding="0" style="width:182mm;font-size:7pt;clear:both;">
              ...
              <tbody>
				...
				<!-- Render out the rest of the empty rows if less than $RowsToShow data items present for consistency with PDF display. -->
                  ...
                  <xsl:if test="($Print = $Separated) and (count($Form990ScheduleHData/SupplementalInformationGrp) &gt; 19) ">
                    <xsl:call-template name="EmptyIteratorTemp">
          ...
          <div class="styBB" style="width:187mm; padding-bottom:.5mm;">
            <div style="float:left;">Schedule H (Form 990) 2022</div>
            <div style="float:right;">Page 
              <span style="font-weight:bold;font-size:8pt;">10
                <!--<script language="JavaScript" type="text/javascript">
                  nextPage();
                </script>-->
              </span>
  ...
  <xsl:template name="IRS990SchHPartVTableFillerRow">
    <tr>
      ...
      <td class="styTableCellText" style="width:62mm;height:8mm;border-bottom-width:1px;border-right-width:0px;border-color:black;float:left;clear:none;float:left;clear:none;display:inline;">
        <span style="width:1px"/>
      </td>
