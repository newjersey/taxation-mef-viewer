...
<body class="styBodyClass" style="width:187mm;">
  <form name="Form1040ScheduleC">
    ...
    <!-- Begin Form Number and Name -->
     <!-- put comment here -->
    <div class="styBB" style="width:187mm;height:21mm;float:none;clear:both;">
	<div class="styFNBox" style="width:31mm;height:21mm;">
		<div style="padding-top:1mm;line-height:150%;">                  
			...
			<br/>
			<span class="styFormNumber" style="font-size:9pt;padding-top:.5mm;">(Form 1040)</span>
			<br/>
		</div>
	...
	<div class="styFTBox" style="width:127mm;height:21mm;">
		...
		<div class="styFBT" style="height:3mm;margin-top:1mm;font:size:6pt;width:127mm;">
			 Go to <i><a href="http://www.irs.gov/schedulec">www.irs.gov/ScheduleC</a></i> for instructions and the latest information.<br/>
			  <span style="margin-top:1mm;">Attach to Form 1040, 1040-SR, 1040-NR, or 1041; partnerships generally must file Form 1065.</span>        
		</div>
	</div>	
	<div class="styTYBox" style="width:29mm;height:21mm;">
		...
		<div style="margin-left:2mm; text-align:left;padding-top:1mm;">
...
<div class="styBB" style="width:187mm;float:none;clear:both;">
	...
	<div class="styForm1040ScheduleCEINFullBox" style="width:48.5mm;height:10.5mm;float:right;">
		...
		<br/>
		<span style="padding-left:5.5mm;"></span>
...
<div class="styBB" style="width:187mm;float:none;clear:both;">        
	...
	<div class="styOMB" style="width:48.5mm;height:auto;border-left-width:1px;float:right; border-bottom-width:0px;">
		<div class="styLNLeftNumBox" style="width:3.6mm; height:8.5mm; font-size:6pt;font-weight:bold;padding-top:0px;">D</div>
			<span style="width:44mm;font-size:6pt;font-weight:bold;">Employer ID number (EIN)<span style="font-weight:normal">(see instr.)</span></span>
			<br/>     
	...
	<div class="styBB" style="width:187mm;border-bottom-width: 0px;float:none;clear:both;height:auto;">        
		...
		<div class="styGenericDiv" style="width:187mm;border-bottom-width: 0px;">        
			...
			<div class="styGenericDiv" style="width:159mm;padding-top:0mm;">
				<span style="float:left;">Did you make any payments in 2022 that would require you to file Form(s) 1099? (see instructions)</span>
	...
	<table class="styTable" style="width:94mm;float:left;font-size:7pt;" cellspacing="0">
		...
		<tbody>
			...
			<tr>
				...
				<td class="styGenericDiv" style="width:46mm;height:100%;padding-top:0.5mm;">Interest (see instructions):</td>        
	...
	<table class="styTable" style="width:93mm;float:left;font-size:7pt;heght:auto;" cellspacing="0">
		...
		<tbody>
			...
			<tr>
				...
				<td class="styGenericDiv" style="width:50mm;padding-bottom:0.5mm;">Travel and meals:</td>
				<td class="styLNRightNumBox" style="height:100%;width:7.25mm;border-bottom-width:0px;background-color:lightgrey;">
					<span style="width:1px;"/>  
				</td>     
				<td class="styLNRightNumBoxNBB" style="width:7.25mm;height:100%;"><span style="width:1px;"/></td>            
			...
			<tr>
				...
				<td class="styGenericDiv" style="width:49mm;padding-top:.7mm;padding-bottom:0mm;">Deductible meals (see instructions)  .
					<!--Dotted Line-->
					<span class="styBoldText"/>  
				</td>
				<td class="styLNRightNumBox" style="height:5mm;width:7.25mm;padding-top:1.5mm;">
					24b
				</td>
				<td class="styLNAmountBox" style="height:5mm;width:31.5mm;padding-top:1.5mm;">
					<xsl:call-template name="PopulateAmount">
			...
			<tr>
				...
				<td class="styLNRightNumBox" style="height:8mm;width:7.25mm;border-bottom-width:0px;">
					27b
				</td>
				<td class="styLNAmountBox" style="height:8mm;width:31.5mm;border-bottom-width:0px;background-color:lightgrey;"> &#160;    
<!--					<xsl:call-template name="PopulateAmount">
...
<div style="width:187mm;float:none;clear:both; ">  
	<div class="styGenericDiv" style="font-weight:bold">For Paperwork Reduction Act Notice, see the separate instructions. </div>   
	<div class="styGenericDiv" style="padding-left:8.5mm">Cat. No. 11334P</div>                        
	<div class="styGenericDiv" style="font-weight:bold;float:right">Schedule C (Form 1040) 2022 </div>
</div> 
<!--</div> --> 
 <!--Begin Page 2 -->
...
<p style="page-break-before: always"/>
    ...
    <div class="styBB" style="width:187mm;float:left;clear:all;">  
      <div style="float:left;">Schedule C (Form 1040) 2022 <span style="width:90mm;"/></div>
 ...
 <!--Line 41-->   
  ...
  <!--Line 48-->
    ...
    <div style="width:187mm;clear:all;">    
      <div class="stySmallText" style="width:135mm;text-align:center;padding-top:1mm;">
      <span style="width:156px"/></div>
      <div class="stySmallText" style="width:52mm;text-align:right;"><span class="styBoldText" style="font-weight:bold;">Schedule C (Form 1040) 2022</span> </div>
    </div>
    <!--    </div> -->      
...
<tr>					
    ...
    <xsl:if test="($Print = $Separated) and (count($Form1040ScheduleCData/OtherExpenseDetail) &gt; 4)">
      <span class="styRepeatingDataTitle">Form 1040 Schedule C, Part V, Other expenses:</span><br/>    
