...
<xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
  ...
  <head>
    ...
    <title>Schedule B (Form 990) (2022)</title>      
    <!-- No Browser Caching -->
    ...
    <meta name="Description" content="Schedule B (Form 990)"/>
...
<xsl:template name="p2Template">    
  ...
  <xsl:if test="$index &lt;= $max">  
    ...
    <tr align="center" style="width:187mm; height:auto">      
      <th class="styIRS990ScheduleBTblRB2" scope="col" style="width:40mm">(a)<br/> No. from Part I
      </th>
      <th class="styIRS990ScheduleBTblRB2" scope="col" style="width:70mm">(b)<br/>Description of noncash property given
      </th>  
      <th class="styIRS990ScheduleBTblRB2" scope="col" colspan="2">(c)<br/>FMV (or estimate)<br/><span style="font-size:7pt">(See
       instructions)</span>
      </th>
      <th class="styTblCell2" scope="col" style="border-bottom:1px solid black; height:8mm">(d)<br/>Date received
      </th>                  
    </tr>            
    <tr style="height:auto">                                    
      ...
      <td class="styIRS990ScheduleBTblRB" style="font-size:7pt;font-family:verdana;text-decoration: underline">
       <xsl:choose>       
        ...
        <xsl:otherwise>                                         
        <xsl:call-template name="PopulateText">
          <xsl:with-param name="TargetNode" select="$Form990ScheduleBData/NonCashPropertyContributionGrp[$index]/
          NoncashPropertyDesc"/>
        ...
        <span style="border-bottom:1px solid black; float:left; width:30mm; text-align:right; font-size:6pt">
          ...
          <xsl:call-template name="PopulateAmount">
            <xsl:with-param name="TargetNode" 
             select="$Form990ScheduleBData/NonCashPropertyContributionGrp[$index]/FairMarketValueAmt"/>
          </xsl:call-template>          
        </span>  
      </td>    
  ...
  <xsl:if test="$index &lt;= 6">  
    <xsl:if test="$index mod 6 = 1">
      ...
      <tr>
        ...
        <th style="width:83mm; border-bottom:1px solid black">            
          <div class="styPartDesc" style="width:98mm">Noncash Property <span style="font-size:5pt">(see Instructions).  Use
           duplicate copies of Part II if additional space is needed.</span></div>                
        </th>  
        <td style="width:30mm; border-bottom:1px solid black"> <span style="width:1px;" /> </td>              
        <td style="width:8mm; border-bottom:1px solid black"> <span style="width:1px;" /> </td>
        <td style="border-bottom:1px solid black"> <span style="width:1px;" /> </td>                
...
<xsl:if test="$index mod 4 = 1">   
  <table class="styIRS990ScheduleBTable" cellspacing="0" cellpadding="0" border="0" style="width:187mm;">  
      ...
      <tr>
        <td style="width:187mm; border-bottom:2px solid black" scope="col" colspan="4">
			<div class="styPartName" style="border-bottom:1px solid black;width:12mm">Part III
			</div>                
			<div class="styPartDesc" style="border-bottom:1px solid blackwidth:170mm; height:20mm;padding-top:0.5mm; ">
			  <i>Exclusively</i> religious, charitable, etc., contributions to organizations described in section 501(c)(7), (8), or
				  (10) that total more than $1,000 for the year from any one contributor.
				  Complete columns <b>(a)</b> through <b>(e) and</b> the following line entry. For organizations completing Part
				  III, enter the total of <i>exclusively</i> religious, charitable, etc., contributions of <b>$1,000 or less</b> for
				  the year. (Enter this information once. See instructions.) 
                <img src="{$ImagePath}/990SchB_Bullet.gif" alt="Arrow Bullet" />
                ...
                <br/>
				<span style=" font-weight:normal; float:left">Use duplicate copies of Part III if additional space is needed.
				</span>
            </div>                  
        </td>  
      </tr> 
  ...
  <table class="styIRS990ScheduleBTable" cellspacing="0" cellpadding="0" border="0" style="width:187mm;">       
    ...
    <tr style="height:auto; text-decoration: underline">                  
      <td class="styIRS990ScheduleBTblRB2" valign="top" rowspan="2">                                                    
        <div style="margin-top:4mm;  width:auto; text-align:center;font-size:6pt;text-decoration: underline">
          <xsl:call-template name="PopulateText">
