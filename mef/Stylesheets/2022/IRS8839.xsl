...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
            ...
            <div class="styIRS8839LineItem" style="height:4mm;">
              ...
              <div class="styIRS8839LNDesc" style="width:106mm;height:100%;padding:0px 0px 0px 0px;">
                ...
                <div class="styIRS8839LNDesc" style="width:auto;height:100%;text-align:right;float:right;padding:0px 4px 0px 0px;">
					<!--Dotted Line-->
					<span class="styDotLn" style="padding-right:1mm;padding-top:2mm;">......</span>	
                </div>
              </div>
 ...
 <!--               <div style="width:187mm;">
            ...
            <div class="styIRS8839LineItem" style="height:10mm;">
              ...
              <div class="styIRS8839LNDesc" style="width:144mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS8839LNDesc" style="width:auto;height:100%;">
                  <b>Adoption Credit.</b> Enter the smaller of line 14 or line 15 here and on Schedule 3 (Form 1040), line 6c. If line 15 is smaller than line 14, you may have a credit carryforward (see instructions)
                  <!--Dotted Line-->
                  <span class="styDotLn" style="float:right;padding-right:1mm;">..........</span>	
                </div>
              </div>
		  ...
		  <xsl:otherwise>
               ...
               <div class="styIRS8839LNLeftNumBox" style="padding-top:6mm;">22</div>
                  ...
                  <div style="padding:0px 0px 0px 0px;width:100%;height:100%;">
                    <div class="styIRS8839LNDesc" style="padding:0px 0px 0px 0px;float:left;width:auto;">
                     ...
                     <input type="checkbox" alt="ExcludedBenefitsMoreThanEmployerProvidedAdoptionBenefits No" class="styCkbox" >
                      ...
                      <label>
                        ...
                        <span style="width:11mm;"/>line 1 of Form 1040 or 1040-SR or line 1a of Form 1040-NR. On the dotted line next to line<br/>
                        <span style="width:11mm;"/>1 of Form 1040 or 1040-SR or line 1a of Form 1040-NR, enter “AB.”<br/>
                      </label>
                      <!-- ++++++++++++++ Yes Checkbox +++++++++++++ -->
                      <span style="width:1mm;"/>
                      <span>
                   ...
                   <input type="checkbox" alt="ExcludedBenefitsMoreThanEmployerProvidedAdoptionBenefits Yes" class="styCkbox">
                      ...
                      <label>
                        ...
                        <span style="width:11mm;"/>the total you would enter on line 1 of Form 1040 or 1040-SR or line 1a of Form 1040-NR by<br/>
                        <span style="width:11mm;"/>the amount on Form 8839, line 29. Enter the result on line 1 of Form 1040 or 1040-SR or<br/>
                        <span style="width:11mm;"/>line 1a of Form 1040-NR. Enter "SNE" on the dotted line next to the entry line.
                      </label>
                    </div>
            ...
            <xsl:if test="count($Form8839Data/AdoptedChild) > 1">
              ...
              <xsl:variable name="SameChildNode">
					<xsl:choose>
						...
						<xsl:when test="AdoptionCreditSameChildPYInd='0'">no</xsl:when>						
						</xsl:choose>
                </xsl:variable>              
                <tr>
              ...
              <xsl:variable name="EmpSameChildNode">
					<xsl:choose>
						...
						<xsl:when test="EmployerAdptnBnftSameChldPYInd='0'">no</xsl:when>
						</xsl:choose>
                </xsl:variable>               
                <tr>
...
<xsl:attribute name="alt">Child <xsl:value-of select="$Number"/> Foreign Child</xsl:attribute>        
      ...
      <td class="styIRS8839TableCell" style="width:44%;font-size: 7pt; text-align:center;border-right-width:0px;">
        <input class="styCkbox" alt="adoption became final in 2015 or earlier" type="checkbox" style="width:4mm;">
<xsl:attribute name="alt">Child <xsl:value-of select="$Number"/> adoption became final in 2014 or earlier</xsl:attribute>        
   ...
   black;border-width:0px 1px 2px 0px;
      ...
      black;border-width:0px 1px 2px 0px;
         ...
         black;border-width:0px 1px 2px 0px;
            ...
            <input class="styCkbox" alt="Disabled Child Over 18" type="checkbox" style="width:4mm;">
          ...
          <td class="styIRS8839TableCell">
            ...
            <input class="styCkbox" alt="Child With Special Needs" type="checkbox" style="width:4mm;">
              <xsl:call-template name="PopulateCheckbox">
                <xsl:with-param name="TargetNode" select="ChildWithSpecialNeedsInd"/>
                <xsl:with-param name="BackupName">Form8839DataAdoptedChildChildWithSpecialNeedsInd</xsl:with-param>
              </xsl:call-template>
          ...
          <td class="styIRS8839TableCell">
            ...
            <input class="styCkbox" alt="Foreign Child" type="checkbox" style="width:4mm;">
              <xsl:call-template name="PopulateCheckbox">
                <xsl:with-param name="TargetNode" select="ForeignChildInd"/>
                <xsl:with-param name="BackupName">Form8839DataAdoptedChildForeignChildInd</xsl:with-param>
              </xsl:call-template>
  ...
  <xsl:template name="PopulatePartIITable">
    ...
    <div class="styIRS8839LineItem"  style="height:10mm;">
     ...
     <div class="styIRS8839LNDesc" style="height:100%;width:132mm;float:right;padding:0px 0px 0px 0px;">
        ...
        <xsl:choose>
          <xsl:when test="count($Form8839Data/AdoptedChild/AdoptionCreditMaxPerChildAmt[1]) != 0">
            <xsl:call-template name="CreateBoxRow">
        ...
        <xsl:otherwise>
         <xsl:call-template name="CreateBoxRow">
          <xsl:with-param name="Number">2</xsl:with-param>
          <xsl:with-param name="Child1StaticText">14,440 </xsl:with-param> 
        </xsl:call-template>        
         </xsl:otherwise>
        </xsl:choose>
    </div>
            ...
            <div class="styIRS8839LNDesc" style="padding:0px 0px 0px 0px;float:left;width:auto;">
             ...
             <!-- ++++++++++++++ Yes Checkbox +++++++++++++ -->
              ...
              <span>
                ...
                <input type="checkbox" alt="AdoptionCreditSameChildPriorYear Yes" class="styCkbox">
                 <xsl:choose>
                  <xsl:when test="$Child1/AdoptionCreditSameChildPYInd and (count($Form8839Data/AdoptedChild) &gt;= 1)">  
                    <xsl:call-template name="PopulateYesCheckbox">
                      <xsl:with-param name="TargetNode" select="$Child1/AdoptionCreditSameChildPYInd"/>
  ...
  <xsl:template name="PopulatePartIIITable">
    ...
    <!-- (17) ////////////////////////////////////////////////////-->  
   <div class="styIRS8839LineItem"  style="height:9mm;">
      ...
      <div class="styIRS8839LNDesc" style="height:12mm;width:132mm;float:right;padding:0px 0px 0px 0px;">      
        <xsl:call-template name="CreateBoxRow">
          <xsl:with-param name="Child3Style">border-bottom-width:0px;</xsl:with-param>
          <xsl:with-param name="Child2Style">border-bottom-width:0px;</xsl:with-param>
          <xsl:with-param name="Child1Style">border-bottom-width:0px;</xsl:with-param>
        ...
        <xsl:choose>
          <xsl:when test="count($Form8839Data/AdoptedChild/EmployerAdoptionExclMaxChldAmt[1]) != 0">
            <xsl:call-template name="CreateBoxRow">                         
  ...
  <xsl:template name="PopulatePartIIILine22">
    ...
    <!-- (22) ////////////////////////////////////////////////////-->
    <div class="styIRS8839LineItem" style="height:18mm;">
      <div class="styIRS8839LNLeftNumBox" style="padding-top:3mm;">22</div>
      <div class="styIRS8839LNDesc" style="width:48mm;height:100%;padding:5px 0px 0px 0px;">
        <div class="styIRS8839LNDesc" style="width:auto;height:auto;">
          Enter the <b>smaller</b> of line 19 or<br/>
          line 20. But if the child was a<br/>
