				...
				<table width="186mm" border="0" cellpadding="0" cellspacing="0" style="font-family: Verdana;        font-size: 7pt;">
					<tr>
						<td width="186mm" colspan="2" style="width: 186mm;">
							<span style="font-family: Courier New, monospace; font-size: 13pt; text-align: right;          width: 186mm;">651119</span>
						</td>
					</tr>
					<tr>
						<td width="186mm" colspan="2" style="width: 186mm;">
					...
					<tr>
						<td style="width: 93mm;" valign="top">
							<table border="0" cellspacing="0" cellpadding="0" style="border-right: 1px solid black;">
								...
								<tr>
									<td style="font-size: 7pt;">
										...
										<span style="float: right; clear: none; padding-right: 1mm;">For calendar year 2022, or tax year</span>
										<span style="float: right; clear: both; padding-right: 1mm;">beginning
								...
								<tr>
									<td class="IRS1065ScheduleK1_tdLeft" style="height: 27mm;">
										<!-- Line B -->
								...
								<tr>
									<td class="IRS1065ScheduleK1_tdLeft" style="height: 8.5mm;padding-bottom:0mm">
										...
										<span style="width: 3mm;"/>
										Partner's SSN or TIN (Do not use TIN of a disregarded entity.  
										<span style="width: 6.5mm;"/>See inst.)<br/>
										<span style="width: 5mm;"/>
								...
								<tr>
									<td class="IRS1065ScheduleK1_tdLeft" style="height: 24mm;">
										...
										<span style="width: 3mm;"/>
										<span style="width: 80mm;">Name, address, city, state, and ZIP code for partner entered in</span>
										<span style="width: 6.5mm;"/>E. See instructions.<br/>
										<span style="width: 5mm;"/>
										<span style="width: 84mm;">
											<xsl:call-template name="PopulateText">
								...
								<tr>
									<td class="IRS1065ScheduleK1_tdLeft" style="height:10mm;">
										<!-- PART II Line G -->
										<div style="float:left;clear:none;">
											<span style="font-weight:bold; width:3.5mm;">G</span>
											<input type="checkbox" class="styckbox" name="checkbox" id="dummyid">
												<xsl:call-template name="PopulateCheckbox">
											...
											<label>
												...
												<span style="width:9mm;"/>member-manager
                                                </label>
										</div>
								...
								<tr>
									<td class="IRS1065ScheduleK1_tdLeft" style="height: 10mm;border-top-width:0;">
										<!-- PART II Line H-->
										<xsl:choose>
											<xsl:when test="$FormData/DomesticPartnerInd">
												<div style="float:left;clear:none;">
													<span style="font-weight: bold; width:3.5mm;height:4mm;">H1</span>
													<span style="width:35mm;height:4mm;">
												...
												<div style="float:right;clear:none;">
													<span style="width:45mm;height:4mm;">
														<input type="checkbox" class="styckbox" name="checkbox">
															<xsl:call-template name="PopulateCheckbox">
										...
										<div style="float:left;clear:none;">
											<span style="font-weight:bold; width:3.5mm;">H2</span>
											<input type="checkbox" class="styckbox" name="checkbox">
												<xsl:call-template name="PopulateCheckbox">
											...
											<label>
												...
												<span style="width: 80mm;">If partnership interest is owned through a disregarded entity</span>
												<span style="width: 9mm;"/>(DE), enter DE's:<br/>
											</label>
											<br/>
											<span style="width:9mm;"/>TIN:
											<span style="width: 19mm; border-bottom: 1px solid black; text-align: left; ">
												<xsl:choose>
													<xsl:when test="$FormData/DisregardedEntitySSN">
														<xsl:call-template name="PopulateSSN">
															<xsl:with-param name="TargetNode" select="$FormData/DisregardedEntitySSN"/>
														</xsl:call-template>
													</xsl:when>
													<xsl:when test="$FormData/DisregardedEntityEIN">
														<xsl:call-template name="PopulateEIN">
											...
											<span style="width:2mm;"/>Name:
											<span style="width: 42mm; border-bottom: 1px solid black; text-align: left; ">
												<xsl:choose>
													<xsl:when test="$FormData/DisregardedEntityName/BusinessNameLine1Txt">
														<xsl:call-template name="PopulateText">
													...
													<xsl:when test="$FormData/BeneficialOwnerBusinessName/BusinessNameLine1Txt">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$FormData/BeneficialOwnerBusinessName/BusinessNameLine1Txt"/>
														</xsl:call-template>
														<span style="width:2mm;"/>
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$FormData/BeneficialOwnerBusinessName/BusinessNameLine2Txt"/>
														</xsl:call-template>
													</xsl:when>
													<xsl:when test="$FormData/BeneficialOwnerPersonNm">
														<xsl:call-template name="PopulateText">
															<xsl:with-param name="TargetNode" select="$FormData/BeneficialOwnerPersonNm"/>
														</xsl:call-template>
													</xsl:when>
												</xsl:choose>
											</span>
									...
									<td class="IRS1065ScheduleK1_tdLeft" style="border-top-width:0;">
										...
										<label>
											<xsl:call-template name="PopulateLabel">
												...
												<xsl:with-param name="BackupName">IRS1065ScheduleK1IsPartnerARetirementPlan</xsl:with-param>
											</xsl:call-template>
											If this partner is a retirement plan (IRA/SEP/Keogh/etc.),
											 <br/>
											<span style="width:6.5mm;"/>check here
											<span style="width:63mm;"/>
											<input type="checkbox" class="styckbox" name="checkbox" alt="Partner is a Retirement Plan indicator">
												<xsl:call-template name="PopulateCheckbox">
													<xsl:with-param name="TargetNode" select="$FormData/PartnerRetirmentPlanInd"/>
													<xsl:with-param name="BackupName">IRS1065ScheduleK1IsPartnerARetirementPlan</xsl:with-param>
												</xsl:call-template>
								...
								<tr>
									<td class="IRS1065ScheduleK1_tdLeft" style="height: 23mm;border-top-width:0;">
											...
											<tbody>
												...
												<tr>
													...
													<td style="border:1px black solid;border-top:0px;border-left:0;border-right:0px;                text-align:right;font-size:6pt">
														<span style="width:35mm;text-align:right;font-size:6pt">
															<xsl:call-template name="PopulatePercent">
										...
										<span style="padding-top:1mm;font-size:6.5pt;padding-left:5mm;">Check if decrease is due to sale or exchange of partnership interest.</span>
										<span style="width:1px;"/>
										<input type="checkbox" class="styckbox" name="checkbox" alt="Sale or exchange of partnership interest Indicator">
											<xsl:call-template name="PopulateCheckbox">
												<xsl:with-param name="TargetNode" select="$FormData/PartnersShareProfitLossCapGrp/DecrSaleExchPrtnrPrtshpIntInd"/>
												<xsl:with-param name="BackupName">IRS1065SchK1PartnersShareProfitLossCapGrpDecrSaleExchPrtnrPrtshpIntInd</xsl:with-param>
											</xsl:call-template>
										</input>
									</td>
								</tr>
								<tr>
									<td class="IRS1065ScheduleK1_tdLeft" style="height: 17.5mm;border-top-width:0;">
										...
										<span style="width: 3mm;"/>Partner’s share of liabilities:
										    <xsl:call-template name="SetFormLinkInline">
											<xsl:with-param name="TargetNode" select="$FormData/PartnerShareLiabilityGrp"/>
										</xsl:call-template>
										<br/>
										<table style="font-size:7pt;margin-left:5.3mm;" cellpadding="0" cellspacing="0">
											<tbody>
												<tr>
													<th/>
													<th scope="col" style="width:27mm;">Beginning</th>
													<th scope="col" style="width:5mm;"/>
													<th scope="col" style="width:20mm;">Ending</th>
												</tr>
												<tr>
													<td width="3" style="width:30mm;border:1px black solid;border-top:0px;border-left:0;border-right:0;">Nonrecourse
														<span style="width:5px;"/>.
														<span style="width:5px;"/>.
														<span>$</span>
													</td>
													<td style="border:1px black solid;border-top:0px;border-left:0;font-size:7pt;text-align:right;">
														<span style="text-align:right;">
															<xsl:call-template name="PopulateAmount">
																<xsl:with-param name="TargetNode" select="$FormData/PartnerShareLiabilityGrp/NonrecourseBOYAmt"/>
															</xsl:call-template>
														</span>
													</td>
													<td style="border:1px black solid;border-top:0px;border-left:0;border-right:0px;font-size:7pt">
														<span style="font-size:7pt">$</span>
													</td>
													<td style="border:1px black solid;border-top:0px;border-left:0;border-right:0px;font-size:7pt;text-align:right;">
														<span style="text-align:right;font-size:7pt">
															<xsl:call-template name="PopulateAmount">
																<xsl:with-param name="TargetNode" select="$FormData/PartnerShareLiabilityGrp/NonrecourseEOYAmt"/>
															</xsl:call-template>
														</span>
													</td>
												</tr>
												<tr>
													<td width="3" style="width:30mm;border:1px black solid;border-top:0px;border-left:0;border-right:0;">Qualified<br/> nonrecourse
															<br/>financing
													...
													<td style="border:1px black solid;border-top:0px;border-left:0;font-size:7pt;text-align:right;">
														<span style="text-align:right;padding-top:6mm;">
															<xsl:call-template name="PopulateAmount">
																<xsl:with-param name="TargetNode" select="$FormData/PartnerShareLiabilityGrp/QlfyNonRcrsFinancingBOYAmt"/>
															</xsl:call-template>
														</span>
													</td>
													<td style="border:1px black solid;border-top:0px;border-left:0;border-right:0px;font-size:7pt;">
														<span style="font-size:7pt;padding-top:6mm;">$</span>
													</td>
													<td style="border:1px black solid;border-top:0px;border-left:0;border-right:0px;font-size:7pt;text-align:right;">
														<span style="text-align:right;padding-top:6mm;">
															<xsl:call-template name="PopulateAmount">
																<xsl:with-param name="TargetNode" select="$FormData/PartnerShareLiabilityGrp/QlfyNonRcrsFinancingEOYAmt"/>
															</xsl:call-template>
														</span>
													</td>
												</tr>
												<tr>
													<td width="3" style="width:30mm;border:1px black solid;border-top:0px;border-left:0;border-right:0;">Recourse
													...
													<td style="border:1px black solid;border-top:0px;border-left:0;font-size:7pt;text-align:right;">
														<span style="text-align:right;">
															<xsl:call-template name="PopulateAmount">
																<xsl:with-param name="TargetNode" select="$FormData/PartnerShareLiabilityGrp/RecourseBOYAmt"/>
															</xsl:call-template>
														</span>
													</td>
													<td style="border:1px black solid;border-top:0px;border-left:0;border-right:0px;font-size:7pt">
													...
													<td style="border:1px black solid;border-top:0px;border-left:0;border-right:0px;font-size:7p;text-align:right;">
														<span style="text-align:right;">
															<xsl:call-template name="PopulateAmount">
																<xsl:with-param name="TargetNode" select="$FormData/PartnerShareLiabilityGrp/RecourseEOYAmt"/>
															</xsl:call-template>
														</span>
													</td>
												</tr>
										...
										<span style="padding-top:1mm;padding-left:5mm;">
											<input type="checkbox" class="styckbox" name="checkbox" alt="Liability amounts from lower-tier partnership Indicator">
												<xsl:call-template name="PopulateCheckbox">
													<xsl:with-param name="TargetNode" select="$FormData/PartnerShareLiabilityGrp/LowerTierPartnershipLiabAmtInd"/>
													<xsl:with-param name="BackupName">IRS1065SchK1PartnerShareLiabilityGrpLowerTierPartnershipLiabAmtInd</xsl:with-param>
												</xsl:call-template>
											</input>
												Check this box if Item K includes liability amounts from lower</span>
										<span style="padding-left:11.5mm;"> tier partnerships.</span>
									</td>
								</tr>
								<tr>
									<td class="IRS1065ScheduleK1_tdLeft" style="height: 30mm;border-bottom-width: 1px solid black;">
										<!-- PART II Line L -->
										<span style="font-weight: bold;">L</span>
										<span style="font-weight: bold;padding-left:17mm;">Partner’s capital account analysis
										</span>
										<span style="font-weight: bold;padding-left:62mm;">Tax Basis Capital</span>
										<table cellspacing="0" cellpadding="0" width="100%">
											<tbody>
												<tr>
													...
													<td>
														<span style="width: 30mm; border-bottom: 1px solid black; text-align: right;                 font-size:7pt; ">
															<span style="font-size:7pt;float:left;">$</span>
															<xsl:call-template name="PopulateAmount">
                              ...
                              Capital contributed during the year
												...
												<tr>
													<td style="padding-left:5.6mm;">
														<span style="font-size:7pt;">
                              Current year net income (loss)</span>
														<!--Dotted Line-->
														<span style="width:8px;"/>.
														<span style="width:8px;"/>. 
													</td>
													<td>
														<span style="width: 30mm; border-bottom: 1px solid black; text-align: right;                 font-size:7pt; ">
															<span style="font-size:7pt;float:left;">$</span>
															<xsl:call-template name="PopulateAmount">
																<xsl:with-param name="TargetNode" select="$FormData/PartnersCapitalAccountGrp/CurrentYearNetIncomeOrLossAmt"/>
															</xsl:call-template>
														</span>
													</td>
												</tr>
                              ...
                              <span style="width:8px;"/>. 
													...
													<td>
														<span style="width: 30mm; border-bottom: 1px solid black; text-align: right;font-size:7pt;padding-top:2mm;">
															<span style="font-size:7pt;float:left;">$</span>
															<span style="float:left">
																<xsl:call-template name="SetFormLinkInline">
																	<xsl:with-param name="TargetNode" select="$FormData/PartnersCapitalAccountGrp/OtherIncreaseDecreaseAmt"/>
																</xsl:call-template>
															</span>
															<xsl:call-template name="PopulateAmount">
																<xsl:with-param name="TargetNode" select="$FormData/PartnersCapitalAccountGrp/OtherIncreaseDecreaseAmt"/>
                          ...
                          <span style="width:8px;"/>.
													...
													<td>
														<span style="width: 30mm; border-bottom: 2px solid black; text-align: right;                 font-size:7pt;">
															<span style="font-size:7pt;float:left;">$</span>
															<xsl:call-template name="PopulateAmount">
								...
								<tr>
									<td class="IRS1065ScheduleK1_tdLeft" style="height: 13mm;border-bottom-width: 1px solid black;">
										<!-- PART II Line M -->
										...
										<span>
											...
											<input type="checkbox" class="styCkbox" alt="Property Contribute Built In Gain Or Loss Yes">
											...
											<span style="width:1mm"/>
											<input type="checkbox" class="styCkbox" alt="Property Contribute Built In Gain Or Loss No">
										...
										<span style="width:3mm"/>If "Yes," attach statement (see
										<br/>
										<span style="width:6mm"/>
										<span style="width:30mm;">instructions)
								             <span style="width:1mm;"/>
											<xsl:call-template name="SetFormLinkInline">
												<xsl:with-param name="TargetNode" select="$FormData/PropContriBuiltInGainLossInd"/>
											</xsl:call-template>
								...
								<tr>
									<td class="IRS1065ScheduleK1_tdLeft" style="height: 13mm;border-bottom: 2px solid black;">
										<!-- PART II Line N -->
										<span style="font-weight: bold;">N</span>
										<span style="width:4mm;"/>
										<span style="width:80mm;font-weight:bold;font-size:6pt;">Partner’s Share of Net Unrecognized Section 704(c) Gain or (Loss)</span>
										<table cellspacing="0" cellpadding="0" width="100%">
											<tbody>
												<tr>
													<td style="padding-left:5.6mm;">
														<span style="font-size:7pt;padding-top:0.5mm;">
															  Beginning</span>														
														<!--Dotted Line-->
														<span style="width:8px;"/>.
														<span style="width:8px;"/>.
						...
						<td width="93mm" style="width: 93mm;" valign="top">
							<table width="93mm" border="0" cellpadding="0" cellspacing="0" style="border-top: 2px solid black; border-bottom: 2px solid black; border-left: 1px solid black;          border-right: 2px solid black;">
								...
								<tr>
									<td valign="top" style="border-right:1px solid black;height:auto;">
										<table width="46.5mm" border="0" cellpadding="0" cellspacing="0" style="height:auto;">
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="border-bottom:0px solid lightgrey;">
													<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
														<tbody>
															<tr>
																<td class="IRS1065ScheduleK1_itemLabel" style="text-align:center;">1</td>
																<td style="font-size:7pt;">
															...
															<xsl:if test="count($FormData/OrdinaryIncomeLossAmt) = 0 ">
																<tr>
																	<td class="IRS1065ScheduleK1_codeBox" style="height:4.5mm;border-top:0px solid;font-size:7pt;">
																		<span style="vertical-align:baseline;height:100%;"/>
																	</td>
																	<td class="IRS1065ScheduleK1_amountBox" style="height:4.5mm;border-top:0px solid;width:41.40mm;font-size:7pt;">
																		<span style="vertical-align:baseline;height:100%;"/>
																	</td>
																</tr>
															</xsl:if>
															<xsl:for-each select="$FormData/OrdinaryIncomeLossAmt">
																<xsl:if test="($Print != $Separated) or                  (count($FormData/OrdinaryIncomeLossAmt) =1)">
																	<tr>
																		<td class="IRS1065ScheduleK1_codeBox" style="height:4.5mm;border-top:0px solid;font-size:7pt;" valign="bottom">
																			<xsl:call-template name="PopulateText">
																				<xsl:with-param name="TargetNode" select="SchK1OtherInformationCd"/>
																			</xsl:call-template>
																		</td>
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="border-bottom:0px solid lightgrey;">
													<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
														<tbody>
															<tr>
																<td class="IRS1065ScheduleK1_itemLabel" style="text-align:center;">2</td>
																<td style="font-size:7pt;">
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="border-bottom:0px solid lightgrey;">
													<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
														<tbody>
															<tr>
																<td class="IRS1065ScheduleK1_itemLabel" style="text-align:center;">3</td>
																<td style="font-size:7pt;">
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="border-bottom:0px solid lightgrey;">
													<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
														<tbody>
															<tr>
																<td class="IRS1065ScheduleK1_itemLabel" style="text-align:center;">4a</td>
																<td style="font-size:7pt;">
																	<span style="width:1mm;"/>Guaranteed payments for services</td>
															</tr>
															<!-- Display a blank line if there are no data elements -->
															<xsl:if test="count($FormData/GuaranteedPaymentsServicesAmt) = 0 ">
																<tr>
																	<td class="IRS1065ScheduleK1_codeBox" style="height:4.63mm;border-top:0px solid;font-size:7pt;">
																		<span style="vertical-align:baseline;height:100%;"/>
																	</td>
																	<td class="IRS1065ScheduleK1_amountBox" style="height:4.63mm;border-top:0px solid;width:41.40mm;font-size:7pt;">
																		<span style="vertical-align:baseline;height:100%;"/>
																	</td>
																</tr>
															</xsl:if>
															<xsl:for-each select="$FormData/GuaranteedPaymentsServicesAmt">
																<xsl:if test="($Print != $Separated) or                  (count($FormData/GuaranteedPaymentsServicesAmt) =1)">
																	<tr>
																		<td class="IRS1065ScheduleK1_codeBox" style="height:4.63mm;border-top:0px solid;font-size:7pt;" valign="bottom">
																			<xsl:call-template name="PopulateText">
																				<xsl:with-param name="TargetNode" select="SchK1OtherInformationCd"/>
																			</xsl:call-template>
																		</td>
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="border-bottom:0px solid lightgrey;">
													<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
														<tbody>
															<tr>
																<td class="IRS1065ScheduleK1_itemLabel" style="text-align:center;">4b</td>
																<td style="font-size:7pt;">
																	<span style="width:1mm;"/>Guaranteed payments for capital</td>
															</tr>
															<!-- Display a blank line if there are no data elements -->
															<xsl:if test="count($FormData/GuaranteedPaymentsCapitalAmt) = 0 ">
																<tr>
																	<td class="IRS1065ScheduleK1_codeBox" style="height:4.63mm;border-top:0px solid;font-size:7pt;">
																		<span style="vertical-align:baseline;height:100%;"/>
																	</td>
															...
															<xsl:for-each select="$FormData/GuaranteedPaymentsCapitalAmt">
																<xsl:if test="($Print != $Separated) or                  (count($FormData/GuaranteedPaymentsCapitalAmt) =1)">
																	<tr>
																		<td class="IRS1065ScheduleK1_codeBox" style="height:4.63mm;border-top:0px solid;font-size:7pt;" valign="bottom">
																			<xsl:call-template name="PopulateText">
																				<xsl:with-param name="TargetNode" select="SchK1OtherInformationCd"/>
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="border-bottom:0px solid lightgrey;">
													<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
														<tbody>
															<tr>
																<td class="IRS1065ScheduleK1_itemLabel" style="text-align:center;">4c</td>
																<td style="font-size:7pt;">
																	<span style="width:1mm;"/>Total guaranteed payments</td>
															</tr>
															<!-- Display a blank line if there are no data elements -->
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="border-bottom:0px solid lightgrey;">
													<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
														<tbody>
															<tr>
																<td class="IRS1065ScheduleK1_itemLabel" style="text-align:center;">5</td>
																<td style="font-size:7pt;">
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="border-bottom:0px solid lightgrey;">
													<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
														<tbody>
															<tr>
																<td class="IRS1065ScheduleK1_itemLabel" style="text-align:center;">6a</td>
																<td style="font-size:7pt;">
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="border-bottom:0px solid lightgrey;">
													<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
														<tbody>
															<tr>
																<td class="IRS1065ScheduleK1_itemLabel" style="text-align:center;">6b</td>
																<td style="font-size:7pt;">
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="border-bottom:0px solid lightgrey;">
													<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
														<tbody>
															<tr>
																<td class="IRS1065ScheduleK1_itemLabel" style="text-align:center;">6c</td>
																<td style="font-size:7pt;">
																	<span style="width:1mm;"/>Dividend equivalents</td>
															</tr>
															<!-- Display a blank line if there are no data elements -->
															<xsl:if test="count($FormData/DividendEquivalentsAmt) = 0 ">
																<tr>
																	<td class="IRS1065ScheduleK1_codeBox" style="height:4.6mm;border-top:0px solid;font-size:7pt;">
																		<span style="vertical-align:baseline;height:100%;"/>
																	</td>
															...
															<xsl:for-each select="$FormData/DividendEquivalentsAmt">
																<xsl:if test="($Print != $Separated) or (count($FormData/DividendEquivalentsAmt) =1)">
																	<tr>
																		<td class="IRS1065ScheduleK1_codeBox" style="height:4.6mm;border-top:0px solid;font-size:7pt;" valign="bottom">
																			<xsl:call-template name="PopulateText">
																				<xsl:with-param name="TargetNode" select="SchK1OtherInformationCd"/>
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="border-bottom:0px solid lightgrey;">
													<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
														<tbody>
															<tr>
																<td class="IRS1065ScheduleK1_itemLabel" style="text-align:center;">7</td>
																<td style="font-size:7pt;">
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="border-bottom:0px solid lightgrey;">
													<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
														<tbody>
															<tr>
																<td class="IRS1065ScheduleK1_itemLabel" style="text-align:center;">8</td>
																<td style="font-size:7pt;">
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="border-bottom:0px solid lightgrey;">
													<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
														<tbody>
															<tr>
																<td class="IRS1065ScheduleK1_itemLabel" style="text-align:center;">9a</td>
																<td style="font-size:7pt;">
															...
															<xsl:if test="count($FormData/NetLTCapitalGainOrLossAmt) = 0 ">
																<tr>
																	<td class="IRS1065ScheduleK1_codeBox" style="height:6.38mm;border-top:0px solid;font-size:7pt;">
																		<span style="vertical-align:baseline;height:100%;"/>
																	</td>
																	<td class="IRS1065ScheduleK1_amountBox" style="height:6.38mm;border-top:0px solid;width:41.40mm;font-size:7pt;">
																		<span style="vertical-align:baseline;height:100%;"/>
																	</td>
																</tr>
															</xsl:if>
															<xsl:for-each select="$FormData/NetLTCapitalGainOrLossAmt">
																<xsl:if test="($Print != $Separated) or                  (count($FormData/NetLTCapitalGainOrLossAmt) =1)">
																	<tr>
																		<td class="IRS1065ScheduleK1_codeBox" style="height:6.38mm;border-top:0px solid;font-size:7pt;" valign="bottom">
																			<xsl:call-template name="PopulateText">
																				<xsl:with-param name="TargetNode" select="SchK1OtherInformationCd"/>
																			</xsl:call-template>
																		</td>
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="border-bottom:0px solid lightgrey;">
													<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
														<tbody>
															<tr>
																<td class="IRS1065ScheduleK1_itemLabel" style="text-align:center;">9b</td>
																<td style="font-size:7pt;">
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="border-bottom:0px solid lightgrey;">
													<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
														<tbody>
															<tr>
																<td class="IRS1065ScheduleK1_itemLabel" style="text-align:center;">9c</td>
																<td style="font-size:7pt;">
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="border-bottom:0px solid lightgrey;">
													<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
														<tbody>
															<tr>
																<td class="IRS1065ScheduleK1_itemLabel" style="text-align:center;">10</td>
																<td style="font-size:7pt;">
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="border-bottom:0px solid lightgrey;">
													<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
														<tbody>
															<tr>
																<td class="IRS1065ScheduleK1_itemLabel" style="text-align:center;">11</td>
																<td style="font-size:7pt;">
															...
															<xsl:if test="count($FormData/IRS1065K1OtherIncomeLossGrp/SchK1OtherIncomeLossGrp) = 0 ">
																<tr>
																	...
																	<td class="IRS1065ScheduleK1_amountBox" style="height:4.5mm;border-top:0px solid;width:41.40mm;
														  font-size:7pt;">
																		<span style="vertical-align:baseline;height:100%;"/>
																	</td>
																</tr>
														  ...
														  border-top:1px solid black;font-size:7pt;">
																		<span style="vertical-align:baseline;height:100%;"/>
																	</td>
																	<td class="IRS1065ScheduleK1_amountBox" style="height:8mm;
														  border-top:1px solid black;width:41.40mm;font-size:7pt;">
																		<span style="vertical-align:baseline;height:100%;"/>
																	</td>
																</tr>
																<tr>
														  ...
														  border-top:1px solid black;width:41.40mm;font-size:7pt;">
															...
															<xsl:for-each select="$FormData/IRS1065K1OtherIncomeLossGrp/SchK1OtherIncomeLossGrp">
															    ...
															    border-top:0px solid;font-size:7pt;" valign="bottom">
																					<xsl:call-template name="PopulateText">
															    ...
															    font-size:7pt;" valign="bottom">
																					<span style="float:left;padding-left:2px;">
																						<xsl:call-template name="SetFormLinkInline">
																							<xsl:with-param name="TargetNode" select="$FormData/IRS1065K1OtherIncomeLossGrp"/>
																						</xsl:call-template>
																					</span>
																					<span style="float:right;">
																						<xsl:call-template name="PopulateAmount">
																		...
																		<xsl:otherwise>
																			<tr>
																				<td class="IRS1065ScheduleK1_codeBox" style="height:8mm;
															    border-top:1px solid black;font-size:7pt;" valign="bottom">
																					<xsl:call-template name="PopulateText">
																						<xsl:with-param name="TargetNode" select="SchK1OtherIncomeLossCd"/>
																					</xsl:call-template>
																				</td>
																				<td class="IRS1065ScheduleK1_amountBox" style="height:8mm;
															    border-top:1px solid black;width:41.40mm;
															    font-size:7pt;" valign="bottom">
																					<xsl:call-template name="PopulateAmount">
																						<xsl:with-param name="TargetNode" select="Amt"/>
																					</xsl:call-template>
														  ...
														  border-top:1px solid black;width:41.40mm;font-size:7pt;">
															...
															<xsl:if test="((count($FormData/IRS1065K1OtherIncomeLossGrp/SchK1OtherIncomeLossGrp) &gt;3)  and              ($Print = $Separated))">
																<tr>
																	<td class="IRS1065ScheduleK1_codeBox" style="height:4.5mm;
														  border-top:0px solid black;font-size:7pt;">
																		<span style="vertical-align:baseline;height:100%;"/>
																	</td>
																	<td class="IRS1065ScheduleK1_amountBox" style="height:4.5mm;
														  border-top:0px solid black;width:41.40mm;font-size:7pt;">
																		<span style="vertical-align:baseline;height:100%;"/>
																		<xsl:call-template name="PopulateAdditionalDataTableMessage">
																			<xsl:with-param name="TargetNode" select="$FormData/IRS1065K1OtherIncomeLossGrp/SchK1OtherIncomeLossGrp"/>
																		</xsl:call-template>
																	</td>
																	<tr>
																		<td class="IRS1065ScheduleK1_codeBox" style="height:8mm;
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="border-bottom:0px solid lightgrey;">
													<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
														<tbody>
															<tr>
																<td class="IRS1065ScheduleK1_itemLabel" style="text-align:center;">12</td>
																<td style="font-size:7pt;">
															...
															<xsl:if test="count($FormData/Section179ExpenseDeductionAmt) = 0 ">
																<tr>
																	<td class="IRS1065ScheduleK1_codeBox" style="height:4.5mm;
														  border-top:0px solid;font-size:7pt;">
																		<span style="vertical-align:baseline;height:100%;"/>
																	</td>
																	<td class="IRS1065ScheduleK1_amountBox" style="height:4.5mm;
														  border-top:0px solid;width:41.40mm;font-size:7pt;">
																		<span style="vertical-align:baseline;height:100%;"/>
																	</td>
																</tr>
															</xsl:if>
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="border-bottom:0px solid lightgrey;">
													<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
														<tbody>
															<tr>
																<td class="IRS1065ScheduleK1_itemLabel" style="text-align:center;">13</td>
																<td style="font-size:7pt;">
														  ...
														  border-top:1px solid black;width:41.40mm;font-size:7pt;">
															...
															<xsl:for-each select="$FormData/IRS1065K1OtherDeductionsGrp/SchK1OtherDeductionsGrp">
															    ...
															    font-size:7pt;" valign="bottom">
																					<span style="padding-left:2px;">
																						<xsl:call-template name="SetFormLinkInline">
																							<xsl:with-param name="TargetNode" select="$FormData/IRS1065K1OtherDeductionsGrp"/>
																						</xsl:call-template>
																					</span>
																					<span style="float:right;">
																						<xsl:call-template name="PopulateAmount">
																		...
																		<xsl:otherwise>
																			<tr>
																				<td class="IRS1065ScheduleK1_codeBox" style="height:7.795mm;border-top:1px solid black;
															    font-size:7pt;" valign="bottom">
																					<xsl:call-template name="PopulateText">
																						<xsl:with-param name="TargetNode" select="SchK1OtherDeductionsCd"/>
																					</xsl:call-template>
																				</td>
																				<td class="IRS1065ScheduleK1_amountBox" style="height:7.795mm;border-top:1px solid black;
														  ...
														  border-top:0px solid black;width:41.40mm;font-size:7pt;">
																		<span style="vertical-align:baseline;height:100%;"/>
																		<xsl:call-template name="PopulateAdditionalDataTableMessage">
																			<xsl:with-param name="TargetNode" select="$FormData/IRS1065K1OtherDeductionsGrp/SchK1OtherDeductionsGrp"/>
																		</xsl:call-template>
																	</td>
																	<tr>
																		<td class="IRS1065ScheduleK1_codeBox" style="height:7.8mm;
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="border-bottom:0px solid lightgrey;">
													<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
														<tbody>
															<tr>
																<td class="IRS1065ScheduleK1_itemLabel" style="text-align:center;">14</td>
																<td style="font-size:7pt;">
														  ...
														  border-top:1px solid black;width:41.40mm;font-size:7pt;">
															...
															<xsl:for-each select="$FormData/IRS1065K1SelfEmplmnEarnLossGrp/SchK1SelfEmploymentEarnLossGrp">
																<xsl:if test="($Print != $Separated) or                                     (count($FormData/IRS1065K1SelfEmplmnEarnLossGrp/SchK1SelfEmploymentEarnLossGrp) &lt;=2)">
																	<xsl:choose>
																		<xsl:when test="position() = 1">
																			<tr>
																				<td class="IRS1065ScheduleK1_codeBox" style="height:4.35mm;border-top:0px solid;
															   font-size:7pt;" valign="bottom">
																					<xsl:call-template name="PopulateText">
																						<xsl:with-param name="TargetNode" select="SchK1SelfEmploymentEarnLossCd"/>
																					</xsl:call-template>
																				</td>
																				<td class="IRS1065ScheduleK1_amountBox" style="height:4.35mm;border-top:0px solid;
															   width:41.40mm;font-size:7pt;" valign="bottom">
																					<xsl:call-template name="PopulateAmount">
																						<xsl:with-param name="TargetNode" select="Amt"/>
																					</xsl:call-template>
																		...
																		<xsl:otherwise>
																			<tr>
																				<td class="IRS1065ScheduleK1_codeBox" style="height:7.7mm;border-top:1px solid black;
															  border-bottom:1px solid black; font-size:7pt;" valign="bottom">
																					<xsl:call-template name="PopulateText">
																						<xsl:with-param name="TargetNode" select="SchK1SelfEmploymentEarnLossCd"/>
																					</xsl:call-template>
																				</td>
																				<td class="IRS1065ScheduleK1_amountBox" style="height:7.7mm;border-top:1px solid black;
															  border-bottom:1px solid black; width:41.40mm;font-size:7pt;" valign="bottom">
																					<xsl:call-template name="PopulateAmount">
																						<xsl:with-param name="TargetNode" select="Amt"/>
																					</xsl:call-template>
																					<br/>
														  ...
														  border-top:0px solid black;width:41.40mm;font-size:7pt;">
																		<span style="vertical-align:baseline;height:100%;"/>
																		<xsl:call-template name="PopulateAdditionalDataTableMessage">
																			<xsl:with-param name="TargetNode" select="$FormData/IRS1065K1SelfEmplmnEarnLossGrp/SchK1SelfEmploymentEarnLossGrp"/>
																		</xsl:call-template>
																	</td>
																	<tr>
																		<td class="IRS1065ScheduleK1_codeBox" style="height:7.5mm;
														    border-top:1px solid black;border-right:0px solid black;font-size:7pt;">
																			<span style="vertical-align:baseline;height:100%;"/>
																		</td>
																		<td class="IRS1065ScheduleK1_amountBox" style="height:7.5mm;
														    border-top:1px solid black;width:41.40mm;font-size:7pt;">
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="border-bottom:0px solid lightgrey;">
													<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
														<tbody>
															<tr>
																<td class="IRS1065ScheduleK1_itemLabel" style="text-align:center;">15</td>
																<td style="font-size:7pt;">
														  ...
														  border-top:1px solid black;width:41.40mm;font-size:7pt;">
															...
															<xsl:for-each select="$FormData/IRS1065K1CreditsAndCrRcptrGrp/SchK1CreditsAndCrRcptrGrp">
															    ...
															    border-top:0px solid;font-size:7pt;" valign="bottom">
																				...
																				<td class="IRS1065ScheduleK1_amountBox" style="height:4.6mm;border-top:0px solid;
															   width:41.40mm;font-size:7pt;" valign="bottom">
																					<span style="float:left;padding-left:2px;">
																						<xsl:call-template name="SetFormLinkInline">
																							<xsl:with-param name="TargetNode" select="$FormData/IRS1065K1CreditsAndCrRcptrGrp"/>
																						</xsl:call-template>
																					</span>
																					<span style="float:right;">
																						<xsl:call-template name="PopulateAmount">
																		...
																		<xsl:otherwise>
																			<tr>
																				<td class="IRS1065ScheduleK1_codeBox" style="height:7.81mm;border-top:1px solid black;	
															    font-size:7pt;" valign="bottom">
																					<xsl:call-template name="PopulateText">
																						<xsl:with-param name="TargetNode" select="SchK1CreditsAndCrRcptrCd"/>
																					</xsl:call-template>
																				</td>
																				<td class="IRS1065ScheduleK1_amountBox" style="height:7.81mm;border-top:1px solid black;
															   width:41.40mm;font-size:7pt;" valign="bottom">
																					<xsl:call-template name="PopulateAmount">
																						<xsl:with-param name="TargetNode" select="Amt"/>
																					</xsl:call-template>
														  ...
														  border-top:0px solid black;width:41.40mm;font-size:7pt;">
																		<span style="vertical-align:baseline;height:100%;"/>
																		<xsl:call-template name="PopulateAdditionalDataTableMessage">
																			<xsl:with-param name="TargetNode" select="$FormData/IRS1065K1CreditsAndCrRcptrGrp/SchK1CreditsAndCrRcptrGrp"/>
																		</xsl:call-template>
																	</td>
																	<tr>
																		<td class="IRS1065ScheduleK1_codeBox" style="height:7.81mm;
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="border-bottom:0px solid lightgrey;">
													<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
													    ...
													    float:left;height:8mm;" valign="top">16</td>
																<td style="font-size:7pt;">
																	<span style="width:1mm;"/>Schedule K-3 is attached if<br/>
																	<span style="width:1mm;"/>checked
																	<span style="width:8px;"/>.
																	<span style="width:8px;"/>.
																	<span style="width:8px;"/>.
																	<span style="width:8px;"/>.
																	...
																	<input type="checkbox" class="styCkbox">
																		<xsl:call-template name="PopulateCheckbox">
																		<xsl:with-param name="TargetNode" select="$FormData/ScheduleK3AttachedInd"/>
																		<xsl:with-param name="BackupName">ScheduleK3AttachedInd
																		</xsl:with-param>
																	</xsl:call-template>
																	</input>
																</td>
...
<!--															--><!-- Display a blank line if there are no data elements --><!--
																...
																<xsl:if test="($Print != $Separated) or                              (count($FormData/SchK1ForeignTransactionsGrp) &lt;=6)">
																	<xsl:if test="CountryOrPossessionCd">
																		<xsl:choose>
																			<xsl:when test="position() = 1">
																				<tr>
																					<td class="IRS1065ScheduleK1_codeBox" style="height:4.5mm;border-top:0px solid;
																 font-size:7pt;" valign="bottom">
																						<xsl:call-template name="PopulateText">
																							<xsl:with-param name="TargetNode" select="CountryOrPossessionCd"/>
																						</xsl:call-template>
																					</td>
																					<td class="IRS1065ScheduleK1_amountBox" style="height:4.5mm;border-top:0px solid;
																 width:41.40mm;font-size:7pt;" valign="bottom">
																						<span style="float:left;padding-left:2px;">
																							<xsl:call-template name="SetFormLinkInline">
																							...
																							<span style="width:1mm"/>
																							<xsl:call-template name="SetFormLinkInline">
																								<xsl:with-param name="TargetNode" select="$FormData/SchK1ForeignTransactionsGrp/CountryOrPossessionCd"/>
																							</xsl:call-template>
																						</span>
																			...
																			<xsl:otherwise>
																				<tr>
																					<td class="IRS1065ScheduleK1_codeBox" style="height:7.81m;border-top:1px solid black;
																 font-size:7pt;" valign="bottom">
																						<xsl:call-template name="PopulateText">
																							<xsl:with-param name="TargetNode" select="CountryOrPossessionCd"/>
																						</xsl:call-template>
																 ...
																 width:41.40mm;font-size:7pt;" valign="bottom">
																						<span style="float:left;padding-left:2px;">
																							...
																							<span style="width:1mm"/>
																							<xsl:call-template name="SetFormLinkInline">
																								<xsl:with-param name="TargetNode" select="$FormData/SchK1ForeignTransactionsGrp/SchK1ForeignTransactionsCd"/>
																							</xsl:call-template>
																						</span>
																						<span style="float:right;">
																							<xsl:call-template name="PopulateAmount">
														 ...
														 border-top:1px solid black;font-size:7pt;">
														  ...
														  border-top:1px solid black;width:41.40mm;font-size:7pt;">
														    ...
														    border-top:0px solid;font-size:7pt;" valign="bottom">
																	...
																	<td class="IRS1065ScheduleK1_amountBox" style="height:4.5mm;
														    border-top:0px solid;width:41.40mm;font-size:7pt;" valign="bottom">
																		<span style="float:right;">
																			<xsl:call-template name="PopulateAdditionalDataTableMessage">
																				<xsl:with-param name="TargetNode" select="$FormData/SchK1ForeignTransactionsGrp"/>
																			</xsl:call-template>
											...
											<tr>
												...
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="border-bottom:0px solid lightgrey;">
													<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
														<tbody>
															<tr>
																<td class="IRS1065ScheduleK1_itemLabel" style="text-align:center;" valign="top">17</td>
																<td style="font-size:7pt;">
														  ...
														  border-top:1px solid black;width:41.40mm;font-size:7pt;">
															...
															<xsl:for-each select="$FormData/IRS1065K1AMTItemsGrp/SchK1AMTItemsGrp">
															    ...
															    border-top:0px solid;font-size:7pt;" valign="bottom">
																				...
																				<td class="IRS1065ScheduleK1_amountBox" style="height:4.2mm;border-top:0px solid;
															    width:41.40mm;font-size:7pt;" valign="bottom">
																					<span style="float:left;padding-left:2px;">
																						<xsl:call-template name="SetFormLinkInline">
																							<xsl:with-param name="TargetNode" select="$FormData/IRS1065K1AMTItemsGrp"/>
																						</xsl:call-template>
																					</span>
																					<span style="float:right;">
																						<xsl:call-template name="PopulateAmount">
																		...
																		<xsl:otherwise>
																			<tr>
																				<td class="IRS1065ScheduleK1_codeBox" style="height:7.87mm;border-top:1px solid black;
															    font-size:7pt;" valign="bottom">
																					<xsl:call-template name="PopulateText">
																						<xsl:with-param name="TargetNode" select="SchK1AMTItemsCd"/>
																					</xsl:call-template>
																				</td>
																				<td class="IRS1065ScheduleK1_amountBox" style="height:7.87mm;border-top:1px solid black;
															    width:41.40mm;font-size:7pt;" valign="bottom">
																					<xsl:call-template name="PopulateAmount">
																						<xsl:with-param name="TargetNode" select="Amt"/>
																					</xsl:call-template>
														  ...
														  border-top:0px solid black;width:41.40mm;font-size:7pt;">
																		<span style="vertical-align:baseline;height:100%;"/>
																		<xsl:call-template name="PopulateAdditionalDataTableMessage">
																			<xsl:with-param name="TargetNode" select="$FormData/IRS1065K1AMTItemsGrp/SchK1AMTItemsGrp"/>
																		</xsl:call-template>
																	</td>
																	<tr>
																		<td class="IRS1065ScheduleK1_codeBox" style="height:7.87mm;
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="border-bottom:0px solid lightgrey;">
													<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
														<tbody>
															<tr>
																<td class="IRS1065ScheduleK1_itemLabel" style="text-align:center;height:6.5mm;" valign="top">18</td>
																<td style="font-size:7pt;">
														  ...
														  border-top:1px solid black;width:41.40mm;font-size:7pt;">
															...
															<xsl:for-each select="$FormData/IRS1065K1TxExmptNondedExpnsGrp/SchK1TxExmptNondedExpnsGrp">
															    ...
															    width:41.40mm;font-size:7pt;" valign="bottom">
																					<span style="float:left;padding-left:2px;">
																						<xsl:call-template name="SetFormLinkInline">
																							<xsl:with-param name="TargetNode" select="$FormData/IRS1065K1TxExmptNondedExpnsGrp"/>
																						</xsl:call-template>
																					</span>
																					<xsl:call-template name="PopulateAmount">
																						<xsl:with-param name="TargetNode" select="Amt"/>
														  ...
														  border-top:0px solid black;width:41.40mm;font-size:7pt;">
																		<span style="vertical-align:baseline;height:100%;"/>
																		<xsl:call-template name="PopulateAdditionalDataTableMessage">
																			<xsl:with-param name="TargetNode" select="$FormData/IRS1065K1TxExmptNondedExpnsGrp/SchK1TxExmptNondedExpnsGrp"/>
																		</xsl:call-template>
																	</td>
																	<tr>
																		<td class="IRS1065ScheduleK1_codeBox" style="height:8mm;
														    border-top:1px solid black;font-size:7pt;" valign="bottom">
																		...
																		<td class="IRS1065ScheduleK1_amountBox" style="height:8mm;
														    border-top:1px solid black;width:41.40mm;font-size:7pt;" valign="bottom">
																			<span style="vertical-align:baseline;height:100%;"/>
																			<br/>
																		</td>
																	</tr>
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="border-bottom:0px solid lightgrey;">
													<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
														<tbody>
															<tr>
																<td class="IRS1065ScheduleK1_itemLabel" style="text-align:center;">19</td>
																<td style="font-size:7pt;">
															...
															<xsl:for-each select="$FormData/IRS1065K1DistributionsGrp/SchK1DistributionsGrp">
																<xsl:if test="($Print != $Separated) or                   (count($FormData/IRS1065K1DistributionsGrp/SchK1DistributionsGrp) &lt;=2)">
																  ...
																  width:41.40mm;font-size:7pt;" valign="bottom">
																						<span style="float:left;padding-left:2px;">
																							<xsl:call-template name="SetFormLinkInline">
																								<xsl:with-param name="TargetNode" select="$FormData/IRS1065K1DistributionsGrp"/>
																							</xsl:call-template>
																							<span style="width:1mm"/>
																							<xsl:call-template name="SetFormLinkInline">
																								<xsl:with-param name="TargetNode" select="$FormData/IRS1065K1DistributionsGrp/SchK1DistributionsGrp"/>
																							</xsl:call-template>
																						</span>
																						<span style="float:right;">
																							<xsl:call-template name="PopulateAmount">
																  ...
																  border-top:1px solid black;font-size:7pt;" valign="bottom">
																					...
																					<td class="IRS1065ScheduleK1_amountBox" style="height:8mm;border-top:1px solid black;
																  width:41.40mm;font-size:7pt;" valign="bottom">
																						<span style="float:left;padding-left:2px;">
																							<xsl:call-template name="SetFormLinkInline">
																								<xsl:with-param name="TargetNode" select="$FormData/IRS1065K1DistributionsGrp"/>
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="border-bottom:0px solid lightgrey;">
													<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
														<tbody>
															<tr>
																<td class="IRS1065ScheduleK1_itemLabel" style="text-align:center;">20</td>
																<td style="font-size:7pt;">
															...
															<xsl:if test="count($FormData/IRS1065K1OtherInformationGrp/SchK1OtherInformationGrp) = 0 ">
																<tr>
																	<td class="IRS1065ScheduleK1_codeBox" style="height:8.6mm;border-top:0px solid;font-size:7pt;">
																		<span style="vertical-align:baseline;height:100%;"/>
																	</td>
																	<td class="IRS1065ScheduleK1_amountBox" style="height:8.6mm;border-top:0px solid;width:41.40mm;font-size:7pt;">
																		<span style="vertical-align:baseline;height:100%;"/>
																	</td>
																</tr>
																<!-- Add 3 blank rows -->
														  ...
														  border-top:1px solid black;width:41.40mm;font-size:7pt;">
															...
															<xsl:for-each select="$FormData/IRS1065K1OtherInformationGrp/SchK1OtherInformationGrp">
															    ...
															    border-top:0px solid;font-size:7pt;" valign="bottom">
																				...
																				<td class="IRS1065ScheduleK1_amountBox" style="height:8.6mm;border-top:0px solid;width:41.40mm;
															    font-size:7pt;" valign="bottom">
																					<span style="float:left;padding-left:2px;">
																						<xsl:call-template name="SetFormLinkInline">
																							<xsl:with-param name="TargetNode" select="$FormData/IRS1065K1OtherInformationGrp"/>
																						</xsl:call-template>
																						<span style="width:1mm;"/>
																					</span>
																					<span style="float:right;">
															    ...
															    border-top:1px solid black;font-size:7pt;" valign="bottom">
																				...
																				<td class="IRS1065ScheduleK1_amountBox" style="height:7.6mm;border-top:1px solid black;
															    width:41.40mm;font-size:7pt;" valign="bottom">
																					<xsl:call-template name="PopulateAmount">
																						<xsl:with-param name="TargetNode" select="Amt"/>
																					</xsl:call-template>
														  ...
														  border-top:0px solid black;width:41.40mm;font-size:7pt;">
																		<span style="vertical-align:baseline;height:100%;"/>
																		<xsl:call-template name="PopulateAdditionalDataTableMessage">
																			<xsl:with-param name="TargetNode" select="$FormData/IRS1065K1OtherInformationGrp/SchK1OtherInformationGrp"/>
																		</xsl:call-template>
																	</td>
																	<tr>
																		<td class="IRS1065ScheduleK1_codeBox" style="height:7.6mm;
														    ...
														    border-top:1px solid black;font-size:7pt;" valign="bottom">
																		...
																		<td class="IRS1065ScheduleK1_amountBox" style="height:7.6mm;
														    border-top:1px solid black;width:41.40mmfont-size:7pt;" valign="bottom">
																			<span style="vertical-align:baseline;height:100%;"/>
																			<br/>
																		</td>
																	</tr>
											...
											<tr>
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="border-bottom:0px solid lightgrey;">
													<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
														<tbody>
															<tr>
																<td class="IRS1065ScheduleK1_itemLabel" style="text-align:center;">21</td>
																<td style="font-size:7pt;">
																	<span style="width:1mm;"/>Foreign taxes paid or accrued</td>
															</tr>
															<!-- Display a blank line if there are no data elements -->
								...
								<tr>
									<td colspan="2" style="font-family: Verdana; font-size: 7pt;text-align: left;border-top: 1px solid black;padding-top:2mm;">
										<!-- Line 22 -->
										<span style="font-weight: bold; width: 2mm;">22</span>
										<span style="width: 1mm;"/>
										<span style="width: 80mm;">
											<input type="checkbox" class="styckbox" name="checkbox" id="dummyid">
												<xsl:call-template name="PopulateCheckbox">
											...
											<label>
												<xsl:call-template name="PopulateLabel">
													<xsl:with-param name="TargetNode" select="$FormData/Sect465AtRiskAggregatedActyInd"/>
													<xsl:with-param name="BackupName">
													  IRS1065ScheduleK1Sect465AtRiskAggregatedActyInd</xsl:with-param>
												</xsl:call-template>
								...
								<tr>
									<td colspan="2" style="font-family: Verdana; font-size: 7pt;text-align:">
										<!-- Line 23 -->
										<span style="font-weight: bold; width: 2mm;">23</span>
										<span style="width: 1mm;"/>
										<span style="width: 80mm;">
											<input type="checkbox" class="styckbox" name="checkbox" id="dummyid">
												<xsl:call-template name="PopulateCheckbox">
											...
											<label>
												<xsl:call-template name="PopulateLabel">
													<xsl:with-param name="TargetNode" select="$FormData/Sect469PALGroupedActyInd"/>
													<xsl:with-param name="BackupName">
													  IRS1065ScheduleK1Sect469PALGroupedActyInd</xsl:with-param>
												</xsl:call-template>
					...
					<tr>
					    ...
					    font-size: 6pt;font-weight: bold; border-top: 1px solid black;">
							<span style="width: 87mm;">For Paperwork Reduction Act Notice, see
						   Instructions for Form 1065.
						</span>
							<span style="font-weight: normal;width: 33mm;">www.irs.gov/Form1065</span>
							<span style="font-weight: normal; width: 25mm;">Cat. No. 11394R</span>
							<span style="width: 40mm;">Schedule K-1 (Form 1065) 2022</span>
						</td>
					</tr>
				</table>
