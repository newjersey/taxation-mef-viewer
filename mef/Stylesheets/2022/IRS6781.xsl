...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
				...
				<form name="Form6781">
					...
					<div class="styTBB" style="width:187mm;">
						...
						<div class="styTYBox" style="width:30mm;height:21mm;">
							...
							<div class="styIRS6781Attachment" style="font-family:arial">Attachment<br/>Sequence No. 
								<span class="styBoldText">82</span>
							</div>
						</div>
					</div>
					...
					<div class="styBB" style="width:187mm;font-size:6pt;height:10mm">
						...
						<div class="styGenericDiv" style="width:65mm;">
							...
							<span style="width:12px;"/>
							<input type="checkbox"  alt="Straddleby-straddle Identification Election Indicator" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
								...
								<xsl:if test="($Print != $Separated) or (count($Form6781Data/Section1256CntrctsAcctInfoGrp) &lt;= 3) ">
									<xsl:for-each select="$Form6781Data/Section1256CntrctsAcctInfoGrp">
										<tr>
											...
											<td class="styTableCell" style="width:37mm;background-color:lightgrey;border-left-width:1px;border-bottom:0px;border-right:0px;">
											</td>
										</tr>
									</xsl:for-each>
								</xsl:if>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:134mm;padding-top:1mm;height:9mm;">
						  ...
						  <span style="float:left;">be carried back.  Enter the loss as a positive number.
						   If you didn't check box D, enter -0-</span>
							<span class="styDotLn" style="float:right;padding-right:1mm;">....</span>
						</div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:134mm;height:4mm;">
							<b>Short-term capital gain or (loss).</b>  Multiply line 7 by 40% (0.40). Enter here and include on line 4 of
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styLNDesc" style="width:134mm;height:4mm;">
							<b>Long-term capital gain or (loss).</b> Multiply line 7 by 60% (0.60). Enter here and include on line 11 of  
							<span style="float:left;">Schedule D or on Form 8949 (see instructions)</span>
							<span class="styDotLn" style="float:right;padding-right:1mm;">.................</span>
						</div>
					...
					<!-- END PART II TITLE -->
					<div class="styBB" style="width:187mm;">
						<div class="styIRS6781SectionDesc" style="width:183mm;float:left;clear:left;height:4mm">Section A&#8212;Losses From Straddles
						</div>
					...
					<div class="styTableContainer" style="height:auto" id="LFSctn">
						...
						<table class="styTable" cellspacing="0" style="border-color:black;">
							<thead class="styTableThead">
								<tr>
								<th class="styTableCellHeader" scope="col" style="width:32mm;"> (a) <span class="styNormalText"> Description of property</span></th>
								<th class="styTableCellHeader" scope="col" style="width:17mm;"> (b)<span class="styNormalText"> Date entered into or acquired</span></th>							
								<th class="styTableCellHeader" scope="col" style="width:17mm;"> (c)<span class="styNormalText"> Date closed out or sold</span></th>
								<th class="styTableCellHeader" scope="col" style="width:24mm;"> (d) <span class="styNormalText">  Gross sales price</span></th>
								<th class="styTableCellHeader" scope="col" style="width:24mm;"> (e)<span class="styNormalText">  Cost or other basis plus expense of sale</span></th>
								<th class="styTableCellHeader" scope="col" style="width:24mm;"> (f)  Loss. <span class="styNormalText">  If column (e) is more than (d), enter difference. Otherwise, enter -0-</span></th>								
								<th class="styTableCellHeader" scope="col" style="width:24mm;"> (g) <span class="styNormalText">  Unrecognized gain on offsetting positions</span></th>	
								<th class="styTableCellHeader" scope="col" style="width:24mm;border-right-width:0mm"> (h) Recognized loss.<span class="styNormalText">  If column (f) is more than (g), enter difference.  Otherwise, enter -0-</span></th>	
								</tr>
							</thead>
							<tfoot/>
					...
					<!-- 
					  START Line 11a - The three amount boxes in this line must be the same width as the last three columns of the
					 "Part II Section A table" when the "Part II Section A table" is in an expanded format. Therefore 5pt Verdana font 
						is used for these amount boxes.
					-->
					<div style="width:187mm;">
  ...
  <!-- Line 13a  -->
					...
					<div class="styTableContainer" style="width:187mm;" id="UGSctn">
						<!-- print logic -->
						<xsl:call-template name="SetInitialState"/>
						<!-- end -->
						<table class="styTable" cellspacing="0" style="border-color:black;">
							<thead class="styTableThead" id="UGSctn" >
								<tr>
					...
					<div style="width:187mm;">
					   ...
					   <span style="width:40mm"/>  
						  Form <span class="styBoldText" style="font-size:8pt">6781</span> (2022 )
					</div>
					<div class="pageEnd"/>
