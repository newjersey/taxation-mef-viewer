...
<!-- Last Modified by Eugenia McDonald on 04/05/2021 -->
		  ...
		  <body class="styBodyClass" style="width:187mm;">
				...
				<div style="width:187mm;">				
					...
					<div class="styTBB" style="width:187mm;">
					  <div class="styFNBox" style="width:33mm;font-size:7pt:height:22.3mm;border-right:0px;">
						...
						<div style="height:6mm;padding-top:2mm;">
						  ...
						  <span class="styAgency" style="width:32mm;">Internal Revenue Service <span style="padding-left:1mm;"> (99)</span></span>
						</div>
					  </div>
					  <div class="styFTBox" style="width:120mm;height:21mm;border-left:1px solid black;">
						...
						<div class="styFST" style="height:auto;font-size:7pt;">
						  ...
						  File only with Schedule C (Form 1040). Use a separate Form 8829 for <br/>
						  each home you used for business during the year.
						</div>
						<div class="styFST" style="height:auto;font-size:7pt;padding-top:1mm;">
						  
						  Go to <i><a href="http://www.irs.gov/form8829">www.irs.gov/Form8829</a> for instructions and the latest information.</i>
						</div>
					  ...
					  <div class="styTYBox" style="width:32mm;height:21mm;">
						...
						<div class="styOMB" style="padding-top:4mm;height:6mm;text-align:left;padding-left:5mm;border-bottom-width:0px;line-height:110%;">
						  Attachment <br/>Sequence No. <span class="styBoldText">176</span>
						</div>
					  </div>
					</div>
					<div style="width:187mm;" class="styBB">
					  <div style="width:138mm;height:11.5mm;font-weight:normal;font-size:7pt;" class="styNameBox">
					   Name(s) of proprietor(s)
					   <div style="width:10mm;height:1mm;"/>
						<span style="width:110mm;text-align:left;">
                               		     <xsl:choose>
                               		              <!-- Name from Form level -->
                                                          <xsl:when test="$FormData/NameOfProprietor != '' ">
                                                                 <span style="padding-top:1.5mm;">
                                                                       ...
                                                                       <xsl:with-param name="TargetNode" select="$FormData/NameOfProprietor"/>
                                                                                           ...
                                                                                           <!-- Name from Form level -->
                                                                                      <xsl:when test="$FormData/ProprietorNm != '' ">
						...
						Your social security number<br/><br/>
						                                    ...
						                                    <!-- HIgh Level SSN -->
						                                     <xsl:when test="$FormData/SSN != '' ">
						                                       ...
						                                       <!-- Name from 1040/1040NR Return Header -->
						                                          <xsl:when test="$FormData/SocialSecurityNumber != '' ">
                                                                             <xsl:call-template name="PopulateSSN">
					  ...
					  <div class="styPartDesc" style="padding-left:3mm;height:auto;">Part of Your Home Used for Business</div>
						...
						<div style="width:187mm;clear:all;">        
							...
							<div style="width:90mm;float:left;padding-top:0.5mm;padding-bottom:.5mm;">
							  ...
							  <span style="float:left;">see instructions; otherwise, enter 8,760</span>
							  <span class="styDotLn" style="float:right;padding-right:1mm;">.........</span>      
							</div>
							<div style="float:right;">
				...
				<div style="width:187mm;" class="styBB">
				 ...
				 <div style="width:187mm;clear:all;">        
					...
					<div style="float:left;padding-top:0.5mm;padding-bottom:.5mm;width:137mm;height:auto;">
						 ...
						 <b>minus</b> any loss from the trade or business not derived from the business use of your home</span>
				   ...
				   <div class="styGenericDiv" style="width:187mm;clear:all;">
						   <div class="styLNDesc" style="padding-left:8mm;width:60mm;height:6mm;">
							   <b>See instructions for columns (a) and (b) before completing lines 9&#45;22.</b>
						   </div>
				...
				<!-- End Line 10 -->
				   ...
				   <div class="styGenericDiv" style="width:187mm;clear:all;">
				    ...
				    <div class="styGenericDiv" style="width: 187mm;clear:all;">
						 ...
						 <div class="styLNDesc" style="width:56mm;">
							   <span style="float:left;">Excess real estate taxes (see instructions)</span>							  
						 </div>
						 <div class="styLNRightNumBox" style="border-bottom-width:1px;border-top-width:0px;border-left-width:1px;border-right-width:0px;">17</div>
						 <div class="styLNAmountBox" style="width:37mm;border-left-width1px; border-top-width:0px;border-right-width:0px;">
								 <xsl:call-template name="PopulateAmount">
										  <xsl:with-param name="TargetNode" select="$FormData/ExcessRealEstateTxsDirectAmt"/>
								 </xsl:call-template>
						 </div>
						 <div class="styLNAmountBox" style="width:36mm;border-left-width;1px; border-top-width:0px;border-right-width:0px;">
								 <xsl:call-template name="PopulateAmount">
										  <xsl:with-param name="TargetNode" select="$FormData/ExcessRealEstateTxsIndirectAmt"/>
								 </xsl:call-template>
						  </div>
						  <div class="styLNRightNumBoxNBB" style="background-color:lightgrey;"/>
						  <div class="styLNAmountBoxNBB" style="width:34mm;"/>
				    ...
				    <div class="styGenericDiv" style="width: 187mm;clear:all;">
					    ...
					    <div class="styLNRightNumBox" style="padding-left:mm; border-bottom-width:1px;border-top-width:0px;border-left-width:1px;border-right-width:0px;height:4.8mm;">19</div>
						<div class="styLNAmountBox" style="font-weight:normal;width:37mm;border-left-width1px; border-top-width:0px;border-right-width:0px;height:4.8mm;">
							  <xsl:call-template name="PopulateAmount">
				    ...
				    <div class="styGenericDiv" style="width: 187mm;clear:all;">
					    ...
					    <div class="styLNRightNumBox" style="padding-left:mm; border-bottom-width:1px;border-top-width:0px;border-left-width:1px;border-right-width:0px;height:4.9mm;">21</div>
					    <div class="styLNAmountBox" style="font-weight:normal;width:37mm;border-left-width1px; border-top-width:0px;border-right-width:0px;height:4.9mm;">
							 <xsl:call-template name="PopulateAmount">
				    ...
				    <div class="styGenericDiv" style="width: 187mm;clear:all;">
					     ...
					     <div class="styLNDesc" style="width:56mm; ;">
							 <span style="float:left;">Add lines 16 through 22</span>
							 <span  class="styDotLn" style="float:right;padding-right:1mm;">.....</span>
						 </div>
					     <div class="styLNRightNumBox" style="padding-left:mm; border-bottom-width:1px;border-top-width:0px;border-left-width:1px;border-right-width:0px;height:4.8mm;">23</div>
					     <div class="styLNAmountBox" style="font-weight:normal;width:37mm;border-left-width1px; border-top-width:0px;border-right-width:0px;height:4.8mm;">
								 <xsl:call-template name="PopulateAmount">
				    ...
				    <div class="styGenericDiv" style="width: 187mm;clear:all;">
						 ...
						 <div class="styLNDesc" style="width:93.1mm;">
								 <span style="float:left;">Multiply line 23, column (b) by line 7</span>
								 <span  class="styDotLn" style="float:right;padding-right:1mm;">..........</span>
						  </div>
				    ...
				    <div class="styGenericDiv" style="width: 187mm;clear:all;">
						 ...
						 <div class="styLNDesc" style="width:93.1mm;">
						  ...
						  <span class="styLNRightNumBox" style="border-bottom-width:1px;border-top-width:0px;border-right-width:0px;border-left-width:1px;height:4mm;padding-top:1mm;">25
						  </span>
					...
					<!-- Line 26 -->
					 <div style="width:187mm;clear:all;">        
						...
						<div style="width:136mm;float:left;padding-top:0.5mm;padding-bottom:.5mm;">
						   <span style="float:left;">Add line 23, column (a), line 24, and line 25 </span>
						   <span  class="styDotLn" style="float:right;padding-right:1mm;">..................</span>
						</div>
						<div style="float:right;">
				   ...
				   <div style="width:187mm;clear:all;">        
						...
						<div style="width:136mm;float:left;padding-top:0.5mm;padding-bottom:.5mm;">
						   <span style="float:left;">Allowable operating expenses. Enter the <b>smaller</b> of line 15 or line 26  </span>
						   <span  class="styDotLn" style="float:right;padding-right:1mm;">..........</span>
						</div>
						<div style="float:right;">
				    ...
				    <div style="width:187mm;clear:all;">        
						...
						<div style="width:136mm;float:left;padding-top:0.5mm;padding-bottom:.5mm;">
						   <span style="float:left;">Limit on excess casualty losses and depreciation. Subtract line 27 from line 15 </span>
						   <span  class="styDotLn" style="float:right;padding-right:1mm;">.......</span>
						</div>
						<div style="float:right;">
				    ...
				    <div style="width:187mm;clear:all;">        
						...
						<div style="width:90mm;float:left;padding-top:0.5mm;padding-bottom:.5mm;">
							 <span style="float:left;">Depreciation of your home from line 42 below</span>
							 <span  class="styDotLn" style="float:right;padding-right:1mm;">.......</span>
						</div>
						<div style="float:right;">
						  <div class="styLNRightNumBox" style="height:4.8mm;">30</div>  
						  <div class="styLNAmountBox" style="height:4.8mm;">
						  <xsl:call-template name="PopulateAmount">
				    ...
				    <div style="width:187mm;clear:all;">        
						...
						<div style="float:right;">
							 <div class="styLNRightNumBox" style="height:7mm;padding-top:3mm;">31</div>  
				    ...
				    <div style="width:187mm;clear:all;">        
						...
						<div style="width:136mm;float:left;padding-top:0.5mm;padding-bottom:.5mm;">
						   <span style="float:left;">Add lines 29 through 31</span>
						   <span class="styDotLn" style="float:right;padding-right:1mm;">.........................</span>
						</div>
						<div style="float:right;">
				    ...
				    <div style="width:187mm;clear:all;">        
						...
						<div style="width:136mm;float:left;padding-top:0.5mm;padding-bottom:.5mm;">
						   <span style="float:left;">Allowable excess casualty losses and depreciation. Enter the <b>smaller </b> of line 28 or line 32  </span>
						   <span  class="styDotLn" style="float:right;padding-right:1mm;">...</span>
						</div>
						<div style="float:right;">
				    ...
				    <div style="width:187mm;clear:all;">        
						...
						<div style="width:136mm;float:left;padding-top:0.5mm;padding-bottom:.5mm;">
							   <span style="float:left;">Add lines 14, 27, and 33  </span>
							   <span  class="styDotLn" style="float:right;padding-right:1mm;">........................</span>
						</div>
						<div style="float:right;">
				    ...
				    <div style="width:187mm">        
						...
						<div style="width:136mm;float:left;padding-top:0.5mm;padding-bottom:.5mm;">
						  Casualty loss portion, if any, from lines 14 and 33. Carry amount to <b>Form 4684</b> (see instructions) 
						   <span style=" letter-spacing:3.2mm; font-weight:bold; padding-left:3mm; "/>
						</div>
						<div style="float:right;">
					...
					<div style="width:187mm" class="styBB">        
						...
						<div style="width:136mm;float:left;padding-top:0.5mm;padding-bottom:0mm; width:137mm;height:auto;">
						  <b>Allowable expenses for business use of your home.</b> Subtract line 35 from line 34. Enter here and
					on Schedule C, line 30. If your home was used for more than one business, see instructions
						...
						<div class="styLNRightNumBoxNBB" style="background-color:lightgrey;height:4mm;"/>
						  <div class="styLNAmountBoxNBB" style="width:34mm;height:4mm;"/>
						  <div class="styLNRightNumBox" style="height:atuo;border-bottom-width:0px;">36</div>
				    ...
				    <div style="width:187mm;clear:all;height:auto;">        
						...
						<div style="width:136mm;float:left;padding-top:0.5mm;padding-bottom:.5mm;height:auto;">
							<span style="float:left;">Value of land included on line 37 </span> 
						   <span class="styDotLn" style="float:right;padding-right:1mm;">......................</span>
						</div>
						<div style="float:right;">
						  <div class="styLNRightNumBox" style="height:4mm;">38</div>
				    ...
				    <div style="width:187mm;clear:all;">        
						<div class="styLNLeftNumBox">39</div>
							<div style="width:136mm;float:left;padding-top:0.5mm;padding-bottom:.5mm;">
							   <span style="float:left;">Basis of building. Subtract line 38 from line 37</span>  
							   <span class="styDotLn" style="float:right;padding-right:1mm;">..................</span>
							</div>
							<div style="float:right;">
				    ...
				    <div style="width:187mm;border-bottom-width:0px; ">        
						...
						<div style="width:136mm;float:left;padding-top:0.5mm;padding-bottom:.5mm;">
						   <span style="float:left;">Business basis of building. Multiply line 39 by line 7</span>  
						   <span class="styDotLn" style="float:right;padding-right:1mm;">................</span>
						</div>
						<div style="float:right;">
				    ...
				    <div style="width:187mm;border-bottom-width:0px;">        
							...
							<div style="width:136mm;float:left;padding-top:0.5mm;padding-bottom:.5mm;">
							<span style="float:left;">Depreciation allowable (see instructions). Multiply line 40 by line 41. Enter here and on line 30 </span><br/>
							...
							<div style="float:right;">
							  <div class="styLNRightNumBox" style="border-bottom-width:0px;height:8mm;padding-top:4mm;">42</div>
				    ...
				    <div class="styBB" style="width:187mm;border-top-width: 1px;">
						  ...
						  <div class="styPartDesc" style="padding-left:3mm;height:auto;">
						   Carryover of Unallowed Expenses to 2023
						  </div>
				    </div>
				<div style="width:187mm;" class="styBB">
				<!-- Line 43 -->
				<div style="width:187mm">        
					  ...
					  <div style="width:136mm;float:left;padding-top:0.5mm;padding-bottom:.5mm;">
						   <span style="float:left;">Operating expenses. Subtract line 27 from line 26. If less than zero, enter -0- </span> 
						   <span class="styDotLn" style="float:right;padding-right:1mm;">.......</span>
					  </div>
					  <div style="float:right;">
				...
				<div style="width:187mm">        
					...
					<div style="float:right;">
					  <div class="styLNRightNumBox" style="border-bottom-width:0px;">44</div>
				...
				<div style="width:187mm;clear:both;">
					  ...
					  <div style="float:right;" class="styGenericDiv">Form <span class="styBoldText">8829</span> (2022)</div>
				</div>
				</div>
