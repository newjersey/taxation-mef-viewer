      ...
      Form 
            <span class="styFormNumber">1065</span>
						...
						<div class="styTYBox" style="width:30mm;height:20mm;">
							...
							<div class="styTY" style="height:11mm;">20<span class="styTYColor">22</span>
							</div>
						</div>
					</div>
					<div style="width:187mm;float:left;clear:left;">
						<div style="width:34mm;height:30mm;float:left;clear:left;">
							<div class="styEINDateAssets" style="width:34mm;height:16mm;border-top-width:1px;">
                ...
                <br/>
						...
						<div class="styLblNameAddr" style="border-width:1px;width:118.5mm;height:auto;">
							<div class="styUseLbl" style="width:15mm;height:42mm;border-right-width:0px;font-size:6pt;padding-top:6mm">
							   <br/><br/><br/><span style="width:3.5mm"/>Type<br/><span style="width:5.5mm"/>or 
							   <br/><span style="width:3.5mm"/>Print
                            </div>
							<div class="styNameAddr" style="width:102.5mm;height:12mm;font-size:8px;border-left-width:1px;padding-left:1px;">Name of partnership<br/>
							...
							<div class="styNameAddr" style="width:102.5mm;height:12mm;border-left-width:1px;">
							...
							<div class="styNameAddr" style="border-bottom-width:0px;width:89mm;height:18mm;border-left-width:1px;">City or town, state or 
province, country, and ZIP or foreign postal code<br/><br/>
						...
						<div class="styEINDateAssets" style="width:34mm;height:12.2mm;padding-left:.5mm;border-top-width:1px;">
						...
						<div class="styEINDateAssets" style="width:34mm;height:12mm;padding-left:.5mm">
						...
						<div class="styEINDateAssets" style="width:34mm;height:18.2mm;
						  border-bottom-width:1px;padding-left:.5mm">
							<span class="styBoldText">F</span> Total assets<br/>
							  <span style="padding-left:2mm">(see instructions)</span>
							<br/><br/><br/><span style="float:left;padding-left:2mm;padding-top:5mm">$</span>
      ...
      Number of Schedules K-1. Attach one for each person who was a partner at any time during the tax year 
					...
					<div class="styBB" style="width:187mm;">
						...
						<div style="width:181mm;float:right;clear:none;">
							...
							<div class="styLNAmountBox" style="height:4.5mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form1065Data/BadDebtExpenseAmt"/>
								</xsl:call-template>
							</div>
						</div>
						<div style="width:181mm;float:right;clear:none;">
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;">
						...
						<div style="float:right;">
							<span style="width:40px;"/>  
							  Form <span class="styBoldText" style="font-size:8pt;">1065</span> (2022)
						</div>
					</div>
					<p style="page-break-before: always"/>
					...
					<div class="styBB" style="width:187mm;padding-top:.5mm;">
						<div style="float:left;">Form 1065 (2022)<span style="width:148mm;"/>
						</div>
...
<!-- End Set Initial Height of Above Table -->
					...
					<div class="styBB" style="width:187mm">
						...
						<div class="styLNDesc" style="height:9mm;width:167mm">
							At any time during calendar year 2022 
					...
					<div style="width:187mm;padding-left:4.5mm;">
						...
						<div class="styLNDesc" style="height:7mm;width:162.5mm">
						  The partnership's aggregate average annual gross receipts (determined under section 448(c)) for the 3 tax years
							preceding the current tax year are more than $27 million and the partnership has business interest.
						</div>
						<div class="styIRS1065LNYesNoBox" style="height:7mm;background:gray;border-bottom:0"/>
						<div class="styIRS1065LNYesNoBox" style="height:7mm;background:gray;border-bottom:0"/>
					</div>
					...
					<div class="styBB" style="width:187mm">
						...
						<div class="styIRS1065LNYesNoBox" style="height:10mm;background:gray;border-bottom:0"/>
						<div class="styIRS1065LNYesNoBox" style="height:10mm;background:gray;border-bottom:0"/>
					</div>
					<!-- SCHEDULE B Line 27-->
					<div class="styBB" style="width:187mm">
					...
					<!-- SCHEDULE B Line 30-->
					<div style="width:187mm">
						<div class="styLNLeftNumBox" style="height:4mm; padding-left:1.5mm;padding-top:1mm;">30</div>
					...
					<div class="styBB" style="width:187mm;">
								...
								<!-- Begin Schedule K section "International Transactions", Line 16 -->


										<div class="styIRS1065VTImageBox" style="width:11mm;height:19mm;border-bottom:1px solid black;padding-left:.5mm;padding-top:1mm;">
											<img src="{$ImagePath}/1065_Transactions.gif" alt="International Transactions"/>
										</div>
										<div style="border-bottom:1px solid black;height:19mm;">
											<div class="styLNLeftNumBox" style="padding-top:5mm;">16</div>
											<div class="styIRS1065LNDesc" style="width:124.5mm;padding-top:5mm;">
											...
											<xsl:call-template name="LinkToLeftoverDataTableInline">
												<xsl:with-param name="Desc">
												  Form 1065, Schedule K, Line 16 - International Tax Relevance Reporting Indicator</xsl:with-param>
												<xsl:with-param name="TargetNode" select="$Form1065ScheduleK/IntntlTaxRelevanceRptgInd/@desc"/>
											</xsl:call-template>
											<xsl:call-template name="SetFormLinkInline">
												<xsl:with-param name="TargetNode" select="$Form1065ScheduleK/IntntlTaxRelevanceRptgInd"/>
											</xsl:call-template>
											<span style="float:right;padding-left:4px;">
												<span class="styIRS1065DotLn">....</span>
											<input class="styCkBox" alt="IntntlTaxRelevanceRptgInd" type="checkbox" name="Checkbox">
												<xsl:call-template name="PopulateCheckbox">
													<xsl:with-param name="TargetNode" select="$Form1065ScheduleK/IntntlTaxRelevanceRptgInd"/>
													<xsl:with-param name="BackupName">IRS1065IntntlTaxRelevanceRptgInd</xsl:with-param>
												</xsl:call-template>
											</input>
											</span>
											</div>
										<div class="styLNRightNumBox" style="width:11.5mm;height:19mm;background-color:lightgrey;"/>
										<div class="styLNAmountBox" style="height:19mm;background-color:lightgrey"/>
										</div>
								...
								<!-- Begin Schedule K section "Other Information", Line 18a-21 -->

									<div class="styIRS1065VTImageBox" style="width:11mm;height:40mm;padding-left:3mm;padding-top:5mm;">
								...
								<!-- Schedule K, Line 20c -->
										...
										<div class="styLNRightNumBox" style="width:11.5mm;height:4.5mm;background-color:lightgrey;"/>
								...
								<!-- Schedule K, Line 21 -->
										...
										<div class="styIRS1065LNDesc" style="width:124.5mm;">Total foreign taxes paid or accrued
										<span style="float:right;">
											<span class="styIRS1065DotLn">...................</span>
										</span>
										</div>
										<div class="styLNRightNumBoxNBB" style="width:11.5mm;height:4.5mm;">21</div>
										<div class="styLNAmountBoxNBB" style="height:4.5mm;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$Form1065ScheduleK/TotalForeignTaxesPaidOrAccrAmt"/>
											</xsl:call-template>
										</div>
				...
				<div style="width:187mm;">
					<div class="styBB" style="width:187mm;">
						<div class="styPartDesc" style="width:187mm;padding-left:0mm;">Analysis of Net Income (Loss) per Return
						</div>
					</div>
					<!--  Line 1 -->
					<div style="width: 187mm">
						...
						<div class="styLNDesc">
						 Net income (loss). Combine Schedule K, lines 1 through 11. From the result, subtract the sum of
						    <br/>Schedule K, lines 12 through 13d, and 21
						    <span class="styBoldText">
							...
							<tbody>
								...
								<tr class="styGenericDiv">
									...
									<td class="styLNDesc" style="width:57mm;padding-left:4mm;padding-bottom:0mm;" colspan="2">
									  ...
									  included on Schedule K, lines 1 through 13d, and 21 (itemize):
										<xsl:call-template name="SetFormLinkInline">
							...
							<tbody>
								...
								<tr class="styGenericDiv">
									...
									<td class="styLNDesc" style="height:12mm;width:57mm;padding-left:4mm;padding-bottom:0mm;" colspan="2">
									  ...
									  through 13d, and 21, not charged against
					...
					<div style="width:187mm;border-style:solid;border-color:black;border-width:0px 0px 1px 0px">
						...
						<table class="styTable" style="width:93.5mm;float:left;clear:none;font-size:7pt;" cellspacing="0">
							...
							<tr class="styGenericDiv">
								...
								<td class="styLNDesc" style="width:57mm;padding-left:4mm;padding-bottom:0mm;" colspan="2">
									<span style="float:left;clear:none;">Net income (loss) (see instructions)</span>
									<!--Dotted Line-->
									<span class="styDotLn" style="float:right;clear:none;padding-right:2mm;">.</span>
								</td>
								<td class="styLNAmountBox" style="border-right-width:1px;padding-bottom:0mm;">
