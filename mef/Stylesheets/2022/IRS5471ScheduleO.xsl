	...
	<xsl:template match="/">
			...
			<body class="styBodyClass" style="width:187mm;">
				<form name="Form5471_ScheduleO">
						...
						<div class="styEINBox" style="padding-left:1mm;width:43mm;height:8mm;">
							...
							<span style="font-weight:normal;">
								...
								<!-- TIN from Form level -->
									...
									<xsl:when test="$Form5471ScheduleO/MissingEINReasonCd != '' ">
										<xsl:call-template name="PopulateText">
					...
					<div class="styBB" style="width:187mm;font-size:8pt;padding-top:2mm;padding-bottom:2mm;">
						...
						<span style="font-weight:bold;">separate</span> Schedule O for each foreign corporation for which information must be reported.</span>
					</div>
					<div class="styBB" style="width:187mm;">
						...
						<table class="styTable" cellspacing="0">
							<thead class="styTableThead">
								<tr>
									...
									<th class="styTableCellHeader" style="width:20mm;border-right-width:0mm;" scope="col">(e)<br/>
								...
								<xsl:for-each select="$Form5471ScheduleO/ShrInfoUSOfficerDirInfoGrp">
									...
									<xsl:if test="($Print != $Separated) or (count($Form5471ScheduleO/ShrInfoUSOfficerDirInfoGrp) &lt;=4)">
										<tr style="font-size: 7pt;">
											...
											<td class="styTableCellCtr" style="width:20mm;text-align:center;padding-left:1mm;border-right-width:0mm;">
												<xsl:call-template name="PopulateText">
					...
					<div class="styBB" style="width:187mm;">
						<div class="styGenericDiv" style="width:187mm;font-size:8pt;padding-left:27mm;">
							<span>
								<b>Note:</b>
								<i> If this return is required because one or more shareholders became U.S. persons, attach a list showing the names of such
								...
								<thead class="styTableThead">
									<tr>
										...
										<th class="styTableCellHeader" style="width:95mm;" colspan="3" scope="col">(b)<br/>
											<span class="styNormalText">For shareholder&#8217;s latest U.S. income tax return filed, indicate:</span>
										</th>
										<th class="styTableCellHeader" style="width:25mm;border-right-width:0mm" rowspan="2" scope="col">(c)<br/>
									...
									<xsl:for-each select="$Form5471ScheduleO/GeneralShareholderInfoGrp">
										...
										<xsl:if test="($Print != $Separated) or (count($Form5471ScheduleO/GeneralShareholderInfoGrp) &lt;=3)">
											<tr style="font-size: 7pt;">
												...
												<td class="styTableCellText" style="width:20mm;border-right-width:0mm">
													<xsl:call-template name="PopulateText">
							...
							<table class="styTable" cellspacing="0">
								<thead class="styTableThead">
									<tr>
										...
										<th class="styTableCellHeader" style="width:22mm;border-right-width:0mm" colspan="2" scope="col">(d)<br/>
									...
									<tr>
										...
										<th class="styTableCellHeader" style="width:11mm;border-right-width:0mm" scope="col">
									...
									<xsl:for-each select="$Form5471ScheduleO/USPrsnOfcrDirectorFrgnCorpGrp">
										...
										<xsl:if test="($Print != $Separated) or (count($Form5471ScheduleO/USPrsnOfcrDirectorFrgnCorpGrp) &lt;=3)">
											<tr style="font-size: 7pt;">
												...
												<td class="styTableCellCtr" style="width:11mm;border-right-width:0mm">
													<xsl:call-template name="PopulateText">
						...
						<table class="styTable" cellspacing="0">
							<thead class="styTableThead">
								<tr>
									...
									<th class="styTableCellHeader" scope="col" style="width:75mm;border-right-width:0mm" colspan="3">(e)<br/>
								...
								<tr>
									...
									<th class="styTableCellHeader" scope="col" style="width:25mm;border-top-width:1px;border-right-width:0mm">(3)<br/>
					...
					<!-- 06/22/2017 WT: Padding-top:4.5mm added for separated display -->
					<div class="pageEnd" style="width:187mm;float:none;clear:both;padding-top:4.5mm;">
						...
						<table class="styTable" cellspacing="0" cellpadding="0" border="0">
							<thead class="styTableThead">
								<tr>
									...
									<th class="styTableCellHeader" scope="col" style="width:141mm;border-right-width:0mm;border-bottom-width:mm">(g)<br/>
								...
								<xsl:for-each select="$Form5471ScheduleO/ShareholderStockAcquisInfoGrp">
									...
									<xsl:if test="($Print != $Separated) or (count($Form5471ScheduleO/ShareholderStockAcquisInfoGrp) &lt;=3)">
										<tr style="font-size: 7pt;">
											...
											<td class="styTableCell" style="width:142mm;text-align:left;border-right-width:0mm">
					...
					<div class="styTableContainer" id="USSP2E1ctn" style="height:auto">
						<!-- print logic -->
						<xsl:call-template name="SetInitialState"/>
						<!-- end -->
						<table class="styTable" cellspacing="0">
							<thead class="styTableThead">
								<tr>
									...
									<th class="styTableCellHeader" scope="col" style="width:20mm; padding-left: 4mm;border-right-width:0mm">(c)<br/>
								...
								<xsl:for-each select="$Form5471ScheduleO/OrgReorganizationFrgnCorpGrp">
									...
									<xsl:if test="($Print != $Separated) or (count($Form5471ScheduleO/OrgReorganizationFrgnCorpGrp) &lt;=3)">
										<tr style="font-size: 7pt;">
											...
											<td class="styTableCellHeader" style="width:20mm;border-right-width:0mm">
												<xsl:call-template name="PopulateText">
						...
						<table class="styTable" cellspacing="0" cellpadding="0" border="0">
							<thead class="styTableThead">
								<tr>
									...
									<th class="styTableCellHeader" scope="col" rowspan="2" style="width:53mm;border-right-width:0mm">(e)<br/>
					...
					<table cellspacing="0" cellpadding="0" border="0">
						...
						<tr>
							<td class="styBB" style="width:187mm;font-size:7pt;">
								<span class="styBoldText">(b)</span> List the date of any reorganization of the foreign corporation that occured during the last 4 years while any U.S. person held 10% or more in value or vote (directly or indirectly) of the corporation's stock 
									<img src="{$ImagePath}/1120S_Bullet_Md.gif" alt="Right Arrow graphic"/>
								<!--<img src="{$ImagePath}/5471SchO_bullet.gif" alt="right arrow graphic"/>-->
								<span style="width:4px"/>
								<xsl:call-template name="PopulateText">
						...
						<tr>
							<td class="styBB" style="width:187mm;font-size:7pt;">
								<span class="styBoldText">(c)</span> If the foreign corporation is a member of a group constituting a chain of ownership, attach a chart, for each unit of which a shareholder owns 10% or more in value or voting power of the outstanding stock. The chart must indicate the corporation's position
        in the chain of ownership and the percentages of stock ownership (see instructions for an example).
							...
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<th class="styDepTblCell" style="width:130mm;" rowspan="2" scope="col">
										<br/>
										<br/>
										<br/>(a)<br/>Name, address, and identifying number of <br/>shareholder(s) filing this schedule
									</th>
									<th class="styDepTblCell" style="width:95mm;" colspan="3" scope="col">
										<br/>(b)<br/>For shareholders latest U.S. income tax return filed, indicate: 
									</th>
									<th class="styDepTblCell" style="width:20mm;" rowspan="2" scope="col">
										<br/>(c)<br/>Date (if any) shareholder last filed information return under section 6046 for the foreign  corporation
									</th>
								</tr>
								<tr class="styDepTblHdr">
					...
					<xsl:if test="($Print = $Separated) and  (count($Form5471ScheduleO/USPrsnOfcrDirectorFrgnCorpGrp) &gt; 3)">
						<br/>
						<br/>
						<span class="styRepeatingDataTitle">Form 5471 Schedule O, Part II, Section B&#8212;U.S. Persons Who Are Officers or Directors of the Foreign Corporation:
						</span>
						<table class="styDepTbl" style="font-size:7pt;" cellspacing="0">
							<!-- Label the Column Headers -->
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<th class="styDepTblCell" style="width:67mm;" rowspan="2" scope="col">
										<br/>(a)<br/>Name of U.S. officer or director
									</th>
									<th class="styDepTblCell" style="width:67mm;" rowspan="2" scope="col">
										<br/>(b)<br/>Address
									</th>
									<th class="styDepTblCell" style="width:30mm;" rowspan="2" scope="col">
										<br/>(c)<br/>Social Security Number
									</th>
									<th class="styDepTblCell" style="width:22mm;" colspan="2" scope="col">(d)<br/>Check appropriate <br/>box(es)</th>
								</tr>
								<tr class="styDepTblHdr">
									<th class="styDepTblCell" style="width:11mm;" scope="col">Officer</th>
									<th class="styDepTblCell" style="width:11mm;" scope="col">Director</th>
								</tr>
							</thead>
							<tfoot/>
							<tbody>
							...
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<th class="styDepTblCell" scope="col" style="width:45mm;" rowspan="2">
										<br/>(a)<br/>Name of shareholder(s) filing this schedule
									</th>
									<th class="styDepTblCell" scope="col" style="width:25mm;" rowspan="2">
										<br/>(b)<br/>Class of stock acquired
									</th>
									<th class="styDepTblCell" scope="col" style="width:25mm;" rowspan="2">
										<br/>(c)<br/>Date of acquisition
									</th>
									<th class="styDepTblCell" scope="col" style="width:25mm;" rowspan="2">
										<br/>(d)<br/>Method of acquisition
									</th>
									<th class="styDepTblCell" scope="col" style="width:75mm;" colspan="3">
										<br/>(e)<br/>Number of shares acquired
									</th>
								</tr>
								<tr class="styDepTblHdr">
									<th class="styDepTblCell" scope="col" style="width:25mm;">(1)<br/>Directly</th>
									<th class="styDepTblCell" scope="col" style="width:25mm;">(2)<br/>Indirectly</th>
									<th class="styDepTblCell" scope="col" style="width:25mm;">(3)<br/>Constructively</th>
								</tr>
							</thead>
							<tfoot/>
							<tbody>
					...
					<xsl:if test="($Print = $Separated) and  (count($Form5471ScheduleO/ShareholderStockAcquisInfoGrp) &gt; 3)">
						...
						<table class="styDepTbl" style="font-size:7pt;border-color:black;" cellspacing="0">
							...
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<th class="styDepTblCell" scope="col" style="width:45mm;">(f)<br/>Amount paid or value given</th>
									<th class="styDepTblCell" scope="col" style="width:141mm;">(g)<br/>Name and address of person from whom shares were acquired</th>
								</tr>
							</thead>
							<tfoot/>
							<tbody>
					...
					<xsl:if test="($Print = $Separated) and  (count($Form5471ScheduleO/ShareholderStockDisposInfoGrp) &gt; 3)">
						...
						<table class="styDepTbl" style="font-size:7pt;" cellspacing="0">
							...
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<th class="styDepTblCell" scope="col" style="width:45mm;" rowspan="2">
										<br/>(a)<br/>Name of shareholder(s) disposing of stock
									</th>
									<th class="styDepTblCell" scope="col" style="width:25mm;" rowspan="2">
										<br/>(b)<br/>Class of stock
									</th>
									<th class="styDepTblCell" scope="col" style="width:25mm;" rowspan="2">
										<br/>(c)<br/>Date of disposition
									</th>
									<th class="styDepTblCell" scope="col" style="width:25mm;" rowspan="2">
										<br/>(d)<br/>Method of disposition
									</th>
									<th class="styDepTblCell" scope="col" style="width:75mm;" colspan="3">(e)<br/>Number of shares disposed of </th>
								</tr>
								<tr class="styDepTblHdr">
									<th class="styDepTblCell" scope="col" style="width:25mm;">(1)<br/>Directly</th>
									<th class="styDepTblCell" scope="col" style="width:25mm;">(2)<br/>Indirectly</th>
					...
					<xsl:if test="($Print = $Separated) and  (count($Form5471ScheduleO/ShareholderStockDisposInfoGrp) &gt; 3)">
						...
						<table class="styDepTbl" style="font-size:7pt;" cellspacing="0">
							...
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<th class="styDepTblCell" scope="col" style="width:45mm;">(f)<br/>Amount received </th>
									<th class="styDepTblCell" scope="col" style="width:141mm;">(g)<br/>Name and address of person to whom disposition of stock was made        </th>
								</tr>
							</thead>
							<tfoot/>
							<tbody>
					...
					<xsl:if test="($Print = $Separated) and  (count($Form5471ScheduleO/OrgReorganizationFrgnCorpGrp) &gt; 3)">
						...
						<table class="styDepTbl" style="font-size:7pt;" cellspacing="0">
							...
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<th class="styDepTblCell" scope="col" style="width:134mm;">(a)<br/>Name and address of transferor</th>
									<th class="styDepTblCell" scope="col" style="width:32mm;">(b)<br/>Identifying number (if any)</th>
									<th class="styDepTblCell" scope="col" style="width:20mm;">(c)<br/>Date of transfer</th>
								</tr>
							</thead>
							<tfoot/>
							<tbody>
					...
					<xsl:if test="($Print = $Separated) and  (count($Form5471ScheduleO/OrgReorganizationFrgnCorpGrp) &gt; 3)">
						...
						<table class="styDepTbl" style="font-size:7pt;" cellspacing="0">
							...
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<th class="styDepTblCell" scope="col" colspan="3" style="width:134mm;">(d)<br/>Assets transferred to foreign corporation</th>
									<th class="styDepTblCell" scope="col" rowspan="2" style="width:52mm;">(e)<br/>Description of assets transferred by, or notes or securities issued by, foreign corporation 
									</th>
								</tr>
								<tr class="styDepTblHdr">
									<th class="styDepTblCell" scope="col" style="width:45mm;">(1)<br/>Description of assets</th>
									<th class="styDepTblCell" scope="col" style="width:44mm;">(2)<br/>Fair market value</th>
									<th class="styDepTblCell" scope="col" style="width:45mm;">(3)<br/>Adjusted basis (if transferor was U.S. person)</th>
								</tr>
							</thead>
							<tfoot/>
							<tbody>
