			...
			<body class="styBodyClass" style="width:187mm;">
				<form name="Form1120ScheduleD">
					...
					<div class="styBB" style="width:187mm;border-bottom-width:2px;">
						<div class="styFNBox" style="width:32mm;height:19mm;border-right-width:.5mm">
					...
					<div class="styFTBox" style="width:122.5mm;height:19mm;">
						...
						<div class="styFST" style="font-size:7pt;text-align:center;">
							...
							<!--<img src="{$ImagePath}/1120SchD_Bullet.gif" alt="Right arrow"/> --> 
							  Attach to Form 1120, 1120-C, 1120-F, 1120-FSC, 1120-H, 1120-IC-DISC, 1120-L,<br/> 1120-ND, 1120-PC, 1120-POL, 1120-REIT, 1120-RIC, 1120-SF, or certain Forms 990-T.
							<br/><br/>
							<span style="height:5mm;">
								<!--<img src="{$ImagePath}/1120SchN_Bullet_Title.gif" alt="Right arrow"/> -->
								  Go to
					...
					<div class="styTYBox" style="width:30mm;height:19mm;border-left-width:.5mm;">
						...
						<div class="styTY" style="padding-top:1mm;height:14mm;">20<span class="styTYColor">22</span></div>
					</div>
				</div>
				<!-- END FORM HEADER -->
				<!-- BEGIN TAXPAYER INFO -->
				<div style="width:187mm;float:left;clear:left;border-top:1 solid black;">
					...
					<!-- END TAXPAYER INFO -->
          <!-- Qurstion in qualified opportunity fund -->
					<div style="width:187mm;border-style: solid; border-color: black;border-top-width: 1px; border-bottom-width: 0px; border-left-width: 0px; border-right-width: 0px;">
						...
						<xsl:with-param name="TargetNode" select="$FormData/DisposeInvestmentQOFInd"/>
									...
									<input type="checkbox" alt="Dispose Investment QOF Yes Indicator" class="styCkbox" name="Checkbox">
									<xsl:call-template name="PopulateYesCheckbox">
									<xsl:with-param name="TargetNode" select="$FormData/DisposeInvestmentQOFInd"/>
									<xsl:with-param name="BackupName">DisposeInvestmentQOFIndYes</xsl:with-param>
								</xsl:call-template>
							</input>
							<label>
								<xsl:call-template name="PopulateLabelYes">
									<xsl:with-param name="TargetNode" select="$FormData/DisposeInvestmentQOFInd"/>
									<xsl:with-param name="BackupName">DisposeInvestmentQOFIndYesLabel</xsl:with-param>
								</xsl:call-template>
						...
						<xsl:with-param name="TargetNode" select="$FormData/DisposeInvestmentQOFInd"/>
							...
							<input type="checkbox" alt="Dispose Investment QOF No Indicator" class="styCkbox" name="Checkbox">
								<xsl:call-template name="PopulateNoCheckbox">
								<xsl:with-param name="TargetNode" select="$FormData/DisposeInvestmentQOFInd"/>
									<xsl:with-param name="BackupName">DisposeInvestmentQOFIndNo</xsl:with-param>
								</xsl:call-template>
							</input>
							<label>
								<xsl:call-template name="PopulateLabelNo">
									<xsl:with-param name="TargetNode" select="$FormData/DisposeInvestmentQOFInd"/>
									<xsl:with-param name="BackupName">DisposeInvestmentQOFIndNoLabel</xsl:with-param>
								</xsl:call-template>
								<span style="width:1mm;"/>
								No
							</label>
					...
					<table class="styTable" style="width:187mm;border-color:black;font-size:7pt;" cellspacing="0" >
						...
						<tr style="height:20mm;vertical-align:top;">
							<td class="IRS1120ScheduleD_styLNCtrNumNBox" style="height:25mm;">1a</td>
						...
						<tr style="vertical-align:top;">
							<td class="IRS1120ScheduleD_styLNCtrNumNBox" style="height:7mm;">1b</td>
							<td class="IRS1120ScheduleD_DescCol" scope="row" style="width:48mm;">
						...
						<!--line 2-->
						<tr style="vertical-align:top;">
							<td class="IRS1120ScheduleD_styLNCtrNumNBox" style="height:7mm;">2</td>
							<td class="IRS1120ScheduleD_DescCol" scope="row" style="width:48mm;">
						...
						<!--line 3-->
						<tr style="vertical-align:top;">	
							<td class="IRS1120ScheduleD_styLNCtrNumNBox" style="height:7mm;">3</td>
							<td class="IRS1120ScheduleD_DescCol" scope="row" style="width:48mm;">
					...
					<!-- END LINE 5 -->
					<!-- BEGIN LINE 6 :EXCEPTION Per Gwen Chambliss' email response to IBM Defect 20437 dated 9/19/08 to allow the descrepancy between Schema and Style 
					  sheet. Where Schema efile data type as USAMOUNT which allow neg and pos amount present in a hardcode bracket line and Style sheet guideline indicate only
					  pos amount allow in a hard coded bracket line.-->
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
					...
					<table class="styTable" style="width:187mm;border-color:black;font-size:7pt;" cellspacing="0">
						<tr valign="top" style="width:187mm;">
							<th class="IRS1120ScheduleD_DescCol" style="padding-left:8.5mm;" colspan="2" scope="col">
							<b>See instructions for how to figure the	amounts to enter on the lines below.</b><br/><br/>					
							    This form may be easier to complete if you round off cents to whole dollars.
							</th>
							<th class="IRS1120ScheduleD_DescColBody" style="text-align:center;" scope="col">
								<b>(d)<br/>
							...
							<th class="IRS1120ScheduleD_DescColBody" style="text-align:left;border-right-width:0px;" scope="col">
								<b>(h) Gain or (loss)</b> <br/>Subtract column (e) from column (d) and combine the result with column (g) 
							</th>
						</tr>
						<!-- part II  body -->
						<!--Line 8a-->
						<tr style="height:20mm;vertical-align:top;">
							<td class="IRS1120ScheduleD_styLNCtrNumNBox" style="height:25mm;">8a</td>
							<td class="IRS1120ScheduleD_DescCol" scope="row" style="width:48mm;">
						...
						<!--Line 8b-->
						<tr style="vertical-align:top;">
							<td class="IRS1120ScheduleD_styLNCtrNumNBox" style="height:7mm;">8b</td>		
							<td class="IRS1120ScheduleD_DescCol" scope="row" style="width:48mm;">
						...
						<!--Line 9-->
						<tr style="vertical-align:top;">		
							<td class="IRS1120ScheduleD_styLNCtrNumNBox" style="height:7mm;">9</td>					
							<td class="IRS1120ScheduleD_DescCol" scope="row" style="width:48mm;">
						...
						<!--Line 10-->
						<tr style="vertical-align:top;">		
						<td class="IRS1120ScheduleD_styLNCtrNumNBox" style="height:7mm;padding-left:2.75mm;">10</td>
						    <td class="IRS1120ScheduleD_DescCol" scope="row" style="width:48mm;">
					...
					<div style="width:187mm;">
					<div style="float:left;clear:none;">
						<div class="styLNLeftNumBoxSD" style="height:4mm;">18</div>
						<div class="styLNDesc" style="width:141mm;">
						...
						<div style="float:right;clear:none;">
						<div class="styLNRightNumBox" style="height:4mm;width:4.75mm;">18</div>
						<div class="IRS1120ScheduleD_styLNAmountBox" style="height:4mm;">
							<xsl:call-template name="PopulateAmount">
					...
					<div class="IRS1120ScheduleD_styFormFooter">
						...
						<span style="width:42mm;text-align:right;float:right;">Schedule D (Form 1120) 2022</span>
					</div>
					<!-- BEGIN FOOTER -->
				</form>
				<br class="pageEnd" style="display:block"/>				
				<!-- added part IV on new page per UWR 182767 -->
				<!-- deleted part IV page per UWR 198911 7/13/17 -->
				<!-- leftover data table -->
