...
<!-- Updated by Doyle Roach 05/1/2022 UWR  # 374367 -->
              ...
              Form<span class="styFormNumber">6252</span>
						...
						<div class="styFTBox" style="width:125mm;height:21.5mm;">
							...
							<div class="styFST" style="font-size:7pt;">
								<img src="{$ImagePath}/6252_Bullet.gif" alt="Medium Right Arrow Image"/> Attach to your tax return.
              </div>
              <br/>
							<div class="styFST" style="font-size:6.2pt;padding-top:4mm;">
								<img src="{$ImagePath}/6252_Bullet.gif" alt="Medium Right Arrow Image"/> Use a separate form for each sale or other disposition of property on the installment method.
							</div>
						<div class="styFST" style="font-size:6.2pt;">
								<img src="{$ImagePath}/6252_Bullet.gif" alt="Medium Right Arrow Image"/>
				 Go to 
	...
	<xsl:with-param name="BackupName">First Dispos Sale Exchange</xsl:with-param>								</xsl:call-template>
                ...
                Enter the <span class="styBoldText">smaller</span> of line 30 or line 31      
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139mm;">
								<span style="float:left;backg">Total payments received by the end of your 2022 tax year (see instructions) </span>
								<!--Dotted Line-->
								<div class="styDotLn" style="float:right;padding-right:1mm;">........</div>
							</div>
              ...
              Form <span class="styBoldText">6252</span> (2022)
            </div>
					</div>
