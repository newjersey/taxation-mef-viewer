    ...
    <div class="styBB" style="width:187mm;height:22.5mm;">
      ...
      <div class="styFTBox" style="width:126mm;height:22.5mm;">
        <div class="styMainTitle" style="height:5mm;margin-top:0mm;padding-left:3px;">
          <div style="width:126mm;float:left;clear:none;vertical-align:top;padding-top:1mm;text-align:center;"> Earned Income Credit  </div> 
          ...
          <div style="width:126mm;font-size:9pt;margin-top:0mm;font-weight:normal;vertical-align:top;float:left;clear:none;padding-bottom:2mm;text-align:center;">
          Qualifying Child Information</div>
		  
		  <div class="styFBT" style="width:126mm;font-size:7pt;margin-top:0mm;font-weight:normal;float:left;text-align:center;font-weight: bold;">
		    <!--<img src="{$ImagePath}/1040SchEIC_Bullet_Sm.gif" alt="right arrow image" style="margin-right:2px;font-weight: bold;"/>-->
		    Complete and attach to Form 1040 or 1040-SR only if you have a qualifying child.</div>
		  <div class="styFBT" style="width:126mm;font-size:7pt;margin-top:0mm;font-weight:normal;float:left;text-align:center;font-family:Arial Narrow;font-size:7pt;font-weight: bold;">
		    <!--<img src="{$ImagePath}/1040SchEIC_Bullet_Sm.gif" alt="right arrow image" style="margin-right:2px;font-weight: bold;"/>-->
...
<div class="styLNDesc" style="width:149mm;height:23mm;">
         <span style="width:149mm;"><img src="{$ImagePath}/1040_EIC_Bullet_Round.gif" alt="Round Bullet"/>
			See the instructions for Form 1040 line 27, to make sure that <b>(a) </b>you can take the EIC, and <b>(b) </b>you have a qualifying child.
		</span>         
        <span style="width:149mm;"><img src="{$ImagePath}/1040_EIC_Bullet_Round.gif" alt="Round Bullet"/>
     ...
     <div class="styBB" style="width:187mm;border-bottom-width:1px">
		...
		<div class="styLNDesc" style="width:172mm;height:20mm;padding-top:3mm;">       
			...
			<span style="width:172mm;"><img src="{$ImagePath}/1040_EIC_Bullet_Round.gif" alt="Round Bullet"/> If your child doesn't have an SSN as defined in the instructions for Form 1040, line 27, see the instructions. </span>         
...
<!--Line 2-->
        <tr>
            ...
            <td scope="row" style="width:75mm;border-bottom:1px solid black;padding-top:1mm:padding-left:0mm;">
				...
				<span style="font-weight:normal;"> The child must have an SSN as defined in the 
					instructions for Form 1040 line 27, unless the child was 
					born and died in 2022 or you are claiming the self-only EIC (see instructions). 
					If your child was born and died in 2022 and did not have an SSN, enter 
            ...
            <xsl:if test="count($Form1040ScheduleEICData/QualifyingChildInformation/ChildBirthYr) &lt;1">   
				<td style="width:34mm;border-left:1px solid black;border-bottom:3px solid black;padding-top:1mm;text-align:left;padding-left:1mm;">      
					...
					<div style="font-size: 6pt;padding-top:1.0mm;padding-bottom:1mm;text-align:left;color:black;">
						<i>If born after 2003 <b>and</b> the child is younger than you (or your spouse, if filing jointly), skip lines 4a and 4b; go to line 5.</i>      
					</div>	                             
				</td>   
				<td style="width:34mm;border-left:1px solid black;border-bottom:3px solid black;padding-top:1mm;text-align:left;padding-left:1mm;">  		  
					Year  <span style="width:2mm;">              
		...
		<tr>
            ...
            <td style="height:4.0mm;width:75mm;border-bottom:1px solid black;vertical-align:top;padding-top:1mm;">
				<span style="font-size:7pt;">Was the child under age 24 at the end of <br/>2022, a student, and younger than you (or your spouse, if filing jointly)? </span>           
            </td>	
...
<xsl:with-param name="TargetNode" select="$Form1040ScheduleEICData/QualifyingChildInformation[1]/ChildIsAStudentUnder24Ind"/>
        ...
        <tr>
            ...
            <td style="height:4.0mm;width:75mm;vertical-align:top;padding-top:1mm;border-bottom:3px solid black;">
				Was the child permanently and totally disabled during any part of 2022? 
            </td>    
  ...
  <tr>
    <td style="vertical-align:top;width:4mm;padding-top:1mm;padding-left:1.5mm;"><b>6</b></td>
       <td style="width:75mm;border-bottom-width:0px;padding-top:1mm">
             ...
             <span style="font-size:9pt;"><b>you in the United States during 2022</b></span><br/><br/>
             <span style="width:65mm;"><img src="{$ImagePath}/1040_EIC_Bullet_Round.gif" alt="Round Bullet"/> If the child lived with you for more than half of<br/>
				2022 but less than 7 months, enter "7".</span>         
			 <span style="width:65mm;padding-top:2mm;"><img src="{$ImagePath}/1040_EIC_Bullet_Round.gif" alt="Round Bullet"/> If the child was born or died in 2022 and your<br/>
			home was the child's home for more than half the<br/>
			time he or she was alive during 2022, enter "12."<br/></span> 
   </td> 
   ...
   <div class="styFixedUnderline" style="width:187mm;padding-top:0mm;height:0.5mm;border-bottom-width:0px;border-top-width:1px;">  
    <!-- Footer-->   
      ...
      <div style="float:right;">
        ...
        <span class="styBoldText">Schedule EIC (Form 1040) 2022 </span>
      </div>    
          </div>   
    <br/> <br/>
