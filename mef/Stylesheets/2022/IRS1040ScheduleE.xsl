				...
				<form id="IRS1040ScheduleE">
					...
					<div class="styBB" style="width:187mm;border-bottom-width:1px;">
						...
						<div class="styTableContainer" style="width:188mm;border-bottom-width:1px;height:auto;" id="PICctn">
							<!--<xsl:call-template name="SetInitialState"/> ss 2022.06.25 -->
							...
							<div style="width:187mm;height:auto;">
								<div style="float:left;">
									...
									<div class="styLnDesc" style="padding-top:.5mm;width:141.8mm;padding-left:2mm;height:5mm;">
										<span class="styBoldText">Income.</span> Add positive amounts shown on line 21. <span class="styBoldText">Do not</span> include any losses
									<span class="styDotLn" style="float:right;clear:none;padding-right:1mm;">.........</span>
									</div>
								</div>
								<div class="styLNRightNumBox" style="width:5.5mm;height:5mm;">
						...
						<div class="styBB" style="width:187mm;height:13mm;float:left;clear:none;">
							<div style="width:187mm;">
								<div style="float:left;">
								   ...
								   line 5. Otherwise, include this amount in the total on line 41 on page 2
								   <xsl:call-template name="LinkToLeftoverDataTableInline">
											<xsl:with-param name="Desc">Part I, Line 26 Total Income Or Loss Amount: Nonpassive Activity Literal </xsl:with-param>
											<xsl:with-param name="TargetNode" select="$FormData/TotalIncomeOrLossAmt/@nonpassiveActivityLiteralCd"/>
										</xsl:call-template>
										<xsl:call-template name="LinkToLeftoverDataTableInline">
											<xsl:with-param name="Desc">Part I, Line 26 Total Income Or Loss Amount: Nonpassive Activity Amount</xsl:with-param>
					...
					<div class="pageEnd" style="width:187mm;page-break-after:always;display:block;">
                          <span class="styBoldText" style="width:95mm;padding-top:.5mm;float:left;clear:none;font-size:6.5pt;">
                        ...
                        <span class="styBoldText" style="font-size:7pt;padding-top:.0mm;padding-left:5mm;float:right;">Schedule E (Form 1040) 2022</span>
                    </div>
					<p class="pageEnd" style="page-break-after:always;display:block;"/>
					<!-- end page 1 footer -->
					<!-- Page 2 -->
					<div class="styTBB" style="height:5.5mm;width:187mm;">
						<span style="float:left;clear:none;padding-top:1mm;">Schedule E (Form 1040) 2022</span>
                  ...
                  If you answered "Yes," see instructions before completing this section.        
					...
					<div class="styBB" style="width:187mm;border-bottom-width:0px" id="sCorpContainerId">
						<table style="float:none;clear:both;" class="styTable" cellspacing="0">
							<thead class="styTableThead">
								<tr style="height:7mm;">
									<th class="styTableCellHeader" scope="col" style="width:5mm;border-right-width:0px;height:9mm;float:left;padding-top:2.5mm">
									...
									<xsl:for-each select="$FormData/PartnershipOrSCorpGroup">
										<tr style="height:11mm;">
											...
											<td class="styTableCell" style="width:32mm;height:11mm;text-align:center;float:center;clear:none;border-right-width:0px;font-size:7pt;vertical-align:top;">
												<!-- Checkbox -->
												<input type="Checkbox"  class="styCkbox">
												<xsl:attribute name="alt">BasisComputationRequired <xsl:number format="A" value="position()"/></xsl:attribute>
													<xsl:call-template name="PopulateCheckbox">
					...
					<div class="styBB" style="width:187mm;border-bottom-width:0px;">
						...
						<div class="styFNBox" style="width:75.2mm;text-align:center;border-right-width:1px;height:4mm;border-bottom-width:1px;">
							<span class="styBoldText" style="font-size:8pt;">Passive Income and Loss</span>
						</div>
						<div class="styFNBox" style="width:106mm;text-align:center;border-right-width:0px;height:4mm;border-bottom-width:1px;">
							<span class="styBoldText" style="font-size:8pt;float:center;">Nonpassive Income and Loss</span>
							...
							<table class="styTable" style="float:none;clear:both;" cellspacing="0">
								<thead class="styTableThead">
									<tr style="height:auto;">
										...
										<th class="styTableCellHeader" scope="col" style="width:43mm;clear:none;height:8.5mm;">
										...
										<th class="styTableCellHeader" scope="col" style="width:33.5mm;border-right-width:1px;clear:none;height:8.5mm;">
											<span style="padding-left:2mm;padding-right:1mm;">
										...
										<th class="styTableCellHeader" scope="col" style="width:33.5mm;clear:none;height:8.5mm;">
                                            										
										        	<span style="font-weight:bold;">(i) <span class="styNormalText">Nonpassive loss</span>
												</span>
												<span style="float:center;">
													<span style="font-weight:normal;padding-right:1mm;">allowed</span>
													    <span style="font-weight:normal">(see <b>Schedule K1</b>)</span>   
												</span>
										...
										<th class="styTableCellHeader" scope="col" style="width:33.5mm;border-right-width:0px;clear:none;">
											<span style="padding-left:2mm;padding-right:1mm;">
								...
								<tbody>
									<xsl:if test="($Print != $Separated) or (count($FormData/PartnershipOrSCorpGroup) &lt;= 4) ">
										<xsl:for-each select="$FormData/PartnershipOrSCorpGroup">
											<tr>
												...
												<!-- Column 2 -->
												<td class="styTableCell" style="width:43mm;height:5mm;clear:none;font-size:7pt;">
													<!-- Form to Form Link -->
													<xsl:call-template name="SetFormLinkInline">
												...
												<!-- Column 3 -->
												<td class="styTableCell" style="width:33.5mm;height:5mm;clear:none;font-size:7pt;">
													<xsl:call-template name="PopulateAmount">
												...
												<!-- Column 6 -->
												<td class="styTableCell" style="width:33.5mm;height:5mm;clear:none;border-right-width:0px;font-size:7pt;padding-right:1mm">
													<xsl:call-template name="PopulateAmount">
									...
									<xsl:if test="count($FormData/PartnershipOrSCorpGroup) &lt; 1 or ((count($FormData/PartnershipOrSCorpGroup) &gt; 4) and ($Print = $Separated))">
										<tr>
											<td class="styTableCell" style="width:43mm;width:5mm;height:4mm;float:left;clear:none;">
											...
											<td class="styTableCell" style="width:33.5mm;height:4mm;clear:none;text-align:left;">
												<xsl:call-template name="PopulateAdditionalDataTableMessage">
													<xsl:with-param name="TargetNode" select="$FormData/PartnershipOrSCorpGroup"/>
												</xsl:call-template>
												<span class="styTableCellPad"/>
											</td>
											<td class="styTableCell" style="width:33.5mm;height:4mm;clear:none;">
												<span class="styTableCellPad"/>
											</td>
											<td class="styTableCell" style="width:33.5mm;height:4mm;clear:none;">
												<span class="styTableCellPad"/>
											...
											<td class="styTableCell" style="width:33.5mm;height:4mm;clear:none;border-right-width:0px;">
												<span class="styTableCellPad"/>
											</td>
										</tr>
									</xsl:if>
									<xsl:if test="count($FormData/PartnershipOrSCorpGroup) &lt; 2 or ((count($FormData/PartnershipOrSCorpGroup) &gt; 4) and ($Print = $Separated))">
										<tr>
											...
											<td class="styTableCell" style="width:43mm;height:4mm;clear:none;">
												<span class="styTableCellPad"/>
											</td>
											<td class="styTableCell" style="width:33.5mm;height:4mm;clear:none;">
												<span class="styTableCellPad"/>
						...
						<div style="width:187mm">
							<div style="width:187mm;border-right-width:0px;height:auto;">
								<div style="float:left;clear:none;height:auto;">
									...
									<div class="styShadingCell" style="width:29.5mm;border-bottom-width:1px;height:5mm;"/>
									<!-- Column 29a (g) total -->
									<div class="styLNAmountBox" style="width:33.5mm;height:5mm;font-size:7pt;border-right-width:0px;">
										<xsl:call-template name="PopulateAmount">
									...
									<div style="float:left;clear:none;height:auto;">
										<div class="styShadingCell" style="width:67mm;border-bottom-width:1px;height:5mm;font-size:7pt;border-right-width:0px;"/>
										<div class="styLNAmountBox" style="width:33.5mm;height:5mm;padding-right:1mm;">
											<xsl:call-template name="PopulateAmount">
									...
									<div style="width:10.2mm;padding-top:.5mm;float:left;clear:none;">Totals</div>
									<!-- Column 29b (f) total -->
									<div class="styLNAmountBox" style="font-size:7pt;width:29.5mm;height:4.5mm;">
										<xsl:call-template name="PopulateAmount">
									...
									<div class="styShadingCell" style="height:4.5mm;width:33.5mm;border-bottom-width:1px;"/>
                     ...
                     32
									...
									<tr>
										...
										<th class="styTableCellHeader" scope="col" style="width:36.5mm;border-right-width:0px;clear:none;">
											<span style="font-weight:bold;">(b) <span class="styNormalText"> Employer </span>
												<span style="font-weight:normal;padding-left:1mm"> identification number</span>
											</span>
											<!--<span>
						...
						<div class="styBB" style="width:187mm;border-bottom-width: 1px;">
							...
							<div class="styFNBox" style="width:84.4mm;text-align:center;border-right-width:0px;height:4mm;border-bottom-width:1px;">
								<div class="styBoldText" style="font-size:8pt;float:center">Nonpassive Income and Loss</div>
                  ...
                  Income or Loss From Real Estate Mortgage Investment Conduits (REMICs)-Residual Holder 
									...
									<tr style="width:187mm;">
										...
										<th class="styTableCellHeader" style="width:32mm;border-right-width:0px;">
											<span style="width:26mm;">
												...
												<span class="styNormalText" style="padding-left:1mm"> Income from </span>
											</span>
											<span >
						...
						<div style="width:187mm;">
							<div style="float:left;width:149mm;">
								...
								<div style="width:141mm;padding-top:0.5mm;" class="styLnDesc">
									<span style="float:left;clear:none;">
										<span class="styBoldText">Total income or (loss).</span> Combine lines 26, 32, 37, 39, and 40. Enter the result here and on Schedule 1 (Form 1040), line 5
						...
						<div class="pageEnd" style="height:6mm;width:187mm;">
							<span class="stySmallText" style="width:121mm;text-align:center;padding-top:1mm;">
								
							</span>
							<div class="stySmallText" style="width:66mm;text-align:right;">
								<span class="styBoldText" style="font-weight:bold;font-size:7pt">Schedule E (Form 1040) 2022</span>
							</div>
						</div>
					</div>
					<!-- end page 2 footer -->
							...
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									...
									<th class="styDepTblCell" scope="col" rowspan="2" style="width:32.2mm;">
										<span style="font-weight:bold;">(e)</span>
										 Income from <b>Schedules Q,</b> line 3b
									</th>
								</tr>
							</thead>
							<tbody>
