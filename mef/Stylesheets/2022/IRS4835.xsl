			...
			<body class="styBodyClass" style="width:187mm;">
				<form name="IRS4835" style="font-family:arial;">
					...
					<div class="styGenericDiv" style="width:93.5mm;height:100%;border-right:1px black solid;">
						...
						<!-- (13) ////////////////////////////////////////////////////-->
						<div style="width:93.5mm;height:14mm;font-size:8.5pt;">
						...
						<div class="styIRS4835LineItem">
							...
							<div class="styIRS4835CleanDiv" style="width:50mm;height:auto;padding:0px 0px 0px 0px;">
								<div class="styIRS4835LNDesc" style="width:auto;height:100%;padding:0px 0px 0px 0px;">
									<div class="styIRS4835LNDesc" style="width:50mm;height:100%;">
									  Other 	
									  <xsl:call-template name="LinkToLeftoverDataTableInline">
					...
					<!-- (32) ////////////////////////////////////////////////////-->
					<div class="styIRS4835LineItem" style="width:187mm;height:14mm;">
						...
						<div class="styIRS4835CleanDiv" style="width:144mm;height:auto;padding:0px 0px 0px 0px;">
							<div class="styIRS4835LNDesc" style="width:auto;height:100%;padding:0px 0px 0px 0px;">
								<div class="styIRS4835LNDesc" style="width:auto;height:100%;">
									<b>Net farm rental income or (loss).</b> Subtract line 31 from line 7. If the result is income, enter it here<br/>
										  and on Schedule E (Form 1040), line 40. If the result is a loss, you <b>must</b> go to line 34. See instructions
						...
						<div class="styIRS4835CleanDiv" style="width:37mm;height:14mm;padding:0px 0px 0px 0px;float:right;">
							<div class="styIRS4835CleanDiv" style="width:100%;height:14mm;float:right;">
								<xsl:call-template name="CreateBox">
									...
									<xsl:with-param name="NumberBoxStyle">height:14mm; padding-top:8mm;</xsl:with-param>
									<xsl:with-param name="AmountBoxStyle">height:14mm; padding-top:8mm;</xsl:with-param>
								</xsl:call-template>
							</div>
						</div>
					</div>
					...
					<div class="styIRS4835CleanDiv" style="width:37mm;height:4mm;padding:0px 0px 0px 0px;float:right;">
							<div class="styIRS4835CleanDiv" style="width:100%;height:4mm;float:right;">
								<xsl:call-template name="CreateBox">
									...
									<xsl:with-param name="NumberBoxStyle">height:4mm; </xsl:with-param>
									<xsl:with-param name="AmountBoxStyle">height:4mm; background-color:rgb(211,211,211)</xsl:with-param>
								</xsl:call-template>
							</div>
						</div>
							<!-- ++++++++++++++ Yes Checkbox +++++++++++++ -->
