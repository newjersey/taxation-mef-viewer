			...
			<body class="styBodyClass">
				<form id="Form5330">
					...
					<div class="styStdDiv">
						...
						<div class="sty5330Desc" style="">
							Section 4971(g)(2) tax on failure to comply with a funding improvement or rehabilitation plan
							 (see instructions)
							<span class="sty5330DotLn">............................</span>
						</div>
						...
						<div class="styLNAmountBox" style="height:7.3mm;"><br />
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/SectionBTaxesReportedGrp/
								FailCmplyFndngImprvRehbltTxAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<div class="styStdDiv">
						...
						<div class="styLNAmountBox" style="height:7.3mm;"><br />
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/SectionBTaxesReportedGrp/
								IRS5330ScheduleF/FailureMeetRqrEndngrCrtclTxGrp/FailMeetRqrPlnEndngrCrtclTxAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<div class="styStdDiv">
						...
						<div class="sty5330NumBox">452</div>
						<div class="styLNRightNumBox" style="">10c</div>
						<div class="styLNAmountBox" style="">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/SectionBTaxesReportedGrp/
								IRS5330ScheduleF/FailureAdoptRehbltPlanTxGrp/FailureToAdoptRehbltPlanTaxAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<div class="styStdDiv">
						...
						<div class="sty5330Desc" style="">
							Section 4971(h) tax on failure of a CSEC plan sponsor to adopt funding restoration plan
							(from Schedule L, line 2)
							<span class="sty5330DotLn">.............................</span>
						</div>
						<div class="sty5330NumBox" style="height:7.3mm;"></div>
						<div class="styLNRightNumBox" style="height:7.3mm;padding-top:4mm">10d</div>
						<div class="styLNAmountBox" style="height:7.3mm;padding-top:4mm">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/SectionBTaxesReportedGrp/
								IRS5330ScheduleL/FailAdoptFndngRstorPlnTxAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Section B1 -->
					<div class="styStdDiv" style="border-bottom:1px solid black;border-top:2px solid black;
					  font-weight:bold;font-size:8pt;padding:0.5mm 0mm 0.5mm 3mm;">
						Section B1. Tax that is reported by the last day of the 7th month after the end of the calendar year
						in which the excess fringe benefits were paid to the employer's employees
					</div>
					...
					<div class="styStdDiv">
						...
						<div class="styLNAmountBox" style="">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/SectionB1TaxReportedGrp/
								ExcessFringeBenefitsTaxAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<div class="styStdDiv">
					...
					<div class="styStdDiv">
						...
						<div class="sty5330Desc" style="">
							...
							Add lines 8a through 10d or 11. Enter here and on Part II, line 17
							<span class="sty5330DotLn" style="margin-right:-6px;">...&#9658;</span>
						</div>
						<div class="sty5330NumBox" style="border-bottom-width:0px;">&nbsp;</div>
					...
					<div class="styStdDiv pageEnd" style="border-top:2px solid black;">
						...
						<span style="float:right;">Form <strong>5330</strong> (Rev. 12-2022)</span>
					</div>
					<!-- Page 2 -->
					<div class="styStdDiv" style="border-bottom:1px solid black;">
						Form 5330 (Rev. 12-2022)
                ...
                <div class="styLNDesc" style="width:55mm;padding-left:1mm;height:auto;border-top:1px solid black;word-break:break-all;"> Phone no. 
					...
					<div class="styStdDiv">
						...
						<div class="styLNAmountBoxNBB" style="width:25mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/SectionBTaxesReportedGrp/
								IRS5330ScheduleE/FTPLiquidityShortfallTaxAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Schedule F -->
					<div class="styStdDiv" style="border-bottom:1px solid black;border-top:2px solid black;
					font-weight:bold;font-size:8pt;padding:0.5mm 0mm;">
						Schedule F. Tax on Multiemployer Plans in Endangered or Critical Status (Sections 4971(g)(3) and
						4971(g)(4))	Reported by the 15th day of the 10th month after the last day of the plan year
					</div>
					<!-- Schedule F, Line 1 -->
					<div class="styStdDiv">
						<div class="styLNLeftNumBoxSD">1</div>
					...
					<div class="styStdDiv">
						...
						<div class="styLNAmountBox">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/SectionBTaxesReportedGrp/
								IRS5330ScheduleF/FailureMeetRqrEndngrCrtclTxGrp/ContriMeetBenchmarkOrRqrAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Schedule F, Line 1b -->
					<div class="styStdDiv">
						...
						<div class="styLNAmountBox">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/SectionBTaxesReportedGrp/
								IRS5330ScheduleF/FailureMeetRqrEndngrCrtclTxGrp/AccumulatedFundingDefnAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Schedule F, Line 1c -->
					<div class="styStdDiv">
						<div class="styLNLeftNumBoxSD" style="padding-left:4.2mm;">c</div>
						<div class="styLNDesc">
							Multiply the greater of line 1a or line 1b by 5%.  Enter the result here and on Part I, line 10b
							<span class="sty5330DotLn" style="margin-right:-6px;">....&#9658;</span>
						</div>
					...
					<div class="styStdDiv">
						...
						<div class="styLNAmountBoxNBB">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/SectionCTaxReportedGrp/
								ExcessContributionCrtnPlnTxAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Schedule I -->
					...
					<div class="styStdDiv">
						...
						<div class="styLNDesc" style="height:auto;">
							...
							<span class="sty5330DotLn" style="float:none;text-align:left;
							padding-left:1.5mm;">...........&#9658;</span>
							MM 
							<span style="width:10mm;min-height:3mm;border-bottom:1px solid black;margin-right:3mm;
							text-align:center;">
					...
					<div class="styStdDiv">
						...
						<div class="styLNDesc" style="height:auto;">
							...
							<span style="width:32mm;min-height:3mm;border-bottom:1px solid black;margin-right:11mm;
							text-align:right;margin-left:1mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/SectionDTaxReportedGrp/
									EmployerReversionAmt"/>
								</xsl:call-template>
							</span>
							<span style="width:4mm;min-height:3mm;text-align:center;font-weight:bold;">b
							</span>
							Excise tax rate (20% or 50%)
							<span style="width:10mm;min-height:3mm;border-bottom:1px solid black;text-align:center;
							margin-left:1mm;">
								<xsl:call-template name="PopulateText">
					...
					<div class="styStdDiv">
						...
						<div class="styLNAmountBox">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/SectionDTaxReportedGrp/
								ReversionQlfyPlanAstEmplrTxAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Schedule I, Line 4 -->
					<div class="styStdDiv">
						...
						<div class="styLNDesc" style="height:auto;min-height:10mm;width:178mm;">
							Explain below why you qualify for a 20% rather than a 50% excise tax rate rate: <br />
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="$FormData/SectionDTaxReportedGrp/
								ExcsTxOtherThan50PctExplnTxt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Schedule J -->
					<div class="styStdDiv" style="border-bottom:1px solid black;border-top:2px solid black;
					font-weight:bold;font-size:8pt;padding:0.5mm 0mm;">
						Schedule J. Tax on Failure To Provide Notice of Significant Reduction in Future Accruals (Section
						4980F) Reported by the last day of the month following the month in which the failure occurred
					</div>
					<!-- Schedule J, Line 1 -->
					<div class="styStdDiv">
						<div class="styLNLeftNumBoxSD">1</div>
					...
					<!-- Schedule K -->
					<div class="styStdIBDiv" style="border-bottom:1px solid black;border-top:2px solid black;
					  font-weight:bold;font-size:8pt;padding:0.5mm 0mm;">
						Schedule K. Tax on Prohibited Tax Shelter Transactions (Section 4965) 
						Reported on or before the 15th day of the 5th month following the close of the entity manager's tax 
						year during which the plan became a party to a prohibited tax shelter transation
					</div>
					<!-- Schedule K, Line 1 -->
					<div class="styStdIBDiv">
						<div class="styLNLeftNumBoxSD">1</div>
						<div class="styLNDesc" style="height:auto;">
							Enter the number of prohibited tax shelter transactions you caused the same plan to be a <br />
							 party to &#9658;
							<span style="width:40mm;min-height:3mm;border-bottom:1px solid black;padding-right:2px;
							  text-align:right;">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" 
									  select="$FormData/SectionFTaxesReportedGrp/ProhibitedTaxShelterTransCnt"/>
								</xsl:call-template>
							</span>
						</div>
						<div class="styLNRightNumBoxNBB" style="height:7.2mm;background-color:lightgrey;">&nbsp;</div>
					...
					<div class="styStdIBDiv">
						...
						<div class="styLNAmountBoxNBB">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" 
								  select="$FormData/SectionFTaxesReportedGrp/TotProhibitedTaxShelterTaxAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Schedule L -->
					<div class="styStdIBDiv" style="border-bottom:1px solid black;border-top:2px solid black;
					  font-weight:bold;font-size:8pt;padding:0.5mm 0mm;">
						Schedule L. Tax on Failure of a CSEC Plan Sponsor to Adopt Funding Restoration Plan (Section 4971(h))
						Reported by the 15th day of the 10th month after the last day of the plan year
					</div>
					<!-- Schedule L, Line 1 -->
					<div class="styStdIBDiv">
						<div class="styLNLeftNumBoxSD">1</div>
						<div class="styLNDesc" style="height:auto;">
							Enter the number of days during the taxable year which are included in the period beginning on
							the	day following the close of the 180-day period described in section 433(j)(3) and ending on 
							the day on which the funding restoration plan is adopted.  &#9658;
							<span style="width:40mm;min-height:3mm;border-bottom:1px solid black;padding-right:2px;
							  text-align:right;">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" 
									  select="$FormData/SectionBTaxesReportedGrp/IRS5330ScheduleL/DaysOver180PlanAdoptedCnt"/>
								</xsl:call-template>
							</span>
						</div>
						<div class="styLNRightNumBoxNBB" style="height:7.2mm;background-color:lightgrey;">&nbsp;</div>
					...
					<div class="styStdIBDiv">
						<div class="styLNLeftNumBoxSD">2</div>
						<div class="styLNDesc">
							Multiply line 1 by $100. Enter the result here and on Part I, line 10d 
							<span class="sty5330DotLn" style="margin-right:-6px;">...........&#9658;</span>
						</div>
						<div class="styLNRightNumBoxNBB">2</div>
						<div class="styLNAmountBoxNBB">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" 
								  select="$FormData/SectionBTaxesReportedGrp/IRS5330ScheduleL/FailAdoptFndngRstorPlnTxAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<div class="styStdDiv pageEnd" style="border-top:2px solid black;">
