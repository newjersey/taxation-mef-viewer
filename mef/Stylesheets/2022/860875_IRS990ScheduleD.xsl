              ...
              <xsl:with-param name="TargetNode" select="$FormData"/>
						...
						<div class="styFTBox" style="width:128mm;">
							...
							<div class="styFBT" style="height:5mm;padding-top:0mm">
								<img src="{$ImagePath}/990SchD_Bullet_Md.gif" alt="right arrow"/> 
       ...
       <span class="styIRS990ScheduleD_DotSpacing">.........</span>
								...
								<td class="styLNAmountBox" style="width:62mm;height:4.5mm;vertical-align:bottom;padding-right:0.75mm;float:none;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData//DonorAdvisedFundsHeldCnt"/>
									</xsl:call-template>
								</td>
								<td class="styLNAmountBox" style="width:62mm;height:4.5mm;vertical-align:bottom;padding-right:0.75mm;float:none;">
									<xsl:call-template name="PopulateAmount">
					...
					<table class="styTable" style="font-size:7pt;width:187mm;border-bottom-width:1px" cellspacing="0">
						<thead>
							<tr scope="col">
								...
								<!--Table num box-->
								<th scope="col" style="width:45mm; border: 1px solid black; height:4mm;font-weight:bold; text-align:center;float:left;">Held at the End of the Year </th>
								<!--Table Description-->
							</tr>
						</thead>
						<tfoot/>
  ...
  <span class="styIRS990ScheduleDUnderlineAmount" style="float:none;width:32mm;">
					...
					<div style="width:187mm;float:none;clear:both;border-top:solid 1px" class="pageEnd">
						...
						<div class="styGenericDiv" style="float:right;">
							<span class="styBoldText">Schedule D (Form 990) 2022</span>
						</div>
					</div>
					<br/>
					<!-- header -->
					<div style="width:187mm;clear:both;padding-bottom:.5mm;float:none;clear:both;" class="styBB">
						<div style="width:90mm;" class="styGenericDiv">Schedule D (Form 990) 2022</div>
...
<br/>assets to be sold to raise funds rather than to be maintained as part of the organization’s collection?<span class="styIRS990ScheduleD_DotSpacing">...</span>
 ...
 <span class="styIRS990ScheduleD_DotSpacing"/>
								...
								<td class="styLNRightNumBox" style="height:4.5mm;border-top-width:1px;"/>
								<td class="styLNAmountBox" style="width:45mm;height:4.5mm;text-align:center;padding-right:0.75mm;border-top-width:1px;">
									<b>Amount</b>
								</td>
							</tr>
							<tr>
...
Describe in Part XIII the intended uses of the organization's endowment funds.
            ...
            Description of property
								...
								<th scope="col" align="center" style="height:9mm;float:left;width:36mm;font-size:6pt;border-left:1px solid black; border-bottom:1px solid black;vertical-align:top;">
									<span class="styNormalText">
										<b>(a)</b> Cost or other basis <br/>(investment) </span>
								</th>
								<th scope="col" align="center" style="height:9mm;float:left;width:36mm;font-size:6pt;border-left:1px solid black; border-bottom:1px solid black; vertical-align:top;">
    ...
    <!--Dotted Line-->
								...
								<td class="styLNAmountBoxSmall" style="width:36mm;height:4.5mm;vertical-align:bottom;padding-right:0.75mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/LandGrp/InvestmentCostOrOtherBasisAmt"/>
									</xsl:call-template>
								</td>
								<td class="styLNAmountBoxSmall" style="width:36mm;height:4.5mm;vertical-align:bottom;padding-right:0.75mm;">
									<xsl:call-template name="PopulateAmount">
        ...
        <span style="width:1px"/>
								...
								<td class="styLNAmountBoxSmall" style="width:36mm;height:4.5mm;vertical-align:bottom;padding-right:0.75mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/BuildingsGrp/InvestmentCostOrOtherBasisAmt"/>
									</xsl:call-template>
								</td>
								<td class="styLNAmountBoxSmall" style="width:36mm;height:4.5mm;vertical-align:bottom;padding-right:0.75mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/BuildingsGrp/OtherCostOrOtherBasisAmt"/>
									</xsl:call-template>
								</td>
								<td class="styLNAmountBoxSmall" style="width:36mm;height:4.5mm;vertical-align:bottom;padding-right:0.75mm;">
									<xsl:call-template name="PopulateAmount">
      ...
      Leasehold improvements
        ...
        <!--Dotted Line-->
								...
								<td class="styLNAmountBoxSmall" style="width:36mm;height:4.5mm;vertical-align:bottom;padding-right:0.75mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/LeaseholdImprovementsGrp/InvestmentCostOrOtherBasisAmt"/>
									</xsl:call-template>
								</td>
								<td class="styLNAmountBoxSmall" style="width:36mm;height:4.5mm;vertical-align:bottom;padding-right:0.75mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/LeaseholdImprovementsGrp/OtherCostOrOtherBasisAmt"/>
									</xsl:call-template>
								</td>
								<td class="styLNAmountBoxSmall" style="width:36mm;height:4.5mm;vertical-align:bottom;padding-right:0.75mm;">
									<xsl:call-template name="PopulateAmount">
     ...
     Equipment
        <!--Dotted Line-->
								...
								<td class="styLNAmountBoxSmall" style="width:36mm;height:4.5mm;vertical-align:bottom;padding-right:0.75mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/EquipmentGrp/InvestmentCostOrOtherBasisAmt"/>
									</xsl:call-template>
								</td>
								<td class="styLNAmountBoxSmall" style="width:36mm;height:4.5mm;vertical-align:bottom;padding-right:0.75mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/EquipmentGrp/OtherCostOrOtherBasisAmt"/>
									</xsl:call-template>
								</td>
								<td class="styLNAmountBoxSmall" style="width:36mm;height:4.5mm;vertical-align:bottom;padding-right:0.75mm;">
									<xsl:call-template name="PopulateAmount">
							...
							<tr>
								<td class="styTableCell" style="width:100mm;height:4.5mm;vertical-align:bottom;padding-right:0.75mm;border-left:0px;border-bottom:0px;border-color:black">
									<span class="styGenericDiv" style="float:left;height:auto;">
										<b>(1)</b> Financial derivatives</span>
									<!-- Dotted Line -->
									<span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm;">.........</span>
								</td>
										...
										<td class="styTableCell" style="width:100mm;height:auto;vertical-align:bottom;padding-right:0.75mm;border-left:0px;text-align:left;border-color:black;">
											<span class="styGenericDiv" style="float:left;height:auto;">
												<xsl:if test="position()=1">
													<b>(3)</b> Other <span class="styTableCell" style="width:65mm;float:none;padding-left:2mm;text-align:center;"/>
												</xsl:if>
												<br/>(<xsl:number value="position()" format="A"/>)
...
<xsl:call-template name="PopulateText">
							...
							<xsl:if test="count($FormData/OtherSecuritiesGrp) &lt; 1 or             (($Print = $Separated) and (count($FormData/OtherSecuritiesGrp) &gt; 9)) ">
								<tr>
									<td class="styTableCell" style="width:187mm;height:auto;vertical-align:bottom;padding-right:0.75mm;border-left:0px;text-align:left;border-color:black;border-bottom:0px;">
										<xsl:if test="position()=1">
											<b>(3)</b>Other <span class="styIRS990ScheduleDUnderlineAmount" style="width:86.3mm;float:none;padding-left:2mm;text-align:center;"/>
										</xsl:if>
										<br/>
 ...
 (Column (b) must equal Form 990, Part X, col. (B) line 12.)</span>
									<span style="padding-left:0mm">
										<img src="{$ImagePath}/990SchD_Bullet_Sm.gif" alt="right arrow"/>
									</span>
								</td>
						...
						<tbody valign="top">
							<xsl:if test="($Print != $Separated) or count($FormData/InvstProgramRelatedOrgGrp) &lt;= 9">
								<xsl:for-each select="$FormData/InvstProgramRelatedOrgGrp">
									<tr>
										<td class="styTableCell" style="width:100mm;vertical-align:bottom;border-left:0px;text-align:left;border-color:black">
						...
						<div style=" width: 187mm; ">
							<table class="styTable" style="font-size:7pt;float:none;clear:both;" cellspacing="0">
								<thead class="styTableThead">
									<tr>
										<th class="styTableCellHeader" scope="col" colspan="4" style="height:auto;width:149mm;font-weight:normal;border-top-width:1px;border-color:black;">
											<span style="font-weight:bold">(a)</span> Description</th>
										<th class="styTableCellHeader" scope="col" style="height:auto;font-weight:normal; text-align:center;border-top-width:1px;border-right-width:0px;border-color:black">
											<span style="font-weight:bold">(b)</span> Book value</th>
									</tr>
								</thead>
								<tfoot/>
									...
									<tr>
										<td class="styIRS990ScheduleDTableCellLB" colspan="4" style="width:149mm;height:auto;vertical-align:bottom;padding-right:0.75mm;border-left:0px;border-color:black">
											<span class="styItalicText" style="float:left;">
												<span style="font-weight:bold;font-style:normal">Total.</span> (Column (b) must equal Form 990, Part X, col.(B)  line 15.)</span>
											<span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">...........</span>
											<span style="padding-left:2mm">
												<img src="{$ImagePath}/990SchD_Bullet_Sm.gif" alt="right arrow"/>
											</span>
            ...
            <xsl:with-param name="containerID" select=" 'ROActn' "/>
					...
					<div style=" width: 187mm; ">
						<table class="styTable" style="font-size:7pt;float:none;clear:both;display:table;" cellspacing="0">
							<thead class="styTableThead">
								<tr>
									<th class="styTableCellHeader" scope="col" style="height:auto;width:140mm;font-weight:normal;border-color:black;border-right-width:1px;">
										<span class="styLNLeftNumBoxSD" style="text-align:left;padding-left:0mm;font-weight:normal">
											<b>1.</b>
										</span>
										<span style="font-weight:bold">(a)</span> Description of liability</th>
									<th class="styTableCellHeader" scope="col" style="height:auto;width:39mm;font-weight:normal; text-align:center;border-right-width:0px;border-color:black;vertical-align:top;">
										<span style="font-weight:bold">(b)</span> Book value</th>
								</tr>
							</thead>
							<tfoot/>
      ...
      <td class="styIRS990ScheduleDShadingCell" style="width:52mm;height:4.5mm;vertical-align:bottom;">
								...
								<tr>
									<td class="styIRS990ScheduleDTableCellLB" style="width:149mm;height:auto;vertical-align:bottom;padding-right:0.75mm;border-left:0px;float:left;border-color:black;">
										<span class="styItalicText" style="float:left;font-size:6pt;">
											<span style="font-weight:bold;font-style:normal">Total.</span>
  ...
  <td class="styLNRightNumBox" style="width:8mm;height:4.5mm; border-right:0">10</td>
    ...
    <!-- Changed from 139 to 138 and 99 to 98-->
              ...
              <!--Dotted Line-->
								...
								<td class="styLNRightNumBox" style="width:8mm;height:4.5mm; border-right:0">1</td>
								<td class="styLNAmountBox" style="height:4.5mm; border-left-width: 1px; border-top-width: 1px;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/TotalRevEtcAuditedFinclStmtAmt"/>
									</xsl:call-template>
								</td>
							</tr>
							<tr>
	...
	<!-- Changed from 139 to 138 and 99 to 98-->
              ...
              .....................</span>
								...
								<td class="styLNAmountBox" style="height:4.5mm; border-left-width: 1px;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/RevenueNotReportedAmt"/>
									</xsl:call-template>
								</td>
							</tr>
							<tr>
								...
								<td class="styLNAmountBox" style="height:4.5mm; border-left-width: 1px;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/RevenueSubtotalAmt"/>
									</xsl:call-template>
								</td>
							</tr>
							<tr>
...
Total revenue. Add lines <span class="styBoldText">3</span> and <span class="styBoldText">4c. </span> (This must equal Form 990, Part I, line 12.)
              ...
              <!-- Changed from 139 to 138 and 99 to 98-->
								...
								<td class="styLNAmountBox" style="height:4.5mm; border-left-width: 1px;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/TotExpnsEtcAuditedFinclStmtAmt"/>
									</xsl:call-template>
								</td>
							</tr>
							<tr>
              ...
              <!--Dotted Line-->
								...
								<td class="styLNAmountBox" style="height:4.5mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/PriorYearAdjustmentsAmt"/>
									</xsl:call-template>
									<span style="width:1px;"/>
								</td>
								<td class="styShadingCellRB" style="width:8mm;height:4.5mm; border-right:0">
              ...
              <!--Dotted Line-->
								...
								<td class="styLNAmountBox" style="height:4.5mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/LossesReportedAmt"/>
									</xsl:call-template>
									<span style="width:1px;"/>
								</td>
								<td class="styShadingCellRB" style="width:8mm;height:4.5mm; border-right:0">
             ...
             <span style="letter-spacing:4mm; font-weight:bold; font-size:7pt; margin-left:2mm">...........</span>
							...
							<tr>
								...
								<td class="styLNAmountBox" style="height:4.5mm; border-left-width: 1px;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/ExpensesNotReportedAmt"/>
									</xsl:call-template>
								</td>
							</tr>
							<tr>
          ...
          Additional Data        
					...
					<xsl:if test="($Print = $Separated) and count($FormData/OtherSecuritiesGrp) &gt;= 8">
						...
						<table class="styLeftOverTbl" cellspacing="0" style="font-size:7pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<th class="styTableCellHeader" scope="col" style="height:auto;width:100mm;font-weight:normal;text-align:center;vertical-align:top;">
										<span style="font-weight:bold">(a)</span> Description of security or category<br/>(including name of security)</th>
									<th class="styTableCellHeader" scope="col" style="width:57mm;font-weight:normal; text-align:center;border-right-width:1px;vertical-align:top;">
										<span style="font-weight:bold">(b)</span>Book value</th>
									<th class="styTableCellHeader" scope="col" style="height:auto;width:57mm;font-weight:normal;border-right-width:0px;text-align:center;vertical-align:top;">
										<span style="font-weight:bold">(c)</span> Method of valuation:<br/>Cost or end-of-year market value</th>
								</tr>
							</thead>
							<tfoot/>
								...
								<tr>
									...
									<td class="styTableCell" style="width:100mm;height:auto;vertical-align:bottom;padding-right:0.75mm;border-left:0px;text-align:left;border-color:black">
										<span class="styGenericDiv" style="float:left;padding-right:1mm">
											<xsl:if test="position()=1">
												<!--<b>(3)</b>Other<span class="styIRS990ScheduleDUnderlineAmount" style="width:80mm;float:none;padding-left:2mm;text-align:center;"/>-->
											</xsl:if>
										</span>
										<br/>(<xsl:number value="position()" format="A"/>)
		<xsl:call-template name="PopulateText">
					...
					<xsl:if test="($Print = $Separated) and count($FormData/InvstProgramRelatedOrgGrp) &gt;= 9">
						...
						<table class="styLeftOverTbl" cellspacing="0" style="font-size:7pt;">
							...
							<xsl:for-each select="$FormData/InvstProgramRelatedOrgGrp">
								<tr>
									<xsl:attribute name="class"><xsl:choose><xsl:when test="position() mod 2 = 1">styDepTblRow1Cell </xsl:when><xsl:otherwise>styDepTblRow2Cell </xsl:otherwise></xsl:choose></xsl:attribute>
									<td class="styIRS990ScheduleDTableCellLB" colspan="2" style="width:82mm;height:4.5mm;vertical-align:bottom;padding-right:0.75mm;border-left:0px;text-align:left;border-color:black;float:none;">
										<b>(<xsl:number value="position()" format="1"/>)</b>
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="Desc"/>
										</xsl:call-template>
					...
					<xsl:if test="($Print = $Separated) and count($FormData/OtherAssetsOrgGrp) &gt;= 8">
						...
						<table class="styLeftOverTbl" cellspacing="0" style="font-size:7pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<th class="styTableCellHeader" scope="col" colspan="4" style="height:auto;width:149mm;font-weight:normal;border-top-width:1px;text-align:center;vertical-align:top;">
										<span style="font-weight:bold">(a)</span> Description</th>
									<th class="styTableCellHeader" scope="col" style="height:auto;font-weight:normal; text-align:center;vertical-align:top;border-top-width:1px;border-right-width:0px">
										<span style="font-weight:bold">(b)</span> Book value</th>
								</tr>
							</thead>
							<tfoot/>
		...
		<xsl:call-template name="PopulateText">
					...
					<xsl:if test="($Print = $Separated) and count($FormData/OtherLiabilitiesOrgGrp) &gt;= 8">
						...
						<table class="styLeftOverTbl" cellspacing="0" style="font-size:7pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<th class="styTableCellHeader" scope="col" style="height:auto;width:100mm;font-weight:normal;">
										<span class="styLNLeftNumBoxSD" style="text-align:left;padding-left:0mm;font-weight:normal">1.</span>
										<span style="font-weight:bold">(a)</span> Description of Liability</th>
