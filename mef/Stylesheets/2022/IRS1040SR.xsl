		...
		<html lang="EN-US">
			...
			<body class="styBodyClass">
				<form id="Form1040SR" style="font-size:10pt;font-family:Arial;">
					...
					<!-- Header -->		
					<div class="styStdDiv">
						<div class="styGenericDiv" style="width:31.8mm;height:15mm;padding-top:2px;">
						...
						<div class="styGenericDiv" style="width:56mm;padding-right:1mm;padding-top:1px;
							height:15mm;">
						...
						<div class="styTYBox" style="width:18mm;border-right-width:1px;height:15mm;
							padding-top:2px;">
							<span class="styTaxYear">20<span class="styTYColor">22</span></span>
						</div>
						<div class="styOMB" style="width:28mm;height:15mm;padding:17px 1mm 1mm 1mm;
							float:left;border-width:0px 1px 0px 0px;vertical-align:bottom;font-family:Verdana;
							font-size:7pt;">	OMB No. 1545-0074
						</div>
						<div class="styGenericDiv" style="width:52.5mm;height:15mm;font-family:Arial-Narrow;
					...
					<div class="styStdDiv" style="border-top:3px solid black;border-bottom:1px solid black;">
					...
					<div class="styGenericDiv" style="width:20mm;padding-top:0mm;height:117mm;">
						...
						<div class="sty1040SRLN" style="min-height:4.6mm;">
							...
							<div class="sty1040SRDesc" style="height:5.6mm;">Other income from Schedule 1, line 10
								<span class="sty1040SRDotLn">..............</span></div>
					...
					select="$FormData/ExcldSect933PuertoRicoIncmAmt/@excldSect933PuertoRicoIncmCd"/>
							...
							<div class="sty1040SRRightNumBox" style="border-bottom-width:0px;height:5.6mm;">11</div>
							<div class="sty1040SRAmountBox" style="border-bottom-width:0px;height:5.6mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" 
						...
						<div class="styStdDiv pageEnd" style="border-top:1px solid black;">
							...
							<span style="float:right;font-size:7pt;">Form <strong style="font-size:10pt;">
								1040-SR</strong> (2022)</span>
						</div>
						<!-- Page 2 -->
						<div class="styStdDiv" style="border-bottom:1px solid black;font-size:7pt;
							font-family:Verdana;">Form 1040-SR (2022)
							<div style="float:right;">Page <strong>2</strong></div>
						</div>
						<div class="styGenericDiv" style="width:20mm;padding-top:1mm;height:22mm;">
					...
					<div class="sty1040SRLN" style="min-height:4.5mm">
						...
						<div class="sty1040SRDesc" style="width:87mm;height:4.5mm;padding-top:.5mm;font-family:Arial Narrow">
							Amount of line 34 you want<strong> applied to your 2023 estimated tax</strong>
						</div>
					...
					<div class="styStdIBDiv">
						...
						<div style="width:187mm;border-top:1px solid black;font-size:10pt;">
							...
							<div style="width:64mm;padding-top:1mm;float:left;text-align:center;
								border-right:0px solid black;padding-bottom:0.5mm">
								$27,300 <br/><br /> 28,700 <br/><br /> 30,100 <br/><br /> 31,500 
							</div>
						</div>
						<div style="width:187mm;border-top:1px solid black;font-size:10pt;">
						...
						<div style="width:187mm;border-top:1px solid black;font-size:10pt;">
							...
							<div style="width:64mm;padding-top:1mm;float:left;text-align:center;">
								$14,350 <br/><br /> 15,750 <br/><br /> 17,150 <br/><br /> 18,550
							</div>
						</div>
					</div>
