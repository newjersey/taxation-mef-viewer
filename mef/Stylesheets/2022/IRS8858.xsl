							...
							<div class="styLNDesc" style="width:63mm;">Check here 
								...
								<label>
									<xsl:call-template name="PopulateLabel">
										<xsl:with-param name="TargetNode" select="$Form8858Data/InitialForm8858Ind"/>
										<xsl:with-param name="BackupName">IRS8858InitialForm8858</xsl:with-param>
									</xsl:call-template>Initial Form 8858
							   </label>
							</div>   
							<div class="styLNDesc" style="width:68mm;">
								<input type="checkbox" class="styCkbox">
								...
								<label>
									<xsl:call-template name="PopulateLabel">
										<xsl:with-param name="TargetNode" select="$Form8858Data/FinalForm8858Ind"/>
										<xsl:with-param name="BackupName">IRS8858FinalForm8858</xsl:with-param>
									</xsl:call-template>Final Form 8858
							   </label>
							</div>
						</div>
					</div>	
						...
						<div style="width:35mm;height:22mm;float:left;">
							...
							<div class="styNameBox" style="border-right-width:0px;height:22mm;">
                               Functional currency<br/>
								<br/>
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$Form8858Data/FunctionalCurrencyCd"/>
								</xsl:call-template>
							</div>
						</div>
					</div>
              ...
              Name, address, and identifying number of branch office or <br/>agent (if any) in the United States
                  ...
                  border-right: 0px;border-top-width: 1px;border-bottom-width: 1px">
                         ...
                         Functional currency<br/>
										...
										<span style="width: 5mm"/>
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$Form8858Data/TaxOwnerFunctionalCurrencyCd"/>
										</xsl:call-template>
									</td>
								</tr>
							</tbody>
           ...
           or ($Print = $Separated) and (count($Form8858Data/DirectOwner) =1)">
              ...
              Name and address<br/>
					...
					<div class="pageEnd" style="width:187mm;float:none;clear:both;">
						...
						<div class="stySmallText" style="width:36mm;text-align:right;float:right;clear:none;">
							Form <span class="styBoldText" style="font-size:8pt;">8858</span> (Rev. 09-2021)
						</div>
					</div>
					...
					<div class="styBB" style="height:auto;width:187mm;font-size: 9pt;padding-bottom:1mm;">
						...
						<div class="styLNDesc" style="width:187mm;float:none;clear:none;">
							...
							<xsl:call-template name="PopulateSpan">
								...
								<i>If you are using the average exchange rate (determined under section 989(b)), check the following box</i>
							...
							<span style="height:5.5mm;float:right;clear:none;">
								<input type="checkbox" alt="Section 989b Average Exchange Rate" class="styCkbox" >
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" select="$Form8858Data/IRS8858ScheduleC/Section989bAvgExchangeRateInd"/>
										<xsl:with-param name="BackupName">IRS8858ScheduleCSection989(b)AverageExchangeRate</xsl:with-param>
									</xsl:call-template>
							...
							<div style="width:187mm;">
								<div style="float:left;">
										...
										<div class="styLNDesc" style="height:7mm;width:105mm;">
											Section 987 gain (loss) deferred under Regulations section 1.987-12 (attach statement)
											<span class="styDotLn" style="float:right;padding-right:1mm;">......................</span>
										</div>
									</div>
								<div style="float:right;">
									<div class="styLNRightNumBox" style="height:3mm;border-bottom-width:0mm;background-color:lightgrey;"/>
									<div class="styLNAmountBox" style="height:3mm;border-bottom-width:0mm;background-color:lightgrey;"/>
									<div class="styLNAmountBox" style="height:3mm;border-bottom-width:0mm;background-color:lightgrey;"/><br/>
                    ...
                    text-align:center;font-size:6pt;padding-top:2mm">
								...
								<div style="width:187mm;">
									...
									<div style="float:right;">
										...
										<div class="styLNRightNumBox" style="height:4mm;">3</div>
										<div class="styLNAmountBox" style="height:4mm;width:33mm;background-color:lightgrey;">
											<!--<xsl:call-template name="PopulateAmount">
                  ...
                  CashAndOtherCurrentAssets/EndingAmt"/>
					...
					<div style="width:187mm;">
						...
						<div style="float:right;clear:none">
							<div class="styLNRightNumBox" style="height: 4.5mm;border-bottom-width: 2px;">2</div>
            ...
            Liabilities and Owner's Equity</span>
                  ...
                  LiabilitiesBalanceSheet/EndingAmt"/>
					...
					<div style="width:187mm;">
						...
						<div style="float:right;clear:none">
							<div class="styLNRightNumBox" style="height: 4.5mm;border-bottom-width: 2px;">5</div>
							<div class="styLNAmountBox" style="height: 4.5mm;border-bottom-width: 2px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form8858Data/IRS8858ScheduleF/
                  ...
                  TotLiabOwnerEquityBalanceSheet/EndingAmt"/>
					...
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
							<div class="styLNLeftLtrBox" style="height:7mm;padding-left:3mm;"/>
							<div class="styLNDesc" style="height:7mm;width:146.5mm; ">Do not complete lines 7 and 8 if you are an individual who owns an FB or FDE directly or through tiers of 
							FBs and FDEs.
							</div>
						</div>
						<div style="float:right;clear:none;">
							<div style="width:32mm;">
								<div style="height:7mm;width:16mm;background-color:lightgrey;text-align:center;border-left:1px solid black;border-bottom:0px solid black; 
					...
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
							<div class="styLNLeftNumBoxSD" style="height:10mm;padding-left:1mm;">8a</div>
							<div class="styLNDesc" style="height:10mm;width:146.5mm;">
					...
					<div  style="width:187mm;">
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="height:10mm;width:146.5mm; ">
								<i>Answer only if the tax owner of the FDE or FB is a CFC:</i> Were there any
					...
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
							<div class="styLNLeftLtrBox" style="height:10mm;padding-left:3mm;"/>
							<div class="styLNDesc" style="height:10mm;width:146.5mm; ">Answer the remaining questions in Schedule G only if the tax owner of the FB or the 
							interest in the FDE is a U.S. corporation. Answer questions 10a through 11c if the tax owner of the FB or the interests in the FDE is treated as a U.S. 
							corporation solely for purposes of these questions.
							</div>
						</div>
						<div style="float:right;clear:none;">
							<div style="width:32mm;">
								<div style="height:10mm;width:16mm;background-color:lightgrey;text-align:center;border-left:1px solid black;border-bottom:0px solid black; 
												 padding-left:0mm;float:left;clear:none;"/>
								<div style="height:10mm;width:16mm;background-color:lightgrey;text-align:center;border-left:1px solid black;border-bottom:0px solid black;
												 float:right;"/>
							</div>
					...
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="height:7mm;width:146.5mm;">
								Was any portion of the dual consolidated loss on line 10b or 11b taken into account in computing U.S.
              ...
              Taxable Income <span class="styNormalText"> (see instructions)</span>
						...
						<div class="styBB" style="width:187mm;">
							...
							<div style="width:187mm;">
								...
								<div style="float:right;">
									<div class="styLNRightNumBox" style="border-bottom-width: 2px;" >3</div>
                    ...
                    (or taxable income &#8211; see instructions) (line 1 plus line 2 minus line 3) </span>
							...
							<div style="width:187mm;">
								...
								<div style="float:right;">
									<div class="styLNRightNumBox" style="border-bottom-width: 2px;">5</div>
									<div class="styLNAmountBox" style="border-bottom-width: 2px;"/>
								</div>
							</div>
							<!-- Line 6 -->
                  ...
                  padding-bottom:.5mm;">
							...
							<div style="width:187mm;">
								...
								<div class="styLNDesc" style="height:4mm;width:100mm;">
									...
									<!--Dotted Lines -->
										<span class="styDotLn" style="float:none;clear: none; padding-right:1mm;">.............</span><!--<span style="width:2mm"/>-->
									    <img src="{$ImagePath}/8858_Bullet_Sm.gif" alt="Right Arrow Image"/>
								</div>
                ...
                Current Earnings and Profits or Taxable Income<span class="styNormalText" style="padding-left:2mm;"> (see instructions)</span>
							...
							<div class="styBB" style="width:187mm;float:none;clear:both;">
								...
								<div style="width:187mm;">
									...
									<div style="float:right;">
										<div class="styLNRightNumBox" style="border-bottom-width:2px;">3</div>
										<div class="styLNAmountBox" style="width:33mm;border-bottom-width:2px;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="TotalNetSubtractionsAmt"/>
												<xsl:with-param name="MaxSize" select="17"/>
											</xsl:call-template>
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styLNDesc" style="height: 4mm; width:15mm; font-size: 9pt;vertical-align: top;"/>
						<div class="styLNDesc" style="height: 4mm;font-weight: bold; width:86mm; font-size: 9pt;vertical-align: top;text-align:center;border-left:1px solid black;">Foreign Income Taxes</div>
						<div class="styLNDesc" style="height: 4mm;font-weight: bold; width:86mm; font-size: 9pt;vertical-align: top;text-align:center;border-left:1px solid black;">Foreign Tax Credit Separate Categories</div>
					</div>
					...
					<table cellpadding="0" cellspacing="0" class="styTable" style="width:187mm;font-weight:normal;font-size:7pt;border:1px solid black;">
						<thead class="stythead">
							<tr>
								...
								<th style="width:15mm;border-color:black;font-weight:normal;vertical-align:middle;border:1px solid black;border-top:0px;border-left:0px;" class="styTablecellHeader" scope="col">
									<div style="padding-top:.5mm;text-align:center;padding-bottom:.5mm;">
										<b>(b) </b><br/> Foreign Tax Year<br/> (YYY/MM/DD)
									</div>
								</th>
								<th style="width:25mm;border-color:black;font-weight:normal;vertical-align:middle;border:1px solid black;border-top:0px;border-left:0px;" class="styTablecellHeader" scope="col">
									<div style="padding-top:.5mm;text-align:center;padding-bottom:.5mm;">
										<b>(c) </b><br/> Foreign Currency
									</div>
								</th>
								<th style="width:31.5mm;border-color:black;font-weight:normal;vertical-align:middle;border:1px solid black;border-top:0px;border-left:0px;" class="styTablecellHeader" scope="col">
									<div style="padding-top:.5mm;text-align:center;padding-bottom:.5mm;">
										<b>(d) </b><br/> Conversion Rate
									</div>
								</th>
								<th style="width:22mm;border-color:black;font-weight:normal;vertical-align:middle;border:1px solid black;border-top:0px;border-left:0px;" class="styTablecellHeader" scope="col">
									<div style="padding-top:.5mm;text-align:center;padding-bottom:.5mm;">
										<b>(e) </b><br/>U.S. Dollars
									</div>
								</th>
								<th style="width:22mm;border-color:black;font-weight:normal;vertical-align:middle;border:1px solid black;border-top:0px;border-left:0px;" class="styTablecellHeader" scope="col">
									<div style="padding-top:.5mm;text-align:center;padding-bottom:.5mm;">
										<b>(f) </b><br/> Foreign Branch
									</div>
								</th>
								<th style="width:22mm;border-color:black;font-weight:normal;vertical-align:middle;border:1px solid black;border-top:0px;border-left:0px;" class="styTablecellHeader" scope="col">
									<div style="padding-top:.5mm;text-align:center;padding-bottom:.5mm;">
								...
								<th style="width:22mm;border-color:black;font-weight:normal;vertical-align:middle;border:1px solid black;border-top:0px;border-left:0px;border-right:0px;" class="styTablecellHeader" scope="col">
									<div style="padding-top:.5mm;text-align:center;padding-bottom:.5mm;">
										<b>(i) </b><br/> Other
									</div>
								</th>
						...
						<tbody>
							...
							<xsl:if test="(count($Form8858Data/IRS8858ScheduleJ/FrgnIncmTaxesPaidAccruedGrp) &gt;  0)">
								<xsl:for-each select="$Form8858Data/IRS8858ScheduleJ/FrgnIncmTaxesPaidAccruedGrp">
									<tr>
										<!-- Column (a) -->
										<td class="styTableCellTextSmall" style="height:4mm;width:15mm;text-align:center;font-size: 6pt;">
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="ForeignCountryOrUSPossessionCd"/>
											</xsl:call-template>
										</td>
										<!-- Column (b) -->
										<td class="styTableCellSmall" style="height:4mm;width:15mm;text-align:center;font-size: 6pt;">
											<xsl:call-template name="PopulateAmount">
										...
										<!-- Column (e) -->
										<td class="styTableCellSmall" style="height:4mm;width:22mm;font-size: 6pt;">
											<xsl:call-template name="PopulateAmount">
										...
										<!-- Column (i) -->
										<td class="styTableCellSmall" style="height:4mm;width:22mm;font-size: 6pt;border-right-width:0px;">
											<xsl:call-template name="PopulateAmount">
							...
							<tr>
								<!-- Column (a) -->
								<td class="styTableCellTextSmall" style="height:4mm;width:18mm;font-weight: bold;text-align:left;">Totals</td>
								<!-- Column (b) -->
								<td class="styTableCellSmall" style="height:4mm;width:18mm;background-color:lightgrey;"/>
								<!-- Column (c) -->
            ...
            Additional Data        
					...
					<!-- Additional Data Table for Separated Repeating Data from Line 1 b(2) -->
						<xsl:if test="count($Form8858Data/ForeignEntityIdentificationGrp) &gt; 1">
					...
					<xsl:if test="count($Form8858Data/TaxOwnerEntityIdGrp) &gt; 1">
						<span class="styRepeatingDataTitle">
               ...
               <!-- puch pen  -->
					...
					<xsl:if test="($Print = $Separated) and (count($Form8858Data/IRS8858ScheduleH) &gt; 1) ">
                      ...
                      Total net additions    
										...
										<td class="styDepTblCell" style="text-align:center;font-weight:bold;width:5mm;border:2px solid black;">2</td>
										<td class="styDepTblCell" style="text-align:right;width:33mm;border:2px solid black;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="TotalNetAdditonsAmt"/>
												<xsl:with-param name="MaxSize" select="17"/>
											</xsl:call-template>
