...
-->
         ...
         Were the bonds issued as part of a current refunding issue of tax-exempt <br/>bonds (or, if issued prior to 2020, a current refunding issue)?
           <!--Dotted Line-->
         ...
         Were the bonds issued as part of an advance refunding issue of taxable <br/>bonds (or, if issued prior to 2020, an advance refunding issue)?
          <!--Dotted Line-->
