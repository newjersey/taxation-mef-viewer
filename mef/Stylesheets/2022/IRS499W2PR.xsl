...
<div style="float:right">
                  <div style="width:24mm; margin-left:2mm; padding-left:5mm; font-size:9pt; font-weight:normal; float:left; border-left: black solid 1px">
                    <span style="width:100%">Año:</span>
                    <span style="width:100%">Year:</span>
                  </div>
                  <div style="width:24mm;font-family:Arial Narrow;font-size:16pt;font-weight:bold;float:left;">
                    2022
                    <span style="width:2mm;"/>
                    <xsl:call-template name="LinkToLeftoverDataTableInline">
              ...
              <div class="styGenericDiv" style="width:50mm;                 border-right:0px solid black;                 border-top:1px solid black;      ">
                ...
                <div class="styIRS499W2PRCell" style="height:55mm;font-family:arial narrow;font-size:;border-bottom-width:0px;">
                   <div class="styIRS499W2PRCell" style="height:10mm;font-family:arial narrow;font-size:;border-bottom-width:0px;">
                    <span style="padding-left:2mm;">Indique si la remuneración incluye pagos al <br/>empleado por: 
                      ...
                      <!--<label>
                            <xsl:call-template name="PopulateLabel">
								...
								<xsl:with-param name="BackupName">IRS499W2PRQlfyPhysicianServicesPymtInd</xsl:with-param>
									...
									<input type="checkbox" alt="Servicios prestados por un medico calificado" class="styCkbox">
										<xsl:call-template name="PopulateCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/QlfyPhysicianServicesPymtInd"/>
											<xsl:with-param name="BackupName">IRS499W2PRQlfyPhysicianServicesPymtInd</xsl:with-param>
										</xsl:call-template>
									</input>
							                    Médico cualificado (Ver instrucciones)
                                                 <br/><span style="padding-left:8.5mm;"/>Qualified physician (See instructions)
							</div>
				<div class="styIRS499W2PRCell" style="border-bottom-width:0px;padding-bottom:1mm;"> 
                      <!--<label>
                            <xsl:call-template name="PopulateLabel">
								...
								<xsl:with-param name="BackupName">IRS499W2PRDomesticServicesPaymentInd</xsl:with-param>
									...
									<input type="checkbox" alt="Servicios domesticos" class="styCkbox">
										<xsl:call-template name="PopulateCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/DomesticServicesPaymentInd"/>
											<xsl:with-param name="BackupName">IRS499W2PRDomesticServicesPaymentInd</xsl:with-param>
										</xsl:call-template>
                      ...
                      <!--<label>
                            <xsl:call-template name="PopulateLabel">
								...
								<xsl:with-param name="BackupName">IRS499W2PRAgriculturalLaborSrvcPymtInd</xsl:with-param>
									...
									<input type="checkbox" alt="Servicios prestados en trabajo agricola" class="styCkbox">
										<xsl:call-template name="PopulateCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/AgriculturalLaborSrvcPymtInd"/>
											<xsl:with-param name="BackupName">IRS499W2PRAgriculturalLaborSrvcPymtInd</xsl:with-param>
										</xsl:call-template>
                      ...
                      <!--<label>
                            <xsl:call-template name="PopulateLabel">
								...
								<xsl:with-param name="BackupName">IRS499W2PRChurchReligiousOrdSrvcPymtInd</xsl:with-param>
									...
									<input type="checkbox" alt="Servicios prestados por un ministro de una iglesia o por un miembro de una orden" class="styCkbox">
										<xsl:call-template name="PopulateCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/ChurchReligiousOrdSrvcPymtInd"/>
											<xsl:with-param name="BackupName">IRS499W2PRChurchReligiousOrdSrvcPymtInd</xsl:with-param>
										</xsl:call-template>
									</input>
							                    Ministro de una iglesia o miembro de una <br/><span style="padding-left:8.5mm;"/>orden religiosa - Minister of a church or
				...
				<div class="styIRS499W2PRCell" style="border-bottom-width:0px;padding-bottom:1mm;"> 
                      <!--<label>
                            <xsl:call-template name="PopulateLabel">
								...
								Profesionales de la salud (Ver
								<br/><span style="padding-left:8.5mm;"/>instrucciones) 
								<br/><span style="padding-left:8.5mm;"/>Health professionals (See instructions)
															</div>							
				<div class="styIRS499W2PRCell" style="border-bottom-width:0px;padding-bottom:1mm;"> 
                      <!--<label>
                            <xsl:call-template name="PopulateLabel">
								...
								<xsl:with-param name="BackupName">IRS499W2PRChurchReligiousOrdSrvcPymtInd</xsl:with-param>
									...
									<input type="checkbox" alt="Servicios prestados por un ministro de una iglesia o por un miembro de una orden" class="styCkbox">
										<xsl:call-template name="PopulateCheckbox">
											<xsl:with-param name="TargetNode" select="$FormData/DirectEmploymentPaymentGrp/DirectEmploymentPaymentInd"/>
											<xsl:with-param name="BackupName">IRS499W2PRHealthProfessionalsPymtInd</xsl:with-param>
										</xsl:call-template>
									</input>
									Empleo directo (Ver instrucciones)
									<br/><span style="padding-left:8.5mm;"/>Direct employment (See instructions)
									<br/><span style="padding-left:8.5mm;"/>(i) Horas trabajadas
									<br/><span style="padding-left:8.5mm;"/>Hours worked
									<div style="width:20mm;border-bottom:1px solid black; margin-left:1mm;">
										        <xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="$FormData/DirectEmploymentPaymentGrp/HoursWorkedQty"/>
												  </xsl:call-template>
												</div>
									<br/><span style="padding-left:8.5mm;"/>(ii) EIN 
												<div style="width:26mm;border-bottom:1px solid black; margin-left:1mm;">
										          <xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="$FormData/DirectEmploymentPaymentGrp/EIN"/>
												  </xsl:call-template>
												</div>								
								  ...
								  <!--<label>
										<xsl:call-template name="PopulateLabel">
											...
											<xsl:with-param name="BackupName">IRS499W2PROtherPaymentsInd</xsl:with-param>
												...
												<input type="checkbox" alt="Otros" class="styCkbox">
													<xsl:call-template name="PopulateCheckbox">
														<xsl:with-param name="TargetNode" select="$FormData/OtherPaymentsInd"/>
														<xsl:with-param name="BackupName">IRS499W2PROtherPaymentsInd</xsl:with-param>
													</xsl:call-template>
												...
												Otros/Others:<br/>
												<div style="width:40mm;border-bottom:1px solid black; margin-left:4mm;">
										          <xsl:call-template name="PopulateText">
