...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
				...
				<form name="Form8919">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styFTBox" style="width:135mm;border-right:1px solid black;border-left:1px solid black;height:20mm;padding-top:2mm;">
							...
							<div class="styFBT" style="height:4mm;margin-top:0mm;padding-top:1mm;">
								<!--<img src="{$ImagePath}/Small_Right_Pointing_Arrow.gif" alt="Right Arrow Image"/>--> Go to <i>
									<a href="http://www.irs.gov/form8919">www.irs.gov/Form8919</a>
								</i> for the latest information.<br/>
								<!--<img src="{$ImagePath}/Small_Right_Pointing_Arrow.gif" alt="Right Arrow Image"/>-->
					...
					<div style="width:187mm;border-bottom:none;">
						...
						<div class="styCodes" style="width:187mm; height:auto;font-size:7.5pt;padding-left:17mm;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;">
							...
							<span style="width:161mm;float:left;">
									I received a Form W-2 and a Form 1099-MISC and/or 1099-NEC from this firm for 2022. The amount on Form 1099-MISC and/or 1099-NEC should have been included as wages on Form W-2. <b>(Don't file Form SS-8 if you select reason code H.)</b>
							</span>
						</div>
					</div>
					...
					<div style="width:187mm; ">
						...
						<div class="styLNDesc" style="width:139.60mm;height:auto;float:left;padding-top:1mm;">
							<b>Total wages.</b> Combine lines 1 through 5 in column (f). Enter here and on Form 1040, 1040-SR, or 1040-NR, <br/>line 1g
							<!--Dotted Line-->
					...
					<div style="width:187mm;">
						...
						<div style="float:left;width:7.05mm;height:auto;background-color:lightgrey;border-left:1px solid black;border-right:1px solid black;padding-top:4.8mm;"/>
					</div>
					<!--Line 8 -->
					<div style="width:187mm;">
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:139.60mm;height:auto;float:left;padding-top:1mm;">
							<div style="float:left;">Add lines 11 and 12. Enter here. Include as tax on your annual tax return (Schedule 2 (Form 1040), line 6; Form 1040-PR, Part I, line 6; Form 1040-SS, Part I, line 6). See the instructions there
									<!--Dotted Line-->
								<span style="margin-left:2mm;letter-spacing:3.5mm;font-weight:bold;">......</span>
								<!--<span style="width:5px;"/>-->
								<!--<img src="{$ImagePath}/Small_Right_Pointing_Arrow.gif" alt="Right Arrow Image"/>-->
							</div>
						</div>
						<div class="styLNRightNumBoxNBB" style="width:7mm;height:auto;padding-top:4mm;">13</div>
						<div class="styLNAmountBox" style="height:auto;width:32mm;font-size:7pt;padding-top:4mm;border-bottom:none;">
							<xsl:call-template name="PopulateAmount">
					...
					<div class="pageEnd" style="width:187mm; font-size:7pt;border-top:2px solid black; padding-top:0.5mm;text-align:right;">
						...
						<div style="float:right;">
							<span style="width:40px;"/>  
								  Form <span class="styBoldText" style="font-size:8pt;">8919</span> (2022)
								</div>
					</div>
	...
	<xsl:template name="CreateTableHeaders">
		<tr class="styDepTblHdr">
			...
			<th scope="col" class="styTableCell" style="width:32mm;font-size:7pt;text-align:center;font-weight:normal;vertical-align:top;">
				<b>(b)</b>Firm's federal<br/>identification<br/>number<br/>(see instructions)
			</th>
			<th scope="col" class="styTableCell" style="width:21mm;font-size:7pt;text-align:center;font-weight:normal;vertical-align:top;padding-top:4mm;">
				<b>(c)</b>Enter<br/>reason code<br/>from above.   
			</th>
			<th scope="col" class="styTableCell" style="width:33.5mm;font-size:7pt;text-align:center;font-weight:normal;vertical-align:top;">
				<b>(d)</b>Date of IRS<br/>determination or<br/>correspondence<label for="receivedInd"/>
				<br/>(MM/DD/YYYY)<br/>(see instructions)
			</th>
			<th scope="col" class="styTableCell" style="width:22mm;font-size:7pt;text-align:center;font-weight:normal;vertical-align:top;">
				<b>(e)</b>Check<br/>if Form<br/>1099-MISC<br/>and/or<br/>1099-NEC<br/>was received.
			</th>
			<th scope="col" class="styTableCell" style="width:43mm;font-size:7pt;text-align:center;font-weight:normal;vertical-align:top;border-right:none;">
				<b>(f)</b>Total wages<br/>received with<br/>no social security<br/>or Medicare tax<br/>withholding and not<br/>reported on Form W-2
			</th>
		</tr>
	</xsl:template>
	...
	<xsl:template name="CreateEmptyTableRows">
		...
		<tr style="font-size: 7pt;">
			...
			<td class="styTableCell" style="width:5%;font-size: 7pt; text-align:center;">
				...
				<label>
					<xsl:attribute name="for">Firm<xsl:value-of select="$Number"/>Form1099ReceivedInd</xsl:attribute>
				</label>
				<span style="width:4px"/>
			</td>
			<!--Amount-->
	...
	<xsl:template name="CreateTableHeaders1">
		<tr class="">
			...
			<th scope="col" class="styTableCell" style="width:37mm;font-size:7pt;text-align:center;font-weight:normal;vertical-align:top;border-right:none;">
				<b>(f)</b>Total wages<br/>received with<br/>no social security<br/>or Medicare tax<br/>withholding and not<br/>reported on Form W-2
			</th>
		</tr>
	</xsl:template>
