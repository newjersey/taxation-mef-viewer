		...
		<html lang="EN-US">
			...
			<body class="styBodyClass">
				<form name="Form8864" id="Form8864">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styFTBox" style="width:127mm;height:19.5mm;">
							<div class="styMainTitle" style="height:11mm;padding-top:.5mm;">
							  Biodiesel, Renewable Diesel, and Sustainable <br/>Aviation Fuels Credit          
							</div>
					...
					<!-- Start Caution Line -->
					<div class="styBB" style="width:187mm;height:55mm;font-size:8.5pt;">
						...
						<span class="styNormalText" style="width: 187mm;padding-top:1mm;">The sustainable aviation fuel credit is only available for fuel produced after 2022.</span>
						<span class="styNormalText" style="height:auto;width: 187mm;padding-top:2mm;">
							<b>Biodiesel or renewable diesel mixtures.</b> Claimant produced a mixture by mixing biodiesel with diesel fuel (or renewable
							diesel with liquid fuel (other than renewable diesel). The biodiesel used to produce the biodiesel mixture met ASTM D6751
							...
							D975, D396, or other equivalent standard approved by the IRS. <b>Sustainable aviation fuel (SAF).</b> Claimant produced a 
							mixture by mixing SAF with kerosene. The SAF used to produce the mixture was liquid fuel, and the portion of such mixture
							which wasn't kerosene met ASTM D7566, or the Fischer-Tropsch provisions of ASTM D1655, Annex A1. <b>For all claims.</b> The 
							mixtures were sold by the claimant to any person for use as a fuel or was used as a fuel by the claimant. Claimant has 
							attached the appropriate certificates and, if applicable, appropriate reseller statements. Claimant has no reason to believe
							that the information in the certificate or statement is false. See the instructions for additional information and requirements.
                      </span>
					</div>
					<!-- end Caution Line -->
					<!--Table header Begin -->
					...
					<div style="width:187mm;height:auto;">
						...
						<div class="styLNDesc" style="height:7mm;width:97.7mm;padding-top:3.5mm;">
							<span style="float:left">Sustainable aviation fuel credit (see instructions)</span>
							<!--Dotted Line-->
							<span class="styDotLn" style="float:right;font-weight:bold;padding-right: 2mm;">........</span>
						</div>
						...
						<div class="styLNAmountBox" style="height:7mm;width:24mm;padding-right:1mm;padding-top:3.5mm;">
							<!-- Line 8a-->
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="$FormData/SustainableAviationFuelCrGrp/GallonsQty"/>
						...
						<div class="styLNAmountBox" style="height:7mm;width:20mm;text-align:left;border-bottom-color:#000000;word-break:break-all;">
							...
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="$FormData/SustainableAviationFuelCrGrp/Rt"/>
						...
						<div class="styLNAmountBox" style="height:7mm;border-bottom-color:#000000;padding-top:3.5mm;">
							<!-- Line 7c-->
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/SustainableAviationFuelCrGrp/ClaimAmt"/>
					...
					<div style="width:187mm">
						...
						<div class="styLNDesc" style="width:138.75mm;height:7mm;">
							Biodiesel and renewable diesel fuels credit from partnerships, S corporations, cooperatives, estates, and<br/> trusts (see instructions)
							<!--Dotted Line-->
							<span class="styDotLn" style="float:right;font-weight:bold;padding-right: 2mm;">..........................</span>
						</div>						
					...
					<div class="styBB" style="width:187mm">
						...
						<div class="styLNDesc" style="width:138.75mm;height:7mm;">
							Cooperatives, estates, and trusts, subtract line 12 from line 11. Report this amount on the appropriate line<br/> of Form 3800
							<!--Dotted Line-->
					...
					<div style="width:187mm;font-size:7pt;border-top-width:1px">
						...
						<div style="float:right">
							<span style="margin-right:32mm; ">Cat. No. 25778F</span>Form <span style="font-size:8pt;"><b>8864</b></span> (Rev. 12-2022)
                        </div>
					</div>
