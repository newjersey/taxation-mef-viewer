		...
		<xsl:if test="$RowCounter &lt;25">
			<tr>
				...
				<td class="styTableCell" style="text-align:left; border-right-width: 0px; width: 173mm">
					<xsl:if test="($Print=$Separated) and (count($FormData/RlnOfActyToAccomOfExmptPrpsGrp/
					RlnOfActyToAccomOfExmptPrpsGrp) &gt;24) and 
					($RowCounter=1)">
						<xsl:call-template name="PopulateAdditionalDataTableMessage">
							<xsl:with-param name="TargetNode" 
							select="$FormData/RlnOfActyToAccomOfExmptPrpsGrp/RlnOfActyToAccomOfExmptPrpsGrp/
	...
	<xsl:template match="/">
		...
		<html>
				...
				<form name="IRS990PF">
					...
					<div class="styBB" style="width:187mm; height:24mm;">
						...
						<div class="styFTBox" style="width:124mm;height:24mm;padding-top: 1.5mm">
							...
							<div class="styFBT" style="font-size: 8pt; margin-top: 0px">or Section 4947(a)(1) Trust Treated as 
								Private Foundation</div>
							<div class="styFBT" style="font-size: 7pt; font-weight: normal; margin-top: 0px; padding-top: 1mm">
								<span style="padding-right: 2mm">
									<img src="{$ImagePath}/990PF_Bullet_Sm.gif" alt="right arrow"/>
								</span>	
								<span class="styBoldText">Do not enter social security numbers on this form as it may be made
								 public.
								</span>
								<br/>
								...
								<span class="styBoldText">Go to <a href="http://www.irs.gov/form990pf" 
									title="Link to IRS.gov"><i>www.irs.gov/Form990PF</i></a> for instructions and the latest 
									information.
								</span>
							</div>
						</div>
						<div class="styTYBox" style="width:29mm;height:24mm;">							
							<div class="styOMB" style="height:5mm;font-size: 7pt">OMB No. 1545-0047</div>
							<div class="styTaxYear" style="padding-top: 1.5mm">20<span class="styTYColor">22</span>
							</div>
						  <div class="styPartName" 
						   style="height:8mm; width:29.5mm;padding-top:0.3mm">Open to Public Inspection</div>					
						</div>
					</div>
					<!--   END FORM HEADER   -->
					<div class="styComType" style="width:187mm; font-size: 8pt; padding-top: 1.5mm; padding-bottom:1.5mm">
						<div class="styBoldText" style="height:3mm;width:182mm;">
						  For calendar year 2022, or tax year beginning						
							<xsl:choose>
								<xsl:when test="string-length($RtnHdrData/TaxPeriodBeginDt) != 0 and 
									string-length($RtnHdrData/TaxPeriodEndDt) != 0" >
					...
					<div style="width:187mm;float:left;clear:left;">
						...
						style="width:122mm;height:29mm;border-left-width:0px;border-top-width:1px;border-right-width:1px;
						...
						<div class="styEINDateAssets" style="width:65mm;height:5mm;border-bottom-width: 0px; padding-top: 2mm">
							...
							<label for="Pending" style="float: left; clear:none; padding-left: 1mm">If exemption application is
							 pending,
							 check here
							</label>
								...
								<span style="width:30mm;"> Check all that apply: </span> 						
									...
									<span style="width:58mm;">
										<input type="checkbox" alt="InitialReturnOfAFormerPublicCharity" class="styIRS990PFCkBox">
											<xsl:call-template name="PopulateCheckbox">
												<xsl:with-param name="TargetNode" 
												 select="$FormData/InitialReturnFormerPubChrtyInd"/>
												<xsl:with-param name="BackupName">IRS990PFInitialReturnFormerPublicChrty
												</xsl:with-param>
											</xsl:call-template>
										</input>
										<label>
									...
									<span style="width:28mm;">
										<input type="checkbox" alt="FinalReturn" class="styIRS990PFCkBox">
											<xsl:call-template name="PopulateCheckbox">
												...
												<xsl:with-param name="BackupName">IRS990PFFutureFilingNotRequiredInd
												</xsl:with-param>
											</xsl:call-template>
										</input>
										<label>
							...
							<span style="float: right; ">
								...
								<input type="checkbox" alt="PFStatusTermSect507b1A" class="styCkBox">
									<xsl:call-template name="PopulateCheckbox">
										...
										<xsl:with-param name="BackupName">PFStatusTermSect507b1A</xsl:with-param>
									</xsl:call-template>
								</input>
							</span>
						</span>										
					...
					<div style="width: 187mm;">
						...
						<span style="width: 55mm; float: left; border-style: solid; border-left-width: 0px; 
						  border-right-width: 1px; border-top-width: 0px; border-bottom-width: 1px;padding-top:1mm; height: 15mm">
					...
					<!-- BEGIN Part I -->
					<!--<div>-->
					<table class="styTable" style="font-size: 7pt; border-color:black; width: 187mm;clear:none;" cellspacing="0">
						<thead style="font-size: 6pt">
								...
								<th scope="col" class="styTableCellHeader" valign="top" rowspan="3" colspan="2" 
									...
									<span class="styPartDesc" style="width: 71mm; font-size: 8pt;">
									  ...
									  <i style="font-size: 6pt;font-weight:normal">
										(The total of amounts in columns (b), (c), and (d) 
										may not necessarily equal the amounts in column (a) (see instructions).)
									  </i>
									</span>
								</th>
								<th scope="col" class="styTableCellHeader"  rowspan="3" colspan="2" style="height: 4mm; 
								  width: 29mm;">
							...
							<tr>
								<th scope="col" class="styTableCellHeader" colspan="2" style="height: 4mm; width: 12mm; 
								  border-bottom-width: 0px; border-right-width: 0px;">
								  <span class="styTableCellPad"/>
								</th>
							</tr>
							<tr>
								<th scope="col" class="styTableCellHeader" style="height: 4mm; width: 6mm;
								  border-right-width: 0px;">
									<span class="styTableCellPad"/>
								</th>
								<th scope="col" class="styTableCellHeader" style="height: 4mm; width: 6mm; 
						...
						<tbody valign="top">
							...
							<tr>
								<td class="styIRS990VTImageBox" style="width: 4mm; border-right: 1px solid black; 
									border-top-width: 0px; border-bottom: 1px solid black" 
									rowspan="16" valign="middle">
									<img src="{$ImagePath}/990PF_Revenue.gif" alt="Revenue"/>
								</td>							
								<td class="styLNLeftNumBox" style="width:4mm; padding-left: 2mm;">1
								</td>
								<td class="styIRS990PFLNDesc" colspan="2" style="border-right-width:0px;" >
									<span style="">Contributions, gifts, grants, etc., received (attach schedule)	
									</span>
								</td>
								<td class="styIRS990PFLNAmountBox" colspan="2" style="border-right-width:1px; boder-bottom-width:1px; 
									float:none;	width: 29mm;vertical-align:bottom;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" 
											select="$FormData/AnalysisOfRevenueAndExpenses/ContriRcvdRevAndExpnssAmt"/>
									</xsl:call-template>
								</td>							
			...
			<tr>
				...
				<tr>					
					<td class="styLNLeftNumBox" style="width: 4mm;padding-left: 2mm;">5a
					</td>
        ...
        <span class="styIRS990PFUnderlinedText" style="font-size: 6pt; text-align: right; width:22mm; float:right">
							...
							<tr>
								...
								<td class="styIRS990PFLNAmountBox" colspan="2" style="border-right-width:1px; border-left-width: 0px; 
									width: 29mm">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" 
										select="$FormData/AnalysisOfRevenueAndExpenses/ContriPaidRevAndExpnssAmt"/>
									</xsl:call-template>
								</td>
								<td class="styIRS990PFShadingCell">
									<span class="styTableCellPad"/>
								...
								<td class="styIRS990PFLNAmountBox" style="border-left-width: 0px; border-right-width:0px">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" 
										select="$FormData/AnalysisOfRevenueAndExpenses/ContriPaidDsbrsChrtblAmt"/>
									</xsl:call-template>
								</td>
							</tr>
							<tr>
								<td class="styLNLeftNumBox" style="border-color: black; border-style: solid; border-left-width: 0px; 
									border-top-width: 0px; border-right-width: 0px; border-bottom-width: 1px; padding-top:1mm; 
									width: 7mm;	height:8mm">26
								</td>
								<td class="styIRS990PFLNDesc" colspan="2" style="border-bottom-width: 1px; font-size: 7pt; 
									padding-top: 1mm">
									<span class="styBoldText">Total expenses and disbursements. </span> Add lines 24 and 25
								</td>
								<td class="styIRS990PFLNAmountBox" colspan="2" style="border-right-width:1px; border-left-width: 0px; 
									width: 29mm;vertical-align:bottom">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" 
										select="$FormData/AnalysisOfRevenueAndExpenses/TotalExpensesRevAndExpnssAmt"/>
									</xsl:call-template>
								</td>
								<td class="styIRS990PFLNAmountBox" style="border-right-width:1px; border-left-width: 0px;
									...
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" 
										select="$FormData/AnalysisOfRevenueAndExpenses/TotalExpensesNetInvstIncmAmt"/>
									</xsl:call-template>
								</td>
								<td class="styIRS990PFLNAmountBox" style="border-right-width:1px; border-left-width: 0px;
									vertical-align:bottom">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" 
										select="$FormData/AnalysisOfRevenueAndExpenses/TotalExpensesAdjNetIncmAmt"/>
									</xsl:call-template>
								</td>
								<td class="styIRS990PFLNAmountBox" style="border-left-width: 0px; border-right-width:0px;
									vertical-align:bottom">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" 
										select="$FormData/AnalysisOfRevenueAndExpenses/TotalExpensesDsbrsChrtblAmt"/>
									</xsl:call-template>
								</td>
							</tr>	
							<!--  Lines 27, a, b, c  -->
							<tr>
								<td class="styIRS990VTImageBox" style="width: 4mm;border-style: solid; border-color: black; 
								...
								<td class="styIRS990PFShadingCell" style="border-bottom-width: 0px; height:4.5mm; 
							...
							<tr>
								...
								<td class="styIRS990PFLNAmountBox" style="font-size: 6pt; border-right-width:1px; 
									border-left-width: 0px;vertical-align:bottom">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" 
										select="$FormData/AnalysisOfRevenueAndExpenses/NetInvestmentIncomeAmt"/>
									</xsl:call-template>
								</td>
								<td class="styIRS990PFShadingCell">
									<span class="styTableCellPad"/>
							...
							<tr>
								<td class="styLNLeftLtrBox" style="border-color: black; border-style: solid; border-right-width: 0px; 
									border-left-width: 0px; border-top-width: 0px; border-bottom-width: 1px; width:7mm; height:5mm">c
								</td>
					...
					<div style="width:187mm; float: none; clear: none">
						...
						<div style="float:right">Cat. No. 11289X 
							<span style="width:60px"/>
								Form <span class="styBoldText" style="font-size: 8pt">990-PF</span> (2022)
						</div>
					</div>
					<div class="pageEnd"/>
					...
					<div class="styGenericDiv" style="width:187mm">
						<div style="float: left; clear: none">Form 990-PF (2022)</div>
...
<!--								<tr>
        ...
        <img src="{$ImagePath}/990PF_Bullet_Md.gif" alt="right arrow"/>
					...
					<div style="width:187mm;border-top-width:1px; height:5mm" class="styBB">
						...
						<div style="float:right">
							<xsl:call-template name="SetDynamicTableToggleButton">
								<xsl:with-param name="TargetNode" 
									select="$FormData/CapGainsLossTxInvstIncmDetail/CapGainsLossTxInvstIncmGrp"/>
					...
					<div style="font-size: 7pt; width: 187mm" >
							...
							<div>
								...
								<div  class="styLNDesc" style="text-align: left; width: 121mm; border-bottom-width: 0px; border-right-width: 0px; ">
									<span style="float: left; clear:none">Reserved--><!--Enter the net value of noncharitable-use assets for 2021 from Part X, line 5--><!--</span>
									<span class="styDotLn" style="float:right">...........................</span>
								</div>
					...
					<!-- Part V  -->
					<div style="width:187mm;border-top-width: 1px" class="styBB">
						<div class="styPartName" style="width:15mm;">Part V
						</div>
					...
					<table class="styTable" style="font-size: 7pt; border-color:black;width:187mm" cellspacing="0">
						...
						<tbody valign="top">
							...
							<tr>
								...
								<td class="styTableCell" colspan="2"  style="text-align: left;float:none ; width: 136mm; 
									border-bottom-width: 0px; border-right-width:0px">
								...
								<td rowspan="5" width="3mm">
									<img src="{$ImagePath}/990PF_Bracket_Med.gif" alt="Bracket for line 1a"/>
								</td>
							...
							<tr>
								...
								<td class="styTableCell" colspan="3" 
									style="padding-top: 1mm; text-align: left; width: 136mm; border-bottom-width: 0px; 
										border-right-width: 0px">
									<span style="font-size: 7pt; ">All other domestic foundations enter 1.39% (0.0139) of line 27b. Exempt 
										foreign organizations enter 4% (0.04) of Part I, line 12, col. (b)
									</span>
								</td>
							...
							<tr>
								...
								<td class="styTableCell" colspan="3" style="text-align: left; width: 140mm; border-bottom-width: 0px; 
									border-right-width: 0px">
									<span style="float: left; clear: none">
										<span class="styBoldText">Tax based on investment income. </span> Subtract line 4 from line 3. 
					...
					<table class="styTable" style="font-size: 7pt; border-color:black; width: 187mm" cellspacing="0">
						...
						<tbody valign="top">
							...
							<tr>
								...
								<td class="styTableCell"  style="padding-left:3mm;text-align: left; width: 99mm; 
								  border-bottom-width: 0px;	border-right-width: 0px">
								...
								<td class="styLNAmountBox" colspan="2" style="width: 36mm">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" 
											select="$FormData/ExciseTaxBasedOnInvstIncmGrp/EstimatedPlusOvpmtIncmTxAmt"/>
										</xsl:call-template>
								</td>
								<td class="styLNRightNumBox" style="background-color: lightgrey; border-bottom-width: 0px">
									<span style="width: 1px"/>
							...
							<tbody valign="top">
								<tr>
									...
									<td class="styTableCell" colspan="2" style="padding-left:3mm;text-align: left; width: 143mm; border-bottom-width: 0px; border-right-width: 0px">
										...
										<span class="styDotLn">..............									
											...
											<xsl:when test="$FormData/ExciseTaxBasedOnInvstIncmGrp/OriginalReturnOverpaymentAmt">
													<xsl:call-template name="LinkToLeftoverDataTableInline">
														<xsl:with-param name="Desc">Part VI Line 7 - Original Return Overpayment
														</xsl:with-param>
														<xsl:with-param name="TargetNode" 
														select="$FormData/ExciseTaxBasedOnInvstIncmGrp/
									...
									<td class="styLNAmountBox" style="width: 30mm; ">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
											 select="$FormData/ExciseTaxBasedOnInvstIncmGrp/TotalPaymentsAndCreditsAmt"/>
										</xsl:call-template>
									</td>
								</tr>
								<tr>
									<td class="styLNLeftNumBox" style="padding-top:1mm;padding-left: 3mm; width: 5mm">8</td>
									<td class="styTableCell" colspan="2" style="padding-left:3mm;text-align: left; width: 134mm; 
										border-bottom-width: 0px; border-right-width: 0px">
											Enter any <span class="styBoldText">penalty</span> for underpayment of estimated tax. 
										<label>
											<xsl:call-template name="PopulateLabel">
												<xsl:with-param name="TargetNode" 
												select="$FormData/ExciseTaxBasedOnInvstIncmGrp/Form2220AttachedInd"/>
										...
										<span style="width: 1mm"/>if Form 2221 is attached.
										<xsl:call-template name="SetFormLinkInline">
											<xsl:with-param name="TargetNode" 
											select="$FormData/ExciseTaxBasedOnInvstIncmGrp/Form2220AttachedInd"/>
											<xsl:with-param name="TabOrder" select="2"/>
									...
									<td class="styLNAmountBox" style="width: 30mm; height:5mm">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
											select="$FormData/ExciseTaxBasedOnInvstIncmGrp/EsPenaltyAmt"/>
										</xsl:call-template>
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class="styTableCell" style="padding-left:3mm; text-align: left; width: 90mm; border-bottom-width: 0px; border-right-width: 1px;">
									    Enter the amount of line 10 to be: <span class="styBoldText" style="font-size:6pt;">Credited to 2023 estimated tax</span>
										<span style="width: 1mm"/>
										<img src="{$ImagePath}/990PF_Bullet_Md.gif" alt="right arrow"/>
										<span style="width: 1mm"/>
					...
					<!-- Part VI-A -->
					<div style="width:187mm;border-top-width: 1px" class="styBB">
						<div class="styPartName" style="width: 20mm">Part VI-A</div>
					...
					<div style="width: 187mm; padding-left: 8mm;">
						<div class="styLNDesc" style="width: 155mm">						
							<img src="{$ImagePath}/T_Bullet_round.gif" alt="round bullet"/>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="font-size: 7pt; width: 155mm;">
						  ...
						  <span class="styItalicText"> If "Yes," complete Part II, col. (c), </span>
						</div>
						<div class="styLNRightNumBox" style="border-bottom-width: 0px"/>
						<div class="styLNRightNumBox" style="border-bottom-width: 0px"/>
						<div class="styLNRightNumBox" style="border-bottom-width: 0px"/>
					...
					<div style="width: 187mm">
						<div class="styLNLeftLtrBox"/>
						<div class="styLNDesc" style="width: 155mm" >
						<td class="styTableCell" colspan="2" style="text-align: left;  border-bottom-width: 0px; 
								border-right-width: 0px">
							<span class="styItalicText" style="float:left">and Part XIV.</span>
							<span class="styDotLn" style="float:right;clear: none">.................................</span>  
						</td>	   
						</div>
						...
						<div class="styLNRightNumBox" >
							<xsl:call-template name="PopulateYesBoxText">
								<xsl:with-param name="TargetNode" 
								select="$FormData/StatementsRegardingActyGrp/AtLeast5000InAssetsInd"/>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBox" >
							<xsl:call-template name="PopulateNoBoxText">
						...
						<div class="styGenericDiv" style="width: 179mm;height:100%;">
							<div class="styLNDesc" style="width: 155mm;height:100%;">
								...
								<span class="styIRS990PFUnderlinedText" style="width: 130mm; font-size: 6pt">
									...
									(count($FormData/StatementsRegardingActyGrp/OrgReportOrRegisterStateCd) &gt;25)">
										<xsl:call-template name="PopulateAdditionalDataTableMessage">
											<xsl:with-param name="TargetNode" 
											select="$FormData/StatementsRegardingActyGrp/OrgReportOrRegisterStateCd"/>
										</xsl:call-template>
									</xsl:if>
									<xsl:if test="($Print != $Separated) or (($Print = $Separated) and 
									(count($FormData/StatementsRegardingActyGrp/OrgReportOrRegisterStateCd)	&lt;26))">
							...
							<div class="styLNRightNumBox" style="height:6.5mm; background-color: lightgrey; 
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none">Is the foundation claiming status as a private operating foundation 
								within the meaning of section 4942(j)(3)</span>
						</div>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom-width: 0px"/>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom-width: 0px"/>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom-width: 0px"/>
					...
					<div style="width: 187mm">
						<div class="styLNLeftLtrBox"/>
						<div class="styLNDesc" style="width: 155mm">
						   or 4942(j)(5) for calendar year 2022 or the taxable year beginning in 2022?  See the instructions for 
						   Part XIII.
						</div>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom-width: 0px"/>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom-width: 0px"/>
					...
					<div style="width: 187mm">
						<div class="styLNLeftNumBox"/>
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none">If "Yes," complete Part XIII
							</span>
							<span class="styDotLn" style="float: right; clear: none">.............................</span>
						</div>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style=" width: 155mm">
						  ...
						  <span class="styItalicText"> If "Yes," attach a schedule listing their names </span>
						</div>
						<div class="styLNRightNumBox" style="border-bottom-width: 0px"/>
						<div class="styLNRightNumBox" style="border-bottom-width: 0px"/>
						<div class="styLNRightNumBox" style="border-bottom-width: 0px"/>						
					...
					<!--BEGIN HEADER-->
					<div class="styGenericDiv" style="width:187mm">
						<div style="float: left; clear: none">Form 990-PF (2022)
						</div>
						<div style="float:right">
					...
					<div style="width:187mm;border-top-width: 1px" class="styBB">
						...
						style="width: 100mm;font-weight:normal"><b>Statements Regarding Activities</b> (continued)</div>
					</div>		
					<!--  Line 11  -->
					<div style="width: 187mm">
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
						  Did the foundation comply with the public inspection requirements for its annual returns and exemption 
						  application?
						</div>
					...
					<span style="float:left;">
						...
						<span class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none">
								At any time during calendar year 2022, did the foundation have an interest in or a signature or other 
								authority over
							</span></span>
						<span style="float:right;">
					...
					<div class="styBB" style="width: 187mm;padding-top:0mm;">
						...
						<span style="float:right;">
							...
							<span class="styLNRightNumBox" style="border-top-width:0px">
								<xsl:call-template name="PopulateYesBoxText">
									<xsl:with-param name="TargetNode" 
									select="$FormData/StatementsRegardingActyGrp/ForeignAccountsQuestionInd"/>
								</xsl:call-template>
							</span>
							<span class="styLNRightNumBox" style="border-top-width:0px;">
								<xsl:call-template name="PopulateNoBoxText">
					...
					<!-- Start Part VI-B -->
					<div style="width:187mm;border-top-width: 1px" class="styBB">
						<div class="styPartName" style="width: 20mm">Part VI-B</div>
					...
					<div style="width: 187mm">
						<div class="styLNLeftNumBox"/>
						<div class="styLNDesc" style="width: 155mm">
							<span class="styBoldText">File Form 4720 if any item is checked in the "Yes" column, unless an exception 
							applies.</span>
						</div>
						<div class="styLNRightNumBox" style="background-color: lightgrey">
							<span style="width: 1px"/>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none">During the year did the foundation 
					...
					<div style="width: 187mm">
						...
						<div class="styLNRightNumBox" style="text-align:left;font-size:6pt">1a(1)</div>
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateYesBoxText">
								<xsl:with-param name="TargetNode" 
								select="$FormData/StatementsRegardingActy4720Grp/SaleOrExchDisqualifiedPrsnInd"/>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateNoBoxText">
					...
					<div style="width: 187mm">
						...
						<div class="styLNRightNumBox" style="text-align:left;font-size:6pt">1a(2)</div>
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateYesBoxText">
								<xsl:with-param name="TargetNode" 
								select="$FormData/StatementsRegardingActy4720Grp/BrrwOrLendDisqualifiedPrsnInd"/>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateNoBoxText">
					...
					<div style="width: 187mm">
						...
						<div class="styLNRightNumBox" style="text-align:left;font-size:6pt">1a(3)</div>
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateYesBoxText">
								<xsl:with-param name="TargetNode" 
								select="$FormData/StatementsRegardingActy4720Grp/FurnGoodsDisqualifiedPrsnInd"/>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateNoBoxText">
					...
					<div style="width: 187mm">
						...
						<div class="styLNRightNumBox" style="text-align:left;font-size:6pt">1a(4)</div>
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateYesBoxText">
								<xsl:with-param name="TargetNode" 
								select="$FormData/StatementsRegardingActy4720Grp/PayCompDisqualifiedPrsnInd"/>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateNoBoxText">
					...
					<div style="width: 187mm">
						...
						<div class="styLNRightNumBox" style="text-align:left;font-size:6pt">1a(5)</div>
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateYesBoxText">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none">
								<span class="styBoldText">(6)</span> 
									 ...
									 (<span class="styBoldText">Exception.</span> Check "No"
							    </span>
						</div>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom:0"/>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom:0"/>
					...
					<div style="width: 187mm">
						...
						<div class="styLNRightNumBox" style="text-align:left;font-size:6pt">1a(6)</div>
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateYesBoxText">
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none"> 
								 If any answer is "Yes" to 1a(1)–(6), did <span class="styBoldText">any </span> of the acts fail to 
								 qualify under the exceptions described in Regulations
						    </span>
						</div>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom:0"/>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom:0"/>
						...
						<div class="styLNDesc" style="width: 155mm">
							...
							<span style="float: right; clear:none; padding-right: 6.25mm">
								<input type="checkbox" alt="RelyingCurrNoticeDisasterAsst1" class="styCkBox">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" 
											select="$FormData/StatementsRegardingActy4720Grp/RelyingCurrentNtcDsstrAsstInd"/>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none"> 
								 Did the foundation engage in a prior year in any of the acts described in 1a, other than excepted 
								 acts,
							</span>
						</div>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom:0"/>
					...
					<div style="width: 187mm">
						...
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateYesBoxText">
								<xsl:with-param name="TargetNode" 
								 select="$FormData/StatementsRegardingActy4720Grp/UncorrectedPriorActsInd"/>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none"> 
								 and 6e) for tax year(s) beginning before 2022?<span class="styDotLn" 
									 style="float: none; clear: none">....................</span>
							</span>
						</div>
						...
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateYesBoxText">
								<xsl:with-param name="TargetNode" 
									select="$FormData/StatementsRegardingActy4720Grp/UndistributedIncomePYInd"/>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateNoBoxText">
							...
							<span style="float: left; clear: none"> 
								...
								<xsl:choose>
									<xsl:when test="$FormData/StatementsRegardingActy4720Grp/UndistributedIncomePY1Yr != ''">
										...
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" 
												select="$FormData/StatementsRegardingActy4720Grp/UndistributedIncomePY1Yr"/>
										</xsl:call-template>
									</xsl:when>
									<xsl:otherwise>
								...
								<xsl:choose>
									<xsl:when test="$FormData/StatementsRegardingActy4720Grp/UndistributedIncomePY2Yr != ''">
										...
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" 
												select="$FormData/StatementsRegardingActy4720Grp/UndistributedIncomePY2Yr"/>
										</xsl:call-template>
									</xsl:when>
									<xsl:otherwise>
										<span style="width: 2mm"/>20<span class="styIRS990PFUnderlinedText" style="width: 6mm"/>
								...
								<xsl:choose>
									<xsl:when test="$FormData/StatementsRegardingActy4720Grp/UndistributedIncomePY3Yr != ''">
										...
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" 
												select="$FormData/StatementsRegardingActy4720Grp/UndistributedIncomePY3Yr"/>
										</xsl:call-template>
									</xsl:when>
									<xsl:otherwise>
										<span style="width: 2mm"/>20<span class="styIRS990PFUnderlinedText" style="width: 6mm"/>
								...
								<xsl:choose>
									<xsl:when test="$FormData/StatementsRegardingActy4720Grp/UndistributedIncomePY4Yr != ''">
										...
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" 
												select="$FormData/StatementsRegardingActy4720Grp/UndistributedIncomePY4Yr"/>
										</xsl:call-template>
									</xsl:when>
									<xsl:otherwise>
										<span style="width: 2mm"/>20<span class="styIRS990PFUnderlinedText" style="width: 6mm"/>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none"> 
								 Are there any years listed in 2a for which the foundation is  <span class="styBoldText">not</span> 
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none"> 
								 to <span class="styBoldText">all </span> years listed, answer "No" and attach statement—see 
								 instructions.)
								<xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode" 
										select="$FormData/StatementsRegardingActy4720Grp/UndistrIncmSect4942a2NotAppInd"/>
									<xsl:with-param name="TabOrder" select="2"/>
								</xsl:call-template>
								<span class="styDotLn" style="float: none; clear: none">..............</span>
							</span>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none"> 
								 If the provisions of section 4942(a)(2) are being applied to <b>any</b> of the years listed in 2a, 
								 list the years here.
							</span>
						</div>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom:0"/>
							...
							<span style="float: left; clear: none">
								...
								<xsl:choose>
									<xsl:when test="$FormData/StatementsRegardingActy4720Grp/UndistrIncmSect4942a2AppYr1Yr != ''">
										...
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" 
												select="$FormData/StatementsRegardingActy4720Grp/UndistrIncmSect4942a2AppYr1Yr"/>
										</xsl:call-template>
									</xsl:when>
									<xsl:otherwise>
										<span style="width: 2mm"/>20<span class="styIRS990PFUnderlinedText" style="width: 6mm"/>
								...
								<xsl:choose>
									<xsl:when test="$FormData/StatementsRegardingActy4720Grp/UndistrIncmSect4942a2AppYr2Yr != ''">
										...
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" 
												select="$FormData/StatementsRegardingActy4720Grp/UndistrIncmSect4942a2AppYr2Yr"/>
										</xsl:call-template>
									</xsl:when>
									<xsl:otherwise>
										<span style="width: 2mm"/>20<span class="styIRS990PFUnderlinedText" style="width: 6mm"/>
								...
								<xsl:choose>
									<xsl:when test="$FormData/StatementsRegardingActy4720Grp/UndistrIncmSect4942a2AppYr3Yr != ''">
										...
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" 
												select="$FormData/StatementsRegardingActy4720Grp/UndistrIncmSect4942a2AppYr3Yr"/>
										</xsl:call-template>
									</xsl:when>
									<xsl:otherwise>
										<span style="width: 2mm"/>20<span class="styIRS990PFUnderlinedText" style="width: 6mm"/>
								...
								<xsl:choose>
									<xsl:when test="$FormData/StatementsRegardingActy4720Grp/UndistrIncmSect4942a2AppYr4Yr != ''">
										...
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" 
												select="$FormData/StatementsRegardingActy4720Grp/UndistrIncmSect4942a2AppYr4Yr"/>
										</xsl:call-template>
									</xsl:when>
									<xsl:otherwise>
										<span style="width: 2mm"/>20<span class="styIRS990PFUnderlinedText" style="width: 6mm"/>
					...
					<div style="width: 187mm">
						...
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateYesBoxText">
								<xsl:with-param name="TargetNode" 
									select="$FormData/StatementsRegardingActy4720Grp/BusinessHoldingsInd"/>
								<xsl:with-param name="BackupName">IRS990PFUndistrIncome4942a2NotAppliedYes</xsl:with-param>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBox">
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none"> 
								...
								<span class="styBoldText">(1)
								</span> any purchase by the foundation
							</span>
						</div>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom:0"/>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom:0"/>
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none"> 
							 or disqualified persons after May 26, 1969; 
								 <span class="styBoldText">(2)
								 </span> the lapse of the 5-year period (or longer period approved
							</span>
						</div>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom:0"/>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom:0"/>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none"> 
								 ...
								 or <span class="styBoldText">(3)</span>
							</span>
						</div>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom:0"/>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom:0"/>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none"> 
								 the lapse of the 10-, 15-, or 20-year first phase holding period?<span class="styItalicText"> 
								 (Use Schedule C, Form 4720, to determine</span>
							</span>
						</div>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom:0"/>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom:0"/>
					...
					<div style="width: 187mm">
						...
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateYesBoxText">
								<xsl:with-param name="TargetNode" 
									select="$FormData/StatementsRegardingActy4720Grp/ExcessBusinessHoldingsInd"/>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none"> 
								Did the foundation invest during the year any amount in a manner that would jeopardize its charitable 
								purposes?
							</span>
						</div>
						<div class="styLNRightNumBox">4a</div>
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateYesBoxText">
								<xsl:with-param name="TargetNode" 
									select="$FormData/StatementsRegardingActy4720Grp/JeopardyInvestmentsInd"/>
								<xsl:with-param name="BackupName">IRS990PFExcessBusinessHoldingsYes</xsl:with-param>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBox">
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none"> 
								 Did the foundation make any investment in a prior year (but after December 31, 1969) that could 
								 jeopardize its
						    </span>
						</div>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom:0"/>
					...
					<div style="width: 187mm" class="styBB">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none"> 
								 charitable purpose that had not been removed from jeopardy before the first day of the tax year 
								 beginning in 2022?
						    </span>
							<span class="styDotLn">..</span>
						</div>
						...
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateYesBoxText">
								<xsl:with-param name="TargetNode" 
									select="$FormData/StatementsRegardingActy4720Grp/UncorrectedPYJeopardyInvstInd"/>
					...
					<div style="width:187mm;border-top-width: 1px" class="styBB">
						<div class="styPartName" style="width: 20mm">Part VI-B</div>
						<div class="styPartDesc" style="width: 160mm">
							Statements Regarding Activities for Which Form 4720 May Be Required <span style="font-weight:normal"> 
							<i>(continued)</i></span>
						</div>
					</div>					
					<!--  Line 5a and (1)-(5) -->
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none">During the year did the foundation pay or incur any amount to:
							</span>
						</div>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom:0">
							<span style="width: 1px"/>
					...
					<div style="width: 187mm">
						...
						<div class="styLNRightNumBox" style="font-size:6pt">5a(1)</div>
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateYesBoxText">
								<xsl:with-param name="TargetNode" 
									select="$FormData/StatementsRegardingActy4720Grp/InfluenceLegislationInd"/>
								<xsl:with-param name="BackupName">IRS990PFUncorrectedJeopardyInvestmentsYes</xsl:with-param>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBox">
					...
					<div style="width: 187mm">
						...
						<div class="styLNRightNumBox" style="font-size:6pt">5a(2)</div>
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateYesBoxText">
								<xsl:with-param name="TargetNode" 
									select="$FormData/StatementsRegardingActy4720Grp/InfluenceElectionInd"/>
								<xsl:with-param name="BackupName">IRS990PFUncorrectedJeopardyInvestmentsYes</xsl:with-param>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBox">
					...
					<div style="width: 187mm">
						...
						<div class="styLNRightNumBox" style="font-size:6pt">5a(3)</div>
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateYesBoxText">
								<xsl:with-param name="TargetNode" 
									select="$FormData/StatementsRegardingActy4720Grp/GrantsToIndividualsInd"/>
								<xsl:with-param name="BackupName">IRS990PFUncorrectedJeopardyInvestmentsYes</xsl:with-param>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBox">
					...
					<div style="width: 187mm">
						...
						<div class="styLNRightNumBox" style="font-size:6pt">5a(4)</div>
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateYesBoxText">
								<xsl:with-param name="TargetNode" 
									select="$FormData/StatementsRegardingActy4720Grp/GrantsToOrganizationsInd"/>
								<xsl:with-param name="BackupName">IRS990PFUncorrectedJeopardyInvestmentsYes</xsl:with-param>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBox">
					...
					<div style="width: 187mm">
						...
						<div class="styLNRightNumBox" style="font-size:6pt">5a(5)</div>
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateYesBoxText">
								<xsl:with-param name="TargetNode" 
									select="$FormData/StatementsRegardingActy4720Grp/NoncharitablePurposeInd"/>
								<xsl:with-param name="BackupName">IRS990PFUncorrectedJeopardyInvestmentsYes</xsl:with-param>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBox">
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none"> 
								 If any answer is "Yes" to 5a(1)–(5), did <span class="styBoldText">any 
								 </span> of the transactions fail to qualify under the exceptions described in
						    </span>
						</div>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom:0"/>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom:0"/>
					...
					<div style="width: 187mm">
						...
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateYesBoxText">
								<xsl:with-param name="TargetNode" 
									select="$FormData/StatementsRegardingActy4720Grp/TransactionsFailToQlfyAsExcInd"/>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							...
							<span style="float: right; clear:none; padding-right: 6.25mm">
								<input type="checkbox" alt="Organizations relying on a current notice regarding disaster assistance" 
									class="styCkBox">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" 
											select="$FormData/StatementsRegardingActy4720Grp/RelyingCurrentNtcDsstrAsst1Ind"/>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none"> 
								 Did the foundation, during the year, pay premiums, directly or indirectly, on a personal benefit 
								 contract?
								 <span class="styDotLn" style="float: none; clear: none">....</span>
							</span>
						</div>
						...
						<div class="styLNRightNumBox">
							<xsl:call-template name="PopulateYesBoxText">
								<xsl:with-param name="TargetNode" 
									select="$FormData/StatementsRegardingActy4720Grp/PayPremiumsPrsnlBnftCntrctInd"/>
					...
					<div class="styNBB" style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none"> 
								 If "Yes", did the foundation receive any proceeds or have any net income attributable to the 
								 transaction?
							</span>
								 <span class="styDotLn">.....</span>
						</div>
						...
						<div class="styLNRightNumBox" style=" border-bottom:1">
							<xsl:call-template name="PopulateYesBoxText">
								<xsl:with-param name="TargetNode" 
									select="$FormData/StatementsRegardingActy4720Grp/ProceedsOrNetIncomeInd"/>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 155mm">
							<span style="float: left; clear: none"> Is the foundation subject to the section 4960 tax on payment(s) 
							of more than $1,000,000 in remuneration or
						    </span>
						</div>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom:0"/>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom:0"/>
					...
					<div style="width:187mm;border-top-width: 0px; float: none; clear: both" class="styBB">
						<div class="styPartName" style="width:18mm; margin-top: 2mm; margin-bottom:2.5mm">Part VII</div>
        ...
        <span class="styNormalText">
          Compensation
					...
					<div class="styBB" style="width: 187mm"><!--
						...
						<img src="{$ImagePath}/990PF_Bullet_Md.gif" alt="right arrow" style="padding-right:5.8mm"/>
					...
					<div style="width:187mm;border-top-width: 0px; " class="styBB">
						<div class="styPartName" style="width:18mm;">Part VIII-A</div> 
					...
					<!--  Part VIII-B  -->
					<div style="width:187mm;border-top-width: 1px" class="styBB">
						<div class="styPartName" style="width:18mm">Part VIII-B</div>
						<div class="styPartDesc" style="width:169mm">
					...
					<div class="styTableContainer" style="width: 187mm; height: 100%; border-bottom-width: 0px">
						<table class="styTable" style="font-size: 7pt; border-color:black" cellspacing="0">
							<thead class="styTHead">
								<tr scope="col">
									<th scope="col" colspan="1" class="styTableCellHeader" style="border-right-width: 0px; width: 155mm; 
										text-align: left; font-size: 6pt; padding-left: 4mm">
										<span class="styNormalText">
										  Describe the two largest program-related investments made by the foundation during the tax 
										  year on lines 1 and 2.
										</span>
									</th>
									<th scope="col" class="styTableCellHeader" style="border-right-width:0px; border-left-width: 1px; width: 32mm">
										<span class="styNormalText">
					...
					<span style="float:right;">
							...
							<img src="{$ImagePath}/990PF_Bullet_Md.gif" alt="right arrow"/></span>					</span>
						</span>
					...
					<div style="width:187mm;border-top-width: 1px; height:auto" class="styBB" >
						...
						<div class="styPartDesc" style="height:auto;  width:174mm; padding-top:0mm;">
							Minimum Investment Return 
							<span class="styNormalText" style="float:none; font-size:7pt"> (All domestic foundations must complete this
							 part. Foreign foundations, see instructions.)
							</span>
						</div>
					</div>
					<!--  Line 1  -->
					...
					<div style="width: 187mm">
						...
						<div class="styLNAmountBox">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" 
									select="$FormData/MinimumInvestmentReturnGrp/AdjustedTotalFMVOfUnusedAstAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Line 3  -->
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 139mm">
							<span style="float:left; clear: none">Cash deemed held for charitable activities. Enter 1.5% (0.015) of line 3 
							(for greater amount, see</span>
						</div>
						<div class="styLNRightNumBox" style="border-bottom-width: 0px"/>
						<div class="styLNAmountBox" style="border-bottom-width: 0px"/>
					</div>
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 139mm">
							<span style="float:left; clear: none">instructions)
								<xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode" 
										select="$FormData/MinimumInvestmentReturnGrp/CashDeemedCharitableAmt"/>
									<xsl:with-param name="TabOrder" select="2"/>
								</xsl:call-template>
							</span>
							<span class="styDotLn">.............................</span>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 139mm">
							<span style="float:left; clear: none">
								<span class="styBoldText">Net value of noncharitable-use assets. 
								</span> Subtract line 4 from line 3.
							</span>
								<span class="styDotLn">............</span>
						</div>
						<div class="styLNRightNumBox">5</div>
						<div class="styLNAmountBox">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" 
									select="$FormData/MinimumInvestmentReturnGrp/NetVlNoncharitableAssetsAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Line 5  -->
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 139mm">
							<span style="float:left; clear: none">
								<span class="styBoldText">Minimum investment return. </span> Enter 5% (0.05) of line 5</span>
							<span class="styDotLn">................</span>
						</div>
						<div class="styLNRightNumBox" style="border-bottom-width: 0px">6</div>
						<div class="styLNAmountBox" style="border-bottom-width: 0px">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/MinimumInvestmentReturnGrp/
					...
					<!--  Part X  -->
					<div style="width:187mm;border-top-width: 1px" class="styBB">
						<div class="styPartName" style="margin-top: 2mm; height:auto">Part X</div>
						<div class="styPartDesc" style="height:auto; font-size:7pt; font-weight:normal; padding-top:0mm;">
							<b>Distributable Amount</b>
							<label style="font-weight:normal">
								<xsl:call-template name="PopulateLabel">
									<xsl:with-param name="TargetNode" select="$FormData/DistributableAmountGrp/
									  Sect4942j3j5FndtnAndFrgnOrgInd"/>
									<xsl:with-param name="BackupName">IRS990PFSect4942j3j5FndtnAndFrgnOrg</xsl:with-param>
								</xsl:call-template> 
							</label> (see instructions) (Section 4942(j)(3) and (j)(5) private operating foundations and certain foreign
							  organizations check here 
								<img src="{$ImagePath}/990PF_Bullet_Md.gif" alt="right arrow"/>
								<span style="width: 2mm"/>
								<input type="checkbox" alt="Section 4942(j)(3) and (j)(5) and do not complete this part" 
								  class="styIRS990PFCkBox">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" select="$FormData/DistributableAmountGrp/
										  Sect4942j3j5FndtnAndFrgnOrgInd"/>
										<xsl:with-param name="BackupName">IRS990PFSect4942j3j5FndtnAndFrgnOrg</xsl:with-param>
					...
					<div style="width: 187mm">
						<div class="styLNLeftNumBox">1</div>
						<div class="styLNDesc" style="width: 139mm">
							<span style="float:left; clear: none">Minimum investment return from Part IX, line 6</span>
							<span class="styDotLn">..................</span>
						</div>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 99mm">
							<span style="float:left; clear: none">Tax on investment income for 2022 from Part V, line 5</span>
							<span class="styDotLn">.......</span>
						</div>
						<div class="styLNRightNumBox">2a</div>
						<div class="styLNAmountBox" style="">
					...
					<div style="width: 187mm">
						<div class="styLNLeftLtrBox">b</div>
						<div class="styLNDesc" style="width: 99mm">
							<span style="float:left; clear: none">Income tax for 2022. (This does not include the tax from Part V.)
							</span>
							<span class="styDotLn">...</span>
						</div>
						<div class="styLNRightNumBox">2b</div>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 139mm">
							<span style="float:left; clear: none">
								<span class="styBoldText">Distributable amount </span> as adjusted. Subtract line 6 from line 5. 
									Enter here and on Part XII, line 1  </span>
								<span class="styDotLn">...</span>
						</div>
					...
					<div style="width:187mm;border-top-width: 1px; height: 8mm" class="styBB">
						<div class="styPartName" style="margin-top: 2.5mm; margin-bottom:1.5mm">Part XI</div>
					...
					<div style="width: 187mm">
						<div class="styLNLeftNumBox">1</div>
						<div class="styLNDesc" style="width: 139mm">
							<span style="float:left; clear: none">Amounts paid (including administrative expenses) to accomplish 
								charitable, etc., purposes:</span>
						</div>
						<div class="styLNRightNumBox" style="background-color: lightgrey; border-bottom-width: 0px; height: 4.5mm"/>
						<div class="styLNAmountBox" style="border-bottom-width: 0px; height: 4.5mm"/>
					</div>
					...
					<div style="width: 187mm">
						<div class="styLNLeftLtrBox">a</div>
						<div class="styLNDesc" style="width: 139mm">
							<span style="float:left; clear: none">Expenses, contributions, gifts, etc.—total from Part I, column (d), 
								line 26
								<xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode" 
										select="$FormData/PFQualifyingDistributionsGrp/ExpensesAndContributionsAmt"/>
									<xsl:with-param name="TabOrder" select="2"/>
								</xsl:call-template>
							</span>
							<span class="styDotLn">..........</span>
					...
					<div style="width: 187mm">
						<div class="styLNLeftLtrBox">b</div>
						<div class="styLNDesc" style="width: 139mm">
							<span style="float:left; clear: none">Program-related investments—total from Part VIII-B</span>
							<span class="styDotLn">..................</span>
						</div>
						<div class="styLNRightNumBox">1b</div>
						<div class="styLNAmountBox">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" 
									select="$FormData/PFQualifyingDistributionsGrp/ProgramRelatedInvstTotalAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Line 1b  -->
					...
					<div style="width: 187mm">
						...
						<div class="styLNAmountBox">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/PFQualifyingDistributionsGrp/CharitableAssetsAcquisPaidAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Line 2 -->
					...
					<div style="width: 187mm">
						...
						<div class="styLNAmountBox">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/PFQualifyingDistributionsGrp/
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 139mm">
							<span style="float:left; clear: none">Cash distribution test (attach the required schedule)
								<xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode" 
										select="$FormData/PFQualifyingDistributionsGrp/SetAsideCashDistriTestAmt"/>
									<xsl:with-param name="TabOrder" select="2"/>
								</xsl:call-template>
							</span>
							<span class="styDotLn">.................</span>
						...
						<div class="styLNAmountBox">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/PFQualifyingDistributionsGrp/SetAsideCashDistriTestAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Line 3b  -->
					...
					<div class="styBB" style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 139mm">
							<span style="float:left; clear: none">
								<span class="styBoldText">Qualifying distributions. </span> Add lines 1a through 3b. Enter here and on 
									Part XII, line 4.
								</span>
							<span class="styDotLn">.......</span>
						</div>
						<div class="styLNRightNumBox" style="border-bottom:0px">4</div>
						<div class="styLNAmountBox" style="border-bottom:0px">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/PFQualifyingDistributionsGrp/QualifyingDistributionsAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Line 4  -->
					...
					<div style="width:187mm;border-top-width: 1px; border-bottom-width: 0px; height: 4mm" class="styBB">
						<div class="styPartName" style="width: 20mm">Part XII</div>
						<div class="styPartDesc" style="width: 160mm">Undistributed Income 
							<span class="styNormalText"> 
								(see instructions)
							</span>
						</div>
						...
						<table class="styTable" style="font-size: 7pt; border-color:black" cellspacing="0">
							<thead>
								<tr scope="col">
									...
									<th scope="col" class="styTableCellHeader" style="width: 28mm">
									    (b)<br/>
										<span class="styNormalText">Years prior to 2021</span>
									</th>
									<th scope="col" class="styTableCellHeader" style="width: 28mm">
									    (c)<br/>
										<span class="styNormalText">2021</span>
									</th>
									<th scope="col" class="styTableCellHeader" style="width: 28mm; border-right-width: 0px">
									    (d)<br/>
										<span class="styNormalText">2022</span>
									</th>
								</tr>
							</thead>
							<tfoot/>
							<tbody valign="top">
								...
								<tr>
									<td class="styTableCell" 
										style="text-align:left; border-bottom-width: 0px; border-left-width: 0px; 
											border-top-width: 0px; width: 75mm" colspan="2">
									...
									<td class="styTableCellSmall" style="width: 28mm; border-right-width:0px; font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/UndistributedIncomeGrp/
								...
								<tr>
									...
									<td class="styTableCellSmall" style="width: 28mm; border-bottom-width:0px; 
										background-color:lightgrey; border-right-width:0px">
										<span class="styTableCellPad"/>
									</td>
								</tr>
								<!-- End Line 2 -->
								...
								<tr>
									<td class="styTableCell" 
										...
										<span style="width: 1.5mm"/>
										    Enter amount for 2021 only<span class="styDotLn" style="float:none; clear:none">.......
										</span>
									</td>
									<td class="styTableCellSmall" style="width: 28mm; background-color:lightgrey">
										<span class="styTableCellPad"/>
									...
									<td class="styTableCellSmall" style="width: 28mm; font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
												select="$FormData/UndistributedIncomeGrp/UndistributedIncomePYAmt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="width: 28mm; background-color:lightgrey; 
									  border-right-width:0px">
								...
								<tr>
									<td class="styTableCell" 
										...
										<xsl:choose>
											<xsl:when test="$FormData/UndistributedIncomeGrp/PriorYear1Yr != ''">
												...
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" 
														select="$FormData/UndistributedIncomeGrp/PriorYear1Yr"/>
												</xsl:call-template>
											</xsl:when>
											<xsl:otherwise>
										...
										<xsl:choose>
											<xsl:when test="$FormData/UndistributedIncomeGrp/PriorYear2Yr != ''">
												...
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" 
														select="$FormData/UndistributedIncomeGrp/PriorYear2Yr"/>
												</xsl:call-template>
											</xsl:when>
											<xsl:otherwise>
												<span style="width: 2mm"/>20<span class="styIRS990PFUnderlinedText" style="width: 5mm"/>
										...
										<xsl:choose>
											<xsl:when test="$FormData/UndistributedIncomeGrp/PriorYear3Yr != ''">
												...
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" 
														select="$FormData/UndistributedIncomeGrp/PriorYear3Yr"/>
												</xsl:call-template>
											</xsl:when>
											<xsl:otherwise>
												<span style="width: 2mm"/>20<span class="styIRS990PFUnderlinedText" style="width: 5mm"/>
									...
									<td class="styTableCellSmall" style="width: 28mm; font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
												select="$FormData/UndistributedIncomeGrp/TotalForPriorYearsAmt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="width: 28mm; background-color:lightgrey">
										<span class="styTableCellPad"/>
								...
								<!-- Line 3a -->
								<tr>
									<td class="styTableCell" style="text-align:left; border-bottom-width: 0px; 
									border-left-width: 0px; border-top-width: 0px; width: 47mm">
									...
									<td class="styTableCellSmall" style="width: 28mm; font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
												select="$FormData/UndistributedIncomeGrp/ExcessDistributionCyovYr5Amt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" 
										style="width: 28mm; background-color:lightgrey; border-bottom-width:0px">
										<span class="styTableCellPad"/>
									</td>
									<td class="styTableCellSmall" 
										style="width: 28mm; background-color:lightgrey; border-bottom-width:0px">
									...
									<td class="styTableCellSmall" 
										style="width: 28mm; background-color:lightgrey; border-bottom-width:0px; border-right-width:0px">
										<span class="styTableCellPad"/>
									</td>
								</tr>
								<!-- End Line 3a -->
								<tr>
									...
									<td class="styTableCellSmall" style="width: 28mm; font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
												select="$FormData/UndistributedIncomeGrp/ExcessDistributionCyovYr4Amt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="width: 28mm; background-color:lightgrey; 
										border-bottom-width:0px">
								...
								<tr>
									...
									<td class="styTableCellSmall" style="width: 28mm; font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
												select="$FormData/UndistributedIncomeGrp/ExcessDistributionCyovYr3Amt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="width: 28mm; background-color:lightgrey; 
										border-bottom-width:0px">
								...
								<!-- Line 3d -->
								<tr>
									<td class="styTableCell" style="text-align:left; border-bottom-width: 0px; border-left-width: 0px; 
										border-top-width: 0px; width: 47mm">
										<span class="styBoldText" style="padding-left: 2.5mm">d</span>
										<span style="width: 1.5mm"/>
										    From 2020<span class="styDotLn" style="float:none; clear:none">......</span>
									</td>
									<td class="styTableCellSmall" style="width: 28mm; font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
												select="$FormData/UndistributedIncomeGrp/ExcessDistributionCyovYr2Amt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="width: 28mm; background-color:lightgrey; 
										border-bottom-width:0px">
								...
								<tr>
									<td class="styTableCell" style="text-align:left; border-bottom-width: 0px; border-left-width: 0px; 
										...
										<span style="width: 1.5mm"/>
										    From 2021<span class="styDotLn" style="float:none; clear:none">......</span>
									</td>
									<td class="styTableCellSmall" style="width: 28mm; font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
												select="$FormData/UndistributedIncomeGrp/ExcessDistributionCyovYr1Amt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="width: 28mm; background-color:lightgrey;
										border-bottom-width:0px">
								...
								<tr>
									<td class="styTableCell" 
										style="text-align:left; border-bottom-width: 0px; border-left-width: 0px; 
											border-top-width: 0px; width: 75mm" colspan="2">
										<span class="styBoldText" style="padding-left: 2.5mm">f
										<span style="width: 2mm"/>Total</span>
									...
									<td class="styTableCellSmall" style="width: 28mm; font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
												select="$FormData/UndistributedIncomeGrp/TotalExcessDistributionCyovAmt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="width: 28mm; background-color:lightgrey">
										<span class="styTableCellPad"/>
								...
								<tr>
									<td class="styTableCell" 
										style="text-align:left; border-bottom-width: 0px; border-left-width: 0px; border-top-width: 0px;
										  width: 75mm" colspan="2">
										<span class="styBoldText" style="padding-left: 1.5mm">4</span>
										<span style="width: 2mm"/>Qualifying distributions for 2022 from Part</td>
									<td class="styTableCellSmall" style="width: 28mm; background-color:lightgrey; 
									  border-bottom-width: 0px">
										<span class="styTableCellPad"/>
									</td>
								...
								<tr>
									<td class="styTableCell" 
										...
										<span style="width: 5.5mm"/>
										    XI, line 4: <img src="{$ImagePath}/990PF_Bullet_Md.gif" alt="right arrow"/>
										<span style="width: 2mm"/>$ <span class="styIRS990PFUnderlinedText" 
											style="text-align: right; width: 32mm; font-size: 6pt">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" 
													select="$FormData/UndistributedIncomeGrp/QualifyingDistributionsAmt"/>
											</xsl:call-template>
										</span>
									</td>
									<td class="styTableCellSmall" style="width: 28mm; background-color:lightgrey; 
								...
								<tr>
									<td class="styTableCell" 
										...
										<span style="width: 1mm"/>
										    Applied to 2021, but not more than line 2a</td>
									<td class="styTableCellSmall" style="width: 28mm; background-color:lightgrey">
										<span class="styTableCellPad"/>
									</td>
									<td class="styTableCellSmall" style="width: 28mm; background-color:lightgrey">
								...
								<tr>
									<td class="styTableCell" 
										...
										<span style="width: 1mm"/>
										    Applied to 2022 distributable amount<span class="styDotLn" 
								...
								<tr>
									<td class="styTableCell" 
										style="text-align:left; border-bottom-width: 0px; border-left-width: 0px; border-top-width: 0px;
										  width: 75mm" colspan="2">
										<span class="styItalicText" style="padding-left: 6mm">(If an amount appears in column (d), the
										 <br/>
											<span style="width: 6mm"/>
											    same amount must be shown in column (a).)
											</span>
									</td>
									<td class="styTableCellSmall" style="width: 28mm; background-color:lightgrey; border-bottom-
									  width:0px">
										<span class="styTableCellPad"/>
									</td>
									<td class="styTableCellSmall" style="width: 28mm; background-color:lightgrey; border-bottom-
								...
								<tr>
									<td class="styTableCell" 
										style="text-align:left; border-bottom-width: 0px; border-left-width: 0px; border-top-width: 0px;
										  width: 75mm" colspan="2">
										<span class="styBoldText" style="padding-left: 1.5mm">6<span style="width: 3mm"/>Enter the net
										  total of each column as<br/>
											<span style="width: 6mm"/>
											    indicated below:
										</span>
									</td>
								...
								<tr>
									...
									<td class="styTableCellSmall" style="width: 28mm; background-color:lightgrey; border-right-
									  width:0px">
										<span class="styTableCellPad"/>
									</td>
								</tr>
								...
								<tr>
									<td class="styTableCell" 
										...
										<span style="width: 1mm"/>
										    Undistributed income for 2021. Subtract line<br/>
								...
								<tr>
									...
									style="text-align:left; border-bottom-width: 0px; border-left-width: 0px; border-top-width: 0px; 
									  width: 75mm" colspan="2">
										...
										<span style="width: 1mm"/>
										    Undistributed income for 2022. Subtract<br/>
										<span style="width: 5.5mm"/>lines 4d and 5 from line 1. This amount must
										    <br/>
										<span style="width: 5.5mm"/>be distributed in 2023
										    <span class="styDotLn" style="float:none; clear:none">..........
										    </span>
									</td>
									<td class="styTableCellSmall" style="width: 28mm; background-color:lightgrey">
								...
								<tr>
									<td class="styTableCell" 
										...
										<span style="width: 2mm"/>Excess distributions carryover from 2017 not
										    <br/>
								...
								<tr>
									<td class="styTableCell" 
										style="text-align:left; border-bottom-width: 0px; border-left-width: 0px; 
											border-top-width: 0px; width: 75mm" colspan="2">
										<span class="styBoldText" style="padding-left: 2mm">9
										<span style="width: 2mm"/>Excess distributions carryover to 2023.
										</span>
										<br/>
								...
								<tr>
									<td class="styTableCell" style="text-align:left; border-bottom-width: 0px; border-left-width: 0px;
									  border-top-width: 0px; width: 47mm">
										...
										<span style="width: 1.5mm"/>
										    Excess from 2021<span class="styDotLn" style="float:none; clear:none">....</span>
									</td>
									<td class="styTableCellSmall" style="width: 28mm; font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/UndistributedIncomeGrp/
								...
								<tr>
									<td class="styTableCell" style="text-align:left; border-bottom-width: 0px; border-left-width: 0px;
									  border-top-width: 0px; width: 47mm">
										<span class="styBoldText" style="padding-left: 2.5mm">e</span>
										<span style="width: 1.5mm"/>
										    Excess from 2022<span class="styDotLn" style="float:none; clear:none">....</span>
									</td>
					...
					<div style="width:187mm;border-top-width: 1px" class="styBB">
						...
						<div class="styPartDesc" style="width: 160mm">
							...
							<span class="styNormalText"> (see instructions and Part VI-A, question 9)
							</span>
						</div>
					</div>
					<!-- Line 1a -->
					<div style="width: 187mm">
						...
						<div class="styLNAmountBox" style="width: 56mm; border-right-width: 0px; height: 6mm; padding-top: 2mm">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" 
									select="$FormData/PrivateOperatingFoundationsGrp/PrivateOperatingFndtnRulingDt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- End Line 1a -->
					...
					<div style="width: 187mm">
						<div class="styLNDesc" style="text-align:left; width: 187mm; height:auto">
							...
							<input type="checkbox" alt="4942(j)(3)" class="styIRS990PFCkBox">
								<xsl:call-template name="PopulateCheckbox">
									<xsl:with-param name="TargetNode" 
									  select="$FormData/PrivateOperatingFoundationsGrp/Section4942j3Ind"/>
							...
							<input type="checkbox" alt="4942(j)(5)" class="styIRS990PFCkBox">
								<xsl:call-template name="PopulateCheckbox">
									<xsl:with-param name="TargetNode" 
										select="$FormData/PrivateOperatingFoundationsGrp/Section4942j5Ind"/>
					...
					<div class="styTableContainer" style="width: 187mm; height: 100%; border-bottom-width: 0px">
						<table class="styTable" style="font-size: 7pt; border-color:black" cellspacing="0">
							...
							<tbody valign="top">
								<!-- Line 2a -->
								<tr>	
									<td class="styTableCell" rowspan="3" style="text-align:left; border-bottom-width: 0px; 
										...
										<span style="width: 6mm"/>investment return from Part IX for each<br/>
										<span style="width: 6mm"/>year listed
										    <span class="styDotLn" style="float:none; clear:none">..........</span>
									</td>
									<td class="styTableCellSmall" style="text-align: center; border-top-width: 1px">Tax year</td>
									<td class="styTableCellSmall" colspan="3" style="text-align: center; border-top-width:1px; 
										width: 75mm">Prior 3 years
									</td>
								...
								<tr>
									<td class="styTableCellSmall" style="text-align: center">
										<span class="styBoldText">(a)</span> 2022</td>
									<td class="styTableCellSmall" style="text-align: center">
										<span class="styBoldText">(b)</span> 2021</td>
									<td class="styTableCellSmall" style="text-align: center">
										<span class="styBoldText">(c)</span> 2020</td>
									<td class="styTableCellSmall" style="text-align: center">
										<span class="styBoldText">(d)</span> 2019
										</td>
								</tr>
								<tr>
									<td class="styTableCellSmall" style="font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
											select="$FormData/PrivateOperatingFoundationsGrp/LessorAdjNetIncmMinInvstRetGrp/
											  CurrentYearAmt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
												select="$FormData/PrivateOperatingFoundationsGrp/LessorAdjNetIncmMinInvstRetGrp/Year1Amt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
												select="$FormData/PrivateOperatingFoundationsGrp/LessorAdjNetIncmMinInvstRetGrp/Year2Amt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
												select="$FormData/PrivateOperatingFoundationsGrp/LessorAdjNetIncmMinInvstRetGrp/Year3Amt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="border-right-width: 0px; font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
												select="$FormData/PrivateOperatingFoundationsGrp/LessorAdjNetIncmMinInvstRetGrp/TotalAmt"/>
										</xsl:call-template>
									</td>
								</tr>
								<!-- End Line 2a -->
								<!-- Line 2b -->
								<tr>
									<td class="styTableCellSmall" style="text-align:left; border-bottom-width: 0px; 
										border-left-width: 0px; border-top-width: 0px; width: 62mm">
									...
									<td class="styTableCellSmall" style="font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
												select="$FormData/PrivateOperatingFoundationsGrp/Pct85LessorAdjIncmOrMinRetGrp/CurrentYearAmt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
												select="$FormData/PrivateOperatingFoundationsGrp/Pct85LessorAdjIncmOrMinRetGrp/Year1Amt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
												select="$FormData/PrivateOperatingFoundationsGrp/Pct85LessorAdjIncmOrMinRetGrp/Year2Amt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
								...
								<tr>
									<td class="styTableCellSmall" style="text-align:left; border-bottom-width: 0px; 
										...
										<span style="width: 2mm"/>
											Qualifying distributions from Part XI,<br/>
									...
									<td class="styTableCellSmall" style="padding-top: 3mm; font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
												select="$FormData/PrivateOperatingFoundationsGrp/QualifyingDistributionsGrp/CurrentYearAmt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="padding-top: 3mm; font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
												select="$FormData/PrivateOperatingFoundationsGrp/QualifyingDistributionsGrp/Year1Amt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="padding-top: 3mm; font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
												select="$FormData/PrivateOperatingFoundationsGrp/QualifyingDistributionsGrp/Year2Amt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="padding-top: 3mm; font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
												select="$FormData/PrivateOperatingFoundationsGrp/QualifyingDistributionsGrp/Year3Amt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="border-right-width: 0px; padding-top: 3mm; font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
												select="$FormData/PrivateOperatingFoundationsGrp/QualifyingDistributionsGrp/TotalAmt"/>
										</xsl:call-template>
									</td>
								</tr>
								<!-- End Line 2c -->
								...
								<tr>
									...
									<td class="styTableCellSmall" style="padding-top: 2mm; font-size: 6pt;vertical-align:bottom;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
												select="$FormData/PrivateOperatingFoundationsGrp/QualifyingDistriNotUsedDrtGrp/CurrentYearAmt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="padding-top: 2mm; font-size: 6pt;vertical-align:bottom;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
												select="$FormData/PrivateOperatingFoundationsGrp/QualifyingDistriNotUsedDrtGrp/Year1Amt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="padding-top: 2mm; font-size: 6pt;vertical-align:bottom;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
												select="$FormData/PrivateOperatingFoundationsGrp/QualifyingDistriNotUsedDrtGrp/Year2Amt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="padding-top: 2mm; font-size: 6pt;vertical-align:bottom;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
												select="$FormData/PrivateOperatingFoundationsGrp/QualifyingDistriNotUsedDrtGrp/Year3Amt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="border-right-width: 0px; padding-top: 2mm; font-size: 6pt;vertical-align:bottom;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
												select="$FormData/PrivateOperatingFoundationsGrp/QualifyingDistriNotUsedDrtGrp/TotalAmt"/>
										</xsl:call-template>
									</td>
								</tr>
								<!-- End Line 2d -->
								...
								<tr>
									...
									<td class="styTableCellSmall" style="padding-top: 6mm; font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
												select="$FormData/PrivateOperatingFoundationsGrp/QualifyingDistriMadeDrtGrp/CurrentYearAmt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="padding-top: 6mm; font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
												select="$FormData/PrivateOperatingFoundationsGrp/QualifyingDistriMadeDrtGrp/Year1Amt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="padding-top: 6mm; font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
												select="$FormData/PrivateOperatingFoundationsGrp/QualifyingDistriMadeDrtGrp/Year2Amt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="padding-top: 6mm; font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
												select="$FormData/PrivateOperatingFoundationsGrp/QualifyingDistriMadeDrtGrp/Year3Amt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="border-right-width: 0px; padding-top: 6mm; font-size: 6pt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
												select="$FormData/PrivateOperatingFoundationsGrp/QualifyingDistriMadeDrtGrp/TotalAmt"/>
										</xsl:call-template>
									</td>
								</tr>
								<tr>
					...
					<div style="float:none;clear:both;width:187mm;border-top-width: 1px" class="styBB">
						<div class="styPartName">Part XIV</div>
					...
					<div class="styTableContainer" style="width: 187mm; height: auto;" id="1bSMctn">
						...
						<table class="styTable" style="font-size: 7pt">
							<tbody>
								...
								<xsl:if test="($Print = $Separated) and 
									(count($FormData/SupplementaryInformationGrp/ShareholderManagerNm) &gt;1)">
									<tr>
										<td class="styBB" style="float:none;width: 187mm; padding-left: 6mm; border-bottom-width: 0px">
											<xsl:call-template name="PopulateAdditionalDataTableMessage">
												<xsl:with-param name="TargetNode" select="$FormData/SupplementaryInformationGrp/ShareholderManagerNm"/>
					...
					<div class="styBB" style="text-align:left; width: 187mm; padding-bottom:1.5mm">
						<span style="width: 6mm"/>Check here <img src="{$ImagePath}/990PF_Bullet_Md.gif" alt="right arrow"/>
							...
							<tbody>
									...
									<xsl:for-each select="$FormData/SupplementaryInformationGrp/ApplicationSubmissionInfoGrp">
										...
										<tr>
											<td style="text-align:left; border-bottom-width: 0px; border-left-width: 0px; border-top-width: 0px; width: 187mm">
												...
												<span style="width: 2mm"/>Any restrictions or limitations on awards, such as by 
													geographical areas, charitable fields, kinds of institutions, or other<br/>
								...
								<xsl:if test="(count($FormData/SupplementaryInformationGrp/ApplicationSubmissionInfoGrp)=0) or (($Print = $Separated) and 
									...
									<tr>
										<td style="text-align:left; border-bottom-width: 0px; border-left-width: 0px; border-top-width: 0px; width: 187mm">
											<span class="styBoldText" style="padding-left:2mm">a</span>
											<span style="width: 2mm"/>The name, address, and telephone number or email address of the 
					...
					<div class="styTableContainerNBB" style="width: 187mm; min-height: 66mm; border-bottom-width: 0px"
					 id="Paidctn">
						<xsl:call-template name="SetInitialState"/>
						<table class="styTable" style="font-size: 7pt; border-color:black" cellspacing="0">
							<thead>
								...
								<tr>
									...
									<th scope="col" class="styTableCellHeader" rowspan="2" style="height: 4mm; width: 32mm; 
										border-right-width: 0px">
										<span class="styNormalText">
										  Amount
										</span>
							...
							<tbody valign="top">
										...
										<tr style="border-bottom-width: 0px">
											<td class="styTableCell" style="text-align:left; width: 55mm">
												...
												<xsl:if test="count(RecipientBusinessName/BusinessNameLine1Txt) &gt;0">
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode" select="RecipientBusinessName/
								...
								<tr>
									<td class="styTableCell" style="text-align: left; width: 155mm; padding-left: 4mm" 
										colspan="4">
										<span class="styBoldText">Total <span class="styDotLn" style="float:none; 
											clear:none">.................................</span>
											<img src="{$ImagePath}/990PF_Bullet_Md.gif" alt="right arrow"/>
					...
					<div class="styTableContainerNBB" style="width: 187mm; min-height: 49mm; border-bottom-width: 0px"
					 id="Futurectn">
						<xsl:call-template name="SetInitialState"/>
						<table class="styTable" style="font-size: 7pt; border-color:black" cellspacing="0">
							<thead/>
							...
							<tbody valign="top">
								...
								($Print = $Separated))">
									<tr style="height: 80mm">
										...
										<xsl:choose>
											<xsl:when test="$FormData/SupplementaryInformationGrp/GrantOrContriApprvForFutGrp/
												RecipientPersonNm !=''">
												<xsl:call-template name="PopulateAdditionalDataTableMessage">
													<xsl:with-param name="TargetNode" 
													select="$FormData/SupplementaryInformationGrp/GrantOrContriApprvForFutGrp/
														RecipientPersonNm"/>
												</xsl:call-template>
											</xsl:when>
											<xsl:otherwise>											
					...
					<!--  Part XV-A  -->
					<div style="width:187mm;border-top-width: 1px; float: none; clear:both" class="styBB">
						<div class="styPartName" style="width: 20mm">Part XV-A</div>
						<div class="styPartDesc" style="width: 160mm">
					...
					<table class="styTable" style="width:187mm;font-size: 7pt; border-color:black" cellspacing="0">
						...
						<tfoot/>
						<tbody valign="top">
							<xsl:if test="(count($FormData/AnalysisIncomeProducingActyGrp/ProgramServiceRevenueDtl) &gt;0 and 
							($Print != $Separated)) or
							 (($Print = $Separated) and (count($FormData/AnalysisIncomeProducingActyGrp/ProgramServiceRevenueDtl) 
							 &lt;7))">
								<xsl:for-each select="$FormData/AnalysisIncomeProducingActyGrp/ProgramServiceRevenueDtl">
									<tr>
										<td class="styTableCell" style="text-align:left; border-bottom-width: 0px; border-left-width: 0px; border-top-width: 0px; width: 71mm">
							...
							<xsl:if test="(count($FormData/AnalysisIncomeProducingActyGrp/ProgramServiceRevenueDtl) &lt;7)">
								<xsl:call-template name="RowsAtoF">
									<xsl:with-param name="RowCount" select="count($FormData/AnalysisIncomeProducingActyGrp/ProgramServiceRevenueDtl) + 1"/>
									<xsl:with-param name="Letters" select="7"/>
								</xsl:call-template>
							</xsl:if>
							<xsl:if test="(($Print = $Separated) and (count($FormData/AnalysisIncomeProducingActyGrp/ProgramServiceRevenueDtl) &gt;6))">
								<xsl:call-template name="RowsAtoF">
									<xsl:with-param name="RowCount" select="1"/>
									<xsl:with-param name="Letters" select="7"/>
								</xsl:call-template>
							...
							<tr>
								...
								<td class="styTableCellSmall" style="font-size: 6pt; width: 20mm; text-align: center;vertical-align:bottom;">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$FormData/AnalysisIncomeProducingActyGrp/DividendsAndInterestFromSecDtl/BusinessCd"/>
									</xsl:call-template>
								</td>
								<td class="styTableCellSmall" style="font-size: 6pt; width: 25mm;vertical-align:bottom;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/AnalysisIncomeProducingActyGrp/DividendsAndInterestFromSecDtl/UnrelatedBusinessTaxblIncmAmt"/>
									</xsl:call-template>
								</td>
								<td class="styTableCellSmall" style="font-size: 6pt; width: 25mm; text-align: center;vertical-align:bottom;">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$FormData/AnalysisIncomeProducingActyGrp/DividendsAndInterestFromSecDtl/ExclusionCd"/>
									</xsl:call-template>
								</td>
								<td class="styTableCellSmall" style="font-size: 6pt; width: 25mm;vertical-align:bottom;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/AnalysisIncomeProducingActyGrp/DividendsAndInterestFromSecDtl/ExclusionAmt"/>
									</xsl:call-template>
								</td>
								<td class="styTableCellSmall" style="font-size: 6pt; border-right-width:0px; width: 25mm;vertical-align:bottom;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/AnalysisIncomeProducingActyGrp/DividendsAndInterestFromSecDtl/RelatedOrExemptFunctionIncmAmt"/>
									</xsl:call-template>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="styTableCellSmall" style="font-size: 6pt; width: 20mm; text-align: center;vertical-align:bottom;">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$FormData/AnalysisIncomeProducingActyGrp/OtherInvestmentIncomeGrp/BusinessCd"/>
									</xsl:call-template>
								</td>
								<td class="styTableCellSmall" style="font-size: 6pt; width: 25mm;vertical-align:bottom;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/AnalysisIncomeProducingActyGrp/OtherInvestmentIncomeGrp/UnrelatedBusinessTaxblIncmAmt"/>
									</xsl:call-template>
								</td>
								<td class="styTableCellSmall" style="font-size: 6pt; width: 25mm; text-align: center;vertical-align:bottom;">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$FormData/AnalysisIncomeProducingActyGrp/OtherInvestmentIncomeGrp/ExclusionCd"/>
									</xsl:call-template>
								</td>
								<td class="styTableCellSmall" style="font-size: 6pt; width: 25mm;vertical-align:bottom;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/AnalysisIncomeProducingActyGrp/OtherInvestmentIncomeGrp/ExclusionAmt"/>
									</xsl:call-template>
								</td>
								<td class="styTableCellSmall" style="font-size: 6pt; border-right-width:0px; width: 25mm;vertical-align:bottom;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$FormData/AnalysisIncomeProducingActyGrp/OtherInvestmentIncomeGrp/RelatedOrExemptFunctionIncmAmt"/>
									</xsl:call-template>
								</td>
							</tr>
							<tr>
					...
					<!--  Part XV-B  -->
					<div style="float:none;clear:both;width:187mm;border-top-width: 1px" class="styBB">
						<div class="styPartName" style="width: 20mm">Part XV-B</div>
						<div class="styPartDesc" style="width: 160mm">
							...
							<thead>
								<tr>
									...
									<th scope="col" class="styTableCellHeader" style="text-align: left; border-right-width:0px; width: 173mm; padding-left: 3mm">
										<span class="styNormalText">
											Explain below how each activity for which income is reported in column (e) of Part XV-A contributed importantly to<br/>
					...
					<!--  Part XVI  -->
					<div style="width:187mm;border-top-width: 1px" class="styBB">
						<div class="styPartName" style="width: 20mm; margin-top:2mm">Part XVI</div>
					...
					<!--  Line 1  -->
					<div style="width: 187mm">
						<div class="styLNLeftNumBox" style="width: 5mm;">1
						</div>
						<div class="styLNDesc" style="width: 157mm; font-size: 7pt">Did the organization directly or indirectly engage 
							in any of the following with any other organization described in section 501(c) (other than section 501(c)(3) 
							organizations) or in section 527, relating to political organizations?
						</div>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 180mm; height:auto">
						  ...
						  <span class="styBoldText">(b)</span> should always show the fair market value<br/>
						  of the goods, other assets, or services given by the reporting foundation. If the foundation received less 
						  than fair market value<br/>
						  in any transaction or sharing arrangement, show in column <span class="styBoldText">(d)</span>  the value of 
						  the goods, other assets, or services received.
						</div>
					</div>
					<!--  Line 1d  -->
					<div class="styGenericDiv" style="float:none;clear:both;width:187mm">
					...
					<table cellspacing="0" style="width:187mm;font-size:7pt;">
						<tr>
							<!-- "Sign Here" image -->
							<td  style="width:10mm;font-size:10pt; font-weight:bold;border-right:1px solid black" rowspan="4">
							  Sign Here								
							</td>				
							<td>
								...
								<table class="styTable" cellspacing="0" style="width:176mm;font-size:7pt;">
									<tr>
										<td colspan="6"  style="width:178mm;vertical-align:top;border-color: black; 
										 border-style:solid;	border-top-width: 0px; border-left-width: 0px; 
										 border-bottom-width: 0px; border-right-width:0px; padding-left: 2mm;">
											...
											is true, correct, and complete.  Declaration of preparer (other than taxpayer) is based
									...
									<tr>
										<td rowspan="2" style=";width:6mm;height:8mm;padding-left:1mm;">
											<img src="{$ImagePath}/990PF_Bullet_Jumbo.gif" alt="right arrow"
											 style="width:2mm;height:8mm;"/>
										</td>
										...
										<td class="styIRS990PFSignatureBox" style="float:none; width:25mm;height:4mm;
										...
										<td class="styIRS990PFSignatureBox" style="float:none;width:30mm;height:4mm;
										  border-right-width:0px">
											<xsl:call-template name="PopulateReturnHeaderOfficer">
												<xsl:with-param name="TargetNode">TaxpayerPIN</xsl:with-param>
											</xsl:call-template>
							    ...
							    <input class="styCkbox" alt="MayIRSdiscussReturnWithPreparerYes" type="checkbox" 
							      name="Checkbox" id="dummyidyes" style="width:3mm;">
								<xsl:call-template name="PopulateReturnHeaderOfficer">
									<xsl:with-param name="TargetNode">AuthorizeThirdPartyYesCheckbox
									</xsl:with-param>
							  ...
							  <input class="styCkbox" alt="MayIRSdiscussReturnWithPreparerNo" type="checkbox" 
							    name="Checkbox" id="dummyidno" style="width:2mm;">
								<xsl:call-template name="PopulateReturnHeaderOfficer">
				...
				<table class="styTable" cellspacing="0" style="width:176mm;font-size:7pt;">
					<tr>
						...
						<td rowspan="3" style="width:20mm;font-weight:bold;font-size:10pt;border-top:1px solid black;
						border-bottom:1px solid black; border-right:1px solid black">
						  Paid Preparer Use Only
						</td>
						<!-- Print/Type preparer's name -->
						<td style="vertical-align:top;border-style:solid;border-color:black;border-top-width:1px; 
						  border-bottom-width: 1px; border-left-width: 0px;	border-right-width: 1px;">
							<span class="styIRS990PFSignatureBox" style="float:none;width:42.5mm;border-right-width:0px;
							  border-bottom-width:0px;border-left-width:0px;border-top-width:0px;">
								<span class="styIRS990PFSignatureText" style="width:40mm;padding-top:1mm;padding-left:1mm;">
								  Print/Type preparer's name
								</span>
						...
						<td style="vertical-align:top;border-style:solid;border-color:black;border-top-width:1px; 
						  border-bottom-width: 1px; border-left-width: 0px; border-right-width: 1px;">
							<span class="styIRS990PFSignatureBox" style="width:42.5mm;border-right-width:0px;
							  border-bottom-width:0px;border-left-width:0px;border-top-width:0px;">
								<span class="styIRS990PFSignatureText" style="width:40mm;padding-top:1mm;
								  padding-left:1mm;">Preparer's Signature
								</span>
								<span class="styGenericDiv" style="width:4mm;height:12mm;padding-top: 6mm">
								</span>
								<span class="styGenericDiv" style="width:32mm;height:12mm;padding-top:6mm;">
						...
						<!-- Date -->
						<td style="width:21mm;vertical-align:top;padding-left:.5mm;text-align:right;border-style:solid;
						  border-color:black;border-top-width:1px; border-bottom-width: 1px; border-left-width: 0px; 
						...
						<!-- Self-employed? -->
						<td style="vertical-align:top;border-top:1px solid black;border-style:solid;border-color:black;
						  border-top-width:1px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 1px;">
							<span class="styIRS990PFSignatureText" style="width:22mm;height:15mm;padding-left:.5mm;
							  padding-top:4mm;">
								Check if self-<br/>employed 
								<img src="{$ImagePath}/990PF_Bullet_Sm.gif" alt="right arrow"/>
					...
					<!-- Preparer's info  -->						
					<!--row 2-->
					<td rowspan="1" colspan="4" style="border-bottom:1px solid black;border-right:1px solid black;
					  padding-left:.5mm;">Firm's name
				...
				<!--row 3-->
					<td rowspan="1" colspan="4" style="border-bottom:1px solid black;border-right:1px solid black;
					  padding-left:.5mm;">Firm's address
						<img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
						<span style="width:3mm"/>
						<xsl:call-template name="PopulateReturnHeaderPreparerFirm">
							<xsl:with-param name="TargetNode">AddressLine1Txt</xsl:with-param>
        ...
        (k) <span class="styNormalText">Excess of col. (i)<br/>over col. (j), if any</span>
					...
					<xsl:if test="($Print = $Separated) and (count($FormData/SupplementaryInformationGrp/ContributingManagerNm) &gt;1)">
						<br/>
						<span class="styRepeatingDataTitle">Form 990PF Part XIV Line 1a - List any managers of the foundation who have contributed more than 2% 
					...
					<xsl:if test="($Print = $Separated) and (count($FormData/SupplementaryInformationGrp/ShareholderManagerNm) &gt;1)">
						<br/>
						<span class="styRepeatingDataTitle">Form 990PF Part XIV Line 1b - List any managers of the foundation who own 10% or more of the stock 
					...
					<xsl:if test="($Print = $Separated) and (count($FormData/SupplementaryInformationGrp/ApplicationSubmissionInfoGrp) &gt;1)">
						<br/>
						<span class="styRepeatingDataTitle">Form 990PF Part XIV Line 2a - 2d - Information Regarding Contribution, Grant, Gift, Loan, Scholarship, 
							etc., Programs:</span>
						<xsl:for-each select="$FormData/SupplementaryInformationGrp/ApplicationSubmissionInfoGrp">
							<table class="styDepTbl" style="font-size: 7pt">
								<thead class="styTableThead"/>
					...
					<xsl:if test="($Print = $Separated) and (count($FormData/SupplementaryInformationGrp/GrantOrContributionPdDurYrGrp) &gt;4)">
						<br/>
						<span class="styRepeatingDataTitle">Form 990PF Part XIV Line 3 - Grants and Contributions Paid During the Year or Approved for Future 	
							Payment</span>
						<table class="styDepTbl" style="font-size: 7pt">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
					...
					<xsl:if test="($Print = $Separated) and (count($FormData/AnalysisIncomeProducingActyGrp/ProgramServiceRevenueDtl) &gt;6)">
						<br/>
						<span class="styRepeatingDataTitle">Form 990PF Part XV-A Line 1 - Program service revenue:</span>
						<table class="styDepTbl" style="font-size: 7pt">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
          ...
          Amount          
					...
					<xsl:if test="($Print = $Separated) and (count($FormData/AnalysisIncomeProducingActyGrp/OtherRevenueDescribedGrp) &gt;5)">
						<br/>
						<span class="styRepeatingDataTitle">Form 990PF Part XV-A Line 11 - Other revenue:</span>
						<table class="styDepTbl" style="font-size: 7pt">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<th scope="col" class="styDepTblCell" style="border-bottom-width: 0px; height: 4mm; width: 71mm; text-align:left">
          ...
          Amount          
					...
					<xsl:if test="($Print = $Separated) and (count($FormData/TrnsfrTransRlnNonchrtblEOGrp/TransferScheduleDetail) &gt;16)">
						<br/>
						<span class="styRepeatingDataTitle">Form 990PF Part XVI Line 1d - Information Regarding Transfers To and Transactions and Relationships With Noncharitable
Exempt Organizations</span>
        ...
        <span class="styNormalText">Description of transfers, transactions, and sharing arrangements</span>
					...
					<xsl:if test="($Print = $Separated) and (count($FormData/TrnsfrTransRlnNonchrtblEOGrp/TransferScheduleDetail) &gt;6)">
						<br/>
						<span class="styRepeatingDataTitle">Form 990PF Part XVI Line 2b - Information Regarding Transfers To and Transactions and Relationships With Noncharitable
Exempt Organizations</span>
						<table class="styDepTbl" style="font-size: 7pt">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
