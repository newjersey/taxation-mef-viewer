			...
			<body class="styBodyClass">
				<form id="Form990T">
					...
					<div class="styStdDiv pageEnd" style="border-top:1px solid black;">
						...
						<span style="float:right;">Form <strong>990-T</strong> (2022)</span>
					</div>
					<!-- Page 2 -->
					...
					<div class="styStdDiv">
						...
						<div class="styLNDesc" style="height:auto;">
							...
							<input type="checkbox" class="styCkboxNM" alt="Form 4255 indicator" style="margin-left:0.5mm;">
								<xsl:call-template name="PopulateCheckbox">
							...
							<input type="checkbox" class="styCkboxNM" alt="Form 8611 indicator" style="margin-left:2mm;">
								<xsl:call-template name="PopulateCheckbox">
							...
							<input type="checkbox" class="styCkboxNM" alt="Form 8697 indicator" style="margin-left:2mm;">
								<xsl:call-template name="PopulateCheckbox">
							...
							<input type="checkbox" class="styCkboxNM" alt="Form 8866 indicator" style="margin-left:2mm;">
								<xsl:call-template name="PopulateCheckbox">
							...
							<br />
							<input type="checkbox" class="styCkboxNM" alt="Other tax indicator" style="margin-left:45mm;">
								<xsl:call-template name="PopulateCheckbox">
							...
							<xsl:call-template name="LinkToLeftoverDataTableInline">
								...
								<xsl:with-param name="Desc">Part III, Line 3 - Section 1291 Interest Code</xsl:with-param>
							</xsl:call-template>
							<xsl:call-template name="LinkToLeftoverDataTableInline">
								<xsl:with-param name="TargetNode" select="$FormData/OtherTaxesAmt/@section1291InterestAmt"/>
								<xsl:with-param name="Desc">Part III, Line 3 - Section 1291 Interest Amount</xsl:with-param>
							</xsl:call-template>
							<xsl:call-template name="LinkToLeftoverDataTableInline">
								<xsl:with-param name="TargetNode" select="$FormData/OtherTaxesAmt/@section1294InterestCd"/>
								<xsl:with-param name="Desc">Part III, Line 3 - Section 1294 Interest Code</xsl:with-param>
							</xsl:call-template>
							<xsl:call-template name="LinkToLeftoverDataTableInline">
								<xsl:with-param name="TargetNode" select="$FormData/OtherTaxesAmt/@section1294InterestAmt"/>
								<xsl:with-param name="Desc">Part III, Line 3 - Section 1294 Interest Amount</xsl:with-param>
							</xsl:call-template>
							<span class="sty990TDotLn">..........</span>
						</div>
					...
					<div class="styStdDiv">
						<div class="styLNLeftNumBox">11</div>
						<div class="styLNDesc">
							Enter the amount of line 10 you want: <strong>Credited to 2023 estimated tax</strong>&#9658;
					...
					<div class="styStdDiv" style="">
						...
						<div class="styLNDesc" style="height:auto;width:162mm;">
							At any time during the 2022 calendar year, did the organization have an interest in or a 
