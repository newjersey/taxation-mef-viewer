	...
	<xsl:template match="/">
		...
		<html>
			...
			<body class="styBodyClass">
                ...
                Attach to your tax return. 
							...
							<div class="styFST" style="font-size:7pt;font-weight:bold; padding-top: 1mm">
								<img src="{$ImagePath}/8835_Bullet.gif" alt="right arrow"/>
				Attach to your tax return. 
          		   				 </div>
						...
						<div class="styTYBox" style="width:30mm;height:auto; border-left-width: 1px">
							...
							<div class="styTaxYear" style="height:auto">20<span class="styTYColor">22</span>
							</div>
						...
						<table class="styTable" style="font-size: 7pt; border-color:black" cellspacing="0">
							...
							<tbody valign="top">
								<tr>
									...
									<td class="styTableCellSmall" style="width: 15mm;text-align:center;">$0.026
										<span class="styTableCellPad"/>
									</td>
								...
								<tr>
									...
									<td class="styTableCellSmall" style="width: 15mm;border-bottom-width:1px;text-align:center;">$0.026
										<span class="styTableCellPad"/>
									</td>
									<td class="styTableCellSmall" style="width: 35mm;">
										<span class="styTableCellPad"/>
								...
								<tr>
									...
									<td class="styTableCellSmall" style="width: 15mm; border-bottom-width:1px;text-align:center;">$X.XXX
										<span class="styTableCellPad"/>
									</td>
									<td class="styTableCellSmall" style="width: 35mm;">
										<span class="styTableCellPad"/>
         ...
         Solar<span class="styDotLn" style="float:none; clear:none">.......</span>
              ...
              Add column (c) of lines 1a through 1d and enter here (see instructions)<span style="width: 7mm">
						...
						<span class="styLNRightNumBox" style="height: 5mm;background-co">1e</span>
        ...
        (c)<br/>
							...
							<tbody valign="top">
								<tr>
									<td class="styTableCell" style="text-align:left; border-bottom-width: 0px; border-left-width: 0px; border-top-width: 0px; width: 47mm">
										<span class="styBoldText" style="padding-left: 2mm">2a</span>
										<span style="width: 1.5mm"/>
											Open-loop biomass<span class="styDotLn" style="float:none; clear:none">...</span>
									</td>
									<td class="styTableCellSmall" style="width: 8mm;border-top-width: 1px;text-align:center;font-weight:bold;">2a
									</td>
									<td class="styTableCellSmall" style="width: 36mm;border-top-width:1px">
										<span class="styTableCellPad"/>
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/QualifiedFacilitiesAfter1022/KwHrsPrdcdSoldOpenLoopBmssQty"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="width: 15mm;border-top-width:1px;text-align:center;">$0.013
										<span class="styTableCellPad"/>
									</td>
									<td class="styTableCellSmall" style="width: 39.3mm;border-top-width:1px;">
										<span class="styTableCellPad"/>
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/QualifiedFacilitiesAfter1022/KwHrsPrdcdSoldOpenLopBmssCrAmt"/>
										</xsl:call-template>
									</td>
									<td class="styTableCellSmall" style="width: 7.8mm; background-color:lightgrey; border-bottom-width:0px;">
										<span class="styTableCellPad"/>
									</td>
									<td class="styTableCellSmall" style="width: 28mm; border-bottom-width:0px;border-right-width:0px;">
										<span class="styTableCellPad"/>
								...
								<tr>
									<td class="styTableCell" style="text-align:left; border-bottom-width: 0px; border-left-width: 0px; border-top-width: 0px; width: 47mm">
										<span class="styBoldText" style="padding-left: 4mm">b</span>
										<span style="width: 1.5mm"/>
										 Reserved for future use<span class="styDotLn" style="float:none; clear:none">..</span>
									</td>
									<td class="styTableCellSmall" style="width: 8mm;text-align:center;font-weight:bold;">2b
									</td>
									<td class="styTableCellSmall" style="width: 36mm;background-color:lightgrey;">
										<span class="styTableCellPad"/>
										<!--
										<xsl:call-template name="PopulateAmount">
									...
									<td class="styTableCellSmall" style="width: 15mm;border-bottom-width:1px;text-align:center;background-color:lightgrey;">
										<span class="styTableCellPad"/>
									</td>
									<td class="styTableCellSmall" style="width: 35.25mm;background-color:lightgrey;">
										<span class="styTableCellPad"/>
										<!--
										<xsl:call-template name="PopulateAmount">
        ...
        Landfill gas<span class="styDotLn" style="float:none; clear:none;padding-left:2mm;">.....</span>
									...
									<td class="styTableCellSmall" style="width: 8mm;text-align:center;font-weight:bold;">2c
									</td>
									<td class="styTableCellSmall" style="width: 36mm;">
										<span class="styTableCellPad"/>
										<xsl:call-template name="PopulateAmount">
									...
									<td class="styTableCellSmall" style="width: 15mm; border-bottom-width:1px;text-align:center;">$0.013
										<span class="styTableCellPad"/>
									</td>
         ...
         Trash<span class="styDotLn" style="float:none; clear:none">.......</span>
									...
									<td class="styTableCellSmall" style="width: 8mm;text-align:center;font-weight:bold;">2d
									</td>
									<td class="styTableCellSmall" style="width: 36mm;">
										<span class="styTableCellPad"/>
										<xsl:call-template name="PopulateAmount">
									...
									<td class="styTableCellSmall" style="width: 15mm;text-align:center;">$0.013
										<span class="styTableCellPad"/>
									</td>
									<td class="styTableCellSmall" style="width: 35.25mm;">
										<span class="styTableCellPad"/>
         ...
         Hydropower<span class="styDotLn" style="float:none; clear:none">.....</span>
									...
									<td class="styTableCellSmall" style="width: 8mm;text-align:center;font-weight:bold;">2e
									</td>
									<td class="styTableCellSmall" style="width: 36mm;">
										<span class="styTableCellPad"/>
										<xsl:call-template name="PopulateAmount">
								...
								<tr>
									...
									<td class="styTableCellSmall" style="width: 15mm; text-align:center;padding-top:3mm;">$0.013
										<span class="styTableCellPad"/>
									</td>
              ...
              Add lines 1e and 2g  
                ...
                ..........................
					...
					<div style="width: 187mm">
						...
						<div style="float:left; padding-top: .5mm">
							  Credit before reduction. Subtract line 4 from line 3  
						</div>
						<div style="float:right">
							<span class="styDotLn" style="padding-top: .5mm">  
								.................
					...
					<div style="width: 187mm">
						...
						<span class="styLNDesc" style="width: 137mm;">
							 Special adjustments (see instructions) 
							 	<span style="width:2mm;">
								<span class="styDotLn" style="float: none;padding-left:3mm;">  
							  .....................
							</span>
						...
						<span class="styLNAmountBox" style="width: 34mm; height: 5mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/QualifiedFacilitiesAfter1022/Sect45VSpecialAdjustmentsAmt"/>
								</xsl:call-template>
							<span style="float: left; clear:none"/>
						</span>
					</div>
					...
					<div style="width: 187mm">
						...
						<span class="styLNRightNumBox" style="height: 5mm">10</span>
						<span class="styLNAmountBox" style="width: 34mm; height: 5mm;background-color:lightgrey;">
							<span style="float: left; clear:none"/>
						</span>
					</div>
					...
					<div style="width: 187mm">
						...
						<span class="styLNRightNumBox" style="height: 5mm">11</span>
						<span class="styLNAmountBox" style="width: 34mm; height: 5mm;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/QualifiedFacilitiesAfter1022/SumNetPhaseoutSpecialAdjAmt"/>
								</xsl:call-template>
						</span>
					</div>
					<!--  Line 12 -->
					...
					<div style="width187mm;height:auto;">
						<div class="styLNDesc" style="font-weight:bold; width:145mm; padding-left:9mm; ">Reduction for government grants, subsidized financing, and other credits
						</div>
						<div class="styLNRightNumBoxNBB" style="background-color:lightgrey;padding-left:4mm;"/>
						<div class="styLNAmountBoxNBB"/>
					</div>
					...
					<div style="width: 187mm">
						...
						<div style="float:left; padding-top: .5mm">
						    Total of additions to the capital account for the qualified facility for this and all prior tax years
						</div>
						<div style="float:right">
							<span class="styDotLn" style="padding-top: .5mm">  
							    ...
        ...
        ........................
              ...
              Enter the amount from line 16 applicable to wind facilities the construction of which began during 2017
					...
					<div style="width: 187mm">
						...
						<div style="float:left; padding-top: .5mm">
              For facilities placed in service after 2021, enter -0-; otherwise, multiply line 17a by 20% (0.20)
            </div>
						<div style="float:right">
							<span class="styDotLn" style="padding-top: .5mm">  
								....
					...
					<div style="width: 187mm">
						...
						<div style="float:left; padding-top: .5mm">
						  For facilities placed in service after 2021, enter -0-; otherwise, multiply line 17c by 40% (0.40)
						</div>
						<div style="float:right">
							<span class="styDotLn" style="padding-top: .5mm">  
								....
					...
					<div style="width: 187mm">
						...
						<div style="float:left; padding-top: .5mm">
						  Enter the amount from line 16 applicable to wind facilities the construction of which began during 2019
						</div>
						<div style="float:right">
							...
							<div class="styLNAmountBox" style="width: 34mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/QualifiedFacilitiesAfter1022/WindFacilityYr3Amt"/>
								</xsl:call-template>
							</div>
						</div>
					</div>
					...
					<div style="width: 187mm">
						...
						<div style="float:left; padding-top: .5mm">
						  For facilities placed in service after 2021, enter -0-; otherwise, multiply line 17e by 60% (0.60)
						</div>
						<div style="float:right">
							<span class="styDotLn" style="padding-top: .5mm">  
								....
							...
							<div class="styLNAmountBox" style="width: 34mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/QualifiedFacilitiesAfter1022/WindFcltyConstrPctYr3Amt"/>
								</xsl:call-template>
							</div>
						</div>
					</div>
					...
					<div style="width: 187mm">
						...
						<div style="float:left; padding-top: .5mm">
						  Add lines 17b, 17d, and 17f
						</div>
						<div style="float:right">
							<span class="styDotLn" style="padding-top: .5mm">  
								........................
							</span>
							<div class="styLNRightNumBox">17g</div>
							<div class="styLNAmountBox" style="width: 34mm">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/QualifiedFacilitiesAfter1022/WindFcltyConstrPhaseOutCrAmt"/>
								</xsl:call-template>
							</div>
						</div>
					</div>
					...
					<div style="width: 187mm">
						...
						<div style="float:left; padding-top: .5mm">
						    Subtract line 17g from line 16, and combine the result with any amounts on line 6
						</div>
						<div style="float:right">
							<span class="styDotLn" style="padding-top: .5mm">  
							     .......
              ...
              .................
					...
					<div style="width:187mm">
						<div class="styLNLeftNumBox" style="height:4mm;"/>
						<div style="float:left">
							stop here and report this amount on Schedule K. All others: For electricity produced during the 4-year
						</div>
						<div style="float: right">
							<div class="styLNRightNumBox" style="height:4.5mm;background-color:lightgrey;border-bottom-width: 0px;"/>
							<div class="styLNAmountBox" style="height:4.5mm;border-bottom-width: 0px;width: 34mm"/>
					...
					<div style="width:187mm">
						<div class="styLNLeftNumBox" style="height:4mm;"/>
						<div style="float:left">
							period beginning on the date the facility was placed in service, stop here and report the applicable part
						</div>
						<div style="float: right">
							<div class="styLNRightNumBox" style="height:4.5mm;background-color:lightgrey;border-bottom-width: 0px;"/>
							<div class="styLNAmountBox" style="height:4.5mm;border-bottom-width: 0px;width: 34mm"/>
					...
					<div style="width:187mm">
						<div class="styLNLeftNumBox" style="height:4mm;"/>
						<div style="float:left">
							of this amount on Form 3800, Part III, line 4e. For all other production of electricity, stop here
						</div>
						<div style="float: right">
							<div class="styLNRightNumBox" style="height:4.5mm;background-color:lightgrey;border-bottom-width: 0px;"/>
							<div class="styLNAmountBox" style="height:4.5mm;border-bottom-width: 0px;width: 34mm"/>
					...
					<div style="width: 187mm">
						<div class="styLNLeftNumBox"/>
						<div style="float: left; padding-top: .5mm;">
						    and report the applicable part of this amount on Form 3800, Part III, line 1f (see instructions)
						</div>
						<div style="float: right">
							<span class="styDotLn" style="padding-top: .5mm">  
								 ...
							</span>
							<div class="styLNRightNumBox" style="height: 5mm">20</div>
							<div class="styLNAmountBox" style="width: 34mm; height: 5mm">
								<xsl:call-template name="PopulateAmount">
        ...
        Amount allocated to patrons of the cooperative or beneficiaries of the estate or trust (see instructions) 
					...
					<div style="width:187mm">
						...
						<div style="float:left; padding-top: .5mm">
						Cooperatives, estates, and trusts, subtract line 21 from line 20. For electricity produced during 
						</div>
						<div style="float: right">
							<div class="styLNRightNumBox" style="height:4.5mm;background-color:lightgrey;border-bottom-width: 0px;"/>
							<div class="styLNAmountBox" style="height:4.5mm;border-bottom-width: 0px;width: 34mm"/>
					...
					<div style="width:187mm">
						<div class="styLNLeftNumBox" style="height:4mm;"/>
						<div style="float:left">
     		    	 	applicable part of this amount on Form 3800, Part III, line 4e. For all other production of electricity,
						</div>
						<div style="float: right">
							<div class="styLNRightNumBox" style="height:4.5mm;background-color:lightgrey;border-bottom-width: 0px;"/>
							<div class="styLNAmountBox" style="height:4.5mm;border-bottom-width: 0px;width: 34mm"/>
					...
					<div class="styBB" style="width:187mm">
						<div class="styLNLeftNumBox" style="height:4mm;"/>
						<div style="float:left">
     		    	 	report the applicable part of this amount on Form 3800, Part III, line 1f.
						</div>
						<div style="float: right">
						<span class="styDotLn" style="padding-top: .5mm">  
								 ..........
					...
					<div style="width:187mm">
						...
						<span style="float: right">
						  Form <span class="styBoldText">8835</span> (2022)
						</span>
					</div>
					<div class="pageEnd"/>
					<br/>
