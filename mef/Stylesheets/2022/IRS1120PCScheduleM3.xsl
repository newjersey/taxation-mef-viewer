	  ...
	  <body class="styBodyClass" style="width:187mm">
        <form name="Form1120PCScheduleM3">
          ...
          <div class="styTBB" style="width:187mm;">
            <div class="styFNBox" style="width:32mm;height:20.5mm;border-right-width:2px;">
              ...
              <br/>
              <span class="styAgency" style="height:5mm;">
                Department of the Treasury<br/>
                Internal Revenue Service
              </span>
            </div>
            <div class="styFTBox" style="width:125mm;height:20.5mm;font-size:11pt;text-align:center;">
              ...
              <div class="styFST" style="height:10mm;font-size:7pt;">
                <br/>
                <img src="{$ImagePath}/1120SchN_Bullet_Title.gif" width="4" height="7" alt="Right pointing arrow"/> Attach to Form 1120-PC.<br/>
                <img src="{$ImagePath}/1120SchN_Bullet_Title.gif" width="4" height="7" alt="Right pointing arrow"/> 
                Go to
            ...
            <div class="styTYBox" style="width:30mm;height:20.5mm;border-left-width:2px;">
              <div class="styOMB" style="height:6mm;padding-top:9mm;border-bottom:0px;font-size:7.5pt;">OMB No. 1545-0123</div>
              <!-- <div class="styTY" style="height:13.5mm;padding-top:2mm;">20<span class="styTYColor">21</span> -->
              <!-- </div> -->
            </div>	
          </div>
          ...
          <!-- <div class="pageEnd" style="width:187mm;padding-top:1mm;clear:all;"> -->
            <!-- <div class="styBoldText" style="float:left;">For Paperwork Reduction Act Notice, see the Instructions for Form 1120-PC</div> -->
            <!-- <div style="width:25mm;float:left;">Cat. No. 39664A</div> -->
            <!-- <div class="styBoldText" style="float:right;">Schedule M-3 (Form 1120-PC) (Rev. 12-2021)</div> -->
          <!-- </div> -->
		  <div class="pageEnd" style="width:187mm;padding-top:.5mm;clear:all;">
			<div style="float:left;font-size:6.5pt;">
				<span class="styBoldText">For Paperwork Reduction Act Notice, see the Instructions for Form 1120-PC</span>
				<span style="width:3.5mm;"/>Cat. No. 39664A
				<span class="styBoldText" style="float:right;padding-left:6mm;">Schedule M-3 (Form 1120-PC) (Rev. 12-2021)</span>
			</div>
		</div>
          ...
          <div class="styBB" style="width:187mm;border-bottom:solid 2px;">
            <div style="float:left;">Schedule M-3 (Form 1120-PC) (Rev. 12-2021)</div>
...
<!--                <span class="styDotLn" style="float:right;padding-right:1mm;">.............</span>-->
          ...
          <div class="pageEnd" style="width:187mm;">
            <div class="styBoldText" style="float:right;padding-top:1mm;">Schedule M-3 (Form 1120-PC) (Rev. 12-2021)</div>
          </div>
          <!-- Page 3 -->
          <p style="page-break-before:always"/>
          <!-- Page 3 Header -->
          ...
          <div style="width:187mm;font-size:6pt;">
            <div class="styGenericDiv">
              ...
              <!-- Check box 6 -->
              <b>(6)</b>
              <input type="checkbox" alt="Is1120PCGroup3" class="styCkbox">
                <xsl:call-template name="PopulateCheckbox">
            ...
            <div class="styGenericDiv" style="padding-left:2mm;">
              <!-- Check box 7 -->
              <b>(7)</b>
              <input type="checkbox" alt="Is1120PCEliminations3" class="styCkbox">
                <xsl:call-template name="PopulateCheckbox">
