				...
				<form name="IRS8814">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styIRS8814LineItem" style="height:11mm">
							...
							<div class="styIRS8814LNDesc" style="width:144mm;height:100%;padding:5px 0px 0px 0px;">
								<div class="styIRS8814LNDesc" style="width:auto;height:100%;">
									Subtract line 11 from line 6. Include this amount in the total on Schedule 1 (Form 1040), line 8z. In the space<br/>
									  next to that line, enter &#8220;Form 8814&#8221; and show the amount. If you checked the box on line C above, see the<br/>
									<span style="float:left;">instructions. Go to line 13 below</span>
									<!--Dotted Line-->
									<span class="styDotLn"  style="float:right;padding-left:3.1mm;">........................</span>
								</div>
							</div>
						...
						<div class="styIRS8814LineItem" style="height:7mm">
							<span style="height:100%;padding-bottom:3px;">
								<b>Note:</b> If you checked the box on line C above, see the instructions. Otherwise, include the 
								  amount from line 15 in the tax you enter on Form 1040, 1040-SR, or 1040-NR, line 16. Be sure 
								  to check box <b>1</b> on Form 1040, 1040-SR, or 1040-NR, line 16.
							</span>
						</div>
					</div>
					<!-- <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< -->
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;">
						...
						<div style="float:right;">
							...
							Form <span class="styBoldText" style="font-size:7pt;"> 8814 </span> (2022)
						</div>
					</div>
