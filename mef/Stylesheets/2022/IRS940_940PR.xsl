...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:variable name="FormTitleText">
		<xsl:choose>
			<xsl:when test="$SubType='940' and $Language='ENGLISH'">940 for 2022:</xsl:when>
			<xsl:when test="$SubType='940PR' and $Language='ENGLISH'">&lt;span style="font-size:9pt;"&gt;940-PR (Eng) for 2022:&lt;/span&gt;</xsl:when>
			<xsl:when test="$SubType='940' and $Language='SPANISH'">940 para 2022:</xsl:when>
			<xsl:when test="$SubType='940PR' and $Language='SPANISH'">940-PR para 2022:</xsl:when>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="ReturnTypeCText">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">No payments to employees in 2022</xsl:when>
			<xsl:otherwise>Ning&amp;#250;n pago hecho a los empleados en 2022</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
								...
								<div style="float:right;">
									<div class="styBB" style="border-left-width:1px;border-right-width:1px;border-top-width:1px;padding-left:2mm;padding-top:.75mm;padding-right:3mm;width:57mm;">
										...
										<div style="width:53mm;float:none;clear:both;">
											...
											<div style="width:53mm;padding-top:1mm;float:left;clear:both;">
												<div style="width:10mm;float:left;">
													<input type="checkbox" alt="No payments to employees in 2022" class="styCkbox">
														<xsl:call-template name="PopulateCheckbox">
								...
								<div style="float:right;">
									<div class="styBB" style="border-left-width:1px;border-right-width:1px;border-top-width:1px;padding-left:2mm;padding-top:.75mm;padding-right:3mm;width:57mm;">
										...
										<div style="width:53mm;float:none;clear:both;">
											...
											<div style="width:53mm;padding-top:1mm;float:left;clear:both;">
												<div style="width:10mm;float:left;">
													<input type="checkbox" alt="No hay pagos a los empleados en 2022" class="styCkbox">
														<xsl:call-template name="PopulateCheckbox">
															<xsl:with-param name="TargetNode" select="$FormData/NoPaymentsToEmployeesInd"/>
															<xsl:with-param name="BackupName">IRS940NoPaymentsToEmployeesInd</xsl:with-param>
														</xsl:call-template>
