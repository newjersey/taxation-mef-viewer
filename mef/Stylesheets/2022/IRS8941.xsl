...
<!-- Last Modified by Steven Fook 7/19/2022 UWR # 860643 drop3 R10.6 -->
			 ...
			 <body class="styBodyClass" style="width:187mm;">
			  <form name="Form8941">
					...
					<div class="styBB" style="width:187mm;">
						<div class="styFNBox" style="padding-top:2mm;width:27mm;font-size:7pt;height:22mm;">
							<div>
...
">
								<img src="{$ImagePath}/8941_Bullet.gif" alt="Right Arrow Image"/>Attach to your tax return.
							</div>
							<div class="styFBT" style="margin-top:0mm;padding-left:0.5mm;font-size:6.0pt;padding-top:3mm;">
								<img src="{$ImagePath}/8941_Bullet.gif" alt="Right Arrow Image"/>Go to <a href="http://www.irs.gov/Form8941" title="Link to IRS.gov"><i>www.irs.gov/Form8941</i></a> for instructions and the latest information.
							</div>
						</div>
...
(SHOP) Marketplace (or do you qualify for an exception to this requirement)? See instructions.<br/>
  ...
  Enter Marketplace Identifier (if any): 
					...
					<div class="styBB" style="width:187mm;">
						...
						<!-- Start Line C -->
					<div style="width:187mm;">
						<div class="styLNLeftNumBoxSD" style="height:7mm;padding-left:4mm;">C
                            </div>
						<div class="styLNDesc" style="width:170mm;height:20mm;font size:7pt;">Does a tax return you (or any predecessor) filed for a tax year beginning after 2013 and before 2021 include a Form 8941 with line A checked "Yes" and line 12 showing a positive amount? See instructions.<br/>
							<!-- CheckboxYesStart -->
							<span>
                             <xsl:call-template name="PopulateSpan">
 ...
 Stop. Do not file Form 8941 (see instructions for an exception that may apply to a partnership, S corporation, cooperative, estate, trust, or tax-exempt entity) (also see instructions for information about the credit period limitation)
    							<!--<span class="styFixedUnderline" style="width:35mm;float:none;padding-bottom:0mm;padding-top:0mm;text-align:center;">-->
								<!--<xsl:call-template name="PopulateEIN">
									<xsl:with-param name="TargetNode" select="$Form8941Data/SHOPIdentificationNum"/>
								</xsl:call-template>-->
							...
							<label>
								...
								<span class="styBoldText" style="padding-left:0mm;padding-right:0mm;">No. Go to line 1</span>
							</label>
							<!-- CheckboxNoEnd -->
        ...
        <!--Dotted Line-->
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:136mm;height:7mm;font size:7pt">Average annual wages you paid for the tax year (from Worksheet 3, line 3).This amount must be a multiple of a $1,000. If you entered $58,000 or more, skip lines 4 through 11 and enter -0- on line 12
        <!--Dotted Line-->
							<span class="styBoldText">
								<span style="width:8px"/>.
								<span style="width:8px"/>.
        ...
        <!--Dotted Line-->
						...
						<div class="styLNDesc" style="width:136mm;height:7mm;">
							<img src="{$ImagePath}/8941_Bullet_Round.gif" alt="RoundBullet"/> Tax-exempt small employers, multiply line 6 by 35% (0.35)<span class="styBoldText">
								<span style="width:8px"/>.
                                    <span style="width:8px"/>.
                                    <span style="width:8px"/>.
                                    <span style="width:8px"/>.
							...
							<img src="{$ImagePath}/8941_Bullet_Round.gif" alt="RoundBullet"/> All other small employers, multiply line 6 by 50% (0.50)
        <span class="styBoldText">
								   <span style="width:8px"/>.
                                    <span style="width:8px"/>.
                                    <span style="width:8px"/>.
        ...
        <!--Dotted Line-->
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:136mm;height:4mm;font size:7pt">If line 3 is $28,000 or less, enter the amount from line 8. Otherwise, enter the amount from Worksheet 6, line 7
        <!--Dotted Line-->
							<span class="styBoldText">
								<span style="width:8px"/>.
                                    <span style="width:8px"/>.
...
3800,  Part III, line 4h
        <!--Dotted Line-->
					...
					<div style="width:187mm;">
						...
						<div class="styLNRightNumBox" style="height:4mm;width:6mm;border-right-width:0px;padding-top:1mm;">17
                            </div>
						<div class="styLNAmountBox" style="height:4mm;width:36.5mm;border-left-width:1px;padding-top:1mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form8941Data/SmllEmplrHIPAllocToPatronsAmt"/>
							</xsl:call-template>
						</div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:136mm;height:7mm;font size:7pt">Cooperatives, estates, and trusts, subtract line 17 from line 16. Stop here and report this amount on Form 3800, Part III, line 4h
        <!--Dotted Line-->
							<span class="styBoldText">
								<span style="width:8px"/>.
                                    <span style="width:8px"/>.
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:136mm;height:7mm;font size:7pt">Enter the amount you paid in 2022 for taxes considered payroll taxes for purposes of this credit. <br/>  See instructions.
        <!--Dotted Line-->
							<span class="styBoldText">
								<span style="width:8px"/>. 
                                    <span style="width:8px"/>.
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:136mm;height:7mm;font size:7pt;">Tax-exempt small employers, enter the <b>smaller</b> of line 16 or line 19 here and on Form 990-T, Part III,<br/> line 6f
                         <!--Dotted Line-->
							<span class="styBoldText">
								<span style="width:8px"/>. 
                                    <span style="width:8px"/>.
						...
						<div class="styLNRightNumBox" style="height:7mm;width:6mm;border-right-width:0px;border-bottom-width:0px;padding-top:3.5mm;">20
                            </div>
						<div class="styLNAmountBox" style="height:7mm;width:36.5mm;border-left-width:1px;border-bottom-width:0px;padding-top:3.5mm;">
							<xsl:call-template name="PopulateAmount">
