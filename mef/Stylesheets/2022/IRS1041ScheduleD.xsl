		...
		<body class="styBodyClass" style="width:187mm">
				...
				<!--<div style="width:187mm;">-->
					<div class="styBB" style="width: 187mm;">
						...
						<div class="styFTBox" style="width:130mm;height:20mm;">
							...
							<div style="padding-top:3.5mm;">
								<span style="font-weight:bold; height:4mm;">
									...
									<a style="text-decoration:none;color:black;" href="http://www.irs.gov/F1041" title="Link to IRS.gov"><i>www.irs.gov/F1041</i> for instructions and the lastest information.</a>
								</span>              
							</div>
						</div>
						<!-- Tax Year Box -->
						<div class="styTYBox" style="width:31mm;height:20mm;border-left-width:2px;">
							...
							<!-- Tax Year -->
							<div class="styTaxYear" style="height:8mm;padding-top:3.5mm;">20<span style="color:green;">22</span></div>            
						</div>
					</div>
					<!-- END FORM HEADER -->
					<!-- BEGIN TAXPAYER INFO -->
					...
					<!-- END NOTE -->
					<!-- Dispose of Investment(s) -->
					<div style="width:187mm;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;float:none;clear:both;">
						<div style="height:8mm;float:left;clear:none;border-right:0px solid black;">
						</div>
						<div style="float:left;clear:none;width:172mm;padding-top:.5mm;">
							<div style="font-size:7pt;float:left;clear:none;padding-left:2mm;">Did you dispose of any investment(s) in a qualified opportunity fund during the tax year?
							</div>
							<div style="float:left;clear:none;padding-left:8mm;font-size:6pt;">
								...
								<input type="Checkbox" alt="DisposeInvestmentYes" class="styCkbox">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="$FormData/DisposeInvestmentQOFInd"/>
										<xsl:with-param name="BackupName">IRS8949DisposeInvestmentQOFIndYesInd</xsl:with-param>
									</xsl:call-template>
								</input>
								<label>
							...
							<div style="float:left;clear:none;padding-left:5mm;font-size:6pt;">
								...
								<input type="Checkbox" alt="DisposeInvestmentNo" class="styCkbox">
								<xsl:call-template name="PopulateNoCheckbox">
										<xsl:with-param name="TargetNode" select="$FormData/DisposeInvestmentQOFInd"/>
										<xsl:with-param name="BackupName">IRS8949DisposeInvestmentQOFIndNoInd</xsl:with-param>
									</xsl:call-template>
								</input>
								<label>
									...
									<div style="float:left;clear:none;width:172mm;padding-top:.1mm;">
							<div style="font-size:7pt;float:left;clear:none;padding-left:2mm;">If "Yes",attach Form 8949 and see its instructions for additional requirements for reporting your gain or loss.
							</div>
							</div>
						</div>
						</div>
					<!-- BEGIN PART I HEADER -->
					<div class="styBB" style="width:187mm;">
						<span class="styPartName" style="width:12mm;font-size:9pt;">Part I</span>
						<div class="styPartDesc" style="padding-left:1mm;width:168mm;font-size:9pt;">Short-Term Capital Gains and Losses&#151;Assets Held One Year or Less (see instructions)
						</div>
					</div>
					<!-- END PART I HEADER -->
					...
					<div>
						<table class="IRS1041ScheduleD_styTable" cellspacing="0" name="STCapGainTable" id="STCapGainTable">
							...
							<tr>
								...
								<th class="IRS1041ScheduleD_styTableCellAmt" style="width:28mm;height:18mm;text-align:center;font-weight:normal;font-size:7pt;border-bottom-width:1px;" scope="col">
									<span style="font-weight:bold;">(g)</span><br/>Adjustments to gain or loss from Form(s) 8949, Part I, line 2, column (g)
								</th>
								<th class="IRS1041ScheduleD_styTableCellAmt" style="width:27mm;height:18mm;text-align:center;font-weight:normal;font-size:7pt;border-right-width:0px;" scope="col">
							...
							<!-- Line 1a -->
							<tr>
								<td class="IRS1041ScheduleD_styTableCellNote" style="width:8mm;height:23mm;border-right-width:0px">
									<span class="styLNLeftNumBoxSD">1a</span>
								</td>
								<td class="IRS1041ScheduleD_styTableCellNote" style="width:67mm;height:23mm">
								...
								<td class="IRS1041ScheduleD_styTableCellDt" style="width:28mm;height:23mm;padding-top:20mm;text-align:right;">
								...
								<td class="IRS1041ScheduleD_styTableCellAmt" style="width:28mm;height:23mm;vertical-align:bottom;background-color:lightgrey;"><br/></td>
								<td class="IRS1041ScheduleD_styTableCellAmt" style="width:27mm;height:23mm;border-right-width:0px;padding-top:20mm;text-align:right;">
										<xsl:call-template name="PopulateAmount">
							...
							<tr>
								...
								<td class="IRS1041ScheduleD_styTableCellAmt" style="width:27mm;height:8mm;border-right-width:0px;padding-top:4mm;text-align:right;">
										<xsl:call-template name="PopulateAmount">
							...
							<tr>
								...
								<td class="IRS1041ScheduleD_styTableCellAmt" style="width:27mm;height:8mm;padding-top:4mm;border-right-width:0px;text-align:right;">
										<xsl:call-template name="PopulateAmount">
					...
					<div class="styGenericDiv" style="width:187mm;height:8mm;">
						...
						<div class="styLNDesc" style="width:143.7mm;">Short-term capital loss carryover. Enter the amount, if any, from line 9 of the 2021 Capital Loss <br/>
							<span style="float:left;">Carryover Worksheet</span>
							<!--Dotted Line-->
							<span class="styDotLn" style="float:right;padding-right:1mm;">...........................</span>
						</div>
						<div class="styLNRightNumBox" style="width:7mm;height:8mm;"><br/>6</div>
						<div class="styLNAmountBox" style="width:27mm;height:8mm;"><br/>(
							<xsl:call-template name="PopulateAmount">
					...
					<div class="styGenericDiv" style="width:187mm;height:8mm;">
						...
						<div class="styLNDesc" style="width:143.7mm;">
							<b>Net short-term capital gain or (loss).</b> Combine lines 1a through 6 in column (h). Enter here and on Part III,  <br/> 
							<span style="float:left;">line 17, column (3)</span>
							<!--Dotted Line-->
						...
						<div class="styLNAmountBox" style="width:27mm;height:8mm;border-bottom:0px;"><br/>
							<xsl:call-template name="PopulateAmount">
				   ...
				   <div class="styBB" style="width:187mm;border-top:1px solid black;">
						<span class="styPartName" style="width:12mm;font-size:8.75pt;">Part II</span>
						<div class="styPartDesc" style="padding-left:1mm;width:168mm;font-size:9pt;">
							Long-Term Capital Gains and Losses&#151;Assets Held More Than One Year (see instructions)
						</div>
					</div>
					<!-- END PART II HEADER -->
					<!-- BEGIN PART II TABLE -->
					<div>
						<table class="IRS1041ScheduleD_styTable" cellspacing="0" name="STCapGainTable" id="STCapGainTable">
							...
							<tr>
								...
								<td class="IRS1041ScheduleD_styTableCellAmt" style="width:27mm;height:24mm;padding-top:20mm;border-right-width:0px;text-align:right;">
										<xsl:call-template name="PopulateAmount">
					...
					<div class="styGenericDiv" style="width:187mm;height:8mm;float:none;clear:both;">
						...
						<div class="styLNDesc" style="width:143.7mm;">Long-term capital loss carryover. Enter the amount, if any, from line 14 of the 2021 Capital Loss <br/>
							<span style="float:left;">Carryover Worksheet</span>
							<!--Dotted Line-->
							<span class="styDotLn" style="float:right;padding-right:1mm;">...........................</span>
						</div>
					...
					<div class="styGenericDiv" style="width:187mm;height:8mm;float:none;clear:both;">
						...
						<div class="styLNDesc" style="width:143.7mm;">
							<b>Net long-term capital gain or (loss).</b> Combine lines 8a through 15 in column (h). Enter here and on Part III, <br/> 
							<span style="float:left;">line 18a, column (3)</span>
							<!--Dotted Line-->
							<span class="styDotLn" style="float:left;padding-left:2mm;padding-right:1mm;">......................</span>
							<img src="{$ImagePath}/1040SchD_Bullet.gif" alt="Right arrow" border="0"/>
						</div>
					...
					<div class="pageEnd" style="width:187mm;border-top:1px solid black;border-top-width:2px;">
						...
						<div class="stySmallText" style="width:48mm;text-align:right;"><span class="styBoldText">Schedule D (Form 1041) 2022</span>       </div>
					</div>
					<p style="page-break-before: always"/>
					<!--Begin Page 2 -->
					<!--<div class="styBB" style="width:187mm;border-bottom-width:2px;">
						<span style="width:65mm;font-size:7pt;" class="styGenericDiv">Schedule D (Form 1041) 2021</span>
						<span style="float:right;font-size:7pt;text-align:center;" class="styGenericDiv">Page <b>2</b></span>
					</div>-->
					<!--  PART III HEADER -->
					<div class="styTBB" style="width:187mm;padding-top:.5mm;">
			<span class="" style="float:left;clear:none;">Schedule D (Form 1041) 2022</span>
			<span style="float:right;clear:none;">Page <span class="styBoldText" style="font-size:8pt;">2</span>
					...
					<div class="styBB" style="width:187mm;height:11mm;">
						<span class="styPartName" style="width:17mm;font-size:9pt;">Part III</span>
					...
					<div class="styGenericDiv" style="width:187mm;padding-top:1mm;padding-bottom:1mm;border-bottom:1px solid black;">
						<b>Note: </b><i> If line 19, column (3), is a net gain, enter the gain on Form 1041, line 4 (or Schedule A (Form 990-T), Part I, line 4a). If lines 18a and 19, column (2), are net
					...
					<!--  PART IV HEADER -->
					<div class="styBB" style="width:187mm;">
						<span class="styPartName" style="width:17mm;font-size:9pt;">Part IV</span>
						<div class="styPartDesc" style="padding-left:1mm;width:168mm;font-size:9pt;">
					...
					<div class="styGenericDiv" style="width:187mm;">
						...
						<div class="styLNDesc" style="width:138.8mm;padding-bottom:0mm;">
							<span style="float:left;">Enter here and enter as a (loss) on Form 1041, line 4 (or Schedule A (Form 990-T), Part I, line 4c, if a trust), the <b>smaller</b> of:</span>
						</div>
					...
					<!-- BEGIN Note -->
					<div class="styGenericDiv" style="width:187mm;padding-top:1mm;padding-bottom:1mm;border-bottom:1px solid black;">
						<b>Note: </b> <i> If the loss on line 19, column (3), is more than $3,000, <b>or</b> if Form 1041, page 1, line 23 (or Form 990-T, Part I, line 11), is a loss, complete the
					...
					<div class="styBB" style="width:187mm;float:none;clear:both;">
						...
						<div class="styGenericDiv" style="width:187mm;padding-top:1mm;font-size:8pt;font-weight:normal;border-top:1px solid black;">
							<b>Form 1041 filers.</b> Complete this part <b>only</b> if both lines 18a and 19 in column (2) are gains, or an amount is entered
							 in Part I or Part II and there is an entry on Form 1041, line 2b(2), <b>and</b> Form 1041, line 23, is more than zero.<br />
						</div>
						<div class="styGenericDiv" style="width:187mm;padding-top:1mm;font-size:8pt;font-weight:normal;">
							...
							• <i>Both Form 1041, line 2b(1), and Form 4952, line 4g are more than zero, or</i><br />
							• <i>There are amounts on  lines 4e and 4g of Form 4952.</i><br />
						</div>
						<div class="styGenericDiv" style="width:187mm;padding-top:1mm;padding-bottom:1mm;font-size:8pt;font-weight:normal;">
							<b>Form 990-T trusts.</b> Complete this part <b>only</b> if both lines 18a and 19 are gains, or qualified dividends are included in income
							 in Part I of Form 990-T, <b>and</b> Form 990-T, Part I, line 11, is more than zero. Skip this part and complete the <b>Schedule D Tax Worksheet</b>
					...
					<div class="styGenericDiv" style="width:187mm;float:none;clear:both;height:4.4mm;">
						...
						<div class="styLNDesc" style="width:98.8mm;height:4.4mm;">
							<span style="float:left;">Enter taxable income from Form 1041, line 23 (or Form 990-T, Part I, line 11)</span>
							<!--Dotted Line-->
							<!--<span class="styDotLn" style="float:right;padding-right:1mm;">.</span>-->
						</div>
					...
					<div class="styGenericDiv" style="width:187mm;float:none;clear:both;">
						...
						<div class="styLNDesc" style="width:98.8mm;height:4.4mm;">
							<span style="float:left;">Enter the <b>smaller</b> of the amount on line 21 or $2,800</span>
							<!--Dotted Line-->
							<span class="styDotLn" style="float:right;padding-right:1mm;">.......</span>					
						</div>
					...
					<div class="styGenericDiv" style="width:187mm;float:none;clear:both;">
						...
						<div class="styLNDesc" style="width:98.8mm; height:4.4mm;">
							<span style="float:left;">Enter the <b>smaller</b> of line 21 or $13,700</span>
							<!--Dotted Line-->
							<span class="styDotLn" style="float:right;padding-right:1mm;">...........</span>						
						</div>
					...
					<div class="styGenericDiv" style="width:187mm;float:none;clear:both;">
						...
						<div class="styLNDesc" style="width:98.8mm;">Figure the tax on the amount on line 27. Use the 2022 Tax Rate Schedule<br />
					...
					<div class="styGenericDiv" style="width:187mm;float:none;clear:both;">
						...
						<div class="styLNDesc" style="width:98.8mm;height:10mm;">Figure the tax on the amount on line 21. Use the 2022 Tax Rate Schedule<br/>
							for Estates and Trusts (see the Schedule G instructions in the Instructions<br/>
							<span style="float:left;">for Form 1041)</span>
							<!--Dotted Line-->
							<span class="styDotLn" style="float:right;padding-right:1mm;">...................</span>
					...
					<div class="styGenericDiv" style="width:187mm;float:none;clear:both;">
						...
						<div class="styLNDesc" style="width:138.75mm; height:7mm;">
							...
							<span style="float:left;">Part I, line 1a (or Form 990-T, Part II, line 2)</span>
							<!--Dotted Line-->
							<span class="styDotLn" style="float:left;padding-left:1.5mm;padding-right:1mm;">..................</span>
							<img src="{$ImagePath}/1040SchD_Bullet.gif" alt="Right arrow" border="0"/>
						</div>
				...
				<div class="styBB" style="width:187mm;border-top-width: 2px;border-bottom-width:0px;">
					<span style="font-weight:bold;float:right" class="styGenericDiv">Schedule D (Form 1041) 2022</span>
				</div>
