...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:variable name="Line1Text">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">Number of agricultural employees employed in the pay period that includes March 12, 2022</xsl:when>
			<xsl:otherwise>Número de empleados agrícolas durante el período de nómina que incluye el 12 de marzo de 2022</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="Line12bText">
		<xsl:choose>
			...
			<xsl:otherwise>&lt;span style="float:left;padding-right:1mm"&gt;Nonrefundable portion of credit for qualified sick and family leave wages for leave taken before April 1, 2021&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line12cText">
		<xsl:choose>
			...
			<xsl:otherwise>&lt;span style="float:left;padding-right:1mm"&gt;Reserved for future use&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line12dText">
		<xsl:choose>
			...
			<xsl:otherwise>Nonrefundable portion of credit for qualified sick and family leave wages for leave taken after March 31, 2021, &lt;span style="float:left;padding-right:1mm"&gt; and before October 1, 2021&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line12eText">
		<xsl:choose>
			...
			<xsl:otherwise>&lt;span style="float:left;padding-right:1mm"&gt;Nonrefundable portion of COBRA premium assistance credit&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line12fText">
		<xsl:choose>
			...
			<xsl:otherwise>&lt;span style="float:left;padding-right:1mm"&gt;Number of individuals provided COBRA premium assistance&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line12gText">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left;padding-right:1mm"&gt;Total nonrefundable credits. Add lines 12a, 12b, 12d, and 12e&lt;/span&gt;</xsl:when>
			<xsl:otherwise>&lt;span style="float:left;padding-right:1mm"&gt;Total nonrefundable credits. Add lines 12a, 12b, 12d, and 12e&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="Line14aText">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;Total deposits for 2022, including overpayment applied from a prior year and Form 943-X&lt;/span&gt;</xsl:when>
			<xsl:otherwise>Total de dep&amp;#243;sitos hechos en 2022, incluyendo todo exceso pagado y aplicado de un a&amp;#241;o anterior&lt;br/&gt;&lt;span style="float:left"&gt;y cantidad pagada en exceso aplicada del Formulario 943-X (PR)&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line14bText">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;Reserved for future use&lt;/span&gt;</xsl:when>
			<xsl:otherwise>&lt;span style="float:left"&gt;Reserved for future use&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="Line14dText">
		<xsl:choose>
			...
			<xsl:otherwise>&lt;span style="float:left"&gt;Refundable portion of credit for qualified sick and family leave wages for leave taken before April 1, 2021&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="Line14fText">
		<xsl:choose>
			...
			<xsl:otherwise>Refundable portion of credit for qualified sick and family leave wages for leave taken after March 31, 2021, &lt;span style="float:left"&gt; and before October 1, 2021&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line14gText">
		<xsl:choose>
			...
			<xsl:otherwise>&lt;span style="float:left"&gt;Refundable portion of COBRA premium assistance credit&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line14hText">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;Total deposits and refundable credits. Add lines 14a, 14d, 14f, and 14g&lt;/span&gt;</xsl:when>
			<xsl:otherwise>&lt;span style="float:left"&gt;Total deposits and refundable credits. Add lines 14a, 14d, 14f, and 14g&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="Line15Text">
		<xsl:choose>
			<xsl:when test="$Language='ENGLISH'">&lt;span style="float:left"&gt;&lt;b&gt;Balance due.&lt;/b&gt; If line 13 is more than line 14h, enter the difference and see the instructions&lt;/span&gt;</xsl:when>
	...
	<xsl:variable name="Line22Text">
		<xsl:choose>
			...
			<xsl:otherwise>&lt;span style="float:left"&gt;Qualified sick leave wages for leave taken after March 31, 2021, and before October 1, 2021&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="Line24Text">
		<xsl:choose>
			...
			<xsl:otherwise>Amounts under certain collectively bargained agreements allocable to qualified sick leave wages reported &lt;span style="float:left"&gt;on line 22&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="Line25Text">
		<xsl:choose>
			...
			<xsl:otherwise>&lt;span style="float:left"&gt;Qualified family leave wages for leave taken after March 31, 2021, and before October 1, 2021&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="Line27Text">
		<xsl:choose>
			...
			<xsl:otherwise>Amounts under certain collectively bargained agreements allocable to qualified family leave wages reported &lt;span style="float:left"&gt;on line 25&lt;/span&gt;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
			...
			<body class="styBodyClass">
				<form name="Form943">
					...
					<div class="styBB" style="width:187mm;float:none;clear:both;border-bottom-width:0px;">
						...
						<div class="styLNRightNumBox" style="background-color:lightgrey;border-bottom-width:0px;border-top-width:0px;width:7.9mm;"/>
						<div class="styLNRightNumBox" style="background-color:lightgrey;border-bottom-width:0px;border-top-width:0px;width:8mm;height:6.5mm;float:right"/>
						<!-- END LINE 2b -->
					</div>		
					<div class="styFNBox" style="border-right:0px solid black;width:30mm;padding-left:1mm;padding-top:0mm;font-size:6px;">
						*Include taxable qualified sick and family leave wages paid in 2022 for leave taken after March 31, 2021, and before
						 October 1, 2021, on line 2. Use lines 2a and 2b <b>only</b> for taxable qualified sick and family leave wages paid 
						 in 2022 for leave taken after March 31, 2020, and before April 1, 2021.
						</div>	
					</div>	
					...
					<xsl:if test="$Language='ENGLISH'">
						<div class="styBB" style="width:187mm;float:none;clear:both;">
							...
							<div class="styLNDesc" style="width:140.8mm;float:left;">
								<b>Overpayment.</b> If line 14h is more than line 13, enter the difference
								<span style="float:right">								
									<span class="styDotLn">............</span> 
