			...
			<body class="styBodyClass">
				<form name="Form3468">
					...
					<div class="styTBB" style="width:187mm;height:24mm;">
						...
						<div class="styTYBox" style="width:38mm;height:24mm;">
							...
							<div style="text-align:left;padding-left:10mm;padding-top:1mm">
								<div class="styTY" style="height:9.5mm;">20<span class="styTYColor">22</span>
								</div>
					...
					<div class="styBB" style="width:187mm;">
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:35mm;height:4mm;">
                                        Name of lessor
                                      <xsl:call-template name="SetFormLinkInline">
										<xsl:with-param name="TargetNode" select="$Form3468Data/LessorBusinessName"/>
									  </xsl:call-template>
							</div>
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:137mm;height:4mm;">
								...
								<img src="{$ImagePath}/3468_Bullet.gif" width="7" alt="right arrow image"/>
							</div>
					...
					<div style="width:187mm; font-size:8pt;">
						...
						<div class="styLNDesc" style="width:130mm;padding-left:2mm;font-weight:bold">
										...
										<span class="styUnderlineAmount" style="width:21mm;padding-bottom:0mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" 
													select="$Form3468Data/InvstIntgrtGasCombCycPropAmt"/>
											</xsl:call-template>
										</span>
					...
					<div style="width:187mm;font-size:8pt; float:left">
						...
						<div class="styLNDesc" style="padding-left:2mm;width:130mm;height:5mm;padding-top:1.2mm">
						...
						<div style="float:left;clear:none;">
								...
								<div class="styLNDesc" style="width:100mm;height:20mm;padding-left:2mm;">
									...
									<span style="float:right; padding-right:4mm; font-size:6pt">
										...
										<span class="styUnderlineAmount" style=";width:21mm;text-align:right;
											padding-bottom:0mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" 
												select="$Form3468Data/QlfyGasificationPropBssAmt"/>
											</xsl:call-template>
										</span>
					...
					<!--Line 7 -->
					<div style="width:187mm;font-size:8pt; float:left">
						<div class="styLNLeftNumBox" style="padding-top:1mm;padding-left:2mm">7
						</div>
						<div class="styLNDesc" style="height:11mm;width:130mm;padding-left:2mm">
							...
							<span style="width:45mm;float:right;padding-left:3mm;font-size:6pt">
								...
								<span class="styUnderlineAmount" style="width:21mm;height:3mm;padding-top:0.5mm;
									...
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" 
											select="$Form3468Data/BssQlfyInvstAdvncEnergyAmt"/>
									</xsl:call-template>
								</span>
								<span style="width:19mm;height:3mm;padding-top:0.5mm;padding-left:1mm;">x 25% (0.25)
								</span>
							</span>
						</div>
				...
				<div class="styLNAmountBox" style="width:32mm;height:5mm;padding-top:1mm;background-color:lightgrey;float:none"/>
					...
					<div class="styBB" style="width:187mm;font-size:8pt">
						...
						<div class="styLNRightNumBox" style="height:7.5mm;width:8mm;border-bottom-width:0px;
							padding-top:3.5mm">10</div>
						<div class="styLNAmountBox" style="border-bottom-width:0px;height:7.5mm;padding-top:3.5mm">
							<xsl:call-template name="PopulateAmount">
				...
				<!-- Page Break and Footer-->
					<div style="width:187mm;clear:both;padding-top:0.4mm;" class="pageend">
						<div style="width:90mm;font-weight:bold;font-size:7pt" class="styGenericDiv">For Paperwork Reduction
						 Act Notice, see separate instructions.</div>
						<div style="width:55mm;text-align:center;" class="styGenericDiv">Cat. No. 12276E</div>
						<div style="float:right;" class="styGenericDiv">Form <span class="styBoldText">3468</span> (2022)
						</div>
					</div>
					<br/>
					<div class="pageEnd"/>
				...
				<!-- END Page Header -->			
					...
					<div class="styBB" style="width:187mm;border-top-width:1px;">
						...
						<div class="styPartDesc" style="width:170mm;font-weight:bold;font-size:9pt:height:auto;
						  padding-top:1mm">
					...
					<div style="width:187mm;font-size:8pt">
						...
						<div class="styLNDesc" style="width:130mm;padding-top:.5mm;padding-left:2mm;font-weight:bold;">
					...
					<div style="width:187mm;font-size:8pt">
						...
						<div class="styLNDesc" style="width:130mm;padding-top:0mm">
                            <b>Note: </b>This credit is allowed for a 5-year period beginning in the tax year that the qualified
										...
										<xsl:choose>
											<xsl:when test="$Form3468Data/NPSProjectNum !=' '">
												...
												<span style="float:none">
													...
													<span class="styUnderlineAmount" style="width:33mm;text-align:left;
											...
											<xsl:otherwise>
												...
												<span style="float:right">
													<span class="styUnderlineAmount" style="width:18mm;text-align:left;
													 padding-top:0px;padding-bottom:0px;">
					...
					<div style="width:187mm;font-size:8pt">
						...
						<div class="styLNDesc" style="width:130mm;font-weight:bold;">
                            Energy credit: </div>
									...
									<span style="float:right; font-size:6pt; padding-right:4mm">									
										...
										<span class="styUnderlineAmount" style="width:22mm;text-align:right;
										  padding-bottom:0mm">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" 
												select="$Form3468Data/GthrmlAndSolarEgyPropBssAmt"/>
											</xsl:call-template>
										</span>
										<span style="width:15mm;float:right;padding-top:1mm ">x 30% (0.30)</span>
									</span>
								</div>
							</div>
						</div>
					...
					<div style="width:187mm; font-size:8pt">
						<div style="float:left;clear:none;">
							<div style="width:138mm;">
								<div class="styLNLeftNumBox" style="text-align:right;">b</div>
								<div class="styLNDesc" style="width:130mm;padding-left:2mm;">
                                    Basis of property using solar illumination or solar energy placed in service during the
                                    tax year that is attributable to periods after 2005 and the construction of which began
                                    before 2020 or after 2021 (see instructions)  
                                        <!--Dotted Line-->
										<span class="styDotLn" style="float:none;padding-left:2mm">......</span>
									<span style="float:right; font-size:6pt;padding-right:4mm">								
									<span style="width:2mm;float:left">$</span>
									<span class="styUnderlineAmount" style="width:22mm;text-align:right;padding-bottom:0mm">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
											 select="$Form3468Data/PropSolarIllmntnOrEgyBssAmt"/>
										</xsl:call-template>
									</span>
						...
						<div style="float:left;clear:none;">
							<div style="float:left;">
								...
								<div class="styLNAmountBox" style="height:11mm;padding-top:7mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" 
										 select="$Form3468Data/CalcPropSolarIllmntnOrEgyAmt"/>
									</xsl:call-template>
								</div>
							</div>
						</div>
					...
					<div style="width:187mm; font-size:8pt">
						<div style="float:left;clear:none;">
							<div style="width:138mm;">
								...
								<div class="styLNDesc" style="width:130mm;padding-left:2mm;">
                                    Basis of property using solar illumination or solar energy placed in service during the
                                    tax year and the construction of which began in 2020 or 2021 (see instructions)
                                        <!--Dotted Line-->
										<span class="styDotLn" style="float:none;padding-left:2mm">...................</span>
									<span style="float:right; font-size:6pt;padding-right:4mm">								
									<span style="width:2mm;float:left">$</span>
									<span class="styUnderlineAmount" style="width:22mm;text-align:right;padding-bottom:0mm">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
											 select="$Form3468Data/PropSolarIllmntnEgyBssDurAmt"/>
										</xsl:call-template>
									</span>
									<span style="width:16mm;float:right;padding-top:1mm">x 30% (0.30)</span>
								</span>
						...
						<div style="float:left;clear:none;">
							<div style="float:left;">
								...
								<div class="styLNAmountBox" style="height:11mm;padding-top:7mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode"
										 select="$Form3468Data/CalcPropSolarIllmntnEgyDurAmt"/>
									</xsl:call-template>
								</div>
							</div>
						</div>
					...
					<!-- Line 12d -->
					<div style="width:187mm;font-size:8pt">
						<div class="styLNDesc" style="width:138mm;height:4.5mm;padding-left:10mm;">
                        </div>
						<div class="styLNRightNumBoxNBB" style="height:4.5mm;background-color:lightgrey"/>
						<div class="styLNAmountBoxNBB" style="height:4.5mm"/>
					</div>
					...
					<div style="width:187mm;font-size:8pt">
						...
						<div class="styLNRightNumBox" style="float:left;height:5mm;padding-top:0mm;">12d</div>
						<div class="styLNAmountBox" style="height:5mm;padding-top:0mm;background-color:lightgrey;">
						</div>
						<div style="width:187mm;font-size:8pt">
					...
					<div style="width:187mm;font-size:8pt">
						<div class="styLNLeftNumBox" style="text-align:right;">e</div>
						<div class="styLNDesc" style="width:130mm;padding-left:2mm;">
                            Basis of property placed in service during the tax year that was acquired after 2005 and before
                            October 4, 2008, and the basis attributable to construction, reconstruction, or erection by the
					...
					<div style="width:187mm;font-size:8pt">
						...
						<div class="styLNDesc" style="width:130mm;padding-left:2mm;">
                            ...
                            October 3, 2008 and the construction of which began before 2020 or after 2021.
							<span class="styDotLn" style="float:none;padding-left:2mm">.....................</span>
						<span style="float:right; font-size:6pt">							
						...
						<div class="styLNDesc" style="width:130mm;padding-left:2mm">
							...
							<span style="float:right; font-size:6pt">
								...
								<span class="styUnderlineAmount" style="width:26mm;text-align:right;padding-bottom:0mm">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" 
										 select="$Form3468Data/AfterLmtFuelCellPropKwCapQty"/>
									</xsl:call-template>
								</span>
					...
					<div style="width:187mm;font-size:8pt">
						...
						<div class="styLNRightNumBox" style="height: 6mm;padding-top:2mm;">12m</div>
							<div class="styLNAmountBox" style="height:6mm;padding-top:2mm;">
							<xsl:call-template name="PopulateAmount">
					...
					<div style="width:187mm;font-size:8pt">
						...
						<div class="styLNRightNumBox" style="height:6mm;padding-top:1mm;">12n</div>
						<div class="styLNAmountBox" style="height:6mm;padding-top:0mm;background-color:lightgrey;">
						</div>
					</div>
					<!-- End of line 12n -->
					<!--  Line 12o -->
					<div style="width:187mm;font-size:8pt">
						...
						<div class="styLNRightNumBox" style="height: 6mm;padding-top:1mm;">12o</div>
						<div class="styLNAmountBox" style="height:6mm;padding-top:1mm;background-color:lightgrey;">
						</div>
					</div>
					<!-- End of line 12o -->
					<!-- Line 12p -->
					<div style="width:187mm;font-size:8pt">
						...
						<div class="styLNRightNumBox" style="height:6mm;padding-top:1mm">12p</div>
						<div class="styLNAmountBox" style="height:6mm;padding-top:1mm;background-color:lightgrey;">
						</div>
					</div>
					<!-- End of line 12p -->
					...
					<div style="width:187mm;font-size:8pt">
						...
						<div class="styLNDesc" style="width:130mm;padding-left:2mm;">
                            Basis of property placed in service during the tax year that was acquired after 2005 and the
                            basis attributable to construction, reconstruction, or erection by the taxpayer after 2005
                            <!--Dotted Line-->
							<span class="styDotLn" style="float:none;padding-left:2mm">..................</span>
							<span style="float:right; font-size:6pt">										
						...
						<div class="styLNDesc" style="width:130mm;padding-left:2mm;">
							...
							<span style="float:right;font-size:6pt">
								<span class="styUnderlineAmount" style="width:28mm;padding-top:0px;padding-bottom:0px;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" 
										select="$Form3468Data/QlfyMicroturbinePropKwCapQty"/>
									</xsl:call-template>
								</span>
					...
					<div style="width:187mm;font-size:8pt">
						...
						<div class="styLNRightNumBox" style="height:4.5mm;border-bottom-width:0pt">12s</div>
					...
					<div style="width:187mm;clear:both;padding-top:0.4mm;border-top:1px solid black" class="pageend">
						...
						<span class="styBoldText" style="font-size:8pt;">3468</span> (2022)</div>
					</div>
					<div class="pageEnd"/>
					<div style="page-break-after:always"/>
					<div style="width:187mm;padding-top:1mm;">
					<span style="float:left">Form 3468 (2022)</span>             
					...
					<div style="width:187mm;font-size:8pt">
						...
						<div class="styLNDesc" style="width:130mm;">
                            <b>Combined heat and power system property (See Instructions):   <br/>
                            Caution:</b> You can't claim this credit if the electrical capacity of the property is more
                            than 50 megawatts or has a mechanical energy capacity of more than 67,000 horsepower or an
                            equivalent combination of electrical and mechanical energy capabilities.
							</div>
						<!--<div class="styLNRightNumBoxNBB" style="background-color:lightgrey;height:20mm"/>-->
						<div class="styLNRightNumBoxNBB" style="background-color:lightgrey;height:16mm"/>
						<div class="styLNAmountBox" style="border-bottom-width: 0px; height: 16mm"/>
					</div>
					<!-- End Line 12t Note -->
					<!-- Line 12t -->
					<div style="width:187mm;font-size:8pt;">
					...
					<div style="width:187mm;font-size:8pt">
						...
						<div class="styLNDesc" style="width:130mm;height:4.5mm;font-weight:bold">
						...
						<div class="styLNDesc" style="width:130mm;padding-left:2mm;">
                            ...
                            <span style="float:right;font-size:6pt">                                  
									...
									<span class="styUnderlineAmount" style="width:22mm;text-align:right;padding-bottom:0mm">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
											 select="$Form3468Data/BasisOfWindEnergyPropAmt"/>
										</xsl:call-template>
									</span>
								<span style="width:16mm;padding-top:1mm;">x 30% (0.30)</span>
							</span>
							...
							<div class="styLNDesc" style="width:130mm;height:12mm;padding-left:2mm;">
								...
								<span style="float:right; font-size:6pt">
									...
									<span class="styUnderlineAmount" style="width:22mm;text-align:right;padding-bottom:0mm">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
											 select="$Form3468Data/BssOfWindEgyConstrErctnAmt"/>
										</xsl:call-template>
									</span>
							...
							<div class="styLNDesc" style="width:130mm;padding-left:2mm">
								...
								<span style="float:right; font-size:6pt">
									...
									<span class="styUnderlineAmount" style="width:22mm;text-align:right;padding-bottom:0mm">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
											select="$Form3468Data/BssWindEgyConstrErctnDurAmt"/>
										</xsl:call-template>
									</span>
									<span style="width:16mm;padding-top:0mm;padding-top:1mm;">x 30% (0.30)</span>
								</span>
					...
					<div style="width:187mm;font-size:8pt">
						...
						<div class="styLNRightNumBox" style="height:4.5mm;padding-top:1mm;">12aa</div>
					...
					<div style="width:187mm;font-size:8pt">
						...
						<div class="styLNDesc" style="width:130mm;height:4.5mm;;padding-left:2mm;font-weight:bold">
					...
					<div style="width:187mm;font-size:8pt">
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="width:130mm;height:8mm;padding-left:2mm">
								Basis of property placed in service during the tax year. See instructions.
								<!--Dotted Line-->
								<span class="styDotLn" style="float:none;padding-left:2mm">....................</span>
								<span style="float:right; font-size:6pt">
									<span style="float:left;width:2mm;">$</span>
									...
									<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode"
											 select="$Form3468Data/BssWasteEgyRcvryPropAmt"/>
										</xsl:call-template>
									</span>
									<span style="width:16mm;padding-top:0mm;padding-top:1mm;">x 30% (0.30)</span>
								</span>
						...
						<div class="styLNRightNumBox" style="height:8mm;padding-top:4mm;">12bb</div>
						<div class="styLNAmountBox" style="height:8mm;padding-top:4mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form3468Data/CalcBssWasteEgyRcvryPropAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- End of line 12bb -->
					...
					<div style="width:187mm;font-size:8pt">
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="width:130mm;padding-left:2mm">
                                Basis of property placed in service during the tax year. See instructions. For property 
                                placed in service after 2022, multiply by 30% instead of 10% <br/>
 								<!--Dotted Line-->
								<span class="styDotLn" style="float:none;padding-left:2mm">....................</span>
								<span style="float:right;font-size:6pt">
									<span style="width:2mm;float:left;">$</span>
									<span class="styUnderlineAmount" style="width:22mm;text-align:right;padding-bottom:0mm">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" 
											 select="$Form3468Data/BssGthrmlPropHtPumpSysAmt"/>
										</xsl:call-template>
									</span>
									<span style="float:right;width:16mm;padding-top:0mm;padding-top:1mm;">x 10% (0.10)
									</span>
								</span>
							</div>
						</div>
						<div style="float:left;clear:none;">
							<div class="styLNRightNumBox" style="height:11mm;padding-top:7mm;">12cc</div>
							<div class="styLNAmountBox" style="height:11mm;padding-top:7mm;">
								<xsl:call-template name="PopulateAmount">
					...
					<div style="width:187mm;font-size:8pt">
						...
						<div style="float:left;clear:none;">
							<div class="styLNRightNumBox" style="height:4.5mm;padding-top:1mm;">12dd</div>
						...
						Reserve for future use
							...
							<!--<span style="float:right;font-size:6pt">
								...
								<span class="styUnderlineAmount" style=";width:22mm;text-align:right;padding-bottom:0mm">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" 
										 select="$Form3468Data/BssWindPropPlacedInSrvcYr2Amt"/>
									</xsl:call-template>
								</span>
						  ...
						  Reserve for future use
							...
							<!--<span style="float:right;font-size:6pt">
								...
								<span class="styUnderlineAmount" style=";width:22mm;text-align:right;padding-bottom:0mm">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode"
										 select="$Form3468Data/BssWindPropPlacedInSrvcYr3Amt"/>
									</xsl:call-template>
								</span>
					...
					<div style="width:187mm;font-size:8pt">
						...
						<!--<span style="float:right;font-size:6pt">
								...
								<span class="styUnderlineAmount" style=";width:22mm;text-align:right;padding-bottom:0mm">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode"
										 select="$Form3468Data/BssWindPropPlacedInSrvcYr4Amt"/>
									</xsl:call-template>
								</span>
								<span style="width:16mm;float:right;padding-top:1mm;">x 18% (0.18)</span>
							</span>-->
