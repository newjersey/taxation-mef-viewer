         ...
         not been provided to the credit card issuer. 
                ...
                Other nontaxable use (see <b>Caution </b>above line 1)   
					...
					<div class="styIRS4136DescLine">Claimant certifies that the kerosene did not contain visible evidence of dye.<br/>
						...
						<div style="float:right;padding-right:.5mm;">
							<input alt="UndyedKeroseneUseExceptionInd" type="checkbox" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS4136Data/UndyedKeroseneUseExceptionInd"/>
					...
					<div style="width:187mm;">
						...
						<div style="float:right">Cat. No. 12625R
							<span style="width:70px"/>Form <span class="styBoldText" style="font-size: 8pt">4136</span> (2022)
						</div>
					</div>
					<!-- ============================================================================= -->
					<!--  PAGE 2 HEADER -->
					...
					<p style="page-break-before: always">
						<div class="styBB" style="width:187mm;border-bottom:2px solid black;">
							<div style="float: left; clear: none">Form 4136 (2022)</div>
					 ...
					 contain visible evidence of dye. <br/>
					  ...
					  and check here <img src="{$ImagePath}/4136_Bullet.gif" alt="Right pointing arrowhead"/>
						...
						<span style="float:right;padding-right:1mm;">
							<input alt="SalesUndyedDieselExceptionInd" type="checkbox" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
									<xsl:with-param name="TargetNode" select="$IRS4136Data/SalesUndyedDieselExceptionInd"/>
...
-->
					...
					<div style="width:187mm;">
						...
						<div style="float:right">
							<span style="width:70px"/>Form <span class="styBoldText" style="font-size: 8pt">4136</span> (2022)</div>
					</div>
					<!-- ============================================================================= -->
					<!--  PAGE 3 HEADER -->
					<!-- ============================================================================= -->
					...
					<div style="width:187mm;float:left;clear:left;" id="UVctn">
						<table class="styIRS4136Table" cellspacing="0">
							...
							<tbody>
								...
								<tr>
									<td class="styIRS4136LetterCell">a</td>
									<td class="styIRS4136TableCellLine">Reserved for future use</td>
					...
					<div class="styIRS4136NumLine" style="padding-left:1mm;">
						10<span style="width:5mm"/>Biodiesel or Renewable Diesel Mixture, or Sustainable Aviation<br/>
						<span style="width:9mm"/>Fuel Credit
						<span style="float:right;width:70mm;">Registration No.<img src="{$ImagePath}/4136_Bullet.gif" alt="Right pointing arrowhead"/>
						<xsl:call-template name="SetFormLinkInline">
					...
					<div class="styBB" style="width:177mm;margin-left:10mm;padding-bottom:1mm;">
					<b>Biodiesel or renewable diesel mixtures.   </b> Claimant produced a mixture by mixing biodiesel with diesel fuel (or renewable diesel with liquid fuel (other than renewable diesel). The biodiesel used to produce the biodiesel mixture met ASTM D6751 and met EPA’s registration requirements for fuels and fuel additives. The renewable diesel used to produce the renewable diesel mixture was derived from biomass, met EPA’s registration requirements for fuels and fuel additives, and met ASTM D975, D396, or other equivalent standard approved by the IRS.  <b>Sustainable aviation fuel (SAF). </b>  Claimant produced a mixture by mixing SAF with kerosene. The SAF used to produce the mixture was liquid fuel, and the portion of such mixture which wasn't kerosene met ASTM D7566, or the Fischer-Tropsch provisions of ASTM D1655, Annex A1. <b>For all claims. </b> The mixtures were sold by the claimant to any person for use as a fuel or was used as a fuel by the claimant. Claimant has attached the appropriate certificates and, if applicable, appropriate reseller statements. See the instructions for additional information and requirements.
					</div>
					<div style="width:187mm;float:left;clear:left;" id="UVctn">
						<table class="styIRS4136Table" cellspacing="0">
							<xsl:call-template name="NoColATableHeaderNoBraces">
					...
					<div style="width:187mm;float:left;clear:left;border-bottom:1px solid black;" id="UVctn">
						<table class="styIRS4136Table" cellspacing="0">
							...
							<tbody>
								...
								<tr>
									<td class="styIRS4136LetterCell">a</td>
									<td class="styIRS4136TableCellLine">Liquefied petroleum gas (LPG) (see instructions)</td>
								...
								<tr>
									<td class="styIRS4136LetterCell">c</td>
									<td class="styIRS4136TableCellLine">Compressed natural gas (CNG) (see instructions)</td>
									<td class="styIRS4136TableCellB">.50</td>
									<td class="styIRS4136TableCellC">
										<xsl:call-template name="PopulateText">
								...
								<tr>
									<td class="styIRS4136LetterCell">d</td>
									<td class="styIRS4136TableCellLine">Liquefied hydrogen (terminated after 12/31/2022)</td>
									<td class="styIRS4136TableCellB">.50</td>
									<td class="styIRS4136TableCellC">
										<xsl:call-template name="PopulateText">
								...
								<tr>
									...
									<td class="styIRS4136TableCellLine">Liquefied natural gas (LNG) (see instructions)</td>
									<td class="styIRS4136TableCellB">.50</td>
									<td class="styIRS4136TableCellC">
										<xsl:call-template name="PopulateText">
        ...
        <span class="styDotLn">.................</span>
					...
					<div class="pageEnd" style="width:187mm;padding-top:.5mm;">
						<div style="float:right">
							<span style="width:80px"/>Form <span class="styBoldText">4136</span> (2022)</div>
					</div>
					<!-- ============================================================================= -->
					<!--  LEFTOVER DATA -->
					<!-- ============================================================================= -->
