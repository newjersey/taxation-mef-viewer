...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<!--<xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>-->
				...
				<form id="Form1041">
					...
					<div class="styTBB" style="width:187mm;">
						...
						<div style="width:187mm;height:14mm;">
							<div class="styGenericDiv" style="width:129mm;height:10mm;">
								<img alt="Form" src="{$ImagePath}/1040_Form.gif" height="34" width="19"/>							
								<span class="styFormNumber">1041</span>
								<div class="styGenericDiv" style="float:right;padding-right:19mm;padding-top:6px;height:10mm;">
								...
								<span style="width:122mm;float:left;padding-left:55px;font-weight:bold;">
									<img src="{$ImagePath}/1040SchD_Bullet.gif" alt="Right arrow" border="0"/> Go to
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styGenericDiv" style="width:146.9mm;height:59.6mm;float:left;border-left:1px solid black;">
							<div class="styBB" style="width:146.9mm;height:5mm;padding-top:1mm;padding-left:1mm;">For calendar year 2020 or fiscal year beginning 
							...
							<div class="styGenericDiv" style="width:146.7mm;padding-left:1mm;">						
								...
								<!-- Top 5 checkboxes -->
								<div style="float:left;padding-left:.5mm;padding-top:.5mm;">
									<label>
										<xsl:call-template name="PopulateLabel">
					...
					<div style="width:187mm;border-bottom:1px solid black;">
						...
						<div style="width:181.8mm;float:left;border-left:1px solid black;">
							...
							<div style="width:181.8mm;font-size:7pt;float:left;">
								...
								<div class="styLNDesc" style="width:46mm;height:4.5mm;">
						...
						<div style="width:181.8mm;float:left;border-left:1px solid black;">
							...
							<div style="width:181.8mm;float:left;">
								...
								<div class="styLNDesc" style="width:134.3mm;">
									...
									<span style="float:left;">
										<span style="float:left;padding-left:1mm;padding-right:1mm;">
							...
							<div style="width:181.8mm;font-size:7pt;float:left;">
								...
								<div class="styLNRightNumBox" style="height:4.5mm;width:8mm;">21</div>
								<div class="styLNAmountBox" style="border-bottom-width:1px;height:4.5mm;width:31.5mm; ">
									<xsl:call-template name="PopulateAmount">
							...
							<div style="width:181.8mm;font-size:7pt;float:left;">
								...
								<div class="styLNRightNumBox" style="height:4.5mm;width:8mm;border-bottom-width:0px;">22</div>
					...
					<!--TAX AND PAYMENTS-->
					<div style="width:187mm;border-bottom:1px solid black;">			
						<div style="width:4.8mm;padding-top:1mm;float:left;">
							<img src="{$ImagePath}/1041_TaxAndPayments.png" alt="Tax and Payments image" width="15.8"/>
						</div>
						<div style="width:181.8mm;float:left;border-left:1px solid black;">
							<!--Line 23-->
							<div style="width:181.8mm;font-size:7pt;float:left;">
							...
							<div style="width:181.8mm;font-size:7pt;float:left;">
								...
								<div class="styLNDesc" style="width:134.3mm;height:4mm;">
									<span style="float:left;"><!--<b>Total tax</b>-->Total tax (from Schedule G, Part I, line 9)</span>
									<span class="styBoldText" style="float:right;padding-right:10px;">
										<xsl:call-template name="DotLoop">						
								...
								<div class="styLNRightNumBox" style="height:4.5mm;width:8mm;">24</div>
								<div class="styLNAmountBox" style="border-bottom-width:1px;height:4.5mm;width:31.5mm; ">
									<xsl:call-template name="PopulateAmount">
							...
							<div style="width:181.8mm;font-size:7pt;float:left;">
								...
								<div class="styLNDesc" style="width:134.3mm;height:4mm;">
									<span style="float:left;">2020 net 965 tax liability paid from Form 965-A, Part II, column (k), line 4</span>
									<span class="styBoldText" style="float:right;padding-right:10px;">
										<xsl:call-template name="DotLoop">						
											<xsl:with-param name="DotQty" select="8"/>
										</xsl:call-template>			  
							...
							<div style="width:181.8mm;font-size:7pt;float:left;">
								...
								<div class="styLNDesc" style="width:134.3mm;height:4mm;">
									<span style="float:left;"><!--<b>Total payments.</b>-->Total payments (from Schedule G, Part II, line 19)</span>
									<span class="styBoldText" style="float:right;padding-right:10px;">
										<xsl:call-template name="DotLoop">						
											<xsl:with-param name="DotQty" select="13"/>
										</xsl:call-template>		  
							...
							<div style="width:181.8mm;font-size:7pt;float:left;">
								...
								<div class="styLNDesc" style="width:134.3mm;height:4mm;">
									<span style="float:left;"><b>Tax due.</b> If line 26 is smaller than the total of lines 24, 25, and 27, enter amount owed</span>
									<span class="styBoldText" style="float:right;padding-right:10px;">
										<xsl:call-template name="DotLoop">						
											<xsl:with-param name="DotQty" select="3"/>
										</xsl:call-template>			  
							...
							<div style="width:181.8mm;font-size:7pt;float:left;">
								...
								<div class="styLNDesc" style="width:134.3mm;height:4mm;">
									<span style="float:left;"><b>Overpayment.</b> If line 26 is larger than the total of lines 24, 25, and 27, enter amount overpaid</span>
									<span class="styBoldText" style="float:right;padding-right:10px;">
										<xsl:call-template name="DotLoop">						
											<xsl:with-param name="DotQty" select="2"/>
										</xsl:call-template>			  
								...
								<div class="styLNRightNumBox" style="height:4.5mm;width:8mm;">29</div>
								<div class="styLNAmountBox" style="border-bottom-width:1px;height:4.5mm;width:31.5mm; ">
									<xsl:call-template name="PopulateAmount">
							...
							<div style="width:181.8mm;font-size:7pt;float:left;">
								...
								<div class="styLNDesc" style="width:134.3mm;height:4mm;">
									<span style="float:left;">Amount on line 29 to be: <b> a Credited to 2021</b><span style="width:2px;" /><img src="{$ImagePath}/1040_Bullet.gif" alt="Right pointing arrowhead image"/></span>				
								...
								<div class="styLNRightNumBox" style="height:4mm;width:8mm;border-bottom-width:1px;">30</div>
								<div class="styLNAmountBox" style="border-bottom-width:1px;height:4mm;width:31.5mm; ">
									<xsl:call-template name="PopulateAmount">
		...
		<div class="pageEnd" style="width:187mm;">
			...
			<span style="float:right;clear:none;">
               Form <span class="styBoldText" style="font-size:10pt;">1041</span> (2020)
            </span>
		</div>
		<!-- end page 1 footer -->
		...
		<div class="styTBB" style="width:187mm;padding-top:.5mm;">
			<span class="" style="float:left;clear:none;">Form 1041 (2020)</span>
		...
		<div class="styBB" style="width:187mm;border-top-width:1px;">			
			<div class="styPartDesc" style="width:167mm;text-align:left;height:4mm;padding-top:0mm;padding-left:2mm;">Part I - Tax Computation</div>
		</div>
		 <!--Line 1a-->
			<div style="width:187mm;font-size:7pt;float:left;">
		  ...
		  <!--Line 1c-->
			<div style="width:187mm;font-size:7pt;float:left;">
			  ...
			  <div class="styLNDesc" style="width:92.1mm;height:4mm;padding-left:3mm;">
				<span style="float:left;">Alternative minimum tax (<!--<span style="font-size:6pt;">-->from Schedule I (Form 1041), line 54<!--</span>-->)
				<xsl:call-template name="SetFormLinkInline">
		  ...
		  <!--Line 1d-->
			<div style="width:187mm;font-size:7pt;float:left;">
			  ...
			  <div class="styLNDesc" style="width:131.3mm;height:4mm;padding-left:3mm;">
				<span style="float:left;"><b>Total.</b> Add lines 1a through 1c
				<xsl:call-template name="SetFormLinkInline">
               <xsl:with-param name="TargetNode" select="$FormData/TotalTaxForTaxYearAmt"/></xsl:call-template>
                </span>
				<span class="styBoldText" style="float:right;padding-right:10px;">
				  <xsl:call-template name="DotLoop">						
						<xsl:with-param name="DotQty" select="17"/>
	...
	<!--Line 4-->
		  ...
		  <!--Line 6-->
			<div style="width:187mm;font-size:7pt;float:left;">
			  <div class="styLNLeftNumBoxSD" style="height:6mm;padding-top:1.8mm">6</div>
			  <div class="styLNDesc" style="width:139.8mm;height:5mm;">
				<span style="float:left;">Recapture taxes. Check if from: 
					<xsl:call-template name="LinkToLeftoverDataTableInline">
						<xsl:with-param name="Desc">Line G-6 - Recapture Tax Code</xsl:with-param>
				...
				<span class="styBoldText" style="float:right;padding-right:10px;padding-top:1mm">
				  <xsl:call-template name="DotLoop">						
						<xsl:with-param name="DotQty" select="9"/>
					</xsl:call-template>			  
				</span>
			   </div>
			<div class="styLNRightNumBox" style="height:6.0mm;width:8mm;padding-top:2mm">6</div>
			  <div class="styLNAmountBox" style="height:6.0mm;width:31.2mm;padding-top:2mm">
				<xsl:call-template name="PopulateAmount">
		...
		<!-- Part II - Payments-->
		<div class="styBB" style="width:187mm;border-top-width:1px;">			
			<div class="styPartDesc" style="width:167mm;text-align:left;height:4mm;padding-top:0mm;padding-left:2mm;">Part II - Payments</div>
			</div>
			<!--Line 10-->
			<div style="width:187mm;font-size:7pt;float:left;">
			  <div class="styLNLeftNumBox" style="height:4mm;">10</div>
			  <div class="styLNDesc" style="width:139.8mm;height:4mm;">
				<span style="float:left;">2020 Estimated tax payments and amount applied from 2019 return
				<xsl:call-template name="LinkToLeftoverDataTableInline">
											<xsl:with-param name="Desc">Line 25a - Estimated Tax Credited To Trust Code</xsl:with-param>
											<xsl:with-param name="TargetNode" select="$FormData/EstimatedTaxCreditedToTrustGrp/EstimatedTaxCreditedToTrustCd" />
										</xsl:call-template>
										<xsl:call-template name="LinkToLeftoverDataTableInline">
											<xsl:with-param name="Desc">Line 25a - Estimated Tax Credited To Trust Amount</xsl:with-param>
		  ...
		  <!--Line 11-->
			<div style="width:187mm;font-size:7pt;float:left;">
			  <div class="styLNLeftNumBox" style="height:4mm;">11</div>
			  <div class="styLNDesc" style="width:139.8mm;height:4mm;">
				<span style="float:left;">Estimated tax payments allocated to beneficiaries (from Form 1041-T)
				<xsl:call-template name="SetFormLinkInline">
		  ...
		  <!--Line 15-->
			<div style="width:187mm;font-size:7pt;float:left;">
			  <div class="styLNLeftNumBox" style="height:4mm;">15</div>
			  <div class="styLNDesc" style="width:139.8mm;height:4mm;">
				<span style="float:left;"><!--<b>Income distribution deduction. </b>--> 2020 net 965 tax liability from Form 965-A, Part I, column (f), line 4 </span>
				<span class="styBoldText" style="float:right:0mm;padding-right:22px;"></span>	
			<xsl:call-template name="DotLoop">						
						<xsl:with-param name="DotQty" select="10"/>
					</xsl:call-template>	
			   </div>
		  ...
		  <!--Line 16-->
			<div style="width:187mm;font-size:7pt;float:left;">
			  ...
			  <div class="styLNDesc" style="width:139.8mm;height:4mm;">
				...
				<span class="styBoldText" style="float:right;padding-right:10px;">
					<span style="float:left;padding-left:1mm;padding-right:1mm;font-weight:bold;">Total</span>
			...
			<div class="styLNRightNumBox" style="height:4mm;width:8mm;border-bottom-width:1px;">16c</div>
			  <div class="styLNAmountBox" style="border-bottom-width:1px;height:4mm;width:31.2mm; ">
				<xsl:call-template name="PopulateAmount">
		  ...
		  <!--Line 17-->
			<div style="width:187mm;font-size:7pt;float:left;">
				<div class="styLNLeftNumBox" style="height:4mm;">17</div>
				<div class="styLNDesc" style="width:139.8mm;height:4mm;">
					<span style="float:left;">Refundable credit for qualified sick and family leave. Attach Schedule H (Form 1040)
						<xsl:call-template name="SetFormLinkInline">
				...
				<div class="styLNRightNumBox" style="height:4mm;width:8mm;border-bottom-width:1px;">17</div>
				<div class="styLNAmountBox" style="border-bottom-width:1px;height:4mm;width:31.2mm; ">
					<xsl:call-template name="PopulateAmount">
						<xsl:with-param name="TargetNode" select="$FormData/RfdblCrQlfySLFMLWagesAmt" />
					</xsl:call-template>     
			...
			<div style="width:187mm;font-size:7pt;float:left;">
				<div class="styLNLeftNumBox" style="height:4mm;">18</div>
				<div class="styLNDesc" style="width:139.8mm;height:4mm;">
					<span style="float:left;">Deferral. If filing Schedule H (Form 1040), see instructions for amount to enter; otherwise, skip this line</span>
					<span class="styBoldText" style="float:right;padding-right:10px;">
						<xsl:call-template name="DotLoop">						
							<xsl:with-param name="DotQty" select="1"/>
						</xsl:call-template>
				...
				<div class="styLNRightNumBox" style="height:4mm;width:8mm;border-bottom-width:1px;">18</div>
				<div class="styLNAmountBox" style="border-bottom-width:1px;height:4mm;width:31.2mm; ">
					<xsl:call-template name="PopulateAmount">
						<xsl:with-param name="TargetNode" select="$FormData/DeferralTaxAmt" />
				</xsl:call-template>     
			  </div>
			</div>
			<!--Line 19-->
			<div style="width:187mm;font-size:7pt;float:left;">
				<div class="styLNLeftNumBox" style="height:4mm;">19</div>
				<div class="styLNDesc" style="width:139.8mm;height:4mm;">
					<span style="float:left;"><b>Total payments.</b> Add lines 12 through 15 and 16c through 18. Enter here and on page 1, line 26	</span>
					<span class="styBoldText" style="float:right;padding-right:10px;">
						<xsl:call-template name="DotLoop">						
							<xsl:with-param name="DotQty" select="2"/>
						</xsl:call-template>
				...
				<div class="styLNRightNumBox" style="height:4mm;width:8mm;border-bottom-width:0px;">19</div>
				<div class="styLNAmountBox" style="border-bottom-width:0px;height:4mm;width:31.2mm; ">
					<xsl:call-template name="PopulateAmount">
						<xsl:with-param name="TargetNode" select="$FormData/TotalPaymentsAmt" />
					</xsl:call-template>     
		...
		<!--Line 1-->
		  ...
		  <!--Line 3 (1)-->
			<div style="width:187mm;font-size:7pt;float:left;">
			  <div class="styLNLeftNumBoxSD" style="height:4mm;">3</div>
			  <div class="styLNDesc" style="width:159mm;height:4mm;">
				<span style="float:left;width:158.9mm;height:auto;">At any time during calendar year 2020, did the estate or trust have an interest in or a signature or other authority</span>
		...
		<div style="width:187mm;font-size:7pt;float:left;">
			...
			<div class="styLNDesc" style="width:159mm;height:4mm;">
				...
				<span class="styBoldText" style="float:right;padding-right:10px;">
					...
					<span style="width:5px;" />
					<span style=""><img src="{$ImagePath}/1040_Bullet.gif" alt="Right pointing arrowhead image"/></span>
					<span style="width:5px;" />
					<!-- Checkbox -->
		  ...
		  <!--Line 7-->
			<div style="width:187mm;font-size:7pt;float:left;">
				...
				<div class="styLNDesc" style="width:159mm;height:4mm;">
					...
					<span class="styBoldText" style="float:left;padding-left:8mm;padding-top:1mm">
						<xsl:call-template name="DotLoop">						
							<xsl:with-param name="DotQty" select="1"/>
						</xsl:call-template>
						<span style="width:5px;" />
		  ...
		  <!--Line 9-->
			...
			<div class="styPartDesc" style="width:10mm;text-align:center;height:4.2mm;padding:0mm;border-left:1px solid black;border-bottom:1px solid black;">
				...
				<!-- Checkbox -->
				<input type="Checkbox" alt="Section965iElectionIndYes" class="styCkbox">
					<xsl:call-template name="PopulateYesCheckbox">
						<xsl:with-param name="TargetNode" select="$FormData/Section965iElectionInd"/>
			...
			<div class="styPartDesc" style="width:10mm;text-align:center;height:4.2mm;padding:0mm;border-left:1px solid black;border-bottom:1px solid black;">
				...
				<!-- Checkbox -->
				<input type="Checkbox" alt="Section965iElectionIndNo" class="styCkbox">
					<xsl:call-template name="PopulateNoCheckbox">
						<xsl:with-param name="TargetNode" select="$FormData/Section965iElectionInd"/>
						<xsl:with-param name="BackupName">IRS1041Section965iElectionInd</xsl:with-param>
					</xsl:call-template>
				...
				<label>
					<xsl:call-template name="PopulateLabelNo">
						...
						<!--Line 11b-->
			<div style="width:187mm;font-size:7pt;float:left;">
			  <div class="styLNLeftNumBox" style="height:4mm;">11b</div>
			  <div class="styLNDesc" style="width:159mm;height:4mm;">
			...
			<div class="styPartDesc" style="width:10mm;text-align:center;height:4.2mm;padding:0mm;border-left:1px solid black;border-bottom:1px solid black;">
				...
				<!-- Checkbox -->
				<input type="Checkbox" alt="BenefNetTaxLiabilityAgrmtIndYes" class="styCkbox">
					<xsl:call-template name="PopulateYesCheckbox">
						<xsl:with-param name="TargetNode" select="$FormData/BenefNetTaxLiabilityAgrmtInd"/>
			...
			<div class="styPartDesc" style="width:10mm;text-align:center;height:4.2mm;padding:0mm;border-left:1px solid black;border-bottom:1px solid black;">
				...
				<!-- Checkbox -->
				<input type="Checkbox" alt="BenefNetTaxLiabilityAgrmtIndNo" class="styCkbox">
					<xsl:call-template name="PopulateNoCheckbox">
						<xsl:with-param name="TargetNode" select="$FormData/BenefNetTaxLiabilityAgrmtInd"/>
						<xsl:with-param name="BackupName">IRS1041BenefNetTaxLiabilityAgrmtInd</xsl:with-param>
					</xsl:call-template>
			...
			<div style="width:187mm;font-size:7pt;float:left;">
				<div class="styLNLeftNumBox" style="height:4mm;">12</div>
				<div class="styLNDesc" style="width:159mm;height:4mm;">
				<span style="float:left;">Did the estate or trust make a section 965(i) election for S corporation stock held on the last day of the taxable year? See</span>
				<span class="styBoldText" style="float:right;padding-right:10px;">
				  <xsl:call-template name="DotLoop">						
						<xsl:with-param name="DotQty" select="0"/>
					</xsl:call-template>	
		  ...
		  <!--Line 12 (2)-->
			<div style="width:187mm;font-size:7pt;float:left;">
			  ...
			  <div class="styLNDesc" style="width:159mm;height:4mm;">
				...
				<span class="styBoldText" style="float:right;padding-right:10px;">
				  <xsl:call-template name="DotLoop">						
						<xsl:with-param name="DotQty" select="30"/>
					</xsl:call-template>	
				</span>
			   </div>
			<div class="styPartDesc" style="width:10mm;text-align:center;height:4.2mm;padding:0mm;border-left:1px solid black;border-bottom:1px solid black;">
		
				<input type="Checkbox" alt="SCorpStockDistributionIndYes" class="styCkbox">
					<xsl:call-template name="PopulateYesCheckbox">
			...
			<div class="styPartDesc" style="width:10mm;text-align:center;height:4.2mm;padding:0mm;border-left:1px solid black;border-bottom:1px solid black;">
				...
				<!-- Checkbox -->
				<input type="Checkbox" alt="SCorpStockDistributionIndNo" class="styCkbox">
					<xsl:call-template name="PopulateNoCheckbox">
						<xsl:with-param name="TargetNode" select="$FormData/SCorpStockDistributionInd"/>
						<xsl:with-param name="BackupName">IRS1041SCorpStockDistributionInd</xsl:with-param>
					</xsl:call-template>
			...
			<div style="width:187mm;font-size:7pt;float:left;border-bottom:0px solid black;">
			    ...
			    <div class="styPartDesc" style="width:10mm;text-align:center;height:4.2mm;padding:0mm;border-left:1px solid black;border-bottom:1px solid black;">
					...
					<!-- Checkbox -->
					<input type="Checkbox" alt="ESBTNonResidentAlienGrantorIndYes" class="styCkbox">
						<xsl:call-template name="PopulateYesCheckbox">
							<xsl:with-param name="TargetNode" select="$FormData/ESBTNonResidentAlienGrantorInd"/>
			    ...
			    <div class="styPartDesc" style="width:10mm;text-align:center;height:4.2mm;padding:0mm;border-left:1px solid black;border-bottom:1px solid black;">
					...
					<!-- Checkbox -->
					<input type="Checkbox" alt="ESBTNonResidentAlienGrantorIndNo" class="styCkbox">
						<xsl:call-template name="PopulateNoCheckbox">
							<xsl:with-param name="TargetNode" select="$FormData/ESBTNonResidentAlienGrantorInd"/>
							<xsl:with-param name="BackupName">IRS1041ESBTNonResidentAlienGrantorInd</xsl:with-param>
						</xsl:call-template>
			...
			<div style="width:187mm;font-size:7pt;float:left;border-bottom:1px solid black;">
				...
				<!-- Checkbox -->
				<input type="Checkbox" alt="QualifiedBusinessIncomeDedIndYes" class="styCkbox">
					<xsl:call-template name="PopulateYesCheckbox">
						<xsl:with-param name="TargetNode" select="$FormData/QualifiedBusinessIncomeDedInd"/>
				...
				<!-- Checkbox -->
				<input type="Checkbox" alt="QualifiedBusinessIncomeDedIndNo" class="styCkbox">
					<xsl:call-template name="PopulateNoCheckbox">
						<xsl:with-param name="TargetNode" select="$FormData/QualifiedBusinessIncomeDedInd"/>
						<xsl:with-param name="BackupName">IRS1041QualifiedBusinessIncomeDedInd</xsl:with-param>
						</xsl:call-template>
        ...
        <p style="page-break-before: always"/>  
          ...
          <!-- Begin Separated Repeating data table for OtherIncomeDescAndAmt -->
					...
					<xsl:if test="$FormData/RecaptureTaxCd">
						<span class="styRepeatingDataTitle">Line G-6 - Recapture Tax Code</span>
						<table class="styDepTbl" cellspacing="0" style="font-size:7pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<th class="styDepTblCell" scope="col" rowspan="1" style="width:91.5mm;">
