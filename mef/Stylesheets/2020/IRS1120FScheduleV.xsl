        ...
        <form name="Form1120FScheduleV">
          ...
          <div class="styBB" style="width:187mm;">
            ...
            <div class="styTYBox" style="width:31mm; height:19.5mm;">
              ...
              <div class="styTY" style="height:8mm; padding-top:1mm;">20<span class="styTYColor">20</span></div>
            </div>
          </div>
				    ...
				    <tr>
		     		  ...
		     		  <td class="styTableCellSmall" style="width:30mm; font-size:6pt; border-style:solid; border-color:black; height:8mm; padding-top:3mm; border-left-width:1px; text-align:center;">
				        ...
				        <span>
				     		...
				     		<xsl:with-param name="TargetNode" select="VesselOrAircraftCharteredInInd"/>
						      ...
						      <xsl:with-param name="TargetNode" select="VesselOrAircraftCharteredInInd"/>
					     	  <xsl:with-param name="BackupName">Vessel Or Aircraft Chartered In Yes Box<xsl:value-of select="$pos"/></xsl:with-param>
					    	    </xsl:call-template>
				    	      </input>
			     		  <label>
					      ...
					      <input type="checkbox" alt="Vessel Or Aircraft Chartered In No Box" class="styCkbox">
		         		  ...
		         		  <span style="width:1px;"/>
		         		    ...
		         		    <input type="checkbox" alt="Vessel Or Aircraft Chartered In Yes Box" class="styCkbox">
			    			      <xsl:call-template name="PopulateYesCheckbox">
							    <xsl:with-param name="TargetNode"  select="$Form1120FScheduleVData/VesselAircraftInformation[$pos + 1]/VesselOrAircraftCharteredInInd"/>
							    <xsl:with-param name="BackupName">Vessel Or Aircraft Chartered In Yes Box<xsl:value-of select="$pos + 1"/></xsl:with-param>
				     		  </xsl:call-template>
				    	        </input>
		    			  <label>
				    		<xsl:call-template name="PopulateLabelYes">
							  <xsl:with-param name="TargetNode" select="$Form1120FScheduleVData/VesselAircraftInformation[$pos + 1]/VesselOrAircraftCharteredInInd"/>
					    	  <xsl:with-param name="BackupName">Vessel Or Aircraft Chartered In Yes Label<xsl:value-of select="$pos + 1"/></xsl:with-param>
					    	</xsl:call-template>
			     			<span style="font-size:6pt">Yes </span>
		     			  </label>
		     			  <span style="width:2mm"/>
		     			  <input type="checkbox" alt="Vessel Or Aircraft Chartered In No Box" class="styCkbox">
					    	<xsl:call-template name="PopulateNoCheckbox">
							  <xsl:with-param name="TargetNode"  select="$Form1120FScheduleVData/VesselAircraftInformation[$pos + 1]/VesselOrAircraftCharteredInInd"/>
						      <xsl:with-param name="BackupName">Vessel Or Aircraft Chartered In No Box<xsl:value-of select="$pos + 1"/></xsl:with-param>
			     			</xsl:call-template>
			     		  </input>
		     			  <label>
					    	<xsl:call-template name="PopulateLabelNo">
							  <xsl:with-param name="TargetNode" select="$Form1120FScheduleVData/VesselAircraftInformation[$pos + 1]/VesselOrAircraftCharteredInInd"/>
							  <xsl:with-param name="BackupName">Vessel Or Aircraft Chartered In No Label<xsl:value-of select="$pos + 1"/></xsl:with-param>
				    		</xsl:call-template>
				      		<span style="font-size:6pt">No </span>
		    			  </label>
		         		  <span class="styTableCellPad"/>
		    		    ...
		    		    <td class="styTableCellSmall" style="width:30mm; font-size:6pt; border-style: solid; border-color:black; height:8mm; padding-top:3mm; text-align:center">
				    	  ...
				    	  <input type="checkbox" alt="Vessel Or Aircraft Chartered In Yes Box" class="styCkbox">
					    	<xsl:call-template name="PopulateYesCheckbox">
						      <xsl:with-param name="TargetNode" select="$Form1120FScheduleVData/VesselAircraftInformation[$pos + 2]/VesselOrAircraftCharteredInInd"/>
					    	  <xsl:with-param name="BackupName">Vessel Or Aircraft Chartered In Yes Box<xsl:value-of select="$pos + 2"/></xsl:with-param>
					    	</xsl:call-template>
				    	  </input>
				    	  <label>
			   	     		<xsl:call-template name="PopulateLabelYes">
							  <xsl:with-param name="TargetNode" select="$Form1120FScheduleVData/VesselAircraftInformation[$pos + 2]/VesselOrAircraftCharteredInInd"/>
							  <xsl:with-param name="BackupName">Vessel Or Aircraft Chartered In Yes Label<xsl:value-of select="$pos + 2"/></xsl:with-param>
			    			</xsl:call-template>
					    	<span style="font-size:6pt">Yes </span>
		     			  </label>
			        	  <span style="width:2mm"/>
			    		  <input type="checkbox" alt="Vessel Or Aircraft Chartered In No Box" class="styCkbox">
					    	<xsl:call-template name="PopulateNoCheckbox">
						      <xsl:with-param name="TargetNode" select="$Form1120FScheduleVData/VesselAircraftInformation[$pos + 2]/VesselOrAircraftCharteredInInd"/>
						      <xsl:with-param name="BackupName">Vessel Or Aircraft Chartered In No Box<xsl:value-of select="$pos + 2"/></xsl:with-param>
					    	</xsl:call-template>
				    	  </input>
				    	  <label>
					    	<xsl:call-template name="PopulateLabelNo">
							  <xsl:with-param name="TargetNode" select="$Form1120FScheduleVData/VesselAircraftInformation[$pos + 2]/VesselOrAircraftCharteredInInd"/>
				     		  <xsl:with-param name="BackupName">Vessel Or Aircraft Chartered In No Label<xsl:value-of select="$pos + 2"/></xsl:with-param>
					    	</xsl:call-template>
					    	<span style="font-size:6pt">No </span>
			    		  </label>
			     		  <xsl:call-template name="SetFormLinkInline">
	    			  ...
	    			  <td class="styTableCellSmall"  style="width:30mm; font-size:6pt; border-style:solid; border-color:black; height:8mm; padding-top:3mm; text-align:center; border-right-width:0px;">
		    			...
		    			<input type="checkbox" alt="Vessel Or Aircraft Chartered In Yes Box" class="styCkbox">
				    	  <xsl:call-template name="PopulateYesCheckbox">
							<xsl:with-param name="TargetNode" select="$Form1120FScheduleVData/VesselAircraftInformation[$pos + 3]/VesselOrAircraftCharteredInInd"/>
							<xsl:with-param name="BackupName">Vessel Or Aircraft Chartered In Yes Box<xsl:value-of select="$pos + 3"/></xsl:with-param>
				     	  </xsl:call-template>
		     			</input>
					    <label>
						  <xsl:call-template name="PopulateLabelYes">
							<xsl:with-param name="TargetNode" select="$Form1120FScheduleVData/VesselAircraftInformation[$pos + 3]/VesselOrAircraftCharteredInInd"/>
							<xsl:with-param name="BackupName">Vessel Or Aircraft Chartered In Yes Label<xsl:value-of select="$pos + 3"/></xsl:with-param>
				    	  </xsl:call-template>
				    	  <span style="font-size:6pt">Yes </span>
			     		</label>
			    		<span style="width:2mm"/>
			    		<input type="checkbox" alt="Vessel Or Aircraft Chartered In No Box" class="styCkbox">
					      <xsl:call-template name="PopulateNoCheckbox">
							<xsl:with-param name="TargetNode" select="$Form1120FScheduleVData/VesselAircraftInformation[$pos + 3]/VesselOrAircraftCharteredInInd"/>
							<xsl:with-param name="BackupName">Vessel Or Aircraft Chartered In No Box<xsl:value-of select="$pos + 3"/></xsl:with-param>
				    	  </xsl:call-template>
		    			</input>
			    		<label>
						  <xsl:call-template name="PopulateLabelNo">
							<xsl:with-param name="TargetNode" select="$Form1120FScheduleVData/VesselAircraftInformation[$pos + 3]/VesselOrAircraftCharteredInInd"/>
							<xsl:with-param name="BackupName">Vessel Or Aircraft Chartered In No Label<xsl:value-of select="$pos + 3"/></xsl:with-param>
						  </xsl:call-template>
						  <span style="font-size:6pt">No </span>
			     		</label>
					    <span class="styTableCellPad"/>
	        		  ...
	        		  <span>
				        <xsl:call-template name="PopulateSpan">
			     		...
			     		<input type="checkbox" alt="Vessel Or Aircraft Chartered Out Yes Box" class="styCkbox">
					      <xsl:call-template name="PopulateYesCheckbox">
						    <xsl:with-param name="TargetNode" select="VesselOrArcrftCharteredOutInd"/>
							<xsl:with-param name="BackupName">Vessel Or Aircraft Chartered Out Yes Box<xsl:value-of select="$pos"/></xsl:with-param>
					      </xsl:call-template>
				    	</input>
				     	<label>
					      <xsl:call-template name="PopulateLabelYes">
							<xsl:with-param name="TargetNode" select="VesselOrArcrftCharteredOutInd"/>
							<xsl:with-param name="BackupName">Vessel Or Aircraft Chartered Out Yes Label<xsl:value-of select="$pos"/></xsl:with-param>
				    	  </xsl:call-template>
			     		  <span style="font-size:6pt;">Yes </span>
				     	</label>
				     	<span style="width:2mm"/>
				    	<input type="checkbox" alt="Vessel Or Aircraft Chartered Out No Box" class="styCkbox">
					      <xsl:call-template name="PopulateNoCheckbox">
							<xsl:with-param name="TargetNode" select="VesselOrArcrftCharteredOutInd"/>
							<xsl:with-param name="BackupName">Vessel Or Aircraft Chartered Out No Box<xsl:value-of select="$pos"/></xsl:with-param>
			     		  </xsl:call-template>
			    		</input>
		    			<label>
						  <xsl:call-template name="PopulateLabelNo">
							<xsl:with-param name="TargetNode" select="VesselOrArcrftCharteredOutInd"/>
							<xsl:with-param name="BackupName">Vessel Or Aircraft Chartered Out No Label<xsl:value-of select="$pos"/></xsl:with-param>
					      </xsl:call-template>
					      <span style="font-size:6pt;">No </span>
				    	</label>
			      		<span class="styTableCellPad"/>
			          ...
			          <span>
			    		<xsl:call-template name="PopulateSpan">
	     				...
	     				<input type="checkbox" alt="Vessel Or Aircraft Chartered Out Yes Box" class="styCkbox">
				    	  <xsl:call-template name="PopulateYesCheckbox">
						    <xsl:with-param name="TargetNode" select="$Form1120FScheduleVData/VesselAircraftInformation[$pos + 1]/VesselOrArcrftCharteredOutInd"/>
							<xsl:with-param name="BackupName">Vessel Or Aircraft Chartered Out Yes Box<xsl:value-of select="$pos + 1"/></xsl:with-param>
					      </xsl:call-template>
	      				</input>
	    				<label>
					      <xsl:call-template name="PopulateLabelYes">
							<xsl:with-param name="TargetNode" select="$Form1120FScheduleVData/VesselAircraftInformation[$pos + 1]/VesselOrArcrftCharteredOutInd"/>
							<xsl:with-param name="BackupName">Vessel Or Aircraft Chartered Out Yes Label<xsl:value-of select="$pos + 1"/></xsl:with-param>
					      </xsl:call-template>
						  <span style="font-size:6pt">Yes </span>
				    	</label>
			     		<span style="width:2mm"/>
				    	<input type="checkbox" alt="Vessel Or Aircraft Chartered Out No Box" class="styCkbox">
					      <xsl:call-template name="PopulateNoCheckbox">
						    <xsl:with-param name="TargetNode" select="$Form1120FScheduleVData/VesselAircraftInformation[$pos + 1]/VesselOrArcrftCharteredOutInd"/>
					    	<xsl:with-param name="BackupName">Vessel Or Aircraft Chartered Out No Box<xsl:value-of select="$pos + 1"/></xsl:with-param>
				    	  </xsl:call-template>
			    		</input>
			    		<label>
					      <xsl:call-template name="PopulateLabelNo">
					  		<xsl:with-param name="TargetNode" select="$Form1120FScheduleVData/VesselAircraftInformation[$pos + 1]/VesselOrArcrftCharteredOutInd"/>
							<xsl:with-param name="BackupName">Vessel Or Aircraft Chartered Out No Label<xsl:value-of select="$pos + 1"/></xsl:with-param>
				    	  </xsl:call-template>
					      <span style="font-size:6pt;">No </span>
				    	</label>
				     	<span class="styTableCellPad"/>
	            	...
	            	<td class="styTableCellSmall" style="width:30mm; font-size:6pt; text-align:center; border-style: solid; border-color:black; black; height:8mm; padding-top:3mm">
		        	  ...
		        	  <span>
			    	    ...
			    	    <input type="checkbox" alt="Vessel Or Aircraft Chartered Out Yes Box" class="styCkbox">
					      <xsl:call-template name="PopulateYesCheckbox">
							<xsl:with-param name="TargetNode" select="$Form1120FScheduleVData/VesselAircraftInformation[$pos + 2]/VesselOrArcrftCharteredOutInd"/>
							<xsl:with-param name="BackupName">Vessel Or Aircraft Chartered Out Yes Box<xsl:value-of select="$pos + 2"/></xsl:with-param>
					      </xsl:call-template>
				        </input>
				    	<label>
					      <xsl:call-template name="PopulateLabelYes">
							<xsl:with-param name="TargetNode" select="$Form1120FScheduleVData/VesselAircraftInformation[$pos + 2]/VesselOrArcrftCharteredOutInd"/>
							<xsl:with-param name="BackupName">Vessel Or Aircraft Chartered Out Yes Label<xsl:value-of select="$pos + 2"/></xsl:with-param>
				    	  </xsl:call-template>
			     		  <span style="font-size:6pt">Yes </span>
			    		</label>
		    			<span style="width:2mm"/>
	     				<input type="checkbox" alt="Vessel Or Aircraft Chartered Out No Box"  class="styCkbox">
					      <xsl:call-template name="PopulateNoCheckbox">
							<xsl:with-param name="TargetNode" select="$Form1120FScheduleVData/VesselAircraftInformation[$pos + 2]/VesselOrArcrftCharteredOutInd"/>
							<xsl:with-param name="BackupName">Vessel Or Aircraft Chartered Out No Box<xsl:value-of select="$pos + 2"/></xsl:with-param>
				    	  </xsl:call-template>
					    </input>
				        <label>
						  <xsl:call-template name="PopulateLabelNo">
							<xsl:with-param name="TargetNode" select="$Form1120FScheduleVData/VesselAircraftInformation[$pos + 2]/VesselOrArcrftCharteredOutInd"/>
							<xsl:with-param name="BackupName">Vessel Or Aircraft Chartered Out No Label<xsl:value-of select="$pos + 2"/></xsl:with-param>
			     		  </xsl:call-template>
					      <span style="font-size:6pt;">No </span>
					    </label>
				        <span class="styTableCellPad"/>
			          ...
			          <span>
			        	<xsl:call-template name="PopulateSpan">
			     	    ...
			     	    <input type="checkbox" alt="Vessel Or Aircraft Chartered Out Yes Box" class="styCkbox">
				     	  <xsl:call-template name="PopulateYesCheckbox">
				    		<xsl:with-param name="TargetNode" select="$Form1120FScheduleVData/VesselAircraftInformation[$pos + 3]/VesselOrArcrftCharteredOutInd"/>
				    		<xsl:with-param name="BackupName">Vessel Or Aircraft Chartered Out Yes Box<xsl:value-of select="$pos + 3"/></xsl:with-param>
				          </xsl:call-template>
			    	    </input>
			    	    <label>
				          <xsl:call-template name="PopulateLabelYes">
			        		<xsl:with-param name="TargetNode" select="$Form1120FScheduleVData/VesselAircraftInformation[$pos + 3]/VesselOrArcrftCharteredOutInd"/>
		        			<xsl:with-param name="BackupName">Vessel Or Aircraft Chartered Out Yes Label<xsl:value-of select="$pos + 3"/></xsl:with-param>
		     			  </xsl:call-template>
			     		  <span style="font-size:6pt">Yes </span>
			        	</label>
			         	<span style="width:2mm"/>
		     	        <input type="checkbox" alt="Vessel Or Aircraft Chartered Out No Box" class="styCkbox">
				          <xsl:call-template name="PopulateNoCheckbox">
					        <xsl:with-param name="TargetNode" select="$Form1120FScheduleVData/VesselAircraftInformation[$pos + 3]/VesselOrArcrftCharteredOutInd"/>
				        	<xsl:with-param name="BackupName">Vessel Or Aircraft Chartered Out No Box<xsl:value-of select="$pos + 3"/></xsl:with-param>
			     	      </xsl:call-template>
		    	        </input>
		    	    	<label>
		        		  <xsl:call-template name="PopulateLabelNo">
				    		<xsl:with-param name="TargetNode" select="$Form1120FScheduleVData/VesselAircraftInformation[$pos + 3]/VesselOrArcrftCharteredOutInd"/>
			    			<xsl:with-param name="BackupName">Vessel Or Aircraft Chartered Out No Label<xsl:value-of select="$pos + 3"/></xsl:with-param>
				          </xsl:call-template>
			    	      <span style="font-size:6pt">No </span>
				    	</label>
			        	<span class="styTableCellPad"/>
			    ...
			    <tr>
				  <td style="border:none;" scope="row">
	     		  ...
	     		  <td class="styTableCellSmall" style="width:30mm; font-size:6pt; border-style:solid; border-color:black; height:8mm; padding-top:3mm; border-left-width:1px; text-align:center;">
		        	...
		        	<label><span style="font-size:6pt">No Labek</span><span style="width:2mm"/></label>
		        	<span class="styTableCellPad"/>
		    	  </td>
     			  <td class="styTableCellSmall" style="width:30mm; font-size:6pt; border-style:solid; border-color:black; height:8mm; padding-top:3mm; text-align:center">
	         		<span style="width:1px;"/>
    ...
    <p>
	  <div class="pageEnd" style="width:187mm; padding-top:0mm;">
	    ...
	    <div style="float:right;">
          ...
          <b>Schedule V (Form 1120-F) 2020</b>
	    </div>
	  </div>
    </p>
