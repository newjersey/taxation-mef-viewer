				...
				<form name="IRS1120F ScheduleS">
					...
					<div class="sty1120ScheduleHBB" style="width:187mm;height:22mm;border-bottom-width:2px;">
						...
						<div class="styTYBox" style="width:37mm;height:22mm;border-left-width:2px;">
							...
							<!-- Tax Year -->
							<div class="styTY" style="text-align:center;padding-top: 3mm">
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;">
						<div style="float:left;">
							...
							<span style="width:11mm;"/>Cat. No. 50766D 
                      </div>
						<div style="float:right;">
							<span style="width:2px;"/>
							<span class="styBoldText" style="font-size:6pt;">
								<b>Schedule S (Form 1120-F) 2020</b>
							</span>
						</div>
					</div>
					...
					<div class="styTBB" style="width:187mm;">
						<div style="float:left;clear:none;">
							<div class="styLNDesc" style="width:94mm;">Schedule S (Form 1120-F) 2020</div>
						</div>
					...
					<div id="TPctn" style="width:187mm;border-bottom:0px;">
                      ...
                      Percentage
							...
							<tfoot/>
							<tbody>
							<!-- Display all rows if the Print parameter is not Separated. If the Print parameter is Separated, but the number of elements is less than the container height, then also display all rows. -->
