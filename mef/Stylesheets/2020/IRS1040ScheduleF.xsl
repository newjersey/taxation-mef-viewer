...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
		...
		<html lang="EN-US">
			...
			<body class="styBodyClass" style="width:187mm">
				<form name="Form1040ScheduleF">
					...
					<div class="styBB" style="width:187mm;height:21mm;">
						<div class="styFNBox" style="width:35mm;height:21mm;">
							<div style="padding-top:1mm;">
								...
								<span class="styFormNumber" style="font-size:8pt">(Form 1040)</span>
							</div>
					...
					<!-- Box A-->
					<div class="styBB" style="width:187mm;">
					<div class="styLNLeftNumBox" style="width:3mm; height:15.5mm;padding-left:0px;">A</div>
						...
						<!-- Box B-->
						<div class="styForm1040ScheduleFEINFullBox" style="width:47mm;height:15.5mm;float:left;">
						...
						<!-- Box C-->
						<div class="styLNLeftNumBox" style="width:4mm;padding-left:2mm;padding-top:1mm;height:15.5mm;">C</div>
						<div class="styNameBox" style="width:41mm;height:15.5mm;padding-left:2mm;padding-top:1mm;font-size:7pt;">
						...
						<!-- Box D-->
						<div class="styEINBox" style="width:51mm;height:15.5mm;font-size:7pt;">
							...
							<br/>
							<span class="styEINFld" style="width:46mm;text-align:left;padding-left:1.5mm;font-weight:normal;padding-top:2mm;">
								<br/><br/>
								<xsl:choose>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:152mm;height:4.5mm;padding-top:1.5mm;">
							<span style="float:left;">
								Did you "materially participate" in the operation of this business during 2020? If "No," see instructions for limit on passive losses
          ...
          <!-- Line G -->
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:152mm;height:5mm;padding-top:3.5mm;">
							<span style="float:left;font-size:7pt;">
					...
					<!-- Line 1a-->
					<div style="width:187mm;">
						<div  style="height:4mm;float:left;width:8mm;padding-left:3mm;padding-top:.5mm;"><b>1a</b></div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNAmountBox" style="height:4mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form1040SchFData/FarmIncomeCashMethodGrp/CCCLoansForfeitedTaxableAmt"/>					
							</xsl:call-template>
						</div>
					</div>
					<!-- Line 6a and b-->
					<div style="width:187mm;">
						<div  style="height:4mm;float:left;width:8mm;padding-left:3mm"><b>6</b></div>
					...
					<div style="width:187mm;">
						<div  style="height:4mm;float:left;width:8mm;padding-left:5mm"><b>a</b></div>
						<div class="styLNDesc" style="width:67.5mm;height:4mm;">
							<span style="float:left">Amount received in 2020</span>
							<span class="styDotLn" style="float:right;padding-right:1mm;">........</span>
						</div>
					...
					<!-- Line 6c and d-->
					<div style="width:187mm;">
						<div  style="height:4mm;float:left;width:8mm;padding-top:2mm;padding-left:5mm"><b>c</b></div>
						<div class="styLNDesc" style="width:80mm;height:4mm;">
							If election to defer to 2021 is attached 
							<xsl:call-template name="SetFormLinkInline">
							...
							<input type="checkbox" alt="Election To Defer CropIns Proc" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
									<xsl:with-param name="TargetNode" select="$Form1040SchFData/FarmIncomeCashMethodGrp/ElectionDeferCropInsProcInd"/>
									<xsl:with-param name="BackupName">Election To Defer CropIns Proc</xsl:with-param>
								</xsl:call-template>
							</input>
						</div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNRightNumBox" style="height:4mm;padding-right:1.5mm">7</div>
						<div class="styLNAmountBox" style="height:4mm;">
							<xsl:call-template name="PopulateAmount">
					...
					<div style="width:187mm;">
						...
						<div class="styLNRightNumBox" style="height:4mm;padding-right:1.5mm">8</div>
						<div class="styLNAmountBox" style="height:4mm;">
							<xsl:call-template name="PopulateAmount">
					...
					<div  style="height:4mm;float:left;width:8mm;padding-top:.5mm;
						...
						<div class="styLNRightNumBoxNBB" style="height:8mm;padding-top:4mm;padding-right:1.5mm">	9
						</div>
					...
					<!-- END Part II Title -->
						<table class="styTable" style="width:94mm;float:left;clear:none;font-size:7pt;" cellspacing="0">
							...
							<tbody>
								<tr><!-- Line 10-->
									<td class="styLNLeftNumBox" style="width:5mm;height: 9mm;padding-top:2mm;">10</td>
									<td class="styGenericDiv" style="width:48mm;height: 9mm;padding-top:2mm;">
								...
								<tr><!-- Line 21-->
									...
									<td class="styGenericDiv" style="width:48mm;height:4.5mm;" colspan="2">Interest (see instructions) </td>
								...
								<tr><!-- Line 22-->
									<td class="styLNLeftNumBox" style="height:6.7mm;width:5mm;padding-bottom:4mm">22</td>
									<td class="styGenericDiv" style="width:48mm;height:6.7mm">Labor hired (less employment <br/>
									<span style="float:left">
										credits)
									</span>
									<span class="styDotLn" style="float:right;padding-right:1mm;">........</span>
									</td>
									<td class="styLNRightNumBox" style="height:6.7mm;border-bottom-width:0px;;padding-top:2.5mm">22</td>
									<td class="styLNAmountBox" style="height:6.7mm;border-right-width:1px;border-bottom-width:0px;padding-left:1mm;padding-top:2.5mm">
										<xsl:call-template name="PopulateAmount">
						...
						<table class="styTable" style="width:92.25mm;float:right;clear:none;font-size:7pt" cellspacing="0">
							...
							<tbody>
								<tr><!-- Line 23-->
									...
									<td class="styLNRightNumBox" style="height:4.5mm;width:7.25mm;padding-right:1.5mm">23</td>
								...
								<tr><!-- Line 31-->
									...
									<td class="styLNRightNumBox" style="height:4.5mm;width:7.25mm;padding-right:1.5mm">31</td>
								...
								<tr><!-- Line 32-->
									<td class="styLNLeftNumBox" style="height:4.5mm;width:6mm;">32</td>
									<td class="styGenericDiv" style="width:47mm;height:4.5mm;" colspan="2">Other expenses (specify): </td>
								...
								<xsl:if test="($Print != $Separated) or (count($Form1040SchFData/FarmExpensesGrp/OtherFarmExpensesGrp/OtherFarmExpense) &lt;= 5) ">
									<xsl:for-each select="$Form1040SchFData/FarmExpensesGrp/OtherFarmExpensesGrp/OtherFarmExpense">
										<tr>
											...
											<td class="styGenericDiv" style="width:48.7mm;height:4.5mm;" colspan="2">
											<span style="width:2mm"/>
											...
											<td class="styLNRightNumBox" style="height:5.2mm;width:7.3mm;">
								...
								((count($Form1040SchFData/FarmExpensesGrp/OtherFarmExpensesGrp/OtherFarmExpense) &gt; 5) and ($Print = $Separated))">
									<tr><!-- Line 32a-->
										...
										<td class="styLNRightNumBox" style="height:4.5mm;width:7.3mm;">32a</td>
										<td class="styLNAmountBox" style="height:4.5mm;width:31.5mm;;padding-left:1mm">
									</td>
									</tr>
								</xsl:if>
								...
								and ($Print = $Separated))">
									<tr><!-- Line 32b-->
										...
										<td class="styLNRightNumBox" style="height:4.5mm;width:7.3mm;">32b</td>
										<td class="styLNAmountBox" style="height:4.5mm;width:31.5mm;padding-left:1mm">
									</td>
									</tr>
								</xsl:if>
								<xsl:if test="count($Form1040SchFData/FarmExpensesGrp/OtherFarmExpensesGrp/OtherFarmExpense) &lt; 3 or ((count($Form1040SchFData/FarmExpensesGrp/OtherFarmExpensesGrp/OtherFarmExpense) &gt; 5) and ($Print = $Separated))">
									<tr><!-- Line 32c-->
										...
										<td class="styLNRightNumBox" style="height:4.5mm;width:7.3mm;">32c</td>
										<td class="styLNAmountBox" style="height:4.5mm;width:31.5mm;padding-left:1mm">
									</td>
									</tr>
								</xsl:if>
								<xsl:if test="count($Form1040SchFData/FarmExpensesGrp/OtherFarmExpensesGrp/OtherFarmExpense) &lt; 4 or ((count($Form1040SchFData/FarmExpensesGrp/OtherFarmExpensesGrp/OtherFarmExpense) &gt; 5) and ($Print = $Separated))">
									<tr><!-- Line 32d-->
										...
										<td class="styLNRightNumBox" style="height:4.5mm;width:7.3mm;">32d</td>
										<td class="styLNAmountBox" style="height:4.5mm;width:31.5mm;padding-left:1mm">
									</td>
									</tr>
								</xsl:if>
								<xsl:if test="count($Form1040SchFData/FarmExpensesGrp/OtherFarmExpensesGrp/OtherFarmExpense) &lt; 5 or
								 ((count($Form1040SchFData/FarmExpensesGrp/OtherFarmExpensesGrp/OtherFarmExpense) &gt; 5) and ($Print = $Separated))">
									...
									<td class="styLNRightNumBox" style="height:4.5mm;width:7.3mm;">32e</td>
	...
	<xsl:if test="($Print = $Separated) or (count($Form1040SchFData/FarmExpensesGrp/OtherFarmExpensesGrp/OtherFarmExpense) &lt;= 5) ">
									...
									<tr>
										...
										<span class="styGenericDiv" style="width: 47mm;float:none;text-align:left;border-top-width:1px;">
				                       <span style="width:1mm"/>
											<xsl:call-template name="PopulateText">
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width: 139.7mm; height:4mm;">
                     	...
                     	<div class="styLNRightNumBox" style="height:4mm;width:7.3mm;padding-right:1.5mm">33</div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNRightNumBox" style="height:4mm;width:7.3mm;padding-right:1.5mm">34</div>
						<div class="styLNAmountBox" style="height:4mm;width:31mm">
							<xsl:call-template name="PopulateAmount">
					...
					<div class="styLNDesc" style="height:4.5mm;width:140mm;">
						<!--Did you receive an applicable subsidy in 2018? See instructions-->
						Reserved for future use.
						<!--<span class="styDotLn" style="float:right;padding-right:2mm;">..............</span>-->
					</div>
						<span style="width:10px"/>
						<!--<input type="checkbox"  alt="Subsidy Received Yes Ind" class="styCkbox" name="Checkbox">
							<xsl:call-template name="PopulateYesCheckbox">
						...
						<label>
							<xsl:call-template name="PopulateLabelYes">
								<xsl:with-param name="TargetNode" select="$Form1040SchFData/FarmExpensesGrp/SubsidyReceivedInd"/>
								<xsl:with-param name="BackupName">IRS1040ScheduleFSubsidyReceivedYesInd</xsl:with-param>
							</xsl:call-template>
							<span style="width:1mm;"/>
							Yes
						</label>
						<span style="width:5mm;"/>
						<input type="checkbox" alt="Subsidy Received No Ind" class="styCkbox" name="Checkbox">
							<xsl:call-template name="PopulateNoCheckbox">
								<xsl:with-param name="TargetNode" select="$Form1040SchFData/FarmExpensesGrp/SubsidyReceivedInd"/>
								<xsl:with-param name="BackupName">IRS1040ScheduleFSubsidyReceivedNoInd</xsl:with-param>
							</xsl:call-template>
						</input>
						<label>
							<xsl:call-template name="PopulateLabelNo">
					...
					<div class="styLNLeftNumBox">36</div>
						<div class="styLNDesc" style="width:148mm">
							...
							<div class="styLNDesc" style="width:70mm;height:4mm;">
								...
								<input type="checkbox" alt="All Investment Is At Risk Ind"  class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
							...
							<div class="styLNDesc" style="width:70mm;height:4mm;">
								...
								<span style="width:4px"/>
								<input type="checkbox" alt="Some Investment Is Not At Risk" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
					...
					<div style="width:187mm;">
						...
						<div style="float:right;">
							...
							<span class="styBoldText">Schedule F (Form 1040) 2020 </span>
						</div>
					</div>
					...
					<!-- Header -->
					<div class="styBB" style="width:187mm;">
						<div style="float:left;">Schedule F (Form 1040) 2020 <span style="width:120mm;"/>
						</div>
					...
					<!--Footer -->
					<div style="width:187mm;">
						<div class="stySmallText" style="width:127mm;text-align:center;padding-top:1mm;">
							<span style="width:127px"/>
						</div>
						<div style="width:60mm;text-align:right;">
							<span class="styBoldText" style="font-weight:bold;">Schedule F (Form 1040) 2020</span>
						</div>
					</div>
					<br/>
					<br class="pageEnd"/>
							...
							<tbody>
								<xsl:for-each select="$Form1040SchFData/FarmExpensesGrp/OtherFarmExpensesGrp/OtherFarmExpense">
									<tr>
										<xsl:if test="position() &gt; 5">
											<xsl:choose>
												...
												<xsl:otherwise>
													...
													<xsl:when test="position() mod 2 = 1">styDepTblRow1</xsl:when><xsl:otherwise>styDepTblRow2</xsl:otherwise>
												</xsl:choose></xsl:attribute>
												</xsl:otherwise>
											</xsl:choose>
										</xsl:if>
										<xsl:if test="position() &lt;=5">
											<xsl:attribute name="class">
											<xsl:choose><xsl:when test="position() mod 2 = 1">styDepTblRow1</xsl:when><xsl:otherwise>styDepTblRow2
											</xsl:otherwise>
											</xsl:choose></xsl:attribute>
										</xsl:if>
