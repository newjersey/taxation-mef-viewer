							...
							<thead class="styTableThead">
								<tr>
									<th class="styTableCellHeader" scope="colgroup" style="width:88mm;font-weight:normal;font-family:Arial;">
										Enter every census tract where QOZ business property directly <br /> owned or leased by the taxpayer is located
									</th>
								...
								<tr>
									<th class="styTableCellHeader" scope="col" style="width:88mm;font-weight:normal;background-color:#DCDCDC;">
										<strong>(a)</strong><br /> QOZ Tract No.
									</th>
							...
							<thead class="styTableThead">
								<tr>
									<th class="styTableCellHeader" scope="colgroup" colspan="2" style="width:66mm;font-weight:normal;font-family:Arial;padding:0.5mm;">
										For every QOZ business in which the taxpayer holds stock or a partnership interest, enter every census tract in which the tangible property of the QOZ business is located and the EIN of that QOZ business.
									</th>
									<th class="styTableCellHeader" scope="colgroup" colspan="1" style="width:43mm;font-weight:normal;font-family:Arial;padding:0.5mm;">
										Value of QOZ stock or partnership interest held on last day of the first 6-month period of the tax year apportioned to each census tract
									</th>
									...
									<th class="styTableCellHeader" scope="colgroup" colspan="1" style="width:43mm;font-weight:normal;font-family:Arial;padding:0.5mm;">
										Value of QOZ stock or partnership interest held on last day of the tax year apportioned to each census tract
									</th>
								...
								<tr>
									<th class="styTableCellHeader" scope="col" style="width:33mm;font-weight:normal;background-color:#DCDCDC;">
										<strong>(a)</strong><br /> QOZ Tract No. <br />
										(indicate nonqualified tracts by 99999999999)
									</th>
									<th class="styTableCellHeader" scope="col" style="width:33mm;font-weight:normal;background-color:#DCDCDC;">
