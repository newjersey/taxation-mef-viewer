	...
	<xsl:template match="/">
		...
		<html lang="EN-US">
			...
			<body class="styBodyClass">
				...
				<!-- ********************************************************************************************************************* -->
					<div class="styArialText" style="height:8mm;font-size:9pt;width:187mm;border-top:0px solid black;border-bottom:1px solid black;">
For use by taxpayers whose taxable income, before any qualified business income deduction, is at or below<br />
 $163,300 ($326,600 if married filing jointly), and who aren't patrons of a specified cooperative.
									</div>
			<!-- ********************************************************************************************************************* -->
					<!-- Table 1, cols (a)-(e) -->
					...
					<div class="styStdDiv pageEnd" style="border-top:2px solid black;">
						...
						<span style="float:right;">Form <strong>8995</strong> (2020)</span>
					</div>
