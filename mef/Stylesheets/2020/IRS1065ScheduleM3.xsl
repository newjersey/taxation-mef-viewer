			...
			<body class="styBodyClass">
				<form name="Form1065ScheduleM3">
					...
					<div class="styTBB" style="width:187mm;">
						<div class="styFNBox" style="width:28mm;height:17mm;border-right-width:2px;">
							<span class="styFormNumber" style="font-size:9pt;">SCHEDULE M-3<span style="font-size:9pt;">(Form 1065)</span>
								<!-- Form Link -->
							...
							<br/>
							<span class="styAgency" style="height:4mm;padding-top:3mm;">
          Department of the Treasury<br/>
          Internal Revenue Service</span>
						</div>
						<div class="styFTBox" style="width:124mm;">
							<div class="styMainTitle" style="font-size:12pt">Net Income (Loss) Reconciliation<br/>for Certain Partnerships</div>
							<div class="styFST" style="height:4mm;">
								<img src="{$ImagePath}/1065ScheduleM3_Bullet_Title.gif" width="7" height="5" alt="Bullet"/>Attach to Form 1065.<br/>
								<img src="{$ImagePath}/1065ScheduleM3_Bullet_Title.gif" width="7" height="5" alt="Bullet"/>
								Go to <i><a style="text-decoration:none;color:black;" href="http://www.irs.gov/form1065">www.irs.gov/Form1065</a></i> for instructions and the latest information.
							</div>
						</div>
						<div class="styTYBox" style="width:30mm;height:17mm;border-left-width:2px;">
							...
							<div class="styTaxYear" style="height:7mm;padding-top:2mm;">20<span class="styTYColor">20</span>
							</div>
						</div>
					</div>
					...
					<div class="styBB" style="width:187mm;">
						<div class="styNameBox" style="width:124mm;height:9.5mm;font-size:7pt;">
          ...
          (If "Yes," attach a statement and the amount of each item restated.)
					...
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
							...
							<label>
								...
								<span style="padding-left:4mm;">Section 704(b)</span>
							</label>
						</div>
						<!-- Closes Lline 4b GAAP (float:left)-->
						<div style="float:right;">
							<div class="styLNRightNumBox" style="height:5mm;border-bottom:none"/>
					...
					<div style="width:187mm;">
						<div style="float:right;width:140mm">
							<div class="styLNAmountBox" style="padding-top:none;padding-bottom:none;width:42mm;border-top:solid black 1px;">
								<span style="padding-right:15mm;">Total Assets</span>
							</div>
							<div class="styLNAmountBox" style="padding-top:none;padding-bottom:none;width:42mm;border-top:solid black 1px;border-right:solid black 1px;">
								<span style="padding-right:12mm;">Total Liabilities</span>
							</div>
						</div>
					</div>
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="width:35mm;">Included on Part I, line 4
                                         </div>
						</div>
						<div style="float:right;width:140mm">
					...
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="width:35mm;">Removed on Part I, line 5
                                  </div>
						</div>
						<div style="float:right;width:140mm">
							<div class="styLNAmountBox" style="width:42mm;border-top:solid black 0px;">
					...
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="width:35mm;">Removed on Part I, line 6
                                  </div>
						</div>
						<div style="float:right;width:140mm">
							<div class="styLNAmountBox" style="width:42mm;border-top:solid black 0px;">
					...
					<div class="styBB" style="width:187mm;">
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="width:35mm;">Included on Part I, line 7
                                   </div>
						</div>
						<div style="float:right;width:140mm">
					...
					<div class="pageEnd" style="width:187mm;">
						...
						<div class="styBoldText" style="float:right;font-size:6pt;height:3mm">Schedule M-3 (Form 1065) 2020</div>
					</div>
					<p style="page-break-before: always"/>
					<!-- Page 2 -->
					<!-- Page 2 Header -->
					<div class="styBB" style="width:187mm;">
						<div style="float:left;">Schedule M-3 (Form 1065) 2020</div>
          ...
          Name of partnership<br/>
           ...
           <xsl:call-template name="SetFormLinkInline">
					...
					<thead class="styTableThead" style="font-size:6.3pt;">
						<tr>
							<th class="styIRS1065ScheduleM3NumberCell" style="width:7mm;border-right-width:0mm;border-bottom-width:0mm;" scope="col"/>
							<th class="styIRS1065ScheduleM3Cell" style="width:80mm;text-align:center;font-size:8pt;border-bottom-width:0mm;border-left-width:0mm;font-weight:bold;" scope="col">
                           Income (Loss) Items
                                   <br/>
								<br/>
...
<!-- Form Link -->
             ...
             22</span>
					...
					<div style="width:187mm;height:auto;">
					<div style="width:165mm;margin-left:7mm;padding-top:4mm;">
...
Analysis of Net Income (Loss), line 1.</div>
					<div class="styBB" style="width:187mm;"/>
					<div class="pageEnd" style="width:187mm;">
						<div class="styBoldText" style="float:right;padding-top:1mm;">Schedule M-3 (Form 1065) 2020</div>
					</div>
					</div>
					<p style="page-break-before: always"/>
					<!-- Page 3 -->
...
Return—Expense/Deduction Items
					...
					<!-- Part III Table -->
					<div style="width:187mm;height:auto;border-style:solid;border-bottom-width:2px;border-top-width:0px; border-right-width:0px;border-left-width:0px;">
					...
					<thead class="styTableThead" style="font-size:6.3pt;">
						<tr>
							<th class="styIRS1065ScheduleM3NumberCell" style="width:7mm;border-right-width:0mm;border-bottom-width:0mm;" scope="col"/>
							<th class="styIRS1065ScheduleM3Cell" style="width:80mm;text-align:center;font-size:8pt;border-left-width:0mm;padding-bottom:2mm;font-weight:bold;border-bottom-width:0mm;" scope="col">Expense/Deduction Items</th>
            ...
            <!-- Form Link -->
						...
						<tr>
							...
							<td class="styIRS1065ScheduleM3Cell" style="border-bottom-width:0;">
								<xsl:call-template name="PopulateAmount">
					...
					<div class="pageEnd" style="width:187mm;">
						<div class="styBoldText" style="float:right;">Schedule M-3 (Form 1065) 2020</div>
					</div>
