...
<!-- 03/12/2021 - Changes related to schema grouping IM01377385 UWR 238246 - AJH-->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
		...
		<html>
            ...
            Form<span class="styFormNumber"> 1310</span><br/>(Rev. October 2020)
...
Refund Due a Deceased Taxpayer</div>
							<div class="styFST" style="height:5mm;font-size:7pt;padding-top:3mm;"><br/>
								<img src="{$ImagePath}/1310_Bullet.gif" width="9" height="9" alt="bullet image"/>Go to <i>www.irs.gov/Form 1310</i> for the latest information.
							</div>
					...
					<div class="styGenericDiv" style="width:187mm;height:auto;">
						...
						<div class="styGenericDiv" style="width:171mm;height:15mm;border-left:1px solid black;border-bottom:1px solid black;padding-left:2mm;">
							<div class="styNameBox" style="width:78mm;height:15mm;font-size:7pt;">
								<div>Name of decedent.  If filing a joint return and both taxpayers are deceased, complete a Form 1310 for each. See instructions.</div><br/>
								<span>
									<xsl:call-template name="PopulateText">
							...
							<div class="styNameBox" style="width:40mm;height:15mm;font-size:7pt;padding-left:2mm;">
								<div>Date of death</div><br/><br/><br/><br/>
								<span>
									<xsl:call-template name="PopulateMonth">
							...
							<div class="styEINBox" style="width:50mm;height:9mm;padding-left:1mm;font-size:7pt;">
								<div style="font-weight:bold;">Decedent&#8217;s social security number</div><br/><br/><br/><br/>
					...
					<div class="styGenericDiv" style="width:187mm;border-top:1px solid black;border-bottom:1px solid black;padding:1mm 0mm;">
						...
						<div class="styPartDesc">Check the <span style= "text-decoration:underline">one</span> box that applies to you. You must also complete Part III below. See instructions.</div>
						<!-->Removed with UWR 240267
					...
					<div class="styGenericDiv" style="width:187mm;padding-top:1mm;font-size:8pt;">
						...
						<label>
						  ...
						  <xsl:with-param name="BackupName">FormDataSurvivingSpouseInd</xsl:with-param>
							...
							<span style="line-height:4mm;">Surviving spouse requesting reissuance of a refund check received in the name of both the decendent<br/> and the surviving spouse.</span>
						</label>
					</div>
					<!-- Part I, Line B -->
						...
						<label>
						  ...
						  <xsl:with-param name="BackupName">FormDataOtherPersonClaimingRefundInd</xsl:with-param>
							...
							<span style="line-height:4mm;">Person, <span style="font-weight:bold;">other</span> than A or B, claiming refund for the decedent's
								 estate. Also, complete Part II.</span>
						</label>
						</div>
							<!-- Part I END -->
							<!-- Part II -->
					...
					<div class="pageEnd" style="width:187mm; font-size:7pt; border-top:1px solid black; padding-top:0.5mm">
						...
						Form <b style="font-size:9pt">1310</b> (Rev. 10-2020)
						</div>
							<br></br>
						<div>
						<xsl:call-template name="LinkToLeftoverDataTableInline">
