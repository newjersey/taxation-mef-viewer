          ...
          <div class="styTBB" style="width:187mm;">
            ...
            <div class="styFTBox" style="width:125mm;height:21mm;">
              ...
              <div class="styFST" style="font-size:6.6pt;">
                <img src="{$ImagePath}/1120SchN_Bullet_Title.gif" alt="Medium right arrow graphic"/> Attach to Form 1120, 1120-C, 1120-F, 1120-FSC, 1120-L, 1120-PC, 1120-REIT, or 1120-RIC.<br/>
                <div class="styFST" style="font-size:7pt;">
                <img src="{$ImagePath}/1120SchN_Bullet_Title.gif" alt="Medium right arrow graphic" style="padding-right:1mm;"/>
					Go to 
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:179mm;">
              ...
              <span>
                ...
                <input type="checkbox" alt="corp member for specific period" class="styCkbox">
                  <xsl:call-template name="PopulateYesCheckbox">
                    <xsl:with-param name="TargetNode" select="$Form1120ScheduleO/CorporateGroupMemberInd"/>
                    <xsl:with-param name="BackupName">corp member for specific period</xsl:with-param>
                  </xsl:call-template>
                </input>
              </span>
              <label>
