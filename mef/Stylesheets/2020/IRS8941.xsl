...
<!-- Last Modified by Iskilu Lawal 7/15/2020 UWR # 234678 -->
...
">
							...
							<div class="styFBT" style="margin-top:0mm;padding-left:0.5mm;font-size:6.0pt;padding-top:3mm;">
								<img src="{$ImagePath}/8941_Bullet.gif" alt="Bullet Image"/>Go to <a href="http://www.irs.gov/Form8941" title="Link to IRS.gov"><i>www.irs.gov/Form8941</i></a> for instructions and the latest information.
							</div>
						</div>
...
(SHOP) Marketplace (or do you qualify for an exception to this requirement)? See instructions.<br/>
  ...
  Enter Marketplace Identifier (if any): 
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:170mm;height:20mm;font size:7pt;">Does a tax return you (or any predecessor) filed for a tax year beginning in 2014, 2015, 2016, 2017, or 2018 include a Form 8941 with line A checked "Yes" and line 12 showing a positive amount?<br/>
							<!-- CheckboxYesStart -->
							<span>
                             <xsl:call-template name="PopulateSpan">
 ...
 Stop. Do not file Form 8941 (see instructions for an exception that may apply to a partnership, S corporation, cooperative, estate, trust, or tax-exempt entity) (also see instructions for information about the credit period limitation)
        ...
        <!--Dotted Line-->
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:136mm;height:7mm;font size:7pt">Average annual wages you paid for the tax year (from Worksheet 3, line 3).This amount must be a multiple of a $1,000. If you entered $56,000 or more, skip lines 4 through 11 and enter -0- on line 12
        <!--Dotted Line-->
							<span class="styBoldText">
								<span style="width:8px"/>.
								<span style="width:8px"/>.
        ...
        <!--Dotted Line-->
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:136mm;height:4mm;font size:7pt">If line 3 is $27,000 or less, enter the amount from line 8. Otherwise, enter the amount from Worksheet 6, line 7
        <!--Dotted Line-->
							<span class="styBoldText">
								<span style="width:8px"/>.
                                    <span style="width:8px"/>.
...
3800,  Part III, line 4h
        ...
        <!--Dotted Line-->
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:136mm;height:7mm;font size:7pt">Enter the amount you paid in 2020 for taxes considered payroll taxes for purposes of this credit. <br/>  See instructions.
        <!--Dotted Line-->
							<span class="styBoldText">
								<span style="width:8px"/>. 
                                    <span style="width:8px"/>.
