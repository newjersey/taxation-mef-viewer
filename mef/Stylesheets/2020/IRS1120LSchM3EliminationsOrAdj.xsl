	...
	<xsl:template match="/">
		...
		<html>
			<head>
				...
				<style type="text/css">
					<!--Print statement for repeating data -->
				...
				<form name="Form1120LSchM3EliminationsOrAdj">
					...
					<div class="styTBB" style="width:187mm;">
						...
						<div class="styFTBox" style="width:125mm;height:19.5mm;">
							...
							<div class="styFST" style="height:5mm;">
								...
								Go to  
								<a style="text-decoration:none;color:black;" href="http://www.irs.gov/Form1120l" title="Link to IRS.gov"><i>www.irs.gov/Form1120L</i></a>
						...
						<div class="styTYBox" style="width:30mm;height:19.5mm;border-left-width:2px;">
							...
							<div class="styTY" style="height:11mm;padding-top:1.5mm;">20<span class="styTYColor">20</span>
							</div>
						</div>
					</div>
					...
					<div style="width:187mm;font-size:6pt;">
						<div class="styGenericDiv" style="width:100mm;">
							...
							<input type="checkbox" alt="Non-consolidated return" class="styCkbox">
						...
						<div class="styGenericDiv" style="width:60mm;">
						 (2)
							<input type="checkbox" alt="Consolidated return (Form 1120-L only)" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
					...
					<div class="styBB" style="width:187mm;font-size:6pt;">
						<div class="styGenericDiv" style="width:100mm;">
							...
							<input type="checkbox" class="styCkbox" alt="Mixed 1120/L/PC group">
								<xsl:call-template name="PopulateCheckbox">
						...
						<div class="styGenericDiv" style="width:60mm;">
						 (4)
							<input type="checkbox" class="styCkbox" alt="Dormant subsidiaries schedule attached">
								<xsl:call-template name="PopulateCheckbox">
									<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/DormantSubsidiariesSchAttInd"/>
									<xsl:with-param name="BackupName">DormantSubsidiariesSchAttachedInd</xsl:with-param>
								</xsl:call-template>
						    </input>
							<label>
								<xsl:call-template name="PopulateLabel">
									<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/DormantSubsidiariesSchAttInd"/>
									<xsl:with-param name="BackupName">DormantSubsidiariesSchAttachedLabel</xsl:with-param>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" alt="Corporation Filed SEC Form10K Yes" class="styCkbox">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/CorporationFiledSECForm10KInd"/>
										<xsl:with-param name="BackupName">CorporationFiledSECForm10KIndYes</xsl:with-param>
									</xsl:call-template>
								</input>
							</span>
							<label>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" alt="Corporation Filed SEC Form10K No" class="styCkbox">
									<xsl:call-template name="PopulateNoCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/CorporationFiledSECForm10KInd"/>
										<xsl:with-param name="BackupName">CorporationFiledSECForm10KIndNo</xsl:with-param>
									</xsl:call-template>
								</input>
							</span>
							<label>
								<xsl:call-template name="PopulateLabelNo">
									<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/CorporationFiledSECForm10KInd"/>
									<xsl:with-param name="BackupName">CorporationFiledSECForm10KLabelNo</xsl:with-param>
								</xsl:call-template>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" alt="Corporation Preprared Certified Audited Income Statement Yes" class="styCkbox">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/CorpPrepCertAuditedIncmStmtInd"/>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" alt="Corporation Preprared Certified Audited Income Statement No" class="styCkbox">
									<xsl:call-template name="PopulateNoCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/CorpPrepCertAuditedIncmStmtInd"/>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" alt="Corporation Prepared Income Statement Indicator Yes" class="styCkbox">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/CorporationPreparedIncmStmtInd"/>
										<xsl:with-param name="BackupName">CorporationPrepIncomeStatementIndYes</xsl:with-param>
									</xsl:call-template>
								</input>
							</span>
							<label>
								<xsl:call-template name="PopulateLabelYes">
									<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/CorporationPreparedIncmStmtInd"/>
									<xsl:with-param name="BackupName">CorporationPrepIncomeStatementLabelYes</xsl:with-param>
								</xsl:call-template>
								<span class="styBoldText" style="padding-left:1mm;">Yes.</span>
							</label>          
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" alt="Corporation Prepared Income Statement Indicator No" class="styCkbox">
									<xsl:call-template name="PopulateNoCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/CorporationPreparedIncmStmtInd"/>
										<xsl:with-param name="BackupName">CorporationPrepIncomeStatementIndNo</xsl:with-param>
									</xsl:call-template>
								</input>
							</span>
							<label>
								<xsl:call-template name="PopulateLabelNo">
									<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/CorporationPreparedIncmStmtInd"/>
									<xsl:with-param name="BackupName">CorporationPrepIncomeStatementLabelNo</xsl:with-param>
								</xsl:call-template>
								<span class="styBoldText" style="padding-left:1mm;">No.</span>
							</label>
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" alt="Corporation Income Statement Restated Yes" class="styCkbox">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/CorporationIncmStmtRestatedInd"/>
										<xsl:with-param name="BackupName">CorporationIncomeStatementRestatedIndYes</xsl:with-param>
									</xsl:call-template>
								</input>
							</span>
							<label>
								<xsl:call-template name="PopulateLabelYes">
									<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/CorporationIncmStmtRestatedInd"/>
									<xsl:with-param name="BackupName">CorporationIncomeStatementRestatedLabelYes</xsl:with-param>
								</xsl:call-template>
								<span class="styBoldText" style="padding-left:1mm;">Yes.</span>
							</label>          
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" alt="Corporation Income Statement Restated No" class="styCkbox">
									<xsl:call-template name="PopulateNoCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/CorporationIncmStmtRestatedInd"/>
										<xsl:with-param name="BackupName">CorporationIncomeStatementRestatedIndNo</xsl:with-param>
									</xsl:call-template>
								</input>
							</span>
							<label>
								<xsl:call-template name="PopulateLabelNo">
									<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/CorporationIncmStmtRestatedInd"/>
									<xsl:with-param name="BackupName">CorporationIncomeStatementRestatedLabelNo</xsl:with-param>
								</xsl:call-template>
								<span class="styBoldText" style="padding-left:1mm;">No.</span>
							</label>
						</div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" alt="Corporation Income Statement Restated 5 Preceding Periods Yes" class="styCkbox">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/CorpIncmStmtRestated5PrecInd"/>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" alt="Corporation Income Statement Restated 5 Preceding Periods No" class="styCkbox">
									<xsl:call-template name="PopulateNoCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/CorpIncmStmtRestated5PrecInd"/>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" alt="Corporation Voting Common Stock Publicly Traded Yes" class="styCkbox">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/CorporationVtngComStkPubTrdInd"/>
										<xsl:with-param name="BackupName">CorporationVotingCommonStockPubTradedIndYes</xsl:with-param>
									</xsl:call-template>
								</input>
							</span>
							<label>
								<xsl:call-template name="PopulateLabelYes">
									<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/CorporationVtngComStkPubTrdInd"/>
									<xsl:with-param name="BackupName">CorporationVotingCommonStockPubTradedLabelYes</xsl:with-param>
								</xsl:call-template>
								<span class="styBoldText" style="padding-left:1mm;">Yes.</span>
							</label>
						</div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;">
							...
							<span>
								...
								<input type="checkbox" alt="Corporation Voting Common Stock Publicly Traded No" class="styCkbox">
									<xsl:call-template name="PopulateNoCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/CorporationVtngComStkPubTrdInd"/>
										<xsl:with-param name="BackupName">CorporationVotingCommonStockPubTradedIndNo</xsl:with-param>
									</xsl:call-template>
								</input>
							</span>
							<label>
								<xsl:call-template name="PopulateLabelNo">
									<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/CorporationVtngComStkPubTrdInd"/>
									<xsl:with-param name="BackupName">CorporationVotingCommonStockPubTradedLabelNo</xsl:with-param>
								</xsl:call-template>
								<span class="styBoldText" style="padding-left:1mm;">No.</span>
							</label>
						    If &#34;No,&#34; go to line 4a.
					...
					<div style="width:187mm;"><br/>
						<div class="styLNLeftNumBoxSD">
							<span style="width:1.5mm"/>b</div>
						<!--R10_D1: Per SS Guide 3.1.23 to allow text naturally wrap and remove line break -->
						...
						<!--R10_D1: Remove margin-top:1.5mm; so the box can be align with the description text -->
						<div style="width:25mm;height:4.5mm;border: solid 1px;float:left;margin-left:3mm;text-align:center;padding-top:1mm;">
							<xsl:call-template name="PopulateText">
					...
					<div class="styNBB" style="width:187mm;">
						...
						<div style="width:45mm;height:4.5mm;border: solid 1px;margin-top:1.5mm;float:left;margin-left:3mm;text-align:center;padding-top:1mm;">
							<xsl:call-template name="PopulateText">
					...
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="width:130mm;padding-top:.5mm;">
							Worldwide consolidated net income (loss) from income statement source identified in Part I, line 1</div>
						</div>
					...
					<div class="styBB" style="width:187mm;">
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="width:137mm;">
								<span class="styBoldText">Note: </span> Part I, line 11, must equal the amount on Part II, line 30, column (a). 
						    </div>
						</div>
					...
					<div style="width:187mm;">
						...
						<div style="float:right;clear:none;">
							<div style="width:120mm;">
								<div class="styLNAmountBox" style="width:50mm;text-align:center;border-left-width:1px;border-top-width:1px;font-size:7.5pt;">
									<b>Total Assets</b>
								</div>
								<div class="styLNAmountBox" style="width:50mm;text-align:center;border-left-width:1px;border-top-width:1px;border-right-width:1px;font-size:7.5pt;">
					...
					<div style="width:187mm;">
						...
						<div style="float:right;clear:none;">
							<div style="width:120mm;">
								<!--Assets column -->
								<div class="styLNAmountBox" style="width:50mm;padding-right:1mm;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/EntIncldWorldwideCnsldtAstAmt"/>
									</xsl:call-template>
								</div>
								<!--Liabilities column -->
								<div class="styLNAmountBox" style="width:50mm;border-right-width:1px;padding-right:1mm;">
									<xsl:call-template name="PopulateAmount">
					...
					<div style="width:187mm;">
						...
						<div style="float:right;clear:none;">
							<div style="width:120mm;">
								<!--Assets column -->
								<div class="styLNAmountBox" style="width:50mm;padding-right:1mm;border-bottom-width:0px;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/EntIncldOtherIncludibleAstAmt"/>
									</xsl:call-template>
								</div>
								<!--Liabilities column -->
								<div class="styLNAmountBox" style="width:50mm;border-right-width:1px;padding-right:1mm;border-bottom-width:0px;">
									<xsl:call-template name="PopulateAmount">
					...
					<div class="pageEnd" style="width:187mm;">
						...
						<div class="styBoldText" style="float:right;">Schedule M-3 (Form 1120-L) 2020</div>
					</div>
					<!-- Page 2 -->
					<!-- Page 2 Header -->
					<div class="styTBB" style="width:187mm;float:none;">
						<div style="float:left;">Schedule M-3 (Form 1120-L) 2020</div>
					...
					<div style="width:187mm;font-size:6pt;">
						<div class="styGenericDiv">
							...
							<input type="checkbox" alt="Consolidated group" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
						...
						<div class="styGenericDiv" style="padding-left:2mm;">
							<b>(2)</b>
							<input type="checkbox" alt="Parent corp" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
						...
						<div class="styGenericDiv" style="padding-left:2mm;">
							<b>(3)</b>
							<input type="checkbox" alt="Consolidated eliminations" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
						...
						<div class="styGenericDiv" style="padding-left:2mm;">
							<b>(4)</b>
							<input type="checkbox" alt="Subsidiary corp" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
						...
						<div class="styGenericDiv" style="padding-left:2mm;">
							<b>(5)</b>
							<input type="checkbox" alt="Mixed 1120/L/PC group" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
					...
					<div style="width:187mm;font-size:6pt;">
						...
						<div class="styGenericDiv" style="padding-left:5mm;">
							<b>(7)</b>
							<input type="checkbox" alt="1120-L eliminations" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
									<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/IncomeLossItems/Is1120LEliminationsInd"/>
									<xsl:with-param name="BackupName">Is1120LEliminationsInd</xsl:with-param>
								</xsl:call-template>
							</input>
							<label>
								<xsl:call-template name="PopulateLabel">
									<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/IncomeLossItems/Is1120LEliminationsInd"/>
									<xsl:with-param name="BackupName">Is1120LEliminationsLabel</xsl:with-param>
								</xsl:call-template>
							</label>
							1120-L eliminations
						</div>
					...
					<div style="width:187mm;">
						...
						<div style="width:48.9mm;float:right;clear:none;border-top:solid 1px;padding-left:2mm">
							...
							<br/><br/>
							<xsl:choose>
								<xsl:when test="$Form1120LScheduleM3/IncomeLossItems/SubsidiaryEIN">
									<xsl:call-template name="PopulateEIN">
					...
					<div style="width:187mm;height:8mm;border-style:solid; border-bottom-width:1px;border-top-width:1px; border-right-width:0px;border-left-width:0px;padding-top:0;float:left;">
						...
						<span class="styPartDesc" style="width:170mm;">
							...
							<span style="width:2mm;"/>Income per Return
						    <span style="font-weight:normal">(see instructions)</span>
						</span>
					</div>
					<!-- Part II Table -->
					<!--Remove summary="Reconciliation of Net Income (Loss) per Income Statement of Includible Corporations With Taxable Income per Return " because JAWS reading it twice; Mitchell Buyck from IBM concur ao5/4/2016 -->
					<table class="styTable" id="IRS1120LScheduleM3PartIITable" cellspacing="0" cellpadding="0" style="font-size:7pt;width:187mm;">
						<tr>
							<th class="styTableThead" style="width:6mm" scope="col"/>
							<th class="styTableThead" style="width:81mm;text-align:center;font-size:8pt;display:table-cell;" scope="col">Income (Loss) Items<br/>
						...
						<tr>
							...
							<td class="styIRS1120LScheduleM3PartIICol1Cell">
								<span style="float:left;">Gross-up for foreign taxes deemed paid
								    <!-- Form Link -->
									<xsl:call-template name="SetFormLinkInline">
										<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/IncomeLossItems/GrossUpForeignTaxesDeemedPd"/>
									</xsl:call-template>
								</span>
								<span class="styDotLn" style="float:right;padding-right:2mm;">.....</span>
							</td>
							...
							<td class="styIRS1120LScheduleM3Cell">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/IncomeLossItems/GrossUpForeignTaxesDeemedPd/TemporaryDifferenceAmt"/>
								</xsl:call-template>
							</td>
							<td class="styIRS1120LScheduleM3Cell">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/IncomeLossItems/GrossUpForeignTaxesDeemedPd/PermanentDifferenceAmt"/>
								</xsl:call-template>
							</td>
							<td class="styIRS1120LScheduleM3Cell">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/IncomeLossItems/GrossUpForeignTaxesDeemedPd/IncomeLossPerTaxReturnAmt"/>
								</xsl:call-template>
							</td>
						</tr>
						<!-- Part II - Line 5 -->
            ...
            <!-- Form Link -->
						...
						<tr>
							...
							<td class="styIRS1120LScheduleM3Cell">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/IncomeLossItems/InterestIncomeForm8916AGrp/IncomeLossPerIncomeStmtAmt"/>
								</xsl:call-template>
							</td>
							<td class="styIRS1120LScheduleM3Cell">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/IncomeLossItems/InterestIncomeForm8916AGrp/TemporaryDifferenceAmt"/>
								</xsl:call-template>
							</td>
							<td class="styIRS1120LScheduleM3Cell">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/IncomeLossItems/InterestIncomeForm8916AGrp/PermanentDifferenceAmt"/>
								</xsl:call-template>
							</td>
							<td class="styIRS1120LScheduleM3Cell">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/IncomeLossItems/InterestIncomeForm8916AGrp/IncomeLossPerTaxReturnAmt"/>
								</xsl:call-template>
							</td>
						</tr>
						<!-- Part II - Line 14 -->
						...
						<tr>
							...
							<td class="styIRS1120LScheduleM3PartIICol1Cell" style="padding-top:.5mm;">
								Income statement gain/loss on sale, exchange, abandonment, worthlessness, or other disposition of assets other than pass-through entities
								<span class="styDotLn" style="float:right;padding-right:2mm;">..............</span>
							</td>
							<td class="styIRS1120LScheduleM3Cell" style="border-top-width:1px;">
								<xsl:call-template name="PopulateAmount">
						...
						<!-- Part II - Line 23b -->
						<tr>
							<td class="styLNLeftNumBoxSD" style="padding-bottom:7px;padding-top:1px;">
								<span style="width:2.5mm;"/>b</td>
							<td class="styIRS1120LScheduleM3PartIICol1Cell" style="padding-top:.5mm;">Gross capital gains from Schedule D, excluding amounts
						...
						<!-- Part II - Line 23c -->
						<tr>
							<td class="styLNLeftNumBoxSD" style="padding-bottom:19px;padding-top:1px;">
							...
							<td class="styIRS1120LScheduleM3PartIICol1Cell" style="padding-top:.5mm;">Gross capital losses from Schedule D, excluding
							  amounts from pass-through entities, abandonment losses, and  worthless 
							    <span style="float:left">stock losses</span>
								<span class="styDotLn" style="float:right;padding-right:2mm;">...............</span>
							</td>
							<td class="styIRS1120LScheduleM3ShadedCell" style="border-bottom-width:0px;">
								<span style="width:1mm"/>
						...
						<!-- Part II - Line 23e -->
						<tr>
							<td class="styLNLeftNumBoxSD" style="padding-bottom:3px;padding-top:1px;">
							...
							<td class="styIRS1120LScheduleM3Cell">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/IncomeLossItems/AbandonmentLosses/IncomeLossPerTaxReturnAmt"/>
								</xsl:call-template>
							</td>
						</tr>
						<!-- Part II - Line 23f -->
...
<!-- Form Link -->
						...
						<!-- Part II - Line 23g -->
						<tr>
							<td class="styLNLeftNumBoxSD" style="padding-bottom:8px;padding-top:1.5px;">
						...
						<tr>
							...
							<td class="styIRS1120LScheduleM3PartIICol1Cell">
							    <span style="float:left">Other income (loss) items with differences (attach statement)							 
									<xsl:call-template name="SetFormLinkInline">
						...
						<tr>
							...
							<td class="styIRS1120LScheduleM3PartIICol1Cell">
								<span class="styBoldText" style="font-weight:normal">
									<b>Total expense/deduction items</b> (from Part III, line 40) </span>
									<span class="styDotLn" style="float:right;padding-right:2mm;">.</span>
							</td>
							<td class="styIRS1120LScheduleM3Cell">
								<xsl:call-template name="PopulateAmount">
						...
						<tr>
							...
							<td class="styIRS1120LScheduleM3PartIICol1Cell" style="padding-top:.5mm;">Mixed groups, see instructions. All others, combine lines 
							 <span style="float:left">26 through 28</span>
								<span class="styDotLn" style="float:right;padding-right:2mm;">..............</span>
							</td>
							<td class="styIRS1120LScheduleM3Cell">
								<xsl:call-template name="PopulateAmount">
						...
						<tr>
							...
							<td class="styIRS1120LScheduleM3PartIICol1Cell">
								...
								<span style="font-weight:normal"><span style="width:.1px;"/> Combine lines 29a through 29c</span>
								<span class="styDotLn" style="float:right;padding-right:2mm;">..</span>
							</td>
							<td class="styIRS1120LScheduleM3Cell">
								<xsl:call-template name="PopulateAmount">
					...
					<!-- Table R40 L 30 Note -->
					<div class="styBB" style="width:187mm;border-bottom:2px solid black;height:4.5mm;">
						<span class="styBoldText" style="margin-left:8mm;">Note:</span> 
					    Line 30, column (a) must equal the amount on Part I, line 11, and column (d) must equal Form 1120-L, page 1,  line 20. </div>
					<!-- Page 2 END -->
					<div class="pageEnd" style="width:187mm;">
						<div class="styBoldText" style="float:right;padding-top:1mm;">Schedule M-3 (Form 1120-L) 2020</div>
					</div>
					<!-- Page 3 -->
					<!-- Page 3 Header -->
					<div class="styTBB" style="width:187mm;float:none;">
					...
					<div style="width:187mm;font-size:6pt;">
						...
						<div class="styGenericDiv" style="padding-left:1px;">
							<b>(2)</b>
							<input type="checkbox" alt="Parent corporation" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
									<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/ExpenseDeductionItems/ParentCorporationInd"/>
									<xsl:with-param name="BackupName">ParentCorporationInd</xsl:with-param>
								</xsl:call-template>
						...
						<div class="styGenericDiv" style="padding-left:1mm;">
							<b>(4)</b>
							<input type="checkbox" alt="Subsidiary corporation" class="styCkbox">
								<xsl:call-template name="PopulateCheckbox">
									<xsl:with-param name="TargetNode" select="$Form1120LScheduleM3/ExpenseDeductionItems/SubsidiaryCorporationInd"/>
									<xsl:with-param name="BackupName">SubsidiaryCorporationInd</xsl:with-param>
								</xsl:call-template>
					...
					<div style="width:187mm;height:8mm;border-style:solid; border-bottom-width:1px;border-top-width:1px; border-right-width:0px;border-left-width:0px;padding-top:0;float:left;">
						...
						<span class="styPartDesc" style="width:170mm;">
							<span style="width:2mm;"/>Reconciliation of Net Income (Loss) per Income Statement of Includible Corporations With Taxable<br/>
							<span style="width:2mm;"/>Income per Return—Expense/Deduction Items <span style="font-weight:normal">(see instructions)</span>
						</span>
					</div>
					<!-- Part III Table -->
					<!--Remove summary="Reconciliation of Net Income (Loss) per Income Statement of Includible Corporations With Taxable Income per Return—Expense/Deduction Items " because JAWS reading it twice; Mitchell Buyck from IBM concur ao5/4/2016 -->
					<table class="styTable" id="IRS1120LScheduleM3PartIII" cellspacing="0" cellpadding="0" style="font-size:7pt;width:187mm;">
						<tr>
							<th class="styTableThead" style="width:6mm" scope="col"/>
              ...
              <!-- Form Link -->
						...
						<tr>
							<td class="styIRS1120LScheduleM3NumberCell">27</td>
							<td style="padding-top:.5mm;">Current year acquisition/reorganization costs (attach <br/>
								<span style="float:left;">statement)								
									<!-- Form Link -->
									<xsl:call-template name="SetFormLinkInline">
						...
						<tr style="height:10mm;">
							...
							<span class="styBoldText" style="font-weight:bold;">Total expense/deduction items.	</span>
							  <span style="font-weight:normal;"><span style="width:1mm;"/>Combine lines 1 through 39. </span>
							  <span>Enter here and on Part II, line 27, reporting positive amounts as negative and negative amounts as positive
								<span class="styDotLn" style="float:right;padding-right:2mm;">.....</span>
								</span>
							</td>
