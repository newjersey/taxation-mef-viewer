         ...
         <xsl:call-template name="PartIIITemplate"/>        
					...
					<div class="styBB" style="width:187mm;">
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139mm;">
								<span style="float:left;">Carryforward of general business credit to 2020. Enter the amount from line 2 of Part III with box C checked.</span>
								<span style="float:left;">See instructions for statement to attach
                    <!--Dotted Line-->
									<xsl:call-template name="SetFormLinkInline">
					...
					<div style="width:187mm;">
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139mm;">
								...
								<span style="float:left;">Carryback of general business credit from 2021. Enter the amount from line 2 of Part III with box D checked.  </span>
