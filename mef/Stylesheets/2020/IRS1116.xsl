...
<!-- Last Modified by Eugenia McDonald on 08/20/2020 -->
  ...
  <xsl:template name="CreateBoxLine12">
    ...
    <div class="styLNRightNumBox">
      <xsl:attribute name="style">
        ...
        border-right-width:0px;
        height:<xsl:value-of select="$Height"/>;
        <xsl:if test="$NumberBoxStyle"><xsl:value-of select="$NumberBoxStyle"/>
		</xsl:if>
	  </xsl:attribute>
      <xsl:if test="$Number">
        <xsl:value-of select="$Number"/>
    ...
    <div class="styLNAmountBox">
      <xsl:attribute name="style">
        ...
        <xsl:if test="$AmountBoxStyle"><xsl:value-of select="$AmountBoxStyle"/>
		</xsl:if>
	  </xsl:attribute>
	  <xsl:choose>
	...
	<xsl:template match="/">
			...
			<body class="styBodyClass">
              ...
              Foreign Taxes Paid or Accrued <span class="styNormalText">(see instructions)</span>
					...
					<div style="width: 187mm; height: auto; clear: left; float: left; padding-bottom: 15mm;">
						...
						<div style="width: 47mm; height: auto; text-align: right;">
							<span style="width: 50px;"/>
							  Form               
							<span class="styBoldText" style="font-size: 8pt;">1116</span> (2020)            
						</div>
					...
					<div class="styIRS1116LineItem" style="width: 187mm; height: 7.5mm;">
						<div class="styIRS1116LNLeftNumBox" style="width: 5mm; height: 8mm; text-align: left; padding-top: 3mm; padding-left: 1mm;">10</div>
						<div class="styIRS1116LNDesc" style="width: 114mm; height: 8mm; padding-top: 3mm;">
					...
					<div class="styIRS1116LineItem" style="width: 187mm; height: 12mm;">
						...
						<div class="styLNRightNumBox" style="border-width: 0px 1px; padding: 0px; width: 8.25mm; height: 12mm; float: left; background-color: lightgrey;"></div>
					</div>
					<!-- (13) ////////////////////////////////////////////////////-->
					<div class="styIRS1116LineItem" style="width: 187mm; height: 8mm;">
        ...
        <div class="styIRS1116LineItem" style="width: 187mm; height: 5mm;">
			<div class="styIRS1116LNLeftNumBox" style="width: 5mm; height: 5mm; text-align: left;"></div>
			...
			<div class="styLNRightNumBox" style="padding: 0px; width: 8mm; height: 5mm; border-bottom-width: 0px; border-left-width: 1px;"></div>
			<div class="styLNAmountBox" style="border-width: 0px 0px 0px 1px; padding: 0px; width: 26mm; height: 5mm; text-align: right; font-size: 6pt;"></div>
		</div>
		<!-- (19) ////////////////////////////////////////////////////-->
		<div class="styIRS1116LineItem" style="width: 187mm; height: 5mm;">
